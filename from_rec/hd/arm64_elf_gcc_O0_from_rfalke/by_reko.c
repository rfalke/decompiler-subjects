...
Eq_149 g_t0E40 = // 0000000000000E40
	{
		0x20
	};
...
word64 dumpline(byte x0[], int32 w2)
{
	...
	Mem159[fp + ~0x4F + CONVERT(dwLoc44_214 + dwLoc42, int32, int32):word16] = Mem135[0x0000000000000E48<p64>:word16];
	fn00000000000008B0();
	return x30;
}

// 0000000000000C28: Register word32 hexdump(Register word64 x0)
// Called from:
//      main
word32 hexdump(word64 x0)
{
	word64 x0_120;
	struct Eq_219 * x29_34 = fp + -200;
...
// 0000000000000E00: Register word32 __stat(Register word64 x0)
// Called from:
//      hexdump
