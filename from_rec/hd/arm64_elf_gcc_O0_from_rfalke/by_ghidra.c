...

{
  ...
  *(undefined2 *)(buff + (long)len + (long)c) = 0x7c;
  puts(buff);
  return;
}
...
void FUN_00100d7c(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x00100d7c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x100d7c);
