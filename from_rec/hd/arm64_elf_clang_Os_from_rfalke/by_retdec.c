...
// From module:   /mnt/from_rec/./hd/source.c
// Address range: 0x4009e0 - 0x400a90
// Line range:    27 - 36
int32_t hexdump(char * fname) {
    // 0x4009e0
    int64_t v1; // 0x4009e0
...
// From module:   /mnt/from_rec/./hd/source.c
// Address range: 0x400a90 - 0x400ae4
// Line range:    56 - 64
int main(int argc, char ** argv) {
    ...
    int32_t result = 0; // 0x400ab0
    int64_t v1 = (int64_t)argv; // 0x400ab0
    v1 += 8;
    result += hexdump((char *)*(int64_t *)v1);
    int64_t v2 = (int64_t)(argc - 1) + 0xffffffff; // 0x400ac0
    int64_t v3 = v2 & 0xffffffff; // 0x400ac4
    while ((int32_t)v2 != 0) {
        // 0x400ab4
        v1 += 8;
        result += hexdump((char *)*(int64_t *)v1);
