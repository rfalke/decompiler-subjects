  ...
  *(undefined4 *)((long)auStack176 + (long)iVar2) = 0x7c2020;
  if (iVar1 < 1) {
    ...
    do {
      ...
      *(byte *)((long)auStack176 + lVar5 + iVar2) = bVar4;
      lVar5 = lVar5 + 1;
    } while (lVar5 < iVar1);
    if (0xf < (int)lVar5) goto LAB_004009b0;
  }
  memset((void *)((long)auStack176 + (long)(int)lVar5 + (long)iVar2),0x20,
         (ulong)(0xf - (int)lVar5) + 1);
  lVar5 = 0x10;
LAB_004009b0:
  *(undefined2 *)((long)(undefined4 *)((long)auStack176 + (long)iVar2) + (long)(int)lVar5) = 0x7c;
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x400ae4);
