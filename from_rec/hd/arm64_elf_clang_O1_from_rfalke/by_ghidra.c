  ...
  *(undefined4 *)((longlong)auStack176 + (longlong)(int)sVar2) = 0x7c2020;
  if (iVar1 < 1) {
    ...
    do {
      ...
      *(byte *)((longlong)auStack176 + lVar5 + (int)sVar2) = bVar3;
      lVar5 = lVar5 + 1;
      iVar4 = (int)lVar5;
    } while (lVar5 < iVar1);
    if (0xf < iVar4) goto LAB_004009b0;
  }
  memset((void *)((longlong)auStack176 + (longlong)iVar4 + (longlong)(int)sVar2),0x20,0x10 - iVar4);
  iVar4 = 0x10;
LAB_004009b0:
  *(undefined2 *)
   ((longlong)(undefined4 *)((longlong)auStack176 + (longlong)(int)sVar2) + (longlong)iVar4) = 0x7c;
