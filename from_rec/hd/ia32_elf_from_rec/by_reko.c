...
// 080485A0: void _start(Register word32 esi, Register word32 edi, Stack word32 dwArg00)
void _start(word32 esi, word32 edi, word32 dwArg00)
{
	__align(fp + 0x04);
	__syscall(0x80);
...
// 08048660: void dumpline(Register (ptr Eq_74) ebx, Stack ptr32 dwArg04, Stack uint32 dwArg08, Stack ptr32 dwArg0C)
void dumpline(stat * ebx, ptr32 dwArg04, uint32 dwArg08, ptr32 dwArg0C)
{
	sprintf();
...
// 080487F0: Register word32 hexdump(Register (ptr Eq_74) ebx, Stack word32 dwArg04)
word32 hexdump(stat * ebx, word32 dwArg04)
{
	...
	if (dwArg04 != 0x00)
	{
		...
		if (dwArg04 != 0x00)
		{
			...
			while (dwLoc48 > dwLoc18_36)
			{
				...
				if (fp == 0x14)
					break;
				dumpline(ebx, fp - 0x14, dwLoc18_36, fp - 0x14);
...
// 080488E0: void main(Register (ptr Eq_74) ebx, Stack ui32 dwArg04, Stack ptr32 dwArg08)
void main(stat * ebx, ui32 dwArg04, ptr32 dwArg08)
{
	int32 dwLoc08_15 = 0x01;
	while (dwArg04 > dwLoc08_15)
	{
		hexdump(ebx, dwArg08[dwLoc08_15]);
		dwLoc08_15 = dwLoc08_15 + 0x01;
	}
	return;
}

// 08048950: void stat(Stack int32 dwArg04, Stack ptr32 dwArg08)
void stat(int32 dwArg04, ptr32 dwArg08)
{
	_xstat();
	return;
}
