...
void dumpline(void* a1, uint32_t a2, uint32_t a3) {
    void* ebp4;
    uint32_t v5;
    uint32_t v6;
    uint32_t eax7;
...
int32_t stat(int32_t a1, void* a2);
...
int32_t hexdump(int32_t a1) {
    ...
    eax3 = stat(a1, reinterpret_cast<int32_t>(ebp2) - 88);
    if (eax3) {
        eax4 = fopen(a1, "rb");
        v5 = eax4;
        if (v5) {
            ...
            while (v7 > v6) {
                ...
                if (!eax8) 
                    goto addr_804889d_6;
                dumpline(reinterpret_cast<int32_t>(ebp2) - 16, v6, eax8);
                v6 = v6 + eax8;
            }
        } else {
            perror(a1);
