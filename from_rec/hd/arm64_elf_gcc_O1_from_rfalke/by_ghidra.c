...
LAB_00100abc:
    ...
    *(undefined4 *)(buff + lVar5) = 0x7c2020;
    ...
    pbVar7 = p;
    do {
      sprintf(buff + (longlong)iVar6 + 9," %02lX",(ulonglong)*pbVar7);
      iVar6 = iVar6 + 3;
      pbVar7 = pbVar7 + 1;
    } while (iVar6 != cnt * 3);
    iVar6 = cnt + 1;
...
LAB_00100b10:
    ...
    do {
      ...
      buff[(int)((int)lVar3 + sVar2)] = uVar4;
      lVar3 = lVar3 + 1;
    } while (lVar3 != (ulonglong)(cnt - 1) + 1);
    iVar6 = cnt;
    if (0xf < cnt) goto LAB_00100b74;
  }
  do {
    cnt = iVar6 + 1;
    buff[(int)(iVar6 + sVar2)] = ' ';
    iVar6 = cnt;
  } while (cnt < 0x10);
LAB_00100b74:
  ...
  if (iVar1 == 0) {
    ...
    if (__stream == (FILE *)0x0) {
      ...
      if (st.st_size != 0) {
        ...
        } while (offset < (ulonglong)st.st_size);
      }
      fclose(__stream);
      iVar1 = 0;
    }
...

{
  ...
  if (argc < 2) {
    ...
    do {
      ...
      iVar3 = iVar3 + iVar1;
      ppcVar2 = ppcVar2;
    } while (ppcVar2 != argv + (ulonglong)(argc - 2) + 2);
  }
  return iVar3;
}
