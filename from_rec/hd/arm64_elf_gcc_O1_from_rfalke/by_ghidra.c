...
// WARNING: Removing unreachable block (ram,0x0010095c)
...
// WARNING: Removing unreachable block (ram,0x0010098c)
...
// WARNING: Removing unreachable block (ram,0x00100a14)
...
LAB_00100abc:
    do {
      sVar2 = strlen(buff);
      *(undefined4 *)(buff + sVar2) = 0x202020;
      bVar1 = iVar6 < 0x10;
      iVar6 = iVar6 + 1;
    } while (bVar1);
    sVar2 = strlen(buff);
    len = (int)sVar2;
    lVar5 = (long)len;
    *(undefined4 *)(buff + lVar5) = 0x7c2020;
    if (0 < cnt) goto LAB_00100b10;
    iVar6 = 0;
  }
  else {
    iVar6 = 0;
    pbVar7 = p;
    do {
      sprintf(buff + (long)iVar6 + 9," %02lX",(ulong)*pbVar7);
      iVar6 = iVar6 + 3;
      pbVar7 = pbVar7 + 1;
    } while (iVar6 != cnt * 3);
    iVar6 = cnt + 1;
    if (cnt < 0x10) goto LAB_00100abc;
    sVar2 = strlen(buff);
    len = (int)sVar2;
    lVar5 = (long)len;
    *(undefined4 *)(buff + lVar5) = 0x7c2020;
LAB_00100b10:
    ...
    do {
      ...
      buff[(int)lVar3 + len] = uVar4;
      lVar3 = lVar3 + 1;
    } while (lVar3 != (ulong)(cnt - 1) + 1);
    iVar6 = cnt;
    if (0xf < cnt) goto LAB_00100b74;
  }
  do {
    cnt = iVar6 + 1;
    buff[iVar6 + len] = ' ';
...
LAB_00100b74:
  *(undefined2 *)(buff + lVar5 + cnt) = 0x7c;
  puts(buff);
  return;
}
    ...
    if (__stream == (FILE *)0x0) {
      ...
      if (st.st_size != 0) {
        do {
          ...
          offset = offset + (long)cnt;
        } while (offset < (ulong)st.st_size);
      }
      fclose(__stream);
      iVar1 = 0;
    }
...

{
  ...
  if (argc < 2) {
    ...
    do {
      ppcVar3 = ppcVar2 + 1;
      iVar1 = hexdump(*ppcVar2);
      iVar4 = iVar4 + iVar1;
      ppcVar2 = ppcVar3;
    } while (ppcVar3 != argv + (ulong)(argc - 2) + 2);
  }
  return iVar4;
}
