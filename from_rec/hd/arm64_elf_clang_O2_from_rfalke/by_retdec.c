...
// From module:   /mnt/from_rec/./hd/source.c
// Address range: 0x4009e0 - 0x400a9c
// Line range:    27 - 36
int32_t hexdump(char * fname) {
    // 0x4009e0
    int64_t v1; // 0x4009e0
    uint64_t v2 = v1;
    int64_t v3; // bp-184, 0x4009e0
    ...
    struct _IO_FILE * file = fopen(fname, "rb"); // 0x400a18
    if (file == NULL) {
        // 0x400a8c
        perror(fname);
        // 0x400a78
    ...
    int64_t v4 = 0; // 0x400a60
    int64_t data; // bp-56, 0x4009e0
    int32_t items_read = fread(&data, 1, 16, file); // 0x400a40
    while (items_read != 0) {
        // 0x400a4c
...
// From module:   /mnt/from_rec/./hd/source.c
// Address range: 0x400a9c - 0x400af0
// Line range:    56 - 64
int main(int argc, char ** argv) {
    ...
    int32_t result = 0; // 0x400abc
    int64_t v1 = (int64_t)argv; // 0x400abc
    v1 += 8;
    result += hexdump((char *)*(int64_t *)v1);
    int64_t v2 = (int64_t)(argc - 1) + 0xffffffff; // 0x400acc
    int64_t v3 = v2 & 0xffffffff; // 0x400ad0
    while ((int32_t)v2 != 0) {
        // 0x400ac0
        v1 += 8;
        result += hexdump((char *)*(int64_t *)v1);
