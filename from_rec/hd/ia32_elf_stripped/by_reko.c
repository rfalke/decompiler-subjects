...
void fn080485A0(int32 dwArg00)
{
	__align(fp + 4);
	__syscall(0x80);
	g_ptr80499E8 = fp + 4 + dwArg00 * 0x04 + 0x04;
...
// 08048660: void fn08048660(Stack Eq_69 dwArg04, Stack Eq_70 dwArg0C)
// Called from:
//      fn080487F0
void fn08048660(Eq_69 dwArg04, Eq_70 dwArg0C)
{
...
word32 fn080488E0(int32 dwArg04, char * dwArg08[])
{
	...
	for (dwLoc08_46 = 0x01; dwArg04 > dwLoc08_46; ++dwLoc08_46)
		dwLoc0C_45 += fn080487F0(dwArg08[dwLoc08_46]);
	return dwLoc0C_45;
}
