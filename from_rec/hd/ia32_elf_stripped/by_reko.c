...
// 08048660: void fn08048660(Stack Eq_89 dwArg04, Stack up32 dwArg08, Stack Eq_91 dwArg0C)
void fn08048660(Eq_89 dwArg04, up32 dwArg08, Eq_91 dwArg0C)
{
	...
	else
	{
		...
		else
		{
			...
			while (dwLoc48 > dwLoc18_122)
			{
				...
				if (eax_105 == 0x00)
					break;
				fn08048660(fp - 0x14, dwLoc18_122, eax_105);
...
word32 fn080488E0(int32 dwArg04, char * dwArg08[])
{
	...
	for (dwLoc08_15 = 0x01; dwArg04 > dwLoc08_15; ++dwLoc08_15)
		dwLoc0C_14 += fn080487F0(dwArg08[dwLoc08_15]);
	return dwLoc0C_14;
}
