...
int sub_8048660(int param0, int param1, int param2) {
    char v0;
    char v1;
...
int sub_80488E0(int param0, int param1) {
    int result = 0;
...
int sub_80488FE() {
    int* ptr0;
    do {
        int v0 = sub_80487F0(*(int*)(*(ptr0 - 1) * 4 + *(ptr0 + 3)));
        *(ptr0 - 2) = *(ptr0 - 2) + v0;
        *(ptr0 - 1) = *(ptr0 - 1) + 1;
    }
    while(*(ptr0 + 2) <= *(ptr0 - 1));
