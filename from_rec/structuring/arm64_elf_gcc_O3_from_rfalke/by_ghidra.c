...

{
  ...
  do {
    lVar1 = lVar2 + 1;
    *(ulong *)(arr + lVar2 * 4 + 2) = CONCAT44(iVar6,iVar5);
    *(ulong *)(arr + lVar2 * 4) = CONCAT44(iVar4,iVar3);
    iVar3 = iVar3 + 4;
    iVar4 = iVar4 + 4;
    iVar5 = iVar5 + 4;
    iVar6 = iVar6 + 4;
    lVar2 = lVar1;
  } while ((uint)lVar1 < 0x19);
  i = 100;
  return;
}
...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x00100a3c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x100a3c);
