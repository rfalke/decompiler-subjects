...

{
  ...
  bVar1 = false;
  i = 0;
  for (lVar2 = 0; (int)lVar2 != 100; lVar2 = lVar2 + 1) {
    arr[lVar2] = (int)lVar2;
    bVar1 = true;
  }
  if (bVar1) {
...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x0010094c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x10094c);
