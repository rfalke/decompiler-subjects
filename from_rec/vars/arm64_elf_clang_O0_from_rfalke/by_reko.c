...
struct Eq_91 * g_ptr411048 = null; // 0000000000411048
...
// 0000000000400590: void func(Register (ptr64 Eq_91) x0)
// Called from:
//      main
void func(struct Eq_91 * x0)
{
	x0->dw0000 = 0x01;
	x0->b0010 = 0x6B;
	x0->qw0018 = 0x0A;
...
// 00000000004005C4: void func2()
// Called from:
//      main
void func2()
{
	g_dw411040 = 0x01;
	g_ptr411048 = (struct Eq_91 *) &g_dw411040;
	g_b411050 = 0x6B;
	g_qw411058 = 0x0A;
	g_ptr411048->dw0000 = 0x02;
	*g_ptr411048->ptr0008 = 0x03;
}

// 0000000000400608: void main()
void main()
{
	func(&g_dw411040);
	func2();
