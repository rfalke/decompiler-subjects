...
// 00000001000010A0: void _cpa(Register (ptr64 Eq_374) rax, Register (ptr64 real32) rcx, Register byte dl, Register byte bl, Register (ptr64 Eq_363) rdi, Register (ptr64 byte) r8, Register (ptr8 real64) Top)
void _cpa(union Eq_374 * rax, real32 * rcx, byte dl, byte bl, struct Eq_363 * rdi, byte * r8, real64 * Top)
{
	ui32 eax_5 = (word32) rax;
	Eq_368 al_9 = (byte) rax;
	byte r8b_25 = (byte) r8;
	*rax = (union Eq_374 *) (*rax - eax_5 - C);
	...
	*rax = (union Eq_374 *) ((char *) *rax + eax_5);
	...
	*rax = (union Eq_374 *) (byte) v44_v43_95;
	*rax = (union Eq_374 *) SLICE(v44_v43_95, word32, 8);
...
// 00000001000010F0: void _d(Register (ptr64 Eq_374) rax, Register byte dl)
// Called from:
//      _cpa
void _d(union Eq_374 * rax, byte dl)
{
	byte al_17 = (byte) rax;
	*rax = (union Eq_374 *) ((char *) *rax + al_17);
	_en(rax, dl);
}

// 00000001000010F8: void _en(Register (ptr64 Eq_374) rax, Register byte dl)
// Called from:
//      _d
void _en(union Eq_374 * rax, byte dl)
{
	byte al_5 = (byte) rax;
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	_f(rax, dl);
}

// 00000001000010FC: void _f(Register (ptr64 Eq_374) rax, Register byte dl)
// Called from:
//      _en
void _f(union Eq_374 * rax, byte dl)
{
	byte al_5 = (byte) rax;
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
...
// 0000000100001100: void _gs1(Register (ptr64 Eq_374) rax, Register byte dl)
// Called from:
//      _f
void _gs1(union Eq_374 * rax, byte dl)
{
	byte al_5 = (byte) rax;
	Eq_690 eax_10 = (word32) rax;
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	Mem12[rax + 0x00:word32] = Mem9[rax + 0x00:word32] + eax_10;
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	*rax = (union Eq_374 *) ((char *) *rax + dl);
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
	*rax = (union Eq_374 *) ((char *) *rax + al_5);
...
// 0000000100001124: void _si(Register word32 eax, Register byte bl, Register (ptr64 Eq_809) rdi)
void _si(word32 eax, byte bl, struct Eq_809 * rdi)
{
	byte * rax_5 = (uint64) (eax + 0x05000000);
	fn0000000100001129(rax_5, bl, rdi);
}

// 0000000100001128: void _sl(Register word32 eax, Register byte bl, Register (ptr64 Eq_809) rdi)
void _sl(word32 eax, byte bl, struct Eq_809 * rdi)
{
	byte * rax_5 = (uint64) eax;
	fn0000000100001129(rax_5, bl, rdi);
}

// 0000000100001129: void fn0000000100001129(Register (ptr64 byte) rax, Register byte bl, Register (ptr64 Eq_809) rdi)
// Called from:
//      _si
//      _sl
void fn0000000100001129(byte * rax, byte bl, struct Eq_809 * rdi)
{
	byte al_10 = (byte) rax;
	*rax += al_10;
	*rax += al_10;
...
// 0000000100001048: void _NXArgc(Register (ptr64 Eq_80) rax)
// Called from:
//      _pvars
void _NXArgc(struct Eq_80 * rax)
{
	byte al_5 = (byte) rax;
	rax->b0000 += al_5;
	rax->b0000 += al_5;
...
// 0000000100001050: void _NXArgv(Register (ptr64 Eq_80) rax)
// Called from:
//      _NXArgc
void _NXArgv(struct Eq_80 * rax)
{
	byte al_5 = (byte) rax;
	rax->b0000 += al_5;
	rax->b0000 += al_5;
...
// 0000000100001058: void _environ(Register (ptr64 Eq_80) rax)
// Called from:
//      _NXArgv
void _environ(struct Eq_80 * rax)
{
	byte al_5 = (byte) rax;
	rax->b0000 += al_5;
	rax->b0000 += al_5;
...
// 0000000100001060: void ___progname(Register (ptr64 Eq_80) rax)
// Called from:
//      _environ
void ___progname(struct Eq_80 * rax)
{
	byte al_5 = (byte) rax;
	rax->b0000 += al_5;
	rax->b0000 += al_5;
...
// 0000000100001020: void _pvars(Register (ptr64 Eq_77) rax, Register (ptr64 byte) rcx, Register byte dl, Stack (ptr64 Eq_80) qwArg00)
void _pvars(struct Eq_77 * rax, byte * rcx, byte dl, struct Eq_80 * qwArg00)
{
	uint8 al_5 = (byte) rax;
	Eq_83 eax_10 = (word32) rax;
	rax->b0000 += al_5;
	rax->b0000 += al_5;
...
// 0000000100000E88: void _func(Register (ptr64 Eq_41) rdi)
// Called from:
//      _main
