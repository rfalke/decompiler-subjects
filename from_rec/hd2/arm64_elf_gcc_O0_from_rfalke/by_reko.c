...
word32 dumpline(ptr64 x0, int32 w2, word32 dwArg00, word32 dwArg04, Eq_211 * & x29Out, word64 * & spOut)
{
	...
	while (true)
	{
		...
		if (dwArg04_186 > 0x0F)
			break;
		fn0000000000000820();
		Mem163[fp + ~0x4F + (fp + ~0x4F):word32] = Mem0[0x0000000000000E40 + 0x00:word32];
	}
	fn0000000000000820();
	...
	for (dwArg04_106 = 0x00; dwArg04_106 < dwLoc6C_14; ++dwArg04_106)
	{
		...
		if ((word32) (x0 + (word64) dwLoc42) > 0x1F && (word32) (x0 + (word64) dwLoc42) <= 0x7E)
			w0_128 = (word32) (x0 + (word64) dwLoc42);
		else
			w0_128 = 0x2E;
...
// 0000000000000C34: Register word32 hexdump(Register word64 x0, Stack word64 qwArg00, Register out (ptr64 Eq_337) x29Out, Register out ptr64 spOut)
word32 hexdump(word64 x0, word64 qwArg00, Eq_337 * & x29Out, ptr64 & spOut)
{
	word32 w0_28;
	__stat();
	word64 * sp_30 = fp + -200;
	struct Eq_347 * x29_66 = fp + -200;
	if (0x00 != 0x00)
	{
		fn0000000000000830();
		w0_28 = 0x01;
...
// 0000000000000D18: void main(Stack word32 dwArg00, Stack word32 dwArg04)
void main(word32 dwArg00, word32 dwArg04)
{
	struct Eq_425 * x29_19 = fp + -0x0028;
...
// 0000000000000D88: void __libc_csu_init(Register word64 x30, Stack word64 qwArg00)
...
// 0000000000000E08: Register word32 __stat()
word32 __stat()
{
...
// 0000000000000E18: void _fini(Stack word64 qwArg00)
