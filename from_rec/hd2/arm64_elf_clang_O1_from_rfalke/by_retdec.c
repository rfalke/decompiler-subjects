...
// Address range: 0x400870 - 0x4009f8
// Line range:    5 - 27
void dumpline(char * p, int64_t offset, int32_t cnt) {
  ...
  lab_0x400914:;
    ...
    *(int32_t *)((int64_t)len + v2) = 0x202020;
    ...
    goto lab_0x40092c;
  lab_0x40092c:;
    int64_t len2 = strlen((char *)&str); // 0x400934
    int64_t v10 = len2 + v2;
    *(int32_t *)v10 = 0x7c2020;
    int64_t v11 = (0x100000000 * len2 + 0x300000000) / 0x100000000 + v2;
    int64_t v12 = 0; // 0x40094c
    if (v4 >= 1) {
        int64_t v13 = v4;
        int64_t v14 = 0; // 0x400960
        unsigned char v15 = *(char *)(v14 + v1); // 0x400964
        *(char *)(v14 + v11) = (int32_t)v15 < 127 ? v15 : 46;
        v14++;
        while (v14 != v13) {
            // 0x400964
            v15 = *(char *)(v14 + v1);
        ...
        if (v4 >= 16) {
            // 0x4009c0
            *(int16_t *)(v10 + 3 + (v13 & 0xffffffff)) = 124;
            puts((char *)&str);
            return;
        }
    }
    int64_t v16 = v12;
    memset((int64_t *)(v16 + v11), 32, 16 - (int32_t)v16);
    // 0x4009c0
    *(int16_t *)(19 + v10) = 124;
    puts((char *)&str);
}
...
// From module:   /mnt/from_rec/./hd2/source.c
// Address range: 0x4009f8 - 0x400aac
// Line range:    29 - 38
int32_t hexdump(char * fname) {
    // 0x4009f8
    int64_t v1; // 0x4009f8
    ...
    struct _IO_FILE * file = fopen(fname, "rb"); // 0x400a28
    if (file == NULL) {
        // 0x400a9c
        perror(fname);
        // 0x400a88
    ...
    int64_t v3 = 0; // 0x400a70
    int64_t data; // bp-56, 0x4009f8
    int32_t items_read = fread(&data, 1, 16, file); // 0x400a50
    while (items_read != 0) {
        // 0x400a5c
...
// From module:   /mnt/from_rec/./hd2/source.c
// Address range: 0x400aac - 0x400b00
// Line range:    58 - 66
int main(int argc, char ** argv) {
    ...
    int64_t v1 = (int64_t)argv; // 0x400acc
    v1 += 8;
    result += hexdump((char *)*(int64_t *)v1);
    int64_t v2 = (int64_t)(argc - 1) + 0xffffffff; // 0x400adc
    int64_t v3 = v2 & 0xffffffff; // 0x400ae0
    while ((int32_t)v2 != 0) {
        // 0x400ad0
        v1 += 8;
        result += hexdump((char *)*(int64_t *)v1);
