...
LAB_00400914:
    iVar4 = 0x10 - iVar4;
    do {
      sVar2 = strlen(auStack176);
      iVar4 = iVar4 + -1;
      *(undefined4 *)(auStack176 + sVar2) = 0x202020;
    } while (iVar4 != 0);
  }
  else {
    lVar5 = 0;
  ...
  sVar2 = strlen(auStack176);
  *(undefined4 *)(auStack176 + (longlong)(int)sVar2) = 0x7c2020;
  if (iVar1 < 1) {
    iVar4 = 0;
  }
  else {
    ...
    do {
      ...
      auStack176[lVar5 + (int)(sVar2 + 3)] = bVar3;
      lVar5 = lVar5 + 1;
      iVar4 = (int)lVar5;
    } while (lVar5 < iVar1);
    if (0xf < iVar4) goto LAB_004009c0;
  }
  memset(auStack176 +
         ((longlong)(((ulonglong)sVar2 << 0x20) + 0x300000000) >> 0x20) + (longlong)iVar4,0x20,
         0x10 - iVar4);
  iVar4 = 0x10;
LAB_004009c0:
  *(undefined2 *)(auStack176 + (longlong)iVar4 + (longlong)(int)sVar2 + 3) = 0x7c;
  puts(auStack176);
  return;
}
