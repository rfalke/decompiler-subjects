...

{
  ...
  long lVar5;
  char buff [80];
  undefined auStack176 [9];
  char acStack167 [71];
  
  sprintf(auStack176,"%08lX:",offset);
  iVar1 = 0x10;
  if (cnt < 0x11) {
    iVar1 = cnt;
  }
...
LAB_00400914:
    ...
    do {
      sVar3 = strlen(auStack176);
      iVar2 = iVar2 + -1;
      *(undefined4 *)(auStack176 + sVar3) = 0x202020;
    } while (iVar2 != 0);
  }
  else {
    lVar5 = 0;
  ...
  sVar3 = strlen(auStack176);
  iVar2 = (int)sVar3;
  *(undefined4 *)(auStack176 + iVar2) = 0x7c2020;
  if (iVar1 < 1) {
    lVar5 = 0;
  }
  else {
    ...
    do {
      ...
      auStack176[lVar5 + (iVar2 + 3)] = bVar4;
      lVar5 = lVar5 + 1;
    } while (lVar5 < iVar1);
    if (0xf < (int)lVar5) goto LAB_004009c0;
  }
  memset(auStack176 + ((long)((sVar3 << 0x20) + 0x300000000) >> 0x20) + (long)(int)lVar5,0x20,
         (ulong)(0xf - (int)lVar5) + 1);
  lVar5 = 0x10;
LAB_004009c0:
  *(undefined2 *)(auStack176 + (long)(int)lVar5 + (long)iVar2 + 3) = 0x7c;
  puts(auStack176);
  return;
}
