...
struct s1* fun_4017a0(struct s2* a1, uint32_t a2) {
    ...
    ecx3 = reinterpret_cast<struct s3*>(a1->f60 + reinterpret_cast<int32_t>(a1));
    eax4 = ecx3->f20;
    esi5 = ecx3->f6;
    edx6 = 0;
...
int32_t fun_401760(struct s0* a1) {
    ...
    if (a1->f0 != 0x5a4d || (eax2 = reinterpret_cast<struct s6*>(a1->f60 + reinterpret_cast<int32_t>(a1)), eax2->f0 != 0x4550)) {
        return 0;
    } else {
        edx3 = 0;
...
void fun_4013cf(int32_t ecx) {
    ...
    *reinterpret_cast<int32_t*>(ebp11 - 4) = -2;
    ...
    esp12->f0 = 0x40140a;
    fun_401901(ecx, esp12->f4, esp12->f8, esp12->f12, esp12->f16);
    goto esp12->f4;
}
