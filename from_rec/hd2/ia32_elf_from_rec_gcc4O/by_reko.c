...
// 08048600: void dumpline(Register (ptr32 Eq_74) gs, Stack ptr32 dwArg04, Stack up32 dwArg08, Stack Eq_77 dwArg0C)
// Called from:
//      hexdump
void dumpline(struct Eq_74 * gs, ptr32 dwArg04, up32 dwArg08, Eq_77 dwArg0C)
{
	word32 eax_20 = gs->dw0014;
	__sprintf_chk(fp - 0x70, 0x01, 0x50, "%08lX:", 0x00);
	Eq_77 esi_31 = dwArg0C;
	if (dwArg0C > 0x10)
		esi_31.u0 = 0x10;
	int32 dwLoc80_265;
	Eq_77 esi_169;
...
l08048707:
			...
			{
l08048747:
				(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(fp - 0x70)[((word32) esi_169 + dwLoc80_265) / 2].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0] = (Eq_203) 0x7C;
				__printf_chk(0x01, "%s\n", 0x00);
...
// 080487AF: Register word32 hexdump(Register (ptr32 Eq_74) gs, Stack (ptr32 char) dwArg04)
// Called from:
//      main
word32 hexdump(struct Eq_74 * gs, char * dwArg04)
{
	...
	else
	{
		...
		if (eax_33 != null)
		{
			...
			{
				Eq_77 eax_53 = fread(fp - 0x30, 0x01, 0x10, eax_33);
				if (eax_53 == 0x00)
					break;
...
// 080488A0: void main(Register (ptr32 Eq_74) gs, Stack int32 dwArg04, Stack (arr (ptr32 char)) dwArg08)
