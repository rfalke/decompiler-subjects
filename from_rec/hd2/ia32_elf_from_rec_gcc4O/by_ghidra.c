...

{
  ...
  byte bVar7;
  int local_80;
  undefined4 auStack113 [2];
  undefined local_67 [71];
  int local_20;
  
  bVar7 = 0;
  local_20 = *(int *)(in_GS_OFFSET + 0x14);
  __sprintf_chk((int)auStack113 + 1,1,0x50,"%08lX:",param_2);
  if (0x10 < param_3) {
    param_3 = 0x10;
  }
  iVar6 = 1;
...
LAB_080486ac:
    do {
      __strcat_chk((int)auStack113 + 1,&DAT_080489ae,0x50);
      bVar1 = iVar6 < 0x10;
      iVar6 = iVar6 + 1;
    } while (bVar1);
    uVar3 = 0xffffffff;
    pcVar4 = (char *)((int)auStack113 + 1);
    do {
      if (uVar3 == 0) break;
      uVar3 = uVar3 - 1;
      cVar2 = *pcVar4;
    ...
    *(undefined4 *)((int)auStack113 + ~uVar3) = 0x7c2020;
    local_80 = ~uVar3 + 2;
    ...
    iVar6 = 0;
    do {
      __sprintf_chk(puVar5,1,0xffffffff," %02lX",(uint)*(byte *)(param_1 + iVar6));
      iVar6 = iVar6 + 1;
      puVar5 = puVar5 + 3;
    } while (iVar6 < param_3);
    if (param_3 < 0x10) {
    ...
    *(undefined4 *)((int)auStack113 + ~uVar3) = 0x7c2020;
    local_80 = ~uVar3 + 2;
LAB_08048707:
    pcVar4 = (char *)((int)auStack113 + local_80 + 1);
    iVar6 = 0;
    do {
  ...
  puVar5 = (undefined *)((int)auStack113 + local_80 + param_3 + 1);
  do {
    *puVar5 = 0x20;
    param_3 = param_3 + 1;
    puVar5 = puVar5 + 1;
...
LAB_08048747:
  *(undefined2 *)((int)auStack113 + 1 + param_3 + local_80) = 0x7c;
  __printf_chk(1,&DAT_080489b2,(int)auStack113 + 1);
