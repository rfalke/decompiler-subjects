...

{
  ...
  strcpy((char *)(auStack116 + (int)sVar3),"  |");
  iVar1 = (int)sVar3 + 3;
  local_78 = 0;
  while (local_78 < local_24) {
    if ((local_18[local_78] < 0x20) || (0x7e < local_18[local_78])) {
      ...
      uVar2 = local_18[local_78];
    }
    auStack116[iVar1 + local_78] = uVar2;
    local_78 = local_78 + 1;
  }
  while (local_78 < 0x10) {
    auStack116[iVar1 + local_78] = ' ';
    local_78 = local_78 + 1;
  }
  strcpy((char *)(auStack116 + (long)local_78 + (long)iVar1),"|");
  printf("%s\n",auStack116);
  return;
}
...
// WARNING: Heritage AFTER dead removal. Example location: s0xffffffffffffffe0 : 0x00400b68
...

{
  ...
  if (iVar1 == 0) {
    ...
    if ((FILE *)sStack192.__unused[1] == (FILE *)0x0) {
      ...
      sStack192.__unused[2] = 0;
      while ((ulong)sStack192.__unused[2] < (ulong)sStack192.st_size) {
