...

{
  ...
  strcpy((char *)(auStack_74 + (int)sVar3),"  |");
  iVar1 = (int)sVar3 + 3;
  for (local_78 = 0; local_78 < local_24; local_78 = local_78 + 1) {
    if ((puStack_18[local_78] < 0x20) || (0x7e < puStack_18[local_78])) {
      ...
      uVar2 = puStack_18[local_78];
    }
    auStack_74[iVar1 + local_78] = uVar2;
  }
  while (local_78 < 0x10) {
    auStack_74[iVar1 + local_78] = ' ';
    local_78 = local_78 + 1;
  }
  strcpy((char *)(auStack_74 + (long)local_78 + (long)iVar1),"|");
  printf("%s\n",auStack_74);
  return;
}
