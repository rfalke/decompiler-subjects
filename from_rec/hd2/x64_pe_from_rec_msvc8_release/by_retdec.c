...
int64_t function_140001000(int64_t * a1, int64_t a2, int64_t a3) {
    ...
    int64_t v9 = v8 / 0x100000000; // 0x140001059
    ...
    if ((int32_t)v7 < 1) {
        ...
        int64_t v13 = v3 + 41; // 0x14000107f
        int64_t v14 = 0; // 0x140001066
        int64_t v15 = 0; // 0x140001066
        unsigned char v16 = *(char *)(v14 + v1); // 0x140001070
        sprintf((char *)(v13 + 0x100000000 * v15 / 0x100000000), " %02lX", (int32_t)v16);
        v14++;
  ...
  lab_0x14000109a:;
    ...
    int64_t v18 = v4;
    int64_t v19 = -1;
    int64_t v20 = v18; // 0x1400010bb
    int64_t v21; // 0x140001000
    int64_t v22; // 0x1400010bb
    while (v19 != 0) {
        v22 = v18 + v17;
        v21 = v19 - 1;
        v20 = v22;
    ...
    int64_t v23 = (16 - v10 & 0xffffffff) - 1; // 0x1400010bd
    *(int32_t *)(v20 - 1) = 0x202020;
    int64_t v24 = v23; // 0x1400010c4
    v11 = v17;
    while (v23 != 0) {
        // 0x1400010b0
        v18 = v4;
    ...
    goto lab_0x1400010c6;
  lab_0x1400010c6:;
    int64_t v25 = -1; // 0x1400010d1
    int64_t v26 = v4; // 0x1400010d1
    int64_t v27 = 0; // 0x1400010d1
    while (v25 != 0) {
        int64_t v28 = v26;
        int64_t v29 = v25 - 1; // 0x1400010d1
        v25 = v29;
        v26 = v28 + v11;
        v27 = v29;
        if (*(char *)v28 == 0) {
    ...
    int64_t v30 = -0x200000000 - 0x100000000 * v27;
    int64_t v31 = v3 + 32; // 0x1400010df
    *(int32_t *)(v30 / 0x100000000 + v31) = 0x7c2020;
    int64_t v32 = (v30 + 0x300000000) / 0x100000000 + v31;
    int64_t v33 = 0; // 0x1400010f0
    int64_t v34 = 0; // 0x1400010f0
    int64_t v35 = 0; // 0x1400010f0
    if (v8 >= 0x100000000) {
        char v36 = *(char *)(v33 + v1); // 0x140001100
        *(char *)(v33 + v32) = v36 < 127 ? v36 : 46;
        int64_t v37 = v33 + 1; // 0x140001119
        v33 = v37;
        while (v37 < v9) {
            // 0x140001100
            v36 = *(char *)(v33 + v1);
    ...
    memset((int64_t *)(v38 + v32), (int32_t)v38 & -256 | 32, (int32_t)v39);
    // 0x140001142
    *(int16_t *)(0x100000000 * (v35 + v39) / 0x100000000 + v32) = 124;
    printf("%s\n", &str);
    __security_check_cookie(g5);
    return &g29;
}
...
int64_t function_140001ab4(int64_t a1, int64_t a2, int64_t a3) {
    ...
    int64_t v3 = *(int64_t *)(v1 + (0x100000000 * a3 / 0x100000000 & -8)); // 0x140001ae6
    uint32_t v4 = *(int32_t *)(*(int64_t *)(a2 + 16) + 8); // 0x140001aee
    char v5 = *(char *)((int64_t)v4 + 3 + *(int64_t *)(a2 + 8)); // 0x140001af5
    int64_t v6 = a1; // 0x140001af9
    if ((v5 & 15) != 0) {
        // 0x140001afb
        v6 = (int64_t)(v5 & -16) + a1;
    }
    // 0x140001b07
    __security_check_cookie(v6 ^ v3);
    return &g29;
}
