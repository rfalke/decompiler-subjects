...
l0000000000000B10:
	...
	{
l0000000000000B74:
		Mem190[fp + ~0x47 + (w19_125 + w8_120):word16] = SLICE(CONVERT(Mem187[0x0000000000000DD8<p64>:word16], word16, word32), word16, 0);
		fn00000000000008B0();
		return x30;
	}
l0000000000000B54:
...
void main(int32 w0, word64 x1)
{
	if (w0 > 0x01)
	{
		...
		do
		{
			ui64 x21_41;
			word64 x20_141;
			hexdump(*x19_23, out x19_23, out x20_141, out x21_41);
