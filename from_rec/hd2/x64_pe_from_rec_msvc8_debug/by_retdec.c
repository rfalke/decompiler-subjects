...
int64_t function_140002860(int64_t a1);
...
int64_t function_1400031d0(int64_t a1);
...
int64_t function_1400020b0(int64_t a1, int64_t a2, int64_t a3, int64_t a4) {
    ...
    if ((int32_t)function_140002000(0x1002, 0) != 0) {
        int32_t v6 = *(int32_t *)(0x100000000 * a3 / 0x40000000 + (int64_t)&g3); // 0x140002181
...
int64_t function_140002df0(int64_t a1, int64_t * a2, int64_t a3, int64_t * a4, int64_t * a5, int32_t a6) {
    ...
    *(int16_t *)a2 = 0;
    ...
    int64_t v5 = v2; // 0x140002eae
    int64_t v6 = 0; // 0x140002eae
    if (v3 != 0) {
        uint32_t v7 = (int32_t)(lpAddress - hModule); // 0x140002eba
        v4 = v3;
        int64_t v8 = 0;
    ...
    int64_t hModule3 = function_1400031d0(v5); // 0x140002ee8
    g9 = hModule3;
    if (hModule3 == 0) {
        // 0x140002e2b
        return 0;
