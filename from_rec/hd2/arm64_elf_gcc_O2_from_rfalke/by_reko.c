...
void main(int32 w0, word64 (* x1)[], ptr64 x4)
{
	if (w0 > 0x01)
	{
		...
		do
		{
			word64 x20_50;
			ui64 x21_51;
			hexdump(x22_28[x19_32], x4, out x4, out x19_32, out x20_50, out x21_51, out x22_28);
...
ptr64 dumpline(ptr64 x0, int32 w2, ptr64 x4, ptr64 & x29Out)
{
	...
	if (w19_108 > 0x00)
	{
		...
		if (w19_108 == 0x10)
		{
			...
			Mem80[fp + ~0x47 + (int64) ((int32) w0_75):word32] = Mem37[0x0000000000000D98<p64>:word32];
			w3_103 = w0_75 + 0x03;
	...
	Mem105[fp + ~0x47 + (int64) ((int32) w0_102):word32] = Mem92[0x0000000000000D98<p64>:word32];
	w3_103 = w0_102 + 0x03;
	x4_119 = x4;
	if (w19_108 <= 0x00)
	{
		x7_107 = (int64) (int32) (w0_102 + 0x03);
		w19_108 = 0x00;
		goto l0000000000000B98;
	}
l0000000000000B54:
	word64 x4_118 = SEQ(x4_32_32, w19_108 - 0x01);
	x7_107 = (int64) (int32) w3_103;
	x4_119 = x4_118 + 0x01;
	...
	{
l0000000000000BB4:
		Mem174[fp + ~0x47 + (x7_107 + 0x10):word16] = (word16) (word32) Mem171[0x0000000000000DA0<p64>:word16];
		fn00000000000008B0();
		x29Out = x30;
		return x4_119;
	}
l0000000000000B98:
	word64 x0_152 = fp + ~0x47 + (int64) ((int32) (w19_108 + w3_103));
	do
	{
		*x0_152 = 0x20;
		++w19_108;
...
// 0000000000000C18: Register word64 hexdump(Register word64 x0, Register ptr64 x4, Register out ptr64 x4Out, Register out ptr64 x19Out, Register out ptr64 x20Out, Register out ptr64 x21Out, Register out ptr64 x22Out)
// Called from:
//      main
