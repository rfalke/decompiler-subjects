...

{
  ...
  if (argc < 2) {
    ...
    do {
      ppcVar1 = argv + lVar3;
      lVar3 = lVar3 + 1;
      iVar2 = hexdump(*ppcVar1);
      iVar4 = iVar4 + iVar2;
    } while (lVar3 != (ulong)(argc - 2) + 2);
  }
  return iVar4;
}
...
// WARNING: Removing unreachable block (ram,0x00100988)
...
// WARNING: Removing unreachable block (ram,0x001009b0)
// WARNING: Removing unreachable block (ram,0x001009bc)
...
// WARNING: Removing unreachable block (ram,0x001009ec)
...
LAB_00100b18:
    ...
    iVar7 = (int)sVar3 + 6;
    *(undefined4 *)(buff + ((int)sVar3 + 3)) = 0x7c2020;
    if (0 < cnt) goto LAB_00100b54;
    lVar8 = (long)iVar7;
    cnt = 0;
  }
  else {
    ...
    do {
      pbVar2 = p + lVar8;
      lVar8 = lVar8 + 1;
      sprintf(pcVar5," %02lX",(ulong)*pbVar2);
      pcVar5 = pcVar5 + 3;
    } while ((int)lVar8 < cnt);
    iVar7 = cnt + 1;
    if (cnt != 0x10) goto LAB_00100b18;
    sVar3 = strlen(buff);
    iVar7 = (int)sVar3 + 3;
    *(undefined4 *)(buff + (int)sVar3) = 0x7c2020;
LAB_00100b54:
    lVar8 = (long)iVar7;
    lVar4 = 0;
    do {
      ...
      buff[lVar4 + lVar8] = uVar6;
      lVar4 = lVar4 + 1;
    } while ((ulong)(cnt - 1) + 1 != lVar4);
    if (cnt == 0x10) goto LAB_00100bb4;
  }
  pcVar5 = buff + (cnt + iVar7);
  do {
    cnt = cnt + 1;
    *pcVar5 = ' ';
    pcVar5 = pcVar5 + 1;
...
LAB_00100bb4:
  *(undefined2 *)(buff + lVar8 + 0x10) = 0x7c;
  puts(buff);
  return;
}
