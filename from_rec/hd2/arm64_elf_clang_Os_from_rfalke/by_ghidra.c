  ...
  *(undefined4 *)((long)auStack_b0 + (long)iVar2) = 0x7c2020;
  if (iVar1 < 1) {
    ...
    do {
      ...
      *(byte *)((long)auStack_b0 + lVar5 + (iVar2 + 3)) = bVar4;
      lVar5 = lVar5 + 1;
    } while (lVar5 < iVar1);
    if (0xf < (int)lVar5) goto LAB_004009bc;
  }
  memset((void *)((long)auStack_b0 + (long)(int)lVar5 + (long)(iVar2 + 3)),0x20,
         (ulong)(0xf - (int)lVar5) + 1);
  lVar5 = 0x10;
LAB_004009bc:
  *(undefined2 *)((long)auStack_b0 + lVar5 + (iVar2 + 3)) = 0x7c;
