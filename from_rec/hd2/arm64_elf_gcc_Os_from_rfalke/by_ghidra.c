...

{
  ...
  lVar2 = 0;
  iVar3 = 0;
  while (lVar2 = lVar2 + 1, (int)lVar2 < argc) {
    iVar1 = hexdump(argv[lVar2]);
    iVar3 = iVar3 + iVar1;
  }
  return iVar3;
}
...
// WARNING: Removing unreachable block (ram,0x00100a6c)
// WARNING: Removing unreachable block (ram,0x00100a78)
...
// WARNING: Removing unreachable block (ram,0x00100ae8)
// WARNING: Removing unreachable block (ram,0x00100af4)
...

{
  ...
  for (; c = (int)lVar5, c < cnt; lVar5 = lVar5 + 1) {
  ...
  for (; iVar1 < 0x10; iVar1 = iVar1 + 1) {
    strcat(buff,"   ");
  }
  sVar3 = strlen(buff);
  strcpy(buff + (int)sVar3,"  |");
  iVar1 = (int)sVar3 + 3;
  for (lVar5 = 0; (int)lVar5 < cnt; lVar5 = lVar5 + 1) {
    uVar4 = p[lVar5];
    if (0x5e < (byte)(uVar4 - 0x20)) {
      uVar4 = '.';
    }
    buff[lVar5 + iVar1] = uVar4;
  }
  lVar5 = (long)iVar2;
  lVar6 = (iVar1 + iVar2) - lVar5;
  for (; (int)lVar5 < 0x10; lVar5 = lVar5 + 1) {
    buff[lVar5 + lVar6] = ' ';
  }
  strcpy(buff + (long)(int)lVar5 + (long)iVar1,"|");
  puts(buff);
  return;
}
...

{
  ...
  iVar1 = stat(fname,(stat *)&st);
  if ((iVar1 == 0) && (__stream = fopen(fname,"rb"), __stream != (FILE *)0x0)) {
    for (offset = 0; offset < (ulong)st.st_size; offset = offset + (long)cnt) {
      sVar2 = fread(buff,1,0x10,__stream);
      cnt = (int)sVar2;
      if (cnt == 0) break;
