...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_00641260 = (undefined *)&camlUnix__50;
...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_006455e0 = (undefined *)&camlPervasives__7;
  ...
  unaff_R15[7] = 0x400;
  *DAT_00645628 = (undefined *)DAT_006454f8;
...

{
  ...
  *puVar9 = uVar4;
  ...
  if (in_RAX <= (long)uVar1) {
    ...
    *(undefined8 *)(uVar7 - 0x18) = 0x800;
    *(undefined8 *)(uVar7 - 0x10) = DAT_00646cc8;
...

{
  ...
  plVar4 = (long *)FUN_00411e34();
  if (*plVar4 != DAT_00646cc8) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar1 = plVar4[1];
...

{
  ...
  if (in_RAX != 0xb9) {
    lVar5 = in_RAX >> 1;
    uVar6 = SEXT48(*(int *)(lVar5 * 4 + 0x435230));
    switch(in_RAX) {
    case 0x10:
    case 0x11:
      return &camlChar__8;
    ...
    case 0x1c:
      ...
      bVar9 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,0xffffffffffbcadcf < uVar6);
      *pcVar1 = (*pcVar1 - 1U) + (0xffffffffffbcadcf < uVar6);
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      ...
      *(int *)(&UNK_00435226 + (long)(&stack0x00000000 + uVar6)) =
           *(int *)(&UNK_00435226 + (long)(&stack0x00000000 + uVar6)) + 1;
      (**(code **)(uVar6 + 0x14))();
...
LAB_0041acc0:
    ...
    if (uVar3 == 0) goto LAB_0041acd4;
    if (uVar3 == 1) goto LAB_0041acc0;
    if (1 < (long)uVar3) goto LAB_0041acfc;
  }
  if (uVar3 != 1) {
LAB_0041acfc:
...

{
  ...
  do {
    ...
    uVar2 = SEXT48((int)(&switchD_0041b72f::switchdataD_00435450)[lVar5 >> 1]);
    switch(lVar5) {
    default:
    ...
    case 0xf7:
      ...
      *(long *)(uVar2 - 8) = lVar5;
      ...
      break;
    case 0xfc:
      *(char *)(uVar2 - 0x7d) = (*(char *)(uVar2 - 0x7d) - in_AL) - (0xffffffffffbcabaf < uVar2);
      return uVar2;
    }
  } while( true );
}
...
code_r0x0041cd7b:
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
         (*(char *)((long)piVar6 + -0x75) - cVar11) - ((int *)0xffffffffffbca933 < piVar6);
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar11;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d5b7) = (ulong)(iVar1 + 0x221e9b);
    *(undefined8 *)(piVar6 + 0x10d5b9) = 0x10f9;
    *(code **)(piVar6 + 0x10d5bb) = caml_curry2;
  case 0x1e4:
    *(undefined8 *)(piVar6 + 0x10d5bd) = 5;
    *(code **)(piVar6 + 0x10d5bf) = camlPrintf__scan_conv_171;
    *(undefined8 *)(piVar6 + 0x10d5c1) = 0x20f9;
    *(code **)(piVar6 + 0x10d5c3) = camlPrintf__scan_fmt_172;
    *(undefined8 *)(piVar6 + 0x10d5c5) = 3;
    *(code ***)(piVar6 + 0x10d5c7) = in_RAX;
    *(code ***)(piVar6 + 0x10d5c9) = unaff_RBX;
    *(code ***)(piVar6 + 0x10d5cb) = param_1;
    *(uint **)(piVar6 + 0x10d5cd) = param_4;
...
code_r0x0041c87c:
  ...
  *(int **)((long)pppcVar14 + 0x20) = piVar6;
  puVar13 = &switchD_0041c89f::switchdataD_00435734;
  piVar6 = (int *)(long)(int)(&switchD_0041c89f::switchdataD_00435734)[(long)param_1 >> 1];
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  unaff_R15[8] = 0x1800;
  *DAT_0064b5a8 = (undefined *)&camlPrintf__38;
...
LAB_004245fb:
  ...
  if (puVar1 != (ulong *)0x0) goto code_r0x00424605;
  goto LAB_0042460a;
code_r0x00424605:
  if (param_2 <= *puVar1) {
LAB_0042460a:
...
LAB_00425baa:
        ...
        while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
          iVar16 = iVar16 + 1;
          if (flp_size <= iVar16) goto LAB_00425baa;
          plVar13 = *pplVar6;
          pplVar6 = pplVar6 + 1;
      ...
      do {
        do {
          plVar12 = plVar10;
          if (plVar12 == plVar13) goto LAB_00425d2b;
...
LAB_00426d20:
  ...
  if ((uVar3 & 7) != 0) goto code_r0x00426dd4;
  goto LAB_00426df5;
code_r0x00426dd4:
  ppuVar4 = param_1;
...
LAB_0042daee:
    if (0xffffffff < lVar4) goto LAB_0042dbd7;
  }
...
LAB_0042e586:
    if (uVar12 != 0) goto code_r0x0042e58f;
        ...
        if (0 < iVar6) {
          if (*pcVar9 != '\0') {
            ...
            do {
              ...
              if ((iVar6 + -1) - iVar7 < 1) goto LAB_0043043d;
              iVar7 = iVar7 + 1;
            } while (*pcVar9 != '\0');
          }
      ...
      if (bVar1 != 0) {
        if (*pcVar9 != '\0') {
          ...
          do {
            sVar4 = strlen(pcVar9);
            pcVar9 = pcVar9 + sVar4 + 1;
            if (bVar1 - 1 == iVar6) goto LAB_00430542;
            iVar6 = iVar6 + 1;
          } while (*pcVar9 != '\0');
        }
        pcVar9 = "<unknown token>";
...
LAB_0042ffc8:
    ...
    do {
      ...
      if (((-1 < iVar7) && (sVar2 != 0)) && (iVar7 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar8 = (long)iVar7;
        lVar3 = lVar8 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar8 * 2) == 0x100) goto LAB_004305b8;
      }
      if (iVar6 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar6 != 0) {
    ...
    if (param_3 < uVar5) goto LAB_00431e1a;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_0043329c;
      }
...
LAB_0043345e:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_004334f3;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_004334f3;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_004334f3:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_0043345e;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_0043374b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_0043374b:
