...
void FUN_0804ca00(undefined4 param_1,undefined4 param_2)
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0804efd5;
    }
    else if (0x74 < uVar2) {
LAB_0804efd5:
...

{
  ...
  while (uVar1 = (uint)*(byte *)(*(int *)(unaff_EBX + 8) + (param_1 >> 1)) * 2 + 1, 0x60 < uVar1) {
    if (0x74 < uVar1) goto LAB_08058bb0;
    param_1 = param_1 + 2;
  }
  if (uVar1 == 0x49) {
    return param_1 + 2;
...
switchD_0805a9af_caseD_b2:
    ...
    case 0x1de:
    case 0x1e0:
      goto switchD_0805ac4d_caseD_40;
    case 0x1b0:
    case 0x1b2:
    case 0x1b6:
    case 0x1b8:
    ...
    case 0x1c6:
    case 0x1cc:
      goto switchD_0805ac4d_caseD_42;
    case 0x1c2:
...
LAB_080662ed:
        ...
        else if ((cStack_55 != 'u') && (cStack_55 != 'x')) goto LAB_080662ed;
      }
      sprintf(pcVar6,acStack_34);
LAB_08066302:
      ppcVar3 = (code **)caml_copy_string();
...
LAB_0806088f:
          ...
          do {
            if ((int)*param_3 >> 1 == (&DAT_08070bc4)[iVar1 * 2]) goto LAB_0806088f;
            iVar1 = iVar1 + 1;
          } while (iVar1 != 0x12);
          unix_error(0x16,"tcsetattr",0);
...
LAB_08060aa1:
      ...
      *piVar8 = 0x4b01;
      ...
      if (sVar6 == 1) {
        iVar3 = 0;
LAB_08060af4:
        *piVar8 = (&DAT_08070bc4)[iVar3 * 2] * 2 + 1;
      }
      else {
        do {
          if ((&speedtable)[iVar3 * 2] == sVar6) goto LAB_08060af4;
          iVar3 = iVar3 + 1;
        } while (iVar3 != 0x12);
      }
    }
...

{
  ...
  local_5c = 1;
  local_54 = &local_40;
  pcStack_80 = (code *)0x806b93e;
  piVar3 = __errno_location();
  pcStack_80 = (code *)0x806b948;
  pcStack_84 = strerror(*piVar3);
  if (param_1 == (void *)0x1) {
    pcStack_80 = (code *)0x806b95a;
