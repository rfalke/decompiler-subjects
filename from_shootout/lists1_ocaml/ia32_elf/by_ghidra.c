...
int * __regparm3 camlSource___seq_1051(int param_1)
...

{
  ...
  puStack_4 = caml_exception_pointer;
  caml_exception_pointer = &puStack_4;
  iVar2 = caml_c_call(*(undefined4 *)(camlSys + 4));
  caml_exception_pointer = (undefined4 **)puStack_4;
  uVar3 = camlSource__seq_1049();
  puVar4 = (undefined4 *)caml_alloc3();
  puVar1 = puVar4 + 1;
  *puVar4 = 0x400;
...
void FUN_0804cdc0(undefined4 param_1,undefined4 param_2)
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0804f395;
    }
    else if (0x74 < uVar2) {
LAB_0804f395:
...

{
  ...
  while (uVar1 = (uint)*(byte *)(*(int *)(unaff_EBX + 8) + (param_1 >> 1)) * 2 + 1, 0x60 < uVar1) {
    if (0x74 < uVar1) goto LAB_08058f70;
    param_1 = param_1 + 2;
  }
  if (uVar1 == 0x49) {
    return param_1 + 2;
...
switchD_0805ad6f_caseD_b2:
    ...
    case 0x1de:
    case 0x1e0:
      goto switchD_0805b00d_caseD_40;
    case 0x1b0:
    case 0x1b2:
    case 0x1b6:
    case 0x1b8:
    ...
    case 0x1c6:
    case 0x1cc:
      goto switchD_0805b00d_caseD_42;
    case 0x1c2:
...
LAB_080666ad:
        ...
        else if ((cStack_55 != 'u') && (cStack_55 != 'x')) goto LAB_080666ad;
      }
      sprintf(pcVar6,acStack_34);
LAB_080666c2:
      ppcVar3 = (code **)caml_copy_string();
...
LAB_08060c4f:
          ...
          do {
            if ((int)*param_3 >> 1 == (&DAT_08070f84)[iVar1 * 2]) goto LAB_08060c4f;
            iVar1 = iVar1 + 1;
          } while (iVar1 != 0x12);
          unix_error(0x16,"tcsetattr",0);
...
LAB_08060e61:
      ...
      *piVar8 = 0x4b01;
      ...
      if (sVar6 == 1) {
        iVar3 = 0;
LAB_08060eb4:
        *piVar8 = (&DAT_08070f84)[iVar3 * 2] * 2 + 1;
      }
      else {
        do {
          if ((&speedtable)[iVar3 * 2] == sVar6) goto LAB_08060eb4;
          iVar3 = iVar3 + 1;
        } while (iVar3 != 0x12);
      }
    }
...
LAB_0806367b:
        ...
        do {
          ...
          if (999 < flp_size) {
            ...
            while( true ) {
              ...
              puVar10 = puVar2;
              if ((*(uint *)(*DAT_0807fe3c + -4) >> 10 <= (uint)puVar2[-1] >> 10) &&
    ...
    piVar8 = (int *)(&DAT_0807eea4)[iVar13];
    iVar5 = 0;
    piVar9 = (&flp)[iVar13];
    do {
      do {
...
LAB_08063861:
    if (flp_size + -1 + iVar5 < 0x3e9) {
      if ((iVar5 == 1) ||
         (memmove(&flp + iVar5 + iVar13,&DAT_0807eea4 + iVar13,((flp_size + -1) - iVar13) * 4),
         0 < iVar5)) {
    ...
    if (iVar5 + iVar13 < 1000) {
      if ((iVar5 == 1) ||
         (memmove(&flp + iVar5 + iVar13,&DAT_0807eea4 + iVar13,((1000 - iVar13) - iVar5) * 4),
         0 < iVar5)) {
        memmove(&flp + iVar13,local_fbc,iVar5 << 2);
      }
    }
...

{
  ...
  if (caml_young_ptr != caml_young_end) {
    ...
    if (caml_ref_table < DAT_0807fe88) {
      do {
        caml_oldify_one(*(undefined4 *)*puVar4,(undefined4 *)*puVar4);
        puVar4 = puVar4 + 1;
      } while (puVar4 < DAT_0807fe88);
    }
    caml_oldify_mopup();
    ppuVar3 = caml_weak_ref_table;
    if (caml_weak_ref_table < DAT_0807fea4) {
      do {
        puVar1 = *ppuVar3;
        puVar2 = (uint *)*puVar1;
  ...
  *param_1 = param_2;
  if ((*(byte *)((&caml_page_table)[(uint)param_1 >> 0x17] + ((uint)param_1 >> 0xc & 0x7ff)) & 1) !=
    ...
    if (((((param_2 & 1) == 0) && (param_2 < caml_young_end)) && (caml_young_start < param_2)) &&
      ...
      if (_DAT_0807fe8c <= DAT_0807fe88) {
        caml_realloc_ref_table(&caml_ref_table);
      }
      *DAT_0807fe88 = param_1;
      DAT_0807fe88 = DAT_0807fe88 + 1;
    }
  }
  return;
}
...

{
  ...
  local_5c = 1;
  local_54 = &local_40;
  pcStack_80 = (code *)0x806bcfe;
  piVar3 = __errno_location();
  pcStack_80 = (code *)0x806bd08;
  pcStack_84 = strerror(*piVar3);
  if (param_1 == (void *)0x1) {
    pcStack_80 = (code *)0x806bd1a;
  ...
  if ((((param_3 & 1) == 0) && (param_3 < caml_young_end)) && (caml_young_start < param_3)) {
    ...
    *puVar1 = param_3;
    if ((((uVar2 & 1) != 0) || (caml_young_end <= uVar2)) || (uVar2 <= caml_young_start)) {
      if (_DAT_0807fea8 <= DAT_0807fea4) {
        caml_realloc_ref_table(&caml_weak_ref_table);
      }
      *DAT_0807fea4 = puVar1;
      DAT_0807fea4 = DAT_0807fea4 + 1;
    }
  }
  else {
