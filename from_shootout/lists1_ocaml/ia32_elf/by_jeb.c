...
int* alloc_host_entry() {
    ...
    v0 = caml_copy_string(*ptr0);
    int* ptr7 = *(int**)(ptr0 + 1);
    ptr1 = ptr7 ? caml_copy_string_array(ptr7): (int*)&gvar_8083504;
...
int* alloc_sockaddr(short* param0, int param1, int __fd) {
    ...
    switch(v4) {
        ...
        default: {
            ...
            return (int*)unix_error(97, &gvar_8071D68, 0);
        }
    }
}
...
int camlArray__bubble_1174() {
    int v0;
    int v1 = sub_8051420(v0);
    if(gvar_80776D8 == *(int*)v1) {
        return *(int*)(v1 + 4);
    }
...
int camlArray__entry(int param0, int param1) {
    ...
    gvar_8077684 = &camlArray__20;
    gvar_8077688 = gvar_8077684;
    gvar_8077698 = &camlArray__19;
    gvar_807768C = &camlArray__18;
    gvar_80776D0 = &camlArray__17;
    gvar_8077690 = &camlArray__16;
    gvar_8077694 = &camlArray__15;
    gvar_807769C = &camlArray__14;
    gvar_80776A0 = &camlArray__13;
    gvar_80776AC = &camlArray__12;
    gvar_80776B0 = &camlArray__11;
    gvar_80776B4 = &camlArray__10;
    gvar_80776B8 = &camlArray__9;
    gvar_80776A4 = &camlArray__8;
    gvar_80776D4 = &camlArray__7;
    gvar_80776A8 = &camlArray__6;
    gvar_80776BC = &camlArray__5;
    gvar_80776C0 = &camlArray__4;
    int v0 = caml_alloc1(param0, param1);
    *(int*)v0 = 0x400;
    *(int*)(v0 + 4) = "Array.Bottom";
    gvar_80776D8 = (int*)(v0 + 4);
    gvar_80776C4 = &camlArray__2;
    gvar_80776DC = 11;
    gvar_80776C8 = &camlArray__1;
    gvar_80776CC = gvar_80776C8;
    return 1;
}
    ...
    *(unsigned int*)(ptr9 + 1) = (long long*)((int)ptr11 * 3);
    ...
    while(1) {
        ...
        if(caml_young_limit <= (unsigned int)ptr12) {
            *ptr12 = 0x800;
            *(unsigned int*)(ptr12 + 1) = gvar_80776D8;
...
int camlArray__trickle_1165(int param0, int param1) {
    ...
    int v3;
    unsigned int v4;
    int v5 = sub_80512C0(param1, param0, v0, v1, v2);
    if(gvar_80776D8 == *(unsigned int*)v5) {
...
int camlBuffer__add_channel_1090(int param0, int param1) {
    ...
    int v1 = v0;
    int v2 = param0;
    if(param0 < 1 || gvar_8079670 < param0) {
        /*NO_RETURN*/ camlPervasives__invalid_arg_1012(param0, param1);
    }
...
int* camlBuffer__create_1039() {
    ...
    void* ptr2 = gvar_8079670 < (int)ptr1 ? gvar_8079670: ptr1;
    int v0 = caml_c_call();
    while(1) {
        ptr0 = (int*)(caml_young_ptr - 20);
        caml_young_ptr -= 20;
...
int camlBuffer__entry() {
    ...
    gvar_807A1A4 = &camlBuffer__19;
    gvar_807A1A8 = &camlBuffer__18;
    gvar_807A1AC = &camlBuffer__17;
    gvar_807A1B0 = &camlBuffer__16;
    gvar_807A1B4 = &camlBuffer__15;
    gvar_807A1B8 = &camlBuffer__14;
    gvar_807A1BC = &camlBuffer__13;
    gvar_807A1DC = &camlBuffer__12;
    gvar_807A1C0 = &camlBuffer__11;
    gvar_807A1C8 = &camlBuffer__10;
    gvar_807A1C4 = &camlBuffer__9;
    gvar_807A1D0 = &camlBuffer__8;
    gvar_807A1D4 = &camlBuffer__7;
    gvar_807A1D8 = &camlBuffer__6;
    gvar_807A1E0 = &camlBuffer__5;
    gvar_807A1E4 = &camlBuffer__4;
    gvar_807A1E8 = &camlBuffer__3;
    gvar_807A1EC = &camlBuffer__2;
    gvar_807A1CC = &camlBuffer__1;
    return 1;
}
...
int camlBuffer__resize_1066() {
    ...
    *(unsigned int*)(ptr0 + 1) = v1;
    ...
    if(*(ptr0 + 1) > gvar_8079670) {
        int v2 = gvar_8079670;
        int v3 = ptr1[1];
        if(v3 + v0 - 1 > v2) {
            /*NO_RETURN*/ camlPervasives__failwith_1010(v3, v2);
        }
        *(unsigned int*)(ptr0 + 1) = gvar_8079670;
    }
    int v4 = caml_c_call();
...
int camlChar__entry() {
    ...
    gvar_80790B4 = &camlChar__4;
    gvar_80790B8 = &camlChar__3;
    gvar_80790BC = &camlChar__2;
    gvar_80790C0 = &camlChar__1;
    return 1;
}
...
unsigned int* camlHashtbl__Make_1251(int param0, int param1) {
    ...
    unsigned int v2 = gvar_80797C4;
    unsigned int v3 = gvar_80797CC;
    while(1) {
    ...
    *(unsigned int*)(ptr0 + 44) = ptr0 + 1;
    unsigned int v4 = gvar_80797E4;
    unsigned int v5 = gvar_80797E8;
    unsigned int v6 = gvar_80797EC;
    *(ptr0 + 45) = 0x3000;
...
int camlHashtbl__entry() {
    gvar_80797F4 = &camlHashtbl__16;
    camlHashtbl = &camlHashtbl__15;
    gvar_80797C4 = &camlHashtbl__14;
    gvar_80797CC = &camlHashtbl__13;
    gvar_80797EC = &camlHashtbl__12;
    gvar_80797F8 = &camlHashtbl__11;
    gvar_80797C8 = &camlHashtbl__10;
    gvar_80797DC = &camlHashtbl__9;
    gvar_80797FC = &camlHashtbl__8;
    gvar_80797D0 = &camlHashtbl__7;
    gvar_80797D4 = &camlHashtbl__6;
    gvar_80797E0 = &camlHashtbl__5;
    gvar_80797D8 = &camlHashtbl__4;
    gvar_80797E4 = &camlHashtbl__3;
    gvar_80797E8 = &camlHashtbl__2;
    gvar_80797F0 = &camlHashtbl__1;
    return 1;
}
...
int camlList__entry() {
    gvar_80785DC = &camlList__38;
    camlList = &camlList__37;
    gvar_807853C = &camlList__36;
    gvar_8078540 = &camlList__35;
    gvar_8078544 = &camlList__34;
    gvar_807854C = gvar_807688C;
    gvar_8078550 = &camlList__33;
    gvar_8078548 = &camlList__32;
    gvar_8078558 = &camlList__31;
    gvar_8078554 = gvar_8078558;
    gvar_8078560 = &camlList__30;
    gvar_8078564 = &camlList__29;
    gvar_807855C = &camlList__28;
    gvar_8078568 = &camlList__27;
    gvar_807856C = &camlList__26;
    gvar_8078574 = &camlList__25;
    gvar_8078578 = &camlList__24;
    gvar_8078570 = &camlList__23;
    gvar_807857C = &camlList__22;
    gvar_8078580 = &camlList__21;
    gvar_8078584 = &camlList__20;
    gvar_8078588 = &camlList__19;
    gvar_807858C = &camlList__18;
    gvar_8078590 = &camlList__17;
    gvar_8078594 = &camlList__16;
    gvar_8078598 = &camlList__15;
    gvar_80785AC = &camlList__14;
    gvar_80785B0 = &camlList__13;
    gvar_80785B4 = &camlList__12;
    gvar_80785B8 = &camlList__11;
    gvar_80785BC = &camlList__10;
    gvar_80785C0 = &camlList__9;
    gvar_807859C = &camlList__8;
    gvar_80785A4 = &camlList__7;
    gvar_80785A0 = gvar_80785A4;
    gvar_80785A8 = &camlList__6;
    gvar_80785C4 = &camlList__5;
    gvar_80785C8 = &camlList__4;
    gvar_80785D8 = &camlList__3;
    gvar_80785E0 = &camlList__2;
    gvar_80785D0 = &camlList__1;
    gvar_80785CC = gvar_80785D0;
    gvar_80785D4 = gvar_80785D0;
    return 1;
}
...
int camlPervasives__at_exit_1322(int param0, int param1) {
    ...
    *(ptr0 + 3) = v0;
    *(ptr0 + 4) = v1;
    caml_modify(gvar_8076980, (unsigned int)(ptr0 + 1));
    return 1;
}
...
int camlPervasives__entry(int param0, int param1) {
    gvar_8076958 = &camlPervasives__84;
    gvar_8076950 = &camlPervasives__83;
    gvar_807694C = &camlPervasives__82;
    gvar_8076948 = &camlPervasives__81;
    gvar_8076944 = &camlPervasives__80;
    gvar_8076940 = &camlPervasives__79;
    gvar_807693C = &camlPervasives__78;
    gvar_8076938 = &camlPervasives__77;
    gvar_8076928 = &camlPervasives__76;
    gvar_8076918 = &camlPervasives__75;
    gvar_807690C = &camlPervasives__74;
    gvar_8076908 = &camlPervasives__73;
    gvar_8076904 = &camlPervasives__72;
    gvar_80768FC = &camlPervasives__71;
    gvar_80768F8 = &camlPervasives__70;
    gvar_80768EC = &camlPervasives__69;
    gvar_80768E4 = &camlPervasives__68;
    gvar_807683C = &camlPervasives__67;
    camlPervasives = &camlPervasives__66;
    int v0 = caml_alloc1(param0, param1);
    *(int*)v0 = 0x400;
    *(int*)(v0 + 4) = "Pervasives.Exit";
    gvar_8076840 = (int*)(v0 + 4);
    gvar_8076844 = &camlPervasives__64;
    gvar_8076848 = &camlPervasives__63;
    gvar_807684C = &camlPervasives__62;
    gvar_8076858 = &camlPervasives__61;
    gvar_8076854 = 0x80000001;
    gvar_8076850 = 0x7fffffff;
    ...
    gvar_8076870 = v6;
    gvar_8076874 = &camlPervasives__54;
    gvar_8076878 = &camlPervasives__53;
    gvar_807687C = &camlPervasives__52;
    gvar_8076880 = &camlPervasives__51;
    gvar_8076884 = &camlPervasives__50;
    gvar_807697C = &camlPervasives__49;
    gvar_8076970 = &camlPervasives__48;
    gvar_8076888 = &camlPervasives__47;
    gvar_807688C = &camlPervasives__46;
    ...
    gvar_8076898 = v9;
    gvar_80768E0 = &camlPervasives__45;
    gvar_80768D8 = &camlPervasives__44;
    gvar_80768DC = &camlPervasives__43;
    gvar_80768E8 = &camlPervasives__42;
    gvar_80768F0 = &camlPervasives__41;
    gvar_80768F4 = &camlPervasives__40;
    gvar_8076900 = &camlPervasives__39;
    gvar_8076910 = &camlPervasives__38;
    gvar_8076914 = &camlPervasives__37;
    gvar_8076924 = &camlPervasives__36;
    gvar_807691C = &camlPervasives__35;
    gvar_8076920 = &camlPervasives__34;
    gvar_8076930 = &camlPervasives__33;
    gvar_8076974 = &camlPervasives__32;
    gvar_8076934 = &camlPervasives__31;
    gvar_807692C = &camlPervasives__30;
    gvar_8076954 = &camlPervasives__29;
    gvar_807689C = &camlPervasives__28;
    gvar_80768A0 = &camlPervasives__27;
    gvar_80768A4 = &camlPervasives__26;
    gvar_80768A8 = &camlPervasives__25;
    gvar_80768AC = &camlPervasives__24;
    gvar_80768B0 = &camlPervasives__23;
    gvar_80768B4 = &camlPervasives__22;
    gvar_80768B8 = &camlPervasives__21;
    gvar_80768BC = &camlPervasives__20;
    gvar_80768C0 = &camlPervasives__19;
    gvar_80768C4 = &camlPervasives__18;
    gvar_80768C8 = &camlPervasives__17;
    gvar_80768CC = &camlPervasives__16;
    gvar_80768D0 = &camlPervasives__15;
    gvar_80768D4 = &camlPervasives__14;
    ...
    *(int*)(v10 + 24) = &camlPervasives__12;
    gvar_807695C = (int*)(v10 + 4);
    gvar_8076964 = &camlPervasives__6;
    gvar_8076960 = &camlPervasives__5;
    *(int*)(v10 + 28) = 0x400;
    *(unsigned int*)(v10 + 32) = gvar_80768E8;
    gvar_8076980 = (unsigned int*)(v10 + 32);
    gvar_807696C = &camlPervasives__4;
    gvar_8076978 = &camlPervasives__3;
    gvar_8076968 = &camlPervasives__2;
    caml_c_call();
    return 1;
}
    ...
    do {
        ...
        if(*(int*)(param0 + 128) > v0) {
            if((unsigned int)*(char*)((v0 >> 1) + *(int*)(param0 + 120)) * 2 != 74) {
                ...
                gvar_807CB20 = (int)(param0 + 64);
                gvar_807CB24 = (int)(param0 + 80);
...
int camlPrintf__entry(int param0, int param1) {
    ...
    *(unsigned int*)(v4 + 56) = (int*)(v4 + 20);
    gvar_807A850 = (unsigned int*)(v4 + 36);
    gvar_807A854 = &camlPrintf__36;
    gvar_807A858 = &camlPrintf__35;
    gvar_807A85C = &camlPrintf__34;
    gvar_807A860 = &camlPrintf__33;
    gvar_807A864 = &camlPrintf__32;
    gvar_807A868 = &camlPrintf__31;
    gvar_807A86C = &camlPrintf__30;
    gvar_807A870 = &camlPrintf__29;
    gvar_807A874 = &camlPrintf__28;
    gvar_807A878 = &camlPrintf__27;
    gvar_807A87C = &camlPrintf__26;
    gvar_807A880 = &camlPrintf__25;
    gvar_807A884 = &camlPrintf__24;
    gvar_807A888 = &camlPrintf__23;
    gvar_807A88C = &camlPrintf__22;
    gvar_807A890 = &camlPrintf__21;
    gvar_807A894 = &camlPrintf__20;
    gvar_807A898 = &camlPrintf__19;
    gvar_807A89C = &camlPrintf__18;
    gvar_807A8A0 = &camlPrintf__17;
    gvar_807A8A4 = &camlPrintf__16;
    *(int*)(v4 + 60) = 4343;
    *(int*)(v4 + 64) = &caml_curry2;
    *(int*)(v4 + 68) = 5;
    *(int*)(v4 + 72) = &camlPrintf__fun_1600;
    *(int*)(v4 + 76) = &camlPrintf__15;
    gvar_807A8A8 = (int*)(v4 + 64);
    gvar_807A8AC = &camlPrintf__14;
    gvar_807A8B0 = &camlPrintf__13;
    gvar_807A83C = &camlPrintf__12;
    gvar_807A830 = &camlPrintf__11;
    camlPrintf = &camlPrintf__10;
    gvar_807A828 = &camlPrintf__9;
    gvar_807A82C = &camlPrintf__8;
    gvar_807A844 = &camlPrintf__7;
    gvar_807A838 = &camlPrintf__6;
    gvar_807A8B4 = &camlPrintf__5;
    gvar_807A8B8 = &camlPrintf__4;
    gvar_807A8BC = &camlPrintf__3;
    gvar_807A840 = &camlPrintf__2;
    gvar_807A834 = &camlPrintf__1;
    gvar_807A848 = gvar_807A840;
    v1 = gvar_807A850;
    unsigned int v5 = gvar_807A88C;
    unsigned int v6 = gvar_807A878;
    unsigned int v7 = gvar_807A884;
    unsigned int v8 = gvar_807A8AC;
    unsigned int v9 = gvar_807A898;
    *(int*)(v4 + 80) = 0x1400;
    ...
    *(int*)(v4 + 144) = *(int*)(v4 + 112);
    gvar_807A84C = (unsigned int*)(v4 + 140);
    return 1;
}
...
int camlPrintf__kbprintf_1397(int param0, int param1) {
    ...
    *(ptr0 + 3) = v0;
    int v1 = gvar_807A1C4;
    int v2 = gvar_807A1C0;
    caml_extra_params = gvar_807A8B0;
    caml_apply6(v2, v1);
    return result;
}
...
int* camlPrintf__next_index_1262() {
    ...
    jump **(unsigned int*)(gvar_807A850 + 8);
}
...
int camlPrintf__scan_format_1278(int param0, int param1) {
    ...
    int v5 = param1;
    unsigned int v6 = caml_extra_params;
    unsigned int v7 = gvar_807CB20;
    unsigned int v8 = gvar_807CB24;
    while(1) {
...
int camlPrintf__sub_format_for_printf_1135() {
    int result;
    caml_apply3(result, gvar_807A878);
    return result;
}
...
int* camlSource___seq_1051(int* param0) {
    unsigned int v0;
    int v1;
    int* result;
    for(int i = v1; i != 1; i = v1) {
        while(1) {
            v0 = caml_young_ptr - 12;
            caml_young_ptr -= 12;
            if(caml_young_limit <= v0) {
...
int camlSource__entry() {
    ...
    gvar_8073D38 = &camlSource__13;
    gvar_8073D3C = &camlSource__12;
    int v8 = sub_804B81B(v0, v1, v2, ptr0, ptr1, v3);
    if(*(int*)v8 != &caml_exn_Invalid_argument) {
        caml_exception_pointer = v4;
        jump v7;
    }
    v2 = 3;
    int* ptr2 = camlSource__seq_1049((int*)&caml_exn_Invalid_argument);
    int v9 = caml_alloc3(v5, v6);
    ptr1 = (unsigned int*)(v9 + 4);
    *(unsigned int*)v9 = 0x400;
    *(unsigned int*)(v9 + 4) = (unsigned int)ptr2;
    ptr0 = (unsigned int*)(v9 + 12);
    *(unsigned int*)(v9 + 8) = 0x400;
    *(unsigned int*)(v9 + 12) = 1;
    camlSource__loop_1063(&camlSource__11, v6);
    v1 = camlPrintf__printf_1393(v5, v6);
    camlList__tl_1039(v5, v6);
    v0 = camlList__hd_1036(v5, v6);
    camlList__hd_1036(v5, v6);
    caml_apply2(v1);
    int* ptr3 = camlList__rev_append_1051((int*)v5);
    caml_modify(ptr0, (unsigned int)ptr3);
    int v10 = camlList__mem_1161();
    camlPervasives__print_endline_1274();
    int v11 = camlList__mem_1161();
    camlPervasives__print_endline_1274();
    int v12 = v2 >> 1;
    if(v12 < 0) {
        ++v12;
    }
    int v13 = caml_alloc3(v5, v6);
    *(int*)v13 = 3319;
    *(int*)(v13 + 4) = &camlSource__fun_1090;
    *(int*)(v13 + 8) = 3;
    *(int*)(v13 + 12) = (v12 >> 1) * 2 + 1;
    int v14 = camlList__find_all_1205(v5, v6);
    unsigned int v15 = (unsigned int)*(int*)v14();
    caml_modify(ptr1, v15);
    camlSource__print_n_1068(v5, v6);
    v0 = camlPrintf__printf_1393(v5, v6);
    camlList__fold_left_1078(ptr1[0]);
    *(int*)v0();
    unsigned int* ptr4 = camlPervasives__$40_1143();
    caml_modify(ptr1, (unsigned int)ptr4);
    v1 = camlPrintf__printf_1393(v5, v6);
    camlList__fold_left_1078(ptr1[0]);
...
int camlSource__fun_1090() {
    int v0;
    int v1;
    return (*(int*)(v0 + 8) > v1 ? 1: 0) * 2 + 1;
}

int camlSource__fun_1095() {
    int v0;
    int result;
    if(v0 < 2001) {
        return result + v0 - 1;
...
int camlSource__fun_1098() {
    int result;
    return result;
}

int camlSource__loop_1063(int param0, int param1) {
    int* ptr0;
    unsigned int* ptr1;
    int v0;
    int* ptr2;
    for(int i = *ptr2; i != 1; i = *ptr2) {
        unsigned int* ptr3 = ptr1;
        int* ptr4 = ptr2;
        int v1 = camlSource__pop_head_1054(i, param1);
        while(1) {
            ptr0 = (int*)(caml_young_ptr - 12);
            caml_young_ptr -= 12;
            if(caml_young_limit <= (unsigned int)ptr0) {
        ...
        *(int*)(unsigned int)(ptr0 + 1) = v1;
        ptr1 = ptr3;
        *(unsigned int*)(ptr0 + 2) = ptr1[0];
        caml_modify(ptr1, (unsigned int)(ptr0 + 1));
        ptr2 = ptr4;
    }
    return 1;
}

int camlSource__pop_head_1054(int param0, int param1) {
    unsigned int* ptr0;
    unsigned int* ptr1 = ptr0;
    int result = camlList__hd_1036(param0, param1);
    int v0 = camlList__tl_1039(param0, param1);
    caml_modify(ptr0, (unsigned int)v0);
    return result;
}

// Stale decompilation - Refresh this view to re-decompile this code
int camlSource__print_n_1068(int param0, int param1) {
    int v0;
    int v1;
    while(v1 != 1) {
        if(v0 > 1) {
            int v2 = camlPrintf__printf_1393(param0, param1);
            camlList__hd_1036(param0, param1);
            caml_apply2((int*)v2);
            v1 = camlList__tl_1039(param0, param1);
            v0 -= 2;
        }
        else {
            return 1;
...
// Stale decompilation - Refresh this view to re-decompile this code
int camlSource__push_head_1057(int param0) {
    int* ptr0;
    unsigned int* ptr1;
    int v0;
    while(1) {
...
int* camlSource__seq_1049(int* param0) {
    return camlSource___seq_1051(param0);
}
...
int camlString__entry() {
    ...
    gvar_80791D8 = &camlString__23;
    gvar_80791DC = &camlString__22;
    gvar_80791E0 = &camlString__21;
    gvar_80791E4 = &camlString__20;
    gvar_80791EC = &camlString__19;
    gvar_80791E8 = &camlString__18;
    gvar_80791F0 = &camlString__17;
    gvar_8079224 = &camlString__16;
    gvar_8079210 = &camlString__15;
    gvar_8079214 = &camlString__14;
    gvar_8079228 = &camlString__13;
    gvar_8079218 = &camlString__12;
    gvar_807921C = &camlString__11;
    gvar_807922C = &camlString__10;
    gvar_80791F4 = &camlString__9;
    gvar_80791FC = &camlString__8;
    gvar_8079230 = &camlString__7;
    gvar_80791F8 = &camlString__6;
    gvar_8079200 = &camlString__5;
    gvar_8079208 = &camlString__4;
    gvar_8079204 = &camlString__3;
    gvar_807920C = &camlString__2;
    gvar_8079220 = &camlString__1;
    return 1;
}
...
int camlSys__entry() {
    ...
    gvar_8079668 = *ptr1;
    gvar_807966C = v3;
    int v4 = (gvar_807966C - 20) >> 1;
    gvar_8079674 = (unsigned int)((2 << (v4 & 0x1f)) - 1);
    int v5 = gvar_8079674 >> 1;
    int v6 = (int)(gvar_807966C >> 1);
    if(v6 < 0) {
        v6 += 7;
    }
    gvar_8079670 = (unsigned int)((v6 >> 3) * 2 * v5 - 1);
    int v7 = caml_alloc3(v4, v0);
    *(int*)v7 = 0x400;
    *(int*)(v7 + 4) = 1;
    gvar_8079664 = (int*)(v7 + 4);
    gvar_8079678 = &camlSys__4;
    gvar_807967C = 0xffffffff;
    gvar_8079680 = 0xfffffffd;
    gvar_8079684 = 0xfffffffb;
    gvar_8079688 = 0xfffffff9;
    gvar_807968C = 0xfffffff7;
    gvar_8079690 = 0xfffffff5;
    gvar_8079694 = 0xfffffff3;
    gvar_8079698 = 0xfffffff1;
    gvar_807969C = 0xffffffef;
    gvar_80796A0 = 0xffffffed;
    gvar_80796A4 = 0xffffffeb;
    gvar_80796A8 = 0xffffffe9;
    gvar_80796AC = 0xffffffe7;
    gvar_80796B0 = 0xffffffe5;
    gvar_80796B4 = 0xffffffe3;
    gvar_80796B8 = 0xffffffe1;
    gvar_80796BC = 0xffffffdf;
    gvar_80796C0 = 0xffffffdd;
    gvar_80796C4 = 0xffffffdb;
    gvar_80796C8 = 0xffffffd9;
    gvar_80796CC = 0xffffffd7;
    *(int*)(v7 + 8) = 0x400;
    *(int*)(v7 + 12) = "Sys.Break";
    gvar_80796D0 = (int*)(v7 + 12);
    gvar_80796D4 = &camlSys__2;
    gvar_80796D8 = "3.12.1";
    return 1;
}
...
void camlSys__fun_1093(int param0, int param1) {
    while(1) {
        ...
        if(caml_young_limit <= (unsigned int)ptr0) {
            *ptr0 = 0x400;
            *(unsigned int*)(ptr0 + 1) = gvar_80796D0;
            caml_raise_exn();
        }
        caml_call_gc(param0, param1);
    }
...
int camlUnixLabels__entry() {
    ...
    gvar_80765C4 = gvar_8074050;
    gvar_80765C8 = gvar_8074054;
    gvar_80765CC = gvar_8074058;
    gvar_80765D0 = gvar_807405C;
    gvar_80765D4 = gvar_8074060;
    gvar_80765D8 = gvar_8074064;
    gvar_80765DC = gvar_8074068;
    gvar_80765E0 = gvar_807406C;
    gvar_80765E4 = gvar_8074070;
    gvar_80765E8 = gvar_8074074;
    gvar_80765EC = gvar_8074078;
    gvar_80765F0 = gvar_807407C;
    gvar_80765F4 = gvar_8074080;
    gvar_80765F8 = gvar_8074084;
    gvar_80765FC = gvar_8074088;
    gvar_8076600 = gvar_807408C;
    gvar_8076604 = 1;
    gvar_8076608 = 3;
    gvar_807660C = 5;
    gvar_8076610 = gvar_807409C;
    gvar_8076614 = gvar_80740A0;
    gvar_8076618 = gvar_80740A4;
    gvar_807661C = gvar_80740A8;
    gvar_8076620 = gvar_80740AC;
    gvar_8076624 = gvar_80740B0;
    gvar_8076628 = gvar_80740B4;
    gvar_807662C = gvar_80740B8;
    gvar_8076630 = gvar_80740BC;
    gvar_8076634 = gvar_80740C0;
    gvar_8076638 = gvar_80740C4;
    gvar_807663C = gvar_80740C8;
    gvar_8076640 = gvar_80740CC;
    gvar_8076644 = gvar_80740D0;
    gvar_8076648 = gvar_80740D4;
    gvar_807664C = gvar_80740D8;
    gvar_8076650 = gvar_80740DC;
    gvar_8076654 = gvar_80740E0;
    gvar_8076658 = gvar_80740E4;
    gvar_807665C = gvar_80740E8;
    gvar_8076660 = gvar_80740EC;
    gvar_8076664 = gvar_80740F0;
    gvar_8076668 = gvar_80740F4;
    gvar_807666C = gvar_80740F8;
    gvar_8076670 = gvar_80740FC;
    gvar_8076674 = gvar_8074100;
    gvar_8076678 = gvar_8074104;
    gvar_807667C = gvar_8074108;
    gvar_8076680 = gvar_807410C;
    gvar_8076684 = gvar_8074110;
    gvar_8076688 = gvar_8074114;
    gvar_807668C = gvar_8074118;
    gvar_8076690 = gvar_807411C;
    gvar_8076694 = gvar_8074120;
    gvar_8076698 = gvar_8074124;
    gvar_807669C = gvar_8074128;
    gvar_80766A0 = gvar_807412C;
    gvar_80766A4 = gvar_8074130;
    gvar_80766A8 = gvar_8074134;
    gvar_80766AC = gvar_8074138;
    gvar_80766B0 = gvar_807413C;
    gvar_80766B4 = gvar_8074140;
    gvar_80766B8 = gvar_8074144;
    gvar_80766BC = gvar_8074148;
    gvar_80766C0 = gvar_807414C;
    gvar_80766C4 = gvar_8074150;
    gvar_80766C8 = gvar_8074154;
    gvar_80766CC = gvar_8074158;
    gvar_80766D0 = gvar_807415C;
    gvar_80766D4 = gvar_8074160;
    gvar_80766D8 = gvar_8074164;
    gvar_80766DC = gvar_8074168;
    gvar_80766E0 = gvar_807416C;
    gvar_80766E4 = gvar_8074170;
    gvar_80766E8 = gvar_8074174;
    gvar_80766EC = gvar_8074178;
    gvar_80766F0 = gvar_807417C;
    gvar_80766F4 = gvar_8074180;
    gvar_80766F8 = gvar_8074184;
    gvar_80766FC = gvar_8074188;
    gvar_8076700 = gvar_807418C;
    gvar_8076704 = gvar_8074190;
    gvar_8076708 = gvar_8074194;
    gvar_807670C = gvar_8074198;
    gvar_8076710 = gvar_807419C;
    gvar_8076714 = gvar_80741A0;
    gvar_8076718 = gvar_80741A4;
    gvar_807671C = gvar_80741A8;
    gvar_8076720 = gvar_80741AC;
    gvar_8076724 = gvar_80741B0;
    gvar_8076728 = gvar_80741B4;
    gvar_807672C = gvar_80741B8;
    gvar_8076730 = gvar_80741BC;
    gvar_8076734 = gvar_80741C0;
    gvar_8076738 = gvar_80741C4;
    gvar_807673C = gvar_80741C8;
    gvar_8076740 = gvar_80741CC;
    gvar_8076744 = gvar_80741D0;
    gvar_8076748 = gvar_80741D4;
    gvar_807674C = gvar_80741D8;
    gvar_8076750 = gvar_80741DC;
    gvar_8076754 = gvar_80741E0;
    gvar_8076758 = gvar_80741E4;
    gvar_807675C = gvar_80741E8;
    gvar_8076760 = gvar_80741EC;
    gvar_8076764 = gvar_80741F0;
    gvar_8076768 = gvar_80741F4;
    gvar_807676C = gvar_80741F8;
    gvar_8076770 = gvar_80741FC;
    gvar_8076774 = gvar_8074200;
    gvar_8076778 = gvar_8074204;
    gvar_807677C = gvar_8074208;
    gvar_8076780 = gvar_807420C;
    gvar_8076784 = gvar_8074210;
    gvar_8076788 = gvar_8074214;
    gvar_807678C = gvar_8074218;
    gvar_8076790 = gvar_807421C;
    gvar_8076794 = gvar_8074220;
    gvar_8076798 = gvar_8074224;
    gvar_807679C = gvar_8074228;
    gvar_80767A0 = gvar_807422C;
    gvar_80767A4 = gvar_8074230;
    gvar_80767A8 = gvar_8074234;
    gvar_80767AC = gvar_8074238;
    gvar_80767B0 = gvar_807423C;
    gvar_80767B4 = gvar_8074240;
    gvar_80767B8 = gvar_8074244;
    gvar_80767BC = gvar_8074248;
    gvar_80767C0 = gvar_807424C;
    gvar_80767C4 = gvar_8074250;
    gvar_80767C8 = gvar_8074254;
    gvar_80767CC = gvar_8074258;
    gvar_80767D0 = gvar_807425C;
    gvar_80767D4 = gvar_8074260;
    gvar_80767D8 = gvar_8074264;
    gvar_80767DC = gvar_8074268;
    gvar_80767E0 = gvar_807426C;
    gvar_80767E4 = gvar_8074270;
    gvar_80767E8 = gvar_8074274;
    gvar_80767EC = gvar_8074278;
    gvar_80767F0 = gvar_807427C;
    gvar_80767F4 = gvar_8074280;
    gvar_80767F8 = gvar_8074284;
    gvar_80767FC = gvar_8074288;
    gvar_8076800 = gvar_807428C;
    gvar_8076804 = gvar_8074290;
    gvar_8076808 = gvar_8074294;
    gvar_807680C = gvar_8074298;
    gvar_8076810 = gvar_807429C;
    gvar_8076814 = gvar_80742A0;
    gvar_8076818 = gvar_80742A4;
    gvar_807681C = gvar_80742A8;
    gvar_8076820 = gvar_80742AC;
    gvar_8076824 = gvar_80742B0;
    gvar_8076828 = gvar_80742B4;
    return 1;
}
...
int camlUnix__close_process_2009() {
    ...
    *(ptr0 + 2) = v2;
    ...
    int v5 = v1;
    caml_c_call();
    int v6 = sub_804E080(v4, v1, v3, v0);
...
int camlUnix__close_process_full_2013(int param0) {
    ...
    *(ptr0 + 3) = v2;
    ...
    int v7 = v1;
    caml_c_call();
    int v8 = sub_804E140(v6, v4, v1, v5, v0);
    if(*(int*)v8 != &caml_exn_Sys_error) {
        caml_raise_exn();
        /*BAD_CALL!*/ sub_804E140(v4, v1, v5, v0, param0);
    }
    caml_c_call();
...
int camlUnix__create_process_1907(int param0, int param1) {
    ...
    int result1 = sub_804D610(v2, v3, v4, v5, v1, v0);
...
int camlUnix__create_process_env_1914(int param0, int param1) {
    ...
    int result1 = sub_804D6C0(v2, v3, v4, v5, v6, v1, v0);
    camlPervasives__exit_1326();
    return result1;
}
...
int camlUnix__entry(int param0, int param1) {
    int v0;
    gvar_80742B4 = &camlUnix__175;
    gvar_80742B0 = &camlUnix__174;
    gvar_80742AC = &camlUnix__173;
    gvar_80742A8 = &camlUnix__172;
    gvar_80742A4 = &camlUnix__171;
    gvar_80742A0 = &camlUnix__170;
    gvar_807429C = &camlUnix__169;
    gvar_8074290 = &camlUnix__168;
    gvar_807428C = &camlUnix__167;
    gvar_8074288 = &camlUnix__166;
    gvar_8074284 = &camlUnix__165;
    gvar_8074280 = &camlUnix__164;
    gvar_807427C = &camlUnix__163;
    gvar_8074278 = &camlUnix__162;
    gvar_8074234 = &camlUnix__161;
    gvar_8074230 = &camlUnix__160;
    gvar_807422C = &camlUnix__159;
    gvar_8074228 = &camlUnix__158;
    gvar_8074224 = &camlUnix__157;
    gvar_8074220 = &camlUnix__156;
    gvar_807421C = &camlUnix__155;
    gvar_8074218 = &camlUnix__154;
    gvar_8074210 = &camlUnix__153;
    gvar_80741FC = &camlUnix__152;
    gvar_80741F8 = &camlUnix__151;
    gvar_80741F4 = &camlUnix__150;
    gvar_80741F0 = &camlUnix__149;
    gvar_80741EC = &camlUnix__148;
    gvar_80741E8 = &camlUnix__147;
    gvar_80741E4 = &camlUnix__146;
    gvar_80741E0 = &camlUnix__145;
    gvar_80741DC = &camlUnix__144;
    gvar_80741D8 = &camlUnix__143;
    gvar_80741D4 = &camlUnix__142;
    gvar_80741D0 = &camlUnix__141;
    gvar_80741CC = &camlUnix__140;
    gvar_80741C8 = &camlUnix__139;
    gvar_80741C4 = &camlUnix__138;
    gvar_80741C0 = &camlUnix__137;
    gvar_80741BC = &camlUnix__136;
    gvar_80741B8 = &camlUnix__135;
    gvar_80741B4 = &camlUnix__134;
    gvar_80741B0 = &camlUnix__133;
    gvar_80741AC = &camlUnix__132;
    gvar_80741A8 = &camlUnix__131;
    gvar_80741A4 = &camlUnix__130;
    gvar_80741A0 = &camlUnix__129;
    gvar_807419C = &camlUnix__128;
    gvar_8074198 = &camlUnix__127;
    gvar_8074194 = &camlUnix__126;
    gvar_807418C = &camlUnix__125;
    gvar_8074188 = &camlUnix__124;
    gvar_8074184 = &camlUnix__123;
    gvar_8074180 = &camlUnix__122;
    gvar_807417C = &camlUnix__121;
    gvar_8074178 = &camlUnix__120;
    gvar_8074174 = &camlUnix__119;
    gvar_8074170 = &camlUnix__118;
    gvar_8074144 = &camlUnix__117;
    gvar_8074140 = &camlUnix__116;
    gvar_807413C = &camlUnix__115;
    gvar_8074138 = &camlUnix__114;
    gvar_8074134 = &camlUnix__113;
    gvar_8074130 = &camlUnix__112;
    gvar_807412C = &camlUnix__111;
    gvar_8074128 = &camlUnix__110;
    gvar_8074124 = &camlUnix__109;
    gvar_8074120 = &camlUnix__108;
    gvar_807411C = &camlUnix__107;
    gvar_8074118 = &camlUnix__106;
    gvar_8074114 = &camlUnix__105;
    gvar_8074110 = &camlUnix__104;
    gvar_807410C = &camlUnix__103;
    gvar_8074108 = &camlUnix__102;
    gvar_8074104 = &camlUnix__101;
    gvar_8074100 = &camlUnix__100;
    gvar_80740FC = &camlUnix__99;
    gvar_80740F8 = &camlUnix__98;
    gvar_80740F4 = &camlUnix__97;
    gvar_80740F0 = &camlUnix__96;
    gvar_80740EC = &camlUnix__95;
    gvar_80740E8 = &camlUnix__94;
    gvar_80740E4 = &camlUnix__93;
    gvar_80740E0 = &camlUnix__92;
    gvar_80740D8 = &camlUnix__91;
    gvar_80740D4 = &camlUnix__90;
    gvar_80740D0 = &camlUnix__89;
    gvar_80740CC = &camlUnix__88;
    gvar_80740C8 = &camlUnix__87;
    gvar_80740C4 = &camlUnix__86;
    gvar_80740C0 = &camlUnix__85;
    gvar_80740BC = &camlUnix__84;
    gvar_80740B8 = &camlUnix__83;
    gvar_80740B4 = &camlUnix__82;
    gvar_80740B0 = &camlUnix__81;
    gvar_80740A0 = &camlUnix__80;
    gvar_807409C = &camlUnix__79;
    gvar_807408C = &camlUnix__78;
    gvar_8074088 = &camlUnix__77;
    gvar_8074084 = &camlUnix__76;
    gvar_807407C = &camlUnix__75;
    gvar_8074078 = &camlUnix__74;
    gvar_8074074 = &camlUnix__73;
    gvar_8074070 = &camlUnix__72;
    gvar_807406C = &camlUnix__71;
    gvar_8074068 = &camlUnix__70;
    gvar_8074064 = &camlUnix__69;
    gvar_8074060 = &camlUnix__68;
    gvar_807405C = &camlUnix__67;
    gvar_8074058 = &camlUnix__66;
    gvar_8074050 = &camlUnix__65;
    ...
    *(int*)(v1 + 24) = &camlUnix__63;
    ...
    gvar_8074054 = &camlUnix__60;
    gvar_8074090 = 1;
    gvar_8074094 = 3;
    gvar_8074098 = 5;
    gvar_80740A4 = &camlUnix__59;
    gvar_80740A8 = &camlUnix__58;
    gvar_80740AC = &camlUnix__57;
    ...
    *(int*)(v2 + 24) = &camlUnix__55;
    gvar_80740DC = (int*)(v2 + 4);
    gvar_80742B8 = &camlUnix__49;
    gvar_8074190 = &camlUnix__48;
    gvar_80742BC = &camlUnix__47;
    unsigned int v3 = (unsigned int)caml_c_call();
    gvar_8074200 = v3;
    unsigned int v4 = (unsigned int)caml_c_call();
    gvar_8074204 = v4;
    int v5 = sub_804E9DA(v0);
    int v6 = *(int*)v5 == &caml_exn_Failure ? gvar_8074200: /*BAD_CALL!*/ caml_raise_exn();
    gvar_8074208 = v6;
    int v7 = sub_804EA22(v0);
    int v8 = *(int*)v7 == &caml_exn_Failure ? gvar_8074204: /*BAD_CALL!*/ caml_raise_exn();
    gvar_807420C = v8;
    gvar_8074214 = &camlUnix__42;
    gvar_8074238 = &camlUnix__41;
    gvar_807423C = &camlUnix__40;
    gvar_8074240 = &camlUnix__39;
    gvar_8074244 = &camlUnix__38;
    ...
    *(int*)(v9 + 28) = &camlUnix__37;
    gvar_80742C0 = (int*)(v9 + 4);
    gvar_8074248 = &camlUnix__35;
    gvar_807424C = &camlUnix__34;
    gvar_8074250 = &camlUnix__33;
    gvar_8074254 = &camlUnix__32;
    gvar_8074258 = &camlUnix__31;
    gvar_807425C = &camlUnix__30;
    gvar_8074260 = &camlUnix__29;
    gvar_8074264 = &camlUnix__28;
    gvar_8074268 = &camlUnix__27;
    gvar_80742C4 = &camlUnix__26;
    gvar_8074294 = &camlUnix__25;
    gvar_80742C8 = &camlUnix__24;
    gvar_8074298 = &camlUnix__23;
    gvar_8074080 = &camlUnix__22;
    gvar_80742CC = &camlUnix__21;
    gvar_80742D0 = &camlUnix__20;
    gvar_80742D4 = &camlUnix__19;
    gvar_8074148 = &camlUnix__18;
    gvar_807414C = &camlUnix__17;
    int* ptr0 = camlHashtbl__create_1051();
    gvar_80742D8 = ptr0;
    gvar_80742DC = &camlUnix__16;
    gvar_8074150 = &camlUnix__15;
    gvar_8074154 = &camlUnix__14;
    gvar_8074158 = &camlUnix__13;
    gvar_80742E0 = &camlUnix__12;
    gvar_807415C = &camlUnix__11;
    gvar_80742E4 = &camlUnix__10;
    gvar_80742E8 = &camlUnix__9;
    gvar_8074160 = &camlUnix__8;
    gvar_8074164 = &camlUnix__7;
    gvar_8074168 = &camlUnix__6;
    gvar_807416C = &camlUnix__5;
    gvar_807426C = &camlUnix__4;
    gvar_8074270 = &camlUnix__3;
    gvar_80742EC = &camlUnix__2;
    gvar_8074274 = &camlUnix__1;
    return 1;
}
...
void camlUnix__find_proc_id_1997() {
    ...
    int v4;
    int v5;
    int* ptr0 = (int*)sub_804DE80(v0, v3, v4, v1);
...
unsigned int* camlUnix__get_port_1739(int param0) {
    ...
    if(v6 == 1) {
        int v7 = sub_804BC40(v4, param0, v3, v0);
        if(*(int*)v7 == &caml_exn_Failure) {
            int v8 = sub_804BBB0(ptr1, v1, v2, v0);
...
int camlUnix__getaddrinfo_1751(int param0, int param1, int param2, int param3, int param4, void* param5) {
    ...
    int v2;
    int v3;
    int v4 = sub_804D040(v1, v2, v3, v0);
...
loc_804CD4E:
    ...
    if(v9 != 1) {
        ...
        if(v10 != 1) {
            ...
            *ptr2 = 0x800;
            *(unsigned int*)(ptr2 + 1) = gvar_8074200;
            *(ptr2 + 2) = "0.0.0.0";
            ...
            *ptr0 = 0x800;
            *(unsigned int*)(ptr0 + 1) = gvar_8074204;
            *(ptr0 + 2) = "127.0.0.1";
        ...
        *(int*)(ptr1 + 1) = 1;
        ...
        int v11 = sub_804CEF0(v3, v5, v6, (int)ptr9, v4, ptr7);
        if(*(int*)v11 == &caml_exn_Failure) {
            int v12 = sub_804CE60(param0, param1, param2, param3, param4, param5);
...
int* camlUnix__getnameinfo_emulation_1772(int param0, int param1) {
    ...
    if(v7) {
        int v8 = sub_804D130(ptr3[0], ptr3[1], v6, v1);
        if(*(int*)v8 == &caml_exn_Not_found) {
        ...
        int v10 = sub_804D1E0(v0, v2, v3, v1);
...
int camlUnix__handle_unix_error_1171() {
    ...
    int v2;
    int v3;
    int v4 = sub_804C640(v0, v1, v2, v3);
    if(camlUnix == *(int*)v4) {
        v2 = *(int*)(v4 + 12);
        v0 = *(int*)(v4 + 8);
        v1 = *(int*)(v4 + 4);
...
int camlUnix__open_proc_1949(int param0, int param1) {
    ...
    int result = sub_804D7F0(v7, v0, v2, param1, param0, v1, (int)ptr0);
    camlPervasives__exit_1326();
    return result;
}
...
int camlUnix__open_proc_full_1975(int param0, int param1) {
    ...
    int result = sub_804DBE0(v4, v2, v3, v11, v0, v1, v10, param0, (int)ptr0);
    camlPervasives__exit_1326();
    return result;
}
...
int caml_alloc1(int param0, int param1) {
    ...
    while(1) {
        ...
        result = sub_807040D(param0, param1);
    }
    return result;
}
        ...
        if(!(v1 & 0x1)) {
            ...
            if(v4 > v1) {
                ...
                if((unsigned int)ptr1 < v1 && ((v3 & 0x1) || v4 <= v3 || (unsigned int)ptr1 >= v3)) {
                    if(gvar_807FE88 >= gvar_807FE8C) {
                        caml_realloc_ref_table((int*)&caml_ref_table);
                    }
                    unsigned int* ptr2 = gvar_807FE88;
                    *ptr2 = ptr0;
                    gvar_807FE88 = (int*)(ptr2 + 1);
                }
            }
        }
    }
        ...
        if(!(v0 & 0x1)) {
            ...
            if(v2 > v0) {
                ...
                if((unsigned int)ptr2 < v0 && ((int*)((int)ptr1 & 0x1) || v2 <= (unsigned int)ptr1 || ptr2 >= ptr1)) {
                    ...
                    unsigned int* ptr3 = gvar_807FE88;
                    *ptr3 = ptr0;
                    gvar_807FE88 = (int*)(ptr3 + 1);
                }
            }
        }
    }
        ...
        do {
            ...
            if(v9 != 1) {
                if(v9 == 2) {
                    ...
                    int v11 = *(int*)(v8 * 4 + param2);
                    result = caml_callback2_exn(v1);
                ...
                result = caml_callback3_exn(v1, *(int*)(v8 * 4 + param2), *(int*)(v8 * 4 + param2 + 4), *(int*)(v8 * 4 + param2 + 8));
                if((unsigned int)(result & 0x3) == 2) {
                    caml_local_roots = v0;
                    return result;
                }
            ...
            result = caml_callback_exn(v1, *(int*)(v8 * 4 + param2));
            if((unsigned int)(result & 0x3) == 2) {
                caml_local_roots = v0;
                return result;
            }
...
int caml_empty_minor_heap() {
    if(caml_young_end != caml_young_ptr) {
        ...
        caml_gc_message(2, &gvar_80713FC, 0);
        caml_oldify_local_roots();
        for(int* i = *(int*)&caml_ref_table; gvar_807FE88 > (unsigned int)i; ++i) {
            int v0 = *i;
            caml_oldify_one(*(int**)v0, v0);
        }
        caml_oldify_mopup();
        for(unsigned int* j = *(int*)&caml_weak_ref_table; gvar_807FEA4 > (unsigned int)j; ++j) {
            unsigned int* ptr0 = *j;
            unsigned int* ptr1 = *ptr0;
...
int caml_gc_set(int param0) {
    ...
    if(caml_percent_free != v1) {
        ...
        caml_gc_message(32, &gvar_8071D4F, v1);
    }
    norm_pmax();
    ...
    *ptr0 = param1;
    if(!((unsigned char)result & 0x1) && caml_young_end > (unsigned int)result && caml_young_start < (unsigned int)result) {
        ...
        if((*(char*)((int)*(unsigned int*)((int)(int*)((int)(int*)((int)ptr0 >>> 23) * 4) + (int)&caml_page_table) + (int)result) & 0x1)) {
            ...
            result = (int*)&gvar_807FE88;
            unsigned int* ptr1 = gvar_807FE88;
            *ptr1 = ptr0;
            gvar_807FE88 = (int*)(ptr1 + 1);
        }
    }
    return result;
}
...
int* caml_install_signal_handler(int param0, unsigned int* param1) {
    ...
    int v8 = caml_set_signal_action((int)v6, (unsigned int)(int*)((char*)param1 - 1) > 2 ? 2: *(int*)((int)(int*)((int)param1 * 4) + (int)&gvar_8071210));
    if(v8 == 1) {
        result = (int*)0x3;
    }
    else if(v8 == 2) {
...
int caml_main(unsigned int param0) {
    ...
    loc_8061963:
        while(1) {
            ...
            while((unsigned char)v19 > 39);
            /*BAD_CALL!*/ *(int*)((v19 & 0xFF) * 4 + (int)&gvar_80710E8){sub_8061917}((int)v5, (int)v12, (int)v6, (int)v13, v7, v10, v2, v14, v8, v11, v4, v15, v9, v16, v22, v21, (int)ptr4, (int)ptr3, v3);
        }
    }
    ...
    int v24 = 0;
    do {
        *(int*)(v24 * 4 + (int)&caml_atom_table) = v24;
        ++v24;
    }
    while(v24 != 0x100);
    int v25 = caml_page_table_add(4, &caml_atom_table, &caml_frame_descriptors_mask);
    if(!v25) {
    ...
    loc_8061A16:
        do {
            int v26 = caml_page_table_add(4, (int)v1, *(int*)((int)(int*)((int)ptr6 * 8) + v20));
            if(v26) {
                /*NO_RETURN*/ caml_fatal_error("Fatal error: not enough memory for the initial page table");
            }
            ++ptr6;
    ...
    unsigned int v27 = gvar_80739E0;
    caml_code_area_end = v27;
    unsigned int v28 = gvar_80739E4;
    if(v28) {
        unsigned int v29 = caml_code_area_start;
        int v30 = 1;
        do {
            v29 = v28 >= v29 ? v29: v28;
            unsigned int v31 = *(unsigned int*)(v30 * 8 + (int)&gvar_80739E0);
            v27 = v31 > v27 ? v31: v27;
            ++v30;
            v28 = *(unsigned int*)(v30 * 8 + (int)&caml_code_segments);
        }
        while(v28);
        caml_code_area_start = v29;
        caml_code_area_end = v27;
    }
    caml_init_signals();
    caml_debugger_init();
    char* ptr7 = *(char**)param0;
    char* __src1 = ptr7 ? ptr7: (char*)&gvar_8071D68;
    int v32 = caml_executable_name((char*)&proc_self_exe.2949, 0x100);
    int v33 = &proc_self_exe.2949;
    if(v32) {
        v33 = caml_search_exe_in_path(__src1);
    }
    caml_sys_init((unsigned int)v33, param0);
            ...
            if(caml_parser_trace) {
                if(v4) {
                    ...
                    if(((unsigned char)__s & 0x1)) {
                        →fprintf(stderr, (char*)&gvar_8071A9B, (int*)((int)__s >> 1));
                    }
                    else {
                        char v12 = __s[-4];
                        switch(v12) {
                            ...
                            case 253: {
                                *(long long*)&v9 = (double)*(long long*)&__s[0];
                                →fprintf(stderr, (char*)&gvar_8071A9F, v9);
                                break;
                            }
                            default: {
                                →fputc(95, stderr);
                    ...
                    →fwrite((void*)&gvar_8071AA2, 1, 2, stderr);
                }
            }
            goto loc_806C388;
        }
                            ...
                            if(!((unsigned char)v11 & 0x1)) {
                                ...
                                if(v13 > (unsigned int)v11) {
                                    ...
                                    if(v14 < (unsigned int)v11 && (((unsigned char)v12 & 0x1) || v13 <= v12 || v14 >= v12)) {
                                        ...
                                        unsigned int* ptr12 = gvar_807FE88;
                                        *ptr12 = (int*)(v10 + (int)ptr2);
                                        gvar_807FE88 = (int*)(ptr12 + 1);
                                    }
                                }
                            }
                        }
    ...
    if(!((unsigned char)param0 & 0x1) && caml_young_end > param0 && caml_young_start < param0) {
        ...
        *ptr0 = param0;
        if(((unsigned char)result & 0x1) || caml_young_end <= result || caml_young_start >= result) {
            if(gvar_807FEA4 >= gvar_807FEA8) {
                caml_realloc_ref_table((int*)&caml_weak_ref_table);
            }
            result = &gvar_807FEA4;
            unsigned int* ptr1 = gvar_807FEA4;
            *ptr1 = ptr0;
            gvar_807FEA4 = (int*)(ptr1 + 1);
        }
    }
    else {
    ...
    if(!*(char*)(result - 4)) {
        ...
        *ptr0 = 1;
        if((unsigned int)v3 > 107) {
            v3 = unix_error(36, (char*)&gvar_8071D68, v0);
        }
        →memmove();
        result = param2;
        *(int*)result = v4 + 2;
            ...
            if(v31 > 31) {
                ...
                *(char*)(v37 + v29) = (unsigned char)v37 - (unsigned char)v32;
                ...
                if((unsigned char)v30 <= 19) {
                    /*BAD_CALL!*/ *(int*)((unsigned int)(v30 & 0xFF) * 4 + (int)&gvar_80719E4){sub_806AE25|sub_806AE39|sub_806AE58|sub_806AE8A|sub_806AEBC|sub_806AED3|sub_806AEFD|sub_806AF50|sub_806AF7C|sub_806B03B|sub_806B150}(v2, v16, v3, v17, v4, v0, v28, v15, v5, v18, v6, v19, v7, v20, v8, v21, v9, v22, v27, v26, v25, v24, v1);
                }
                intern_cleanup();
...
int sub_804B81B(int param0, int param1, int param2, unsigned int* param3, unsigned int* param4, int param5) {
    int* ptr0;
    int v0;
    ...
    param2 = caml_c_call();
    caml_exception_pointer = v1;
    int* ptr1 = camlSource__seq_1049(ptr0);
    int v2 = caml_alloc3((int)ptr0, v0);
    param4 = (unsigned int*)(v2 + 4);
    *(unsigned int*)v2 = 0x400;
    *(unsigned int*)(v2 + 4) = (unsigned int)ptr1;
    param3 = (unsigned int*)(v2 + 12);
    *(unsigned int*)(v2 + 8) = 0x400;
    *(unsigned int*)(v2 + 12) = 1;
    camlSource__loop_1063(&camlSource__11, v0);
    param1 = camlPrintf__printf_1393((int)ptr0, v0);
    camlList__tl_1039((int)ptr0, v0);
    param0 = camlList__hd_1036((int)ptr0, v0);
    camlList__hd_1036((int)ptr0, v0);
    caml_apply2(param1);
    int* ptr2 = camlList__rev_append_1051(ptr0);
    caml_modify(param3, (unsigned int)ptr2);
    ...
    int v6 = caml_alloc3((int)ptr0, v0);
    *(int*)v6 = 3319;
    *(int*)(v6 + 4) = &camlSource__fun_1090;
    *(int*)(v6 + 8) = 3;
    *(int*)(v6 + 12) = (v5 >> 1) * 2 + 1;
    int v7 = camlList__find_all_1205((int)ptr0, v0);
    unsigned int v8 = (unsigned int)*(int*)v7();
    caml_modify(param4, v8);
    camlSource__print_n_1068((int)ptr0, v0);
    param0 = camlPrintf__printf_1393((int)ptr0, v0);
    camlList__fold_left_1078(param4[0]);
    *(int*)param0();
    unsigned int* ptr3 = camlPervasives__$40_1143();
    caml_modify(param4, (unsigned int)ptr3);
    param1 = camlPrintf__printf_1393((int)ptr0, v0);
    param0 = camlList__fold_left_1078(param4[0]);
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804BBB0(void* param0, int param1, int param2, int param3) {
    int* ptr0;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804BC40(int param0, int param1, int param2, int param3) {
    int* ptr0;
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    int v1 = caml_c_call();
...
int sub_804C640(int param0, int param1, int param2, int param3) {
    int* ptr0;
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    *ptr0((int)v0);
...
int sub_804CE60(int param0, int param1, int param2, int param3, int param4, void* param5) {
    int* ptr0;
    int v0;
    int v1;
...
int sub_804CEF0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    int* ptr0;
    int v0;
    unsigned int v1 = caml_exception_pointer;
    caml_exception_pointer = &v1;
...
int sub_804D040(int param0, int param1, int param2, int param3) {
    int* ptr0;
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    caml_c_call();
...
int sub_804D130(int param0, int param1, int param2, int param3) {
    int* ptr0;
    int v0;
    int* ptr1;
    int v1;
    ...
    param0 = *ptr2;
    caml_exception_pointer = v3;
    int v6 = sub_804D1E0(param0, param1, param2, param3);
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804D1E0(int param0, int param1, int param2, int param3) {
    int* ptr0;
    int* ptr1;
    int v0;
    int v1;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804D340(int param0, int param1, int param2) {
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    caml_c_call();
    caml_exception_pointer = v0;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804D3D0(int param0, int param1) {
    int* ptr0;
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    while(1) {
...
int sub_804D610(int param0, int param1, int param2, int param3, int param4, int param5) {
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
...
int sub_804D6C0(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    camlUnix__perform_redirections_1900(param2);
    caml_c_call();
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804D7F0(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
    int* ptr0;
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    while(1) {
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804DBE0(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
    int* ptr0;
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    while(1) {
...
int sub_804DE80(int param0, int param1, int param2, int param3) {
    int v0;
    int v1;
...
int sub_804E080(int param0, int param1, int param2, int param3) {
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    camlPervasives__close_out_1209();
    caml_exception_pointer = v0;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804E140(int param0, int param1, int param2, int param3, int param4) {
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804E1E0(int param0, int param1, int param2) {
    int* ptr0;
    int v0;
    int v1;
    unsigned int v2 = caml_exception_pointer;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_804E2D0(int param0, int param1) {
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    caml_c_call();
    caml_exception_pointer = v0;
...
int sub_804E430(int param0, int param1, int param2, int param3) {
    jump param3;
}

int sub_804E9DA(int param0) {
    int v0;
    unsigned int v1 = caml_exception_pointer;
    caml_exception_pointer = &v1;
    int v2 = &camlUnix__44;
    ...
    caml_exception_pointer = v1;
    gvar_8074208 = v3;
    int v4 = sub_804EA22(param0);
    int v5 = *(int*)v4 == &caml_exn_Failure ? gvar_8074204: /*BAD_CALL!*/ caml_raise_exn();
    gvar_807420C = v5;
    gvar_8074214 = &camlUnix__42;
    gvar_8074238 = &camlUnix__41;
    gvar_807423C = &camlUnix__40;
...
int sub_804F3D0(int param0, int param1) {
    int v0;
    unsigned int v1 = caml_exception_pointer;
    caml_exception_pointer = &v1;
    int v2 = v0;
    ...
    caml_exception_pointer = v1;
    while(param0 != 1) {
        sub_804F3D0(*(int*)(param0 + 4), param1);
    }
    jump param1;
}

// Stale decompilation - Refresh this view to re-decompile this code
int sub_804FC60(int param0, int param1) {
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    caml_c_call();
    caml_exception_pointer = v0;
    sub_804FCA0(param0, param1);
    jump param1;
}

// Stale decompilation - Refresh this view to re-decompile this code
int sub_804FCA0(int param0, int param1) {
    unsigned int v0 = caml_exception_pointer;
    caml_exception_pointer = &v0;
    caml_c_call();
    caml_exception_pointer = v0;
...
int sub_80512C0(int param0, int param1, int param2, int param3, int param4) {
    unsigned int v0;
    int v1;
    unsigned int v2 = caml_exception_pointer;
    caml_exception_pointer = &v2;
...
int sub_8055490(int param0) {
    jump param0;
}

int sub_80554A0(int param0) {
    jump param0;
}

int sub_80554B0(int param0) {
    jump param0;
}

int sub_80554C0(int param0) {
    jump param0;
}

int sub_80561B0(int param0) {
    int v0;
    int v1;
    unsigned int v2 = caml_exception_pointer;
    caml_exception_pointer = &v2;
...
int sub_8057400(int param0, int param1, int param2, int param3, int param4, unsigned int param5, int param6, int param7, int param8) {
    int v0;
    int v1;
    int v2;
    int v3;
...
int sub_8057DE0(int param0, int param1, int param2, int param3, int param4, unsigned int param5, int param6, int param7) {
    int v0;
    int v1;
    int v2;
    int v3;
...
int sub_80598E0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    caml_apply3(param0, *(int**)(param1 + 28));
    /*BAD_CALL!*/ camlPrintf__scan_fmt_1144();
}

int sub_8059900(int param0, int param1, int param2, int param3, int param4, void* param5) {
    int v0;
sub_8059900:
    int v1 = param0;
    caml_apply3(param0, *(int**)(param1 + 28));
...
int sub_80599A0(int param0, int param1, int param2, int param3) {
    jump param3;
}

int sub_80599B0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    /*BAD_CALL!*/ caml_apply3(231, *(int**)(param1 + 28));
}

int sub_80599C0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    /*BAD_CALL!*/ caml_apply3(199, *(int**)(param1 + 28));
}

int sub_80599D0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    /*BAD_CALL!*/ caml_apply3(211, *(int**)(param1 + 28));
}

int sub_80599E0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    /*BAD_CALL!*/ caml_apply3(205, *(int**)(param1 + 28));
}

int sub_80599F0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    /*BAD_CALL!*/ caml_apply3(133, *(int**)(param1 + 28));
}

int sub_8059A00(int param0, int param1, int param2, int param3, int param4, void* param5) {
    /*BAD_CALL!*/ caml_apply3(param0, *(int**)(param1 + 28));
}

int sub_8059A10(int param0, int param1, int param2, void* param3, int param4, void* param5, int param6, int param7, void* param8) {
    int v0;
    int v1;
...
int sub_8059AB0(int param0, int param1, int param2, int param3, int param4, void* param5) {
    /*BAD_CALL!*/ caml_apply3(param0, *(int**)(param1 + 28));
}

// Stale decompilation - Refresh this view to re-decompile this code
int sub_805A8A0(int param0, int param1, int param2, int param3, int param4, int param5, void* param6) {
    int v0;
    /*BAD_CALL!*/ caml_apply2(*(int**)(v0 + 32));
}

int sub_805A8C0(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, void* param8) {
    int v0;
    /*BAD_CALL!*/ caml_apply3(param1 + 2, *(int**)(v0 + 20));
}

int sub_805A8E0(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, void* param8) {
    int v0;
    /*BAD_CALL!*/ caml_apply3(param1 + 2, *(int**)(v0 + 20));
}

int sub_805A900(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, void* param8) {
    int v0;
    /*BAD_CALL!*/ caml_apply3(param1 + 2, *(int**)(v0 + 20));
}

int sub_805A920(int param0, int param1, int param2, int param3, int param4, int param5, int param6, void* param7) {
    int v0;
    int v1 = param0;
...
int sub_805A9C0(int param0, int param1, int param2, int param3, int param4, int param5, void* param6) {
    int v0;
    int v1 = camlPrintf__get_arg_1288(*(int*)(v0 + 40));
    param1 = **(unsigned int*)(gvar_807A850 + 8)();
...
int sub_805AA50(int param0, int param1, int param2, int param3, int param4, int param5, void* param6) {
    int v0;
    int v1 = camlPrintf__get_arg_1288(*(int*)(v0 + 40));
    if(param3 == 1) {
        **(unsigned int*)(gvar_807A850 + 8)();
...
int sub_805AAB0(int param0, int param1, int* param2, int param3, int param4, int param5, void* param6) {
    int v0;
    int v1;
    int v2;
    int v3;
...
int sub_805AB70(int param0, int param1, int param2, int param3, int param4, int param5, int param6, void* param7) {
    int v0;
    int v1 = param0;
...
int sub_805AC00(int param0, void* param1, int param2, int param3, int param4, int param5, int param6, void* param7) {
    int v0;
    int v1 = param0;
...
int sub_805AC80(int param0, int param1, int* param2, int param3, int param4, int param5, void* param6) {
    int v0;
    int v1 = camlPrintf__get_arg_1288(*(int*)(v0 + 40));
...
int sub_805AD00(int param0, int param1, int param2, int param3, int param4, int param5, void* param6) {
    int v0;
    camlPrintf__get_arg_1288(*(int*)(v0 + 40));
...
unsigned int sub_805AD50(int param0, int param1, int param2, int param3, int param4, int param5, void* param6) {
    int* ptr0;
    int v0;
    void* ptr1;
    int* ptr2;
...
int sub_805AF20(int param0, int param1, int param2, int param3, int param4, int param5, int param6, void* param7) {
    int v0;
    int v1;
    param1 = param0;
...
int sub_805B4D0(int param0, int param1) {
    int v0;
    unsigned int v1 = caml_exception_pointer;
    caml_exception_pointer = &v1;
...
int unix_lockf(int param0, int param1, int param2) {
    ...
    switch((unsigned int)(param1 >> 1)) {
        case 0: {
            v7 & 0xFFFF = 2;
            →fcntl();
            /*BAD_CALL!*/ sub_805E9E1(13, (int)&v7, v3, v8, v4, v7, v2, v1, v0, v10, v5, v9, (int)ptr1, (int)ptr2, v6);
            return 1;
        }
        case 1: {
            v7 & 0xFFFF = 1;
            /*BAD_CALL!*/ caml_enter_blocking_section();
            →fcntl();
            caml_leave_blocking_section();
            /*BAD_CALL!*/ sub_805E9E1(14, (int)&v7, v3, v8, v4, v7, v2, v1, v0, v10, v5, v9, (int)ptr1, (int)ptr2, v6);
            return 1;
        }
        case 2: {
            v7 & 0xFFFF = 1;
...
int sub_8060288(int param0, int param1, int param2, int param3) {
    char v0;
    char v1;
    void* ptr0;
    int v2;
    ...
    int v4;
    int v5;
    unsigned int* ptr1 = (unsigned int*)(v5 - 1);
    if(!~((unsigned char)ptr1 > 0x99 || v1)) {
        ptr1 = (unsigned int)((unsigned char)ptr1 - 96) | ((unsigned int)(int*)((int)(int*)((int)ptr1 >>> 8) & 0xffffff) << 8);
    }
    int v6 = *ptr1;
    *ptr1 = (int*)(*ptr1 + (int)ptr1);
    unsigned int* ptr2 = (unsigned int*)((char*)ptr1 - 1);
    if(!~((unsigned char)ptr2 > 0x99 || (unsigned int*)__carry__((int)ptr1, v6))) {
        ptr2 = (unsigned int)((unsigned char)ptr2 - 96) | ((unsigned int)(int*)((int)(int*)((int)ptr2 >>> 8) & 0xffffff) << 8);
    }
    int v7 = *ptr2;
    *ptr2 = (int*)(*ptr2 + (int)ptr2);
    if((unsigned char)((unsigned char)ptr2 & 0xf) <= 9 && (int*)((int)(int*)((int)(int*)((int)(int*)((int)ptr2 ^ v7) ^ *ptr2) >>> 4) & 0x1) != 1) {
        v0 = 0;
    }
    else {
        ptr2 = (unsigned int)((unsigned char)ptr2 - 6) | ((unsigned int)((unsigned char)(((unsigned short)ptr2 - 6) >>> 8) - 1) << 8) | ((unsigned int)(unsigned short)(int*)((int)ptr2 >>> 16) << 16);
        v0 = 1;
    }
    ptr2 = (unsigned int)((unsigned char)ptr2 & 0xf) | ((unsigned int)(int*)((int)(int*)((int)ptr2 >>> 8) & 0xffffff) << 8);
    if(!~((unsigned char)ptr2 > 0x99 || v0)) {
        ptr2 = (unsigned int)((unsigned char)ptr2 - 96) | ((unsigned int)(int*)((int)(int*)((int)ptr2 >>> 8) & 0xffffff) << 8);
    }
    int v8 = *ptr2;
    *ptr2 = (int*)(*ptr2 + (int)ptr2);
    if(!~((unsigned char)ptr2 > 0x99 || (unsigned int*)__carry__((int)ptr2, v8))) {
        ptr2 = (unsigned int)((unsigned char)ptr2 - 96) | ((unsigned int)(int*)((int)(int*)((int)ptr2 >>> 8) & 0xffffff) << 8);
    }
    int v9 = *ptr2;
    *ptr2 = (int*)(*ptr2 + (int)ptr2);
    unsigned int* ptr3 = (unsigned int*)((char*)ptr2 - 1);
    if(!~((unsigned char)ptr3 > 0x99 || (unsigned int*)__carry__((int)ptr2, v9))) {
        ptr3 = (unsigned int)((unsigned char)ptr3 - 96) | ((unsigned int)(int*)((int)(int*)((int)ptr3 >>> 8) & 0xffffff) << 8);
    }
    *ptr3 = (int*)(*ptr3 + (int)ptr3);
    int v10 = →getsockopt(*(int*)((int)ptr0 + 24) >> 1, *(int*)((int)ptr0 + 16), *(int*)((int)ptr0 + 20), (void*)((int)ptr0 - 32), (socklen_t*)((int)ptr0 - 36));
    if(v10 == -1) {
        uerror(v2, 0);
    }
    if(v3 <= 4) {
        return v4 - *(int*)(v3 * 4 + v4 - 77504){sub_8060344|sub_8060370|sub_8060388}(param0);
    }
    unix_error(22, v2, 0);
    jump param0;
}
...
int sub_8060324() {
    char* ptr0;
    int* ptr1;
    unsigned int* ptr2 = (unsigned int)*ptr0 | ((unsigned int)(int*)((int)(int*)((int)ptr2 >>> 8) & 0xffffff) << 8);
    *ptr2 = (int*)(*ptr2 + (int)ptr2);
    ptr2 = (unsigned int)*(ptr0 + 1) | ((unsigned int)(int*)((int)(int*)((int)ptr2 >>> 8) & 0xffffff) << 8);
    *ptr2 = (int*)(*ptr2 + (int)ptr2);
    ptr2 = (unsigned int)*(char*)0x7400012E | ((unsigned int)(int*)((int)(int*)((int)ptr2 >>> 8) & 0xffffff) << 8);
    *ptr2 = (int*)(*ptr2 + (int)ptr2);
    *ptr2 = (int*)(*ptr2 + (int)ptr2);
    return *(ptr1 - 8) * 2 + 1;
}
...
long long* sub_8060370(int param0, int param1) {
    int v0;
    int* ptr0;
    int v1;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_80618CE(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
    ...
    do {
        ...
        if(!(unsigned char)result) {
            ...
            caml_code_area_start = caml_code_segments;
            unsigned int v10 = gvar_80739E0;
            caml_code_area_end = v10;
            unsigned int v11 = gvar_80739E4;
            if(v11) {
                unsigned int v12 = caml_code_area_start;
                int v13 = 1;
                do {
                    v12 = v11 >= v12 ? v12: v11;
                    unsigned int v14 = *(unsigned int*)(v13 * 8 + (int)&gvar_80739E0);
                    v10 = v14 > v10 ? v14: v10;
                    ++v13;
            ...
            caml_debugger_init();
            char* ptr1 = **(char***)(v5 + 8);
            char* __src1 = ptr1 ? ptr1: (char*)&gvar_8071D68;
    ...
    *(int*)((unsigned int)(v6 & 0xFF) * 4 + v4){sub_8061917}(param0, param1, (int)param2, (int)param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18);
    return result;
}

// Stale decompilation - Refresh this view to re-decompile this code
int sub_80618DF(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_80618ED(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_80618FB(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_8061909(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
...
int sub_8061917(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
    ...
    while((unsigned char)v6 > 39);
    *(int*)((unsigned int)(v6 & 0xFF) * 4 + v4){sub_8061917}();
    return result;
}

int sub_8061925(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
    ...
    while((unsigned char)v6 > 39);
    *(int*)((unsigned int)(v6 & 0xFF) * 4 + v4){sub_8061917}(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18);
    return result;
}

int sub_8061933(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int result;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_8061941(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    int v1;
    unsigned int v2;
    int v3;
    ...
    *(int*)((unsigned int)(result & 0xFF) * 4 + v4){sub_8061917}(param0, param1, (int)param2, (int)param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18);
    return result;
}

int sub_806194D(int param0, int param1, unsigned int param2, unsigned int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
    int v0;
    unsigned int v1;
    int v2;
    int v3;
    ...
    while((unsigned char)result > 39);
    *(int*)((unsigned int)(result & 0xFF) * 4 + v5){sub_8061917}(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18);
    return result;
}
...
int sub_806AE25(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    char* ptr0;
    int v1 = (int)*ptr0;
    intern_src = (int*)(ptr0 + 1);
...
int sub_806AE39(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    char* ptr0;
...
int sub_806AE58(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    char* ptr0;
...
int sub_806AE8A(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    intern_cleanup();
...
int sub_806AEBC(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    char* ptr0;
    intern_src = (unsigned int)(ptr0 + 2);
...
int sub_806AED3(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    char* ptr0;
    intern_src = (unsigned int)(ptr0 + 4);
...
// Stale decompilation - Refresh this view to re-decompile this code
char* sub_806AEFD(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    int v1;
    int v2;
    ...
    while(v6) {
        ...
        *ptr0 = v6 * 0x400 + intern_color + v5;
        ...
        if(v11 > 127) {
            ...
            *(int*)((unsigned int)(v5 & 0xFF) * 4 + v0){sub_806AE25|sub_806AE39|sub_806AE58|sub_806AE8A|sub_806AEBC|sub_806AED3|sub_806AEFD|sub_806AF50|sub_806AF7C|sub_806B03B|sub_806B150}(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20, param21, param22);
            return result;
        }
        else {
            intern_cleanup();
    ...
    v0 = v5 * 4 + &gvar_8083504;
    **(int**)(v2 - 60) = v0;
    jump param22;
}

// Stale decompilation - Refresh this view to re-decompile this code
int sub_806AF2F(unsigned int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    intern_cleanup();
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_806AF50(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    char* ptr0;
    int v0;
    intern_src = (unsigned int)(ptr0 + 4);
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_806AF7C(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    int v0;
    int v1;
    void* __dest = (void*)(intern_dest + 4);
    unsigned int v2 = intern_obj_table;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_806B03B(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    char* ptr0;
    int v0;
    int v1;
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_806B150(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    char* ptr0;
    int v0;
    int v1;
    intern_src = (unsigned int)(ptr0 + 4);
...
// Stale decompilation - Refresh this view to re-decompile this code
int sub_806B181(unsigned int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    char* ptr0;
    int v0;
    intern_src = (unsigned int)(ptr0 + 4);
...
int sub_806B211(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    char* ptr0;
    int v0;
    intern_src = (unsigned int)(ptr0 + 4);
...
int sub_806B24E(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20, int param21, int param22) {
    char* __s2;
    char v0;
    int v1;
...
int sub_807040D(int param0, int param1) {
    int v0;
    int result;
    caml_gc_regs = &v0;
...
int sub_807056E(unsigned int param0, unsigned int param1, int param2, int param3, int param4, int param5, int param6) {
    unsigned int v0;
...
int unix_getsockopt_aux(int param0, unsigned int param1, int __level, int __optname, int param4) {
    ...
    if(param1 <= 4) {
        /*BAD_CALL!*/ &_GLOBAL_OFFSET_TABLE_ - *(int*)(param1 * 4 + &sub_8060324){sub_8060344|sub_8060370|sub_8060388}(v2);
    }
            ...
            if(v2 == 1) {
                ...
                if(v2 == 2) {
                    ...
                    *(int*)v3 = 19201;
                    ...
                    loc_8060EBF:
                        *(int*)v3 = *(unsigned int*)((int)(int*)((int)ptr0 * 8) + (int)&gvar_8070F84) * 2 + 1;
                    }
                }
                else if(v2 == 3) {
                    int v11 = *ptr1;
                    ++ptr1;
                    *(int*)v3 = (unsigned int)*(char*)(v11 + 134728593) * 2 + 1;
                }
                else if(v2 <= 1 && !v2) {
    ...
    loc_8060B83:
        ...
        if(v5 == 2) {
            ...
            if(v5 == 3) {
                int v7 = *ptr1;
                ++ptr1;
                *(char*)(v7 + 134728593) = (unsigned char)(*ptr2 >>> 1);
            }
            goto loc_8060CE5;
        }
        else {
