...

{
  ...
  while( true ) {
    ...
    if (uVar1 < 4) break;
    if (uVar1 == 0x2f) goto LAB_0804b650;
    param_1 = param_1 + 2;
  }
  if (uVar1 != 1) {
...
void FUN_0804cb60(undefined4 param_1,undefined4 param_2)
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0804f135;
    }
    else if (0x74 < uVar2) {
LAB_0804f135:
...

{
  ...
  while (uVar1 = (uint)*(byte *)(*(int *)(unaff_EBX + 8) + (param_1 >> 1)) * 2 + 1, 0x60 < uVar1) {
    if (0x74 < uVar1) goto LAB_08058d10;
    param_1 = param_1 + 2;
  }
  if (uVar1 == 0x49) {
    return param_1 + 2;
...
switchD_0805ab0f_caseD_b2:
    ...
    case 0x1de:
    case 0x1e0:
      goto switchD_0805adad_caseD_40;
    case 0x1b0:
    case 0x1b2:
    case 0x1b6:
    case 0x1b8:
    ...
    case 0x1c6:
    case 0x1cc:
      goto switchD_0805adad_caseD_42;
    case 0x1c2:
...
LAB_0806644d:
        ...
        else if ((cStack_55 != 'u') && (cStack_55 != 'x')) goto LAB_0806644d;
      }
      sprintf(pcVar6,acStack_34);
LAB_08066462:
      ppcVar3 = (code **)caml_copy_string();
...
LAB_080609ef:
          ...
          do {
            if ((int)*param_3 >> 1 == (&DAT_08070d24)[iVar1 * 2]) goto LAB_080609ef;
            iVar1 = iVar1 + 1;
          } while (iVar1 != 0x12);
          unix_error(0x16,"tcsetattr",0);
...
LAB_08060c01:
      ...
      *piVar8 = 0x4b01;
      ...
      if (sVar6 == 1) {
        iVar3 = 0;
LAB_08060c54:
        *piVar8 = (&DAT_08070d24)[iVar3 * 2] * 2 + 1;
      }
      else {
        do {
          if ((&speedtable)[iVar3 * 2] == sVar6) goto LAB_08060c54;
          iVar3 = iVar3 + 1;
        } while (iVar3 != 0x12);
      }
    }
...

{
  ...
  local_5c = 1;
  local_54 = &local_40;
  pcStack_80 = (code *)0x806ba9e;
  piVar3 = __errno_location();
  pcStack_80 = (code *)0x806baa8;
  pcStack_84 = strerror(*piVar3);
  if (param_1 == (void *)0x1) {
    pcStack_80 = (code *)0x806baba;
