...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_00641680 = (undefined *)&camlUnix__50;
...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_00645a00 = (undefined *)&camlPervasives__7;
  ...
  unaff_R15[7] = 0x400;
  *DAT_00645a48 = (undefined *)DAT_00645918;
...

{
  ...
  *puVar9 = uVar4;
  ...
  if (in_RAX <= (long)uVar1) {
    ...
    *(undefined8 *)(uVar7 - 0x18) = 0x800;
    *(undefined8 *)(uVar7 - 0x10) = DAT_006470e8;
...

{
  ...
  plVar4 = (long *)FUN_004122f4();
  if (*plVar4 != DAT_006470e8) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar1 = plVar4[1];
...

{
  ...
  if (in_RAX != 0xb9) {
    lVar5 = in_RAX >> 1;
    uVar6 = SEXT48(*(int *)(lVar5 * 4 + 0x4356f0));
    switch(in_RAX) {
    case 0x10:
    case 0x11:
      return &camlChar__8;
    ...
    case 0x1c:
      ...
      bVar9 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,0xffffffffffbca90f < uVar6);
      *pcVar1 = (*pcVar1 - 1U) + (0xffffffffffbca90f < uVar6);
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      bVar10 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,bVar9);
      *pcVar1 = (*pcVar1 - 1U) + bVar9;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      bVar9 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,bVar10);
      *pcVar1 = (*pcVar1 - 1U) + bVar10;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      bVar10 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,bVar9);
      *pcVar1 = (*pcVar1 - 1U) + bVar9;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      ...
      *pcVar1 = (*pcVar1 - 1U) + bVar9;
      ...
      cVar2 = *pcVar1;
      cVar3 = *pcVar1;
      *pcVar1 = (cVar3 - 1U) + bVar10;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      *pcVar1 = *pcVar1 + -1 + (cVar2 != '\0' || CARRY1(cVar3 - 1U,bVar10));
      *(int *)(&UNK_004356e6 + (long)(&stack0x00000000 + uVar6)) =
           *(int *)(&UNK_004356e6 + (long)(&stack0x00000000 + uVar6)) + 1;
      (**(code **)(uVar6 + 0x14))();
    ...
    lVar7 = caml_c_call();
    if (lVar7 != 1) {
      puVar8 = (undefined *)caml_c_call(3);
      *puVar8 = (char)lVar5;
      return puVar8;
    }
    puVar8 = (undefined *)caml_c_call(9);
    *puVar8 = 0x5c;
    lVar7 = in_RAX >> 0x3f;
    puVar8[1] = (char)(SUB168(CONCAT88(lVar7,lVar5) / SEXT816(100),0) * 2 + 0x61 >> 1);
    auVar4 = CONCAT88(lVar7,lVar5) / SEXT816(10);
    puVar8[2] = (char)(SUB168((ZEXT816((ulong)(SUB168(auVar4,0) >> 0x3f)) << 0x40 |
                              auVar4 & (undefined  [16])0xffffffffffffffff) % SEXT816(10),0) * 2 +
                       0x61 >> 1);
    puVar8[3] = (char)(SUB168(CONCAT88(lVar7,lVar5) % SEXT816(10),0) * 2 + 0x61 >> 1);
    return puVar8;
  }
  return &camlChar__7;
}
...
LAB_0041b180:
    ...
    if (uVar3 == 0) goto LAB_0041b194;
    if (uVar3 == 1) goto LAB_0041b180;
    if (1 < (long)uVar3) goto LAB_0041b1bc;
  }
  if (uVar3 != 1) {
LAB_0041b1bc:
...

{
  ...
  do {
    ...
    uVar2 = SEXT48((int)(&switchD_0041bbef::switchdataD_00435910)[lVar5 >> 1]);
    switch(lVar5) {
    default:
    ...
    case 0xf7:
      ...
      *(long *)(uVar2 - 8) = lVar5;
      ...
      break;
    case 0xfc:
      *(char *)(uVar2 - 0x7d) = (*(char *)(uVar2 - 0x7d) - in_AL) - (0xffffffffffbca6ef < uVar2);
      return uVar2;
    }
  } while( true );
}
...
code_r0x0041d23b:
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
         (*(char *)((long)piVar6 + -0x75) - cVar11) - ((int *)0xffffffffffbca473 < piVar6);
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar11;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d6e7) = (ulong)(iVar1 + 0x221a2b);
    *(undefined8 *)(piVar6 + 0x10d6e9) = 0x10f9;
    *(code **)(piVar6 + 0x10d6eb) = caml_curry2;
  case 0x1e4:
    *(undefined8 *)(piVar6 + 0x10d6ed) = 5;
    *(code **)(piVar6 + 0x10d6ef) = camlPrintf__scan_conv_171;
    *(undefined8 *)(piVar6 + 0x10d6f1) = 0x20f9;
    *(code **)(piVar6 + 0x10d6f3) = camlPrintf__scan_fmt_172;
    *(undefined8 *)(piVar6 + 0x10d6f5) = 3;
    *(code ***)(piVar6 + 0x10d6f7) = in_RAX;
    *(code ***)(piVar6 + 0x10d6f9) = unaff_RBX;
    *(code ***)(piVar6 + 0x10d6fb) = param_1;
    *(uint **)(piVar6 + 0x10d6fd) = param_4;
  ...
  case 0x1f2:
    if (puVar13 != (uint *)0x0) {
      ...
      halt_baddata();
                    ...
                    // WARNING: Treating indirect jump as call
    uVar5 = (**(code **)((long)piVar6 + -0x5f00018d))((ulong)in_RAX & 0xffffffff);
    return uVar5;
  }
...
code_r0x0041cd3c:
  ...
  *(int **)((long)pppcVar14 + 0x20) = piVar6;
  puVar13 = &switchD_0041cd5f::switchdataD_00435bf4;
  piVar6 = (int *)(long)(int)(&switchD_0041cd5f::switchdataD_00435bf4)[(long)param_1 >> 1];
...

{
  ...
  case 0xdd:
    ...
    case 0xf0:
      local_30 = param_2 + 2;
      uVar8 = lVar4 - 0xd7;
      if ((uVar8 < 6) && (lVar4 = (long)uVar8 >> 1, lVar4 != 1)) {
        if (lVar4 < 2) {
          local_38 = camlPrintf__get_arg_320(*(undefined8 *)(param_3 + 0x50));
  ...
  case 0xf8:
    plVar6 = (long *)(ulong)((int)register0x00000020 - 0x38U &
                            *(uint *)((long)&switchD_0041cd5f::switchdataD_00435bf4 +
                                     (long)(int)(&switchD_0041cd5f::switchdataD_00435bf4)
                                                [local_38 >> 1]));
    pcVar1 = (char *)((long)(int)(&switchD_0041cd5f::switchdataD_00435bf4)[local_38 >> 1] + -0x75);
  ...
  *(undefined8 *)((long)plVar7 + -8) = 0x41d191;
  (*pcVar2)(pcVar2);
LAB_0041d191:
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  unaff_R15[8] = 0x1800;
  *DAT_0064b9c8 = (undefined *)&camlPrintf__38;
...
LAB_00424abb:
  ...
  if (puVar1 != (ulong *)0x0) goto code_r0x00424ac5;
  goto LAB_00424aca;
code_r0x00424ac5:
  if (param_2 <= *puVar1) {
LAB_00424aca:
...
LAB_00424c8b:
    ...
    if (puVar2 != (ulong *)0x0) goto code_r0x00424c95;
    goto LAB_00424c9a;
  }
LAB_00424cb0:
...
LAB_0042606a:
        ...
        while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
          iVar16 = iVar16 + 1;
          if (flp_size <= iVar16) goto LAB_0042606a;
          plVar13 = *pplVar6;
          pplVar6 = pplVar6 + 1;
      ...
      do {
        do {
          plVar12 = plVar10;
          if (plVar12 == plVar13) goto LAB_004261eb;
...
LAB_004271e0:
  ...
  if ((uVar3 & 7) != 0) goto code_r0x00427294;
  goto LAB_004272b5;
code_r0x00427294:
  ppuVar4 = param_1;
...
LAB_0042dfae:
    if (0xffffffff < lVar4) goto LAB_0042e097;
  }
...
LAB_0042ea46:
    if (uVar12 != 0) goto code_r0x0042ea4f;
        ...
        if (0 < iVar6) {
          if (*pcVar9 != '\0') {
            ...
            do {
              ...
              if ((iVar6 + -1) - iVar7 < 1) goto LAB_004308fd;
              iVar7 = iVar7 + 1;
            } while (*pcVar9 != '\0');
          }
      ...
      if (bVar1 != 0) {
        if (*pcVar9 != '\0') {
          ...
          do {
            sVar4 = strlen(pcVar9);
            pcVar9 = pcVar9 + sVar4 + 1;
            if (bVar1 - 1 == iVar6) goto LAB_00430a02;
            iVar6 = iVar6 + 1;
          } while (*pcVar9 != '\0');
        }
        pcVar9 = "<unknown token>";
...
LAB_00430488:
    ...
    do {
      ...
      if (((-1 < iVar7) && (sVar2 != 0)) && (iVar7 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar8 = (long)iVar7;
        lVar3 = lVar8 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar8 * 2) == 0x100) goto LAB_00430a78;
      }
      if (iVar6 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar6 != 0) {
    ...
    if (param_3 < uVar5) goto LAB_004322da;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_0043375c;
      }
...
LAB_0043391e:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_004339b3;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_004339b3;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_004339b3:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_0043391e;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_00433c0b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_00433c0b:
