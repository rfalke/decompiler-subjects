...

{
  ...
  for (; param_2 != 1; param_2 = (param_2 - lVar1) + 1) {
...

{
  ...
  while( true ) {
    ...
    if ((ulong)*(byte *)(in_RAX + (unaff_RBX >> 1)) * 2 + 1 !=
        (ulong)*(byte *)(camlSource + (unaff_RBX >> 1)) * 2 + 1) break;
...

{
  ...
  plVar2 = (long *)FUN_0040ae14();
  if ((undefined **)*plVar2 == &caml_exn_Failure) {
    plVar2 = (long *)FUN_0040ad98();
...

{
  ...
  *(undefined8 *)(uVar6 - 8) = unaff_RBX;
  ...
  if (lVar4 == 1) {
    plVar5 = (long *)FUN_0040c98c();
    if ((undefined **)*plVar5 != &caml_exn_Failure) {
                    // WARNING: Subroutine does not return
      caml_raise_exn();
    }
    plVar5 = (long *)FUN_0040c910();
    ...
    if (lVar4 == 1) {
      ...
      *(undefined8 *)(uVar6 - 0x30) = 0x800;
      *(undefined8 *)(uVar6 - 0x28) = DAT_006418c0;
      ...
      *(undefined8 *)(uVar7 - 0x28) = DAT_006418b8;
...

{
  ...
  *(undefined8 *)(unaff_R15 - 0x30) = 0x800;
  *(undefined8 *)(unaff_R15 - 0x28) = DAT_006418c0;
...

{
  ...
  *camlUnix = camlUnix__64;
  ...
  caml_allocN();
  DAT_00641680 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_00641680 = &camlUnix__50;
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0040fb62;
    }
    else if (0x74 < uVar2) {
LAB_0040fb62:
...

{
  ...
  *DAT_006457c8 = camlPervasives__65;
  ...
  caml_allocN();
  DAT_00645a00 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_00645a00 = &camlPervasives__7;
  ...
  DAT_00645a48 = unaff_R15 + 8;
  unaff_R15[7] = 0x400;
  *DAT_00645a48 = DAT_00645918;
...

{
  ...
  if (in_RAX != 0xb9) {
    lVar7 = in_RAX >> 1;
    uVar8 = (ulong)(int)(&switchD_00416b24::caseD_1c)[lVar7];
    switch(in_RAX) {
    case 0x10:
    case 0x11:
      return &camlChar__8;
    ...
    case 0x1c:
      ...
      bVar11 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,0xffffffffffbca90f < uVar8);
      *pcVar1 = (*pcVar1 - 1U) + (0xffffffffffbca90f < uVar8);
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      bVar12 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,bVar11);
      *pcVar1 = (*pcVar1 - 1U) + bVar11;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      bVar11 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,bVar12);
      *pcVar1 = (*pcVar1 - 1U) + bVar12;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      bVar12 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,bVar11);
      *pcVar1 = (*pcVar1 - 1U) + bVar11;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      ...
      *pcVar1 = (*pcVar1 - 1U) + bVar11;
      ...
      cVar2 = *pcVar1;
      cVar3 = *pcVar1;
      *pcVar1 = (cVar3 - 1U) + bVar12;
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      *pcVar1 = *pcVar1 + -1 + (cVar2 != '\0' || CARRY1(cVar3 - 1U,bVar12));
      *(int *)(&UNK_004356e6 + (long)(&stack0x00000000 + uVar8)) =
           *(int *)(&UNK_004356e6 + (long)(&stack0x00000000 + uVar8)) + 1;
      (**(code **)(uVar8 + 0x14))();
    ...
    lVar9 = caml_c_call();
    if (lVar9 != 1) {
      puVar10 = (undefined *)caml_c_call(3);
      *puVar10 = (char)lVar7;
      return puVar10;
    }
    puVar10 = (undefined *)caml_c_call(9);
    *puVar10 = 0x5c;
    lVar9 = in_RAX >> 0x3f;
    auVar4._8_8_ = lVar9;
    auVar4._0_8_ = lVar7;
    puVar10[1] = (char)(SUB168(auVar4 / SEXT816(100),0) * 2 + 0x61 >> 1);
    auVar5._8_8_ = lVar9;
    auVar5._0_8_ = lVar7;
    puVar10[2] = (char)((SUB168(auVar5 / SEXT816(10),0) % 10) * 2 + 0x61 >> 1);
    auVar6._8_8_ = lVar9;
    auVar6._0_8_ = lVar7;
    puVar10[3] = (char)(SUB168(auVar6 % SEXT816(10),0) * 2 + 0x61 >> 1);
    return puVar10;
  }
  return &camlChar__7;
}
  ...
  *plVar1 = 1;
  ...
  if (0 < lVar8) {
    ...
    do {
      ...
      if (uVar6 < 0x1d) {
        if (uVar6 < 0x17) {
          if (0x10 < uVar6) goto LAB_004173b8;
          goto LAB_0041738e;
        }
        if (uVar6 < 0x1b) goto LAB_0041738e;
LAB_004173b8:
        lVar5 = 5;
      }
      else {
        if ((uVar6 == 0x45) || (uVar6 == 0xb9)) goto LAB_004173b8;
LAB_0041738e:
        lVar5 = caml_c_call();
        if (lVar5 == 1) {
          lVar5 = 9;
...
switchD_004174d0_caseD_0:
      ...
      case 0x1a:
        ...
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x72;
        break;
      default:
        if (lVar7 - 0x45U < 0x72) goto switchD_004174d0_caseD_0;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(char *)(lVar5 + (*plVar1 >> 1)) = (char)uVar6;
      }
...

{
  ...
  DAT_0064a000 = *puVar1;
  DAT_0064a018 = (2L << ((byte)(DAT_0064a008 + -0x14 >> 1) & 0x3f)) + -1;
...

{
  ...
  while (uVar1 = (ulong)*(byte *)(*(long *)(unaff_RBX + 0x10) + (in_RAX >> 1)) * 2 + 1, 0x60 < uVar1
    ...
    if (0x74 < uVar1) goto LAB_0041b0e4;
    in_RAX = in_RAX + 2;
  }
  if (uVar1 == 0x49) {
    return in_RAX + 2;
...
LAB_0041b89c:
    ...
    if (uVar2 != 0x5b) goto LAB_0041b89c;
    unaff_RBX = unaff_RBX + 2;
    in_RAX = 3;
  } while( true );
}
...

{
  ...
  do {
    ...
    uVar2 = (ulong)(int)(&switchD_0041bbef::switchdataD_00435910)[lVar5 >> 1];
    switch(lVar5) {
    default:
...
switchD_0041bec4_caseD_42:
  ...
  uVar1 = (&switchD_0041bec4::caseD_1f0)[lVar2 + -0x3f >> 1];
  piVar6 = (int *)(long)(int)uVar1;
  puVar14 = (uint *)(piVar6 + 0x10d6e3);
  cVar3 = (char)uVar1;
  ...
  case 0x138:
    ...
    *pcVar8 = *pcVar8 + (char)pcVar8;
    ppcStack_20 = (code **)0x41d1ef;
    local_18 = (code **)caml_c_call(pcVar8,in_RAX);
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41d221;
      (***(code ***)(DAT_0064b9c8 + 0x10))();
    }
...
code_r0x0041d23b:
  ...
  case 0x11a:
  case 0x15a:
    ppcStack_20 = (code **)0x41cf44;
    local_18 = (code **)camlPrintf__get_arg_320();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41cf75;
      (***(code ***)(DAT_0064b9c8 + 0x10))();
    }
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
         (*(char *)((long)piVar6 + -0x75) - cVar12) - ((int *)0xffffffffffbca473 < piVar6);
    ppcStack_20 = (code **)0x41ce2f;
    camlPrintf__extract_format_float_138(param_1,CONCAT44(unaff_retaddr_00,unaff_retaddr));
    ppcStack_20 = (code **)0x41ce39;
    local_18 = (code **)camlPrintf__fun_630();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41ce69;
      (***(code ***)(DAT_0064b9c8 + 0x10))();
    }
    uVar5 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28)
                       );
    return uVar5;
  case 0x15c:
    ppcStack_20 = (code **)0x41cedf;
    local_10 = (code **)camlPrintf__get_arg_320(piVar6[0x14]);
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41cf11;
      (***(code ***)(DAT_0064b9c8 + 0x10))();
    }
  ...
  case 0x1aa:
    if (in_RAX == (code **)0xc7) {
      ppcStack_20 = (code **)0x41d09b;
      local_18 = (code **)camlString__make_66();
    }
    else {
      ppcStack_20 = (code **)0x41d0ac;
      camlChar__escaped_66();
      ppcStack_20 = (code **)0x41d0b8;
      camlPervasives___5e_136();
      ppcStack_20 = (code **)0x41d0c7;
      local_18 = (code **)camlPervasives___5e_136();
    }
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41d0f9;
      (***(code ***)(DAT_0064b9c8 + 0x10))();
    }
    uVar5 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28)
                       );
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar12;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d6e7) = (ulong)(uVar1 + 0x221a2b);
...
code_r0x0041cd3c:
  ...
  *(int **)((long)pppcVar15 + 0x20) = piVar6;
  puVar14 = &switchD_0041cd5f::switchdataD_00435bf4;
...
switchD_0041bec4_caseD_1ae:
  ppcStack_20 = (code **)0x41d3a1;
  local_18 = (code **)camlPrintf__get_arg_320(param_1);
  ppcStack_20 = (code **)0x41d3c1;
  uVar5 = camlPrintf__extract_format_113(local_10,local_8);
  ppcStack_20 = (code **)0x41d3d4;
  local_18 = (code **)caml_c_call(uVar5,local_18);
LAB_0041d46b:
  if (param_7 == 1) {
    ppcStack_20 = (code **)0x41d499;
    (***(code ***)(DAT_0064b9c8 + 0x10))();
  }
...

{
  ...
  case 0xc3:
    local_38 = camlPrintf__get_arg_320(*(undefined8 *)(param_3 + 0x50));
    local_28 = (***(code ***)(DAT_0064b9c8 + 0x10))();
    local_30 = camlPrintf__get_arg_320(*(undefined8 *)(param_3 + 0x50));
    if (local_18 == 1) {
      (***(code ***)(DAT_0064b9c8 + 0x10))();
    }
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  DAT_0064b9c8 = unaff_R15 + 9;
  unaff_R15[8] = 0x1800;
  *DAT_0064b9c8 = &camlPrintf__38;
  ...
  *DAT_0064ba78 = caml_curry2;
  ...
  ppuVar5 = DAT_0064ba58;
  ppuVar4 = DAT_0064ba40;
...
LAB_00423018:
          iVar1 = *(int *)ppuVar6;
          ppuVar6 = ppuVar5 + 2;
          *(char *)((long)iVar1 + 0x64e431) = (char)((long)*param_3 >> 1);
        }
      }
      else {
    ...
    if (puVar9 == (uint *)0x1) {
      ...
      if (0 < iVar5) {
        ...
        while ((uint *)(long)(int)((uint)*ppuVar2 & **ppuVar4) != puVar9) {
          iVar6 = iVar6 + 1;
          if (iVar5 <= iVar6) goto LAB_0042319f;
          ppuVar3 = ppuVar10 + 6;
          ppuVar10 = ppuVar10 + 1;
          puVar9 = *ppuVar3;
        }
...
LAB_0042319f:
      ...
      *plVar12 = 0x4b01;
      ...
      puVar9 = &UINT_00436308;
      iVar5 = 1;
      ppuVar4 = ppuVar10 + 2;
      if (uVar7 == 1) {
        iVar5 = 0;
LAB_004231fa:
        *plVar12 = (long)(int)(&UINT_00436304)[(long)iVar5 * 2] * 2 + 1;
      }
      else {
        do {
          if (*puVar9 == uVar7) goto LAB_004231fa;
          iVar5 = iVar5 + 1;
          puVar9 = puVar9 + 2;
        } while (iVar5 != 0x12);
      }
      ...
      *plVar12 = (ulong)*(byte *)((long)*(int *)ppuVar4 + 0x64e431) * 2 + 1;
      ppuVar4 = ppuVar10 + 2;
    }
    ppuVar10 = ppuVar4;
    puVar9 = *ppuVar10;
        ...
        do {
          ...
          if (999 < iVar16) {
            ...
            while( true ) {
              ...
              puVar9 = puVar3;
              if ((*(ulong *)(*DAT_006527d8 + -8) >> 10 <= (ulong)puVar3[-1] >> 10) &&
...
LAB_004261eb:
    if (iVar19 + flp_size < 0x3ea) {
      if ((iVar19 == 1) ||
         (memmove(&flp + (iVar19 + iVar16),&DAT_006508a8 + iVar16,
...

{
  ...
  if (caml_young_ptr != caml_young_end) {
    ...
    if (caml_ref_table < DAT_00652878) {
      do {
        puVar1 = (undefined8 *)*puVar8;
        puVar8 = puVar8 + 1;
        caml_oldify_one(*puVar1,puVar1);
      } while (puVar8 < DAT_00652878);
    }
    caml_oldify_mopup();
    ...
    for (ppuVar6 = caml_weak_ref_table; ppuVar6 < DAT_006528b8; ppuVar6 = ppuVar6 + 1) {
      puVar2 = *ppuVar6;
      puVar3 = (ulong *)*puVar2;
...

{
  ...
  uVar2 = (param_1 >> 0xc) * -0x61c8864680b583ea >> ((byte)DAT_00652908 & 0x3f);
  uVar1 = *(ulong *)(DAT_00652920 + uVar2 * 8);
  while( true ) {
    if (((uVar1 ^ param_1) & 0xfffffffffffff000) == 0) {
      return (uint)uVar1 & 0xff;
    }
    if (uVar1 == 0) break;
    uVar2 = uVar2 + 1 & DAT_00652910;
    uVar1 = *(ulong *)(DAT_00652920 + uVar2 * 8);
  }
  return 0;
}
  ...
  *param_1 = param_2;
  ...
  if ((uVar2 & 1) != 0) {
    ...
    if (((((param_2 & 1) == 0) && (param_2 < caml_young_end)) && (caml_young_start < param_2)) &&
      ...
      if (_DAT_00652880 <= DAT_00652878) {
        caml_realloc_ref_table(&caml_ref_table);
      }
      *DAT_00652878 = param_1;
      DAT_00652878 = DAT_00652878 + 1;
    }
  }
  return;
}
...

{
  ...
  if (caml_page_table <= (ulong)(_DAT_00652918 * 2)) {
  ...
  uVar6 = (param_1 >> 0xc) * -0x61c8864680b583ea >> ((byte)DAT_00652908 & 0x3f);
  puVar1 = (ulong *)((long)DAT_00652920 + uVar6 * 8);
  uVar2 = *puVar1;
  while( true ) {
    if (uVar2 == 0) {
      *puVar1 = (long)param_3 | param_1;
      _DAT_00652918 = _DAT_00652918 + 1;
      return 0;
    }
    if (((uVar2 ^ param_1) & 0xfffffffffffff000) == 0) break;
    uVar6 = uVar6 + 1 & DAT_00652910;
    puVar1 = (ulong *)((long)DAT_00652920 + uVar6 * 8);
    uVar2 = *puVar1;
  }
...

{
  ...
  if (1 < uVar1) {
    ...
    DAT_00652910 = uVar2 - 1;
    caml_page_table = uVar2;
    DAT_00652908 = iVar3;
  }
  _DAT_00652918 = 0;
  DAT_00652920 = calloc(caml_page_table,8);
  return -(uint)(DAT_00652920 == (void *)0x0);
}
...

{
  ...
  plVar1 = &DAT_006584c8 + (param_2 & 0xffffffff);
  if (param_1 != 0) {
...
LAB_00429517:
    ...
    if (pcVar8 == param_1 + lVar6) {
      if (iVar9 == 10) {
        if (uVar3 <= (ulong)(1L << ((byte)param_2 - 1 & 0x3f))) goto LAB_00429544;
      }
    ...
    for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
      ...
      while( true ) {
        ...
        *pplVar4 = (long *)((ulong)plVar15 & 0xfffffffffffffc00 | 0x3f3);
        pplVar4 = pplVar4 + ((ulong)plVar15 >> 10) + 1;
        if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar4) goto LAB_0043375c;
      }
...
LAB_0043391e:
          ...
          pplVar13 = pplVar6;
          if (0x20 < uVar17) goto LAB_004339b3;
          pplVar11 = (long **)pplVar6[-1];
          if (0x20 < (ulong)((long)pplVar11[-2] - (long)pplVar11[-3])) goto LAB_004339b3;
          do {
            pplVar6 = pplVar11;
            pplVar11 = (long **)pplVar6[-1];
            pplVar13 = pplVar6;
...
LAB_004339b3:
          ...
          *pplVar4 = (long *)(lVar18 * 0x400 + -0x400 + (ulong)uVar3);
          ...
          uVar3 = (uint)uVar17;
          if ((char)uVar17 == -7) goto LAB_0043391e;
    ...
    do {
      ...
      for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
        ...
        while (plVar15 = *pplVar4, ((ulong)plVar15 & 0x300) == 0) {
          ...
          pplVar4 = pplVar14;
          if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar14) goto LAB_00433c0b;
        }
      }
LAB_00433c0b:
...
undefined  [16] FUN_0043510b(undefined8 param_1,undefined8 param_2,undefined8 param_3)
