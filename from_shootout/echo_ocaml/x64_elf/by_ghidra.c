...
LAB_0043391e:
          ...
          pplVar11 = pplVar5;
          if (0x20 < uVar15) goto LAB_004339b3;
          pplVar14 = (long **)pplVar5[-1];
          if (0x20 < (ulong)((long)pplVar14[-2] - (long)pplVar14[-3])) goto LAB_004339b3;
          do {
            pplVar5 = pplVar14;
            pplVar14 = (long **)pplVar5[-1];
            pplVar11 = pplVar5;
...
LAB_004339b3:
          ...
          *pplVar3 = (long *)(lVar16 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar15;
          if ((char)uVar15 == -7) goto LAB_0043391e;
    ...
    do {
      ...
      for (pplVar3 = pplVar8; pplVar3 < (long **)((long)pplVar8 + (long)plVar1);
        ...
        while (plVar13 = *pplVar3, ((ulong)plVar13 & 0x300) == 0) {
          ...
          pplVar3 = pplVar12;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar12) goto LAB_00433c0b;
        }
      }
LAB_00433c0b:
