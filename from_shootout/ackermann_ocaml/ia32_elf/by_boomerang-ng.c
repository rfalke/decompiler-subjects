...
__size32 caml_raise_out_of_memory(int param1, __size32 param2, __size32 param1)
{
    ...
    union { __size32; __size32 *; } esp_71; 		// r28{197}
    union { __size32; __size32 *; } esp_72; 		// r28{197}
    __size32 esp_73; 		// r28{230}
    __size32 esp_74; 		// r28{230}
    ...
    int local105; 		// tmpb{282}
    int local106; 		// tmpb{282}
    int local107; 		// tmpb{233}
    ...
    __size32 local142; 		// esp_58{154}
    int local143; 		// local98{156}
    __size16 local144; 		// local116{157}
    __size32 local145; 		// m[esp_50 - 4]{158}
    __size32 local146; 		// m[esp_50 - 28]{159}
    unsigned int local147; 		// m[esp_50 - 32]{160}
    ...
    __size32 local160; 		// esp_55{230}
    int local161; 		// local94{233}
    __size32 local162; 		// local17{234}
    __size32 local163; 		// local56{235}
    unsigned int local164; 		// local79{236}
    unsigned int local165; 		// ebx{255}
    union { __size32 *; __size32; } local166; 		// esp_49{256}
    ...
    __size32 local184; 		// esp{314}
    int local185; 		// local99{317}
    __size16 local186; 		// local117{318}
    __size32 local187; 		// local19{319}
    __size32 local188; 		// local55{320}
    unsigned int local189; 		// local78{321}
    __size32 local19; 		// m[esp_50 - 4]{319}
    __size32 local190; 		// esp_56{331}
    ...
    __size32 local21; 		// m[esp_50 - 4]{201}
    __size32 local22; 		// m[esp_50 - 4]{172}
    __size32 local23; 		// m[esp_50 - 4]{172}
    __size32 local24; 		// m[esp_50 - 4]{260}
    __size32 local25; 		// m[esp_50 - 4]{260}
    __size32 local26; 		// m[esp_50 - 4]{284}
    __size32 local27; 		// m[esp_50 - 4]{284}
    __size32 local28; 		// m[esp_50 - 4]{301}
    __size32 local29; 		// m[esp_50 - 4]{301}
    int local3; 		// m[esp - 64]
    __size32 local30; 		// m[esp_50 - 4]{336}
    ...
    __size32 local45; 		// m[esp_50 - 28]{285}
    __size32 local46; 		// m[esp_50 - 28]{285}
    __size32 local47; 		// m[esp_50 - 28]{261}
    __size32 local48; 		// m[esp_50 - 28]{261}
    __size32 local49; 		// m[esp_50 - 28]{302}
    __size32 local5; 		// m[esp_50 - 4]{7}
    __size32 local50; 		// m[esp_50 - 28]{302}
    __size32 local51; 		// m[esp_50 - 28]{337}
    __size32 local52; 		// m[esp_50 - 28]{337}
    __size32 local53; 		// m[esp_50 - 28]{202}
    __size32 local54; 		// m[esp_50 - 28]{202}
    __size32 local55; 		// m[esp_50 - 28]{320}
    __size32 local56; 		// m[esp_50 - 28]{235}
    __size32 local57; 		// m[esp_50 - 28]{235}
    __size32 local58; 		// m[esp_50 - 28]{235}
    __size32 local59; 		// m[esp_50 - 28]{173}
    __size32 local6; 		// m[esp_50 - 4]{7}
    __size32 local60; 		// m[esp_50 - 28]{173}
    ...
    unsigned int local74; 		// m[esp_50 - 32]{174}
    unsigned int local75; 		// m[esp_50 - 32]{174}
    unsigned int local76; 		// m[esp_50 - 32]{286}
    unsigned int local77; 		// m[esp_50 - 32]{286}
    unsigned int local78; 		// m[esp_50 - 32]{321}
    unsigned int local79; 		// m[esp_50 - 32]{236}
    __size32 local8; 		// m[esp_50 - 4]{172}
    unsigned int local80; 		// m[esp_50 - 32]{236}
    unsigned int local81; 		// m[esp_50 - 32]{236}
    unsigned int local82; 		// m[esp_50 - 32]{338}
    unsigned int local83; 		// m[esp_50 - 32]{338}
    unsigned int local84; 		// m[esp_50 - 32]{262}
    unsigned int local85; 		// m[esp_50 - 32]{262}
    unsigned int local86; 		// m[esp_50 - 32]{203}
    unsigned int local87; 		// m[esp_50 - 32]{203}
    unsigned int local88; 		// m[esp_50 - 32]{303}
    unsigned int local89; 		// m[esp_50 - 32]{303}
...
bb0x8061b07:
    ...
    local98 = local143;
    local116 = local144;
    *(__size32*)(esp_50 - 4) = local145;
    *(__size32*)(esp_50 - 28) = local146;
    *(unsigned int*)(esp_50 - 32) = local147;
    local190 = esp_58;
    local191 = local98;
    local192 = local116;
    local193 = *(esp_50 - 4);
...
__size32 caml_raise(int param1, __size32 param2, __size32 param3, __size32 param4)
{
    ...
    __size32 local100; 		// m[esp_92 - 8]{261}
    __size32 local101; 		// m[esp_92 - 8]{261}
    int local102; 		// m[esp_92 - 32]{7}
    int local103; 		// m[esp_92 - 32]{7}
    int local104; 		// m[esp_92 - 32]{15}
    int local105; 		// m[esp_92 - 32]{15}
    int local106; 		// m[esp_92 - 32]{15}
    int local107; 		// m[esp_92 - 32]{262}
    int local108; 		// m[esp_92 - 32]{232}
    int local109; 		// m[esp_92 - 32]{280}
    __size32 local11; 		// m[esp_92 + 4]{233}
    int local110; 		// m[esp_92 - 32]{280}
    int local111; 		// m[esp_92 - 32]{322}
    int local112; 		// m[esp_92 - 32]{364}
    int local113; 		// m[esp_92 - 32]{401}
    int local114; 		// m[esp_92 - 32]{346}
    int local115; 		// m[esp_92 - 32]{328}
    int local116; 		// m[esp_92 - 32]{328}
    int local117; 		// m[esp_92 - 32]{401}
    ...
    int local2; 		// m[esp - 28]
    __size32 local20; 		// m[esp_92 + 4]{233}
    ...
    __size32 local21; 		// m[esp_92 + 4]{233}
    ...
    __size32 local22; 		// m[esp_92 + 4]{24}
    ...
    __size32 local282; 		// m[esp_92 - 8]{382}
    ...
    __size32 local52; 		// m[esp_92 - 4]{320}
    ...
    __size32 local57; 		// m[esp_92 - 4]{21}
                    ...
                    *(__size32*)(ebp - 36) = ebx;
                    ...
                    for(;;) {
                        ...
                        *(__size32*)(esp_67 + 4) = eax;
                        eax = *eax;
                        *(__size32*)esp_67 = eax;
                        (*ebx)((unsigned char) eax, cl, dl, eax, ecx, edx, ebx, ebp, esi, edi, <all>, flags, ZF, CF, local38, local73, local107, param2);
                        local245 = esp_58;
                        local247 = local40;
                        local248 = local75;
                        local249 = local109;
                    ...
                    if (*(esi + 8) > 0) {
                        do {
                            ...
                            *(__size32*)esp_79 = eax_12;
                            (**(ebp + 8))((unsigned char) eax_12, cl, dl, eax_12, ecx, edx, ebx, ebp, esi, edi, <all>, ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), local42, local77, local111, param2);
                            local258 = esp_61;
                            local259 = local46;
                            local260 = local81;
                            local261 = local115;
...
__size32 caml_raise_with_arg(int param1, __size32 param1, __size32 param2, __size32 param3)
{
    ...
    __size32 local268; 		// m[esp_68 - 68]{152}
    __size32 local269; 		// m[esp_68 - 68]{152}
    __size32 local27; 		// m[esp_68 + 4]{132}
    __size32 local270; 		// m[esp_68 - 68]{373}
    __size32 local271; 		// m[esp_68 - 68]{238}
    __size32 local272; 		// m[esp_68 - 68]{277}
    __size32 local273; 		// m[esp_68 - 68]{277}
    __size32 local274; 		// m[esp_68 - 68]{342}
    __size32 local275; 		// m[esp_68 - 68]{342}
    __size32 local276; 		// m[esp_68 - 68]{403}
    __size32 local277; 		// m[esp_68 - 68]{403}
    __size32 local278; 		// m[esp_68 - 68]{312}
    __size32 local279; 		// m[esp_68 - 68]{312}
    __size32 local28; 		// m[esp_68 + 4]{380}
    __size32 local280; 		// m[esp_68 - 68]{194}
    __size32 local281; 		// m[esp_68 - 68]{194}
    __size32 local282; 		// m[esp_68 - 68]{238}
    ...
    __size32 local297; 		// m[esp_68 - 72]{278}
    __size32 local298; 		// m[esp_68 - 72]{278}
    __size32 local299; 		// m[esp_68 - 72]{374}
    int local3; 		// m[esp - 36]
    ...
    __size32 local303; 		// m[esp_68 - 72]{313}
    __size32 local304; 		// m[esp_68 - 72]{313}
    __size32 local305; 		// m[esp_68 - 72]{239}
    __size32 local306; 		// m[esp_68 - 72]{239}
    __size32 local307; 		// m[esp_68 - 72]{404}
    __size32 local308; 		// m[esp_68 - 72]{404}
    __size32 local309; 		// m[esp_68 - 72]{153}
    ...
    __size32 local316; 		// m[esp_68 - 76]{196}
    __size32 local317; 		// m[esp_68 - 76]{154}
    int local318; 		// m[esp_68 - 76]{218}
    int local319; 		// m[esp_68 - 76]{218}
    __size32 local32; 		// m[esp_68 + 4]{410}
    __size32 local320; 		// m[esp_68 - 76]{279}
    __size32 local321; 		// m[esp_68 - 76]{344}
    __size32 local322; 		// m[esp_68 - 76]{405}
    __size32 local323; 		// m[esp_68 - 76]{314}
    ...
    __size32 local586; 		// local271{238}
    __size32 local587; 		// local300{239}
    ...
    __size32 local661; 		// local270{373}
    __size32 local662; 		// local299{374}
...
__size32 caml_raise_with_string(__size32 param1, __size32 param2)
{
    ...
    unsigned int local104; 		// m[esp_38 - 32]{135}
    ...
    __size32 local171; 		// esp_47{84}
    int local172; 		// local120{86}
    __size16 local173; 		// local146{87}
    __size32 local174; 		// local44{88}
    __size32 local175; 		// m[esp_38 - 28]{89}
    unsigned int local176; 		// m[esp_38 - 32]{90}
    __size32 local177; 		// esp_43{99}
    ...
    union { __size32 *; __size32; } local184; 		// esp_42{129}
    ...
    __size32 local190; 		// esp_45{162}
    int local191; 		// local116{165}
    __size32 local192; 		// local45{166}
    ...
    __size32 local44; 		// m[esp_38 - 4]{88}
...
__size8 caml_raise_constant(int param1, __size32 param1, __size32 param2)
{
    ...
    __size32 local105; 		// m[esp_2 - 36]{130}
    __size32 local106; 		// m[esp_2 - 36]{130}
    __size32 local107; 		// m[esp_2 - 36]{272}
    __size32 local108; 		// m[esp_2 - 36]{272}
    __size32 local109; 		// m[esp_2 - 36]{65}
    int local11; 		// m[esp - 104]
    __size32 local110; 		// m[esp_2 - 36]{173}
    __size32 local111; 		// m[esp_2 - 36]{329}
    __size32 local112; 		// m[esp_2 - 36]{329}
    __size32 local113; 		// m[esp_2 - 36]{173}
    __size32 local114; 		// m[esp_2 - 36]{173}
    __size32 local115; 		// m[esp_2 - 36]{90}
    __size32 local116; 		// m[esp_2 - 36]{90}
    __size32 local117; 		// m[esp_2 - 36]{210}
    __size32 local118; 		// m[esp_2 - 36]{210}
    __size32 local119; 		// m[esp_2 - 36]{244}
    int local12; 		// m[esp - 112]
    __size32 local120; 		// m[esp_2 - 36]{244}
    __size32 local121; 		// m[esp_2 - 40]{10}
    __size32 local122; 		// m[esp_2 - 40]{10}
    __size32 local123; 		// m[esp_2 - 40]{10}
    __size32 local124; 		// m[esp_2 - 40]{131}
    __size32 local125; 		// m[esp_2 - 40]{91}
    int local126; 		// m[esp_2 - 40]{160}
    int local127; 		// m[esp_2 - 40]{160}
    __size32 local128; 		// m[esp_2 - 40]{211}
    __size32 local129; 		// m[esp_2 - 40]{273}
    int local13; 		// m[esp - 144]
    __size32 local130; 		// m[esp_2 - 40]{330}
    __size32 local131; 		// m[esp_2 - 40]{245}
    int local132; 		// m[esp_2 - 40]{228}
    int local133; 		// m[esp_2 - 40]{228}
    __size32 local134; 		// m[esp_2 - 40]{131}
    __size32 local135; 		// m[esp_2 - 40]{131}
    __size32 local136; 		// m[esp_2 - 40]{174}
    __size32 local137; 		// m[esp_2 - 40]{174}
    __size32 local138; 		// m[esp_2 - 40]{66}
    __size32 local139; 		// m[esp_2 - 40]{330}
    __size32 local14; 		// m[esp + 4]
    __size32 local140; 		// m[esp_2 - 40]{330}
    __size32 local141; 		// m[esp_2 - 40]{91}
    __size32 local142; 		// m[esp_2 - 40]{91}
    __size32 local143; 		// m[esp_2 - 40]{211}
    __size32 local144; 		// m[esp_2 - 40]{211}
    __size32 local145; 		// m[esp_2 - 40]{245}
    __size32 local146; 		// m[esp_2 - 40]{245}
    __size32 local147; 		// m[esp_2 - 40]{273}
    __size32 local148; 		// m[esp_2 - 40]{273}
    ...
    __size32 local162; 		// m[esp_2 - 44]{175}
    __size32 local163; 		// m[esp_2 - 44]{175}
    __size32 local164; 		// m[esp_2 - 44]{92}
    __size32 local165; 		// m[esp_2 - 44]{92}
    __size32 local166; 		// m[esp_2 - 44]{303}
    __size32 local167; 		// m[esp_2 - 44]{212}
    __size32 local168; 		// m[esp_2 - 44]{212}
    __size32 local169; 		// m[esp_2 - 44]{246}
    int local17; 		// m[esp_2 + 4]{160}
    __size32 local170; 		// m[esp_2 - 44]{246}
    __size32 local171; 		// m[esp_2 - 44]{132}
    __size32 local172; 		// m[esp_2 - 44]{132}
    __size32 local173; 		// m[esp_2 - 44]{274}
    __size32 local174; 		// m[esp_2 - 44]{274}
    __size32 local175; 		// m[esp_2 - 44]{331}
    __size32 local176; 		// m[esp_2 - 44]{331}
    __size32 local177; 		// m[esp_2 - 48]{19}
    __size32 local178; 		// m[esp_2 - 48]{19}
    __size32 local179; 		// m[esp_2 - 48]{19}
    __size32 local18; 		// m[esp_2 + 4]{103}
    __size32 local180; 		// m[esp_2 - 48]{133}
    __size32 local181; 		// m[esp_2 - 48]{93}
    int local182; 		// m[esp_2 - 48]{160}
    int local183; 		// m[esp_2 - 48]{160}
    __size32 local184; 		// m[esp_2 - 48]{213}
    __size32 local185; 		// m[esp_2 - 48]{275}
    __size32 local186; 		// m[esp_2 - 48]{332}
    __size32 local187; 		// m[esp_2 - 48]{247}
    int local188; 		// m[esp_2 - 48]{228}
    int local189; 		// m[esp_2 - 48]{228}
    int local19; 		// m[esp_2 + 4]{228}
    __size32 local190; 		// m[esp_2 - 48]{133}
    __size32 local191; 		// m[esp_2 - 48]{133}
    __size32 local192; 		// m[esp_2 - 48]{176}
    __size32 local193; 		// m[esp_2 - 48]{176}
    __size32 local194; 		// m[esp_2 - 48]{93}
    __size32 local195; 		// m[esp_2 - 48]{93}
    __size32 local196; 		// m[esp_2 - 48]{304}
    __size32 local197; 		// m[esp_2 - 48]{213}
    __size32 local198; 		// m[esp_2 - 48]{213}
    __size32 local199; 		// m[esp_2 - 48]{247}
    int local2; 		// m[esp - 44]
    int local20; 		// m[esp_2 + 4]{228}
    __size32 local200; 		// m[esp_2 - 48]{247}
    __size32 local201; 		// m[esp_2 - 48]{275}
    __size32 local202; 		// m[esp_2 - 48]{275}
    __size32 local203; 		// m[esp_2 - 48]{332}
    __size32 local204; 		// m[esp_2 - 48]{332}
    __size32 local205; 		// m[esp_2 - 68]{16}
    __size32 local206; 		// m[esp_2 - 68]{16}
    __size32 local207; 		// m[esp_2 - 68]{16}
    __size32 local208; 		// m[esp_2 - 68]{134}
    __size32 local209; 		// m[esp_2 - 68]{94}
    __size32 local21; 		// m[esp_2 + 4]{342}
    int local210; 		// m[esp_2 - 68]{160}
    int local211; 		// m[esp_2 - 68]{160}
    __size32 local212; 		// m[esp_2 - 68]{214}
    __size32 local213; 		// m[esp_2 - 68]{276}
    __size32 local214; 		// m[esp_2 - 68]{333}
    __size32 local215; 		// m[esp_2 - 68]{248}
    int local216; 		// m[esp_2 - 68]{228}
    int local217; 		// m[esp_2 - 68]{228}
    __size32 local218; 		// m[esp_2 - 68]{134}
    __size32 local219; 		// m[esp_2 - 68]{134}
    __size32 local22; 		// m[esp_2 + 4]{257}
    __size32 local220; 		// m[esp_2 - 68]{177}
    __size32 local221; 		// m[esp_2 - 68]{177}
    __size32 local222; 		// m[esp_2 - 68]{94}
    __size32 local223; 		// m[esp_2 - 68]{94}
    __size32 local224; 		// m[esp_2 - 68]{305}
    __size32 local225; 		// m[esp_2 - 68]{214}
    __size32 local226; 		// m[esp_2 - 68]{214}
    __size32 local227; 		// m[esp_2 - 68]{248}
    __size32 local228; 		// m[esp_2 - 68]{248}
    __size32 local229; 		// m[esp_2 - 68]{276}
    __size32 local23; 		// m[esp_2 + 4]{78}
    __size32 local230; 		// m[esp_2 - 68]{276}
    __size32 local231; 		// m[esp_2 - 68]{333}
    __size32 local232; 		// m[esp_2 - 68]{333}
    __size32 local233; 		// m[esp_2 - 72]{14}
    __size32 local234; 		// m[esp_2 - 72]{14}
    __size32 local235; 		// m[esp_2 - 72]{14}
    __size32 local236; 		// m[esp_2 - 72]{135}
    __size32 local237; 		// m[esp_2 - 72]{95}
    int local238; 		// m[esp_2 - 72]{160}
    int local239; 		// m[esp_2 - 72]{160}
    __size32 local24; 		// m[esp_2 + 4]{314}
    __size32 local240; 		// m[esp_2 - 72]{215}
    __size32 local241; 		// m[esp_2 - 72]{277}
    __size32 local242; 		// m[esp_2 - 72]{334}
    __size32 local243; 		// m[esp_2 - 72]{249}
    int local244; 		// m[esp_2 - 72]{228}
    int local245; 		// m[esp_2 - 72]{228}
    __size32 local246; 		// m[esp_2 - 72]{135}
    __size32 local247; 		// m[esp_2 - 72]{135}
    __size32 local248; 		// m[esp_2 - 72]{178}
    __size32 local249; 		// m[esp_2 - 72]{178}
    __size32 local25; 		// m[esp_2 + 4]{285}
    __size32 local250; 		// m[esp_2 - 72]{95}
    __size32 local251; 		// m[esp_2 - 72]{95}
    __size32 local252; 		// m[esp_2 - 72]{306}
    __size32 local253; 		// m[esp_2 - 72]{215}
    __size32 local254; 		// m[esp_2 - 72]{215}
    __size32 local255; 		// m[esp_2 - 72]{249}
    __size32 local256; 		// m[esp_2 - 72]{249}
    __size32 local257; 		// m[esp_2 - 72]{277}
    __size32 local258; 		// m[esp_2 - 72]{277}
    __size32 local259; 		// m[esp_2 - 72]{334}
    __size32 local26; 		// m[esp_2 + 4]{186}
    __size32 local260; 		// m[esp_2 - 72]{334}
    __size32 local261; 		// m[esp_2 - 76]{15}
    __size32 local262; 		// m[esp_2 - 76]{15}
    __size32 local263; 		// m[esp_2 - 76]{15}
    __size32 local264; 		// m[esp_2 - 76]{136}
    __size32 local265; 		// m[esp_2 - 76]{96}
    int local266; 		// m[esp_2 - 76]{160}
    int local267; 		// m[esp_2 - 76]{160}
    __size32 local268; 		// m[esp_2 - 76]{216}
    __size32 local269; 		// m[esp_2 - 76]{278}
    __size32 local27; 		// m[esp_2 + 4]{186}
    __size32 local270; 		// m[esp_2 - 76]{335}
    __size32 local271; 		// m[esp_2 - 76]{250}
    int local272; 		// m[esp_2 - 76]{228}
    int local273; 		// m[esp_2 - 76]{228}
    __size32 local274; 		// m[esp_2 - 76]{136}
    __size32 local275; 		// m[esp_2 - 76]{136}
    __size32 local276; 		// m[esp_2 - 76]{179}
    __size32 local277; 		// m[esp_2 - 76]{179}
    __size32 local278; 		// m[esp_2 - 76]{96}
    __size32 local279; 		// m[esp_2 - 76]{96}
    __size32 local28; 		// m[esp_2 + 4]{3}
    __size32 local280; 		// m[esp_2 - 76]{307}
    __size32 local281; 		// m[esp_2 - 76]{216}
    __size32 local282; 		// m[esp_2 - 76]{216}
    __size32 local283; 		// m[esp_2 - 76]{250}
    __size32 local284; 		// m[esp_2 - 76]{250}
    __size32 local285; 		// m[esp_2 - 76]{278}
    __size32 local286; 		// m[esp_2 - 76]{278}
    __size32 local287; 		// m[esp_2 - 76]{335}
    __size32 local288; 		// m[esp_2 - 76]{335}
    __size32 local289; 		// m[esp_2 - 80]{12}
    __size32 local29; 		// m[esp_2 + 4]{3}
    __size32 local290; 		// m[esp_2 - 80]{12}
    __size32 local291; 		// m[esp_2 - 80]{12}
    __size32 local292; 		// m[esp_2 - 80]{137}
    __size32 local293; 		// m[esp_2 - 80]{97}
    int local294; 		// m[esp_2 - 80]{160}
    int local295; 		// m[esp_2 - 80]{160}
    __size32 local296; 		// m[esp_2 - 80]{217}
    __size32 local297; 		// m[esp_2 - 80]{279}
    __size32 local298; 		// m[esp_2 - 80]{336}
    __size32 local299; 		// m[esp_2 - 80]{251}
    int local3; 		// m[esp - 36]
    __size32 local30; 		// m[esp_2 + 4]{103}
    int local300; 		// m[esp_2 - 80]{228}
    int local301; 		// m[esp_2 - 80]{228}
    __size32 local302; 		// m[esp_2 - 80]{137}
    __size32 local303; 		// m[esp_2 - 80]{137}
    __size32 local304; 		// m[esp_2 - 80]{180}
    __size32 local305; 		// m[esp_2 - 80]{180}
    __size32 local306; 		// m[esp_2 - 80]{97}
    __size32 local307; 		// m[esp_2 - 80]{97}
    __size32 local308; 		// m[esp_2 - 80]{308}
    __size32 local309; 		// m[esp_2 - 80]{217}
    __size32 local31; 		// m[esp_2 + 4]{103}
    __size32 local310; 		// m[esp_2 - 80]{217}
    __size32 local311; 		// m[esp_2 - 80]{251}
    __size32 local312; 		// m[esp_2 - 80]{251}
    __size32 local313; 		// m[esp_2 - 80]{279}
    __size32 local314; 		// m[esp_2 - 80]{279}
    __size32 local315; 		// m[esp_2 - 80]{336}
    __size32 local316; 		// m[esp_2 - 80]{336}
    __size32 local317; 		// m[esp_2 - 104]{17}
    __size32 local318; 		// m[esp_2 - 104]{17}
    __size32 local319; 		// m[esp_2 - 104]{17}
    __size32 local32; 		// m[esp_2 + 4]{257}
    __size32 local320; 		// m[esp_2 - 104]{138}
    __size32 local321; 		// m[esp_2 - 104]{98}
    int local322; 		// m[esp_2 - 104]{160}
    int local323; 		// m[esp_2 - 104]{160}
    __size32 local324; 		// m[esp_2 - 104]{218}
    __size32 local325; 		// m[esp_2 - 104]{280}
    __size32 local326; 		// m[esp_2 - 104]{337}
    __size32 local327; 		// m[esp_2 - 104]{252}
    int local328; 		// m[esp_2 - 104]{228}
    int local329; 		// m[esp_2 - 104]{228}
    __size32 local33; 		// m[esp_2 + 4]{257}
    __size32 local330; 		// m[esp_2 - 104]{138}
    __size32 local331; 		// m[esp_2 - 104]{138}
    __size32 local332; 		// m[esp_2 - 104]{181}
    __size32 local333; 		// m[esp_2 - 104]{181}
    __size32 local334; 		// m[esp_2 - 104]{98}
    __size32 local335; 		// m[esp_2 - 104]{98}
    __size32 local336; 		// m[esp_2 - 104]{309}
    __size32 local337; 		// m[esp_2 - 104]{218}
    __size32 local338; 		// m[esp_2 - 104]{218}
    __size32 local339; 		// m[esp_2 - 104]{252}
    __size32 local34; 		// m[esp_2 + 4]{342}
    __size32 local340; 		// m[esp_2 - 104]{252}
    __size32 local341; 		// m[esp_2 - 104]{280}
    __size32 local342; 		// m[esp_2 - 104]{280}
    __size32 local343; 		// m[esp_2 - 104]{337}
    __size32 local344; 		// m[esp_2 - 104]{337}
    __size32 local345; 		// m[esp_2 - 108]{21}
    __size32 local346; 		// m[esp_2 - 108]{21}
    __size32 local347; 		// m[esp_2 - 108]{21}
    __size32 local348; 		// m[esp_2 - 108]{139}
    __size32 local349; 		// m[esp_2 - 108]{99}
    __size32 local35; 		// m[esp_2 + 4]{342}
    int local350; 		// m[esp_2 - 108]{160}
    int local351; 		// m[esp_2 - 108]{160}
    __size32 local352; 		// m[esp_2 - 108]{219}
    __size32 local353; 		// m[esp_2 - 108]{281}
    __size32 local354; 		// m[esp_2 - 108]{338}
    __size32 local355; 		// m[esp_2 - 108]{253}
    int local356; 		// m[esp_2 - 108]{228}
    int local357; 		// m[esp_2 - 108]{228}
    __size32 local358; 		// m[esp_2 - 108]{139}
    __size32 local359; 		// m[esp_2 - 108]{139}
    __size32 local36; 		// m[esp_2 - 4]{7}
    __size32 local360; 		// m[esp_2 - 108]{182}
    __size32 local361; 		// m[esp_2 - 108]{182}
    __size32 local362; 		// m[esp_2 - 108]{99}
    __size32 local363; 		// m[esp_2 - 108]{99}
    __size32 local364; 		// m[esp_2 - 108]{310}
    __size32 local365; 		// m[esp_2 - 108]{219}
    __size32 local366; 		// m[esp_2 - 108]{219}
    __size32 local367; 		// m[esp_2 - 108]{253}
    __size32 local368; 		// m[esp_2 - 108]{253}
    __size32 local369; 		// m[esp_2 - 108]{281}
    __size32 local37; 		// m[esp_2 - 4]{7}
    __size32 local370; 		// m[esp_2 - 108]{281}
    __size32 local371; 		// m[esp_2 - 108]{338}
    __size32 local372; 		// m[esp_2 - 108]{338}
    unsigned int local373; 		// m[esp_2 - 112]{22}
    unsigned int local374; 		// m[esp_2 - 112]{22}
    unsigned int local375; 		// m[esp_2 - 112]{22}
    unsigned int local376; 		// m[esp_2 - 112]{140}
    unsigned int local377; 		// m[esp_2 - 112]{100}
    int local378; 		// m[esp_2 - 112]{160}
    int local379; 		// m[esp_2 - 112]{160}
    __size32 local38; 		// m[esp_2 - 4]{7}
    unsigned int local380; 		// m[esp_2 - 112]{220}
    unsigned int local381; 		// m[esp_2 - 112]{282}
    unsigned int local382; 		// m[esp_2 - 112]{339}
    unsigned int local383; 		// m[esp_2 - 112]{254}
    int local384; 		// m[esp_2 - 112]{228}
    int local385; 		// m[esp_2 - 112]{228}
    unsigned int local386; 		// m[esp_2 - 112]{140}
    unsigned int local387; 		// m[esp_2 - 112]{140}
    unsigned int local388; 		// m[esp_2 - 112]{183}
    unsigned int local389; 		// m[esp_2 - 112]{183}
    __size32 local39; 		// m[esp_2 - 4]{128}
    unsigned int local390; 		// m[esp_2 - 112]{100}
    unsigned int local391; 		// m[esp_2 - 112]{100}
    unsigned int local392; 		// m[esp_2 - 112]{311}
    unsigned int local393; 		// m[esp_2 - 112]{220}
    unsigned int local394; 		// m[esp_2 - 112]{220}
    unsigned int local395; 		// m[esp_2 - 112]{254}
    unsigned int local396; 		// m[esp_2 - 112]{254}
    unsigned int local397; 		// m[esp_2 - 112]{282}
    unsigned int local398; 		// m[esp_2 - 112]{282}
    unsigned int local399; 		// m[esp_2 - 112]{339}
    int local4; 		// m[esp - 40]
    ...
    __size32 local472; 		// esp_30{59}
    int local473; 		// local409{61}
    __size16 local474; 		// local442{62}
    __size32 local475; 		// m[esp_2 - 4]{63}
    __size32 local476; 		// local87{64}
    __size32 local477; 		// local109{65}
    __size32 local478; 		// local138{66}
    __size32 local479; 		// m[esp_2 - 44]{67}
    int local48; 		// m[esp_2 - 4]{228}
    __size32 local480; 		// m[esp_2 - 48]{68}
    __size32 local481; 		// m[esp_2 - 68]{69}
    __size32 local482; 		// m[esp_2 - 72]{70}
    __size32 local483; 		// m[esp_2 - 76]{71}
    __size32 local484; 		// m[esp_2 - 80]{72}
    __size32 local485; 		// m[esp_2 - 104]{73}
    __size32 local486; 		// m[esp_2 - 108]{74}
    unsigned int local487; 		// m[esp_2 - 112]{75}
    __size32 local488; 		// esp_5{84}
    int local489; 		// local401{87}
    __size32 local49; 		// m[esp_2 - 4]{128}
    ...
    int local5; 		// m[esp - 32]
    __size32 local50; 		// m[esp_2 - 4]{128}
    ...
    __size32 local52; 		// m[esp_2 - 4]{171}
    union { __size32 *; unsigned int; } local520; 		// eax{151}
    __size32 local521; 		// esp_27{167}
    ...
    __size32 local53; 		// m[esp_2 - 4]{208}
    ...
    __size32 local536; 		// local26{186}
    unsigned int local537; 		// ebx{203}
    union { __size32 *; __size32; } local538; 		// esp_1{204}
    __size32 local539; 		// local43{208}
    __size32 local54; 		// m[esp_2 - 4]{208}
    ...
    __size32 local56; 		// m[esp_2 - 4]{242}
    ...
    __size32 local569; 		// local22{257}
    __size32 local57; 		// m[esp_2 - 4]{88}
    __size32 local570; 		// esp_23{264}
    ...
    __size32 local587; 		// local25{285}
    __size32 local588; 		// esp_31{294}
    int local589; 		// local410{297}
    __size32 local59; 		// m[esp_2 - 4]{299}
    __size16 local590; 		// local443{298}
    __size32 local591; 		// local59{299}
    __size32 local592; 		// m[esp_2 - 32]{300}
    __size32 local593; 		// m[esp_2 - 36]{301}
    __size32 local594; 		// m[esp_2 - 40]{302}
    ...
    int local6; 		// m[esp - 48]
    __size32 local60; 		// m[esp_2 - 4]{327}
    ...
    __size32 local62; 		// m[esp_2 - 4]{270}
    unsigned int local620; 		// local382{339}
    __size32 local621; 		// local21{342}
    __size32 local622; 		// esp{348}
    __size32 local63; 		// m[esp_2 - 4]{270}
    ...
    __size32 local77; 		// m[esp_2 - 32]{129}
    __size32 local78; 		// m[esp_2 - 32]{129}
    __size32 local79; 		// m[esp_2 - 32]{172}
    int local8; 		// m[esp - 72]
    __size32 local80; 		// m[esp_2 - 32]{172}
    __size32 local81; 		// m[esp_2 - 32]{209}
    __size32 local82; 		// m[esp_2 - 32]{209}
    __size32 local83; 		// m[esp_2 - 32]{243}
    __size32 local84; 		// m[esp_2 - 32]{243}
    __size32 local85; 		// m[esp_2 - 32]{271}
    __size32 local86; 		// m[esp_2 - 32]{271}
    __size32 local87; 		// m[esp_2 - 32]{64}
    __size32 local88; 		// m[esp_2 - 32]{328}
    __size32 local89; 		// m[esp_2 - 32]{328}
    int local9; 		// m[esp - 76]
    __size32 local90; 		// m[esp_2 - 32]{89}
    __size32 local91; 		// m[esp_2 - 32]{89}
...
bb0x8061b07:
    ...
    local409 = local473;
    local442 = local474;
    *(__size32*)(esp_2 - 4) = local475;
    local87 = local476;
    local109 = local477;
    local138 = local478;
    *(__size32*)(esp_2 - 44) = local479;
    *(__size32*)(esp_2 - 48) = local480;
    *(__size32*)(esp_2 - 68) = local481;
    *(__size32*)(esp_2 - 72) = local482;
    *(__size32*)(esp_2 - 76) = local483;
    *(__size32*)(esp_2 - 80) = local484;
    *(__size32*)(esp_2 - 104) = local485;
    *(__size32*)(esp_2 - 108) = local486;
    *(unsigned int*)(esp_2 - 112) = local487;
    local605 = esp_30;
    local606 = local409;
    local607 = local442;
    local608 = *(esp_2 - 4);
    ...
    if (*(ebp + 24) != 0) {
        ...
        *(__size32*)(ebp - 28) = 0;
        do {
            ...
            local443 = local590;
            local59 = local591;
            *(__size32*)(esp_2 - 32) = local592;
            *(__size32*)(esp_2 - 36) = local593;
            *(__size32*)(esp_2 - 40) = local594;
            local166 = local595;
            local196 = local596;
            local224 = local597;
            local252 = local598;
...
void caml_alloc_shr(unsigned int param1, unsigned int param2, __size8 param3, __size8 param4, __size8 param5, unsigned int param6, __size32 param7, __size32 param8, __size32 param9, __size32 param10)
{
    ...
    *(unsigned int*)esp_5 = esi_3;
    ...
    if (eax_1 == 0) {
        edx = *(&caml_globals + 0x100fc) * ((unsigned long long)((esi_3) * 0x51eb851f >> 32) >> 5);
        eax_4 = (esi_3 + edx + 1) * 4;
...
__size32 caml_check_urgent_gc()
{
    ...
    esp_1 = esp_6 - 44;
    *(__size32*)(&caml_globals + 0x93c0) = esp_6 - 44;
...
__size8 caml_do_local_roots(__size32 param1, __size32 param2, __size32 param3, unsigned int param4, __size32 param5, __size32 param6, unsigned int param7, unsigned int param8, __size32 param9, unsigned int param10, unsigned int param11)
{
    ...
    __size32 local18; 		// m[esp_35 + 8]{43}
    ...
    __size32 local19; 		// m[esp_35 + 8]{214}
    ...
    __size32 local372; 		// m[esp_35 + 8]{192}
    ...
    __size32 local83; 		// m[esp_35 - 4]{165}
    __size32 local84; 		// m[esp_35 - 4]{208}
    __size32 local85; 		// m[esp_35 - 4]{186}
    __size32 local86; 		// m[esp_35 - 4]{116}
...
__size32 caml_final_do_strong_roots(__size32 param1, __size32 param2, __size32 param3, __size32 param4, unsigned int param5, __size32 param6)
{
    ...
    __size32 local23; 		// m[esp_24 - 4]{0}
    __size32 local24; 		// m[esp_24 - 4]{0}
    int local25; 		// m[esp_24 - 4]{57}
    int local26; 		// m[esp_24 - 4]{57}
    int local27; 		// m[esp_24 - 4]{57}
    __size32 local28; 		// m[esp_24 - 4]{0}
    int local29; 		// m[esp_24 - 4]{62}
    __size32 local3; 		// m[esp - 16]
    int local30; 		// m[esp_24 - 4]{62}
    __size32 local31; 		// m[esp_24 - 4]{8}
    __size32 local32; 		// m[esp_24 - 4]{8}
            ...
            if (*(ebx + 4) != 0) {
                do {
                    ...
                    *(__size32*)(esp_17 + 4) = edx + esi * 12 + 8;
                    eax = *(ebx + 8);
                    *(__size32*)esp_17 = eax;
                    (**(ebp + 8))(eax, edx, ebx, ebp, esi, edx + esi * 12, flags, ZF, CF, param1, local28, local44, local62, local80);
                    *(__size32*)(esp_7 + 4) = edi + 12;
                    eax = *(ebx + 12);
                    *(__size32*)esp_7 = eax;
                    (**(ebp + 8))(eax, edx, ebx, ebp, esi, edi + 12, <all>, ADDFLAGS32(edi, 12, edi + 12), ADDFLAGS32(edi, 12, edi + 12), ADDFLAGS32(edi, 12, edi + 12), local8, local25, local41, local59, local77);
                    local100 = esp_10;
                    local102 = esp_10;
                    local103 = local29;
                    local104 = local45;
