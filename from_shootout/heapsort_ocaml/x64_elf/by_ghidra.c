...

{
  ...
  lVar1 = (*DAT_006410d0 + -1) * 0xf25 + 0xe70b;
  lVar1 = SUB168(CONCAT88(lVar1 >> 0x3f,lVar1 >> 1) % SEXT816(0x222c0),0) * 2 + 1;
  *DAT_006410d0 = lVar1;
  while( true ) {
  ...
  *(double *)(unaff_R15 - 8) = ((double)(lVar1 >> 1) * *in_RAX) / 139968.0;
  return;
}
...

{
  ...
  do {
    if (param_2 < 4) {
      dVar4 = *(double *)(unaff_RBX + -4 + in_RAX * 4);
      *(undefined8 *)(unaff_RBX + -4 + in_RAX * 4) = *(undefined8 *)(unaff_RBX + 8);
      in_RAX = in_RAX + -2;
      if (in_RAX == 3) {
        *(double *)(unaff_RBX + 8) = dVar4;
      ...
      param_2 = param_2 + -2;
      dVar4 = *(double *)(unaff_RBX + -4 + param_2 * 4);
    }
    lVar3 = param_2 * 2 + -1;
    lVar1 = param_2;
    while (lVar3 <= in_RAX) {
      lVar2 = lVar3;
      if ((lVar3 < in_RAX) &&
         (*(double *)(unaff_RBX + -4 + lVar3 * 4) < *(double *)(unaff_RBX + 4 + lVar3 * 4))) {
        lVar2 = lVar3 + 2;
      }
      if (*(double *)(unaff_RBX + -4 + lVar2 * 4) <= dVar4) {
        lVar3 = in_RAX + 2;
      }
      else {
        *(undefined8 *)(unaff_RBX + -4 + lVar1 * 4) = *(undefined8 *)(unaff_RBX + -4 + lVar2 * 4);
        lVar3 = lVar2 * 2 + -1;
        lVar1 = lVar2;
      }
    }
    *(double *)(unaff_RBX + -4 + lVar1 * 4) = dVar4;
  } while( true );
}
...

{
  ...
  *DAT_006410d0 = 0x55;
  ...
  lVar1 = camlArray__init_65();
  camlSource__heapsort_65();
  ppcVar2 = (code **)camlPrintf__printf_425();
  caml_alloc1();
  *unaff_R15 = 0x4fd;
  unaff_R15[1] = *(undefined8 *)(lVar1 + -4 + DAT_006410e8 * 4);
  (**ppcVar2)(*ppcVar2);
  return 1;
}
...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_00641320 = (undefined *)&camlUnix__50;
...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_006456a0 = (undefined *)&camlPervasives__7;
  ...
  unaff_R15[7] = 0x400;
  *DAT_006456e8 = (undefined *)DAT_006455b8;
...

{
  ...
  *puVar9 = uVar4;
  ...
  if (in_RAX <= (long)uVar1) {
    ...
    *(undefined8 *)(uVar7 - 0x18) = 0x800;
    *(undefined8 *)(uVar7 - 0x10) = DAT_00646d88;
...

{
  ...
  plVar4 = (long *)FUN_00412064();
  if (*plVar4 != DAT_00646d88) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar1 = plVar4[1];
...

{
  ...
  if (in_RAX != 0xb9) {
    ...
    case 0x1c:
      bVar2 = (byte)uVar1 - 2;
      bVar7 = 1 < (byte)uVar1 || CARRY1(bVar2,0xffbcabaf < uVar1);
      auStack16 = 0x435459;
...
LAB_0041aef0:
    ...
    if (uVar3 == 0) goto LAB_0041af04;
    if (uVar3 == 1) goto LAB_0041aef0;
    if (1 < (long)uVar3) goto LAB_0041af2c;
  }
  if (uVar3 != 1) {
LAB_0041af2c:
...

{
  ...
  do {
    ...
    uVar2 = SEXT48((int)(&switchD_0041b95f::switchdataD_00435670)[lVar5 >> 1]);
    switch(lVar5) {
    default:
    ...
    case 0xf7:
      ...
      *(long *)(uVar2 - 8) = lVar5;
      ...
      break;
    case 0xfc:
      *(char *)(uVar2 - 0x7d) = (*(char *)(uVar2 - 0x7d) - in_AL) - (0xffffffffffbca98f < uVar2);
      return uVar2;
    }
  } while( true );
}
...
code_r0x0041cfab:
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
         (*(char *)((long)piVar6 + -0x75) - cVar11) - ((int *)0xffffffffffbca713 < piVar6);
  ...
  case 0x1cc:
    *(char *)piVar6 = *(char *)piVar6 + cVar3;
    if ((long)param_1 >> 1 == 1) {
      ...
      uVar8 = camlPrintf__extract_format_113(local_10,uStack8);
  ...
  case 0x1c2:
    ...
    *pcVar7 = *pcVar7 + cVar11;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d63f) = (ulong)(uVar1 + 0x221c83);
    *(undefined8 *)(piVar6 + 0x10d641) = 0x10f9;
    *(code **)(piVar6 + 0x10d643) = caml_curry2;
  case 0x1e4:
    *(undefined8 *)(piVar6 + 0x10d645) = 5;
    *(code **)(piVar6 + 0x10d647) = camlPrintf__scan_conv_171;
    *(undefined8 *)(piVar6 + 0x10d649) = 0x20f9;
    *(code **)(piVar6 + 0x10d64b) = camlPrintf__scan_fmt_172;
    *(undefined8 *)(piVar6 + 0x10d64d) = 3;
    *(code ***)(piVar6 + 0x10d64f) = in_RAX;
    *(code ***)(piVar6 + 0x10d651) = unaff_RBX;
    *(code ***)(piVar6 + 0x10d653) = param_1;
    *(uint **)(piVar6 + 0x10d655) = param_4;
...
code_r0x0041caac:
  ...
  *(int **)((long)pppcVar14 + 0x20) = piVar6;
  puVar13 = &switchD_0041cacf::switchdataD_00435954;
  piVar6 = (int *)(long)(int)(&switchD_0041cacf::switchdataD_00435954)[(long)param_1 >> 1];
...

{
  ...
  *(undefined8 *)((long)plVar5 + -8) = 0x41cf01;
  (*pcVar1)(pcVar1);
LAB_0041cf01:
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  unaff_R15[8] = 0x1800;
  *DAT_0064b668 = (undefined *)&camlPrintf__38;
...
LAB_0042482b:
  ...
  if (puVar1 != (ulong *)0x0) goto code_r0x00424835;
  goto LAB_0042483a;
code_r0x00424835:
  if (param_2 <= *puVar1) {
LAB_0042483a:
...
LAB_004249fb:
    ...
    if (puVar2 != (ulong *)0x0) goto code_r0x00424a05;
    goto LAB_00424a0a;
  }
LAB_00424a20:
      ...
      do {
        while( true ) {
          ...
          *(undefined8 *)(*plVar1 + 8 + lVar7 * 8) = *(undefined8 *)((long)puVar6 + lVar3);
          if (iVar4 < iVar8) goto LAB_00424a78;
        }
        iVar8 = iVar8 + 1;
        lVar5 = lVar5 + 8;
      } while (iVar8 <= iVar4);
...
LAB_00425dda:
        ...
        while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
          iVar16 = iVar16 + 1;
          if (flp_size <= iVar16) goto LAB_00425dda;
          plVar13 = *pplVar6;
          pplVar6 = pplVar6 + 1;
      ...
      do {
        do {
          plVar12 = plVar10;
          if (plVar12 == plVar13) goto LAB_00425f5b;
...
LAB_00426f50:
  ...
  if ((uVar3 & 7) != 0) goto code_r0x00427004;
  goto LAB_00427025;
code_r0x00427004:
  ppuVar4 = param_1;
...
LAB_0042dd1e:
    if (0xffffffff < lVar4) goto LAB_0042de07;
  }
...
LAB_0042e7b6:
    if (uVar12 != 0) goto code_r0x0042e7bf;
        ...
        if (0 < iVar6) {
          if (*pcVar9 != '\0') {
            ...
            do {
              ...
              if ((iVar6 + -1) - iVar7 < 1) goto LAB_0043066d;
              iVar7 = iVar7 + 1;
            } while (*pcVar9 != '\0');
          }
      ...
      if (bVar1 != 0) {
        if (*pcVar9 != '\0') {
          ...
          do {
            sVar4 = strlen(pcVar9);
            pcVar9 = pcVar9 + sVar4 + 1;
            if (bVar1 - 1 == iVar6) goto LAB_00430772;
            iVar6 = iVar6 + 1;
          } while (*pcVar9 != '\0');
        }
        pcVar9 = "<unknown token>";
...
LAB_004301f8:
    ...
    do {
      ...
      if (((-1 < iVar7) && (sVar2 != 0)) && (iVar7 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar8 = (long)iVar7;
        lVar3 = lVar8 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar8 * 2) == 0x100) goto LAB_004307e8;
      }
      if (iVar6 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar6 != 0) {
    ...
    if (param_3 < uVar5) goto LAB_0043204a;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_004334cc;
      }
...
LAB_0043368e:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_00433723;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_00433723;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_00433723:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_0043368e;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_0043397b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_0043397b:
