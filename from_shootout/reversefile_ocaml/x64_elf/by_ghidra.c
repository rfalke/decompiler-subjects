...

{
  ...
  plVar2 = (long *)FUN_00409354();
  if ((undefined **)*plVar2 == &caml_exn_Failure) {
    plVar2 = (long *)FUN_004092d8();
...

{
  ...
  *(undefined8 *)(uVar6 - 8) = unaff_RBX;
  ...
  if (lVar4 == 1) {
    plVar5 = (long *)FUN_0040aecc();
    if ((undefined **)*plVar5 != &caml_exn_Failure) {
                    // WARNING: Subroutine does not return
      caml_raise_exn();
    }
    plVar5 = (long *)FUN_0040ae50();
    ...
    if (lVar4 == 1) {
      ...
      *(undefined8 *)(uVar6 - 0x30) = 0x800;
      *(undefined8 *)(uVar6 - 0x28) = DAT_00638608;
      ...
      *(undefined8 *)(uVar7 - 0x28) = DAT_00638600;
...

{
  ...
  *camlUnix = camlUnix__64;
  ...
  caml_allocN();
  DAT_006383c8 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_006383c8 = &camlUnix__50;
...

{
  ...
  *DAT_0063c510 = camlPervasives__65;
  ...
  caml_allocN();
  DAT_0063c748 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_0063c748 = &camlPervasives__7;
  ...
  DAT_0063c790 = unaff_R15 + 8;
  unaff_R15[7] = 0x400;
  *DAT_0063c790 = DAT_0063c660;
    ...
    if (puVar9 == (uint *)0x1) {
      ...
      if (0 < iVar5) {
        ...
        while ((uint *)(long)(int)((uint)*ppuVar2 & **ppuVar4) != puVar9) {
          iVar6 = iVar6 + 1;
          if (iVar5 <= iVar6) goto LAB_0041b48f;
...
LAB_0041b4ea:
        *plVar13 = (long)*(int *)(speedtable + (long)iVar5 * 8 + 4) * 2 + 1;
        ...
        do {
          if (*psVar10 == sVar7) goto LAB_0041b4ea;
          iVar5 = iVar5 + 1;
          psVar10 = psVar10 + 2;
        } while (iVar5 != 0x12);
      }
    ...
    for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
      ...
      while( true ) {
        ...
        *pplVar4 = (long *)((ulong)plVar15 & 0xfffffffffffffc00 | 0x3f3);
        pplVar4 = pplVar4 + ((ulong)plVar15 >> 10) + 1;
        if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar4) goto LAB_0042ba4c;
      }
...
LAB_0042bc0e:
          ...
          pplVar13 = pplVar6;
          if (0x20 < uVar17) goto LAB_0042bca3;
          pplVar11 = (long **)pplVar6[-1];
          if (0x20 < (ulong)((long)pplVar11[-2] - (long)pplVar11[-3])) goto LAB_0042bca3;
          do {
            pplVar6 = pplVar11;
            pplVar11 = (long **)pplVar6[-1];
            pplVar13 = pplVar6;
...
LAB_0042bca3:
          ...
          *pplVar4 = (long *)(lVar18 * 0x400 + -0x400 + (ulong)uVar3);
          ...
          uVar3 = (uint)uVar17;
          if ((char)uVar17 == -7) goto LAB_0042bc0e;
    ...
    do {
      ...
      for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
        ...
        while (plVar15 = *pplVar4, ((ulong)plVar15 & 0x300) == 0) {
          ...
          pplVar4 = pplVar14;
          if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar14) goto LAB_0042befb;
        }
      }
LAB_0042befb:
...
undefined  [16] FUN_0042d3fb(undefined8 param_1,undefined8 param_2,undefined8 param_3)
