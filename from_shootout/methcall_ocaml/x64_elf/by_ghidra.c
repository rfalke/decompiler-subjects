...

{
  ...
  *(undefined8 *)(unaff_R15 - 0x30) = 0x800;
  *(undefined8 *)(unaff_R15 - 0x28) = DAT_00648e90;
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_00411262;
    }
    else if (0x74 < uVar2) {
LAB_00411262:
...

{
  ...
  if (in_RAX != 0xb9) {
    ...
    lVar5 = caml_c_call();
    if (lVar5 != 1) {
      puVar6 = (undefined *)caml_c_call(3);
      *puVar6 = (char)lVar4;
      return puVar6;
    }
    puVar6 = (undefined *)caml_c_call(9);
    *puVar6 = 0x5c;
    lVar5 = in_RAX >> 0x3f;
    auVar1._8_8_ = lVar5;
    auVar1._0_8_ = lVar4;
    puVar6[1] = (char)(SUB168(auVar1 / SEXT816(100),0) * 2 + 0x61 >> 1);
    auVar2._8_8_ = lVar5;
    auVar2._0_8_ = lVar4;
    puVar6[2] = (char)((SUB168(auVar2 / SEXT816(10),0) % 10) * 2 + 0x61 >> 1);
    auVar3._8_8_ = lVar5;
    auVar3._0_8_ = lVar4;
    puVar6[3] = (char)(SUB168(auVar3 % SEXT816(10),0) * 2 + 0x61 >> 1);
    return puVar6;
  }
  return &camlChar__7;
}
...

{
  ...
  *(undefined8 *)(unaff_R15 - 0x10) = 0x400;
  *plVar1 = 1;
  lVar5 = (*(ulong *)(lVar8 + -8) >> 10) * 8 + -1;
  lVar8 = (lVar5 - (ulong)*(byte *)(lVar8 + lVar5)) * 2 + -1;
  if (0 < lVar8) {
    local_38 = 1;
    do {
      uVar6 = (ulong)*(byte *)(in_RAX + (local_38 >> 1)) * 2 + 1;
      if (uVar6 < 0x1d) {
        if (uVar6 < 0x17) {
          if (0x10 < uVar6) goto LAB_00418ab8;
          goto LAB_00418a8e;
        }
        if (uVar6 < 0x1b) goto LAB_00418a8e;
LAB_00418ab8:
        lVar5 = 5;
      }
      else {
        if ((uVar6 == 0x45) || (uVar6 == 0xb9)) goto LAB_00418ab8;
LAB_00418a8e:
        lVar5 = caml_c_call();
        if (lVar5 == 1) {
          lVar5 = 9;
      ...
      *plVar1 = *plVar1 + lVar5 + -1;
      bVar9 = local_38 != lVar8;
      local_38 = local_38 + 2;
    } while (bVar9);
  }
  lVar8 = (*(ulong *)(in_RAX + -8) >> 10) * 8 + -1;
  if (*plVar1 == (lVar8 - (ulong)*(byte *)(in_RAX + lVar8)) * 2 + 1) {
    return in_RAX;
  }
  lVar5 = caml_c_call(*plVar1);
  *plVar1 = 1;
  lVar8 = (*(ulong *)(in_RAX + -8) >> 10) * 8 + -1;
  lVar8 = (lVar8 - (ulong)*(byte *)(in_RAX + lVar8)) * 2 + -1;
  if (0 < lVar8) {
    local_38 = 1;
    do {
      lVar7 = (ulong)*(byte *)(in_RAX + (local_38 >> 1)) * 2;
      uVar6 = lVar7 + 1 >> 1;
      switch(lVar7) {
      case 0:
      case 2:
...
switchD_00418bd0_caseD_0:
        lVar7 = caml_c_call();
        if (lVar7 == 1) {
          *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
          *plVar1 = *plVar1 + 2;
          auVar2._8_8_ = 0;
          auVar2._0_8_ = uVar6;
          *(char *)(lVar5 + (*plVar1 >> 1)) =
               (char)(SUB168(auVar2 / SEXT816(100),0) * 2 + 0x61 >> 1);
          *plVar1 = *plVar1 + 2;
          auVar3._8_8_ = 0;
          auVar3._0_8_ = uVar6;
          *(char *)(lVar5 + (*plVar1 >> 1)) =
               (char)((SUB168(auVar3 / SEXT816(10),0) % 10) * 2 + 0x61 >> 1);
          *plVar1 = *plVar1 + 2;
          auVar4._8_8_ = 0;
          auVar4._0_8_ = uVar6;
          *(char *)(lVar5 + (*plVar1 >> 1)) = (char)(SUB168(auVar4 % SEXT816(10),0) * 2 + 0x61 >> 1)
          ;
        }
        else {
          *(char *)(lVar5 + (*plVar1 >> 1)) = (char)uVar6;
        }
        break;
      case 0x10:
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x62;
        break;
      case 0x12:
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x74;
        break;
      case 0x14:
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x6e;
        break;
      case 0x1a:
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x72;
        break;
      default:
        if (lVar7 - 0x45U < 0x72) goto switchD_00418bd0_caseD_0;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(char *)(lVar5 + (*plVar1 >> 1)) = (char)uVar6;
      }
...

{
  ...
  DAT_006515d0 = *puVar1;
  DAT_006515e8 = (2L << ((byte)(DAT_006515d8 + -0x14 >> 1) & 0x3f)) + -1;
...
undefined2 * camlBuffer__advance_139(long param_1)

{
  ...
  while( true ) {
    if ((long)unaff_RBX <= (long)in_RAX) {
      return unaff_RBX;
    }
    lVar3 = *(long *)(param_1 + 0x18);
    lVar1 = (*(ulong *)(lVar3 + -8) >> 10) * 8 + -1;
    if (lVar1 - (ulong)*(byte *)(lVar3 + lVar1) <= (ulong)((long)in_RAX >> 1)) break;
    lVar1 = (ulong)*(byte *)(lVar3 + ((long)in_RAX >> 1)) * 2;
    uVar2 = lVar1 + 1;
    if (uVar2 < 0xbf) {
      if (uVar2 < 0x75) {
        if (uVar2 < 0x61) {
...

{
  ...
  while (uVar1 = (ulong)*(byte *)(*(long *)(unaff_RBX + 0x10) + (in_RAX >> 1)) * 2 + 1, 0x60 < uVar1
        ) {
    if (0x74 < uVar1) goto LAB_0041df54;
    in_RAX = in_RAX + 2;
  }
  if (uVar1 == 0x49) {
    return in_RAX + 2;
...
switchD_0041ed34_caseD_42:
  ...
  uVar1 = (&switchD_0041ed34::caseD_1f0)[lVar2 + -0x3f >> 1];
  piVar5 = (int *)(long)(int)uVar1;
  puVar12 = (uint *)(piVar5 + 0x10f283);
  cVar3 = (char)uVar1;
  iVar10 = (int7)(int3)(uVar1 >> 8);
  local_18 = in_RAX;
  local_10 = param_1;
                    // WARNING (jumptable): Sanity check requires truncation of jumptable
                    // WARNING: Could not find normalized switch variable to match jumptable
  ...
  case 0xb6:
    ...
    *(char *)piVar5 = *(char *)piVar5 + cVar3;
    pppcVar13 = (code ***)auStack_50;
    puVar11 = (uint *)((long)in_RAX >> 1);
  ...
  case 0xc4:
  case 0x16a:
    pbVar8 = (byte *)CONCAT71(iVar10,*(byte *)in_RAX);
  ...
  case 0x138:
    ...
    *pcVar7 = *pcVar7 + (char)pcVar7;
    ppcStack_20 = (code **)0x42005f;
    local_18 = (code **)caml_c_call(pcVar7,in_RAX);
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x420091;
      (***(code ***)(DAT_00653c20 + 0x10))();
    }
    in_RAX = *(code ***)(param_9 + 0x28);
    param_1 = (code **)(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2);
    goto code_r0x004200ab;
  case 0xfa:
  case 0x13a:
    ppcStack_20 = (code **)0x41fe86;
    camlPrintf__extract_format_113(param_1,puStack_8);
    ppcStack_20 = (code **)0x41fe8f;
    local_18 = (code **)camlPrintf__format_string_108();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41fec1;
      (***(code ***)(DAT_00653c20 + 0x10))();
    }
    uVar4 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28)
                       );
    return uVar4;
  case 0xfe:
  case 0x102:
...
code_r0x004200ab:
  ...
  case 0x11a:
  case 0x15a:
    ppcStack_20 = (code **)0x41fdb4;
    local_18 = (code **)camlPrintf__get_arg_320();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41fde5;
      (***(code ***)(DAT_00653c20 + 0x10))();
    }
    uVar4 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x38)
                       );
    return uVar4;
  case 0x136:
    *(char *)((long)piVar5 + -0x75) =
         (*(char *)((long)piVar5 + -0x75) - (char)param_4) - ((int *)0xffffffffffbc35f3 < piVar5);
    ppcStack_20 = (code **)0x41fc9f;
    camlPrintf__extract_format_float_138(param_1,CONCAT44(unaff_retaddr_00,unaff_retaddr));
    ppcStack_20 = (code **)0x41fca9;
    local_18 = (code **)camlPrintf__fun_630();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41fcd9;
      (***(code ***)(DAT_00653c20 + 0x10))();
    }
    uVar4 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28)
                       );
    return uVar4;
  case 0x15c:
    ppcStack_20 = (code **)0x41fd4f;
    local_10 = (code **)camlPrintf__get_arg_320(piVar5[0x14]);
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41fd81;
      (***(code ***)(DAT_00653c20 + 0x10))();
    }
    puVar12 = *(uint **)(param_9 + 0x30);
    in_RAX = (code **)(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2);
    goto switchD_0041ed34_caseD_74;
  case 0x16c:
  case 0x184:
  case 0x18e:
  ...
  case 0x1ac:
    ...
    *pbVar8 = (*pbVar8 - (char)((ulong)unaff_RBX >> 8)) - ((int *)0xffffffffffbc35f3 < piVar5);
    ppcStack_20 = (code **)0x41ff98;
    local_10 = (code **)camlPrintf__get_arg_320(param_4[0x14]);
    param_1 = *(code ***)(param_9 + 0x20);
    in_RAX = (code **)CONCAT44(unaff_retaddr_00,unaff_retaddr);
    puVar12 = puStack_8;
    goto switchD_0041ed34_caseD_fe;
  case 0x16e:
  case 0x170:
  ...
  case 0x1aa:
    if (in_RAX == (code **)0xc7) {
      ppcStack_20 = (code **)0x41ff0b;
      local_18 = (code **)camlString__make_66();
      goto LAB_0041ff3b;
    }
LAB_0041ff14:
    ppcStack_20 = (code **)0x41ff1c;
    camlChar__escaped_66();
    ppcStack_20 = (code **)0x41ff28;
    camlPervasives___5e_136();
    ppcStack_20 = (code **)0x41ff37;
    local_18 = (code **)camlPervasives___5e_136();
LAB_0041ff3b:
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41ff69;
      (***(code ***)(DAT_00653c20 + 0x10))();
    }
    uVar4 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28)
                       );
  ...
  case 0x1cc:
    *(char *)piVar5 = *(char *)piVar5 + cVar3;
    if ((long)param_1 >> 1 == 1) {
      ppcStack_20 = (code **)0x4202a4;
      local_18 = (code **)camlPrintf__get_arg_320(*(undefined8 *)(param_4 + 0x14));
      ppcStack_20 = (code **)0x4202c4;
      uVar4 = camlPrintf__extract_format_113(local_10,puStack_8);
      ppcStack_20 = (code **)0x4202d7;
      local_18 = (code **)caml_c_call(uVar4,local_18);
      goto LAB_004202db;
    }
    if (1 < (long)param_1 >> 1) {
      ppcStack_20 = (code **)0x42025c;
      local_18 = (code **)camlPrintf__get_arg_320(*(undefined8 *)(param_4 + 0x14));
      ppcStack_20 = (code **)0x42027c;
      uVar4 = camlPrintf__extract_format_113(local_10,puStack_8);
      ppcStack_20 = (code **)0x42028f;
      local_18 = (code **)caml_c_call(uVar4,local_18);
      goto LAB_004202db;
    }
    ...
    goto switchD_0041ed34_caseD_1ae;
  case 0x1c2:
    local_18 = (code **)CONCAT71(iVar10,cVar3 + (char)((ulong)param_4 >> 8));
    *(int *)local_18 = *(int *)local_18 + (int)local_18;
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x4201bd;
      (***(code ***)(DAT_00653c20 + 0x10))();
    }
    uVar4 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28)
                       );
    return uVar4;
  case 0x1e2:
    *(ulong *)(piVar5 + 0x10f287) = (ulong)(uVar1 + 0x22602b);
...
code_r0x0042109e:
  ...
  case 0x1f0:
  case 0x1f2:
    ppcStack_20 = (code **)0x43ca13;
    (**(code **)((long)unaff_RBX + -2))((uint)param_1 & (uint)in_RAX);
    ppcStack_20 = (code **)0x43ca17;
  ...
  param_1 = (code **)((ulong)*(byte *)(uVar6 + (long)puVar11) * 2 + 1);
  if ((code **)0xf8 < param_1) {
    uVar4 = camlPrintf__bad_conversion_format_89();
    return uVar4;
  }
  *pppcVar13 = param_1;
  ((byte **)pppcVar13)[6] = (byte *)param_4;
  ((byte **)pppcVar13)[3] = (byte *)in_RAX;
code_r0x0041fbac:
  *(code ***)((long)pppcVar13 + 0x10) = param_6;
  *(code ***)((long)pppcVar13 + 0x28) = unaff_RBX;
  *(int **)((long)pppcVar13 + 0x20) = piVar5;
  puVar12 = &switchD_0041fbcf::switchdataD_0043ca74;
...
switchD_0041ed34_caseD_cc:
                    ...
                    // WARNING: Treating indirect jump as call
  uVar4 = (*(code *)((long)puVar12 + (long)piVar5))
                    (param_1,in_RAX,(code *)((long)puVar12 + (long)piVar5));
  return uVar4;
switchD_0041ed34_caseD_5c:
  unaff_RBX = (code **)((long)unaff_RBX + 2);
  goto LAB_0041ecc4;
switchD_0041ed34_caseD_74:
  uVar4 = caml_apply4(local_10,in_RAX,puVar12);
  return uVar4;
switchD_0041ed34_caseD_fe:
  ppcStack_20 = (code **)0x41ffbd;
  uVar4 = camlPrintf__extract_format_int_131(param_1,in_RAX,puVar12);
  ppcStack_20 = (code **)0x41ffd1;
  local_18 = (code **)caml_c_call(uVar4,local_10);
  if (param_7 == 1) {
    ppcStack_20 = (code **)0x420001;
    (***(code ***)(DAT_00653c20 + 0x10))();
  }
  uVar4 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28));
  return uVar4;
switchD_0041ed34_caseD_1ae:
  ppcStack_20 = (code **)0x420211;
  local_18 = (code **)camlPrintf__get_arg_320(param_1);
  ppcStack_20 = (code **)0x420231;
  uVar4 = camlPrintf__extract_format_113(local_10,puStack_8);
  ppcStack_20 = (code **)0x420244;
  local_18 = (code **)caml_c_call(uVar4,local_18);
LAB_004202db:
  if (param_7 == 1) {
    ppcStack_20 = (code **)0x420309;
    (***(code ***)(DAT_00653c20 + 0x10))();
  }
...

{
  ...
  if ((((long)uVar3 >> 1) % 2 & 0x7fffffffffffffffU) != 0) {
    lVar5 = DAT_006515d8 >> 1;
    if (lVar5 == 0) {
                    // WARNING: Subroutine does not return
      caml_raise_exn();
    }
    ...
    lVar4 = (*(long *)(lVar1 + 8) + -1) * 0x10 + 1;
    auVar2._8_8_ = lVar4 >> 0x3f;
    auVar2._0_8_ = lVar4 >> 1;
    if ((long)uVar3 <= SUB168(auVar2 / SEXT816(lVar5),0) * 2 + 5) {
      uVar3 = camlCamlinternalOO__new_method_203(in_RAX,lVar1,SUB168(auVar2 % SEXT816(lVar5),0));
    }
  }
  if (uVar3 < *(ulong *)(*(long *)(in_RAX + 8) + -8) >> 9) {
...

{
  ...
  iVar1 = getitimer((&itimers)[(int)(param_1 >> 1)],&iStack_28);
  if (iVar1 == -1) {
                    // WARNING: Subroutine does not return
...

{
  ...
  iVar1 = setitimer((&itimers)[(int)(param_1 >> 1)],(itimerval *)local_38,&iStack_58);
  if (iVar1 == -1) {
                    // WARNING: Subroutine does not return
    uerror(0x43cf46,0);
  }
...

{
  ...
  caml_enter_blocking_section();
  iVar1 = sigprocmask(__how,&local_98,&sStack_118);
  caml_leave_blocking_section();
  if (iVar1 == -1) {
                    // WARNING: Subroutine does not return
    uerror(0x43d05e,0);
...
LAB_00429878:
          iVar1 = *(int *)ppuVar6;
          ppuVar6 = ppuVar5 + 2;
          *(char *)((long)iVar1 + 0x6588b1) = (char)((long)*param_3 >> 1);
        }
      }
      else {
...
LAB_004299ff:
      ...
      *plVar13 = 0x4b01;
      ...
      psVar10 = &DAT_0043d208;
      iVar5 = 1;
      ppuVar4 = ppuVar11 + 2;
      if (sVar7 == 1) {
        iVar5 = 0;
LAB_00429a5a:
        *plVar13 = (long)(int)(&DAT_0043d204)[(long)iVar5 * 2] * 2 + 1;
      }
      else {
        do {
      ...
      *plVar13 = (ulong)*(byte *)((long)*(int *)ppuVar4 + 0x6588b1) * 2 + 1;
      ppuVar4 = ppuVar11 + 2;
    }
    ppuVar11 = ppuVar4;
    puVar9 = *ppuVar11;
        ...
        do {
          ...
          if (999 < iVar16) {
            ...
            while( true ) {
              ...
              puVar9 = puVar3;
              if ((*(ulong *)(*DAT_0065cc58 + -8) >> 10 <= (ulong)puVar3[-1] >> 10) &&
...
LAB_0042ca4b:
    if (iVar19 + flp_size < 0x3ea) {
      if ((iVar19 == 1) ||
         (memmove(&flp + (iVar19 + iVar16),&DAT_0065ad28 + iVar16,
...

{
  ...
  if (caml_young_ptr != caml_young_end) {
    ...
    if (caml_ref_table < DAT_0065ccf8) {
      do {
        puVar1 = (undefined8 *)*puVar8;
        puVar8 = puVar8 + 1;
        caml_oldify_one(*puVar1,puVar1);
      } while (puVar8 < DAT_0065ccf8);
    }
    caml_oldify_mopup();
    ...
    for (ppuVar6 = caml_weak_ref_table; ppuVar6 < DAT_0065cd38; ppuVar6 = ppuVar6 + 1) {
      puVar2 = *ppuVar6;
      puVar3 = (ulong *)*puVar2;
...

{
  ...
  uVar2 = (param_1 >> 0xc) * -0x61c8864680b583ea >> ((byte)DAT_0065cd88 & 0x3f);
  uVar1 = *(ulong *)(DAT_0065cda0 + uVar2 * 8);
  while( true ) {
    if (((uVar1 ^ param_1) & 0xfffffffffffff000) == 0) {
      return (uint)uVar1 & 0xff;
    }
    if (uVar1 == 0) break;
    uVar2 = uVar2 + 1 & DAT_0065cd90;
    uVar1 = *(ulong *)(DAT_0065cda0 + uVar2 * 8);
  }
  return 0;
}
  ...
  *param_1 = param_2;
  ...
  if ((uVar2 & 1) != 0) {
    ...
    if (((((param_2 & 1) == 0) && (param_2 < caml_young_end)) && (caml_young_start < param_2)) &&
      ...
      if (_DAT_0065cd00 <= DAT_0065ccf8) {
        caml_realloc_ref_table(&caml_ref_table);
      }
      *DAT_0065ccf8 = param_1;
      DAT_0065ccf8 = DAT_0065ccf8 + 1;
    }
  }
  return;
}
...

{
  ...
  if (caml_page_table <= (ulong)(DAT_0065cd98 * 2)) {
  ...
  uVar6 = (param_1 >> 0xc) * -0x61c8864680b583ea >> ((byte)DAT_0065cd88 & 0x3f);
  puVar1 = (ulong *)((long)DAT_0065cda0 + uVar6 * 8);
  uVar2 = *puVar1;
  while( true ) {
    if (uVar2 == 0) {
      *puVar1 = (long)param_3 | param_1;
      DAT_0065cd98 = DAT_0065cd98 + 1;
      return 0;
    }
    if (((uVar2 ^ param_1) & 0xfffffffffffff000) == 0) break;
    uVar6 = uVar6 + 1 & DAT_0065cd90;
    puVar1 = (ulong *)((long)DAT_0065cda0 + uVar6 * 8);
    uVar2 = *puVar1;
  }
...

{
  ...
  if (1 < uVar1) {
    ...
    DAT_0065cd90 = uVar2 - 1;
    caml_page_table = uVar2;
    DAT_0065cd88 = iVar3;
  }
  DAT_0065cd98 = 0;
  DAT_0065cda0 = calloc(caml_page_table,8);
  return -(uint)(DAT_0065cda0 == (void *)0x0);
}
...

{
  ...
  plVar1 = &DAT_00662948 + (param_2 & 0xffffffff);
  if (param_1 != 0) {
...
LAB_0042fd77:
    ...
    if (pcVar8 == param_1 + lVar6) {
      if (iVar9 == 10) {
        if (uVar3 <= (ulong)(1L << ((byte)param_2 - 1 & 0x3f))) goto LAB_0042fda4;
      }
...
undefined8 * caml_obj_block(long param_1,long param_2)

{
  ...
  uVar3 = param_2 >> 1;
  if (uVar3 == 0) {
    return &DAT_00662948 + (param_1 >> 1 & 0xffffffff);
  }
  puVar1 = (undefined8 *)caml_alloc(uVar3,param_1 >> 1 & 0xffffffff);
  uVar2 = 0;
  do {
    puVar1[uVar2] = 1;
    uVar2 = uVar2 + 1;
  ...
  if ((((param_3 & 1) == 0) && (param_3 < caml_young_end)) && (caml_young_start < param_3)) {
    ...
    *puVar1 = param_3;
    if ((((uVar2 & 1) != 0) || (uVar4 <= uVar2)) || (uVar2 <= uVar3)) {
      if (_DAT_0065cd40 <= DAT_0065cd38) {
        caml_realloc_ref_table(&caml_weak_ref_table);
      }
      *DAT_0065cd38 = puVar1;
      DAT_0065cd38 = DAT_0065cd38 + 1;
    }
    return;
  }
