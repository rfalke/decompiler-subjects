...
code_r0x004200ab:
  ...
  case 0x1a6:
  case 0x1ac:
    pcVar9 = (code *)((long)in_RAX + (long)param_1 * 8 + 0x3c8948ff);
    *pcVar9 = (code)(((char)*pcVar9 - (char)((ulong)unaff_RBX >> 8)) -
                    ((int *)0xffffffffffbc35f3 < piVar5));
...
LAB_0043a74e:
          ...
          pplVar11 = pplVar5;
          if (0x20 < uVar15) goto LAB_0043a7e3;
          pplVar14 = (long **)pplVar5[-1];
          if (0x20 < (ulong)((long)pplVar14[-2] - (long)pplVar14[-3])) goto LAB_0043a7e3;
          do {
            pplVar5 = pplVar14;
            pplVar14 = (long **)pplVar5[-1];
            pplVar11 = pplVar5;
...
LAB_0043a7e3:
          ...
          *pplVar3 = (long *)(lVar16 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar15;
          if ((char)uVar15 == -7) goto LAB_0043a74e;
    ...
    do {
      ...
      for (pplVar3 = pplVar8; pplVar3 < (long **)((long)pplVar8 + (long)plVar1);
        ...
        while (plVar13 = *pplVar3, ((ulong)plVar13 & 0x300) == 0) {
          ...
          pplVar3 = pplVar12;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar12) goto LAB_0043aa3b;
        }
      }
LAB_0043aa3b:
