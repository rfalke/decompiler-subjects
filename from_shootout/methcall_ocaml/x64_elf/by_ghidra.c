...

{
  ...
  plVar2 = (long *)FUN_0040c514();
  if ((undefined **)*plVar2 == &caml_exn_Failure) {
    plVar2 = (long *)FUN_0040c498();
...

{
  ...
  *(undefined8 *)(uVar6 - 8) = unaff_RBX;
  ...
  if (lVar4 == 1) {
    plVar5 = (long *)FUN_0040e08c();
    if ((undefined **)*plVar5 != &caml_exn_Failure) {
                    // WARNING: Subroutine does not return
      caml_raise_exn();
    }
    plVar5 = (long *)FUN_0040e010();
    ...
    if (lVar4 == 1) {
      ...
      *(undefined8 *)(uVar6 - 0x30) = 0x800;
      *(undefined8 *)(uVar6 - 0x28) = DAT_00648e90;
      ...
      *(undefined8 *)(uVar7 - 0x28) = DAT_00648e88;
...

{
  ...
  *camlUnix = camlUnix__64;
  ...
  caml_allocN();
  DAT_00648c50 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_00648c50 = &camlUnix__50;
...

{
  ...
  *DAT_0064cd98 = camlPervasives__65;
  ...
  caml_allocN();
  DAT_0064cfd0 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_0064cfd0 = &camlPervasives__7;
  ...
  DAT_0064d018 = unaff_R15 + 8;
  unaff_R15[7] = 0x400;
  *DAT_0064d018 = DAT_0064cee8;
...

{
  ...
  uVar1 = (***(code ***)(*(long *)(*(long *)(param_2 + 0x18) + 0x10) + 8))();
  uVar3 = SUB168(ZEXT816((ulong)((long)(uVar1 & 0x7fffffffffffffff) >> 1)) % SEXT816((long)uVar3),0)
          * 2 + 1;
  while( true ) {
    if (caml_young_limit <= unaff_R15 - 0x20) break;
    caml_call_gc();
...

{
  ...
  *(undefined8 *)(unaff_R15 - 8) = unaff_RBX;
  ...
  uVar2 = SUB168(ZEXT816((ulong)((long)(uVar3 & 0x7fffffffffffffff) >> 1)) % SEXT816((long)uVar2),0)
          * 2 + 1;
  lVar1 = *(long *)(in_RAX + 8);
  if (*(ulong *)(lVar1 + -8) >> 9 <= uVar2) {
                    // WARNING: Subroutine does not return
    caml_ml_array_bound_error();
  }
  if (uVar2 < *(ulong *)(*(long *)(in_RAX + 8) + -8) >> 9) {
    uVar4 = camlHashtbl__remove_bucket_216();
    caml_modify(lVar1 + -4 + uVar2 * 4,uVar4);
    return 1;
  }
                    // WARNING: Subroutine does not return
  caml_ml_array_bound_error();
...

{
  ...
  uVar1 = (***(code ***)(*(long *)(*(long *)(param_1 + 0x20) + 0x10) + 8))();
  uVar5 = SUB168(ZEXT816((ulong)((long)(uVar1 & 0x7fffffffffffffff) >> 1)) % SEXT816((long)uVar5),0)
          * 2 + 1;
  if (*(ulong *)(*(long *)(in_RAX + 8) + -8) >> 9 <= uVar5) {
                    // WARNING: Subroutine does not return
    caml_ml_array_bound_error();
  }
  lVar2 = *(long *)(*(long *)(in_RAX + 8) + -4 + uVar5 * 4);
  if (lVar2 == 1) {
    while( true ) {
      if (caml_young_limit <= unaff_R15 - 0x10) break;
      caml_call_gc();
  ...
  uVar4 = camlHashtbl__find_rec_221(*(undefined8 *)(param_1 + 0x28));
  return uVar4;
}
...

{
  ...
  *(undefined8 *)(unaff_R15 - 8) = unaff_RBX;
  uVar1 = *(ulong *)(*(long *)(in_RAX + 8) + -8) >> 10;
  if (uVar1 != 0) {
    uVar2 = (***(code ***)(*(long *)(*(long *)(param_1 + 0x20) + 0x10) + 8))();
    if (SUB168(ZEXT816((ulong)((long)(uVar2 & 0x7fffffffffffffff) >> 1)) % SEXT816((long)uVar1),0) *
...

{
  ...
  *(undefined8 *)(unaff_R15 - 8) = param_1;
  uVar1 = *(ulong *)(in_RAX[1] + -8) >> 10;
  if (uVar1 == 0) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar2 = (***(code ***)(*(long *)(*(long *)(param_2 + 0x20) + 0x10) + 8))();
  uVar1 = SUB168(ZEXT816((ulong)((long)(uVar2 & 0x7fffffffffffffff) >> 1)) % SEXT816((long)uVar1),0)
          * 2 + 1;
  if (*(ulong *)(in_RAX[1] + -8) >> 9 <= uVar1) {
                    // WARNING: Subroutine does not return
    caml_ml_array_bound_error();
  }
  uVar4 = *(undefined8 *)(in_RAX[1] + -4 + uVar1 * 4);
  plVar3 = (long *)FUN_0041a758();
  if ((undefined **)*plVar3 == &caml_exn_Not_found) {
    lVar5 = in_RAX[1];
    if (*(ulong *)(lVar5 + -8) >> 9 <= uVar1) {
                    // WARNING: Subroutine does not return
      caml_ml_array_bound_error();
    }
    while( true ) {
...

{
  ...
  if (uVar2 < 0xbf) {
    ...
    else if (lVar1 - 0x81U < 0x34) goto switchD_0041d1eb_caseD_180;
  }
  else {
...
LAB_0041e70c:
    ...
    if (uVar2 != 0x5b) goto LAB_0041e70c;
    unaff_RBX = unaff_RBX + 2;
    in_RAX = 3;
  } while( true );
}
...

{
  ...
  do {
    ...
    uVar2 = (ulong)(int)(&switchD_0041ea5f::switchdataD_0043c790)[lVar5 >> 1];
    switch(lVar5) {
    default:
...
switchD_0041ed34_caseD_42:
  ...
  case 0xc4:
  case 0x16a:
    pbVar8 = (byte *)((ulong)piVar5 & 0xffffffffffffff00 | (ulong)*(byte *)in_RAX);
  ...
  case 0x100:
    uVar4 = caml_apply3((byte *)((long)in_RAX + 2),param_4,&camlPrintf__61);
    return uVar4;
  case 0x10c:
  case 0x14c:
  case 0x150:
code_r0x004200ab:
  ...
  case 0x1a6:
  case 0x1ac:
    pbVar8 = (byte *)((long)in_RAX + (long)param_1 * 8 + 0x3c8948ff);
    *pbVar8 = (*pbVar8 - (char)((ulong)unaff_RBX >> 8)) - ((int *)0xffffffffffbc35f3 < piVar5);
...
code_r0x0042109e:
  ...
  *pppcVar12 = param_1;
  ((byte **)pppcVar12)[6] = (byte *)param_4;
  ((byte **)pppcVar12)[3] = (byte *)in_RAX;
code_r0x0041fbac:
...
LAB_004202db:
  ...
  uVar4 = caml_apply3((byte *)((long)local_10 + 2),*(undefined8 *)(param_9 + 0x28));
  return uVar4;
}
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  DAT_00653c20 = unaff_R15 + 9;
  unaff_R15[8] = 0x1800;
  *DAT_00653c20 = &camlPrintf__38;
  ...
  *DAT_00653cd0 = caml_curry2;
  ...
  ppuVar4 = DAT_00653c98;
  ppuVar3 = DAT_00653c88;
  ...
  unaff_R15[0x15] = ppuVar4;
  unaff_R15[0x16] = ppuVar8;
  unaff_R15[0x17] = ppuVar3;
  unaff_R15[0x18] = &camlPrintf__14;
  unaff_R15[0x19] = ppuVar5;
  plVar7 = unaff_R15 + 0x1b;
...

{
  ...
  (***(code ***)(*in_RAX + -4 + *(long *)(unaff_RBX + 0x18) * 4))();
...

{
  ...
  (***(code ***)(*in_RAX + -4 + *(long *)(unaff_RBX + 0x20) * 4))();
  caml_apply2(*(undefined8 *)(unaff_RBX + 0x10));
  return;
}
...

{
  ...
  caml_send0(*in_RAX + -4 + *(long *)(unaff_RBX + 0x28) * 4);
  return;
}
...

{
  ...
  *DAT_00655ef0 = *DAT_00655ef0 + 2;
  ...
  if (3 < *(ulong *)(lVar2 + -8) >> 9) {
    ...
    caml_modify(lVar2 + 8,(lVar3 >> 3) * 2 + -1);
    uVar6 = 1;
    if (0 < (long)(uVar5 - 2)) {
      do {
        uVar8 = uVar6 * 2 + 5;
...

{
  ...
  *(undefined8 *)(uVar4 - 0x28) = 0x800;
  *(undefined8 *)(uVar4 - 0x20) = uVar2;
  *(undefined8 **)(uVar4 - 0x18) = (undefined8 *)(uVar3 - 0x10);
  *(undefined8 *)(uVar4 - 0x10) = 0x400;
  *(undefined8 *)(uVar4 - 8) = local_20;
  uVar2 = caml_c_call();
  while( true ) {
    if (caml_young_limit <= uVar5 - 0x18) break;
    caml_call_gc();
    uVar5 = uVar5 - 0x18;
  }
  *(undefined8 *)(uVar5 - 0x18) = 0x800;
  *(undefined8 *)(uVar5 - 0x10) = uVar2;
  *(undefined8 **)(uVar5 - 8) = (undefined8 *)(uVar4 - 0x20);
...

{
  ...
  puVar11 = terminal_io_descr;
  puVar9 = terminal_io_descr._0_8_;
  plVar13 = plVar8;
  do {
    ppuVar4 = (uint **)((long)puVar11 + 8);
    if (puVar9 == (uint *)0x1) {
      ppuVar1 = (uint **)((long)puVar11 + 0x10);
      iVar5 = *(int *)((long)puVar11 + 0x18);
      ppuVar2 = (uint **)((long)puVar11 + 0x20);
      ppuVar12 = (uint **)((long)puVar11 + 0x28);
      if (0 < iVar5) {
        iVar6 = 0;
        puVar9 = *ppuVar12;
        while ((uint *)(long)(int)((uint)*ppuVar2 & **ppuVar4) != puVar9) {
          iVar6 = iVar6 + 1;
          if (iVar5 <= iVar6) goto LAB_004299ff;
          ppuVar3 = (uint **)((long)puVar11 + 0x30);
          puVar11 = (undefined1 *)((long)puVar11 + 8);
          puVar9 = *ppuVar3;
        }
...
LAB_004299ff:
      ...
      if (puVar9 == (uint *)0x0) {
        *plVar13 = (-(ulong)(((uint)*(uint **)((long)puVar11 + 0x10) & **ppuVar4) == 0) &
                   0xfffffffffffffffe) + 3;
        ppuVar4 = (uint **)((long)puVar11 + 0x18);
      }
    }
      ...
      *plVar13 = 0x4b01;
      ...
      psVar10 = (speed_t *)(speedtable + 8);
      iVar5 = 1;
      ppuVar4 = (uint **)((long)puVar11 + 0x10);
      if (sVar7 == 1) {
        iVar5 = 0;
LAB_00429a5a:
        *plVar13 = (long)*(int *)(speedtable + (long)iVar5 * 8 + 4) * 2 + 1;
      }
      else {
        do {
          if (*psVar10 == sVar7) goto LAB_00429a5a;
          iVar5 = iVar5 + 1;
          psVar10 = psVar10 + 2;
        } while (iVar5 != 0x12);
      }
      ...
      *plVar13 = (ulong)(byte)terminal_status[(long)*(int *)ppuVar4 + 0x11] * 2 + 1;
      ppuVar4 = (uint **)((long)puVar11 + 0x10);
    }
...

{
  ...
  ppuStack160 = &puStack48;
  puStack48 = (undefined8 *)caml_alloc_small(1,0);
  *puStack48 = ppuStack192;
                    // WARNING: Subroutine does not return
  caml_raise(puStack48);
}
...

{
  ...
  ppuStack152 = &puStack40;
  puStack40 = (undefined8 *)caml_alloc_small(1,0);
  *puStack40 = ppuStack184;
                    // WARNING: Subroutine does not return
  caml_raise(puStack40);
}
...

{
  ...
  ppuStack144 = &puStack32;
  puStack32 = (undefined8 *)caml_alloc_small(1,0);
  *puStack32 = ppuStack176;
                    // WARNING: Subroutine does not return
  caml_raise(puStack32);
}
...

{
  ...
  undefined8 **ppuStack136;
  undefined8 uStack96;
  undefined8 uStack88;
  undefined8 uStack80;
  undefined ***pppuStack72;
  undefined8 *puStack24;
  undefined8 uStack16;
  ...
  ppuStack136 = &puStack24;
  puStack24 = (undefined8 *)caml_alloc_small(1,0);
  *puStack24 = ppuStack168;
                    // WARNING: Subroutine does not return
  caml_raise(puStack24);
}
...

{
  ...
  if (caml_allocation_policy == 1) {
    if (caml_fl_merge == (ulong **)(sentinel + 0x10)) {
      ...
      if ((0 < flp_size) &&
         (iVar3 = flp_size + -1,
         caml_fl_merge < (ulong **)**(undefined8 **)(flp + (long)(flp_size + -1) * 8) ||
         caml_fl_merge == (ulong **)**(undefined8 **)(flp + (long)(flp_size + -1) * 8))) {
        do {
          flp_size = iVar3;
          if (flp_size == 0) {
          ...
          iVar3 = flp_size + -1;
        } while (caml_fl_merge < (ulong **)**(undefined8 **)(flp + (long)(flp_size + -1) * 8) ||
                 caml_fl_merge == (ulong **)**(undefined8 **)(flp + (long)(flp_size + -1) * 8));
      }
...
LAB_0042fd77:
    ...
    if (pcVar8 == param_1 + lVar6) {
      ...
      else if ((0x3f < param_2) || (uVar3 < (ulong)(1 << ((byte)param_2 & 0x3f)))) {
LAB_0042fda4:
        uVar5 = -uVar3;
        if (iVar7 != -1) {
          uVar5 = uVar3;
...

{
  ...
  case 1:
    ...
    uVar10 = (ulong)(int)(param_2[0xd] >> 1);
    ...
    for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
      ...
      while( true ) {
        ...
        *pplVar4 = (long *)((ulong)plVar15 & 0xfffffffffffffc00 | 0x3f3);
        pplVar4 = pplVar4 + ((ulong)plVar15 >> 10) + 1;
        if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar4) goto LAB_0043a58c;
      }
...
LAB_0043a74e:
          ...
          pplVar13 = pplVar6;
          if (0x20 < uVar17) goto LAB_0043a7e3;
          pplVar11 = (long **)pplVar6[-1];
          if (0x20 < (ulong)((long)pplVar11[-2] - (long)pplVar11[-3])) goto LAB_0043a7e3;
          do {
            pplVar6 = pplVar11;
            pplVar11 = (long **)pplVar6[-1];
            pplVar13 = pplVar6;
...
LAB_0043a7e3:
          ...
          *pplVar4 = (long *)(lVar18 * 0x400 + -0x400 + (ulong)uVar3);
          ...
          uVar3 = (uint)uVar17;
          if ((char)uVar17 == -7) goto LAB_0043a74e;
    ...
    do {
      ...
      for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
        ...
        while (plVar15 = *pplVar4, ((ulong)plVar15 & 0x300) == 0) {
          ...
          pplVar4 = pplVar14;
          if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar14) goto LAB_0043aa3b;
        }
      }
LAB_0043aa3b:
...
undefined  [16] FUN_0043bf3b(undefined8 param_1,undefined8 param_2,undefined8 param_3)
