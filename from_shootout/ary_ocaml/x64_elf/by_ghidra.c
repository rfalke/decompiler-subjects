...

{
  ...
  if (in_RAX != 0xb9) {
    lVar5 = in_RAX >> 1;
    uVar6 = SEXT48(*(int *)(lVar5 * 4 + 0x435210));
    switch(in_RAX) {
    case 0x10:
    case 0x11:
      return &camlChar__8;
    ...
    case 0x1c:
      ...
      bVar9 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,0xffffffffffbcadef < uVar6);
      *pcVar1 = (*pcVar1 - 1U) + (0xffffffffffbcadef < uVar6);
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      ...
      *(int *)(&UNK_00435206 + (long)(&stack0x00000000 + uVar6)) =
           *(int *)(&UNK_00435206 + (long)(&stack0x00000000 + uVar6)) + 1;
      (**(code **)(uVar6 + 0x14))();
...
LAB_0041aca0:
    ...
    if (uVar3 == 0) goto LAB_0041acb4;
    if (uVar3 == 1) goto LAB_0041aca0;
    if (1 < (long)uVar3) goto LAB_0041acdc;
  }
  if (uVar3 != 1) {
LAB_0041acdc:
...

{
  ...
  do {
    ...
    uVar2 = SEXT48((int)(&switchD_0041b70f::switchdataD_00435430)[lVar5 >> 1]);
    switch(lVar5) {
    default:
    ...
    case 0xf7:
      ...
      *(long *)(uVar2 - 8) = lVar5;
      ...
      break;
    case 0xfc:
      *(char *)(uVar2 - 0x7d) = (*(char *)(uVar2 - 0x7d) - in_AL) - (0xffffffffffbcabcf < uVar2);
      return uVar2;
    }
  } while( true );
}
...
code_r0x0041cd5b:
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
         (*(char *)((long)piVar6 + -0x75) - cVar11) - ((int *)0xffffffffffbca953 < piVar6);
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar11;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d5af) = (ulong)(iVar1 + 0x221eab);
    *(undefined8 *)(piVar6 + 0x10d5b1) = 0x10f9;
    *(code **)(piVar6 + 0x10d5b3) = caml_curry2;
  case 0x1e4:
    *(undefined8 *)(piVar6 + 0x10d5b5) = 5;
    *(code **)(piVar6 + 0x10d5b7) = camlPrintf__scan_conv_171;
    *(undefined8 *)(piVar6 + 0x10d5b9) = 0x20f9;
    *(code **)(piVar6 + 0x10d5bb) = camlPrintf__scan_fmt_172;
    *(undefined8 *)(piVar6 + 0x10d5bd) = 3;
    *(code ***)(piVar6 + 0x10d5bf) = in_RAX;
    *(code ***)(piVar6 + 0x10d5c1) = unaff_RBX;
    *(code ***)(piVar6 + 0x10d5c3) = param_1;
    *(uint **)(piVar6 + 0x10d5c5) = param_4;
...
code_r0x0041c85c:
  ...
  *(int **)((long)pppcVar14 + 0x20) = piVar6;
  puVar13 = &switchD_0041c87f::switchdataD_00435714;
  piVar6 = (int *)(long)(int)(&switchD_0041c87f::switchdataD_00435714)[(long)param_1 >> 1];
...
LAB_004245db:
  ...
  if (puVar1 != (ulong *)0x0) goto code_r0x004245e5;
  goto LAB_004245ea;
code_r0x004245e5:
  if (param_2 <= *puVar1) {
LAB_004245ea:
...
LAB_004247ab:
    ...
    if (puVar2 != (ulong *)0x0) goto code_r0x004247b5;
    goto LAB_004247ba;
  }
LAB_004247d0:
...
LAB_00425b8a:
        ...
        while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
          iVar16 = iVar16 + 1;
          if (flp_size <= iVar16) goto LAB_00425b8a;
          plVar13 = *pplVar6;
          pplVar6 = pplVar6 + 1;
      ...
      do {
        do {
          plVar12 = plVar10;
          if (plVar12 == plVar13) goto LAB_00425d0b;
...
LAB_00426d00:
  ...
  if ((uVar3 & 7) != 0) goto code_r0x00426db4;
  goto LAB_00426dd5;
code_r0x00426db4:
  ppuVar4 = param_1;
...
LAB_0042dace:
    if (0xffffffff < lVar4) goto LAB_0042dbb7;
  }
...
LAB_0042e566:
    if (uVar12 != 0) goto code_r0x0042e56f;
        ...
        if (0 < iVar6) {
          if (*pcVar9 != '\0') {
            ...
            do {
              ...
              if ((iVar6 + -1) - iVar7 < 1) goto LAB_0043041d;
              iVar7 = iVar7 + 1;
            } while (*pcVar9 != '\0');
          }
      ...
      if (bVar1 != 0) {
        if (*pcVar9 != '\0') {
          ...
          do {
            sVar4 = strlen(pcVar9);
            pcVar9 = pcVar9 + sVar4 + 1;
            if (bVar1 - 1 == iVar6) goto LAB_00430522;
            iVar6 = iVar6 + 1;
          } while (*pcVar9 != '\0');
        }
        pcVar9 = "<unknown token>";
...
LAB_0042ffa8:
    ...
    do {
      ...
      if (((-1 < iVar7) && (sVar2 != 0)) && (iVar7 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar8 = (long)iVar7;
        lVar3 = lVar8 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar8 * 2) == 0x100) goto LAB_00430598;
      }
      if (iVar6 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar6 != 0) {
    ...
    if (param_3 < uVar5) goto LAB_00431dfa;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_0043327c;
      }
...
LAB_0043343e:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_004334d3;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_004334d3;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_004334d3:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_0043343e;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_0043372b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_0043372b:
