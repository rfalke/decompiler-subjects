...
__size32 caml_raise_out_of_memory(int param1, __size32 param2, __size32 param1)
{
    ...
    __size32 esp_59; 		// r28{278}
    __size32 esp_6; 		// r28{40}
    __size32 esp_60; 		// r28{278}
    ...
    union { __size32; __size32 *; } esp_73; 		// r28{197}
    ...
    int local120; 		// tmpb{171}
    int local121; 		// tmpb{171}
    int local122; 		// tmpb{156}
    ...
    __size16 local150; 		// tmph{157}
    int local151; 		// tmph{268}
    __size16 local152; 		// tmph{335}
    __size16 local153; 		// tmph{283}
    __size16 local154; 		// tmph{157}
    __size16 local155; 		// tmph{318}
    __size16 local156; 		// tmph{300}
    __size16 local157; 		// tmph{185}
    __size16 local158; 		// tmph{4}
    __size16 local159; 		// tmph{4}
    int local16; 		// m[esp_74 - 4]{268}
    unsigned int local160; 		// edx_1{33}
    __size32 local161; 		// esp_65{154}
    int local162; 		// local97{156}
    __size16 local163; 		// local130{157}
    __size32 local164; 		// m[esp_74 - 4]{158}
    __size32 local165; 		// local54{159}
    unsigned int local166; 		// m[esp_74 - 32]{160}
    __size32 local167; 		// esp_56{168}
    int local168; 		// local89{171}
    __size32 local169; 		// local8{172}
    __size32 local17; 		// m[esp_74 - 4]{201}
    __size32 local170; 		// local37{173}
    unsigned int local171; 		// local65{174}
    int local172; 		// eax_1{180}
    union { __size32 *; __size32; } local173; 		// esp_71{197}
    unsigned int local174; 		// esi{199}
    __size32 local175; 		// local7{201}
    __size32 local176; 		// local36{202}
    unsigned int local177; 		// local64{203}
    union { __size32 *; unsigned int; } local178; 		// eax{212}
    __size32 local179; 		// esp_53{230}
    __size32 local18; 		// m[esp_74 - 4]{201}
    int local180; 		// local93{233}
    __size32 local181; 		// local20{234}
    __size32 local182; 		// local48{235}
    unsigned int local183; 		// local76{236}
    unsigned int local184; 		// ebx{255}
    union { __size32 *; __size32; } local185; 		// esp_68{256}
    __size32 local186; 		// local11{260}
    __size32 local187; 		// local40{261}
    unsigned int local188; 		// local68{262}
    unsigned int local189; 		// ebx{277}
    __size32 local19; 		// m[esp_74 - 4]{319}
    __size32 local190; 		// esp_59{278}
    int local191; 		// local96{282}
    __size16 local192; 		// local129{283}
    __size32 local193; 		// local14{284}
    __size32 local194; 		// local43{285}
    unsigned int local195; 		// local71{286}
    __size32 local196; 		// esp_62{295}
    unsigned int local197; 		// edi{298}
    int local198; 		// local99{299}
    __size16 local199; 		// local132{300}
    int local2; 		// m[esp - 32]
    __size32 local20; 		// m[esp_74 - 4]{234}
    __size32 local200; 		// local12{301}
    __size32 local201; 		// local41{302}
    unsigned int local202; 		// local69{303}
    __size32 local203; 		// esp_49{314}
    int local204; 		// local98{317}
    __size16 local205; 		// local131{318}
    __size32 local206; 		// local19{319}
    __size32 local207; 		// m[esp_74 - 28]{320}
    unsigned int local208; 		// local80{321}
    __size32 local209; 		// esp_50{331}
    __size32 local21; 		// m[esp_74 - 4]{284}
    int local210; 		// local95{334}
    __size16 local211; 		// local128{335}
    __size32 local212; 		// local13{336}
    __size32 local213; 		// local42{337}
    unsigned int local214; 		// local70{338}
    __size32 local215; 		// esp{348}
    ...
    __size32 local54; 		// m[esp_74 - 28]{159}
    __size32 local55; 		// m[esp_74 - 28]{302}
    __size32 local56; 		// m[esp_74 - 28]{302}
    ...
    unsigned int local74; 		// m[esp_74 - 32]{174}
    unsigned int local75; 		// m[esp_74 - 32]{174}
    ...
    unsigned int local80; 		// m[esp_74 - 32]{321}
    unsigned int local81; 		// m[esp_74 - 32]{203}
    unsigned int local82; 		// m[esp_74 - 32]{203}
    unsigned int local83; 		// m[esp_74 - 32]{338}
    unsigned int local84; 		// m[esp_74 - 32]{338}
...
bb0x8061b27:
    ...
    local97 = local162;
    local130 = local163;
    *(__size32*)(esp_74 - 4) = local164;
    local54 = local165;
    *(unsigned int*)(esp_74 - 32) = local166;
    local209 = esp_65;
    local210 = local97;
    local211 = local130;
    local212 = *(esp_74 - 4);
...
void caml_final_do_calls(__size32 param3, __size32 param4)
{
    ...
    if ( ~(*0x80820a0 != 0 || *0x80820b4 == 0)) {
        ecx = caml_gc_message(128, 0x8071af4); /* Warning: also results in edx, esp */
bb0x806f3e6:
        param3 = local6;
        param4 = local7;
        eax = *0x80820b4;
...
__size32 caml_raise(int param1, __size32 param2, __size32 param3, __size32 param4)
{
    ...
    union { __size32; __size32 *; } esp_80; 		// r28{18}
    ...
    int local115; 		// m[esp_65 - 32]{322}
    int local116; 		// m[esp_65 - 32]{383}
    int local117; 		// m[esp_65 - 32]{23}
    int local118; 		// m[esp_65 - 32]{295}
    int local119; 		// m[esp_65 - 32]{401}
    __size32 local12; 		// m[esp_65 + 4]{24}
    int local120; 		// m[esp_65 - 32]{401}
    int local121; 		// m[esp_65 - 32]{295}
    int local122; 		// m[esp_65 - 32]{295}
    int local123; 		// m[esp_65 - 32]{23}
    int local124; 		// m[esp_65 - 32]{23}
    int local125; 		// m[esp_65 - 32]{262}
    int local126; 		// m[esp_65 - 32]{262}
    int local127; 		// m[esp_65 - 32]{232}
    int local128; 		// m[esp_65 - 32]{232}
    int local129; 		// m[esp_65 - 32]{364}
    int local13; 		// m[esp_65 + 4]{328}
    int local130; 		// m[esp_65 - 32]{364}
    int local131; 		// m[esp_65 - 32]{346}
    int local132; 		// m[esp_65 - 32]{346}
    ...
    __size32 local21; 		// m[esp_65 + 4]{347}
    __size16 local210; 		// tmph{214}
    __size32 local211; 		// ebx{17}
    union { __size32 *; __size32; } local212; 		// esp_69{18}
    __size32 local213; 		// local49{21}
    __size32 local214; 		// local87{22}
    int local215; 		// local117{23}
    __size32 local216; 		// local12{24}
    unsigned int local217; 		// edx_1{90}
    __size32 local218; 		// esp_73{211}
    int local219; 		// local144{213}
    __size32 local22; 		// m[esp_65 + 4]{233}
    __size16 local220; 		// local177{214}
    __size32 local221; 		// m[esp_65 - 4]{215}
    __size32 local222; 		// m[esp_65 - 8]{216}
    int local223; 		// m[esp_65 - 32]{217}
    __size32 local224; 		// local17{218}
    __size32 local225; 		// esp_68{226}
    int local226; 		// local135{229}
    __size32 local227; 		// local39{230}
    __size32 local228; 		// local74{231}
    int local229; 		// local105{232}
    __size32 local23; 		// m[esp_65 + 4]{233}
    __size32 local230; 		// local11{233}
    int local231; 		// eax_1{239}
    union { __size32 *; __size32; } local232; 		// esp_67{256}
    unsigned int local233; 		// esi{258}
    __size32 local234; 		// local38{260}
    __size32 local235; 		// local73{261}
    int local236; 		// local104{262}
    union { __size32 *; unsigned int; } local237; 		// eax{271}
    __size32 local238; 		// esp_70{289}
    int local239; 		// local140{292}
    __size32 local24; 		// m[esp_65 + 4]{296}
    __size32 local240; 		// local50{293}
    __size32 local241; 		// local88{294}
    int local242; 		// local118{295}
    __size32 local243; 		// local15{296}
    unsigned int local244; 		// ebx{315}
    union { __size32 *; __size32; } local245; 		// esp_64{316}
    __size32 local246; 		// local42{320}
    __size32 local247; 		// local77{321}
    int local248; 		// local108{322}
    unsigned int local249; 		// ebx{337}
    __size32 local25; 		// m[esp_65 + 4]{296}
    __size32 local250; 		// esp_72{338}
    int local251; 		// local143{342}
    __size16 local252; 		// local176{343}
    __size32 local253; 		// local45{344}
    __size32 local254; 		// local80{345}
    int local255; 		// local111{346}
    __size32 local256; 		// local20{347}
    __size32 local257; 		// esp_75{356}
    unsigned int local258; 		// edi{359}
    int local259; 		// local146{360}
    __size32 local26; 		// m[esp_65 + 4]{4}
    __size16 local260; 		// local179{361}
    __size32 local261; 		// local43{362}
    __size32 local262; 		// local78{363}
    int local263; 		// local109{364}
    __size32 local264; 		// local19{365}
    __size32 local265; 		// esp_74{376}
    int local266; 		// local145{379}
    __size16 local267; 		// local178{380}
    __size32 local268; 		// local48{381}
    __size32 local269; 		// local90{382}
    __size32 local27; 		// m[esp_65 + 4]{4}
    int local270; 		// local116{383}
    __size32 local271; 		// local18{384}
    __size32 local272; 		// esp_71{394}
    int local273; 		// local142{397}
    __size16 local274; 		// local175{398}
    __size32 local275; 		// local44{399}
    __size32 local276; 		// local79{400}
    int local277; 		// local110{401}
    __size32 local278; 		// local16{402}
    __size32 local279; 		// esp{408}
    __size32 local28; 		// m[esp_65 + 4]{24}
    __size32 local29; 		// m[esp_65 + 4]{24}
    int local3; 		// m[esp - 32]
    ...
    __size32 local84; 		// m[esp_65 - 8]{231}
    __size32 local85; 		// m[esp_65 - 8]{363}
    __size32 local86; 		// m[esp_65 - 8]{363}
    ...
    __size32 local91; 		// m[esp_65 - 8]{400}
    __size32 local92; 		// m[esp_65 - 8]{400}
    __size32 local93; 		// m[esp_65 - 8]{261}
    __size32 local94; 		// m[esp_65 - 8]{261}
...
bb0x8061b27:
    ...
    local144 = local219;
    local177 = local220;
    *(__size32*)(esp_65 - 4) = local221;
    *(__size32*)(esp_65 - 8) = local222;
    *(esp_65 - 32) = local223;
    local17 = local224;
    local272 = esp_73;
    local273 = local144;
...
__size32 caml_raise_with_arg(int param1, __size32 param1, __size32 param2, __size32 param3)
{
    ...
    __size32 local240; 		// m[esp_68 - 48]{402}
    __size32 local241; 		// m[esp_68 - 48]{402}
    __size32 local242; 		// m[esp_68 - 48]{193}
    __size32 local243; 		// m[esp_68 - 48]{193}
    __size32 local244; 		// m[esp_68 - 48]{237}
    __size32 local245; 		// m[esp_68 - 48]{237}
    __size32 local246; 		// m[esp_68 - 48]{151}
    __size32 local247; 		// m[esp_68 - 48]{151}
    __size32 local248; 		// m[esp_68 - 48]{372}
    __size32 local249; 		// m[esp_68 - 48]{276}
    __size32 local25; 		// m[esp_68 + 4]{245}
    ...
    __size32 local26; 		// m[esp_68 + 4]{410}
    ...
    __size32 local27; 		// m[esp_68 + 4]{319}
    __size32 local270; 		// m[esp_68 - 68]{312}
    __size32 local271; 		// m[esp_68 - 68]{312}
    __size32 local272; 		// m[esp_68 - 68]{342}
    __size32 local273; 		// m[esp_68 - 68]{342}
    __size32 local274; 		// m[esp_68 - 68]{125}
    __size32 local275; 		// m[esp_68 - 68]{238}
    __size32 local276; 		// m[esp_68 - 68]{238}
    __size32 local277; 		// m[esp_68 - 68]{238}
    __size32 local278; 		// m[esp_68 - 68]{152}
    __size32 local279; 		// m[esp_68 - 68]{152}
    __size32 local28; 		// m[esp_68 + 4]{380}
    __size32 local280; 		// m[esp_68 - 68]{194}
    __size32 local281; 		// m[esp_68 - 68]{194}
    __size32 local282; 		// m[esp_68 - 68]{277}
    __size32 local283; 		// m[esp_68 - 68]{277}
    ...
    int local3; 		// m[esp - 36]
    __size32 local30; 		// m[esp_68 + 4]{319}
    ...
    __size32 local36; 		// m[esp_68 + 4]{159}
    ...
    __size32 local37; 		// m[esp_68 + 4]{159}
    ...
    __size32 local533; 		// local274{125}
    ...
    __size32 local584; 		// local244{237}
    __size32 local585; 		// local275{238}
    __size32 local586; 		// local297{239}
    ...
    __size32 local659; 		// local248{372}
    __size32 local66; 		// m[esp_68 - 4]{270}
    __size32 local660; 		// m[esp_68 - 68]{373}
...
__size32 caml_raise_with_string(__size32 param1, __size32 param2)
{
    ...
    __size32 local40; 		// m[esp_38 - 4]{217}
    __size32 local41; 		// m[esp_38 - 4]{217}
    ...
    __size32 local69; 		// m[esp_38 - 28]{255}
...
__size8 caml_raise_constant(int param1, __size32 param1, __size32 param2)
{
    ...
    __size32 local120; 		// m[esp_50 - 36]{173}
    __size32 local121; 		// m[esp_50 - 36]{90}
    __size32 local122; 		// m[esp_50 - 36]{90}
    ...
    __size32 local136; 		// m[esp_50 - 40]{211}
    __size32 local137; 		// m[esp_50 - 40]{211}
    ...
    __size32 local146; 		// m[esp_50 - 40]{131}
    __size32 local147; 		// m[esp_50 - 40]{131}
    __size32 local148; 		// m[esp_50 - 40]{174}
    __size32 local149; 		// m[esp_50 - 40]{174}
    int local15; 		// m[esp_50 + 4]{160}
    __size32 local150; 		// m[esp_50 - 40]{91}
    __size32 local151; 		// m[esp_50 - 40]{91}
    ...
    __size32 local23; 		// m[esp_50 + 4]{103}
    ...
    __size32 local25; 		// m[esp_50 + 4]{186}
    ...
    __size32 local479; 		// local80{64}
    int local48; 		// m[esp_50 - 4]{228}
    __size32 local480; 		// local109{65}
    ...
    __size32 local528; 		// local110{173}
    ...
    __size32 local624; 		// local26{342}
    __size32 local625; 		// esp{348}
    __size32 local63; 		// m[esp_50 - 4]{270}
    __size32 local64; 		// m[esp_50 - 4]{270}
    ...
    __size32 local78; 		// m[esp_50 - 32]{271}
    __size32 local79; 		// m[esp_50 - 32]{271}
    int local8; 		// m[esp - 72]
    __size32 local80; 		// m[esp_50 - 32]{64}
    ...
    __size32 local93; 		// m[esp_50 - 32]{328}
...
void caml_oldify_local_roots(__size8 param1, int param2, unsigned int param3, __size32 param4, unsigned int param5, unsigned int param6)
{
    ...
    __size32 esi; 		// r30
    int esi_11; 		// r30{59}
    __size32 esi_12; 		// r30{232}
    unsigned int esi_15; 		// r30{189}
    unsigned int esi_16; 		// r30{195}
    unsigned int esi_17; 		// r30{198}
    __size32 esi_20; 		// r30{29}
    __size32 esi_21; 		// r30{329}
    __size32 esi_22; 		// r30{304}
    union { __size32; __size32 *; } esi_24; 		// r30{302}
    __size32 esi_25; 		// r30{274}
    __size32 esi_26; 		// r30{260}
    __size32 esi_27; 		// r30{241}
    union { int *; unsigned int; } esi_28; 		// r30{108}
    __size32 esi_29; 		// r30{95}
    int esi_3; 		// r30{84}
    union { int *; unsigned int; } esi_30; 		// r30{35}
    __size32 esi_31; 		// r30{21}
    __size32 esi_32; 		// r30{315}
    __size32 esi_33; 		// r30{287}
    unsigned int esi_34; 		// r30{174}
    __size32 esi_4; 		// r30{102}
    unsigned int esi_5; 		// r30{155}
    unsigned int esi_8; 		// r30{166}
    ...
    union { unsigned int; int *; } local17; 		// esi_30{35}
    ...
    union { unsigned int; int *; } local49; 		// esi_28{108}
    ...
    unsigned int local74; 		// esi_34{174}
    ...
    unsigned int local81; 		// esi_16{195}
                    ...
                    do {
                        ...
                        if ( ~(((unsigned char) eax_8 & 0x1) != 0 || eax_8 >= *(&caml_globals + 0xc51c) || eax_8 <= *(&caml_globals + 0xc518))) {
                            ...
                            *(unsigned int*)esp_18 = eax_8;
                            bl = caml_oldify_one(*esp_18, *(esp_18 + 4), (unsigned char) edi_31 + eax_7 * 4, eax_8, ecx_30, edi_31 + eax_7 * 4); /* Warning: also results in ecx_19, ebx_17, esp_7, ebp_7, esi_20, edi_12 */
                            local13 = ecx_19;
                            local14 = ebx_17;
                            local15 = esp_7;
                            local16 = ebp_7;
                ...
                do {
                    ...
                    if ( ~(((unsigned char) eax_2 & 0x1) != 0 || eax_2 >= *(&caml_globals + 0xc51c) || eax_2 <= *(&caml_globals + 0xc518))) {
                        ...
                        *(unsigned int*)esp_31 = eax_2;
                        bl = caml_oldify_one(*esp_31, *(esp_31 + 4), (unsigned char) edi_27 + eax_1 * 4, eax_2, ecx_27, edi_27 + eax_1 * 4); /* Warning: also results in ecx_8, ebx_2, esp_4, ebp_4, esi_4, edi_7 */
                        local45 = ecx_8;
                        local46 = ebx_2;
                        local47 = esp_4;
                        local48 = ebp_4;
...
bb0x8062077:
            ...
            ebp_14 = local66;
            edi_22 = local67;
            esi_5 = *(&caml_globals + 0xffac);
            eax = (unsigned int)edx >> 3 & esi_5;
            ecx_12 = *(&caml_globals + 0x93a8);
            ebx_7 = *(ecx_12 + ((unsigned int)edx >> 3 & esi_5) * 4);
            local65 = esp_51;
            local66 = ebp_14;
            local67 = edi_22;
            local68 = eax;
                    ...
                    for(;;) {
                        ...
                        if ( ~(((unsigned char) eax & 0x1) != 0 || eax >= *(&caml_globals + 0xc51c) || eax <= *(&caml_globals + 0xc518))) {
                            ...
                            *(unsigned int*)esp_47 = eax;
                            bl = caml_oldify_one(*esp_47, *(esp_47 + 4), dl_1, eax, ecx_34, edx); /* Warning: also results in ecx_18, ebx_16, esp_6, ebp_6, esi_15, edi_10 */
                            local77 = ecx_18;
                            local78 = ebx_16;
                            local79 = esp_6;
                            local80 = ebp_6;
    ...
    *(__size32*)(ebp_13 - 28) = 0;
                ...
                do {
                    ...
                    if (*(esi_33 + 8) > 0) {
                        do {
                            ...
                            esi_27 = local96;
                            edi_21 = local97;
                            edx = ebx_29 * 4 + *(esi_27 + edi_21 * 4 + 12);
                            dl = (unsigned char) edx;
                            eax_11 = *edx;
                            local98 = eax_11;
                            local99 = ecx_23;
    ...
    esp_75 = local127;
    *(esp_78 - 32) = *0x807b9b0;
    *(__size32*)esp_75 = 0x80641cc;
    cl = caml_scan_global_young_roots(*esp_75, ecx_1); /* Warning: also results in ecx, edx, esp_8 */
    *(__size32*)esp_8 = 0x80641cc;
    edx = caml_final_do_young_roots(*esp_8, edx); /* Warning: also results in ebx_23, ebp_11, esi_21, edi_17 */
    eax = *(&caml_globals + 0x93a4);
    if (eax != 0) {
        *(__size32*)esp_11 = 0x80641cc;
        (*eax)((unsigned char) eax, dl, bl, eax, ecx, edx, ebx_23, ebp_11, esi_21, edi_17, LOGICALFLAGS32(eax), LOGICALFLAGS32(eax), LOGICALFLAGS32(eax), param4, param6, param5, param3, *(esp_78 - 32), cl);
    }
    return;
}
...
__size32 start_cycle()
{
    ...
    ecx = caml_gc_message(1, 0x8070f6b);
...
__size32 caml_callback_exn()
{
    ...
    *(__size32*)(%esp - 4) = %ebp;
    ...
    (*esi)(local0, caml_last_return_address, caml_bottom_of_stack, 0x80701de, caml_exception_pointer, pc);
...
void caml_fatal_uncaught_exception(__size32 param1, unsigned char param2)
{
    ...
    *(__size32*)(&named_value_table + 100) = 0;
    eax = caml_named_value(0x8071a07); /* Warning: also results in esp */
    if (eax != 0) {
...
bb0x8062251:
    ...
    if ( ~(eax_7 != 0 && *eax_7 == param2)) {
        eax_8 = *(&caml_globals + 0x94d8) * 0x10dcd;
        eax_11 = eax_8 + 0x6255;
        *(__size32*)(&caml_globals + 0x94d8) = eax_8 + 0x6255;
        esi = 0;
        local12 = eax_11;
...
void caml_add_to_heap(unsigned int param1)
{
    ...
    ecx = caml_gc_message(4, 0x80710df); /* Warning: also results in edx */
    eax = param1 + *(param1 - 8);
...
__size32 caml_do_roots(__size32 param1, __size8 param2, __size8 param3, __size8 param4, __size32 param5, unsigned int param6, __size32 param7, unsigned int param8, __size32 param9)
{
    ...
    __size32 local88; 		// m[esp_20 - 32]{19}
    __size32 local89; 		// m[esp_20 - 32]{141}
    __size32 local9; 		// m[esp_20 - 4]{137}
    __size32 local90; 		// m[esp_20 - 32]{114}
    int local91; 		// m[esp_20 - 32]{148}
    __size32 local93; 		// m[esp_20 - 32]{99}
    __size32 local94; 		// m[esp_20 - 32]{61}
    __size32 local95; 		// m[esp_20 - 32]{37}
    __size32 local96; 		// m[esp_20 - 32]{166}
    __size32 local97; 		// m[esp_20 - 32]{77}
    int local98; 		// m[esp_20 - 32]{44}
            ...
            if ((unsigned int)edx_6 >> 10 != 0) {
                do {
                    ...
                    *(unsigned int*)(esp_29 + 4) = edi + eax * 4;
                    eax = *(edi + eax * 4);
                    *(__size32*)esp_29 = eax;
                    (**(ebp + 8))(al, eax, ecx, edx, ebx, ebp, esi, edi, flags, ZF, CF, local15, local35, local55, local75, local95, cl, dl);
                    local106 = al;
                    local107 = ecx;
                    local110 = esp_17;
                    local111 = local18;
            ...
            if ((unsigned int)eax >> 10 != 0) {
                ...
                do {
                    ...
                    *(unsigned int*)(esp_25 + 4) = edi + eax * 4;
                    eax = *(edi + eax * 4);
                    *(__size32*)esp_25 = eax;
                    (**(ebp + 8))(al, eax, ecx, edx, ebx, ebp, esi, edi, flags, ZF, CF, local9, local29, local49, local69, local89, cl, dl);
                    local164 = esp_4;
                    local165 = local11;
                    local166 = local31;
                    local167 = local51;
...
__size8 caml_do_local_roots(__size32 param1, __size32 param2, __size32 param3, unsigned int param4, __size32 param5, __size32 param6, unsigned int param7, unsigned int param8, __size32 param9, unsigned int param10, unsigned int param11)
{
    ...
    unsigned int local114; 		// m[esp_35 - 8]{166}
    ...
    unsigned int local139; 		// m[esp_35 - 12]{167}
    unsigned int local140; 		// m[esp_35 - 12]{39}
    ...
    __size32 local312; 		// local83{37}
    unsigned int local313; 		// local111{38}
    unsigned int local314; 		// local140{39}
    ...
    __size32 local337; 		// local88{116}
    unsigned int local338; 		// local120{117}
    ...
    __size32 local352; 		// local86{165}
    unsigned int local353; 		// local114{166}
    unsigned int local354; 		// local139{167}
    ...
    __size32 local365; 		// local85{186}
    unsigned int local366; 		// local113{187}
    unsigned int local367; 		// local141{188}
    unsigned int local368; 		// local169{189}
    __size32 local369; 		// local189{190}
    __size32 local370; 		// local218{191}
    __size32 local371; 		// m[esp_35 + 8]{192}
    ...
    __size32 local377; 		// local84{208}
    unsigned int local378; 		// local112{209}
    unsigned int local379; 		// m[esp_35 - 12]{210}
    unsigned int local380; 		// local168{211}
    __size32 local381; 		// local188{212}
    __size32 local382; 		// local217{213}
    __size32 local383; 		// local21{214}
    ...
    if (*(ebp + 24) != 0) {
        ...
        *(__size32*)(ebp - 28) = 0;
        do {
            ...
            local84 = local377;
            local112 = local378;
            *(unsigned int*)(esp_35 - 12) = local379;
            local168 = local380;
            local188 = local381;
            local217 = local382;
            local21 = local383;
...
__size32 caml_final_do_strong_roots(__size32 param1, __size32 param2, __size32 param3, __size32 param4, unsigned int param5, __size32 param6)
{
    ...
    int local8; 		// m[esp_24 + 4]{29}
    __size32 local80; 		// m[esp_24 - 16]{0}
    int local81; 		// m[esp_24 - 16]{62}
    int local82; 		// m[esp_24 - 16]{62}
    __size32 local83; 		// m[esp_24 - 16]{39}
    __size32 local84; 		// m[esp_24 - 16]{89}
    __size32 local85; 		// m[esp_24 - 16]{0}
    __size32 local86; 		// m[esp_24 - 16]{0}
    __size32 local87; 		// m[esp_24 - 16]{0}
    __size32 local88; 		// m[esp_24 - 16]{0}
    int local89; 		// m[esp - 60]
    int local9; 		// m[esp_24 + 4]{29}
            ...
            if (*(ebx + 4) != 0) {
                do {
                    ...
                    *(__size32*)(esp_7 + 4) = edi + 12;
                    eax = *(ebx + 12);
                    *(__size32*)esp_7 = eax;
                    (**(ebp + 8))(eax, edx, ebx, ebp, esi, edi + 12, <all>, ADDFLAGS32(edi, 12, edi + 12), ADDFLAGS32(edi, 12, edi + 12), ADDFLAGS32(edi, 12, edi + 12), local10, local23, local41, local59, local77);
                    local100 = esp_10;
                    local102 = esp_10;
                    local103 = local27;
                    local104 = local45;
