...

{
  ...
  if (uVar2 < 0xbf) {
    ...
    else if (lVar1 - 0x81U < 0x34) goto switchD_0041aaab_caseD_180;
  }
  else {
...
switchD_0041c5f4_caseD_42:
  ...
  case 0xc4:
  case 0x16a:
    pbVar9 = (byte *)((ulong)piVar6 & 0xffffffffffffff00 | (ulong)*(byte *)in_RAX);
...
code_r0x0041e95e:
  ...
  *pppcVar14 = param_1;
  ((byte **)pppcVar14)[6] = (byte *)param_4;
  ((byte **)pppcVar14)[3] = (byte *)in_RAX;
code_r0x0041d46c:
