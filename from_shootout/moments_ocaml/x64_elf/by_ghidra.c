...

{
  ...
  *unaff_R15 = 0x400;
  *DAT_00641620 = lVar1;
  plVar2 = (long *)FUN_0040b0a4();
  if ((undefined **)*plVar2 != &caml_exn_End_of_file) {
    return plVar2;
  }
  uVar4 = *DAT_00641608;
  lVar1 = *DAT_00641620;
...

{
  ...
  if (uVar2 < 0xbf) {
    ...
    else if (lVar1 - 0x81U < 0x34) goto switchD_0041a99b_caseD_180;
  }
  else {
...
switchD_0041c4e4_caseD_42:
  ...
  case 0xc4:
  case 0x16a:
    pbVar10 = (byte *)((ulong)piVar6 & 0xffffffffffffff00 | (ulong)*(byte *)in_RAX);
