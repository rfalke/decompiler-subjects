...
long * camlSource__scan_words_83(long param_1)

{
  ...
  while( true ) {
    ...
    plVar1 = (long *)FUN_0040a7e4();
    uVar2 = unaff_R15;
    if ((undefined **)*plVar1 != &caml_exn_Not_found) break;
    while( true ) {
...

{
  ...
  *plVar1 = *plVar1 + 2;
  while( true ) {
    ...
    while( true ) {
      while( true ) {
        while( true ) {
          ...
          uVar3 = (ulong)*(byte *)(DAT_006410c0 + (in_stack_00000010 >> 1)) * 2 + 1;
          if ((uVar3 < 0xc3) || (0xf5 < uVar3)) break;
          camlBuffer__add_char_100();
          lVar2 = 3;
          in_stack_00000010 = in_stack_00000010 + 2;
        }
        if ((uVar3 < 0x83) || (0xb5 < uVar3)) break;
        camlBuffer__add_char_100();
        lVar2 = 3;
        in_stack_00000010 = in_stack_00000010 + 2;
      }
    ...
    *(undefined8 *)(uVar3 - 0x10) = 0x400;
    *(undefined8 *)(uVar3 - 8) = 3;
    camlHashtbl__add_102();
  }
  return plVar1;
}
...

{
  ...
  plVar2 = (long *)FUN_0040ac14();
  if ((undefined **)*plVar2 == &caml_exn_Failure) {
    plVar2 = (long *)FUN_0040ab98();
...

{
  ...
  *(undefined8 *)(uVar6 - 8) = unaff_RBX;
  ...
  if (lVar4 == 1) {
    plVar5 = (long *)FUN_0040c78c();
    if ((undefined **)*plVar5 != &caml_exn_Failure) {
                    // WARNING: Subroutine does not return
      caml_raise_exn();
    }
    plVar5 = (long *)FUN_0040c710();
    ...
    if (lVar4 == 1) {
      ...
      *(undefined8 *)(uVar6 - 0x30) = 0x800;
      *(undefined8 *)(uVar6 - 0x28) = DAT_00641608;
      ...
      *(undefined8 *)(uVar7 - 0x28) = DAT_00641600;
...

{
  ...
  *(undefined8 *)(unaff_R15 - 0x30) = 0x800;
  *(undefined8 *)(unaff_R15 - 0x28) = DAT_00641608;
...

{
  ...
  *camlUnix = camlUnix__64;
  ...
  caml_allocN();
  DAT_006413c8 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_006413c8 = &camlUnix__50;
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0040f962;
    }
    else if (0x74 < uVar2) {
LAB_0040f962:
...

{
  ...
  *DAT_00645510 = camlPervasives__65;
  ...
  caml_allocN();
  DAT_00645748 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_00645748 = &camlPervasives__7;
  ...
  DAT_00645790 = unaff_R15 + 8;
  unaff_R15[7] = 0x400;
  *DAT_00645790 = DAT_00645660;
...

{
  ...
  if (in_RAX != 0xb9) {
    lVar7 = in_RAX >> 1;
    uVar8 = (ulong)(int)(&switchD_00416924::caseD_1c)[lVar7];
    switch(in_RAX) {
    case 0x10:
    case 0x11:
      return &camlChar__8;
    ...
    case 0x1c:
      ...
      bVar11 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,0xffffffffffbcab0f < uVar8);
      *pcVar1 = (*pcVar1 - 1U) + (0xffffffffffbcab0f < uVar8);
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      ...
      *(int *)(&UNK_004354e6 + (long)(&stack0x00000000 + uVar8)) =
           *(int *)(&UNK_004354e6 + (long)(&stack0x00000000 + uVar8)) + 1;
      (**(code **)(uVar8 + 0x14))();
  ...
  *plVar1 = 1;
  ...
  if (0 < lVar8) {
    ...
    do {
      ...
      if (uVar6 < 0x1d) {
        if (uVar6 < 0x17) {
          if (0x10 < uVar6) goto LAB_004171b8;
          goto LAB_0041718e;
        }
        if (uVar6 < 0x1b) goto LAB_0041718e;
LAB_004171b8:
        lVar5 = 5;
      }
      else {
        if ((uVar6 == 0x45) || (uVar6 == 0xb9)) goto LAB_004171b8;
LAB_0041718e:
        lVar5 = caml_c_call();
        if (lVar5 == 1) {
          lVar5 = 9;
...
switchD_004172d0_caseD_0:
      ...
      case 0x1a:
        ...
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x72;
        break;
      default:
        if (lVar7 - 0x45U < 0x72) goto switchD_004172d0_caseD_0;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(char *)(lVar5 + (*plVar1 >> 1)) = (char)uVar6;
      }
...

{
  ...
  DAT_00649d48 = *puVar1;
  DAT_00649d60 = (2L << ((byte)(DAT_00649d50 + -0x14 >> 1) & 0x3f)) + -1;
...

{
  ...
  while (uVar1 = (ulong)*(byte *)(*(long *)(unaff_RBX + 0x10) + (in_RAX >> 1)) * 2 + 1, 0x60 < uVar1
    ...
    if (0x74 < uVar1) goto LAB_0041aee4;
    in_RAX = in_RAX + 2;
  }
  if (uVar1 == 0x49) {
    return in_RAX + 2;
...
LAB_0041b69c:
    ...
    if (uVar2 != 0x5b) goto LAB_0041b69c;
    unaff_RBX = unaff_RBX + 2;
    in_RAX = 3;
  } while( true );
}
...

{
  ...
  do {
    ...
    uVar2 = (ulong)(int)(&switchD_0041b9ef::switchdataD_00435710)[lVar5 >> 1];
    switch(lVar5) {
    default:
...
switchD_0041bcc4_caseD_42:
  ...
  uVar1 = (&switchD_0041bcc4::caseD_1f0)[lVar2 + -0x3f >> 1];
  piVar6 = (int *)(long)(int)uVar1;
  puVar14 = (uint *)(piVar6 + 0x10d663);
  cVar3 = (char)uVar1;
  ...
  case 0x140:
  case 0x142:
    ppcStack_20 = (code **)0x41cf4d;
    uVar8 = camlPrintf__extract_format_int_131();
    ppcStack_20 = (code **)0x41cf61;
...
code_r0x0041d03b:
  ...
  case 0x11a:
  case 0x15a:
    ppcStack_20 = (code **)0x41cd44;
    local_18 = (code **)camlPrintf__get_arg_320();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41cd75;
      (***(code ***)(DAT_0064b710 + 0x10))();
    }
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
         (*(char *)((long)piVar6 + -0x75) - cVar12) - ((int *)0xffffffffffbca673 < piVar6);
    ppcStack_20 = (code **)0x41cc2f;
    camlPrintf__extract_format_float_138(param_1,CONCAT44(unaff_retaddr_00,unaff_retaddr));
    ppcStack_20 = (code **)0x41cc39;
    local_18 = (code **)camlPrintf__fun_630();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41cc69;
      (***(code ***)(DAT_0064b710 + 0x10))();
    }
    uVar5 = caml_apply3(CONCAT44(unaff_retaddr_00,unaff_retaddr) + 2,*(undefined8 *)(param_9 + 0x28)
                       );
    return uVar5;
  case 0x15c:
    ppcStack_20 = (code **)0x41ccdf;
    local_10 = (code **)camlPrintf__get_arg_320(piVar6[0x14]);
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41cd11;
      (***(code ***)(DAT_0064b710 + 0x10))();
    }
...
code_r0x0041cb3c:
  ...
  *(int **)((long)pppcVar15 + 0x20) = piVar6;
  puVar14 = &switchD_0041cb5f::switchdataD_004359f4;
...
switchD_0041bcc4_caseD_1ae:
  ppcStack_20 = (code **)0x41d1a1;
  local_18 = (code **)camlPrintf__get_arg_320(param_1);
  ppcStack_20 = (code **)0x41d1c1;
  uVar8 = camlPrintf__extract_format_113(local_10,local_8);
  ppcStack_20 = (code **)0x41d1d4;
  local_18 = (code **)caml_c_call(uVar8,local_18);
LAB_0041d26b:
  if (param_7 == 1) {
    ppcStack_20 = (code **)0x41d299;
    (***(code ***)(DAT_0064b710 + 0x10))();
  }
...

{
  ...
  case 0xc3:
    local_38 = camlPrintf__get_arg_320(*(undefined8 *)(param_3 + 0x50));
    local_28 = (***(code ***)(DAT_0064b710 + 0x10))();
    local_30 = camlPrintf__get_arg_320(*(undefined8 *)(param_3 + 0x50));
    if (local_18 == 1) {
      (***(code ***)(DAT_0064b710 + 0x10))();
    }
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  DAT_0064b710 = unaff_R15 + 9;
  unaff_R15[8] = 0x1800;
  *DAT_0064b710 = &camlPrintf__38;
  ...
  *DAT_0064b7c0 = caml_curry2;
  ...
  ppuVar4 = DAT_0064b788;
  ppuVar3 = DAT_0064b778;
...
LAB_00422e18:
          iVar1 = *(int *)ppuVar6;
          ppuVar6 = ppuVar5 + 2;
          *(char *)((long)iVar1 + 0x64e171) = (char)((long)*param_3 >> 1);
        }
      }
      else {
    ...
    if (puVar9 == (uint *)0x1) {
      ...
      if (0 < iVar5) {
        ...
        while ((uint *)(long)(int)((uint)*ppuVar2 & **ppuVar4) != puVar9) {
          iVar6 = iVar6 + 1;
          if (iVar5 <= iVar6) goto LAB_00422f9f;
          ppuVar3 = ppuVar10 + 6;
          ppuVar10 = ppuVar10 + 1;
          puVar9 = *ppuVar3;
        }
...
LAB_00422f9f:
      ...
      *plVar12 = 0x4b01;
      ...
      puVar9 = &UINT_00436108;
      iVar5 = 1;
      ppuVar4 = ppuVar10 + 2;
      if (uVar7 == 1) {
        iVar5 = 0;
LAB_00422ffa:
        *plVar12 = (long)(int)(&UINT_00436104)[(long)iVar5 * 2] * 2 + 1;
      }
      else {
        do {
          if (*puVar9 == uVar7) goto LAB_00422ffa;
          iVar5 = iVar5 + 1;
          puVar9 = puVar9 + 2;
        } while (iVar5 != 0x12);
      }
      ...
      *plVar12 = (ulong)*(byte *)((long)*(int *)ppuVar4 + 0x64e171) * 2 + 1;
      ppuVar4 = ppuVar10 + 2;
    }
    ppuVar10 = ppuVar4;
    puVar9 = *ppuVar10;
        ...
        do {
          ...
          if (999 < iVar16) {
            ...
            while( true ) {
              ...
              puVar9 = puVar3;
              if ((*(ulong *)(*DAT_00652518 + -8) >> 10 <= (ulong)puVar3[-1] >> 10) &&
...
LAB_00425feb:
    if (iVar19 + flp_size < 0x3ea) {
      if ((iVar19 == 1) ||
         (memmove(&flp + (iVar19 + iVar16),&DAT_006505e8 + iVar16,
...

{
  ...
  if (caml_young_ptr != caml_young_end) {
    ...
    if (caml_ref_table < DAT_006525b8) {
      do {
        puVar1 = (undefined8 *)*puVar8;
        puVar8 = puVar8 + 1;
        caml_oldify_one(*puVar1,puVar1);
      } while (puVar8 < DAT_006525b8);
    }
    caml_oldify_mopup();
    ...
    for (ppuVar6 = caml_weak_ref_table; ppuVar6 < DAT_006525f8; ppuVar6 = ppuVar6 + 1) {
      puVar2 = *ppuVar6;
      puVar3 = (ulong *)*puVar2;
...

{
  ...
  uVar2 = (param_1 >> 0xc) * -0x61c8864680b583ea >> ((byte)DAT_00652648 & 0x3f);
  uVar1 = *(ulong *)(DAT_00652660 + uVar2 * 8);
  while( true ) {
    if (((uVar1 ^ param_1) & 0xfffffffffffff000) == 0) {
      return (uint)uVar1 & 0xff;
    }
    if (uVar1 == 0) break;
    uVar2 = uVar2 + 1 & DAT_00652650;
    uVar1 = *(ulong *)(DAT_00652660 + uVar2 * 8);
  }
  return 0;
}
  ...
  *param_1 = param_2;
  ...
  if ((uVar2 & 1) != 0) {
    ...
    if (((((param_2 & 1) == 0) && (param_2 < caml_young_end)) && (caml_young_start < param_2)) &&
      ...
      if (_DAT_006525c0 <= DAT_006525b8) {
        caml_realloc_ref_table(&caml_ref_table);
      }
      *DAT_006525b8 = param_1;
      DAT_006525b8 = DAT_006525b8 + 1;
    }
  }
  return;
}
...

{
  ...
  if (caml_page_table <= (ulong)(_DAT_00652658 * 2)) {
  ...
  uVar6 = (param_1 >> 0xc) * -0x61c8864680b583ea >> ((byte)DAT_00652648 & 0x3f);
  puVar1 = (ulong *)((long)DAT_00652660 + uVar6 * 8);
  uVar2 = *puVar1;
  while( true ) {
    if (uVar2 == 0) {
      *puVar1 = (long)param_3 | param_1;
      _DAT_00652658 = _DAT_00652658 + 1;
      return 0;
    }
    if (((uVar2 ^ param_1) & 0xfffffffffffff000) == 0) break;
    uVar6 = uVar6 + 1 & DAT_00652650;
    puVar1 = (ulong *)((long)DAT_00652660 + uVar6 * 8);
    uVar2 = *puVar1;
  }
...

{
  ...
  if (1 < uVar1) {
    ...
    DAT_00652650 = uVar2 - 1;
    caml_page_table = uVar2;
    DAT_00652648 = iVar3;
  }
  _DAT_00652658 = 0;
  DAT_00652660 = calloc(caml_page_table,8);
  return -(uint)(DAT_00652660 == (void *)0x0);
}
...

{
  ...
  plVar1 = &DAT_00658208 + (param_2 & 0xffffffff);
  if (param_1 != 0) {
...
LAB_00429317:
    ...
    if (pcVar8 == param_1 + lVar6) {
      if (iVar9 == 10) {
        if (uVar3 <= (ulong)(1L << ((byte)param_2 - 1 & 0x3f))) goto LAB_00429344;
      }
  ...
  if ((((param_3 & 1) == 0) && (param_3 < caml_young_end)) && (caml_young_start < param_3)) {
    ...
    *puVar1 = param_3;
    if ((((uVar2 & 1) != 0) || (uVar4 <= uVar2)) || (uVar2 <= uVar3)) {
      if (_DAT_00652600 <= DAT_006525f8) {
        caml_realloc_ref_table(&caml_weak_ref_table);
      }
      *DAT_006525f8 = puVar1;
      DAT_006525f8 = DAT_006525f8 + 1;
    }
    return;
  }
    ...
    for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
      ...
      while( true ) {
        ...
        *pplVar4 = (long *)((ulong)plVar15 & 0xfffffffffffffc00 | 0x3f3);
        pplVar4 = pplVar4 + ((ulong)plVar15 >> 10) + 1;
        if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar4) goto LAB_0043355c;
      }
...
LAB_0043371e:
          ...
          pplVar13 = pplVar6;
          if (0x20 < uVar17) goto LAB_004337b3;
          pplVar11 = (long **)pplVar6[-1];
          if (0x20 < (ulong)((long)pplVar11[-2] - (long)pplVar11[-3])) goto LAB_004337b3;
          do {
            pplVar6 = pplVar11;
            pplVar11 = (long **)pplVar6[-1];
            pplVar13 = pplVar6;
...
LAB_004337b3:
          ...
          *pplVar4 = (long *)(lVar18 * 0x400 + -0x400 + (ulong)uVar3);
          ...
          uVar3 = (uint)uVar17;
          if ((char)uVar17 == -7) goto LAB_0043371e;
    ...
    do {
      ...
      for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
        ...
        while (plVar15 = *pplVar4, ((ulong)plVar15 & 0x300) == 0) {
          ...
          pplVar4 = pplVar14;
          if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar14) goto LAB_00433a0b;
        }
      }
LAB_00433a0b:
...
undefined  [16] FUN_00434f0b(undefined8 param_1,undefined8 param_2,undefined8 param_3)
