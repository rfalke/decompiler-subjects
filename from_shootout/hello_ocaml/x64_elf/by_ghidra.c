...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_00638898 = (undefined *)&camlUnix__50;
...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_0063cc18 = (undefined *)&camlPervasives__7;
  ...
  unaff_R15[7] = 0x400;
  *DAT_0063cc60 = (undefined *)DAT_0063cb30;
...

{
  ...
  *puVar9 = uVar4;
  ...
  if (in_RAX <= (long)uVar1) {
    ...
    *(undefined8 *)(uVar7 - 0x18) = 0x800;
    *(undefined8 *)(uVar7 - 0x10) = DAT_0063e300;
...

{
  ...
  plVar4 = (long *)FUN_00410494();
  if (*plVar4 != DAT_0063e300) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar1 = plVar4[1];
...
LAB_0041ca0b:
  ...
  if (puVar1 != (ulong *)0x0) goto code_r0x0041ca15;
  goto LAB_0041ca1a;
code_r0x0041ca15:
  if (param_2 <= *puVar1) {
LAB_0041ca1a:
...
LAB_0041cbdb:
    ...
    if (puVar2 != (ulong *)0x0) goto code_r0x0041cbe5;
    goto LAB_0041cbea;
  }
LAB_0041cc00:
      ...
      do {
        while( true ) {
          ...
          *(undefined8 *)(*plVar1 + 8 + lVar7 * 8) = *(undefined8 *)((long)puVar6 + lVar3);
          if (iVar4 < iVar8) goto LAB_0041cc58;
        }
        iVar8 = iVar8 + 1;
        lVar5 = lVar5 + 8;
      } while (iVar8 <= iVar4);
...
LAB_0041dfba:
        ...
        while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
          iVar16 = iVar16 + 1;
          if (flp_size <= iVar16) goto LAB_0041dfba;
          plVar13 = *pplVar6;
          pplVar6 = pplVar6 + 1;
      ...
      do {
        do {
          plVar12 = plVar10;
          if (plVar12 == plVar13) goto LAB_0041e13b;
...
LAB_0041f130:
  ...
  if ((uVar3 & 7) != 0) goto code_r0x0041f1e4;
  goto LAB_0041f205;
code_r0x0041f1e4:
  ppuVar4 = param_1;
...
LAB_00425efe:
    if (0xffffffff < lVar4) goto LAB_00425fe7;
  }
...
LAB_00426996:
    if (uVar12 != 0) goto code_r0x0042699f;
        ...
        if (0 < iVar6) {
          if (*pcVar9 != '\0') {
            ...
            do {
              ...
              if ((iVar6 + -1) - iVar7 < 1) goto LAB_0042884d;
              iVar7 = iVar7 + 1;
            } while (*pcVar9 != '\0');
          }
      ...
      if (bVar1 != 0) {
        if (*pcVar9 != '\0') {
          ...
          do {
            sVar4 = strlen(pcVar9);
            pcVar9 = pcVar9 + sVar4 + 1;
            if (bVar1 - 1 == iVar6) goto LAB_00428952;
            iVar6 = iVar6 + 1;
          } while (*pcVar9 != '\0');
        }
        pcVar9 = "<unknown token>";
...
LAB_004283d8:
    ...
    do {
      ...
      if (((-1 < iVar7) && (sVar2 != 0)) && (iVar7 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar8 = (long)iVar7;
        lVar3 = lVar8 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar8 * 2) == 0x100) goto LAB_004289c8;
      }
      if (iVar6 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar6 != 0) {
    ...
    if (param_3 < uVar5) goto LAB_0042a22a;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_0042b6ac;
      }
...
LAB_0042b86e:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_0042b903;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_0042b903;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_0042b903:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_0042b86e;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_0042bb5b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_0042bb5b:
