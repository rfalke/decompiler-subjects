...
int32_t caml_main(int32_t a1) {
  ...
  lab_0x805be53:;
    char v2 = *env_val2; // 0x805be5b
    if (v2 != 0) {
        int32_t v3 = (int32_t)env_val2; // 0x805bdaa
        g124 = v2 - 79;
        int32_t v4; // 0x805bd5e
        switch (v2) {
            case 79: {
                // 0x805be07
                scanmult();
  ...
  lab_0x805be66:
    ...
    *(int32_t *)(4 * v6 + (int32_t)&g106) = v6;
    ...
    int32_t v9 = v8; // 0x805bee4
    int32_t v10 = 0; // 0x805bee4
    if (v8 != 0) {
        int32_t v11 = *(int32_t *)(8 * v10 + (int32_t)&g6); // 0x805bef4
        while (caml_page_table_add(4, (int32_t *)v9, (int32_t *)v11) == 0) {
            int32_t v12 = v10 + 1; // 0x805bf1b
  ...
  lab_0x805bf25:
    ...
    if (g9 != 0) {
        ...
        uint32_t v16 = g8;
        uint32_t v17 = g9;
        int32_t v18 = v15 > v17 ? v17 : v15; // 0x805bf5b
        uint32_t v19 = *(int32_t *)(8 * v14 + (int32_t)&g8); // 0x805bf5e
        int32_t v20 = v16 < v19 ? v19 : v16; // 0x805bf63
...
int32_t caml_init_major_heap(int32_t a1) {
    int32_t v1 = clip_heap_chunk_size(); // 0x805def5
    g85 = v1;
    g86 = v1;
    int32_t v2 = caml_alloc_for_heap(v1); // 0x805df07
    g114 = v2;
    if (v2 == 0) {
        // 0x805df15
    ...
    *(int32_t *)(v2 - 4) = 0;
    ...
    int32_t v4 = (int32_t)mem; // 0x805dfa4
    g57 = v4;
    if (mem == NULL) {
        // 0x805dfb2
    ...
    // 0x805dfbe
    g58 = v4;
    int32_t result = 4 * g60 + v4; // 0x805dfc9
    g59 = result;
    g61 = 1;
    g117 = 0;
    g116 = 0.0;
...
int32_t caml_round_heap_chunk_size(uint32_t a1) {
    int32_t v1 = clip_heap_chunk_size(); // 0x805e003
    int32_t result = v1; // 0x805e00a
    if (v1 < a1) {
        // 0x805e00c
...
int32_t realloc_gray_vals(void) {
    ...
    int32_t result = (v2 < 0 ? v2 + 127 : v2) >> 7; // 0x805e077
    if (result <= v1) {
        // 0x805e116
        g58 = g57 + 4 * v1 / 2;
        g61 = 0;
...
int32_t caml_major_collection_slice(int32_t a1) {
    ...
    int32_t v1 = g112; // 0x805e787
    float80_t v2 = v1 + 100; // 0x805e79b
    float80_t v3 = v1; // 0x805e7a9
    int32_t v4 = g113; // 0x805e7e6
    float80_t v5 = 0.0L; // 0x805e7ee
    if (v4 != 0) {
        // 0x805e7f8
        v5 = v2 * (float80_t)(0x100000000 * g119 >> 32) / (float80_t)v4 / v3;
    }
    int32_t v6 = g117; // 0x805e782
    float80_t v7 = 0.5L * 3.0L * (float80_t)v6 * v2 / (float80_t)(g85 / 4) / v3; // 0x805e7dd
    bool v8 = false; // 0x805e825
    ...
    float80_t v10 = v8 | v9 ? v7 : v5; // 0x805e827
    float80_t v11 = g116; // 0x805e82b
    bool v12 = false; // 0x805e831
    ...
    float80_t v14 = v12 | v13 ? v10 : v11; // 0x805e833
...
int32_t caml_alloc_shr(uint32_t a1, int32_t a2) {
    ...
    if (v1 != 0) {
        ...
        int32_t v5 = caml_round_heap_chunk_size(4 * (a1 + 1 + (int32_t)((0x100000000 * g112 >> 32) * 0x51eb851f * (int64_t)a1 / 0x2000000000))); // 0x805f690
...
int32_t caml_named_value(int32_t str) {
    int32_t v1 = hash_value_name(); // 0x806884d
    int32_t v2 = *(int32_t *)(4 * v1 + (int32_t)&g89); // 0x8068852
    if (v2 == 0) {
        // 0x8068880
        return 0;
    }
    int32_t v3 = v2; // 0x8068874
    int32_t strcmp_rc = strcmp((char *)str, (char *)(v3 + 8)); // 0x8068867
    int32_t result = v3; // 0x806886e
    while (strcmp_rc != 0) {
        // 0x8068874
        v3 += 4;
        result = 0;
