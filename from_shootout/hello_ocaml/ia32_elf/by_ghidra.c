...
void FUN_0804c540(undefined4 param_1,undefined4 param_2)
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0804eb15;
    }
    else if (0x74 < uVar2) {
LAB_0804eb15:
...
LAB_0805b13f:
          ...
          do {
            if ((int)*param_3 >> 1 == (&DAT_0806b464)[iVar1 * 2]) goto LAB_0805b13f;
            iVar1 = iVar1 + 1;
          } while (iVar1 != 0x12);
          unix_error(0x16,"tcsetattr",0);
...
LAB_0805b351:
      ...
      *piVar8 = 0x4b01;
      ...
      if (sVar6 == 1) {
        iVar3 = 0;
LAB_0805b3a4:
        *piVar8 = (&DAT_0806b464)[iVar3 * 2] * 2 + 1;
      }
      else {
        do {
          if ((&speedtable)[iVar3 * 2] == sVar6) goto LAB_0805b3a4;
          iVar3 = iVar3 + 1;
        } while (iVar3 != 0x12);
      }
    }
...
LAB_0805db6b:
        ...
        do {
          ...
          if (999 < flp_size) {
            ...
            while( true ) {
              ...
              puVar10 = puVar2;
              if ((*(uint *)(*DAT_080774fc + -4) >> 10 <= (uint)puVar2[-1] >> 10) &&
    ...
    piVar8 = (int *)(&DAT_08076564)[iVar13];
    iVar5 = 0;
    piVar9 = (&flp)[iVar13];
    do {
      do {
...
LAB_0805dd51:
    if (flp_size + -1 + iVar5 < 0x3e9) {
      if ((iVar5 == 1) ||
         (memmove(&flp + iVar5 + iVar13,&DAT_08076564 + iVar13,((flp_size + -1) - iVar13) * 4),
         0 < iVar5)) {
    ...
    if (iVar5 + iVar13 < 1000) {
      if ((iVar5 == 1) ||
         (memmove(&flp + iVar5 + iVar13,&DAT_08076564 + iVar13,((1000 - iVar13) - iVar5) * 4),
         0 < iVar5)) {
        memmove(&flp + iVar13,local_fbc,iVar5 << 2);
      }
    }
...

{
  ...
  if (caml_young_ptr != caml_young_end) {
    ...
    if (caml_ref_table < DAT_08077548) {
      do {
        caml_oldify_one(*(undefined4 *)*puVar4,(undefined4 *)*puVar4);
        puVar4 = puVar4 + 1;
      } while (puVar4 < DAT_08077548);
    }
    caml_oldify_mopup();
    ppuVar3 = caml_weak_ref_table;
    if (caml_weak_ref_table < DAT_08077564) {
      do {
        puVar1 = *ppuVar3;
        puVar2 = (uint *)*puVar1;
  ...
  *param_1 = param_2;
  if ((*(byte *)((&caml_page_table)[(uint)param_1 >> 0x17] + ((uint)param_1 >> 0xc & 0x7ff)) & 1) !=
    ...
    if (((((param_2 & 1) == 0) && (param_2 < caml_young_end)) && (caml_young_start < param_2)) &&
      ...
      if (_DAT_0807754c <= DAT_08077548) {
        caml_realloc_ref_table(&caml_ref_table);
      }
      *DAT_08077548 = param_1;
      DAT_08077548 = DAT_08077548 + 1;
    }
  }
  return;
}
...

{
  ...
  local_5c = 1;
  local_54 = &local_40;
  pcStack_80 = (code *)0x80661ee;
  piVar3 = __errno_location();
  pcStack_80 = (code *)0x80661f8;
  pcStack_84 = strerror(*piVar3);
  if (param_1 == (void *)0x1) {
    pcStack_80 = (code *)0x806620a;
  ...
  if ((((param_3 & 1) == 0) && (param_3 < caml_young_end)) && (caml_young_start < param_3)) {
    ...
    *puVar1 = param_3;
    if ((((uVar2 & 1) != 0) || (caml_young_end <= uVar2)) || (uVar2 <= caml_young_start)) {
      if (_DAT_08077568 <= DAT_08077564) {
        caml_realloc_ref_table(&caml_weak_ref_table);
      }
      *DAT_08077564 = puVar1;
      DAT_08077564 = DAT_08077564 + 1;
    }
  }
  else {
