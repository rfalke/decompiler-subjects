  ...
  *(undefined4 *)(uVar3 - 4) = local_14;
  ...
  if (iVar7 == 1) {
    ...
    if (iVar7 == 1) {
      ...
      caml_young_ptr = uVar4;
      *puVar2 = 0x800;
      *puVar10 = DAT_08072ebc;
      *(undefined4 *)(uVar3 - 0x10) = 0x80739fc;
      piVar9 = (int *)(uVar3 - 8);
      *(undefined4 *)(uVar3 - 0xc) = 0x800;
      ...
      *(undefined4 *)(uVar3 - 0x10) = 0x8073a0c;
      piVar9 = (int *)(uVar3 - 8);
      *(undefined4 *)(uVar3 - 0xc) = 0x800;
      *(undefined4 **)piVar9 = puVar10;
      *(undefined4 *)(uVar3 - 4) = 1;
...

{
  ...
  *(undefined4 *)(uVar4 - 4) = uVar3;
  caml_modify(DAT_08075638,puVar1);
  return 1;
}
...

{
  ...
  _DAT_080754f8 = puVar1 + 1;
  *puVar1 = 0x400;
  *_DAT_080754f8 = 0x8075ab0;
  ...
  *_DAT_08075614 = 0x8075680;
  ...
  puVar1[7] = 0x400;
  *(undefined ***)DAT_08075638 = DAT_080755a0;
...

{
  ...
  *piVar1 = iVar5;
  ...
  if (DAT_08078328 < *piVar1) {
    if (DAT_08078328 < *(int *)(iVar4 + 4) + -1 + unaff_EBX) {
...

{
  ...
  if ((in_ECX < 1) || (DAT_08078328 < in_ECX)) {
    camlPervasives__invalid_arg_1012();
  }
...

{
  ...
  *puVar4 = 0xcf7;
  ...
  puVar4[8] = 0x1800;
  *(undefined4 *)UINT_08079508 = 0x807977c;
  *(code ***)(puVar4 + 10) = ppcVar1;
  puVar4[0xb] = uVar3;
  *(undefined4 **)(puVar4 + 0xc) = puVar4 + 1;
  puVar4[0xd] = 0x807976c;
