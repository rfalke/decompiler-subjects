...

{
  ...
  if (uVar2 < 0x61) {
    if (uVar2 == 0x5b) goto LAB_0804efd0;
  }
  else if (uVar2 < 0x75) {
LAB_0804efd0:
...

{
  ...
  if (uVar2 < 0xbf) {
    if (uVar2 < 0x75) {
      if (0x60 < uVar2) goto switchD_080580b8_caseD_180;
    }
    else if (iVar1 - 0x81U < 0x34) goto switchD_080580b8_caseD_180;
  }
  else {
...
switchD_080580b8_caseD_180:
    ...
    case 0x1fe:
      break;
    default:
      if (uVar2 != 0xc1) goto switchD_080580b8_caseD_180;
    }
  }
  return;
}
...
LAB_08059703:
  do {
    while( true ) {
      ...
      iVar7 = (uint)*(byte *)(*(int *)(param_3_00 + 0x28) + iStack20) * 2;
...
switchD_08059761_caseD_42:
    ...
    case 0x150:
      ...
      case 0xea:
      case 0xf0:
        goto switchD_08059761_caseD_16c;
      default:
        goto switchD_08059761_caseD_16e;
      }
    case 0x110:
    case 0x124:
    case 0x13c:
...
LAB_080662dd:
        ...
        else if ((cStack85 != 'u') && (cStack85 != 'x')) goto LAB_080662dd;
      }
      sprintf(pcVar6,acStack52);
LAB_080662f2:
      ppcVar3 = (code **)caml_copy_string();
...
LAB_08066f93:
    if (uVar8 < 0x172) {
LAB_08066fe3:
      sprintf(acStack406,param_3_00,*unaff_retaddr);
...
switchD_0805b7c2_caseD_8:
  ...
  *(int *)(uVar8 - 8) = param_1_00;
  *(char **)(uVar8 - 4) = param_3_00;
  return ppcVar3;
...
LAB_0806087f:
          ...
          do {
            if ((int)*param_3 >> 1 == *(int *)(speedtable + iVar1 * 8 + 4)) goto LAB_0806087f;
            iVar1 = iVar1 + 1;
          } while (iVar1 != 0x12);
          unix_error(0x16,"tcsetattr",0);
...
LAB_08060ae4:
        *piVar8 = *(int *)(speedtable + iVar3 * 8 + 4) * 2 + 1;
        ...
        do {
          if (*(speed_t *)(speedtable + iVar3 * 8) == sVar6) goto LAB_08060ae4;
          iVar3 = iVar3 + 1;
        } while (iVar3 != 0x12);
      }
    }
...
LAB_0806419b:
  ...
  if ((*(byte *)(*(int *)(caml_page_table + ((uint)param_1 >> 0x17) * 4) +
                ((uint)param_1 >> 0xc & 0x7ff)) & 7) != 0) goto code_r0x080642be;
  goto LAB_080642e9;
code_r0x080642be:
  ppiVar4 = param_1 + -1;
  if (*ppiVar4 == (int *)0x0) {
...

{
  ...
  local_5c = 1;
  local_54 = &local_40;
  pcStack128 = (code *)0x806b92e;
  piVar3 = __errno_location();
  pcStack128 = (code *)0x806b938;
  pcStack132 = strerror(*piVar3);
  if (param_1 == (void *)0x1) {
    pcStack128 = (code *)0x806b94a;
