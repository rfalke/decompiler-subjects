...

{
  ...
  caml_alloc3();
  *unaff_R15 = 0xcf7;
  *(code **)(unaff_R15 + 1) = camlSource__loop_77;
  unaff_R15[2] = 3;
  unaff_R15[3] = uVar1;
...

{
  ...
  *unaff_R15 = 0x1800;
  *(undefined ***)DAT_006380d8 = &camlUnix__50;
...

{
  ...
  *unaff_R15 = 0x1800;
  *(undefined ***)DAT_0063c458 = &camlPervasives__7;
  ...
  *(undefined ***)(unaff_R15 + 6) = &camlPervasives__12;
  ...
  unaff_R15[7] = 0x400;
  *(undefined ***)DAT_0063c4a0 = DAT_0063c370;
...

{
  ...
  *local_10 = uVar5;
  ...
  if (in_RAX <= (long)uVar2) {
    ...
    *(undefined8 *)(uVar8 - 0x18) = 0x800;
    *(undefined8 *)(uVar8 - 0x10) = DAT_0063db40;
...

{
  ...
  plVar6 = (long *)FUN_00410604();
  if (*plVar6 != DAT_0063db40) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar3 = plVar6[1];
...

{
  ...
  if (*(char *)(param_1 + -1) == '\0') {
    ...
    *(undefined2 *)param_2 = 1;
    uVar4 = uVar3;
    if (0x6b < uVar3) {
      uVar4 = unix_error(0x24,0x42ea61,__src);
    }
...

{
  ...
  if ((0x3fffffffffffffff < sStack152.st_size) && ((sStack152.st_mode & 0xf000) == 0x8000)) {
    unix_error(0x4b,0x42db31,param_1);
  }
  stat_aux(0,&sStack152);
  return;
}
...

{
  ...
  if (param_3 == 0) {
    caml_local_roots = &local_78;
    param_3 = caml_copy_string(0x42ea61);
  }
  local_30 = param_3;
...
LAB_0041cb7b:
  ...
  if (puVar2 != (ulong *)0x0) goto code_r0x0041cb85;
  goto LAB_0041cb8a;
code_r0x0041cb85:
  if (param_2 <= *puVar2) {
LAB_0041cb8a:
...
LAB_0041cd4b:
    ...
    if (puVar3 != (ulong *)0x0) goto code_r0x0041cd55;
    goto LAB_0041cd5a;
  }
LAB_0041cd70:
...
LAB_0041e12a:
        ...
        do {
          ...
          if (uVar7 < uVar15) {
            ...
            *(long **)(flp + lVar20 * 8) = plVar10;
            uVar7 = uVar15;
            if (param_1 <= uVar15) goto LAB_0041e218;
          }
          uVar16 = (uint)uVar17;
          plVar10 = beyond;
        } while( true );
      ...
      while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
        uVar16 = uVar16 + 1;
        if ((int)flp_size <= (int)uVar16) goto LAB_0041e12a;
        plVar10 = *pplVar6;
        pplVar6 = pplVar6 + 1;
...
LAB_0041e218:
      ...
      do {
        do {
          plVar12 = plVar13;
          if (plVar12 == plVar10) goto LAB_0041e2ab;
...
LAB_0041f2a0:
  ...
  if ((uVar4 & 7) != 0) goto code_r0x0041f354;
  goto LAB_0041f375;
code_r0x0041f354:
  ppuVar3 = param_1;
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  puVar1 = (undefined *)parse_format(param_1,0x42ebfb,local_58,local_78,&local_79);
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  puVar1 = (undefined *)parse_format(param_1,0x42ea61,local_58,local_78,&local_79);
...
LAB_0042606e:
    if (0xffffffff < lVar3) goto LAB_00426157;
  }
...
LAB_00426b06:
    if (uVar11 != 0) goto code_r0x00426b0f;
        ...
        if (0 < iVar5) {
          if (*__s != '\0') {
            ...
            do {
              sVar4 = strlen(__s);
              __s = __s + sVar4 + 1;
              if ((iVar5 + -1) - iVar8 < 1) goto LAB_004289bd;
              iVar8 = iVar8 + 1;
            } while (*__s != '\0');
          }
          __s = "<unknown token>";
      ...
      if (bVar1 != 0) {
        if (*__s != '\0') {
          ...
          do {
            sVar4 = strlen(__s);
            __s = __s + sVar4 + 1;
            if ((uint)bVar1 - 1 == iVar5) goto LAB_00428ac2;
            iVar5 = iVar5 + 1;
          } while (*__s != '\0');
        }
        __s = "<unknown token>";
...
LAB_00428548:
    ...
    do {
      ...
      if (((-1 < iVar8) && (sVar2 != 0)) && (iVar8 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar9 = (long)iVar8;
        lVar3 = lVar9 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar9 * 2) == 0x100) goto LAB_00428b38;
      }
      if (iVar5 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar5 != 0) {
    ...
    if (param_3 < __n) goto LAB_0042a39a;
    ...
    while (__src < (long **)((long)pplVar7 + (long)plVar1)) {
      while( true ) {
        ...
        *__src = (long *)((ulong)__n & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar7 + (long)plVar1) <= __src) goto LAB_0042b81c;
      }
...
LAB_0042b9de:
          ...
          pplVar12 = pplVar4;
          if ((long *)0x20 < plVar9) goto LAB_0042ba73;
          pplVar10 = (long **)pplVar4[-1];
          if ((long *)0x20 < (long *)((long)pplVar10[-2] - (long)pplVar10[-3])) goto LAB_0042ba73;
          do {
            pplVar4 = pplVar10;
            pplVar10 = (long **)pplVar4[-1];
            pplVar12 = pplVar4;
...
LAB_0042ba73:
          ...
          *__src = (long *)(lVar15 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar14;
          if ((char)uVar14 == -7) goto LAB_0042b9de;
    ...
    do {
      ...
      while (__src < (long **)((long)pplVar7 + (long)plVar1)) {
        while (__n = *__src, ((ulong)__n & 0x300) == 0) {
          ...
          __src = pplVar13;
          if ((long **)((long)pplVar7 + (long)plVar1) <= pplVar13) goto LAB_0042bccb;
        }
        __src = __src + ((ulong)__n >> 10) + 1;
      }
LAB_0042bccb:
  ...
  if (((param_2 & 1) == 0) && (uVar2 = caml_page_table_lookup(param_2), (uVar2 & 3) != 0)) {
    ...
    *puVar1 = param_1;
    ...
    return 1;
                    ...
                    // WARNING: Subroutine does not return
  caml_invalid_argument(0x42eb88);
}
