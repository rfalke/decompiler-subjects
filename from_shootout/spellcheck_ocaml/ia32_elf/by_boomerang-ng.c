...
__size8 global_0x08074267 = 0;// 1 bytes
__size32 caml_last_return_address = 1;// 4 bytes
int caml_fl_merge = 0x8074288;
union { unsigned int; int *; } global_0x08074288;
unsigned int fl_prev = 0x8074288;
__size32 caml_weak_none = 0x807ac38;// 4 bytes
...
__size32 global_0x0807452c;// 4 bytes
__size32 global_0x08074530;// 4 bytes
...
union { unsigned int; unsigned int *; } global_0x080766dc[9999999];
...
void caml_main()
{
    ...
    *(__size32*)(&caml_globals + 0xd4d0) = ebp - 25;
    *(__size32*)esp_1 = 0x806b69e;
...
bb0x805bf73:
        ...
        local0 = ebx;
        ebx_1 = local0;
        eax_4 = *(unsigned char*)ebx_1;
        local1 = esp;
        while ((unsigned char) eax_4 != 0) {
            ebx_2 = ebx_1 + 1;
            local0 = ebx_2;
            local0 = ebx_2;
            local0 = ebx_2;
    ...
    esp = local1;
    eax = *(&caml_globals + 0x65c4);
    *(__size32*)(esp + 16) = eax;
    eax = *(&caml_globals + 0x65c8);
    *(__size32*)(esp + 12) = eax;
    eax = *(&caml_globals + 0x65cc);
    *(__size32*)(esp + 8) = eax;
    eax = *(&caml_globals + 0x65d0);
    *(__size32*)(esp + 4) = eax;
    eax = *(&caml_globals + 0x65d4);
    *(__size32*)esp = eax;
    ...
    *(__size32*)(esp + 4) = 0x807b140;
    *(__size32*)esp = 0x807ad40;
    *(__size32*)(esp - 4) = 4;
    eax = caml_page_table_add(*(esp - 4), *esp, *(esp + 4), ecx, 0x807ad40); /* Warning: also results in ecx */
    if (eax != 0) {
        *(__size32*)(esp - 4) = 0x806b6ac;
...
bb0x805c045:
        ...
        *(__size32*)(&caml_globals + 0xd00c) = eax;
        ecx = *(&caml_globals + 644);
        *(__size32*)(&caml_globals + 0xd0c8) = ecx;
...
__size8 caml_init_custom_operations()
{
    ...
    *(__size32*)esp = 0x80742d4;
    caml_register_custom_operations();
    *(__size32*)esp = 0x80742b8;
...
void caml_init_signals(sigset_t param1)
{
    ...
    sigemptyset(&param1);
    *(__size32*)(&caml_globals + 0x6a0c) = (esp - 164);
    eax = sigaltstack(&0x80746a0, 0);
    if (eax == 0) {
        sigaction(11, &0x805d45f, 0);
    }
    return;
}
...
__size8 caml_register_custom_operations()
{
    ...
    edx = *(ebp + 8);
    *(__size32*)eax = edx;
    edx = *(&caml_globals + 0xcfec);
    *(__size32*)(eax + 4) = edx;
    *(union { __size32 *; __size32; }*)0x807ac60 = eax;
    ebp = *ebp;
    return cl; /* WARNING: Also returning: dl := dl, ebp := ebp, esi := esi, edi := edi */
}
...
void caml_set_minor_heap_size(__size32 param1)
{
    ...
    *(__size32*)esp_7 = 2;
    ...
    eax = *(&caml_globals + 0x9a38);
    if (eax != 0) {
        edx = *(&caml_globals + 0x9a3c);
        *(__size32*)(esp + 8) = edx;
        *(__size32*)(esp + 4) = eax;
        *(__size32*)esp = 2;
        caml_page_table_remove(*esp, *(esp + 4), *(esp + 8));
        eax = *(&caml_globals + 0x9a88);
        *(__size32*)esp = eax;
        ecx = free(*esp); /* Warning: also results in edx */
    }
    eax = *(ebp - 28);
    *(__size32*)(&caml_globals + 0x9a88) = eax;
    *(__size32*)(&caml_globals + 0x9a38) = ebx;
    *(__size32*)(&caml_globals + 0x9a3c) = esi;
    *(__size32*)(&caml_globals + 0x9a44) = ebx;
    *(__size32*)(&caml_globals + 0x9a40) = esi;
    *(__size32*)(&caml_globals + 0xd620) = edi;
    ecx = reset_table(0x80776bc, ecx, edx); /* Warning: also results in edx */
    reset_table(0x80776d8, ecx, edx);
    return;
}
...
__size32 caml_page_table_modify(int param1, __size32 param2, __size32 param3)
{
    ...
    local2 = param2;
    local3 = param3;
    if (named_value_table[((unsigned int)param1 >> 23)] != 0x8077700) {
bb0x805f555:
        ecx_1 = local2;
        edx_1 = local3;
...
void caml_minor_collection()
{
    ...
    ebx_1 = *(global_0x080766dc + 0x4bac);
    caml_empty_minor_heap(bl, edi);
    eax = *(global_0x080766dc + 0x4bac);
    st7 = (float)(eax - ebx_1) + *((double *)&*0x807abc8);
    *(union { double; __size64; }*)0x807abc8 = st7;
    tmp1 = *(global_0x080766dc + 0x44fc);
    *(__size32*)(global_0x080766dc + 0x44fc)++;
    caml_major_collection_slice(eax - ebx_1, ebx_1, esp - 4, 0, st7, ADDFLAGS32(tmp1, 1, *0x807abd8), ADDFLAGS32(tmp1, 1, *0x807abd8), ADDFLAGS32(tmp1, 1, *0x807abd8), ebp, esi, ebx_4, 0, eax - ebx_1, 0, pc, ecx, edx);
}
...
__size32 caml_raise_out_of_memory(int param1, __size32 param2, __size32 param1)
{
    ...
    __size32 esp_49; 		// r28{154}
    __size32 esp_5; 		// r28{40}
    __size32 esp_50; 		// r28{154}
    __size32 esp_51; 		// r28{154}
    ...
    int local109; 		// tmpb{299}
    __size32 local11; 		// m[esp_74 - 4]{260}
    int local110; 		// tmpb{317}
    ...
    __size32 local162; 		// esp_49{154}
    int local163; 		// local98{156}
    __size16 local164; 		// local131{157}
    __size32 local165; 		// local21{158}
    __size32 local166; 		// local56{159}
    unsigned int local167; 		// local76{160}
    __size32 local168; 		// esp_64{168}
    int local169; 		// local90{171}
    __size32 local17; 		// m[esp_74 - 4]{284}
    __size32 local170; 		// local8{172}
    __size32 local171; 		// local37{173}
    unsigned int local172; 		// local65{174}
    int local173; 		// eax_1{180}
    union { __size32 *; __size32; } local174; 		// esp_58{197}
    ...
    __size32 local18; 		// m[esp_74 - 4]{284}
    __size32 local180; 		// esp_61{230}
    int local181; 		// local94{233}
    __size32 local182; 		// local22{234}
    __size32 local183; 		// local48{235}
    unsigned int local184; 		// local77{236}
    unsigned int local185; 		// ebx{255}
    union { __size32 *; __size32; } local186; 		// esp_52{256}
    ...
    __size32 local29; 		// m[esp_74 - 4]{234}
    int local3; 		// m[esp - 64]
    __size32 local30; 		// m[esp_74 - 4]{234}
    ...
    __size32 local55; 		// m[esp_74 - 28]{337}
    __size32 local56; 		// m[esp_74 - 28]{159}
    ...
    unsigned int local74; 		// m[esp_74 - 32]{203}
    unsigned int local75; 		// m[esp_74 - 32]{203}
    unsigned int local76; 		// m[esp_74 - 32]{160}
    unsigned int local77; 		// m[esp_74 - 32]{236}
    unsigned int local78; 		// m[esp_74 - 32]{174}
    unsigned int local79; 		// m[esp_74 - 32]{174}
    __size32 local8; 		// m[esp_74 - 4]{172}
    unsigned int local80; 		// m[esp_74 - 32]{338}
    unsigned int local81; 		// m[esp_74 - 32]{338}
    unsigned int local82; 		// m[esp_74 - 32]{286}
    unsigned int local83; 		// m[esp_74 - 32]{286}
    unsigned int local84; 		// m[esp_74 - 32]{303}
    unsigned int local85; 		// m[esp_74 - 32]{303}
    unsigned int local86; 		// m[esp_74 - 32]{262}
    unsigned int local87; 		// m[esp_74 - 32]{262}
    unsigned int local88; 		// m[esp_74 - 32]{236}
    unsigned int local89; 		// m[esp_74 - 32]{236}
    ...
    local4 = param1;
    local33 = 0x806dae4;
    ebx = caml_raise(param1, 0x806dae4, param2, esp_74 - 4); /* Warning: also results in esp_1, ebp, esi */
    local163 = local126;
    local164 = local159;
    local165 = local4;
    local166 = local33;
    ...
    if (*(ebp + 24) != 0) {
        ...
        *(__size32*)(ebp - 28) = 0;
        do {
            ...
            *(unsigned int*)(esp_74 - 32) = local209;
            esi = *esi;
            local210 = esp_70;
            local211 = local99;
            local212 = local132;
...
void caml_fl_init_merge()
{
    *(__size32*)(&caml_globals + 0x9a0c) = 0;
    *(__size32*)(&caml_globals + 0x6608) = 0x8074288;
    return;
}
...
void caml_empty_minor_heap(__size8 param1, unsigned int param4)
{
    ...
    eax = *(global_0x080766dc + 0xfd8);
    if (eax != *0x80776b0) {
        *(__size32*)(global_0x080766dc + 0x1018) = 1;
        caml_gc_message(2, 0x806b9fc);
        esp = caml_oldify_local_roots(param1, ecx, ebx, esp - 4, esi, param4);
        ebx_1 = *(global_0x080766dc + 0xfe0);
        local7 = ebx_1;
        if (ebx_1 < *(global_0x080766dc + 0xfec)) {
            do {
                ebx_7 = local7;
                eax = *ebx_7;
                *(__size32*)(esp + 4) = eax;
        ...
        caml_oldify_mopup();
        eax = *(global_0x080766dc + 0xffc);
        if (eax < *(global_0x080766dc + 0x1008)) {
            do {
                eax_1 = eax;
                ecx = *eax_1;
                edx = *ecx;
                if ( ~(((unsigned char) edx & 0x1) != 0 || edx >= *(global_0x080766dc + 0xfd4) || edx <= *(global_0x080766dc + 0xfd0))) {
                    if (*(edx - 4) == 0) {
                        edx = *edx;
                        *(__size32*)ecx = edx;
                        goto bb0x805ee4b;
...
bb0x805ee4b:
                eax = eax_1 + 4;
            } while (*(global_0x080766dc + 0x1008) > eax_1 + 4);
        }
    }
...
bb0x805e8a2:
        ...
        *(__size32*)(ebp - 28) = 0;
        st5 = (float)*(ebp - 32);
        edx = *(global_0x080766dc + 0x4504);
        *(int*)(ebp - 32) = (unsigned int)edx >> 2;
        *(__size32*)(ebp - 28) = 0;
        st4 = (float)*(ebp - 32);
        *(union { double; __size64; }*)(ebp - 48) = st5 * 3. * st7 / st4 / st6 * 0.5;
        edx = *(global_0x080766dc + 0x4b98);
        if (edx != 0) {
            esi = *(global_0x080766dc + 0x4bb4);
            *(__size32*)(ebp - 32) = esi;
            *(__size32*)(ebp - 28) = 0;
            *(__size32*)(ebp - 32) = edx;
            *(__size32*)(ebp - 28) = 0;
...
void caml_final_do_calls(__size32 param3, __size32 param4)
{
    ...
    local6 = param3;
    local7 = param4;
    if ( ~(*0x807ac40 != 0 || *0x807ac54 == 0)) {
        ecx = caml_gc_message(128, 0x806c494); /* Warning: also results in edx, esp */
bb0x8069d86:
        param3 = local6;
        param4 = local7;
        eax = *0x807ac54;
        ...
        while (eax != 0) {
            ...
            if (edx == 0) {
                ...
                *(int*)(global_0x080766dc + 0x4578) = ebx;
                if (ebx != 0) {
                    continue;
                }
                *(__size32*)(global_0x080766dc + 0x457c) = 0;
            }
            else {
                *(int*)(eax + 4) = edx - 1;
                eax += (edx - 1) * 12;
...
__size32 caml_raise(int param1, __size32 param2, __size32 param3, __size32 param4)
{
    ...
    __size32 esp_67; 		// r28{289}
    __size32 esp_68; 		// r28{289}
    __size32 esp_69; 		// r28{289}
    __size32 esp_7; 		// r28{42}
    __size32 esp_70; 		// r28{226}
    __size32 esp_71; 		// r28{226}
    __size32 esp_72; 		// r28{226}
    __size32 esp_73; 		// r28{211}
    __size32 esp_74; 		// r28{211}
    __size32 esp_75; 		// r28{211}
    union { __size32; __size32 *; } esp_76; 		// r28{316}
    ...
    int local102; 		// m[esp_92 - 32]{262}
    int local103; 		// m[esp_92 - 32]{232}
    int local104; 		// m[esp_92 - 32]{280}
    int local105; 		// m[esp_92 - 32]{280}
    int local106; 		// m[esp_92 - 32]{322}
    int local107; 		// m[esp_92 - 32]{364}
    int local108; 		// m[esp_92 - 32]{401}
    int local109; 		// m[esp_92 - 32]{346}
    __size32 local11; 		// m[esp_92 + 4]{233}
    int local110; 		// m[esp_92 - 32]{328}
    int local111; 		// m[esp_92 - 32]{328}
    int local112; 		// m[esp_92 - 32]{401}
    int local113; 		// m[esp_92 - 32]{401}
    int local114; 		// m[esp_92 - 32]{217}
    ...
    int local128; 		// m[esp_92 - 32]{23}
    int local129; 		// m[esp_92 - 32]{322}
    int local13; 		// m[esp_92 + 4]{328}
    int local130; 		// m[esp_92 - 32]{322}
    int local131; 		// m[esp_92 - 32]{7}
    int local132; 		// m[esp_92 - 32]{7}
    int local133; 		// tmpb{229}
    int local134; 		// tmpb{280}
    int local135; 		// tmpb{280}
    int local136; 		// tmpb{280}
    int local137; 		// tmpb{280}
    int local138; 		// tmpb{292}
    int local139; 		// tmpb{280}
    int local14; 		// m[esp_92 + 4]{328}
    int local140; 		// tmpb{397}
    int local141; 		// tmpb{342}
    int local142; 		// tmpb{213}
    int local143; 		// tmpb{379}
    int local144; 		// tmpb{360}
    int local145; 		// tmpb{397}
    int local146; 		// tmpb{342}
    int local147; 		// tmpb{213}
    int local148; 		// tmpb{379}
    int local149; 		// tmpb{360}
    __size32 local15; 		// m[esp_92 + 4]{4}
    int local150; 		// tmpb{328}
    int local151; 		// tmpb{328}
    int local152; 		// tmpb{328}
    int local153; 		// tmpb{328}
    int local154; 		// tmpb{280}
    int local155; 		// tmpb{229}
    int local156; 		// tmpb{19}
    int local157; 		// tmpb{292}
    int local158; 		// tmpb{328}
    ...
    int local164; 		// tmpb{292}
    int local165; 		// tmpb{292}
    int local166; 		// tmpb{229}
    int local167; 		// tmpb{229}
    int local168; 		// tmpb{342}
    int local169; 		// tmpb{342}
    __size32 local17; 		// m[esp_92 + 4]{296}
    int local170; 		// tmpb{397}
    int local171; 		// tmpb{397}
    __size16 local172; 		// tmph{244}
    __size16 local173; 		// tmph{398}
    __size16 local174; 		// tmph{343}
    __size16 local175; 		// tmph{214}
    __size16 local176; 		// tmph{380}
    __size16 local177; 		// tmph{361}
    __size16 local178; 		// tmph{244}
    __size16 local179; 		// tmph{244}
    __size32 local18; 		// m[esp_92 + 4]{402}
    __size16 local180; 		// tmph{398}
    __size16 local181; 		// tmph{343}
    __size16 local182; 		// tmph{214}
    __size16 local183; 		// tmph{380}
    __size16 local184; 		// tmph{361}
    int local185; 		// tmph{328}
    ...
    __size32 local209; 		// ebx{17}
    __size32 local21; 		// m[esp_92 + 4]{365}
    union { __size32 *; __size32; } local210; 		// esp_82{18}
    __size32 local211; 		// local58{21}
    __size32 local212; 		// local87{22}
    int local213; 		// local115{23}
    __size32 local214; 		// local12{24}
    unsigned int local215; 		// edx_1{90}
    __size32 local216; 		// esp_73{211}
    int local217; 		// local142{213}
    __size16 local218; 		// local175{214}
    __size32 local219; 		// m[esp_92 - 4]{215}
    __size32 local22; 		// m[esp_92 + 4]{347}
    __size32 local220; 		// local89{216}
    int local221; 		// local114{217}
    __size32 local222; 		// local20{218}
    __size32 local223; 		// esp_70{226}
    int local224; 		// local133{229}
    __size32 local225; 		// local39{230}
    __size32 local226; 		// local72{231}
    int local227; 		// local103{232}
    __size32 local228; 		// local11{233}
    int local229; 		// eax_1{239}
    __size32 local23; 		// m[esp_92 + 4]{347}
    union { __size32 *; __size32; } local230; 		// esp_64{256}
    unsigned int local231; 		// esi{258}
    __size32 local232; 		// local38{260}
    __size32 local233; 		// local71{261}
    int local234; 		// local102{262}
    union { __size32 *; unsigned int; } local235; 		// eax{271}
    __size32 local236; 		// esp_67{289}
    int local237; 		// local138{292}
    __size32 local238; 		// local60{293}
    __size32 local239; 		// local90{294}
    __size32 local24; 		// m[esp_92 + 4]{402}
    int local240; 		// local116{295}
    __size32 local241; 		// local17{296}
    unsigned int local242; 		// ebx{315}
    union { __size32 *; __size32; } local243; 		// esp_76{316}
    __size32 local244; 		// local42{320}
    __size32 local245; 		// local75{321}
    int local246; 		// local106{322}
    unsigned int local247; 		// ebx{337}
    __size32 local248; 		// esp_79{338}
    int local249; 		// local141{342}
    __size32 local25; 		// m[esp_92 + 4]{402}
    __size16 local250; 		// local174{343}
    __size32 local251; 		// local45{344}
    __size32 local252; 		// local78{345}
    int local253; 		// local109{346}
    __size32 local254; 		// local19{347}
    __size32 local255; 		// esp_85{356}
    unsigned int local256; 		// edi{359}
    int local257; 		// local144{360}
    __size16 local258; 		// local177{361}
    __size32 local259; 		// local43{362}
    __size32 local26; 		// m[esp_92 + 4]{24}
    __size32 local260; 		// local76{363}
    int local261; 		// local107{364}
    __size32 local262; 		// local21{365}
    __size32 local263; 		// esp_88{376}
    int local264; 		// local143{379}
    __size16 local265; 		// local176{380}
    __size32 local266; 		// local62{381}
    __size32 local267; 		// m[esp_92 - 8]{382}
    int local268; 		// m[esp_92 - 32]{383}
    __size32 local269; 		// m[esp_92 + 4]{384}
    __size32 local27; 		// m[esp_92 + 4]{24}
    __size32 local270; 		// esp_89{394}
    int local271; 		// local140{397}
    __size16 local272; 		// local173{398}
    __size32 local273; 		// local44{399}
    __size32 local274; 		// local77{400}
    int local275; 		// local108{401}
    __size32 local276; 		// local18{402}
    __size32 local277; 		// esp{408}
    ...
    __size32 local81; 		// m[esp_92 - 8]{363}
    __size32 local82; 		// m[esp_92 - 8]{363}
    __size32 local83; 		// m[esp_92 - 8]{231}
    ...
    __size32 local89; 		// m[esp_92 - 8]{216}
                ...
                do {
                    ...
                    if (*(esi + 8) > 0) {
                        do {
                            ...
                            local106 = local246;
                            eax_9 = ebx * 4 + *(esi + edi * 4 + 12);
                            *(__size32*)(esp_76 + 4) = eax_9;
                            eax_12 = *eax_9;
                            *(__size32*)esp_76 = eax_12;
                            (**(ebp + 8))((unsigned char) eax_12, cl, dl, eax_12, ecx, edx, ebx, ebp, esi, edi, <all>, ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), local42, local75, local106, param2);
                            local243 = esp_61;
                            local244 = local46;
                            local245 = local79;
                            local246 = local110;
...
__size32 caml_alloc_small(unsigned int param1, __size32 param2)
{
    ...
    esp_4 = esp_8 - 12;
    eax = *(global_0x080766dc + 0xfd8) - param1 * 4 - 4;
    *(unsigned int*)(global_0x080766dc + 0xfd8) = eax;
    local4 = esp_4;
    if (eax < *(global_0x080766dc + 0xfdc)) {
        *(unsigned int*)(global_0x080766dc + 0xfd8) = eax + param1 * 4 + 4;
        esp_1 = esp_8 - 16;
        caml_minor_collection();
        local4 = esp_1;
        *(__size32*)(global_0x080766dc + 0xfd8) = *(global_0x080766dc + 0xfd8) - param1 * 4 - 4;
    }
    esp_7 = local4;
    eax = *0x80776b4;
...
__size32 caml_raise_with_arg(int param1, __size32 param1, __size32 param2, __size32 param3)
{
    ...
    __size32 local100; 		// m[esp_68 - 28]{336}
    __size32 local101; 		// m[esp_68 - 28]{336}
    __size32 local102; 		// m[esp_68 - 28]{119}
    __size32 local103; 		// m[esp_68 - 28]{232}
    __size32 local104; 		// m[esp_68 - 28]{397}
    __size32 local105; 		// m[esp_68 - 28]{397}
    __size32 local106; 		// m[esp_68 - 28]{188}
    __size32 local107; 		// m[esp_68 - 28]{188}
    __size32 local108; 		// m[esp_68 - 28]{232}
    __size32 local109; 		// m[esp_68 - 28]{232}
    int local11; 		// m[esp - 68]
    __size32 local110; 		// m[esp_68 - 28]{146}
    __size32 local111; 		// m[esp_68 - 28]{146}
    __size32 local112; 		// m[esp_68 - 28]{271}
    __size32 local113; 		// m[esp_68 - 28]{271}
    __size32 local114; 		// m[esp_68 - 28]{306}
    ...
    __size32 local119; 		// m[esp_68 - 32]{189}
    int local12; 		// m[esp - 104]
    __size32 local120; 		// m[esp_68 - 32]{147}
    int local121; 		// m[esp_68 - 32]{218}
    int local122; 		// m[esp_68 - 32]{218}
    __size32 local123; 		// m[esp_68 - 32]{272}
    __size32 local124; 		// m[esp_68 - 32]{337}
    __size32 local125; 		// m[esp_68 - 32]{398}
    __size32 local126; 		// m[esp_68 - 32]{307}
    int local127; 		// m[esp_68 - 32]{289}
    int local128; 		// m[esp_68 - 32]{289}
    __size32 local129; 		// m[esp_68 - 32]{233}
    int local13; 		// m[esp - 112]
    __size32 local130; 		// m[esp_68 - 32]{233}
    __size32 local131; 		// m[esp_68 - 32]{147}
    __size32 local132; 		// m[esp_68 - 32]{147}
    __size32 local133; 		// m[esp_68 - 32]{368}
    __size32 local134; 		// m[esp_68 - 32]{272}
    __size32 local135; 		// m[esp_68 - 32]{272}
    __size32 local136; 		// m[esp_68 - 32]{307}
    __size32 local137; 		// m[esp_68 - 32]{307}
    __size32 local138; 		// m[esp_68 - 32]{337}
    __size32 local139; 		// m[esp_68 - 32]{337}
    int local14; 		// m[esp - 144]
    __size32 local140; 		// m[esp_68 - 32]{398}
    __size32 local141; 		// m[esp_68 - 32]{398}
    __size32 local142; 		// m[esp_68 - 32]{189}
    __size32 local143; 		// m[esp_68 - 32]{189}
    ...
    __size32 local157; 		// m[esp_68 - 36]{399}
    __size32 local158; 		// m[esp_68 - 36]{399}
    ...
    __size32 local175; 		// m[esp_68 - 40]{191}
    __size32 local176; 		// m[esp_68 - 40]{149}
    int local177; 		// m[esp_68 - 40]{218}
    int local178; 		// m[esp_68 - 40]{218}
    __size32 local179; 		// m[esp_68 - 40]{274}
    int local18; 		// m[esp_68 + 4]{218}
    __size32 local180; 		// m[esp_68 - 40]{339}
    __size32 local181; 		// m[esp_68 - 40]{400}
    __size32 local182; 		// m[esp_68 - 40]{309}
    ...
    __size32 local197; 		// m[esp_68 - 40]{339}
    __size32 local198; 		// m[esp_68 - 40]{400}
    __size32 local199; 		// m[esp_68 - 40]{400}
    int local2; 		// m[esp - 44]
    ...
    __size32 local203; 		// m[esp_68 - 44]{192}
    __size32 local204; 		// m[esp_68 - 44]{150}
    int local205; 		// m[esp_68 - 44]{218}
    int local206; 		// m[esp_68 - 44]{218}
    __size32 local207; 		// m[esp_68 - 44]{275}
    __size32 local208; 		// m[esp_68 - 44]{340}
    __size32 local209; 		// m[esp_68 - 44]{401}
    int local21; 		// m[esp_68 + 4]{289}
    __size32 local210; 		// m[esp_68 - 44]{310}
    int local211; 		// m[esp_68 - 44]{289}
    int local212; 		// m[esp_68 - 44]{289}
    __size32 local213; 		// m[esp_68 - 44]{192}
    __size32 local214; 		// m[esp_68 - 44]{192}
    __size32 local215; 		// m[esp_68 - 44]{401}
    __size32 local216; 		// m[esp_68 - 44]{401}
    ...
    __size32 local221; 		// m[esp_68 - 44]{340}
    __size32 local222; 		// m[esp_68 - 44]{340}
    __size32 local223; 		// m[esp_68 - 44]{150}
    __size32 local224; 		// m[esp_68 - 44]{150}
    __size32 local225; 		// m[esp_68 - 44]{371}
    __size32 local226; 		// m[esp_68 - 44]{310}
    __size32 local227; 		// m[esp_68 - 44]{310}
    ...
    __size32 local231; 		// m[esp_68 - 48]{193}
    __size32 local232; 		// m[esp_68 - 48]{151}
    int local233; 		// m[esp_68 - 48]{218}
    int local234; 		// m[esp_68 - 48]{218}
    __size32 local235; 		// m[esp_68 - 48]{276}
    __size32 local236; 		// m[esp_68 - 48]{341}
    __size32 local237; 		// m[esp_68 - 48]{402}
    __size32 local238; 		// m[esp_68 - 48]{311}
    int local239; 		// m[esp_68 - 48]{289}
    __size32 local24; 		// m[esp_68 + 4]{3}
    int local240; 		// m[esp_68 - 48]{289}
    __size32 local241; 		// m[esp_68 - 48]{151}
    __size32 local242; 		// m[esp_68 - 48]{151}
    ...
    __size32 local247; 		// m[esp_68 - 48]{372}
    __size32 local248; 		// m[esp_68 - 48]{276}
    __size32 local249; 		// m[esp_68 - 48]{276}
    __size32 local25; 		// m[esp_68 + 4]{410}
    __size32 local250; 		// m[esp_68 - 48]{311}
    __size32 local251; 		// m[esp_68 - 48]{311}
    __size32 local252; 		// m[esp_68 - 48]{341}
    __size32 local253; 		// m[esp_68 - 48]{341}
    ...
    __size32 local259; 		// m[esp_68 - 68]{194}
    __size32 local26; 		// m[esp_68 + 4]{319}
    __size32 local260; 		// m[esp_68 - 68]{152}
    int local261; 		// m[esp_68 - 68]{218}
    int local262; 		// m[esp_68 - 68]{218}
    __size32 local263; 		// m[esp_68 - 68]{277}
    __size32 local264; 		// m[esp_68 - 68]{342}
    __size32 local265; 		// m[esp_68 - 68]{403}
    __size32 local266; 		// m[esp_68 - 68]{312}
    int local267; 		// m[esp_68 - 68]{289}
    int local268; 		// m[esp_68 - 68]{289}
    __size32 local269; 		// m[esp_68 - 68]{194}
    __size32 local27; 		// m[esp_68 + 4]{132}
    __size32 local270; 		// m[esp_68 - 68]{194}
    __size32 local271; 		// m[esp_68 - 68]{238}
    __size32 local272; 		// m[esp_68 - 68]{238}
    __size32 local273; 		// m[esp_68 - 68]{152}
    __size32 local274; 		// m[esp_68 - 68]{152}
    __size32 local275; 		// m[esp_68 - 68]{373}
    ...
    __size32 local287; 		// m[esp_68 - 72]{195}
    __size32 local288; 		// m[esp_68 - 72]{153}
    int local289; 		// m[esp_68 - 72]{218}
    __size32 local29; 		// m[esp_68 + 4]{349}
    int local290; 		// m[esp_68 - 72]{218}
    __size32 local291; 		// m[esp_68 - 72]{278}
    __size32 local292; 		// m[esp_68 - 72]{343}
    __size32 local293; 		// m[esp_68 - 72]{404}
    __size32 local294; 		// m[esp_68 - 72]{313}
    int local295; 		// m[esp_68 - 72]{289}
    int local296; 		// m[esp_68 - 72]{289}
    __size32 local297; 		// m[esp_68 - 72]{195}
    __size32 local298; 		// m[esp_68 - 72]{195}
    __size32 local299; 		// m[esp_68 - 72]{239}
    int local3; 		// m[esp - 36]
    __size32 local30; 		// m[esp_68 + 4]{245}
    __size32 local300; 		// m[esp_68 - 72]{239}
    __size32 local301; 		// m[esp_68 - 72]{153}
    __size32 local302; 		// m[esp_68 - 72]{153}
    __size32 local303; 		// m[esp_68 - 72]{374}
    __size32 local304; 		// m[esp_68 - 72]{278}
    __size32 local305; 		// m[esp_68 - 72]{278}
    __size32 local306; 		// m[esp_68 - 72]{313}
    __size32 local307; 		// m[esp_68 - 72]{313}
    __size32 local308; 		// m[esp_68 - 72]{343}
    __size32 local309; 		// m[esp_68 - 72]{343}
    __size32 local31; 		// m[esp_68 + 4]{245}
    __size32 local310; 		// m[esp_68 - 72]{404}
    __size32 local311; 		// m[esp_68 - 72]{404}
    ...
    __size32 local526; 		// local76{118}
    __size32 local527; 		// local102{119}
    ...
    __size32 local544; 		// local120{147}
    __size32 local545; 		// local148{148}
    __size32 local546; 		// local176{149}
    __size32 local547; 		// local204{150}
    __size32 local548; 		// local232{151}
    __size32 local549; 		// local260{152}
    ...
    __size32 local563; 		// local119{189}
    __size32 local564; 		// local147{190}
    __size32 local565; 		// local175{191}
    __size32 local566; 		// local203{192}
    __size32 local567; 		// local231{193}
    __size32 local568; 		// local259{194}
    ...
    __size32 local579; 		// local103{232}
    __size32 local58; 		// m[esp_68 + 8]{411}
    __size32 local580; 		// local129{233}
    __size32 local581; 		// local161{234}
    __size32 local582; 		// local187{235}
    __size32 local583; 		// local217{236}
    __size32 local584; 		// local245{237}
    ...
    __size32 local598; 		// local123{272}
    __size32 local599; 		// local151{273}
    int local6; 		// m[esp - 28]
    __size32 local60; 		// m[esp_68 - 4]{8}
    __size32 local600; 		// local179{274}
    __size32 local601; 		// local207{275}
    __size32 local602; 		// local235{276}
    __size32 local603; 		// local263{277}
    ...
    __size32 local616; 		// local126{307}
    __size32 local617; 		// local154{308}
    __size32 local618; 		// local182{309}
    __size32 local619; 		// local210{310}
    __size32 local62; 		// m[esp_68 - 4]{187}
    __size32 local620; 		// local238{311}
    __size32 local621; 		// local266{312}
    ...
    __size32 local636; 		// local124{337}
    __size32 local637; 		// local152{338}
    __size32 local638; 		// local180{339}
    __size32 local639; 		// local208{340}
    int local64; 		// m[esp_68 - 4]{218}
    __size32 local640; 		// local236{341}
    __size32 local641; 		// local264{342}
    ...
    __size32 local653; 		// m[esp_68 - 4]{366}
    __size32 local654; 		// m[esp_68 - 28]{367}
    __size32 local655; 		// local133{368}
    __size32 local656; 		// local165{369}
    __size32 local657; 		// local191{370}
    __size32 local658; 		// local225{371}
    __size32 local659; 		// local247{372}
    __size32 local66; 		// m[esp_68 - 4]{270}
    __size32 local660; 		// local275{373}
    __size32 local661; 		// local303{374}
    ...
    __size32 local674; 		// local125{398}
    __size32 local675; 		// local153{399}
    __size32 local676; 		// local181{400}
    __size32 local677; 		// local209{401}
    __size32 local678; 		// local237{402}
    __size32 local679; 		// local265{403}
    ...
    __size32 local74; 		// m[esp_68 - 4]{145}
    __size32 local75; 		// m[esp_68 - 4]{145}
    __size32 local76; 		// m[esp_68 - 4]{118}
    __size32 local77; 		// m[esp_68 - 4]{396}
    __size32 local78; 		// m[esp_68 - 4]{396}
    __size32 local79; 		// m[esp_68 - 4]{187}
    int local8; 		// m[esp - 80]
    __size32 local80; 		// m[esp_68 - 4]{187}
    __size32 local81; 		// m[esp_68 - 4]{270}
    __size32 local82; 		// m[esp_68 - 4]{270}
    __size32 local83; 		// m[esp_68 - 4]{305}
    __size32 local84; 		// m[esp_68 - 4]{305}
    __size32 local85; 		// m[esp_68 - 4]{335}
    __size32 local86; 		// m[esp_68 - 4]{335}
                    ...
                    *(__size32*)(ebp - 36) = ebx;
                    ...
                    for(;;) {
                        ...
                        *(__size32*)(esp_50 + 4) = eax;
                        eax = *eax;
                        *(__size32*)esp_50 = eax;
                        (*ebx)((unsigned char) eax, cl, dl, eax, ecx, edx, ebx, ebp, esi, edi, <all>, flags, ZF, CF, local62, local90, local119, local147, local175, local203, local231, local259, local287, local315, local343, local371, local399, local427, param1, param2, param1);
                        local559 = esp_37;
                        local561 = local64;
                        local562 = local92;
                        local563 = local121;
    ...
    if (*(ebp + 24) != 0) {
        ...
        *(__size32*)(ebp - 28) = 0;
        do {
                    ...
                    if (*(esi + 8) > 0) {
                        do {
                            ...
                            *(__size32*)esp_62 = eax_12;
                            (**(ebp + 8))((unsigned char) eax_12, cl, dl, eax_12, ecx, edx, ebx, ebp, esi, edi, <all>, ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), local66, local94, local123, local151, local179, local207, local235, local263, local291, local319, local347, local375, local403, local431, param1, param2, param1);
                            local595 = esp_40;
                            local596 = local70;
                            local597 = local98;
                            local598 = local127;
            ...
            local461 = local651;
            local494 = local652;
            *(__size32*)(esp_68 - 4) = local653;
            *(__size32*)(esp_68 - 28) = local654;
            local133 = local655;
            local165 = local656;
            local191 = local657;
            local225 = local658;
...
__size32 caml_raise_with_string(__size32 param1, __size32 param2)
{
    ...
    __size16 local155; 		// tmph{234}
    __size16 local156; 		// tmph{253}
    __size16 local157; 		// tmph{271}
    ...
    __size32 local218; 		// m[esp_38 + 8]{240}
...
__size8 caml_raise_constant(int param1, __size32 param1, __size32 param2)
{
    ...
    __size32 local105; 		// m[esp_26 - 36]{130}
    __size32 local106; 		// m[esp_26 - 36]{130}
    __size32 local107; 		// m[esp_26 - 36]{173}
    __size32 local108; 		// m[esp_26 - 36]{173}
    __size32 local109; 		// m[esp_26 - 36]{90}
    int local11; 		// m[esp - 104]
    __size32 local110; 		// m[esp_26 - 36]{90}
    __size32 local111; 		// m[esp_26 - 36]{301}
    __size32 local112; 		// m[esp_26 - 36]{210}
    __size32 local113; 		// m[esp_26 - 36]{210}
    __size32 local114; 		// m[esp_26 - 36]{244}
    __size32 local115; 		// m[esp_26 - 36]{244}
    __size32 local116; 		// m[esp_26 - 36]{272}
    __size32 local117; 		// m[esp_26 - 36]{272}
    __size32 local118; 		// m[esp_26 - 36]{329}
    __size32 local119; 		// m[esp_26 - 36]{329}
    int local12; 		// m[esp - 112]
    __size32 local120; 		// m[esp_26 - 40]{10}
    __size32 local121; 		// m[esp_26 - 40]{10}
    __size32 local122; 		// m[esp_26 - 40]{10}
    __size32 local123; 		// m[esp_26 - 40]{131}
    __size32 local124; 		// m[esp_26 - 40]{91}
    int local125; 		// m[esp_26 - 40]{160}
    int local126; 		// m[esp_26 - 40]{160}
    __size32 local127; 		// m[esp_26 - 40]{211}
    __size32 local128; 		// m[esp_26 - 40]{273}
    __size32 local129; 		// m[esp_26 - 40]{330}
    int local13; 		// m[esp - 144]
    __size32 local130; 		// m[esp_26 - 40]{245}
    int local131; 		// m[esp_26 - 40]{228}
    int local132; 		// m[esp_26 - 40]{228}
    __size32 local133; 		// m[esp_26 - 40]{131}
    __size32 local134; 		// m[esp_26 - 40]{131}
    __size32 local135; 		// m[esp_26 - 40]{174}
    __size32 local136; 		// m[esp_26 - 40]{174}
    __size32 local137; 		// m[esp_26 - 40]{91}
    __size32 local138; 		// m[esp_26 - 40]{91}
    __size32 local139; 		// m[esp_26 - 40]{302}
    __size32 local14; 		// m[esp + 4]
    __size32 local140; 		// m[esp_26 - 40]{211}
    __size32 local141; 		// m[esp_26 - 40]{211}
    __size32 local142; 		// m[esp_26 - 40]{245}
    __size32 local143; 		// m[esp_26 - 40]{245}
    __size32 local144; 		// m[esp_26 - 40]{273}
    __size32 local145; 		// m[esp_26 - 40]{273}
    __size32 local146; 		// m[esp_26 - 40]{330}
    __size32 local147; 		// m[esp_26 - 40]{330}
    __size32 local148; 		// m[esp_26 - 44]{8}
    __size32 local149; 		// m[esp_26 - 44]{8}
    __size32 local15; 		// m[esp_26 + 4]{78}
    __size32 local150; 		// m[esp_26 - 44]{8}
    __size32 local151; 		// m[esp_26 - 44]{132}
    __size32 local152; 		// m[esp_26 - 44]{92}
    int local153; 		// m[esp_26 - 44]{160}
    int local154; 		// m[esp_26 - 44]{160}
    __size32 local155; 		// m[esp_26 - 44]{212}
    __size32 local156; 		// m[esp_26 - 44]{274}
    __size32 local157; 		// m[esp_26 - 44]{331}
    __size32 local158; 		// m[esp_26 - 44]{246}
    int local159; 		// m[esp_26 - 44]{228}
    __size32 local16; 		// m[esp_26 + 4]{186}
    int local160; 		// m[esp_26 - 44]{228}
    __size32 local161; 		// m[esp_26 - 44]{132}
    __size32 local162; 		// m[esp_26 - 44]{132}
    __size32 local163; 		// m[esp_26 - 44]{175}
    __size32 local164; 		// m[esp_26 - 44]{175}
    __size32 local165; 		// m[esp_26 - 44]{92}
    __size32 local166; 		// m[esp_26 - 44]{92}
    __size32 local167; 		// m[esp_26 - 44]{303}
    __size32 local168; 		// m[esp_26 - 44]{212}
    __size32 local169; 		// m[esp_26 - 44]{212}
    __size32 local17; 		// m[esp_26 + 4]{186}
    __size32 local170; 		// m[esp_26 - 44]{246}
    __size32 local171; 		// m[esp_26 - 44]{246}
    __size32 local172; 		// m[esp_26 - 44]{274}
    __size32 local173; 		// m[esp_26 - 44]{274}
    __size32 local174; 		// m[esp_26 - 44]{331}
    __size32 local175; 		// m[esp_26 - 44]{331}
    __size32 local176; 		// m[esp_26 - 48]{19}
    __size32 local177; 		// m[esp_26 - 48]{19}
    __size32 local178; 		// m[esp_26 - 48]{19}
    __size32 local179; 		// m[esp_26 - 48]{133}
    __size32 local18; 		// m[esp_26 + 4]{186}
    __size32 local180; 		// m[esp_26 - 48]{93}
    int local181; 		// m[esp_26 - 48]{160}
    int local182; 		// m[esp_26 - 48]{160}
    __size32 local183; 		// m[esp_26 - 48]{213}
    __size32 local184; 		// m[esp_26 - 48]{275}
    __size32 local185; 		// m[esp_26 - 48]{332}
    __size32 local186; 		// m[esp_26 - 48]{247}
    int local187; 		// m[esp_26 - 48]{228}
    int local188; 		// m[esp_26 - 48]{228}
    __size32 local189; 		// m[esp_26 - 48]{133}
    int local19; 		// m[esp_26 + 4]{160}
    __size32 local190; 		// m[esp_26 - 48]{133}
    __size32 local191; 		// m[esp_26 - 48]{176}
    __size32 local192; 		// m[esp_26 - 48]{176}
    __size32 local193; 		// m[esp_26 - 48]{93}
    __size32 local194; 		// m[esp_26 - 48]{93}
    __size32 local195; 		// m[esp_26 - 48]{304}
    __size32 local196; 		// m[esp_26 - 48]{213}
    __size32 local197; 		// m[esp_26 - 48]{213}
    __size32 local198; 		// m[esp_26 - 48]{247}
    __size32 local199; 		// m[esp_26 - 48]{247}
    int local2; 		// m[esp - 44]
    int local20; 		// m[esp_26 + 4]{160}
    __size32 local200; 		// m[esp_26 - 48]{275}
    __size32 local201; 		// m[esp_26 - 48]{275}
    __size32 local202; 		// m[esp_26 - 48]{332}
    __size32 local203; 		// m[esp_26 - 48]{332}
    __size32 local204; 		// m[esp_26 - 68]{16}
    __size32 local205; 		// m[esp_26 - 68]{16}
    __size32 local206; 		// m[esp_26 - 68]{16}
    __size32 local207; 		// m[esp_26 - 68]{134}
    __size32 local208; 		// m[esp_26 - 68]{94}
    int local209; 		// m[esp_26 - 68]{160}
    int local21; 		// m[esp_26 + 4]{160}
    int local210; 		// m[esp_26 - 68]{160}
    __size32 local211; 		// m[esp_26 - 68]{214}
    __size32 local212; 		// m[esp_26 - 68]{276}
    __size32 local213; 		// m[esp_26 - 68]{333}
    __size32 local214; 		// m[esp_26 - 68]{248}
    int local215; 		// m[esp_26 - 68]{228}
    int local216; 		// m[esp_26 - 68]{228}
    __size32 local217; 		// m[esp_26 - 68]{134}
    __size32 local218; 		// m[esp_26 - 68]{134}
    __size32 local219; 		// m[esp_26 - 68]{177}
    __size32 local22; 		// m[esp_26 + 4]{103}
    __size32 local220; 		// m[esp_26 - 68]{177}
    __size32 local221; 		// m[esp_26 - 68]{94}
    __size32 local222; 		// m[esp_26 - 68]{94}
    __size32 local223; 		// m[esp_26 - 68]{305}
    __size32 local224; 		// m[esp_26 - 68]{214}
    __size32 local225; 		// m[esp_26 - 68]{214}
    __size32 local226; 		// m[esp_26 - 68]{248}
    __size32 local227; 		// m[esp_26 - 68]{248}
    __size32 local228; 		// m[esp_26 - 68]{276}
    __size32 local229; 		// m[esp_26 - 68]{276}
    int local23; 		// m[esp_26 + 4]{228}
    __size32 local230; 		// m[esp_26 - 68]{333}
    __size32 local231; 		// m[esp_26 - 68]{333}
    __size32 local232; 		// m[esp_26 - 72]{14}
    __size32 local233; 		// m[esp_26 - 72]{14}
    __size32 local234; 		// m[esp_26 - 72]{14}
    __size32 local235; 		// m[esp_26 - 72]{135}
    __size32 local236; 		// m[esp_26 - 72]{95}
    int local237; 		// m[esp_26 - 72]{160}
    int local238; 		// m[esp_26 - 72]{160}
    __size32 local239; 		// m[esp_26 - 72]{215}
    int local24; 		// m[esp_26 + 4]{228}
    __size32 local240; 		// m[esp_26 - 72]{277}
    __size32 local241; 		// m[esp_26 - 72]{334}
    __size32 local242; 		// m[esp_26 - 72]{249}
    int local243; 		// m[esp_26 - 72]{228}
    int local244; 		// m[esp_26 - 72]{228}
    __size32 local245; 		// m[esp_26 - 72]{135}
    __size32 local246; 		// m[esp_26 - 72]{135}
    __size32 local247; 		// m[esp_26 - 72]{178}
    __size32 local248; 		// m[esp_26 - 72]{178}
    __size32 local249; 		// m[esp_26 - 72]{95}
    __size32 local25; 		// m[esp_26 + 4]{103}
    __size32 local250; 		// m[esp_26 - 72]{95}
    __size32 local251; 		// m[esp_26 - 72]{306}
    __size32 local252; 		// m[esp_26 - 72]{215}
    __size32 local253; 		// m[esp_26 - 72]{215}
    __size32 local254; 		// m[esp_26 - 72]{249}
    __size32 local255; 		// m[esp_26 - 72]{249}
    __size32 local256; 		// m[esp_26 - 72]{277}
    __size32 local257; 		// m[esp_26 - 72]{277}
    __size32 local258; 		// m[esp_26 - 72]{334}
    __size32 local259; 		// m[esp_26 - 72]{334}
    __size32 local26; 		// m[esp_26 + 4]{103}
    __size32 local260; 		// m[esp_26 - 76]{15}
    __size32 local261; 		// m[esp_26 - 76]{15}
    __size32 local262; 		// m[esp_26 - 76]{15}
    __size32 local263; 		// m[esp_26 - 76]{136}
    __size32 local264; 		// m[esp_26 - 76]{96}
    int local265; 		// m[esp_26 - 76]{160}
    int local266; 		// m[esp_26 - 76]{160}
    __size32 local267; 		// m[esp_26 - 76]{216}
    __size32 local268; 		// m[esp_26 - 76]{278}
    __size32 local269; 		// m[esp_26 - 76]{335}
    __size32 local27; 		// m[esp_26 + 4]{342}
    __size32 local270; 		// m[esp_26 - 76]{250}
    int local271; 		// m[esp_26 - 76]{228}
    int local272; 		// m[esp_26 - 76]{228}
    __size32 local273; 		// m[esp_26 - 76]{136}
    __size32 local274; 		// m[esp_26 - 76]{136}
    __size32 local275; 		// m[esp_26 - 76]{179}
    __size32 local276; 		// m[esp_26 - 76]{179}
    __size32 local277; 		// m[esp_26 - 76]{96}
    __size32 local278; 		// m[esp_26 - 76]{96}
    __size32 local279; 		// m[esp_26 - 76]{307}
    __size32 local28; 		// m[esp_26 + 4]{257}
    __size32 local280; 		// m[esp_26 - 76]{216}
    __size32 local281; 		// m[esp_26 - 76]{216}
    __size32 local282; 		// m[esp_26 - 76]{250}
    __size32 local283; 		// m[esp_26 - 76]{250}
    __size32 local284; 		// m[esp_26 - 76]{278}
    __size32 local285; 		// m[esp_26 - 76]{278}
    __size32 local286; 		// m[esp_26 - 76]{335}
    __size32 local287; 		// m[esp_26 - 76]{335}
    __size32 local288; 		// m[esp_26 - 80]{12}
    __size32 local289; 		// m[esp_26 - 80]{12}
    __size32 local29; 		// m[esp_26 + 4]{285}
    __size32 local290; 		// m[esp_26 - 80]{12}
    __size32 local291; 		// m[esp_26 - 80]{137}
    __size32 local292; 		// m[esp_26 - 80]{97}
    int local293; 		// m[esp_26 - 80]{160}
    int local294; 		// m[esp_26 - 80]{160}
    __size32 local295; 		// m[esp_26 - 80]{217}
    __size32 local296; 		// m[esp_26 - 80]{279}
    __size32 local297; 		// m[esp_26 - 80]{336}
    __size32 local298; 		// m[esp_26 - 80]{251}
    int local299; 		// m[esp_26 - 80]{228}
    int local3; 		// m[esp - 36]
    __size32 local30; 		// m[esp_26 + 4]{3}
    int local300; 		// m[esp_26 - 80]{228}
    __size32 local301; 		// m[esp_26 - 80]{137}
    __size32 local302; 		// m[esp_26 - 80]{137}
    __size32 local303; 		// m[esp_26 - 80]{180}
    __size32 local304; 		// m[esp_26 - 80]{180}
    __size32 local305; 		// m[esp_26 - 80]{97}
    __size32 local306; 		// m[esp_26 - 80]{97}
    __size32 local307; 		// m[esp_26 - 80]{308}
    __size32 local308; 		// m[esp_26 - 80]{217}
    __size32 local309; 		// m[esp_26 - 80]{217}
    __size32 local31; 		// m[esp_26 + 4]{3}
    __size32 local310; 		// m[esp_26 - 80]{251}
    __size32 local311; 		// m[esp_26 - 80]{251}
    __size32 local312; 		// m[esp_26 - 80]{279}
    __size32 local313; 		// m[esp_26 - 80]{279}
    __size32 local314; 		// m[esp_26 - 80]{336}
    __size32 local315; 		// m[esp_26 - 80]{336}
    __size32 local316; 		// m[esp_26 - 104]{17}
    __size32 local317; 		// m[esp_26 - 104]{17}
    __size32 local318; 		// m[esp_26 - 104]{17}
    __size32 local319; 		// m[esp_26 - 104]{138}
    __size32 local32; 		// m[esp_26 + 4]{342}
    __size32 local320; 		// m[esp_26 - 104]{98}
    int local321; 		// m[esp_26 - 104]{160}
    int local322; 		// m[esp_26 - 104]{160}
    __size32 local323; 		// m[esp_26 - 104]{218}
    __size32 local324; 		// m[esp_26 - 104]{280}
    __size32 local325; 		// m[esp_26 - 104]{337}
    __size32 local326; 		// m[esp_26 - 104]{252}
    int local327; 		// m[esp_26 - 104]{228}
    int local328; 		// m[esp_26 - 104]{228}
    __size32 local329; 		// m[esp_26 - 104]{138}
    __size32 local33; 		// m[esp_26 + 4]{342}
    __size32 local330; 		// m[esp_26 - 104]{138}
    __size32 local331; 		// m[esp_26 - 104]{181}
    __size32 local332; 		// m[esp_26 - 104]{181}
    __size32 local333; 		// m[esp_26 - 104]{98}
    __size32 local334; 		// m[esp_26 - 104]{98}
    __size32 local335; 		// m[esp_26 - 104]{309}
    __size32 local336; 		// m[esp_26 - 104]{218}
    __size32 local337; 		// m[esp_26 - 104]{218}
    __size32 local338; 		// m[esp_26 - 104]{252}
    __size32 local339; 		// m[esp_26 - 104]{252}
    __size32 local34; 		// m[esp_26 + 4]{257}
    __size32 local340; 		// m[esp_26 - 104]{280}
    __size32 local341; 		// m[esp_26 - 104]{280}
    __size32 local342; 		// m[esp_26 - 104]{337}
    __size32 local343; 		// m[esp_26 - 104]{337}
    __size32 local344; 		// m[esp_26 - 108]{21}
    __size32 local345; 		// m[esp_26 - 108]{21}
    __size32 local346; 		// m[esp_26 - 108]{21}
    __size32 local347; 		// m[esp_26 - 108]{139}
    __size32 local348; 		// m[esp_26 - 108]{99}
    int local349; 		// m[esp_26 - 108]{160}
    __size32 local35; 		// m[esp_26 + 4]{257}
    int local350; 		// m[esp_26 - 108]{160}
    __size32 local351; 		// m[esp_26 - 108]{219}
    __size32 local352; 		// m[esp_26 - 108]{281}
    __size32 local353; 		// m[esp_26 - 108]{338}
    __size32 local354; 		// m[esp_26 - 108]{253}
    int local355; 		// m[esp_26 - 108]{228}
    int local356; 		// m[esp_26 - 108]{228}
    __size32 local357; 		// m[esp_26 - 108]{310}
    __size32 local358; 		// m[esp_26 - 108]{182}
    __size32 local359; 		// m[esp_26 - 108]{99}
    __size32 local36; 		// m[esp_26 - 4]{7}
    __size32 local360; 		// m[esp_26 - 108]{99}
    __size32 local361; 		// m[esp_26 - 108]{182}
    __size32 local362; 		// m[esp_26 - 108]{182}
    __size32 local363; 		// m[esp_26 - 108]{139}
    __size32 local364; 		// m[esp_26 - 108]{139}
    ...
    __size32 local475; 		// m[esp_26 - 4]{63}
    __size32 local476; 		// m[esp_26 - 32]{64}
    __size32 local477; 		// m[esp_26 - 36]{65}
    __size32 local478; 		// m[esp_26 - 40]{66}
    ...
    __size32 local500; 		// local320{98}
    __size32 local501; 		// local348{99}
    unsigned int local502; 		// local377{100}
    __size32 local503; 		// local22{103}
    ...
    __size32 local517; 		// local319{138}
    __size32 local518; 		// local347{139}
    ...
    __size32 local532; 		// local303{180}
    __size32 local533; 		// local331{181}
    __size32 local534; 		// local358{182}
    unsigned int local535; 		// local388{183}
    __size32 local536; 		// local16{186}
    ...
    __size32 local549; 		// local323{218}
    __size32 local55; 		// m[esp_26 - 4]{299}
    __size32 local550; 		// local351{219}
    ...
    __size32 local56; 		// m[esp_26 - 4]{208}
    ...
    __size32 local566; 		// local326{252}
    __size32 local567; 		// local354{253}
    unsigned int local568; 		// local383{254}
    __size32 local569; 		// local28{257}
    __size32 local57; 		// m[esp_26 - 4]{208}
    ...
    int local6; 		// m[esp - 48]
    __size32 local60; 		// m[esp_26 - 4]{270}
    __size32 local600; 		// local307{308}
    __size32 local601; 		// local335{309}
    __size32 local602; 		// local357{310}
    unsigned int local603; 		// local392{311}
    __size32 local604; 		// m[esp_26 + 4]{314}
    ...
    __size32 local61; 		// m[esp_26 - 4]{270}
    ...
    __size32 local618; 		// local325{337}
    __size32 local619; 		// local353{338}
    __size32 local62; 		// m[esp_26 - 4]{327}
    unsigned int local620; 		// local382{339}
    __size32 local621; 		// local27{342}
    __size32 local622; 		// esp{348}
    __size32 local63; 		// m[esp_26 - 4]{327}
    ...
    __size32 local84; 		// m[esp_26 - 32]{209}
    __size32 local85; 		// m[esp_26 - 32]{209}
    __size32 local86; 		// m[esp_26 - 32]{243}
    __size32 local87; 		// m[esp_26 - 32]{243}
    __size32 local88; 		// m[esp_26 - 32]{271}
    __size32 local89; 		// m[esp_26 - 32]{271}
    int local9; 		// m[esp - 76]
    __size32 local90; 		// m[esp_26 - 32]{328}
    __size32 local91; 		// m[esp_26 - 32]{328}
...
bb0x805c4c7:
                    ...
                    *(__size32*)(ebp - 36) = ebx;
                    ...
                    for(;;) {
                        ...
                        *(__size32*)(esp_28 + 4) = eax;
                        eax = *eax;
                        *(__size32*)esp_28 = eax;
                        (*ebx)((unsigned char) eax, eax, ecx, edx, ebx, ebp, esi, edi, <all>, flags, ZF, CF, local39, local67, local95, local123, local151, local179, local207, local235, local263, local291, local319, local347, local376, cl, dl, param1, param1);
                        local505 = esp_19;
                        local507 = local41;
                        local508 = local69;
                        local509 = local97;
    ...
    local409 = local473;
    local442 = local474;
    *(__size32*)(esp_26 - 4) = local475;
    *(__size32*)(esp_26 - 32) = local476;
    *(__size32*)(esp_26 - 36) = local477;
    *(__size32*)(esp_26 - 40) = local478;
...
void caml_oldify_local_roots(__size8 param1, int param2, unsigned int param3, __size32 param4, unsigned int param5, unsigned int param6)
{
            ...
            do {
                ...
                if ((unsigned int)edx >> 10 != 0) {
                    do {
                        ...
                        local17 = esi_28;
                        local18 = edi_31;
                        if ( ~(((unsigned char) eax_8 & 0x1) != 0 || eax_8 >= *(&caml_globals + 0x9a3c) || eax_8 <= *(&caml_globals + 0x9a38))) {
    ...
    ebp_21 = local32;
    edi_28 = local33;
    *(unsigned int*)(&caml_globals + 0x68dc) = eax;
    ecx_5 = *(&caml_globals + 0x68d8);
    *(int*)(ebp_21 - 28) = ecx_5;
    local34 = param1;
    local35 = ecx_5;
    local36 = ebx_38;
        ...
        do {
            ...
            if ((unsigned int)eax >> 10 != 0) {
                ...
                do {
                    ...
                    local49 = esi_26;
                    local50 = edi_27;
                    if ( ~(((unsigned char) eax_2 & 0x1) != 0 || eax_2 >= *(&caml_globals + 0x9a3c) || eax_2 <= *(&caml_globals + 0x9a38))) {
    ...
    ebp_15 = local63;
    edi_23 = local64;
    ecx_9 = *(&caml_globals + 0x68cc);
    *(__size32*)(ebp_15 - 28) = ecx_9;
    edx = *(&caml_globals + 0x65f8);
    dl_2 = (unsigned char) edx;
    eax = *(&caml_globals + 0xd4d4);
    al = (unsigned char) eax;
...
bb0x805ca17:
            ...
            ebp_14 = local66;
            edi_22 = local67;
            esi_3 = *(&caml_globals + 0xd4cc);
            eax = (unsigned int)edx >> 3 & esi_3;
            ecx_12 = *(&caml_globals + 0x68c8);
            ...
            if (*(ebx_31 + 4) != -1) {
                ...
                if ((int)esi_6 > 0) {
                    ...
                    for(;;) {
                        ...
                        eax = *edx;
                        local77 = ecx_34;
                        if ( ~(((unsigned char) eax & 0x1) != 0 || eax >= *(&caml_globals + 0x9a3c) || eax <= *(&caml_globals + 0x9a38))) {
                ...
                do {
                    ...
                    if (*(esi_30 + 8) > 0) {
                        do {
                            ...
                            local103 = esi_24;
                            local104 = edi_21;
                            if ( ~(((unsigned char) eax_11 & 0x1) != 0 || eax_11 >= *(&caml_globals + 0x9a3c) || eax_11 <= *(&caml_globals + 0x9a38))) {
...
bb0x805eb7b:
    ...
    local23 = esp_4;
    local23 = esp_4;
    while ( ~((bl & 0x1) != 0 || ebx_2 >= *(&caml_globals + 0x9a3c) || ebx_2 <= *(&caml_globals + 0x9a38))) {
        edx_1 = *(ebx_2 - 4);
                ...
                *(unsigned int*)ebx_2 = ((unsigned char) edx_1);
                ...
                if ((unsigned int)(edx_1 >> 10) <= 1) {
                    ...
                    *(unsigned int*)((unsigned char) edx_1) = edx_4;
                    edx_7 = *(&caml_globals + 0x9a84);
                    dl = (unsigned char) edx_7;
                    *(__size32*)(((unsigned char) edx_1) + 4) = edx_7;
                    *(union { unsigned int *; __size32; }*)0x80776f8 = ebx_2;
                    local19 = dl;
                    local22 = edx_7;
                }
            }
...
void caml_oldify_mopup()
{
    ...
    do {
        ...
        if (edi != 0) {
            ...
            esi = ebx + 4;
            eax = *(ebx + 4);
            *(__size32*)(&caml_globals + 0x9a84) = eax;
            eax = *ebx;
            if ( ~(((unsigned char) eax & 0x1) != 0 || eax >= *(&caml_globals + 0x9a3c) || eax <= *(&caml_globals + 0x9a38))) {
...
void caml_final_empty_young()
{
    ...
    eax = *(global_0x080766dc + 0x4568);
    *(__size32*)(global_0x080766dc + 0x4574) = eax;
    return;
}
...
__size32 start_cycle()
{
    ...
    ecx = caml_gc_message(1, 0x806b90b);
    ebp = caml_darken_all_roots(al, cl, dl, ecx, ebx, esi, edi);
    *(__size32*)(&caml_globals + 0xd608) = 0;
    *(__size32*)(&caml_globals + 0xd5f4) = 10;
    *(__size32*)(&caml_globals + 0x9a28) = 0;
    ebp = *ebp;
    return ebp;
}
...
__size32 caml_callback_exn()
{
    ...
    *(__size32*)(%esp - 4) = %ebp;
    ...
    (*esi)(local0, caml_last_return_address, caml_bottom_of_stack, 0x806ab7e, caml_exception_pointer, pc);
...
void caml_fatal_uncaught_exception(__size32 param1, unsigned char param2)
{
    ...
    *(__size32*)(&named_value_table + 100) = 0;
    eax = caml_named_value(0x806c3a7); /* Warning: also results in esp */
    if (eax != 0) {
...
__size32 caml_alloc_string(__size32 param1, __size8 param2)
{
    ...
    if ((unsigned int)(param1 + 4 >> 2) > 256) {
        ...
        *(__size32*)esp_1 = eax;
        ...
        edx = (param1 + 4 >> 2) * 4 + 4;
        eax = *(&caml_globals + 0x9a40) - edx;
        *(unsigned int*)(&caml_globals + 0x9a40) = eax;
        if (eax < *(&caml_globals + 0x9a44)) {
            *(unsigned int*)(&caml_globals + 0x9a40) = eax + edx;
            caml_minor_collection();
            *(__size32*)(&caml_globals + 0x9a40) += edi;
        }
        ebx = param1 + 4 >> 2;
        ebp = esp_4 - 4;
        eax = *0x80776b4;
...
__size8 caml_init_frame_descriptors()
{
    ...
    if (*0x8074558 == 0) {
        ...
        *(__size32*)(&caml_globals + 0x68e4) = 1;
    }
    eax = *(&caml_globals + 0x68e0);
    if (eax == 0) {
bb0x805c78d:
        *(__size32*)esp = 16;
        eax = caml_stat_alloc(*esp); /* Warning: also results in al, cl, dl, ecx, esp, ebp */
        *(unsigned int*)(&caml_globals + 0x68c8) = eax;
        ebx = 4;
bb0x805c7a3:
        eax = 0;
        local6 = eax;
    ...
    *(__size32*)(ebp - 32) = eax;
    if (eax != 0) {
        do {
            ...
            *(int*)(ebp - 28) = eax;
            if (eax > 0) {
                ebx = *(&caml_globals + 0xd4cc);
                eax_1 = *(esi + 4);
                eax = (unsigned int)eax_1 >> 3 & ebx;
                ecx = *(&caml_globals + 0x68c8);
...
__size8 caml_scan_global_young_roots(__size32 param1, __size32 param2)
{
    ...
    ebx = caml_iterate_global_roots(param1, 0x8074560); /* Warning: also results in esp */
    local4 = param2;
    esp = caml_iterate_global_roots(ebx, 0x80745c0);
    ebx = *(&caml_globals + 0x6950);
    if (ebx != 0) {
        do {
            cl = caml_insert_global_root(0x8074620, edx); /* Warning: also results in ecx, ebx, esp */
            local4 = ecx;
            ebx = *(ebx + 4);
        } while (ebx != 0);
        eax = *(&caml_globals + 0x6950);
        if (eax != 0) {
            for(;;) {
                ebx = *(eax + 4);
                *(unsigned int*)esp = eax;
    ...
    ecx = local6;
    *(__size32*)(&caml_globals + 0x6994) = 0;
...
__size32 caml_final_do_young_roots(__size32 param1, __size32 param2)
{
    ...
    esp_1 = (esp_11 - 44);
    edi = param1;
    esi = *(global_0x080766dc + 0x4574);
    local30 = param2;
    local31 = esp_1;
    local32 = esi;
    local33 = param2;
    local34 = esp_1;
    if (esi < *(global_0x080766dc + 0x4568)) {
        ebx = esi * 12;
        do {
            param2 = local30;
            esp_8 = local31;
            ...
            *(__size32*)esp_8 = eax_4;
            (*edi)(eax_4, param2, ebx, ebp, esi, edi, ADDFLAGS32(ebx, *0x807ac4c, eax_1), ADDFLAGS32(ebx, *0x807ac4c, eax_1), ADDFLAGS32(ebx, *0x807ac4c, eax_1), param1, local9, local14, local19, local24);
            eax_6 = ebx + *(global_0x080766dc + 0x4570);
            *(__size32*)(esp_4 + 4) = eax_6 + 4;
            eax_9 = *(eax_6 + 4);
            *(__size32*)esp_4 = eax_9;
            (*edi)(eax_9, eax_6 + 4, ebx, ebp, esi, edi, <all>, ADDFLAGS32(ebx, *0x807ac4c, eax_6), ADDFLAGS32(ebx, *0x807ac4c, eax_6), ADDFLAGS32(ebx, *0x807ac4c, eax_6), local5, local10, local15, local20, local25);
            local30 = edx;
            local31 = esp_7;
            local33 = edx;
            local34 = esp_7;
            ...
            ebx += 12;
            local32 = esi_4;
        } while (*(global_0x080766dc + 0x4568) > esi_1 + 1);
    }
    param2 = local33;
    esp = local34;
    ebx = *(esp + 28);
...
void caml_alloc_shr(unsigned int param1, unsigned int param2, __size8 param3, __size8 param4, __size8 param5, unsigned int param6, __size32 param7, __size32 param8, __size32 param9, __size32 param10)
{
    ...
    *(unsigned int*)esp_5 = esi_1;
    ...
    if (eax_1 == 0) {
        edx = *(&caml_globals + 0xd5fc) * ((unsigned long long)((esi_1) * 0x51eb851f >> 32) >> 5);
        eax_4 = (esi_1 + edx + 1) * 4;
    ...
    *(__size32*)(&caml_globals + 0xd614) = %eax;
    if ( ~flags) {
...
__size32 caml_stash_backtrace(unsigned int param1, __size32 param2, int param3, unsigned int param4, __size8 param5, __size8 param6, __size8 param7)
{
    ...
    local11 = param7;
    if (param2 != *0x8074348) {
        *(__size32*)(&caml_globals + 0xcff4) = 0;
        *(__size32*)(&caml_globals + 0x66d4) = param2;
    }
    if (*0x807ac6c != 0) {
bb0x806a924:
        esp_2 = esp - 44;
...
bb0x806a9a7:
                        ...
                        edx_4 = *(&caml_globals + 0xcff4);
                        local15 = edx_4;
                        if (edx_4 <= 1023) {
                            ecx = *(&caml_globals + 0xcff8);
                            *(__size32*)(ecx + edx_4 * 4) = eax;
                            edx = edx_4 + 1;
                            *(__size32*)(&caml_globals + 0xcff4) = edx_4 + 1;
        ...
        local15 = edx;
        local16 = esp_1;
        *(union { void *; __size32; }*)0x807ac6c = eax;
        if (eax != 0) {
            goto bb0x806a924;
        }
    }
...
__size32 caml_check_urgent_gc()
{
    ...
    esp_1 = esp_6 - 44;
    *(__size32*)(&caml_globals + 0x68c0) = esp_6 - 44;
    eax = *(&caml_globals + 0x6a00);
    local8 = esp_1;
    if (eax != 0) {
        esp_4 = esp_6 - 48;
        caml_minor_collection();
    ...
    ebx = *(&caml_globals + 0x68c0);
    esp_5 = local8;
    *(__size32*)(&caml_globals + 0x68c0) = ebx;
    ebx = *(esp_5 + 36);
    ebp = *(esp_5 + 40);
...
__size32 caml_register_frametable(__size32 param1)
{
    ...
    *(__size32*)(&caml_globals + 0x68e0) = param1;
    eax = *(&caml_globals + 0x68c8);
    if (eax != 0) {
        *(__size32*)esp_1 = eax;
        caml_stat_free(*esp_1);
        *(__size32*)(&caml_globals + 0x68c8) = 0;
    }
...
bb0x805cbf1:
    ...
    if ( ~(eax_7 != 0 && *eax_7 == param2)) {
        eax_8 = *(&caml_globals + 0x69f8) * 0x10dcd;
        eax_11 = eax_8 + 0x6255;
        *(__size32*)(&caml_globals + 0x69f8) = eax_8 + 0x6255;
        esi = 0;
        local12 = eax_11;
...
bb0x805dc08:
            fl_last = ecx;
            ecx = 0x8074288;
            edx = global_0x08074288;
            local15 = ecx;
            if (fl_prev == 0x8074288) {
bb0x805dfd6:
                param3 = local15;
                edi = 0;
                local16 = param3;
...
bb0x805dc8b:
                ...
                while (flp_size <= 999) {
                    ...
                    if (edi < (unsigned int)((unsigned int)esi_15 >> 10)) {
                        global_0x080766dc[flp_size] = ecx;
                        ebx = flp_size;
                        flp_size++;
...
bb0x805ddb7:
                            ...
                            if (ebx_4 < flp_size) {
                                ...
                                if (flp_size - 1 != ebx_4) {
                                    ...
                                    local13 = ecx;
                                    local14 = ebx_6;
                                    while (global_0x080766dc[ebx_4] != eax) {
                                        edx = *eax;
                                        ecx_1 = *(edx - 4);
...
bb0x805de71:
                                    ...
                                    if (flp_size + ebx_5 - 1 > 1000) {
                                        if (ebx_5 + ebx_4 > 999) {
                                            if (ebx_4 != 1000) {
                                                ecx = memmove(ebx_4 * 4 + 0x80766e0, &param1, (1000 - ebx_4) * 4);
                                            }
                                        }
                                        else {
                                            if (ebx_5 == 1) {
bb0x805df67:
                                                ecx = memmove(ebx_4 * 4 + 0x80766e0, &param1, ebx_5 * 4);
                                            }
                                            else {
                                                ecx = memmove((ebx_5 + ebx_4) * 4 + 0x80766e0, ebx_4 * 4 + 0x80766e4, (1000 - ebx_4 + ebx_5) * 4);
                                                if ((int)ebx_5 > 0) {
                                                    goto bb0x805df67;
                                                }
                                            }
...
bb0x805ded9:
                                            ...
                                            ecx = memmove((ebx_5 + ebx_4) * 4 + 0x80766e0, ebx_4 * 4 + 0x80766e4, (flp_size - ebx_4 - 1) * 4);
                                            if ((int)ebx_5 > 0) {
                                                goto bb0x805ded9;
                                            }
                                        }
                                    ...
                                    eax = *global_0x080766dc[(flp_size - 1)];
                                    edx = *(eax - 4);
                ...
                ecx = edx;
                if (edx == 0) {
                    ecx = global_0x080766dc[flp_size];
                }
                edx = *0x807767c;
                edx = *edx;
                esi = *(edx - 4);
...
void caml_urge_major_slice()
{
    ...
    eax = *(global_0x080766dc + 0xfd4);
    *(__size32*)(global_0x080766dc + 0xfdc) = eax;
    return;
}
...
void caml_fl_add_blocks(unsigned int param1)
{
    ...
    edx = *0x80766d0;
    if (param1 <= edx) {
        ecx = global_0x08074288;
        if (global_0x08074288 != 0 && param1 > global_0x08074288) {
            edx = *ecx;
        ...
        *(unsigned int*)ebx = param1;
        if ( ~(ebx != *0x807427c || param1 >= *(global_0x080766dc + 0x4b90))) {
            edx = *(param1 + 4);
            caml_fl_merge = edx;
        }
        if (*0x80766c4 == 1) {
        ...
        *(unsigned int*)edx = param1;
        if ( ~(edx != *0x807427c || param1 >= *(global_0x080766dc + 0x4b90))) {
            eax = *(param1 + 4);
            caml_fl_merge = eax;
        }
        if ( ~(*0x80766c4 != 1 || flp_size > 999)) {
            global_0x080766dc[flp_size] = edx;
            flp_size++;
        }
    }
    return;
...
void caml_add_to_heap(unsigned int param1)
{
    ...
    ecx = caml_gc_message(4, 0x806ba7f); /* Warning: also results in edx */
    eax = param1 + *(param1 - 8);
    eax = caml_page_table_add(1, param1, eax, ecx, edx);
    if (eax == 0) {
        eax = *(global_0x080766dc + 0x4b9c);
        if (eax != 0 && param1 > eax) {
            do {
                edx = eax - 4;
                eax = *(eax - 4);
        ...
        *(unsigned int*)edx = param1;
        *(__size32*)(global_0x080766dc + 0x4510)++;
        edx = *(global_0x080766dc + 0x4504);
        edx += *(param1 - 8);
        *(int*)(global_0x080766dc + 0x4504) = edx;
        if (edx > *(global_0x080766dc + 0x4508)) {
            *(int*)(global_0x080766dc + 0x4508) = edx;
        }
    }
    return;
}
...
__size32 caml_do_roots(__size32 param1, __size8 param2, __size8 param3, __size8 param4, __size32 param5, unsigned int param6, __size32 param7, unsigned int param8, __size32 param9)
{
    ...
    *(__size32*)(esp_45 - 32) = local185;
    ...
    esp_42 = local188;
    eax = *(&caml_globals + 0x68c0);
    *(__size32*)(esp_42 + 16) = eax;
    eax = *(&caml_globals + 0xd4d4);
    *(__size32*)(esp_42 + 12) = eax;
    eax = *(&caml_globals + 0x65f8);
    *(__size32*)(esp_42 + 8) = eax;
    eax = *(&caml_globals + 0x68cc);
...
void truncate_flp(unsigned int param1)
{
    ...
    if (param1 == 0x8074288) {
        ...
        if (flp_size > 0) {
            edx = flp_size - 1;
            if (param1 <= *global_0x080766dc[(flp_size - 1)]) {
                while (edx > 0) {
                    if (param1 > *global_0x080766dc[(edx - 1)]) {
                        flp_size = edx;
                        goto bb0x805d86a;
                    }
                    edx--;
...
__size8 caml_do_local_roots(__size32 param1, __size32 param2, __size32 param3, unsigned int param4, __size32 param5, __size32 param6, unsigned int param7, unsigned int param8, __size32 param9, unsigned int param10, unsigned int param11)
{
    ...
    __size32 local215; 		// m[esp_35 - 36]{170}
    __size32 local216; 		// m[esp_35 - 36]{42}
    __size32 local217; 		// m[esp_35 - 36]{213}
    __size32 local218; 		// m[esp_35 - 36]{191}
    __size32 local219; 		// m[esp_35 - 36]{234}
    __size32 local223; 		// m[esp_35 - 36]{121}
    int local233; 		// tmpb{54}
    int local234; 		// tmpb{105}
    int local237; 		// tmpb{115}
    int local239; 		// tmpb{227}
    int local240; 		// tmpb{163}
    int local241; 		// tmpb{35}
    int local242; 		// tmpb{206}
    int local243; 		// tmpb{184}
    int local249; 		// tmpb{151}
    int local269; 		// tmpb{11}
    __size16 local271; 		// tmph{74}
    __size16 local272; 		// tmph{228}
    __size16 local273; 		// tmph{164}
    __size16 local274; 		// tmph{36}
    __size16 local275; 		// tmph{207}
    __size16 local276; 		// tmph{185}
    int local283; 		// tmph{151}
    unsigned int local3; 		// m[esp - 16]
    int local30; 		// m[esp_35 + 12]{105}
    __size16 local302; 		// tmph{12}
    __size32 local305; 		// param6{30}
    unsigned int local306; 		// param7{31}
    unsigned int local307; 		// param8{32}
    __size32 local308; 		// esp_19{33}
    int local309; 		// local241{35}
    __size16 local310; 		// local274{36}
    __size32 local311; 		// m[esp_35 - 4]{37}
    unsigned int local312; 		// m[esp_35 - 8]{38}
    unsigned int local313; 		// m[esp_35 - 12]{39}
    unsigned int local314; 		// m[esp_35 - 16]{40}
    __size32 local315; 		// param2{41}
    __size32 local316; 		// local216{42}
    __size32 local317; 		// esp_16{51}
    unsigned int local318; 		// param11{53}
    int local319; 		// local233{54}
    __size32 local320; 		// local76{55}
    unsigned int local321; 		// local102{56}
    unsigned int local322; 		// local128{57}
    unsigned int local323; 		// local154{58}
    __size32 local324; 		// local180{59}
    __size32 local325; 		// local209{60}
    __size32 local326; 		// local12{61}
    unsigned int local327; 		// local33{62}
    __size32 local328; 		// local54{63}
    int local329; 		// eax_1{69}
    unsigned int local33; 		// m[esp_35 + 12]{62}
    union { __size32 *; __size32; } local330; 		// esp_10{84}
    unsigned int local331; 		// esi{86}
    union { __size32 *; unsigned int; } local332; 		// eax{96}
    __size32 local333; 		// esp_13{112}
    unsigned int local334; 		// edi{114}
    int local335; 		// local237{115}
    __size32 local336; 		// local87{116}
    unsigned int local337; 		// local111{117}
    unsigned int local338; 		// local137{118}
    unsigned int local339; 		// local163{119}
    int local34; 		// m[esp_35 + 12]{151}
    __size32 local340; 		// local190{120}
    __size32 local341; 		// local223{121}
    __size32 local342; 		// local15{122}
    unsigned int local343; 		// local43{123}
    __size32 local344; 		// local64{124}
    unsigned int local345; 		// ebx{141}
    union { __size32 *; __size32; } local346; 		// esp_22{142}
    unsigned int local347; 		// ebx{158}
    __size32 local348; 		// esp_25{159}
    int local349; 		// local240{163}
    __size16 local350; 		// local273{164}
    __size32 local351; 		// local89{165}
    unsigned int local352; 		// local115{166}
    unsigned int local353; 		// local141{167}
    unsigned int local354; 		// local167{168}
    __size32 local355; 		// local187{169}
    __size32 local356; 		// local215{170}
    __size32 local357; 		// local20{171}
    unsigned int local358; 		// local39{172}
    __size32 local359; 		// local60{173}
    __size32 local360; 		// esp_28{180}
    unsigned int local361; 		// edi{183}
    int local362; 		// local243{184}
    __size16 local363; 		// local276{185}
    __size32 local364; 		// local91{186}
    unsigned int local365; 		// local117{187}
    unsigned int local366; 		// local143{188}
    unsigned int local367; 		// local169{189}
    __size32 local368; 		// local189{190}
    __size32 local369; 		// local218{191}
    __size32 local370; 		// local19{192}
    unsigned int local371; 		// local42{193}
    __size32 local372; 		// local63{194}
    __size32 local373; 		// esp_31{203}
    int local374; 		// local242{206}
    __size16 local375; 		// local275{207}
    __size32 local376; 		// local90{208}
    unsigned int local377; 		// local116{209}
    unsigned int local378; 		// local142{210}
    unsigned int local379; 		// local168{211}
    unsigned int local38; 		// m[esp_35 + 12]{236}
    __size32 local380; 		// local188{212}
    __size32 local381; 		// local217{213}
    __size32 local382; 		// local18{214}
    unsigned int local383; 		// local41{215}
    __size32 local384; 		// local62{216}
    __size32 local385; 		// ecx{221}
    unsigned int local386; 		// edx{222}
    unsigned int local387; 		// ebx{223}
    __size32 local388; 		// esp_32{224}
    int local389; 		// local239{227}
    unsigned int local39; 		// m[esp_35 + 12]{172}
    __size16 local390; 		// local272{228}
    __size32 local391; 		// local86{229}
    unsigned int local392; 		// local110{230}
    unsigned int local393; 		// local136{231}
    unsigned int local394; 		// local162{232}
    __size32 local395; 		// local186{233}
    __size32 local396; 		// local219{234}
    __size32 local397; 		// local16{235}
    unsigned int local398; 		// local38{236}
    __size32 local399; 		// local59{237}
    __size32 local4; 		// m[esp - 36]
    unsigned int local40; 		// m[esp_35 + 12]{44}
    __size32 local400; 		// ecx{242}
    __size32 local401; 		// esp{243}
...
bb0x805c4c7:
    ...
    local241 = local309;
    local274 = local310;
    *(__size32*)(esp_35 - 4) = local311;
    *(unsigned int*)(esp_35 - 8) = local312;
    *(unsigned int*)(esp_35 - 12) = local313;
    *(unsigned int*)(esp_35 - 16) = local314;
    param2 = local315;
    local216 = local316;
    local385 = param6;
    local386 = param7;
...
__size32 caml_scan_global_roots(__size32 param1)
{
    ...
    ebx = caml_iterate_global_roots(param1, 0x8074560); /* Warning: also results in esp */
    ebx = caml_iterate_global_roots(ebx, 0x80745c0); /* Warning: also results in esp */
    esp = caml_iterate_global_roots(ebx, 0x8074620); /* Warning: also results in esi */
    ebx = *(esp + 4);
    ebp = *(esp + 8);
    ...
    if (*0x807ac50 != 0) {
        ...
        do {
            ...
            *(__size32*)esp_13 = eax_4;
            (*edi)(eax_4, param2, ebx, ebp, esi, edi, ADDFLAGS32(ebx, *0x807ac4c, eax_1), ADDFLAGS32(ebx, *0x807ac4c, eax_1), ADDFLAGS32(ebx, *0x807ac4c, eax_1), param1, local20, local38, local56, local74);
            local90 = edx;
            local91 = esp_4;
            local93 = esp_4;
            local94 = edi;
            ...
            ebx += 12;
            local92 = esi_4;
        } while (*(global_0x080766dc + 0x4574) > esi_1 + 1);
    }
    esp_16 = local93;
    param6 = local94;
    local29 = local95;
...
{
    if (param1 == 0) {
        *(__size32*)(&caml_globals + 0x661c) = 0x8074288;
    }
    else {
        if (param1 == 1) {
            *(__size32*)(&caml_globals + 0x8a54) = 0;
            *(__size32*)(&caml_globals + 0x8a58) = 0;
        }
    }
    *(__size32*)(&caml_globals + 0x8a50) = param1;
    return;
}
...
__size8 caml_record_backtrace(int param1, __size8 param3, __size8 param3, __size32 param5, __size32 param6, __size32 param7, int param8, __size32 param8)
{
    ...
    local8 = param8;
    local8 = param8;
    if (param1 >> 1 != *0x807ac64) {
        *(int*)(&caml_globals + 0xcff0) = param1 >> 1;
        *(__size32*)(&caml_globals + 0xcff4) = 0;
        if (param1 >> 1 == 0) {
            ecx = caml_remove_global_root(0x8074348, param8); /* Warning: also results in edx */
            local4 = ecx;
            local5 = edx;
        }
        else {
            cl = caml_register_global_root(0x8074348); /* Warning: also results in dl, ecx, edx, ebx, ebp, esi, edi */
            local2 = cl;
            local3 = dl;
            local4 = ecx;
            local5 = edx;
...
__size8 caml_register_global_root(unsigned int param1)
{
    ...
    cl = caml_insert_global_root(0x8074560, param1); /* Warning: also results in dl, ecx, edx, ebx, ebp, esi, edi */
    ebp = *ebp;
    return cl; /* WARNING: Also returning: dl := dl, ecx := ecx, edx := edx, ebx := ebx, ebp := ebp, esi := esi, edi := edi */
}
...
__size32 caml_remove_global_root(unsigned int param1, int param2)
{
    ...
    ecx = caml_delete_global_root(0x8074560, param1, param2); /* Warning: also results in edx */
    return ecx; /* WARNING: Also returning: edx := edx */
}
