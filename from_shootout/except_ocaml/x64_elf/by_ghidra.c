...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_006413e0 = (undefined *)&camlUnix__50;
...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_00645760 = (undefined *)&camlPervasives__7;
  ...
  unaff_R15[7] = 0x400;
  *DAT_006457a8 = (undefined *)DAT_00645678;
...

{
  ...
  *puVar9 = uVar4;
  ...
  if (in_RAX <= (long)uVar1) {
    ...
    *(undefined8 *)(uVar7 - 0x18) = 0x800;
    *(undefined8 *)(uVar7 - 0x10) = DAT_00646e48;
...

{
  ...
  plVar4 = (long *)FUN_00412084();
  if (*plVar4 != DAT_00646e48) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar1 = plVar4[1];
...

{
  ...
  if (in_RAX != 0xb9) {
    ...
    case 0x1c:
      bVar2 = (byte)uVar1 - 2;
      bVar7 = 1 < (byte)uVar1 || CARRY1(bVar2,0xffbcab8f < uVar1);
      auStack16 = 0x435479;
...
LAB_0041af10:
    ...
    if (uVar3 == 0) goto LAB_0041af24;
    if (uVar3 == 1) goto LAB_0041af10;
    if (1 < (long)uVar3) goto LAB_0041af4c;
  }
  if (uVar3 != 1) {
LAB_0041af4c:
...

{
  ...
  do {
    ...
    uVar2 = SEXT48((int)(&switchD_0041b97f::switchdataD_00435690)[lVar5 >> 1]);
    switch(lVar5) {
    default:
    ...
    case 0xf7:
      ...
      *(long *)(uVar2 - 8) = lVar5;
      ...
      break;
    case 0xfc:
      *(char *)(uVar2 - 0x7d) = (*(char *)(uVar2 - 0x7d) - in_AL) - (0xffffffffffbca96f < uVar2);
      return uVar2;
    }
  } while( true );
}
...
code_r0x0041cfcb:
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
         (*(char *)((long)piVar6 + -0x75) - cVar11) - ((int *)0xffffffffffbca6f3 < piVar6);
  ...
  case 0x142:
    ...
    uVar8 = camlPrintf__extract_format_int_131(param_1,in_RAX,puVar13);
  ...
  case 0x1cc:
    *(char *)piVar6 = *(char *)piVar6 + cVar3;
    if ((long)param_1 >> 1 == 1) {
      ...
      uVar8 = camlPrintf__extract_format_113(local_10,puStack8);
  ...
  case 0x1c2:
    ...
    *pcVar7 = *pcVar7 + cVar11;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d647) = (ulong)(uVar1 + 0x221c7b);
    *(undefined8 *)(piVar6 + 0x10d649) = 0x10f9;
    *(code **)(piVar6 + 0x10d64b) = caml_curry2;
  case 0x1e4:
    *(undefined8 *)(piVar6 + 0x10d64d) = 5;
    *(code **)(piVar6 + 0x10d64f) = camlPrintf__scan_conv_171;
    *(undefined8 *)(piVar6 + 0x10d651) = 0x20f9;
    *(code **)(piVar6 + 0x10d653) = camlPrintf__scan_fmt_172;
    *(undefined8 *)(piVar6 + 0x10d655) = 3;
    *(code ***)(piVar6 + 0x10d657) = in_RAX;
    *(code ***)(piVar6 + 0x10d659) = unaff_RBX;
    *(code ***)(piVar6 + 0x10d65b) = param_1;
    *(uint **)(piVar6 + 0x10d65d) = param_4;
...
code_r0x0041cacc:
  ...
  *(int **)((long)pppcVar14 + 0x20) = piVar6;
  puVar13 = &switchD_0041caef::switchdataD_00435974;
  piVar6 = (int *)(long)(int)(&switchD_0041caef::switchdataD_00435974)[(long)param_1 >> 1];
...

{
  ...
  *(undefined8 *)((long)plVar5 + -8) = 0x41cf21;
  (*pcVar1)(pcVar1);
LAB_0041cf21:
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  unaff_R15[8] = 0x1800;
  *DAT_0064b728 = (undefined *)&camlPrintf__38;
...
LAB_0042484b:
  ...
  if (puVar1 != (ulong *)0x0) goto code_r0x00424855;
  goto LAB_0042485a;
code_r0x00424855:
  if (param_2 <= *puVar1) {
LAB_0042485a:
...
LAB_00424a1b:
    ...
    if (puVar2 != (ulong *)0x0) goto code_r0x00424a25;
    goto LAB_00424a2a;
  }
LAB_00424a40:
...
LAB_00425dfa:
        ...
        while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
          iVar16 = iVar16 + 1;
          if (flp_size <= iVar16) goto LAB_00425dfa;
          plVar13 = *pplVar6;
          pplVar6 = pplVar6 + 1;
      ...
      do {
        do {
          plVar12 = plVar10;
          if (plVar12 == plVar13) goto LAB_00425f7b;
...
LAB_00426f70:
  ...
  if ((uVar3 & 7) != 0) goto code_r0x00427024;
  goto LAB_00427045;
code_r0x00427024:
  ppuVar4 = param_1;
...
LAB_0042dd3e:
    if (0xffffffff < lVar4) goto LAB_0042de27;
  }
...
LAB_0042e7d6:
    if (uVar12 != 0) goto code_r0x0042e7df;
        ...
        if (0 < iVar6) {
          if (*pcVar9 != '\0') {
            ...
            do {
              ...
              if ((iVar6 + -1) - iVar7 < 1) goto LAB_0043068d;
              iVar7 = iVar7 + 1;
            } while (*pcVar9 != '\0');
          }
      ...
      if (bVar1 != 0) {
        if (*pcVar9 != '\0') {
          ...
          do {
            sVar4 = strlen(pcVar9);
            pcVar9 = pcVar9 + sVar4 + 1;
            if (bVar1 - 1 == iVar6) goto LAB_00430792;
            iVar6 = iVar6 + 1;
          } while (*pcVar9 != '\0');
        }
        pcVar9 = "<unknown token>";
...
LAB_00430218:
    ...
    do {
      ...
      if (((-1 < iVar7) && (sVar2 != 0)) && (iVar7 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar8 = (long)iVar7;
        lVar3 = lVar8 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar8 * 2) == 0x100) goto LAB_00430808;
      }
      if (iVar6 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar6 != 0) {
    ...
    if (param_3 < uVar5) goto LAB_0043206a;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_004334ec;
      }
...
LAB_004336ae:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_00433743;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_00433743;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_00433743:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_004336ae;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_0043399b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_0043399b:
