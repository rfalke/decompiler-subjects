...
__size32 caml_raise_out_of_memory(int param1, __size32 param2, __size32 param1)
{
    ...
    __size32 esp_55; 		// r28{154}
    __size32 esp_56; 		// r28{154}
    __size32 esp_57; 		// r28{154}
    ...
    int local116; 		// tmpb{299}
    int local117; 		// tmpb{317}
    ...
    int local124; 		// tmpb{156}
    int local125; 		// tmpb{221}
    int local126; 		// tmpb{171}
    int local127; 		// tmpb{3}
    int local128; 		// tmpb{3}
    __size16 local129; 		// tmph{185}
    ...
    int local153; 		// tmph{268}
    __size16 local154; 		// tmph{335}
    __size16 local155; 		// tmph{283}
    __size16 local156; 		// tmph{157}
    __size16 local157; 		// tmph{318}
    __size16 local158; 		// tmph{300}
    __size16 local159; 		// tmph{185}
    int local16; 		// m[esp_74 - 4]{268}
    __size16 local160; 		// tmph{4}
    __size16 local161; 		// tmph{4}
    unsigned int local162; 		// edx_1{33}
    __size32 local163; 		// esp_55{154}
    int local164; 		// local99{156}
    __size16 local165; 		// local132{157}
    __size32 local166; 		// m[esp_74 - 4]{158}
    __size32 local167; 		// m[esp_74 - 28]{159}
    unsigned int local168; 		// local79{160}
    __size32 local169; 		// esp_52{168}
    __size32 local17; 		// m[esp_74 - 4]{172}
    int local170; 		// local91{171}
    __size32 local171; 		// local8{172}
    __size32 local172; 		// local37{173}
    unsigned int local173; 		// local66{174}
    int local174; 		// eax_1{180}
    union { __size32 *; __size32; } local175; 		// esp_49{197}
    unsigned int local176; 		// esi{199}
    __size32 local177; 		// local7{201}
    __size32 local178; 		// local36{202}
    unsigned int local179; 		// local65{203}
    __size32 local18; 		// m[esp_74 - 4]{172}
    union { __size32 *; unsigned int; } local180; 		// eax{212}
    __size32 local181; 		// esp_71{230}
    int local182; 		// local95{233}
    __size32 local183; 		// local20{234}
    __size32 local184; 		// local47{235}
    unsigned int local185; 		// local80{236}
    unsigned int local186; 		// ebx{255}
    union { __size32 *; __size32; } local187; 		// esp_58{256}
    __size32 local188; 		// local11{260}
    __size32 local189; 		// local40{261}
    __size32 local19; 		// m[esp_74 - 4]{319}
    unsigned int local190; 		// local69{262}
    unsigned int local191; 		// ebx{277}
    __size32 local192; 		// esp_61{278}
    int local193; 		// local98{282}
    __size16 local194; 		// local131{283}
    __size32 local195; 		// local14{284}
    __size32 local196; 		// local43{285}
    unsigned int local197; 		// local72{286}
    __size32 local198; 		// esp_64{295}
    unsigned int local199; 		// edi{298}
    int local2; 		// m[esp - 32]
    __size32 local20; 		// m[esp_74 - 4]{234}
    int local200; 		// local101{299}
    __size16 local201; 		// local134{300}
    __size32 local202; 		// local12{301}
    __size32 local203; 		// local41{302}
    unsigned int local204; 		// local70{303}
    __size32 local205; 		// esp_67{314}
    int local206; 		// local100{317}
    __size16 local207; 		// local133{318}
    __size32 local208; 		// local19{319}
    __size32 local209; 		// local46{320}
    __size32 local21; 		// m[esp_74 - 4]{201}
    unsigned int local210; 		// m[esp_74 - 32]{321}
    __size32 local211; 		// esp_68{331}
    int local212; 		// local97{334}
    __size16 local213; 		// local130{335}
    __size32 local214; 		// local13{336}
    __size32 local215; 		// local42{337}
    unsigned int local216; 		// local71{338}
    __size32 local217; 		// esp{348}
    __size32 local22; 		// m[esp_74 - 4]{201}
    ...
    __size32 local27; 		// m[esp_74 - 4]{301}
    ...
    __size32 local46; 		// m[esp_74 - 28]{320}
    ...
    __size32 local55; 		// m[esp_74 - 28]{173}
    ...
    __size32 local60; 		// m[esp_74 - 28]{235}
    __size32 local61; 		// m[esp_74 - 28]{235}
    ...
    unsigned int local81; 		// m[esp_74 - 32]{236}
...
bb0x8061ce7:
    ...
    local99 = local164;
    local132 = local165;
    *(__size32*)(esp_74 - 4) = local166;
    *(__size32*)(esp_74 - 28) = local167;
    local79 = local168;
    local211 = esp_55;
    local212 = local99;
    local213 = local132;
    ...
    if (*(ebp + 24) != 0) {
        ...
        *(__size32*)(ebp - 28) = 0;
        do {
            ...
            local19 = local208;
            local46 = local209;
            *(unsigned int*)(esp_74 - 32) = local210;
            esi = *esi;
            local211 = esp_67;
            local212 = local100;
            local213 = local133;
...
void caml_final_do_calls(__size32 param3, __size32 param4)
{
    ...
    if ( ~(*0x8082180 != 0 || *0x8082194 == 0)) {
        ecx = caml_gc_message(128, 0x8071cb4); /* Warning: also results in edx, esp */
bb0x806f5a6:
        param3 = local6;
        param4 = local7;
        eax = *0x8082194;
...
__size32 caml_raise(int param1, __size32 param2, __size32 param3, __size32 param4)
{
    ...
    __size32 esp_64; 		// r28{226}
    __size32 esp_65; 		// r28{226}
    __size32 esp_66; 		// r28{226}
    __size32 esp_67; 		// r28{211}
    __size32 esp_68; 		// r28{211}
    __size32 esp_69; 		// r28{211}
    __size32 esp_7; 		// r28{42}
    union { __size32; __size32 *; } esp_70; 		// r28{316}
    union { __size32; __size32 *; } esp_71; 		// r28{316}
    union { __size32; __size32 *; } esp_72; 		// r28{316}
    ...
    int local124; 		// m[esp_92 - 32]{232}
    int local125; 		// m[esp_92 - 32]{232}
    int local126; 		// m[esp_92 - 32]{262}
    ...
    __size32 local226; 		// local52{21}
    __size32 local227; 		// local82{22}
    int local228; 		// local114{23}
    __size32 local229; 		// local12{24}
    __size32 local23; 		// m[esp_92 + 4]{347}
    unsigned int local230; 		// edx_1{90}
    __size32 local231; 		// esp_67{211}
    int local232; 		// local143{213}
    __size16 local233; 		// local188{214}
    ...
    __size32 local59; 		// m[esp_92 - 4]{293}
    int local6; 		// m[esp_92 + 4]{15}
    __size32 local60; 		// m[esp_92 - 4]{230}
    __size32 local61; 		// m[esp_92 - 4]{230}
    ...
    __size32 local98; 		// m[esp_92 - 8]{261}
    __size32 local99; 		// m[esp_92 - 8]{261}
                ...
                do {
                    ...
                    if (*(esi + 8) > 0) {
                        do {
                            ...
                            local107 = local261;
                            eax_9 = ebx * 4 + *(esi + edi * 4 + 12);
                            *(__size32*)(esp_70 + 4) = eax_9;
                            eax_12 = *eax_9;
                            *(__size32*)esp_70 = eax_12;
...
__size32 caml_raise_with_arg(int param1, __size32 param1, __size32 param2, __size32 param3)
{
    ...
    __size32 local326; 		// m[esp_68 - 76]{127}
    __size32 local327; 		// m[esp_68 - 76]{240}
    __size32 local328; 		// m[esp_68 - 76]{279}
    __size32 local329; 		// m[esp_68 - 76]{279}
    ...
    __size32 local333; 		// m[esp_68 - 76]{405}
    ...
    __size32 local535; 		// local326{127}
    ...
    union { __size32 *; __size32; } local559; 		// esp_62{183}
    ...
    __size32 local592; 		// local28{245}
    __size32 local593; 		// local51{246}
    unsigned int local594; 		// ebx{265}
    union { __size32 *; __size32; } local595; 		// esp_49{266}
    ...
    __size32 local648; 		// local27{349}
    __size32 local649; 		// local50{350}
    int local65; 		// m[esp_68 - 4]{218}
    __size32 local650; 		// esp_58{361}
    ...
    __size32 local667; 		// local26{380}
    __size32 local668; 		// local49{381}
    __size32 local669; 		// esp_59{391}
...
__size32 caml_raise_with_string(__size32 param1, __size32 param2)
{
    ...
    __size32 esp_54; 		// r28{84}
    union { __size32; __size32 *; } esp_55; 		// r28{129}
    union { __size32; __size32 *; } esp_56; 		// r28{129}
    ...
    int local0; 		// m[esp - 4]
    int local1; 		// m[esp - 28]
    __size32 local10; 		// m[esp_38 + 8]{171}
    unsigned int local100; 		// m[esp_38 - 32]{237}
    unsigned int local101; 		// m[esp_38 - 32]{90}
    ...
    __size32 local11; 		// m[esp_38 + 8]{277}
    ...
    __size32 local12; 		// m[esp_38 + 8]{222}
    ...
    __size32 local16; 		// m[esp_38 + 8]{277}
    ...
    unsigned int local187; 		// local85{135}
    ...
    __size32 local191; 		// local39{166}
    __size32 local192; 		// local67{167}
    unsigned int local193; 		// local102{168}
    __size32 local194; 		// local10{171}
    ...
    unsigned int local199; 		// local89{195}
    int local2; 		// m[esp - 32]
    ...
    unsigned int local206; 		// local92{219}
    __size32 local207; 		// local12{222}
    ...
    unsigned int local214; 		// local90{237}
    __size32 local215; 		// local14{240}
    __size32 local216; 		// esp{249}
    int local217; 		// local120{252}
    __size16 local218; 		// local146{253}
    __size32 local219; 		// local38{254}
    __size32 local22; 		// m[esp_38 + 8]{3}
    __size32 local220; 		// m[esp_38 - 28]{255}
    unsigned int local221; 		// m[esp_38 - 32]{256}
    __size32 local222; 		// local13{259}
    ...
    unsigned int local228; 		// local91{274}
    __size32 local229; 		// local11{277}
    ...
    __size32 local72; 		// m[esp_38 - 28]{218}
...
__size8 caml_raise_constant(int param1, __size32 param1, __size32 param2)
{
    ...
    __size32 local113; 		// m[esp_50 - 36]{272}
    __size32 local114; 		// m[esp_50 - 36]{272}
    __size32 local115; 		// m[esp_50 - 36]{65}
    ...
    __size32 local133; 		// m[esp_50 - 40]{302}
    __size32 local134; 		// m[esp_50 - 40]{174}
    __size32 local135; 		// m[esp_50 - 40]{211}
    ...
    __size32 local15; 		// m[esp_50 + 4]{103}
    ...
    __size32 local18; 		// m[esp_50 + 4]{257}
    ...
    __size32 local19; 		// m[esp_50 + 4]{257}
    ...
    int local2; 		// m[esp - 44]
    __size32 local20; 		// m[esp_50 + 4]{257}
    ...
    __size32 local21; 		// m[esp_50 + 4]{314}
    ...
    __size32 local22; 		// m[esp_50 + 4]{285}
    ...
    __size32 local29; 		// m[esp_50 + 4]{342}
    ...
    __size32 local475; 		// local53{63}
    __size32 local476; 		// m[esp_50 - 32]{64}
    __size32 local477; 		// local115{65}
    ...
    __size32 local51; 		// m[esp_50 - 4]{270}
    ...
    __size32 local52; 		// m[esp_50 - 4]{270}
    ...
    __size32 local569; 		// local18{257}
    __size32 local57; 		// m[esp_50 - 4]{128}
    ...
    __size32 local58; 		// m[esp_50 - 4]{88}
    ...
    if (*(ebp + 24) != 0) {
        ...
        *(__size32*)(ebp - 28) = 0;
        do {
            ...
            local410 = local589;
            local443 = local590;
            *(__size32*)(esp_50 - 4) = local591;
            local83 = local592;
            *(__size32*)(esp_50 - 36) = local593;
            local133 = local594;
            local166 = local595;
            local196 = local596;
            local224 = local597;
...
__size32 start_cycle()
{
    ...
    ecx = caml_gc_message(1, 0x807112b);
...
__size32 caml_callback_exn()
{
    ...
    *(__size32*)(%esp - 4) = %ebp;
    ...
    (*esi)(local0, caml_last_return_address, caml_bottom_of_stack, 0x807039e, caml_exception_pointer, pc);
...
void caml_fatal_uncaught_exception(__size32 param1, unsigned char param2)
{
    ...
    *(__size32*)(&named_value_table + 100) = 0;
    eax = caml_named_value(0x8071bc7); /* Warning: also results in esp */
    if (eax != 0) {
...
__size32 caml_check_urgent_gc()
{
    ...
    esp_1 = esp_8 - 44;
    *(__size32*)(&caml_globals + 0x9480) = esp_8 - 44;
...
void caml_add_to_heap(unsigned int param1)
{
    ...
    ecx = caml_gc_message(4, 0x807129f); /* Warning: also results in edx */
    eax = param1 + *(param1 - 8);
...
__size8 caml_do_local_roots(__size32 param1, __size32 param2, __size32 param3, unsigned int param4, __size32 param5, __size32 param6, unsigned int param7, unsigned int param8, __size32 param9, unsigned int param10, unsigned int param11)
{
    ...
    unsigned int local115; 		// m[esp_35 - 8]{209}
    unsigned int local116; 		// m[esp_35 - 8]{187}
    ...
    unsigned int local141; 		// m[esp_35 - 12]{39}
    ...
    __size32 local200; 		// m[esp_35 - 32]{120}
    ...
    __size32 local24; 		// m[esp_35 + 8]{235}
    ...
    __size32 local313; 		// local84{37}
    unsigned int local314; 		// m[esp_35 - 8]{38}
    unsigned int local315; 		// local141{39}
    ...
    __size32 local342; 		// local200{120}
    ...
    unsigned int local354; 		// local114{166}
    ...
    unsigned int local367; 		// local116{187}
    ...
    __size32 local378; 		// local85{208}
    unsigned int local379; 		// local115{209}
    unsigned int local38; 		// m[esp_35 + 12]{123}
    unsigned int local380; 		// local142{210}
    ...
    __size32 local84; 		// m[esp_35 - 4]{37}
    __size32 local85; 		// m[esp_35 - 4]{208}
                    ...
                    *(__size32*)(ebp - 36) = ebx;
                    ...
                    for(;;) {
                        ...
                        *(__size32*)(esp_10 + 4) = eax;
                        eax = *eax;
                        *(__size32*)esp_10 = eax;
                        (*ebx)((unsigned char) eax, eax, ecx, edx, ebx, ebp, esi, edi, flags, ZF, CF, param3, param4, param5, local75, local102, local128, local154, local181, local209);
                        local332 = esp_4;
                        local335 = esp_4;
                        local336 = edi;
                        local337 = local236;
                    ...
                    if (*(esi + 8) > 0) {
                        do {
                            ...
                            *(__size32*)esp_22 = eax_12;
                            (**(ebp + 8))((unsigned char) eax_12, eax_12, ecx, edx, ebx, ebp, esi, edi, ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), ADDFLAGS32(ebx * 4, *(esi + edi * 4 + 12), eax_9), param3, param4, param5, local79, local106, local132, local158, local185, local213);
                            local348 = esp_7;
                            local350 = esp_7;
                            local351 = local251;
                            local352 = local285;
...
__size32 caml_delete_global_root(__size32 param1, unsigned int param2, int param3)
{
    unsigned int eax_10; 		// r24{22}
    union { __size32 *; unsigned int; unsigned int * x10; } eax_11; 		// r24{30}
    int eax_14; 		// r24{33}
    int eax_17; 		// r24{36}
    unsigned int eax_19; 		// r24{23}
    int eax_3; 		// r24{35}
    int eax_4; 		// r24{5}
    union { int; unsigned int * x10; int *; } eax_7; 		// r24{10}
    __size32 ecx; 		// r25
    unsigned int edx; 		// r26
    int esi; 		// r30
    int esi_1; 		// r30{9}
    ...
    if ( ~(ecx == 0 || *ecx != param2)) {
        if (eax_4 >= 0) {
            ...
            do {
                ...
                esi = local4;
                edx = *(esp + eax_19 * 4 - 96);
                if (*(edx + eax_19 * 4 + 4) == ecx) {
                    esi = *(ecx + eax_19 * 4 + 4);
                    *(int*)(edx + eax_19 * 4 + 4) = esi;
                }
                eax_11 = eax_19 + 1;
                local3 = eax_11;
                local4 = esi;
            } while (*(param1 + 72) >= eax_19 + 1);
        }
        ...
        eax_14 = *(param1 + 72);
        local5 = eax_14;
        if ( ~(eax_14 <= 0 || *(param1 + eax_14 * 4 + 4) != 0)) {
            do {
                eax_3 = local5;
                eax_17 = eax_3 - 1;
                local5 = eax_17;
