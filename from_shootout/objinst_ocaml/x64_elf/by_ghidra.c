...

{
  ...
  plVar2 = (long *)FUN_0040c534();
  if ((undefined **)*plVar2 == &caml_exn_Failure) {
    plVar2 = (long *)FUN_0040c4b8();
...

{
  ...
  *(undefined8 *)(uVar6 - 8) = unaff_RBX;
  ...
  if (lVar4 == 1) {
    plVar5 = (long *)FUN_0040e0ac();
    if ((undefined **)*plVar5 != &caml_exn_Failure) {
                    // WARNING: Subroutine does not return
      caml_raise_exn();
    }
    plVar5 = (long *)FUN_0040e030();
    ...
    if (lVar4 == 1) {
      ...
      *(undefined8 *)(uVar6 - 0x30) = 0x800;
      *(undefined8 *)(uVar6 - 0x28) = DAT_00648ea8;
      ...
      *(undefined8 *)(uVar7 - 0x28) = DAT_00648ea0;
...

{
  ...
  *camlUnix = camlUnix__64;
  ...
  caml_allocN();
  DAT_00648c68 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_00648c68 = &camlUnix__50;
...

{
  ...
  *DAT_0064cdb0 = camlPervasives__65;
  ...
  caml_allocN();
  DAT_0064cfe8 = unaff_R15 + 1;
  *unaff_R15 = 0x1800;
  *DAT_0064cfe8 = &camlPervasives__7;
  ...
  DAT_0064d030 = unaff_R15 + 8;
  unaff_R15[7] = 0x400;
  *DAT_0064d030 = DAT_0064cf00;
...

{
  ...
  if (uVar2 < 0xbf) {
    ...
    else if (lVar1 - 0x81U < 0x34) goto switchD_0041d20b_caseD_180;
  }
  else {
...
LAB_0041e72c:
    ...
    if (uVar2 != 0x5b) goto LAB_0041e72c;
    unaff_RBX = unaff_RBX + 2;
    in_RAX = 3;
  } while( true );
}
...

{
  ...
  do {
    ...
    uVar2 = (ulong)(int)(&switchD_0041ea7f::switchdataD_0043c7b0)[lVar5 >> 1];
    switch(lVar5) {
    default:
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  DAT_00653c38 = unaff_R15 + 9;
  unaff_R15[8] = 0x1800;
  *DAT_00653c38 = &camlPrintf__38;
  ...
  *DAT_00653ce8 = caml_curry2;
  ...
  ppuVar5 = DAT_00653cc8;
  ppuVar4 = DAT_00653cb0;
  ppuVar3 = DAT_00653ca0;
    ...
    if (puVar9 == (uint *)0x1) {
      ...
      if (0 < iVar5) {
        ...
        while ((uint *)(long)(int)((uint)*ppuVar2 & **ppuVar4) != puVar9) {
          iVar6 = iVar6 + 1;
          if (iVar5 <= iVar6) goto LAB_00429a1f;
...
LAB_00429a7a:
        *plVar13 = (long)*(int *)(speedtable + (long)iVar5 * 8 + 4) * 2 + 1;
        ...
        do {
          if (*psVar10 == sVar7) goto LAB_00429a7a;
          iVar5 = iVar5 + 1;
          psVar10 = psVar10 + 2;
        } while (iVar5 != 0x12);
      }
    ...
    for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
      ...
      while( true ) {
        ...
        *pplVar4 = (long *)((ulong)plVar15 & 0xfffffffffffffc00 | 0x3f3);
        pplVar4 = pplVar4 + ((ulong)plVar15 >> 10) + 1;
        if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar4) goto LAB_0043a5ac;
      }
...
LAB_0043a76e:
          ...
          pplVar13 = pplVar6;
          if (0x20 < uVar17) goto LAB_0043a803;
          pplVar11 = (long **)pplVar6[-1];
          if (0x20 < (ulong)((long)pplVar11[-2] - (long)pplVar11[-3])) goto LAB_0043a803;
          do {
            pplVar6 = pplVar11;
            pplVar11 = (long **)pplVar6[-1];
            pplVar13 = pplVar6;
...
LAB_0043a803:
          ...
          *pplVar4 = (long *)(lVar18 * 0x400 + -0x400 + (ulong)uVar3);
          ...
          uVar3 = (uint)uVar17;
          if ((char)uVar17 == -7) goto LAB_0043a76e;
    ...
    do {
      ...
      for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
        ...
        while (plVar15 = *pplVar4, ((ulong)plVar15 & 0x300) == 0) {
          ...
          pplVar4 = pplVar14;
          if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar14) goto LAB_0043aa5b;
        }
      }
LAB_0043aa5b:
...
undefined  [16] FUN_0043bf5b(undefined8 param_1,undefined8 param_2,undefined8 param_3)
