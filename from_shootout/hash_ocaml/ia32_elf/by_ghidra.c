...
{
  for (; 1 < (int)param_3; param_3 = param_3 >> 4 | 1) {
    param_1 = param_1 + -2;
    *(char *)(DAT_08073cb8 + (param_1 >> 1)) =
...
void FUN_0804cab0(undefined4 param_1,undefined4 param_2)
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0804f085;
    }
    else if (0x74 < uVar2) {
LAB_0804f085:
...

{
  ...
  while (uVar1 = (uint)*(byte *)(*(int *)(unaff_EBX + 8) + (param_1 >> 1)) * 2 + 1, 0x60 < uVar1) {
    if (0x74 < uVar1) goto LAB_08058c60;
    param_1 = param_1 + 2;
  }
  if (uVar1 == 0x49) {
    return param_1 + 2;
...
switchD_0805aa5f_caseD_b2:
    ...
    case 0x1de:
    case 0x1e0:
      goto switchD_0805acfd_caseD_40;
    case 0x1b0:
    case 0x1b2:
    case 0x1b6:
    case 0x1b8:
    ...
    case 0x1c6:
    case 0x1cc:
      goto switchD_0805acfd_caseD_42;
    case 0x1c2:
...
LAB_0806639d:
        ...
        else if ((cStack_55 != 'u') && (cStack_55 != 'x')) goto LAB_0806639d;
      }
      sprintf(pcVar6,acStack_34);
LAB_080663b2:
      ppcVar3 = (code **)caml_copy_string();
...
LAB_0806093f:
          ...
          do {
            if ((int)*param_3 >> 1 == (&DAT_080710e4)[iVar1 * 2]) goto LAB_0806093f;
            iVar1 = iVar1 + 1;
          } while (iVar1 != 0x12);
          unix_error(0x16,"tcsetattr",0);
...
LAB_08060b51:
      ...
      *piVar8 = 0x4b01;
      ...
      if (sVar6 == 1) {
        iVar3 = 0;
LAB_08060ba4:
        *piVar8 = (&DAT_080710e4)[iVar3 * 2] * 2 + 1;
      }
      else {
        do {
          if ((&speedtable)[iVar3 * 2] == sVar6) goto LAB_08060ba4;
          iVar3 = iVar3 + 1;
        } while (iVar3 != 0x12);
      }
    }
...
LAB_0806336b:
        ...
        do {
          ...
          if (999 < flp_size) {
            ...
            while( true ) {
              ...
              puVar10 = puVar2;
              if ((*(uint *)(*DAT_0807fb7c + -4) >> 10 <= (uint)puVar2[-1] >> 10) &&
    ...
    piVar8 = (int *)(&DAT_0807ebe4)[iVar13];
    iVar5 = 0;
    piVar9 = (&flp)[iVar13];
    do {
      do {
...
LAB_08063551:
    if (flp_size + -1 + iVar5 < 0x3e9) {
      if ((iVar5 == 1) ||
         (memmove(&flp + iVar5 + iVar13,&DAT_0807ebe4 + iVar13,((flp_size + -1) - iVar13) * 4),
         0 < iVar5)) {
    ...
    if (iVar5 + iVar13 < 1000) {
      if ((iVar5 == 1) ||
         (memmove(&flp + iVar5 + iVar13,&DAT_0807ebe4 + iVar13,((1000 - iVar13) - iVar5) * 4),
         0 < iVar5)) {
        memmove(&flp + iVar13,local_fbc,iVar5 << 2);
      }
    }
...

{
  ...
  if (caml_young_ptr != caml_young_end) {
    ...
    if (caml_ref_table < DAT_0807fbc8) {
      do {
        caml_oldify_one(*(undefined4 *)*puVar4,(undefined4 *)*puVar4);
        puVar4 = puVar4 + 1;
      } while (puVar4 < DAT_0807fbc8);
    }
    caml_oldify_mopup();
    ppuVar3 = caml_weak_ref_table;
    if (caml_weak_ref_table < DAT_0807fbe4) {
      do {
        puVar1 = *ppuVar3;
        puVar2 = (uint *)*puVar1;
  ...
  *param_1 = param_2;
  if ((*(byte *)((&caml_page_table)[(uint)param_1 >> 0x17] + ((uint)param_1 >> 0xc & 0x7ff)) & 1) !=
    ...
    if (((((param_2 & 1) == 0) && (param_2 < caml_young_end)) && (caml_young_start < param_2)) &&
      ...
      if (_DAT_0807fbcc <= DAT_0807fbc8) {
        caml_realloc_ref_table(&caml_ref_table);
      }
      *DAT_0807fbc8 = param_1;
      DAT_0807fbc8 = DAT_0807fbc8 + 1;
    }
  }
  return;
}
...

{
  ...
  local_5c = 1;
  local_54 = &local_40;
  pcStack_80 = (code *)0x806b9ee;
  piVar3 = __errno_location();
  pcStack_80 = (code *)0x806b9f8;
  pcStack_84 = strerror(*piVar3);
  if (param_1 == (void *)0x1) {
    pcStack_80 = (code *)0x806ba0a;
...

{
  ...
  if ((((param_1 & 1) == 0) && (iVar1 = 0x7d5, (param_1 & 3) == 0)) &&
     (iVar1 = 0x7d3,
     (*(byte *)((&caml_page_table)[param_1 >> 0x17] + (param_1 >> 0xc & 0x7ff)) & 7) != 0)) {
...
{
  if (((((uint)param_1 & 1) == 0) &&
      ((*(byte *)((&caml_page_table)[(uint)param_1 >> 0x17] + ((uint)param_1 >> 0xc & 0x7ff)) & 7)
       != 0)) && (*(char *)(param_1 + -1) == -6)) {
...

{
  ...
  uVar1 = *local_30;
  *local_30 = param_1;
  if ((*(byte *)((&caml_page_table)[(uint)local_30 >> 0x17] + ((uint)local_30 >> 0xc & 0x7ff)) & 1)
      != 0) {
    if (caml_gc_phase == 0) {
      caml_darken(uVar1,0);
    }
...
undefined4 * caml_obj_block(int param_1,int param_2)

{
  ...
  puVar1 = &DAT_08083244 + (param_1 >> 1);
  uVar3 = param_2 >> 1;
  if (uVar3 != 0) {
    puVar1 = (undefined4 *)caml_alloc(uVar3,param_1 >> 1);
    uVar2 = 0;
    do {
      puVar1[uVar2] = 1;
      uVar2 = uVar2 + 1;
  ...
  if ((((param_3 & 1) == 0) && (param_3 < caml_young_end)) && (caml_young_start < param_3)) {
    ...
    *puVar1 = param_3;
    if ((((uVar2 & 1) != 0) || (caml_young_end <= uVar2)) || (uVar2 <= caml_young_start)) {
      if (_DAT_0807fbe8 <= DAT_0807fbe4) {
        caml_realloc_ref_table(&caml_weak_ref_table);
      }
      *DAT_0807fbe4 = puVar1;
      DAT_0807fbe4 = DAT_0807fbe4 + 1;
    }
  }
  else {
