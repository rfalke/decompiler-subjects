...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_006412e0 = (undefined *)&camlUnix__50;
...

{
  ...
  *unaff_R15 = 0x1800;
  *DAT_00645660 = (undefined *)&camlPervasives__7;
  ...
  unaff_R15[7] = 0x400;
  *DAT_006456a8 = (undefined *)DAT_00645578;
...

{
  ...
  *puVar9 = uVar4;
  ...
  if (in_RAX <= (long)uVar1) {
    ...
    *(undefined8 *)(uVar7 - 0x18) = 0x800;
    *(undefined8 *)(uVar7 - 0x10) = DAT_00646d48;
...

{
  ...
  plVar4 = (long *)FUN_00411f04();
  if (*plVar4 != DAT_00646d48) {
                    // WARNING: Subroutine does not return
    caml_raise_exn();
  }
  uVar1 = plVar4[1];
...

{
  ...
  if (in_RAX != 0xb9) {
    ...
    case 0x1c:
      bVar2 = (byte)uVar1 - 2;
      bVar7 = 1 < (byte)uVar1 || CARRY1(bVar2,0xffbcad0f < uVar1);
      auStack16 = 0x4352f9;
...
LAB_0041ad90:
    ...
    if (uVar3 == 0) goto LAB_0041ada4;
    if (uVar3 == 1) goto LAB_0041ad90;
    if (1 < (long)uVar3) goto LAB_0041adcc;
  }
  if (uVar3 != 1) {
LAB_0041adcc:
...

{
  ...
  do {
    ...
    uVar2 = SEXT48((int)(&switchD_0041b7ff::switchdataD_00435510)[lVar5 >> 1]);
    switch(lVar5) {
    default:
...
code_r0x0041ce4b:
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar11;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d5e7) = (ulong)(iVar1 + 0x221ddb);
...
code_r0x0041c94c:
  ...
  *(int **)((long)pppcVar14 + 0x20) = piVar6;
  puVar13 = &switchD_0041c96f::switchdataD_004357f4;
  piVar6 = (int *)(long)(int)(&switchD_0041c96f::switchdataD_004357f4)[(long)param_1 >> 1];
...

{
  ...
  *unaff_R15 = 0xcf7;
  ...
  unaff_R15[8] = 0x1800;
  *DAT_0064b628 = (undefined *)&camlPrintf__38;
...
LAB_004246cb:
  ...
  if (puVar1 != (ulong *)0x0) goto code_r0x004246d5;
  goto LAB_004246da;
code_r0x004246d5:
  if (param_2 <= *puVar1) {
LAB_004246da:
...
LAB_0042489b:
    ...
    if (puVar2 != (ulong *)0x0) goto code_r0x004248a5;
    goto LAB_004248aa;
  }
LAB_004248c0:
...
LAB_00425c7a:
        ...
        while (uVar15 = uVar15 >> 10, uVar15 < param_1) {
          iVar16 = iVar16 + 1;
          if (flp_size <= iVar16) goto LAB_00425c7a;
          plVar13 = *pplVar6;
          pplVar6 = pplVar6 + 1;
      ...
      do {
        do {
          plVar12 = plVar10;
          if (plVar12 == plVar13) goto LAB_00425dfb;
...
LAB_00426df0:
  ...
  if ((uVar3 & 7) != 0) goto code_r0x00426ea4;
  goto LAB_00426ec5;
code_r0x00426ea4:
  ppuVar4 = param_1;
...
LAB_0042dbbe:
    if (0xffffffff < lVar4) goto LAB_0042dca7;
  }
...
LAB_0042e656:
    if (uVar12 != 0) goto code_r0x0042e65f;
        ...
        if (0 < iVar6) {
          if (*pcVar9 != '\0') {
            ...
            do {
              ...
              if ((iVar6 + -1) - iVar7 < 1) goto LAB_0043050d;
              iVar7 = iVar7 + 1;
            } while (*pcVar9 != '\0');
          }
      ...
      if (bVar1 != 0) {
        if (*pcVar9 != '\0') {
          ...
          do {
            sVar4 = strlen(pcVar9);
            pcVar9 = pcVar9 + sVar4 + 1;
            if (bVar1 - 1 == iVar6) goto LAB_00430612;
            iVar6 = iVar6 + 1;
          } while (*pcVar9 != '\0');
        }
        pcVar9 = "<unknown token>";
...
LAB_00430098:
    ...
    do {
      ...
      if (((-1 < iVar7) && (sVar2 != 0)) && (iVar7 <= (int)(*(long *)(param_1 + 0x50) >> 1))) {
        lVar8 = (long)iVar7;
        lVar3 = lVar8 * 2;
        if (*(short *)(*(long *)(param_1 + 0x60) + lVar8 * 2) == 0x100) goto LAB_00430688;
      }
      if (iVar6 != 0) {
...

{
  ...
  *(int *)(param_1 + 0x14) = iVar4 + (int)(param_3 >> 0x1d);
  if (uVar6 != 0) {
    ...
    if (param_3 < uVar5) goto LAB_00431eea;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_0043336c;
      }
...
LAB_0043352e:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_004335c3;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_004335c3;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_004335c3:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_0043352e;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_0043381b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_0043381b:
