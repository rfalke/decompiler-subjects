...

{
  ...
  iVar3 = caml_c_call();
  while (param_3 < iVar1) {
    *(int *)(iVar2 + -2 + param_3 * 2) = param_3;
    *(int *)(iVar2 + -2 + (param_3 + 2) * 2) = param_3 + 2;
    *(int *)(iVar2 + -2 + (param_3 + 4) * 2) = param_3 + 4;
    *(int *)(iVar2 + -2 + (param_3 + 6) * 2) = param_3 + 6;
    *(int *)(iVar2 + -2 + (param_3 + 8) * 2) = param_3 + 8;
    *(int *)(iVar2 + -2 + (param_3 + 10) * 2) = param_3 + 10;
    *(int *)(iVar2 + -2 + (param_3 + 0xc) * 2) = param_3 + 0xc;
    *(int *)(iVar2 + -2 + (param_3 + 0xe) * 2) = param_3 + 0xe;
    *(int *)(iVar2 + -2 + (param_3 + 0x10) * 2) = param_3 + 0x10;
    *(int *)(iVar2 + -2 + (param_3 + 0x12) * 2) = param_3 + 0x12;
