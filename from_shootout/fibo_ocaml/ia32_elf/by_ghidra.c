  ...
  *(undefined4 *)(uVar3 - 4) = local_14;
  ...
  if (iVar7 == 1) {
    ...
    if (iVar7 == 1) {
      ...
      *(undefined4 *)(uVar3 - 0x10) = 0x8073a10;
      piVar9 = (int *)(uVar3 - 8);
      *(undefined4 *)(uVar3 - 0xc) = 0x800;
      ...
      *(undefined4 *)(uVar3 - 4) = 1;
      ...
      caml_young_ptr = uVar4;
      *puVar2 = 0x800;
      *puVar10 = DAT_08072ecc;
      *(undefined4 *)(uVar3 - 0x10) = 0x8073a20;
      piVar9 = (int *)(uVar3 - 8);
      *(undefined4 *)(uVar3 - 0xc) = 0x800;
      *(undefined4 **)piVar9 = puVar10;
      *(undefined4 *)(uVar3 - 4) = 1;
...

{
  ...
  *(undefined4 *)(uVar4 - 4) = uVar3;
  caml_modify(DAT_0807564c,puVar1);
  return 1;
}
...

{
  ...
  _DAT_0807550c = puVar1 + 1;
  *puVar1 = 0x400;
  *_DAT_0807550c = 0x8075ac4;
  ...
  *_DAT_08075628 = 0x8075694;
  ...
  puVar1[7] = 0x400;
  *(undefined ***)DAT_0807564c = DAT_080755b4;
...

{
  ...
  *piVar1 = iVar5;
  ...
  if (DAT_0807833c < *piVar1) {
    if (DAT_0807833c < *(int *)(iVar4 + 4) + -1 + unaff_EBX) {
...

{
  ...
  if ((in_ECX < 1) || (DAT_0807833c < in_ECX)) {
    camlPervasives__invalid_arg_1012();
  }
...

{
  ...
  *puVar4 = 0xcf7;
  ...
  puVar4[8] = 0x1800;
  *(undefined4 *)UINT_0807951c = 0x8079790;
  *(code ***)(puVar4 + 10) = ppcVar1;
  puVar4[0xb] = uVar3;
  *(undefined4 **)(puVar4 + 0xc) = puVar4 + 1;
  puVar4[0xd] = 0x8079780;
