...

{
  ...
  plVar2 = (long *)FUN_0040a954();
  if ((undefined **)*plVar2 == &caml_exn_Failure) {
    plVar2 = (long *)FUN_0040a8d8();
...

{
  ...
  *(undefined8 *)(uVar6 - 8) = unaff_RBX;
  ...
  if (lVar4 == 1) {
    plVar5 = (long *)FUN_0040c4cc();
    if ((undefined **)*plVar5 != &caml_exn_Failure) {
                    // WARNING: Subroutine does not return
      caml_raise_exn();
    }
    plVar5 = (long *)FUN_0040c450();
...

{
  ...
  do {
    ...
    if (uVar2 < 0x61) {
      if (uVar2 != 0x5b) goto LAB_0040f6a2;
    }
    else if (0x74 < uVar2) {
LAB_0040f6a2:
...

{
  ...
  if (in_RAX != 0xb9) {
    lVar7 = in_RAX >> 1;
    uVar8 = (ulong)(int)(&switchD_00416664::caseD_1c)[lVar7];
    switch(in_RAX) {
    case 0x10:
    case 0x11:
      return &camlChar__8;
    ...
    case 0x1c:
      ...
      bVar11 = *pcVar1 != '\0' || CARRY1(*pcVar1 - 1U,0xffffffffffbcadcf < uVar8);
      *pcVar1 = (*pcVar1 - 1U) + (0xffffffffffbcadcf < uVar8);
      pcVar1 = (char *)(param_2 + in_RAX * 8);
      ...
      *(int *)(&UNK_00435226 + (long)(&stack0x00000000 + uVar8)) =
           *(int *)(&UNK_00435226 + (long)(&stack0x00000000 + uVar8)) + 1;
      (**(code **)(uVar8 + 0x14))();
  ...
  *plVar1 = 1;
  ...
  if (0 < lVar8) {
    ...
    do {
      ...
      if (uVar6 < 0x1d) {
        if (uVar6 < 0x17) {
          if (0x10 < uVar6) goto LAB_00416ef8;
          goto LAB_00416ece;
        }
        if (uVar6 < 0x1b) goto LAB_00416ece;
LAB_00416ef8:
        lVar5 = 5;
      }
      else {
        if ((uVar6 == 0x45) || (uVar6 == 0xb9)) goto LAB_00416ef8;
LAB_00416ece:
        lVar5 = caml_c_call();
        if (lVar5 == 1) {
          lVar5 = 9;
...
switchD_00417010_caseD_0:
      ...
      case 0x1a:
        ...
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x72;
        break;
      default:
        if (lVar7 - 0x45U < 0x72) goto switchD_00417010_caseD_0;
        *(undefined *)(lVar5 + (*plVar1 >> 1)) = 0x5c;
        *plVar1 = *plVar1 + 2;
        *(char *)(lVar5 + (*plVar1 >> 1)) = (char)uVar6;
      }
...

{
  ...
  while (uVar1 = (ulong)*(byte *)(*(long *)(unaff_RBX + 0x10) + (in_RAX >> 1)) * 2 + 1, 0x60 < uVar1
    ...
    if (0x74 < uVar1) goto LAB_0041ac24;
    in_RAX = in_RAX + 2;
  }
  if (uVar1 == 0x49) {
    return in_RAX + 2;
...
LAB_0041b3dc:
    ...
    if (uVar2 != 0x5b) goto LAB_0041b3dc;
    unaff_RBX = unaff_RBX + 2;
    in_RAX = 3;
  } while( true );
}
...

{
  ...
  do {
    ...
    uVar2 = (ulong)(int)(&switchD_0041b72f::switchdataD_00435450)[lVar5 >> 1];
    switch(lVar5) {
    default:
...
switchD_0041ba04_caseD_42:
  ...
  uVar1 = (&switchD_0041ba04::caseD_1f0)[lVar2 + -0x3f >> 1];
...
code_r0x0041cd7b:
  ...
  case 0x11a:
  case 0x15a:
    ppcStack_20 = (code **)0x41ca84;
    local_18 = (code **)camlPrintf__get_arg_320();
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41cab5;
      (***(code ***)(DAT_0064b5a8 + 0x10))();
    }
  ...
  case 0x136:
    *(char *)((long)piVar6 + -0x75) =
    ...
    return uVar5;
  case 0x15c:
    ppcStack_20 = (code **)0x41ca1f;
    local_10 = (code **)camlPrintf__get_arg_320(piVar6[0x14]);
    if (param_7 == 1) {
      ppcStack_20 = (code **)0x41ca51;
      (***(code ***)(DAT_0064b5a8 + 0x10))();
    }
  ...
  case 0x1aa:
    if (in_RAX == (code **)0xc7) {
      ppcStack_20 = (code **)0x41cbdb;
      local_18 = (code **)camlString__make_66();
    }
    else {
      ppcStack_20 = (code **)0x41cbec;
      camlChar__escaped_66();
      ppcStack_20 = (code **)0x41cbf8;
      camlPervasives___5e_136();
      ppcStack_20 = (code **)0x41cc07;
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar12;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d5b7) = (ulong)(uVar1 + 0x221e9b);
...
code_r0x0041c87c:
  ...
  *(int **)((long)pppcVar15 + 0x20) = piVar6;
  puVar14 = &switchD_0041c89f::switchdataD_00435734;
...
switchD_0041ba04_caseD_1ae:
  ppcStack_20 = (code **)0x41cee1;
  local_18 = (code **)camlPrintf__get_arg_320(param_1);
  ppcStack_20 = (code **)0x41cf01;
  uVar5 = camlPrintf__extract_format_113(local_10,uStack_8);
  ppcStack_20 = (code **)0x41cf14;
  local_18 = (code **)caml_c_call(uVar5,local_18);
LAB_0041cfab:
  if (param_7 == 1) {
    ppcStack_20 = (code **)0x41cfd9;
    (***(code ***)(DAT_0064b5a8 + 0x10))();
  }
    ...
    if (puVar9 == (uint *)0x1) {
      ...
      if (0 < iVar5) {
        ...
        while ((uint *)(long)(int)((uint)*ppuVar2 & **ppuVar4) != puVar9) {
          iVar6 = iVar6 + 1;
          if (iVar5 <= iVar6) goto LAB_00422cdf;
          ppuVar3 = ppuVar10 + 6;
          ppuVar10 = ppuVar10 + 1;
          puVar9 = *ppuVar3;
        }
...
LAB_00422d3a:
        *plVar12 = (long)(int)(&UINT_00435e44)[(long)iVar5 * 2] * 2 + 1;
        ...
        do {
          if (*puVar9 == uVar7) goto LAB_00422d3a;
          iVar5 = iVar5 + 1;
          puVar9 = puVar9 + 2;
        } while (iVar5 != 0x12);
      }
...
LAB_00429057:
    ...
    if (pcVar8 == param_1 + lVar6) {
      if (iVar9 == 10) {
        if (uVar3 <= (ulong)(1L << ((byte)param_2 - 1 & 0x3f))) goto LAB_00429084;
      }
    ...
    for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
      ...
      while( true ) {
        ...
        *pplVar4 = (long *)((ulong)plVar15 & 0xfffffffffffffc00 | 0x3f3);
        pplVar4 = pplVar4 + ((ulong)plVar15 >> 10) + 1;
        if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar4) goto LAB_0043329c;
      }
...
LAB_0043345e:
          ...
          pplVar13 = pplVar6;
          if (0x20 < uVar17) goto LAB_004334f3;
          pplVar11 = (long **)pplVar6[-1];
          if (0x20 < (ulong)((long)pplVar11[-2] - (long)pplVar11[-3])) goto LAB_004334f3;
          do {
            pplVar6 = pplVar11;
            pplVar11 = (long **)pplVar6[-1];
            pplVar13 = pplVar6;
...
LAB_004334f3:
          ...
          *pplVar4 = (long *)(lVar18 * 0x400 + -0x400 + (ulong)uVar3);
          ...
          uVar3 = (uint)uVar17;
          if ((char)uVar17 == -7) goto LAB_0043345e;
    ...
    do {
      ...
      for (pplVar4 = pplVar9; pplVar4 < (long **)((long)pplVar9 + (long)plVar1);
        ...
        while (plVar15 = *pplVar4, ((ulong)plVar15 & 0x300) == 0) {
          ...
          pplVar4 = pplVar14;
          if ((long **)((long)pplVar9 + (long)plVar1) <= pplVar14) goto LAB_0043374b;
        }
      }
LAB_0043374b:
...
undefined  [16] FUN_00434c4b(undefined8 param_1,undefined8 param_2,undefined8 param_3)
