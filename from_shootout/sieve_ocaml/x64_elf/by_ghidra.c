...

{
  ...
  if (in_RAX != 0xb9) {
    ...
    case 0x1c:
      bVar2 = (byte)uVar1 - 2;
      bVar7 = 1 < (byte)uVar1 || CARRY1(bVar2,0xffbcacaf < uVar1);
      auStack16 = 0x435359;
...

{
  ...
  do {
    ...
    uVar2 = SEXT48((int)(&switchD_0041b85f::switchdataD_00435570)[lVar5 >> 1]);
    switch(lVar5) {
    default:
...
LAB_0041cd3b:
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar11;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d5ff) = (ulong)(iVar1 + 0x221d73);
...
code_r0x0041c9ac:
  ...
  *(int **)((long)pppcVar14 + 0x20) = piVar6;
  puVar13 = &switchD_0041c9cf::switchdataD_00435854;
    ...
    while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
      while( true ) {
        ...
        *pplVar3 = (long *)((ulong)plVar14 & 0xfffffffffffffc00 | 0x3f3);
        ...
        if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar3) goto LAB_004333cc;
      }
...
LAB_0043358e:
          ...
          pplVar12 = pplVar5;
          if ((long *)0x20 < plVar10) goto LAB_00433623;
          pplVar15 = (long **)pplVar5[-1];
          if ((long *)0x20 < (long *)((long)pplVar15[-2] - (long)pplVar15[-3])) goto LAB_00433623;
          do {
            pplVar5 = pplVar15;
            pplVar15 = (long **)pplVar5[-1];
            pplVar12 = pplVar5;
...
LAB_00433623:
          ...
          *pplVar3 = (long *)(lVar17 * 0x400 + -0x400 + (ulong)uVar2);
          ...
          uVar2 = (uint)uVar16;
          if ((char)uVar16 == -7) goto LAB_0043358e;
    ...
    do {
      ...
      while (pplVar3 < (long **)((long)pplVar8 + (long)plVar1)) {
        while (plVar14 = *pplVar3, ((ulong)plVar14 & 0x300) == 0) {
          ...
          pplVar3 = pplVar13;
          if ((long **)((long)pplVar8 + (long)plVar1) <= pplVar13) goto LAB_0043387b;
        }
        pplVar3 = pplVar3 + ((ulong)plVar14 >> 10) + 1;
      }
LAB_0043387b:
