...

{
  ...
  if ((*(ulong *)(camlSys + -8) >> 9 | 1) < 4) {
    ...
    lStack_18 = caml_c_call(*(undefined8 *)(camlSys + 8));
  }
  lVar5 = lStack_18 + -2;
  lVar1 = caml_c_call(lStack_18,1);
  lVar2 = caml_c_call(lStack_18,1);
  lVar6 = 1;
  if (0 < lVar5) {
    do {
...
code_r0x0041cd8b:
  ...
  case 0x1c2:
    ...
    *pcVar8 = *pcVar8 + cVar12;
    ...
    return uVar5;
  case 0x1e2:
    *(ulong *)(piVar6 + 0x10d5b7) = (ulong)(uVar1 + 0x221e7b);
...
code_r0x0041dcd9:
    *unaff_RBX = pcVar10;
    ...
    return uVar5;
  case 0x1ea:
    pcVar10 = (code *)(ulong)(uVar1 + 0x221d77);
