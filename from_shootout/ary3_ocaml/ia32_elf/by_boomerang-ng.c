...
__size32 caml_raise_out_of_memory(int param1, __size32 param2, __size32 param1)
{
    ...
    union { __size32; __size32 *; } esp_74; 		// r28{197}
    ...
    __size32 local179; 		// esp_55{230}
    __size32 local18; 		// m[esp_50 - 4]{201}
    ...
    union { __size32 *; __size32; } local185; 		// esp_49{256}
    ...
    __size32 local23; 		// m[esp_50 - 4]{336}
    __size32 local24; 		// m[esp_50 - 4]{336}
    ...
    __size32 local31; 		// m[esp_50 - 4]{234}
    __size32 local32; 		// m[esp_50 - 4]{234}
    ...
    __size32 local46; 		// m[esp_50 - 28]{337}
    __size32 local47; 		// m[esp_50 - 28]{337}
    ...
    __size32 local54; 		// m[esp_50 - 28]{159}
    __size32 local55; 		// m[esp_50 - 28]{302}
    __size32 local56; 		// m[esp_50 - 28]{302}
    __size32 local57; 		// m[esp_50 - 28]{202}
    ...
    unsigned int local77; 		// m[esp_50 - 32]{236}
    unsigned int local78; 		// m[esp_50 - 32]{286}
    unsigned int local79; 		// m[esp_50 - 32]{286}
    __size32 local8; 		// m[esp_50 - 4]{172}
    unsigned int local80; 		// m[esp_50 - 32]{321}
    unsigned int local81; 		// m[esp_50 - 32]{203}
    unsigned int local82; 		// m[esp_50 - 32]{203}
    unsigned int local83; 		// m[esp_50 - 32]{338}
    unsigned int local84; 		// m[esp_50 - 32]{338}
    unsigned int local85; 		// m[esp_50 - 32]{262}
    unsigned int local86; 		// m[esp_50 - 32]{262}
...
bb0x8061b37:
    ...
    local97 = local162;
    local130 = local163;
    *(__size32*)(esp_50 - 4) = local164;
    local54 = local165;
    *(unsigned int*)(esp_50 - 32) = local166;
    local209 = esp_58;
    local210 = local97;
    local211 = local130;
    local212 = *(esp_50 - 4);
...
void caml_final_do_calls(__size32 param3, __size32 param4)
{
    ...
    if ( ~(*0x80820a0 != 0 || *0x80820b4 == 0)) {
        ecx = caml_gc_message(128, 0x8071b14); /* Warning: also results in edx, esp */
bb0x806f3f6:
        param3 = local6;
        param4 = local7;
        eax = *0x80820b4;
...
__size32 caml_raise(int param1, __size32 param2, __size32 param3, __size32 param4)
{
    ...
    int local121; 		// m[esp_92 - 32]{401}
    int local122; 		// m[esp_92 - 32]{401}
    ...
    int local133; 		// m[esp_92 - 32]{346}
    int local134; 		// m[esp_92 - 32]{346}
    ...
    __size16 local222; 		// tmph{214}
    __size32 local223; 		// ebx{17}
    union { __size32 *; __size32; } local224; 		// esp_71{18}
    __size32 local225; 		// local49{21}
    __size32 local226; 		// local87{22}
    int local227; 		// local119{23}
    __size32 local228; 		// local12{24}
    unsigned int local229; 		// edx_1{90}
    __size32 local23; 		// m[esp_92 + 4]{347}
    __size32 local230; 		// esp_83{211}
    int local231; 		// local144{213}
    __size16 local232; 		// local189{214}
    __size32 local233; 		// m[esp_92 - 4]{215}
    __size32 local234; 		// m[esp_92 - 8]{216}
    int local235; 		// m[esp_92 - 32]{217}
    __size32 local236; 		// local18{218}
    __size32 local237; 		// esp_80{226}
    int local238; 		// local135{229}
    __size32 local239; 		// local39{230}
    __size32 local24; 		// m[esp_92 + 4]{233}
    __size32 local240; 		// local74{231}
    int local241; 		// local105{232}
    __size32 local242; 		// local11{233}
    int local243; 		// eax_1{239}
    union { __size32 *; __size32; } local244; 		// esp_74{256}
    unsigned int local245; 		// esi{258}
    __size32 local246; 		// local38{260}
    __size32 local247; 		// local73{261}
    int local248; 		// local104{262}
    union { __size32 *; unsigned int; } local249; 		// eax{271}
    __size32 local25; 		// m[esp_92 + 4]{233}
    __size32 local250; 		// esp_77{289}
    int local251; 		// local140{292}
    __size32 local252; 		// local50{293}
    __size32 local253; 		// local88{294}
    int local254; 		// local120{295}
    __size32 local255; 		// local15{296}
    unsigned int local256; 		// ebx{315}
    union { __size32 *; __size32; } local257; 		// esp_86{316}
    __size32 local258; 		// local42{320}
    __size32 local259; 		// local77{321}
    __size32 local26; 		// m[esp_92 + 4]{24}
    int local260; 		// local108{322}
    unsigned int local261; 		// ebx{337}
    __size32 local262; 		// esp_89{338}
    int local263; 		// local143{342}
    __size16 local264; 		// local188{343}
    __size32 local265; 		// local45{344}
    __size32 local266; 		// local80{345}
    int local267; 		// local111{346}
    __size32 local268; 		// local17{347}
    __size32 local269; 		// esp_64{356}
    __size32 local27; 		// m[esp_92 + 4]{24}
    unsigned int local270; 		// edi{359}
    int local271; 		// local146{360}
    __size16 local272; 		// local191{361}
    __size32 local273; 		// local43{362}
    __size32 local274; 		// local78{363}
    int local275; 		// local109{364}
    __size32 local276; 		// local19{365}
    __size32 local277; 		// esp_67{376}
    int local278; 		// local145{379}
    __size16 local279; 		// local190{380}
    __size32 local28; 		// m[esp_92 + 4]{296}
    __size32 local280; 		// local48{381}
    __size32 local281; 		// local90{382}
    int local282; 		// local118{383}
    __size32 local283; 		// m[esp_92 + 4]{384}
    __size32 local284; 		// esp_68{394}
    int local285; 		// local142{397}
    __size16 local286; 		// local187{398}
    __size32 local287; 		// local44{399}
    __size32 local288; 		// local79{400}
    int local289; 		// local110{401}
    __size32 local29; 		// m[esp_92 + 4]{296}
    __size32 local290; 		// local16{402}
    __size32 local291; 		// esp{408}
    int local3; 		// m[esp - 32]
    ...
    __size32 local60; 		// m[esp_92 - 4]{230}
    __size32 local61; 		// m[esp_92 - 4]{21}
    __size32 local62; 		// m[esp_92 - 4]{21}
    __size32 local63; 		// m[esp_92 - 4]{260}
    __size32 local64; 		// m[esp_92 - 4]{260}
    ...
    __size32 local90; 		// m[esp_92 - 8]{382}
    ...
    __size32 local97; 		// m[esp_92 - 8]{345}
...
bb0x8061b37:
    ...
    local144 = local231;
    local189 = local232;
    *(__size32*)(esp_92 - 4) = local233;
    *(__size32*)(esp_92 - 8) = local234;
    *(esp_92 - 32) = local235;
    local18 = local236;
    local284 = esp_83;
    local285 = local144;
...
__size32 start_cycle()
{
    ...
    ecx = caml_gc_message(1, 0x8070f8b);
...
__size32 caml_callback_exn()
{
    ...
    *(__size32*)(%esp - 4) = %ebp;
    ...
    (*esi)(local0, caml_last_return_address, caml_bottom_of_stack, 0x80701ee, caml_exception_pointer, pc);
...
void caml_fatal_uncaught_exception(__size32 param1, unsigned char param2)
{
    ...
    *(__size32*)(&named_value_table + 100) = 0;
    eax = caml_named_value(0x8071a27); /* Warning: also results in esp */
    if (eax != 0) {
...
void caml_add_to_heap(unsigned int param1)
{
    ...
    ecx = caml_gc_message(4, 0x80710ff); /* Warning: also results in edx */
    eax = param1 + *(param1 - 8);
