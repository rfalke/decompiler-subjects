...
int32_t function_11538(void);
int32_t function_11574(void);
int32_t function_115b8(void);
int32_t function_11620(void);
...
int32_t function_11454(void) {
    // 0x11454
    int32_t v1; // 0x11454
    return function_113e0(v1, &g3, &g4);
}
...
int32_t function_11470(void) {
    // 0x11470
    int32_t v1; // 0x11470
    return function_113e0(v1, &g3, &g4) == 0;
}

// Address range: 0x11498 - 0x11508
int32_t function_11498(void) {
    uint32_t v1 = g3; // 0x114a0
    if (v1 == 0) {
        // 0x114fc
        return fflush(NULL);
    }
    uint32_t v2 = g4 - 4; // 0x114b4
    if (v1 >= v2 != v1 != v2) {
        int32_t v3 = g4 - 8; // 0x114c4
        while (v1 == v3 || v1 < v3) {
            // 0x114c8
            v3 -= 4;
        }
...
int32_t function_11648(int32_t a1, int32_t a2, int32_t wstr) {
    ...
    *mem2 = v4;
    ...
    int32_t v7 = g6 + 1; // 0x11700
    g6 = v7;
    int32_t v8 = v7; // 0x1170c
    if (v3 < 1) {
        goto lab_0x11860;
    } else {
        int32_t str = *(int32_t *)g7; // 0x11718
        ...
        if (v9 == 0) {
            ...
            while (c != 0) {
                ...
                *(char *)v16 = 0;
                ...
                int32_t * mem3 = realloc((int32_t *)g7, v21); // 0x11800
                if (mem3 == NULL) {
                    // 0x11844
                    g6 = -1;
                    goto lab_0x11834;
  ...
  lab_0x11860:
    // 0x11860
    *(int32_t *)(g7 + 4 * v8) = 0;
    return function_112f0(g6, g7, g7);
  lab_0x11834:
    // 0x11834
