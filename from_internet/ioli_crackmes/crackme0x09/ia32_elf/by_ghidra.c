...

{
  ...
  __libc_start_main(FUN_080486ee,param_2,&stack0x00000004,FUN_08048770,FUN_080487e0,param_1,
                    auStack_4);
  do {
...
// WARNING: Removing unreachable block (ram,0x080484af)
