...
int sub_4013A3(char* _Buffer, int param1) {
    int v0;
...
int sub_40141A(char* param0, int param1) {
    char v0;
    int v1;
    int v2;
    int v3;
    ...
    while(1) {
        ...
        if(!v15) {
            ...
            if(v28) {
                int v34 = param1;
                char* _Buffer = param0;
                int v35 = sub_4013A3(_Buffer, v34);
            }
            int* ptr9 = &ptr2;
            ptr1 = ptr2;
    ...
    /*NO_RETURN*/ sub_401385();
}

int sub_4014DE(int param0) {
    int v0;
    char v1;
    int v2 = 16;
    sub_402E20(param0);
    sub_401620();
    →msvcrt.dll!printf("IOLI Crackme Level 0x09\n");
    →msvcrt.dll!printf("Password: ");
    →msvcrt.dll!scanf((char*)&gvar_405055, &v1);
    int v3 = v0;
    /*NO_RETURN*/ sub_40141A(&v1, v3);
}
...
int sub_4015C0() {
    ...
    if(v0) {
        do {
            *(unsigned int*)(counter * 4 + (int)&gvar_403030)();
            --counter;
        }
        while(counter);
    }
...
LONG sub_401900(int* param0, int* param1, int param2, int param3) {
    LONG result;
    void* ptr0;
    int v0;
    int v1;
...
LONG sub_4019F0(int* param0, int* param1) {
...
LONG sub_401B60(int param0, int* param1) {
    return sub_401A60(param0, param1, 0, 0);
}

LONG sub_401B90(int param0) {
    void* ptr0 = →msvcrt.dll!malloc(24);
    ...
    loc_401E40:
        ...
        while(*ptr0 != 82) {
            switch(v8) {
                ...
                case 80: {
                    ++ptr0;
                    ptr2 = (char*)sub_401750((unsigned int*)(ptr2 + 1), &v2);
                    v8 = *ptr0;
                    break;
                }
                default: {
...
int sub_401F20(int param0, int param1, int param2) {
    unsigned int v0;
    unsigned int v1;
    int v2;
    int v3;
