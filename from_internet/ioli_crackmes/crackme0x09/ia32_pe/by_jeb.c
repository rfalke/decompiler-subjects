...
int sub_4013A3(LPSTR buffer, int param1) {
    int v0;
...
int sub_40141A(char* _Str, int param1) {
    int v0;
    int v1 = 0;
    unsigned int min = 0;
