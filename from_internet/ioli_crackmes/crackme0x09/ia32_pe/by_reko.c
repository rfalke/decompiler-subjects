...
void fn00401140()
{
	...
	fn00401580();
	__getmainargs(&g_dw406004, &g_dw406000, &ptrLoc10, g_dw404000);
	...
	if (eax_28 != 0x00)
	{
		...
		if (edx_34 != ~0x1F)
		{
			setmode(iob->dw0030, g_dw406040);
			edx_34 = iob;
		}
		if (edx_34 != ~0x3F)
			setmode(iob->dw0050, g_dw406040);
	}
	*__p__fmode() = g_dw404010;
	word32 ecx_95 = fn00401550();
	__align_stack<word32>(esp_101);
	esp_101->ptr0008 = (char * (*)[]) *__p__environ();
	esp_101->dw0004 = g_dw406000;
	esp_101->dw0000 = g_dw406004;
	Eq_67 eax_110 = fn004014DE(ecx_95, fp - 4, esp_101->ptr0008);
	cexit();
	*esp_121 = (uint32) eax_110;
	ExitProcess(*esp_121);
}

// 00401260: Register Eq_133 Win32CrtStartup()
Eq_133 Win32CrtStartup()
{
	__set_app_type(0x01);
	fn00401140();
}

// 004012A0: void fn004012A0(Stack (ptr32 Eq_142) ptrArg04)
// Called from:
//      Win32CrtStartup
//      fn00401620
...
word32 fn00401310(char * dwArg08[])
{
	...
	do
	{
		if (dwArg08[dwLoc08_56] == null)
			exit(~0x00);
		dwLoc08_42 = dwLoc08_56 + 0x01;
		dwLoc08_56 = dwLoc08_42;
	} while (strncmp(dwArg08[dwLoc08_56], "LOLO", 0x03) != 0x00);
	g_dw406030 = 0x01;
	return 0x01;
}
...
// 0040141A: void fn0040141A(Register (ptr32 Eq_233) ebp, Stack (ptr32 char) dwArg04, Stack (ptr32 (arr (ptr32 char))) dwArg08)
// Called from:
//      fn004014DE
void fn0040141A(struct Eq_233 * ebp, char * dwArg04, char * (* dwArg08)[])
{
	char bLoc11;
	int32 dwLoc08;
	word32 dwLoc0C_82 = 0x00;
	Eq_163 dwLoc10_83 = 0x00;
	while (dwLoc10_83 < strlen(dwArg04))
	{
		Mem45[&bLoc11 + 0x00:byte] = Mem16[dwLoc10_83 + dwArg04:byte];
		sscanf(&bLoc11, "%d", &dwLoc08);
		word32 v10_54 = dwLoc0C_82 + dwLoc08;
		dwLoc0C_82 = v10_54;
		if (v10_54 == 0x10)
			fn004013A3(dwArg04, dwArg08);
		dwLoc10_83 = (word32) dwLoc10_83.u0 + 1;
	}
	fn00401385();
}

// 004014DE: Register word32 fn004014DE(Register word32 ecx, Register ptr32 ebp, Stack (ptr32 (arr (ptr32 char))) dwArg0C)
// Called from:
//      fn00401140
word32 fn004014DE(word32 ecx, ptr32 ebp, char * (* dwArg0C)[])
{
	ptr32 fp;
	char bLoc7C;
	Eq_323 tLoc04;
	...
	printf("Password: ");
	scanf("%s", &bLoc7C);
	fn0040141A(&tLoc04, &bLoc7C, dwArg0C);
	return 0x00;
}

// 00401550: Register (ptr32 Eq_364) fn00401550()
// Called from:
//      fn00401140
struct Eq_364 * fn00401550()
{
	struct Eq_364 * ecx_15;
	for (ecx_15 = (struct Eq_364 *) 0x00405310; ecx_15 < (struct Eq_364 *) 0x00405310; ++ecx_15)
	{
		struct Eq_369 * edx_13 = ecx_15->dw0004;
...
Eq_142 g_t401590 = ??/* Unexpected function type (fn void ()) */ ; // 00401590
...
void fn00401620()
{
	if (g_dw406050 != 0x00)
		return;
	g_dw406050 = 0x01;
	ui32 eax_24 = g_dw403030;
	if (eax_24 == ~0x00)
	{
		eax_24 = 0x00;
		bool v19_85 = g_dw403034 != 0x00;
		while (v19_85)
		{
			++eax_24;
			v19_85 = (&g_dw403034)[eax_24 * 0x04] != 0x00;
		}
	}
	ui32 ebx_41 = eax_24;
	if (eax_24 != 0x00)
