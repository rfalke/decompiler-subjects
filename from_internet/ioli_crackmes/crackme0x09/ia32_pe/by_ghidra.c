...

{
  ...
  *piVar1 = DAT_00404010;
  ...
  uExitCode = FUN_004014de(DAT_00406004,DAT_00406000,*piVar1);
  _cexit();
...
{
  FUN_00402c00();
  FUN_004019f0((int *)&DAT_00405160,(undefined4 *)&DAT_00406010);
  return;
}
...
void __cdecl FUN_004013a3(char *param_1,int param_2)
...
void __cdecl FUN_0040141a(char *param_1,int param_2)
...
undefined4 __cdecl FUN_004014de(undefined4 param_1,undefined4 param_2,int param_3)
...
int __cdecl FUN_00401bc0(int *param_1)
...
void __cdecl FUN_00401d50(int *param_1)

{
  FUN_00401bc0(param_1);
  return;
}
...
LAB_00402baa:
  ...
  uStack_80._3_1_ = '2';
  uStack_7c = 0;
  AVar1 = FindAtomA((LPCSTR)&uStack_b8);
  if (AVar1 == 0) {
