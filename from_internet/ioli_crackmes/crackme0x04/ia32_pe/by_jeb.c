...
int sub_401395(int param0) {
    ...
    sub_402CD0(param0);
    sub_4014D0();
    →msvcrt.dll!printf("IOLI Crackme Level 0x04\n");
...
int sub_401470() {
    ...
    while(*(unsigned int*)(v0 * 4 + (int)&gvar_402ED4));
    int counter = v0;
    if(v0) {
        do {
    ...
    return sub_4012A0((void __cdecl (*_)())&sub_401440);
}
...
LONG sub_4018D0(int* param0) {
    ...
    return sub_4018A0(param0, (int*)ptr0);
}
...
int sub_401C00(int* param0) {
    return sub_401A70(param0);
}

int* sub_401C10(void* param0) {
    if(*(int*)param0) {
        int v0 = sub_401C00((int*)param0);
...
int sub_401DD0(int param0, int param1, int param2) {
    ...
    int v4 = v2;
    int v5 = sub_401CA0();
    int v6 = sub_401C40(v3, param0);
    sub_401600((unsigned int*)(param1 + 8), &v0);
    int v7 = sub_401CA0();
    int v8 = sub_401C40(v3, param0);
    sub_401600((unsigned int*)(param2 + 8), &v1);
    int result = 1;
    char v9 = v1 > v0;
    if((v9 || v1 == v0)) {
...
int sub_401E60(int param0, unsigned int param1, unsigned int param2) {
    int v0;
    int result;
    int v1;
    int v2;
...
int sub_401EF0(int param0) {
    ...
    while((int)v9 > 0) {
        ...
        *(int*)(v9 * 4 + v7) = v10;
        unsigned int v11 = v9;
        --v9;
        result = sub_401E60(v7, 0, v11);
    }
    return result;
}

int sub_401F60(int param0, unsigned int* param1) {
    char v0;
    unsigned int* ptr0;
    int v1;
    int v2;
...
int sub_402080(unsigned int* param0) {
    char v0;
    int v1;
    int v2;
    int v3;
...
unsigned int* sub_402180(int param0) {
    int v0;
    int v1;
    unsigned int* ptr0;
    int v2;
    ...
    while(!v10) {
        ...
        if(v12) {
            ...
            if(!v8) {
                ...
                int* ptr4 = sub_401600(result + 2, &ptr0);
                sub_401600((unsigned int*)ptr4, &v1);
                int v13 = sub_4014F0();
...
// Stale decompilation - Refresh this view to re-decompile this code
unsigned int* sub_4022A0(int param0, int param1) {
    unsigned int v0;
    int v1;
    unsigned int v2;
    unsigned int v3;
    ...
    if(!((unsigned char)param1 & 0x1)) {
        ...
        if(v20) {
            ...
            if(!i) {
                ...
                ptr10 = (void*)sub_401F60(v19, ptr14);
            }
                    ...
                    loc_4024AE:
                        ...
                        if(!v28) {
                            ...
                            loc_4026DC:
                                ...
                                *(int*)((int)ptr28 + 4) = v30;
                                ...
                                /*BAD_CALL!*/ sub_401EF0((int)_Block);
                                void* ptr36 = ptr18;
                                ...
                                if(ptr1) {
                                    ...
                                    do {
                                        ...
                                        while(v35) {
                                            v11 = v36;
                                            int v37 = v26{sub_401DD0|sub_401D30|sub_401D50}((int)ptr8, *((int*)(v35 * 4 + (int)ptr36) + 1), v36);
                                            if(v37 <= 0) {
                                                break;
                                            }
                                            else {
                        ...
                        while(1) {
                            if(v12 + 36 != ptr5) {
                                ...
                                int v41 = v26{sub_401DD0}((int)ptr8, v40, v39);
                                if(v41 < 0) {
                                    void* ptr41 = ptr3;
                                    void* ptr42 = ptr5;
                                    void* ptr43 = _Block;
    ...
    loc_4022EB:
        if(!((unsigned char)param1 & 0x1)) {
            if(!((unsigned char)param1 & 0x2)) {
                return sub_402180(v18);
            }
            unsigned int* ptr45 = ptr8[3];
            while(*ptr45) {
                int v42 = v18;
                result = sub_402180(v18);
                if(result) {
                    return result;
                }
                ++ptr45;
        ...
        loc_402581:
            ...
            if(!result) {
                ...
                v6 = ptr8[3];
                result = (unsigned int*)sub_401C40(param0, (int)ptr8);
                v5 = 0;
            ...
            loc_40232B:
                do {
                    ...
                    int v46 = sub_401CA0();
                    int v47 = sub_401C40(param0, (int)ptr8);
                    int* ptr48 = sub_401600(result1 + 2, &ptr6);
                    sub_401600((unsigned int*)ptr48, &v13);
                    result = ptr6;
                    ...
                    while(v8) {
                        ...
                        loc_40262E:
                            do {
                                ...
                                int* ptr49 = sub_401600(result1 + 2, &ptr7);
                                sub_401600((unsigned int*)ptr49, &v15);
                                result = ptr7;
                                if((unsigned int)result > (unsigned int)v18) {
                                    v4 = v49;
                                }
...
unsigned int* sub_402820(int param0, int* param1) {
    unsigned int* result;
    void* ptr0;
    int v0;
    int v1;
    ...
    while(v8) {
        ...
        if(*(unsigned int*)v8 > (unsigned int)v9) {
            ...
            --ptr2;
            *ptr2 = &loc_4029A1;
            unsigned int* ptr3 = /*BAD_CALL!*/ sub_4022A0(v2, v9);
            result = ptr3;
            v4 = gvar_4050B0;
            if(ptr3) {
                goto loc_4028C4;
    ...
    do {
        ...
        if(!v8) {
            ...
            *(int*)(v4 + 12) = *(int*)(v8 + 20);
            --ptr2;
            *ptr2 = &loc_402887;
            unsigned int* ptr4 = /*BAD_CALL!*/ sub_4022A0(v2, v10);
            v4 = gvar_4050B0;
            result = ptr4;
    ...
    if(result) {
        ...
        *(ptr6 + 1) = *(int*)(v8 + 8);
        if(*(char*)(v8 + 16) & 0x4) {
            --ptr2;
            *ptr2 = &loc_4029CC;
            int v13 = /*BAD_CALL!*/ sub_401CA0();
        }
        --ptr2;
        *ptr2 = &loc_402903;
        int v14 = /*BAD_CALL!*/ sub_401C40(v2, v8);
        *(ptr2 + 1) = param1 + 2;
        *ptr2 = (int*)(result + 2);
        --ptr2;
        *ptr2 = &loc_40291C;
