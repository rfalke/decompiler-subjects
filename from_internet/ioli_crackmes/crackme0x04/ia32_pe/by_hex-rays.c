...
int (*off_402ED4)() = &__reg_frame_ctor; // weak
int _CRT_glob = -1; // weak
int _fmode = 16384;
int (**p_0)() = &off_402EE0; // weak
...
// 402D60: using guessed type int __cdecl __getmainargs(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
...
int __do_global_ctors()
{
  ...
  {
    v0 = 0;
    for ( i = __reg_frame_ctor == 0; !i; i = *(&off_402ED4 + v0) == 0 )
      ++v0;
  }
  for ( j = v0; j; --j )
...
// 402ED0: using guessed type int __CTOR_LIST__[];
// 402ED4: using guessed type int (*off_402ED4)();
...
// 401CA0: using guessed type _DWORD var_C[3];
...
// 401D50: using guessed type unsigned int var_C[3];
...
// 401DD0: using guessed type unsigned int var_10[4];
...
// 401F60: using guessed type unsigned int var_10[4];
...
// 402080: using guessed type int var_10[4];
...
// 402180: using guessed type int var_10[4];
...
// 402DF0: using guessed type void __thiscall __noreturn _assert(_DWORD, _DWORD, _DWORD, _DWORD);
// 402A10: using guessed type CHAR Buffer[68];
...
// 402AB0: using guessed type CHAR var_98[32];
...
// nfuncs=75 queued=46 decompiled=46 lumina nreq=0 worse=0 better=0
