...
int32_t _main(int32_t ecx, int32_t a2, int32_t a3, int32_t a4) {
    ...
    _scanf("%s", v10);
    text(reinterpret_cast<int32_t>(ebp5) + 0xffffff88, v10);
    return 0;
}
    ...
    if (*reinterpret_cast<unsigned char*>(&edx5) & 1) {
        ...
        if (!eax39) {
            ...
            if (reinterpret_cast<unsigned char>(edx46) >> 11 == v41) 
                goto addr_4026ae_42; else 
                goto addr_402428_43;
        } else {
            addr_4022c9_44:
            if (v41) 
                goto addr_40243c_45; else 
                goto addr_4022d4_46;
        }
    }
    goto addr_402390_13;
    ...
    *reinterpret_cast<void***>(v7 + 16) = reinterpret_cast<void**>(reinterpret_cast<unsigned char>(edx46) & 0x7ff);
    ...
    if (!eax48) {
        ...
        *reinterpret_cast<void***>(eax48 + 4) = reinterpret_cast<void**>(0);
        ...
        addr_4024ae_56:
        v55 = 0x401dd0;
        if (!(reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(v7 + 16)) & 4) && (eax56 = reinterpret_cast<uint16_t>(*reinterpret_cast<void***>(v7 + 16)), v55 = 0x401d30, eax57 = eax56 >> 3, !!*reinterpret_cast<signed char*>(&eax57))) {
            v55 = 0x401d50;
        }
        v58 = v52;
        v59 = v52;
...
void ___main() {
    ...
    while (!zf3) {
        ++eax2;
        zf3 = *reinterpret_cast<int32_t*>(eax2 * 4 + 0x402ed4) == 0;
    }
    addr_401481_5:
    ebx4 = eax2;
    if (eax2) {
        do {
            *reinterpret_cast<int32_t*>(ebx4 * 4 + 0x402ed0)();
            --ebx4;
        } while (ebx4);
    }
    _atexit();
...
void text(void** a1, void* a2) {
    ...
    while (eax7 = _strlen(a1, "%d", v6), v5 < eax7) {
        ...
        _sscanf(reinterpret_cast<int32_t>(ebp3) - 13, "%d", v6);
        v4 = v4 + v8;
        if (v4 == 15) {
            _printf("Password OK!\n", "%d", v6);
            _exit(0, "%d", v6);
...
uint32_t fun_401d4c(int32_t a1, struct s22* a2, struct s23* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
uint32_t fun_401dc9(int32_t a1, struct s24* a2, struct s25* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
void fun_40284c(void*** a1, void** a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    void** v8;
    void** esi9;
    void** esi10;
    struct s26* ebp11;
...
/* .data */
struct s31* data = reinterpret_cast<struct s31*>(0x402ee0);
