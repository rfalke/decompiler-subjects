...
void fun_804850d(int32_t a1, int32_t a2, int32_t a3) {
    struct s1* ebp4;
...
void _start() {
    ...
    fun_80482fc(main, __return_address(), esp1, __libc_csu_init, 0x80484d0, edx2, (reinterpret_cast<uint32_t>(esp1) & 0xfffffff0) - 4 - 4, eax3);
    __asm__("hlt ");
}
...
void _fini() {
    ...
    fun_804850d(ebx1, ebp2, __return_address());
}
