...
// WARNING: Removing unreachable block (ram,0x000110e4)
// WARNING: Removing unreachable block (ram,0x00011100)
    ...
    if (DAT_00014000 <= (void *)(next_atexit + -4)) {
      ...
      do {
        if (*(code **)((int)pvVar2 + 4) != (code *)0x0) {
                    // WARNING: Could not recover jumptable at 0x00011248. Too many branches
...
{
                    // WARNING: Could not recover jumptable at 0x00011614. Too many branches
                    // WARNING: Treating indirect jump as call
  _fpreset();
  return;
}
