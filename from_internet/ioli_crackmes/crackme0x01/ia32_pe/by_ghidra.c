...

{
  ...
  iVar2 = ___w32_sharedptr;
  lpAddend = (LONG *)(___w32_sharedptr + 0x14);
  if ((__CRT_MT != 0) && (LVar3 = _InterlockedIncrement_4(lpAddend), LVar3 != 0)) goto LAB_00401b54;
  do {
    ...
    while (iVar1 != 0) {
      iVar6 = *piVar5;
      if (*(LONG **)(iVar6 + 0xc) == param_1) goto LAB_00401a88;
    ...
    if (__CRT_MT != 0) goto LAB_00401b23;
    do {
      _abort();
LAB_00401b23:
...

{
  ...
  if (bVar1 < 0x21) {
    ...
    if (bVar1 == 0x30) goto LAB_00401bff;
    bVar2 = bVar1 == 0x50;
  }
  if (bVar2) {
    return 0;
  ...
  if ((bVar11 & 1) == 0) {
    ...
    if (local_38 != (uint *)0x0) {
      ...
      if (local_1c != (uint *)0x0) {
        ...
        pvVar3 = local_18;
        puVar2 = local_1c;
        if ((local_1c != (uint *)0x0) && ((uint *)local_1c[1] != local_38)) goto LAB_00402655;
  ...
  if (uVar6 == 0) {
    ...
    if (puVar9 == (uint *)0x0) {
      ...
      *(undefined4 *)((int)puVar7 - uVar6) = *(undefined4 *)((int)puVar7 - uVar6);
                    // WARNING: Could not recover jumptable at 0x00402c8b. Too many branches
                    // WARNING: Treating indirect jump as call
