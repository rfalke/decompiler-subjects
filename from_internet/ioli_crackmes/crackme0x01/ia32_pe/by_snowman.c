    ...
    if (*reinterpret_cast<unsigned char*>(&edx5) & 1) {
        ...
        if (!eax39) {
            ...
            if (reinterpret_cast<unsigned char>(edx46) >> 11 == v41) 
                goto addr_40263e_42; else 
                goto addr_4023b8_43;
        } else {
            addr_402259_44:
            if (v41) 
                goto addr_4023cc_45; else 
                goto addr_402264_46;
        }
    }
    goto addr_402320_13;
    ...
    *reinterpret_cast<void***>(v7 + 16) = reinterpret_cast<void**>(reinterpret_cast<unsigned char>(edx46) & 0x7ff);
    ...
    if (!eax48) {
        ...
        *reinterpret_cast<void***>(eax48 + 4) = reinterpret_cast<void**>(0);
        ...
        addr_40243e_56:
        v55 = 0x401d60;
        if (!(reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(v7 + 16)) & 4) && (eax56 = reinterpret_cast<uint16_t>(*reinterpret_cast<void***>(v7 + 16)), v55 = 0x401cc0, eax57 = eax56 >> 3, !!*reinterpret_cast<signed char*>(&eax57))) {
            v55 = 0x401ce0;
        }
        v58 = v52;
        v59 = v52;
...
void ___main() {
    ...
    if (eax2) {
        do {
            *reinterpret_cast<int32_t*>(ebx4 * 4 + 0x402e40)();
            --ebx4;
        } while (ebx4);
    }
    _atexit();
...
uint32_t fun_401cdc(int32_t a1, struct s23* a2, struct s24* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
uint32_t fun_401d59(int32_t a1, struct s25* a2, struct s26* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
void fun_4027dc(void*** a1, void** a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    void** v8;
    void** esi9;
    void** esi10;
    struct s27* ebp11;
...
/* .data */
struct s33* data = reinterpret_cast<struct s33*>(0x402e50);
...
void text() {
    ...
    if (eax1->f0) {
        do {
            eax1->f0();
            edx2 = data;
            eax1 = reinterpret_cast<struct s33*>(&edx2->f4);
            edx3 = edx2->f4;
            data = eax1;
        } while (edx3);
    }
