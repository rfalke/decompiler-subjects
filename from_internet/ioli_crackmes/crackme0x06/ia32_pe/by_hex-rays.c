...
int (*off_402FC4)() = &__reg_frame_ctor; // weak
int _CRT_glob = -1; // weak
int _fmode = 16384;
int (**p_0)() = &off_402FD0; // weak
...
int __do_global_ctors()
{
  ...
  {
    v0 = 0;
    for ( i = __reg_frame_ctor == 0; !i; i = *(&off_402FC4 + v0) == 0 )
      ++v0;
  }
  for ( j = v0; j; --j )
...
// 402FC0: using guessed type int __CTOR_LIST__[];
// 402FC4: using guessed type int (*off_402FC4)();
...
// nfuncs=78 queued=48 decompiled=48 lumina nreq=0 worse=0 better=0
