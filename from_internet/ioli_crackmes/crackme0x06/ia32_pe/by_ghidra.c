...

{
  ...
  for (iVar5 = *(int *)(___w32_sharedptr + 0xc); iVar5 != 0; iVar5 = *(int *)(iVar5 + 0x14)) {
    iVar5 = *piVar4;
    if (*(int **)(iVar5 + 0xc) == param_1) goto LAB_00401bd8;
...
LAB_004027a5:
        ...
        if (local_18 == (void *)0x0) {
          ...
          *(int *)((int)pvVar3 + 4) = iVar4;
          if ((uint *)(*(int *)((int)local_18 + 4) + local_1c[1]) != local_38) goto LAB_004027a5;
