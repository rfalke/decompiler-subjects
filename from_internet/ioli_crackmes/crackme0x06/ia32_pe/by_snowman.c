...
void _check(void** a1, int32_t* a2);
...
/* .text */
int32_t* text(int32_t a1, int32_t* a2, void* a3);

int32_t* _parell(void** a1, int32_t* a2, void* a3) {
    void* ebp4;
    void* v5;
    int32_t* v6;
    int32_t v7;
...
int32_t abort = 0x62a0;

uint32_t _abort(void** a1, void*** a2, void** a3) {
    goto abort;
}

int32_t Sleep = 0x6204;
...
int32_t InterlockedDecrement = 0x61a0;
...
int32_t ReleaseSemaphore = 0x61d0;
...
int32_t WaitForSingleObject = 0x620c;
    ...
    if (*reinterpret_cast<unsigned char*>(&edx5) & 1) {
        ...
        if (!eax39) {
            ...
            if (reinterpret_cast<unsigned char>(edx46) >> 11 == v41) 
                goto addr_40278e_42; else 
                goto addr_402508_43;
        } else {
            addr_4023a9_44:
            if (v41) 
                goto addr_40251c_45; else 
                goto addr_4023b4_46;
        }
    }
    goto addr_402470_13;
    ...
    *reinterpret_cast<void***>(v7 + 16) = reinterpret_cast<void**>(reinterpret_cast<unsigned char>(edx46) & 0x7ff);
    ...
    if (!eax48) {
        ...
        *reinterpret_cast<void***>(eax48 + 4) = reinterpret_cast<void**>(0);
        ...
        addr_40258e_56:
        v55 = 0x401eb0;
        if (!(reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(v7 + 16)) & 4) && (eax56 = reinterpret_cast<uint16_t>(*reinterpret_cast<void***>(v7 + 16)), v55 = 0x401e10, eax57 = eax56 >> 3, !!*reinterpret_cast<signed char*>(&eax57))) {
            v55 = 0x401e30;
        }
        v58 = v52;
        v59 = v52;
...
void ___main() {
    ...
    while (!zf3) {
        ++eax2;
        zf3 = *reinterpret_cast<int32_t*>(eax2 * 4 + 0x402fc4) == 0;
    }
    addr_401561_5:
    ebx4 = eax2;
    if (eax2) {
        do {
            *reinterpret_cast<int32_t*>(ebx4 * 4 + 0x402fc0)();
            --ebx4;
        } while (ebx4);
    }
    _atexit();
...
void _check(void** a1, int32_t* a2) {
    ...
    while (eax8 = _strlen(a1, v6, v7), v5 < eax8) {
        v7 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(ebp3) - 4);
...
int32_t InterlockedIncrement = 0x61b8;
...
int32_t _assert = 0x6268;

void __assert(int32_t a1, int32_t a2, int32_t a3) {
    goto _assert;
}

int32_t GetAtomNameA = 0x6190;
...
int32_t __p__environ = 0x6234;

int32_t __argv;

int32_t __argc;

int32_t _cexit = 0x6274;
...
struct s21* _iob = reinterpret_cast<struct s21*>(0x6280);

int32_t _setmode = 0x6294;
...
int32_t CreateSemaphoreA = 0x6160;
...
int32_t SetUnhandledExceptionFilter = 0x61e4;
...
void fun_402fc3() {
    ...
    goto *reinterpret_cast<int32_t*>(eax1 + 0x402f);
}
...
uint32_t fun_401e2c(int32_t a1, struct s22* a2, struct s23* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
uint32_t fun_401ea9(int32_t a1, struct s24* a2, struct s25* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
void fun_40292c(void*** a1, void** a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    void** v8;
    void** esi9;
    void** esi10;
    struct s26* ebp11;
...
/* .data */
struct s31* data = reinterpret_cast<struct s31*>(0x402fd0);
...
void text() {
    ...
    if (eax1->0x0) {
        do {
            eax1->0x0();
            edx2 = data;
            eax1 = reinterpret_cast<struct s31*>(&edx2->0x4);
            edx3 = edx2->0x4;
            data = eax1;
        } while (edx3);
    }
