...
void sub_401140() {
    ...
    int v1 = 0;
    int* ptr1 = &v1;
    unsigned int v2 = gvar_403000;
    int* ptr2 = &v0;
    unsigned int v3 = &gvar_405000;
    →msvcrt.dll!__getmainargs();
    unsigned int v4 = gvar_405030;
    if(!v4) {
    loc_4011F0:
        ...
        *((int*)((int)&ptr0 & 0xfffffff0) - 2) = &loc_401227;
        int v5 = /*BAD_CALL!*/ sub_401463(*((int*)((int)&ptr0 & 0xfffffff0) - 1), *(int*)((int)&ptr0 & 0xfffffff0), *((int*)((int)&ptr0 & 0xfffffff0) + 1));
        *((int*)((int)&ptr0 & 0xfffffff0) - 3) = &loc_40122F;
        /*BAD_CALL!*/ _cexit();
        *((int*)((int)&ptr0 & 0xfffffff0) - 3) = v5;
...
LONG sub_4012C0() {
    sub_402B90();
    return sub_401980((int*)&gvar_404160, (int*)0x405010);
}

int sub_4012F0() {
    return sub_401CE0((int*)&gvar_404160);
}
...
int sub_401376(char* _Buffer, int param1) {
    int v0;
    →msvcrt.dll!sscanf(_Buffer, (char*)&gvar_404005, &v0);
...
int sub_4013E4(char* _Str, int param1) {
    int v0;
    unsigned int v1 = 0;
    unsigned int min = 0;
    for(size_t i = →msvcrt.dll!strlen(_Str); i > min; i = →msvcrt.dll!strlen(_Str)) {
        char v2 = _Str[min];
        →msvcrt.dll!sscanf(&v2, (char*)&gvar_404005, &v0);
        v1 += v0;
        if(v1 == 16) {
            sub_401376(_Str, param1);
        }
        ++min;
    }
    return →msvcrt.dll!printf("Password Incorrect!\n");
}

int sub_401463(int param0, int param1, int param2) {
    char v0;
    int v1;
    sub_402DB0(v1);
    sub_4015B0();
    →msvcrt.dll!printf("IOLI Crackme Level 0x06\n");
    →msvcrt.dll!printf("Password: ");
    →msvcrt.dll!scanf((char*)&gvar_40404F, &v0);
    sub_4013E4(&v0, param2);
    return 0;
}
...
int sub_401550() {
    ...
    while(*(unsigned int*)(v0 * 4 + (int)&gvar_402FC4));
    int counter = v0;
    if(v0) {
        do {
            *(unsigned int*)(counter * 4 + (int)&gvar_402FC0)();
            --counter;
        }
        while(counter);
    }
    return sub_4012A0((void __cdecl (*_)())&sub_401520);
}
...
char* sub_401620(int param0, int* param1) {
    char v0;
    int v1;
    char* ptr0;
    int v2 = v1;
...
char* sub_401670(int param0, int* param1) {
    char v0;
    int v1;
    char* ptr0;
    int v2 = v1;
...
// Stale decompilation - Refresh this view to re-decompile this code
int* sub_4016E0(unsigned int* param0, unsigned int* param1) {
    char v0;
    char v1;
    int v2;
    int v3;
    ...
    if(v0 != 80) {
        if((unsigned int)(((unsigned int)v0 | ((unsigned int)v3 << 8)) & 0xf) <= 12) {
            jump *(int*)((unsigned int)(((unsigned int)v0 | ((unsigned int)v3 << 8)) & 0xf) * 4 + 4210784);
        }
        else {
            /*NO_RETURN*/ →msvcrt.dll!abort();
...
LONG sub_401890(int* param0, int* param1, int param2, int param3) {
    LONG result;
    void* ptr0;
    int v0;
    int v1;
...
LONG sub_401980(int* param0, int* param1) {
    return sub_401890(param0, param1, 0, 0);
}

LONG sub_4019B0(int* param0) {
    int v0;
    int v1 = v0;
    if(!param0[0]) {
        return 0;
    ...
    return sub_401980(param0, (int*)ptr0);
}

LONG sub_4019F0(int param0, int* param1, int param2, int param3) {
    LONG result;
    void* ptr0;
    int v0;
    int v1;
...
LONG sub_401AF0(int param0, int* param1) {
    return sub_4019F0(param0, param1, 0, 0);
}

LONG sub_401B20(int param0) {
    void* ptr0 = →msvcrt.dll!malloc(24);
    return sub_401AF0(param0, (int*)ptr0);
}

int sub_401B50(int* param0) {
    DWORD v0;
    LONG v1;
    int result1;
    int result;
...
int sub_401CE0(int* param0) {
    return sub_401B50(param0);
}

int* sub_401CF0(void* param0) {
    if(*(int*)param0) {
        int v0 = sub_401CE0((int*)param0);
        →msvcrt.dll!free((void*)v0);
    }
    return (int*)param0;
}

int sub_401D20(int param0, int param1) {
    char v0;
    int v1;
    int result = 0;
...
int sub_401D80() {
    ...
    if(*(char*)(v4 + 9) == 122) {
        ...
        sub_401620(v7 + v4 + 10, &v0);
        unsigned char* ptr0 = (unsigned char*)(v4 + 10);
        char* ptr1 = sub_401670(v5, &v1);
        char* ptr2 = sub_401620((int)(ptr1 + 1), &v0);
    loc_401DD0:
        ...
        while(*ptr0 != 82) {
            switch(v8) {
                ...
                case 80: {
                    ++ptr0;
                    ptr2 = (char*)sub_4016E0((unsigned int*)(ptr2 + 1), &v2);
                    v8 = *ptr0;
                    break;
                }
                default: {
...
int sub_401E30(int param0, int param1, int param2) {
    unsigned int v0;
    unsigned int v1;
    int v2;
    int v3;
    int v4 = v2;
    int v5 = sub_401D20(v3, param0);
    sub_4016E0((unsigned int*)(param1 + 8), &v0);
    sub_4016E0((unsigned int*)(param2 + 8), &v1);
    int result = 1;
    char v6 = v1 > v0;
    if((v6 || v1 == v0)) {
        result = v6 ? -1: 0;
...
int sub_401EB0(int param0, int param1, int param2) {
    unsigned int v0;
    unsigned int v1;
    int v2;
    int v3;
    int v4 = v2;
    int v5 = sub_401D80();
    int v6 = sub_401D20(v3, param0);
    sub_4016E0((unsigned int*)(param1 + 8), &v0);
    int v7 = sub_401D80();
    int v8 = sub_401D20(v3, param0);
    sub_4016E0((unsigned int*)(param2 + 8), &v1);
    int result = 1;
    char v9 = v1 > v0;
    if((v9 || v1 == v0)) {
...
int sub_401F40(int param0, unsigned int param1, unsigned int param2) {
    int v0;
    int result;
    int v1;
    int v2;
...
int sub_401FD0(int param0) {
    ...
    while((int)v9 > 0) {
        ...
        *(int*)(v9 * 4 + v7) = v10;
        unsigned int v11 = v9;
        --v9;
        result = sub_401F40(v7, 0, v11);
    }
    return result;
}

int sub_402040(int param0, unsigned int* param1) {
    char v0;
    unsigned int* ptr0;
    int v1;
    int v2;
...
int sub_402160(unsigned int* param0) {
    char v0;
    int v1;
    int v2;
    int v3;
...
unsigned int* sub_402260(int param0) {
    int v0;
    int v1;
    unsigned int* ptr0;
    int v2;
    ...
    while(!v10) {
        ...
        if(v12) {
            ...
            if(!v8) {
                ...
                int* ptr4 = sub_4016E0(result + 2, &ptr0);
                sub_4016E0((unsigned int*)ptr4, &v1);
                int v13 = sub_4015D0();
...
// Stale decompilation - Refresh this view to re-decompile this code
unsigned int* sub_402380(int param0, int param1) {
    unsigned int v0;
    int v1;
    unsigned int v2;
    unsigned int v3;
    ...
    if(!((unsigned char)param1 & 0x1)) {
        ...
        if(v20) {
            ...
            if(!i) {
                ...
                ptr10 = (void*)sub_402040(v19, ptr14);
            }
                    ...
                    loc_40258E:
                        ...
                        if(!v28) {
                            ...
                            loc_4027BC:
                                ...
                                *(int*)((int)ptr28 + 4) = v30;
                                ...
                                /*BAD_CALL!*/ sub_401FD0((int)_Block);
                                void* ptr36 = ptr18;
                                ...
                                if(ptr1) {
                                    ...
                                    do {
                                        ...
                                        while(v35) {
                                            v11 = v36;
                                            int v37 = v26{sub_401EB0|sub_401E10|sub_401E30}((int)ptr8, *((int*)(v35 * 4 + (int)ptr36) + 1), v36);
                                            if(v37 <= 0) {
                                                break;
                                            }
                                            else {
                        ...
                        while(1) {
                            if(v12 + 36 != ptr5) {
                                ...
                                int v41 = v26{sub_401EB0}((int)ptr8, v40, v39);
                                if(v41 < 0) {
                                    void* ptr41 = ptr3;
                                    void* ptr42 = ptr5;
                                    void* ptr43 = _Block;
    ...
    loc_4023CB:
        if(!((unsigned char)param1 & 0x1)) {
            if(!((unsigned char)param1 & 0x2)) {
                return sub_402260(v18);
            }
            unsigned int* ptr45 = ptr8[3];
            while(*ptr45) {
                int v42 = v18;
                result = sub_402260(v18);
                if(result) {
                    return result;
                }
                ++ptr45;
        ...
        loc_402661:
            ...
            if(!result) {
                ...
                v6 = ptr8[3];
                result = (unsigned int*)sub_401D20(param0, (int)ptr8);
                v5 = 0;
            ...
            loc_40240B:
                do {
                    ...
                    int v46 = sub_401D80();
                    int v47 = sub_401D20(param0, (int)ptr8);
                    int* ptr48 = sub_4016E0(result1 + 2, &ptr6);
                    sub_4016E0((unsigned int*)ptr48, &v13);
                    result = ptr6;
                    ...
                    while(v8) {
                        ...
                        loc_40270E:
                            do {
                                ...
                                int* ptr49 = sub_4016E0(result1 + 2, &ptr7);
                                sub_4016E0((unsigned int*)ptr49, &v15);
                                result = ptr7;
                                if((unsigned int)result > (unsigned int)v18) {
                                    v4 = v49;
                                }
...
unsigned int* sub_402900(int param0, int* param1) {
    unsigned int* result;
    void* ptr0;
    int v0;
    int v1;
    ...
    while(v8) {
        ...
        if(*(unsigned int*)v8 > (unsigned int)v9) {
            ...
            --ptr2;
            *ptr2 = &loc_402A81;
            unsigned int* ptr3 = /*BAD_CALL!*/ sub_402380(v2, v9);
            result = ptr3;
            v4 = gvar_4050B0;
            if(ptr3) {
                goto loc_4029A4;
    ...
    do {
        ...
        if(!v8) {
            ...
            *(int*)(v4 + 12) = *(int*)(v8 + 20);
            --ptr2;
            *ptr2 = &loc_402967;
            unsigned int* ptr4 = /*BAD_CALL!*/ sub_402380(v2, v10);
            v4 = gvar_4050B0;
            result = ptr4;
    ...
    if(result) {
        ...
        *(ptr6 + 1) = *(int*)(v8 + 8);
        if(*(char*)(v8 + 16) & 0x4) {
            --ptr2;
            *ptr2 = &loc_402AAC;
            int v13 = /*BAD_CALL!*/ sub_401D80();
        }
        --ptr2;
        *ptr2 = &loc_4029E3;
        int v14 = /*BAD_CALL!*/ sub_401D20(v2, v8);
        *(ptr2 + 1) = param1 + 2;
        *ptr2 = (int*)(result + 2);
        --ptr2;
        *ptr2 = &loc_4029FC;
        /*BAD_CALL!*/ sub_4016E0(*(unsigned int**)(ptr2 + 1), *(unsigned int**)(ptr2 + 2));
    }
    return result;
}
