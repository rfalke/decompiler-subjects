...
void fun_80483b8(int32_t a1, int32_t* a2, void* a3) {
    goto printf;
}

int32_t exit = 0x80483ee;

void fun_80483e8(int32_t a1, int32_t* a2, void* a3) {
    goto exit;
}

int32_t sscanf = 0x80483ce;

void fun_80483c8(void* a1, int32_t* a2, void* a3) {
    goto sscanf;
}

int32_t* dummy(int32_t a1, int32_t* a2, void* a3);

int32_t* parell(void* a1, int32_t* a2, void* a3) {
    void* ebp4;
    void* v5;
    int32_t* v6;
    int32_t v7;
...
uint32_t fun_80483a8(void* a1, int32_t* a2, void* a3);

void check(void* a1, int32_t* a2) {
    void* ebp3;
    int32_t v4;
    uint32_t v5;
    int32_t* v6;
...
void fun_804871d(int32_t a1, int32_t a2, int32_t a3) {
    struct s1* ebp4;
...
void _start() {
    ...
    fun_8048388(main, __return_address(), esp1, __libc_csu_init, 0x80486e0, edx2, (reinterpret_cast<uint32_t>(esp1) & 0xfffffff0) - 4 - 4, eax3);
    __asm__("hlt ");
}
...
void _fini() {
    ...
    fun_804871d(ebx1, ebp2, __return_address());
}
...
int32_t main() {
    ...
    fun_80483b8("IOLI Crackme Level 0x06\n", v2, v3);
    fun_80483b8("Password: ", v4, v5);
