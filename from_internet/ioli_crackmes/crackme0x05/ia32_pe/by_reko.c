...
void fn00401354(char * dwArg04)
{
	char bLoc11;
	int32 dwLoc08;
	word32 dwLoc0C_60 = 0x00;
	Eq_173 dwLoc10_61 = 0x00;
	while (dwLoc10_61 < strlen(dwArg04))
	{
		Mem29[&bLoc11 + 0x00:byte] = Mem16[dwLoc10_61 + dwArg04:byte];
		sscanf(&bLoc11, "%d", &dwLoc08);
		word32 v10_38 = dwLoc0C_60 + dwLoc08;
		dwLoc0C_60 = v10_38;
		if (v10_38 == 0x10)
			fn00401310(dwArg04);
		dwLoc10_61 = (word32) dwLoc10_61.u0 + 1;
	}
...
// 00401440: Register (ptr32 Eq_248) fn00401440()
// Called from:
//      fn00401140
struct Eq_248 * fn00401440()
{
	struct Eq_248 * ecx_15;
	for (ecx_15 = (struct Eq_248 *) 0x00404300; ecx_15 < (struct Eq_248 *) 0x00404300; ++ecx_15)
	{
		struct Eq_253 * edx_13 = ecx_15->dw0004;
...
Eq_135 g_t401480 = ??/* Unexpected function type (fn void ()) */ ; // 00401480
...
void fn00401510()
{
	if (g_dw405040 != 0x00)
		return;
	g_dw405040 = 0x01;
	ui32 eax_24 = g_dw402F10;
	if (eax_24 == ~0x00)
	{
		eax_24 = 0x00;
		bool v19_85 = g_dw402F14 != 0x00;
		while (v19_85)
		{
			++eax_24;
			v19_85 = (&g_dw402F14)[eax_24 * 0x04] != 0x00;
		}
	}
	ui32 ebx_41 = eax_24;
	if (eax_24 != 0x00)
