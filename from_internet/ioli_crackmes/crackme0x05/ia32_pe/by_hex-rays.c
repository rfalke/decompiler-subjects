...
int __do_frame_fini();
int __cdecl parell(char *); // idb
int __cdecl check(char *); // idb
...
int (*off_402F14)() = &__reg_frame_ctor; // weak
int _CRT_glob = -1; // weak
int _fmode = 16384;
int (**p_0)() = &off_402F20; // weak
...
// 402DA0: using guessed type int __cdecl __getmainargs(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
...
//----- (00401310) --------------------------------------------------------
int __cdecl parell(char *Buffer)
{
  int result; // eax
...
int __do_global_ctors()
{
  ...
  {
    v0 = 0;
    for ( i = __reg_frame_ctor == 0; !i; i = *(&off_402F14 + v0) == 0 )
      ++v0;
  }
  for ( j = v0; j; --j )
...
// 402F10: using guessed type int __CTOR_LIST__[];
// 402F14: using guessed type int (*off_402F14)();
...
// 401CE0: using guessed type _DWORD var_C[3];
...
// 401D90: using guessed type unsigned int var_C[3];
...
// 401E10: using guessed type unsigned int var_10[4];
...
// 401FA0: using guessed type unsigned int var_10[4];
...
// 4020C0: using guessed type int var_10[4];
...
// 4021C0: using guessed type int var_10[4];
...
// 402E30: using guessed type void __thiscall __noreturn _assert(_DWORD, _DWORD, _DWORD, _DWORD);
// 402A50: using guessed type CHAR Buffer[68];
...
// 402AF0: using guessed type CHAR var_98[32];
...
// nfuncs=76 queued=47 decompiled=47 lumina nreq=0 worse=0 better=0
