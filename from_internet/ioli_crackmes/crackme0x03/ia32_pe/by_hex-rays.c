...
int (*off_402EE4)() = &__reg_frame_ctor; // weak
int _CRT_glob = -1; // weak
int _fmode = 16384;
int (**p_0)() = &off_402EF0; // weak
...
_DWORD _RUNTIME_PSEUDO_RELOC_LIST_END__[64] =
{
  0,
  0,
  0,
...
// 402D90: using guessed type int __cdecl __getmainargs(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
...
// 404150: using guessed type _DWORD __EH_FRAME_BEGIN__[107];
...
// 401310: using guessed type char var_78[120];
...
// 404300: using guessed type _DWORD _RUNTIME_PSEUDO_RELOC_LIST_END__[64];
...
int __do_global_ctors()
{
  ...
  {
    v0 = 0;
    for ( i = __reg_frame_ctor == 0; !i; i = *(&off_402EE4 + v0) == 0 )
      ++v0;
  }
  for ( j = v0; j; --j )
...
// 402EE0: using guessed type int __CTOR_LIST__[];
// 402EE4: using guessed type int (*off_402EE4)();
...
// 401CD0: using guessed type _DWORD var_C[3];
...
// 401D80: using guessed type unsigned int var_C[3];
...
// 401E00: using guessed type unsigned int var_10[4];
...
// 401F90: using guessed type unsigned int var_10[4];
...
// 4020B0: using guessed type int var_10[4];
...
// 4021B0: using guessed type int var_10[4];
...
// 402E00: using guessed type void __thiscall __noreturn _assert(_DWORD, _DWORD, _DWORD, _DWORD);
// 402A40: using guessed type CHAR Buffer[68];
...
// 402AE0: using guessed type CHAR var_98[32];
...
// nfuncs=74 queued=47 decompiled=47 lumina nreq=0 worse=0 better=0
