...
void text(int32_t a1, int32_t a2) {
    ...
    ecx3 = reinterpret_cast<struct s0*>(0x404310);
    while (reinterpret_cast<uint32_t>(ecx3) < 0x404310) {
        ++ecx3;
...
void _printf(int32_t a1, int32_t a2);

void _scanf(int32_t a1, void* a2);

int32_t _strcmp(void* a1, int32_t a2);

/* .text */
int32_t text(int32_t ecx, int32_t a2, int32_t a3, int32_t a4) {
    void* ebp5;
    int32_t v6;
    int32_t v7;
    int32_t eax8;
    ...
    _printf("Password: ", v7);
    _scanf("%s", reinterpret_cast<int32_t>(ebp5) - 24);
    eax8 = _strcmp(reinterpret_cast<int32_t>(ebp5) - 24, "250382");
    if (!eax8) {
        _printf("Password OK :)\n", "250382");
    } else {
...
int32_t printf = 0x62b8;

void _printf(int32_t a1, int32_t a2) {
    goto printf;
}

int32_t atexit = 0x6298;
...
int32_t abort = 0x6290;

uint32_t _abort(void** a1, void*** a2, void** a3) {
    goto abort;
}

int32_t Sleep = 0x61f4;
...
int32_t InterlockedDecrement = 0x6190;
...
int32_t ReleaseSemaphore = 0x61c0;
...
int32_t WaitForSingleObject = 0x61fc;
    ...
    if (*reinterpret_cast<unsigned char*>(&edx5) & 1) {
        ...
        if (!eax39) {
            ...
            if (reinterpret_cast<unsigned char>(edx46) >> 11 == v41) 
                goto addr_40264e_42; else 
                goto addr_4023c8_43;
        } else {
            addr_402269_44:
            if (v41) 
                goto addr_4023dc_45; else 
                goto addr_402274_46;
        }
    }
    goto addr_402330_13;
    ...
    *reinterpret_cast<void***>(v7 + 16) = reinterpret_cast<void**>(reinterpret_cast<unsigned char>(edx46) & 0x7ff);
    ...
    if (!eax48) {
        ...
        *reinterpret_cast<void***>(eax48 + 4) = reinterpret_cast<void**>(0);
        ...
        addr_40244e_56:
        v55 = 0x401d70;
        if (!(reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(v7 + 16)) & 4) && (eax56 = reinterpret_cast<uint16_t>(*reinterpret_cast<void***>(v7 + 16)), v55 = 0x401cd0, eax57 = eax56 >> 3, !!*reinterpret_cast<signed char*>(&eax57))) {
            v55 = 0x401cf0;
        }
        v58 = v52;
        v59 = v52;
...
void ___main() {
    ...
    while (!zf3) {
        ++eax2;
        zf3 = *reinterpret_cast<int32_t*>("@.@" + eax2 * 4) == 0;
    }
    addr_401421_5:
    ebx4 = eax2;
    if (eax2) {
        do {
            *reinterpret_cast<int32_t*>(ebx4 * 4 + 0x402e60)();
            --ebx4;
        } while (ebx4);
    }
    _atexit();
...
int32_t scanf = 0x62c4;

void _scanf(int32_t a1, void* a2) {
    goto scanf;
}

int32_t strcmp = 0x62d8;
...
int32_t InterlockedIncrement = 0x61a8;
...
int32_t _assert = 0x6258;

void __assert(int32_t a1, int32_t a2, int32_t a3) {
    goto _assert;
}

int32_t GetAtomNameA = 0x6180;
...
int32_t __p__environ = 0x6224;

int32_t __argv;

int32_t __argc;

int32_t _cexit = 0x6264;
...
struct s21* _iob = reinterpret_cast<struct s21*>(0x6270);

int32_t _setmode = 0x6284;
    ...
    if (!eax6) {
        while (1) {
            ...
            *eax9 = edx10;
            ...
            eax13 = __argv;
            eax14 = __argc;
            eax15 = text(ecx, eax14, eax13, v12);
...
int32_t CreateSemaphoreA = 0x6150;
...
int32_t SetUnhandledExceptionFilter = 0x61d4;
...
void fun_402e6f() {
    ...
    eax2 = reinterpret_cast<struct s26*>(eax1->0x2e(__return_address()));
    eax3 = &eax2->0x1;
    *eax3 = reinterpret_cast<signed char>(*eax3 + *reinterpret_cast<signed char*>(&eax3));
    *eax3 = reinterpret_cast<signed char>(*eax3 + *reinterpret_cast<signed char*>(&eax3));
    *eax3 = reinterpret_cast<signed char>(*eax3 + *reinterpret_cast<signed char*>(&eax3));
...
uint32_t fun_401cec(int32_t a1, struct s27* a2, struct s28* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
uint32_t fun_401d69(int32_t a1, struct s29* a2, struct s30* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
void fun_4027ec(void*** a1, void** a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    void** v8;
    void** esi9;
    void** esi10;
    struct s31* ebp11;
...
/* .data */
struct s36* data = reinterpret_cast<struct s36*>(0x402e70);
...
void text() {
    ...
    if (eax1->0x0) {
        do {
            eax1->0x0();
            edx2 = data;
            eax1 = reinterpret_cast<struct s36*>(&edx2->0x4);
            edx3 = edx2->0x4;
            data = eax1;
        } while (edx3);
    }
...
void fun_402e38() {
    ...
    *eax10 = reinterpret_cast<signed char>(*eax11 + al12);
    ...
    ___register_frame_info(0x404160, 0x405010);
    return;
}
...
void** fun_402e49() {
    ...
    eax1 = ___deregister_frame_info(0x404160);
    return eax1;
}
