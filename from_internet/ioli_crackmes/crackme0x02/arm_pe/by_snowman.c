...
struct s0* g11134 = reinterpret_cast<struct s0*>(0x13058);

struct s0* g11138 = reinterpret_cast<struct s0*>(0x13058);

int32_t g1113c = 0x10000;
...
void*** g11230 = reinterpret_cast<void***>(0x14000);

void**** g11234 = reinterpret_cast<void****>(0x14004);
...
struct s1** g112a8 = reinterpret_cast<struct s1**>(0x14000);

void** g112ac = reinterpret_cast<void**>(0x14004);
...
struct s2* g113b8 = reinterpret_cast<struct s2*>(0x1170c);

void** g113bc = reinterpret_cast<void**>(20);
...
int32_t* g113e4 = reinterpret_cast<int32_t*>(0x14008);
...
void** g1162c = reinterpret_cast<void**>(0);
...
void** g11630 = reinterpret_cast<void**>(16);

void wcstombs(void** r0, void** r1, void** r2);

void** g11634 = reinterpret_cast<void**>(12);
...
int32_t g11638 = 0x1304c;

void* strspn(void** r0, int32_t r1, void** r2);

void** g1163c = reinterpret_cast<void**>(84);
    ...
    *reinterpret_cast<int32_t*>(reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(r1_28)) + reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(r0_27)) << 2) = 0;
    ...
    if (!r4_32) {
        ...
        *reinterpret_cast<void***>(r3_36) = reinterpret_cast<void**>(1);
        ...
        while (r1_38 = g11638, r0_39 = strspn(r4_32, r1_38, r2_33), r6_40 = reinterpret_cast<void*>(reinterpret_cast<unsigned char>(r4_32) + reinterpret_cast<uint32_t>(r0_39)), r0_41 = *reinterpret_cast<unsigned char*>(reinterpret_cast<unsigned char>(r4_32) + reinterpret_cast<uint32_t>(r0_39)), !!r0_41) {
            r2_33 = g1163c;
...
int32_t* g11648 = reinterpret_cast<int32_t*>(0x15084);
...
int32_t* g11654 = reinterpret_cast<int32_t*>(0x1507c);
...
int32_t* g11660 = reinterpret_cast<int32_t*>(0x15098);
...
int32_t* g1166c = reinterpret_cast<int32_t*>(0x150a0);
...
int32_t* g11678 = reinterpret_cast<int32_t*>(0x15094);
...
int32_t* g11684 = reinterpret_cast<int32_t*>(0x15090);
...
int32_t* g11690 = reinterpret_cast<int32_t*>(0x1508c);
...
int32_t* g1169c = reinterpret_cast<int32_t*>(0x15088);
...
int32_t* g116a8 = reinterpret_cast<int32_t*>(0x1509c);
...
int32_t* g116b4 = reinterpret_cast<int32_t*>(0x15080);
...
int32_t* g116c0 = reinterpret_cast<int32_t*>(0x150b0);
...
int32_t* g116cc = reinterpret_cast<int32_t*>(0x150a4);
...
int32_t* g116d8 = reinterpret_cast<int32_t*>(0x150a8);
...
int32_t* g116e4 = reinterpret_cast<int32_t*>(0x15078);
...
int32_t* g116f0 = reinterpret_cast<int32_t*>(0x150b4);
...
int32_t* g116fc = reinterpret_cast<int32_t*>(0x150ac);
...
int32_t* g11708 = reinterpret_cast<int32_t*>(0x150b8);
...
void*** g1130c = reinterpret_cast<void***>(0x14000);

void*** g11310 = reinterpret_cast<void***>(0x14004);
...
int32_t g110e8 = 0x13000;

int32_t g110ec = 0x13018;

int32_t g110f0 = 0x13024;

int32_t g110f8 = 0x13038;

int32_t g110f4 = 0x13028;
...
int32_t text(void** r0, void** r1) {
    ...
    printf(r0_4);
    r0_5 = g110f0;
    r1_6 = reinterpret_cast<void**>(reinterpret_cast<int32_t>(__zero_stack_offset()) - 4 - 24);
    scanf(r0_5, r1_6);
    if (v7 != 0x52b24) {
        r0_8 = g110f8;
        puts(r0_8, r1_6);
...
void fun_11630(int32_t r0, int32_t r1) {
    int1_t z3;
    int1_t z4;
    int1_t z5;
    int1_t z6;
...
int32_t* g1114c = reinterpret_cast<int32_t*>(0x14000);

int32_t fun_11134(int32_t r0, int32_t r1) {
    int1_t z3;
    int1_t z4;
    int1_t z5;
    int32_t* r3_6;
...
void fun_1114c(int32_t r0, int32_t r1) {
    int1_t z3;
...
void*** g11208 = reinterpret_cast<void***>(0x14000);

void**** g1120c = reinterpret_cast<void****>(0x14004);
...
struct s3** g11354 = reinterpret_cast<struct s3**>(0x12000);

void fun_1130c(int32_t r0, int32_t r1) {
    int1_t z3;
    int1_t z4;
    struct s3** r3_5;
    int32_t r3_6;
...
void fun_11654(int32_t r0, int32_t r1) {
    int1_t z3;
...
void fun_1166c(int32_t r0, int32_t r1) {
    int1_t z3;
...
void fun_116c0(int32_t r0, int16_t* r1) {
    int1_t z3;
    int32_t r5_4;
...
void fun_116e4(int32_t r0, int32_t r1) {
    int1_t z3;
...
void fun_110e8(int32_t r0, int32_t r1) {
    int1_t z3;
    int1_t z4;
    int1_t z5;
    int1_t z6;
...
void fun_112a8(int32_t r0, int32_t r1) {
    int1_t z3;
    int1_t z4;
