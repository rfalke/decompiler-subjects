...
int32_t text(int32_t ecx, int32_t a2, int32_t a3, int32_t a4) {
    ...
    _printf("Password: ", v6);
    v7 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(__zero_stack_offset()) - 4 - 4);
    _scanf("%d", v7);
    if (v8 != 0x52b24) {
    ...
    if (*reinterpret_cast<unsigned char*>(&edx5) & 1) {
        ...
        if (!eax39) {
            ...
            if (reinterpret_cast<unsigned char>(edx46) >> 11 == v41) 
                goto addr_40265e_42; else 
                goto addr_4023d8_43;
        } else {
            addr_402279_44:
            if (v41) 
                goto addr_4023ec_45; else 
                goto addr_402284_46;
        }
    }
    goto addr_402340_13;
    ...
    *reinterpret_cast<void***>(v7 + 16) = reinterpret_cast<void**>(reinterpret_cast<unsigned char>(edx46) & 0x7ff);
    ...
    if (!eax48) {
        ...
        *reinterpret_cast<void***>(eax48 + 4) = reinterpret_cast<void**>(0);
        ...
        addr_40245e_56:
        v55 = 0x401d80;
        if (!(reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(v7 + 16)) & 4) && (eax56 = reinterpret_cast<uint16_t>(*reinterpret_cast<void***>(v7 + 16)), v55 = 0x401ce0, eax57 = eax56 >> 3, !!*reinterpret_cast<signed char*>(&eax57))) {
            v55 = 0x401d00;
        }
        v58 = v52;
        v59 = v52;
...
uint32_t fun_401cfc(int32_t a1, struct s27* a2, struct s28* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
uint32_t fun_401d79(int32_t a1, struct s29* a2, struct s30* a3) {
    void* ebp4;
    void** v5;
    void*** v6;
    void** v7;
...
void fun_4027fc(void*** a1, void** a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    void** v8;
    void** esi9;
    void** esi10;
    struct s31* ebp11;
