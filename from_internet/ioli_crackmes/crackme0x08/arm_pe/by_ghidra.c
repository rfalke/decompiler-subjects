...

{
  ...
  p_Var1 = (_onexit_t)__dllonexit(_Func,(void **)&first_atexit,(void **)&next_atexit);
  return p_Var1;
}
...

{
  ...
  iVar1 = __dllonexit(param_1,(void **)&first_atexit,(void **)&next_atexit);
  if (iVar1 == 0) {
    iVar1 = -1;
  }
  else {
...

{
  ...
  if (first_atexit != (void *)0x0) {
    if (first_atexit <= (void *)(next_atexit + -4)) {
      ...
      do {
        ...
        bVar1 = first_atexit <= pvVar2;
        pvVar2 = (void *)((int)pvVar2 + -4);
      } while (bVar1);
    }
    free(first_atexit);
    first_atexit = (void *)0x0;
  }
  fflush((FILE *)0x0);
  return;
}
