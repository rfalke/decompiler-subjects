...
void __cdecl __noreturn check(char *, int); // idb
...
int (*off_403034)() = &__reg_frame_ctor; // weak
int _CRT_glob = -1; // weak
int _fmode = 16384;
int (**p_0)() = &off_403040; // weak
...
void __noreturn __mingw_CRTStartup()
{
  ...
  *__p__fmode() = _fmode;
  ...
  v1 = ___p__environ();
  main(_argc, (const char **)_argv, (const char **)*v1);
}
// 402EB0: using guessed type int __cdecl __getmainargs(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
// 404000: using guessed type int _CRT_glob;
...
// 405160: using guessed type _DWORD __EH_FRAME_BEGIN__[107];
// 406010: using guessed type _DWORD obj[8];
...
// 406030: using guessed type int LOL;
...
//----- (00401415) --------------------------------------------------------
void __cdecl __noreturn check(char *Str, int a2)
{
...
// 405310: using guessed type _DWORD _RUNTIME_PSEUDO_RELOC_LIST_END__[60];
...
// 404020: using guessed type int (**p_0)();
...
int __do_global_ctors()
{
  ...
  {
    v0 = 0;
    for ( i = __reg_frame_ctor == 0; !i; i = *(&off_403034 + v0) == 0 )
      ++v0;
  }
  for ( j = v0; j; --j )
...
// 403030: using guessed type int __CTOR_LIST__[];
...
// 406050: using guessed type int initialized;
...
// 4060C0: using guessed type int __w32_sharedptr;
...
// 4060A0: using guessed type int _CRT_MT;
// 4060C0: using guessed type int __w32_sharedptr;
...
// 402F50: using guessed type void __thiscall __noreturn _assert(_DWORD, _DWORD, _DWORD, _DWORD);
...
// 404030: using guessed type int dw2_once_1;
// 404034: using guessed type int dword_404034;
// 404038: using guessed type int eh_globals_once_4;
// 40403C: using guessed type int dword_40403C;
// 406070: using guessed type int dw2_object_mutex_0;
// 406074: using guessed type int dword_406074;
// 406080: using guessed type int eh_globals_static_2;
// 406084: using guessed type int dword_406084;
// 406090: using guessed type int eh_globals_key_3;
// 4060B0: using guessed type int __w32_sharedptr_terminate;
// 4060C0: using guessed type int __w32_sharedptr;
// 4060D0: using guessed type int __w32_sharedptr_unexpected;
...
// nfuncs=79 queued=49 decompiled=49 lumina nreq=0 worse=0 better=0
