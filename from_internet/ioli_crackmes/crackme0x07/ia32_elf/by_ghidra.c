...

{
  ...
  __libc_start_main(FUN_0804867d,param_2,&stack0x00000004,FUN_080486e0,FUN_08048750,param_1,
                    auStack_4);
  do {
...
undefined4 FUN_080484b4(undefined4 param_1,int param_2)
...
void FUN_08048542(char *param_1,undefined4 param_2)

{
  ...
  iVar1 = FUN_080484b4(local_8,param_2);
  if (iVar1 != 0) {
...
void FUN_080485b9(char *param_1,undefined4 param_2)

{
  ...
  while( true ) {
    ...
    if (local_c == 0x10) {
      FUN_08048542(param_1,param_2);
    }
    local_10 = local_10 + 1;
  }
  FUN_08048524();
  iVar2 = FUN_080484b4(local_8,param_2);
  if (iVar2 != 0) {
