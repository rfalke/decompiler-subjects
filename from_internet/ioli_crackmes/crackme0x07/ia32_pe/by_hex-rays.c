...
int *__cdecl sub_40139E(char *Buffer, int);
void __cdecl __noreturn sub_401415(char *, int); // idb
void __cdecl __noreturn sub_4014D9(int, int, int);
int sub_401550();
void sub_401580();
int (**sub_401590())();
int sub_4015C0();
...
// 4014FC: variable 'v3' is possibly undefined
// 4014FC: variable 'Format' is possibly undefined
