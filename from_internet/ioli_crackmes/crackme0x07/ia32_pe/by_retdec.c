...
int32_t function_401310(int32_t a1, int32_t a2);
int32_t function_401380(void);
int32_t function_40139e(int32_t str, int32_t a2);
int32_t function_401415(int32_t * str, int32_t a2);
int32_t function_40148b(void);
int32_t function_4014d9(int32_t a1, int32_t a2, int32_t a3);
...
int32_t function_4020b0(int32_t a1);
...
int32_t function_402c00(int32_t a1);
...
void function_402ef0(int32_t status);
int32_t function_402f00(char * format, ...);
...
int32_t function_401140(void) {
  ...
  lab_0x4011f0:
    ...
    *__p__fmode() = g4;
    function_401550();
    char ** v6 = *__p__environ(); // 0x40120b
    int32_t uExitCode = function_4014d9(g12, (int32_t)g11, (int32_t)v6); // 0x401222
    _cexit();
...
// Address range: 0x40148b - 0x4014d9
int32_t function_40148b(void) {
    // 0x40148b
    int32_t v1; // 0x40148b
    int32_t * v2 = (int32_t *)(v1 - 4); // 0x401492
    if (function_401310(*v2, *(int32_t *)(v1 + 12)) == 0) {
        // 0x4014d7
        return 0;
    }
    int32_t result = v1 - 12; // 0x4014a1
    int32_t * v3 = (int32_t *)result; // 0x4014a1
    *v3 = 0;
    int32_t v4 = 0; // 0x4014d3
    while (*v2 % 2 != 0) {
        uint32_t v5 = v4;
        v4 = v5 + 1;
        *v3 = v4;
        ...
        if (v11 < 2048) {
            if ((v6 & 2) == 0) {
                ...
                if (*(int32_t *)v12 == 0) {
                    ...
                    int32_t v13 = 0;
                    int32_t v14 = v12 + 4; // 0x402542
                    int32_t v15 = function_4020b0(v13) + v13; // 0x40254d
                    int32_t v16 = v14; // 0x402554
                    v8 = v15;
                    while (*(int32_t *)v14 != 0) {
                        // 0x402540
                        v13 = v15;
                        v14 = v16 + 4;
                        v15 = function_4020b0(v13) + v13;
                        v16 = v14;
                        v8 = v15;
                    }
                    goto lab_0x402556;
