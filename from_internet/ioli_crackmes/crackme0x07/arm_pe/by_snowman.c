...
void fun_118e0(int32_t r0, void** r1, void** r2, ...);

void** fun_11524(int32_t r0, void** r1, void** r2, void** r3, void** a5, void** a6, int32_t a7, int32_t a8, void* a9);

void** g111d0 = reinterpret_cast<void**>(28);

void fun_118d4(void** r0, void** r1, void** r2);
...
void** fun_1110c() {
    ...
    r0_1 = g11128;
    fun_118e0(r0_1, r1_2, r2_3, r0_1, r1_4, r2_5);
    r0_11 = fun_11524(0, r1_6, r2_7, r3_8, r11_9, __zero_stack_offset(), __return_address(), 0x11118, v10);
    if (z12) {
    }
    ...
    fun_118d4(v14, r1_17, r2_18);
    r1_19 = v15;
    r0_21 = fun_11050(v20, r1_19, r2_18);
    if (r0_21) {
        v22 = 0;
        while (v22 <= 9) {
            if (!(v23 & 1)) {
                ...
                if (reinterpret_cast<int1_t>(*r3_24 == 1)) {
                    r0_25 = g111d8;
                    fun_118e0(r0_25, r1_19, r2_18);
                }
                r0_21 = fun_11524(0, r1_19, r2_18, *r3_24, v15, v14, v26, v22, v13);
            }
            ++v22;
        }
    }
...
void** fun_1112c(void** r0, void** r1) {
    void* v3;
    void* r11_4;
    void** v5;
    void** v6;
        ...
        while (v12 <= 9) {
            if (!(v13 & 1)) {
                ...
                if (reinterpret_cast<int1_t>(*r3_14 == 1)) {
                    r0_15 = g111d8;
                    fun_118e0(r0_15, r1_9, r2_8);
                }
                r0_11 = fun_11524(0, r1_9, r2_8, *r3_14, v6, v5, v16, v12, v3);
            }
            ++v12;
        }
    }
...
void* fun_118c8(void** r0, void** r1, void** r2);

void** g112ec = reinterpret_cast<void**>(28);

int32_t g112f0 = 0x13030;

void** fun_111dc(void** r0, void** r1) {
    void* r11_3;
    void** v4;
    void** v5;
    void* v6;
    ...
    while (r0_9 = fun_118c8(v4, r1, r2_8), reinterpret_cast<uint32_t>(v7) >= reinterpret_cast<uint32_t>(r0_9)) {
        *reinterpret_cast<signed char*>(reinterpret_cast<int32_t>(&v10) + 3) = static_cast<signed char>(static_cast<uint32_t>(*reinterpret_cast<unsigned char*>(reinterpret_cast<uint32_t>(v7) + reinterpret_cast<unsigned char>(v4))));
        r1 = g112ec;
        fun_118d4(reinterpret_cast<int32_t>(r11_3) - 29, r1, reinterpret_cast<int32_t>(r11_3) - 28);
        r2_8 = v11;
    ...
    if (r0_14) {
        ...
        while (v15 <= 9) {
            ...
            if (!r3_16) {
                r0_18 = g112f0;
                fun_118e0(r0_18, r1_12, r2_8);
                r0_14 = fun_11524(0, r1_12, r2_8, r3_16, v5, v4, v10, v19, v6);
            }
            ++v15;
        }
    }
...
void fun_118bc(int32_t r0, void* r1);

int32_t fun_112f4(void** r0, void** r1, void** r2) {
    void* r11_4;
    int32_t r0_5;
    int32_t r0_6;
    int32_t r0_7;
    ...
    fun_11624(r0);
    r0_5 = g11354;
    fun_118e0(r0_5, r1, r2, r0_5, r1, r2);
    r0_6 = g11358;
    fun_118ec(r0_6);
    r0_7 = g1135c;
    fun_118bc(r0_7, reinterpret_cast<int32_t>(r11_4) - 0x70);
    fun_111dc(reinterpret_cast<int32_t>(r11_4) - 0x70, r2);
    return 0;
}
...
void** fun_113e4(void** r0, void*** r1, void**** r2);

void** fun_11474(void** r0) {
    void*** r1_2;
    void**** r2_3;
    void** r0_4;
    int1_t z5;
...
void** fun_11970(void** r0, void** r1, void** r2);

void** fun_11904(uint32_t r0, void** r1, void** r2);

void fun_118b0(uint32_t r0, int32_t r1, void** r2, void** r3, void** a5, void** a6, int32_t a7, int32_t a8, void* a9);

void** g11894 = reinterpret_cast<void**>(20);

void fun_1197c(void** r0, void** r1, void** r2);

void** g11898 = reinterpret_cast<void**>(16);

int32_t g1189c = 0x13060;

void* fun_11940(void** r0, int32_t r1, void** r2);

void** g118a0 = reinterpret_cast<void**>(0x68);

void* fun_11958(void* r0, int32_t r1);

void** fun_11928(void** r0, void* r1);

void** fun_1194c(void* r0, int32_t r1);

int32_t fun_1164c(int32_t r0, int32_t r1, void** r2, void** r3, void** a5, void** a6, int32_t a7, int32_t a8, void* a9) {
    void** sp10;
    void** r3_11;
    int32_t r0_12;
    int1_t z13;
    ...
    *reinterpret_cast<int16_t*>(reinterpret_cast<uint32_t>(sp10 + 0x400) - reinterpret_cast<unsigned char>(r3_11)) = 0;
    ...
    if (!z13) {
        r0_15 = fun_11970(r2, sp10, 0x200);
        r6_14 = r0_15;
    }
    r0_16 = fun_11904(r0_12 + reinterpret_cast<uint32_t>(r6_14 + 2), sp10, 0x200);
    r5_17 = r0_16;
    if (!r5_17) {
        fun_118b0(r0_16 + 66, -1, 0x200, r3_11, v18, v19, v20, v21, v22);
        while (1) {
        }
    }
    r0_23 = fun_11904(4, sp10, 0x200);
    r3_24 = g11894;
    *reinterpret_cast<void***>(r3_24) = r0_23;
    if (!r0_23) 
        goto addr_116cc_11;
    *reinterpret_cast<void***>(r0_23) = r5_17;
    r0_25 = fun_11970(sp10, sp10, 0x200);
    fun_1197c(r5_17, sp10, r0_25 + 1);
    r2_26 = g11898;
    ...
    *reinterpret_cast<int32_t*>(reinterpret_cast<unsigned char>(r2_29) + reinterpret_cast<unsigned char>(*reinterpret_cast<void***>(r0_27)) << 2) = 0;
    r0_30 = fun_112f4(*reinterpret_cast<void***>(r0_27), *reinterpret_cast<void***>(r1_28), r2_29);
    return r0_30;
    addr_11714_14:
    r3_31 = g11894;
    r0_32 = fun_118c8(*reinterpret_cast<void***>(*reinterpret_cast<void***>(r3_31)), sp10, r2_26);
    ...
    r2_34 = r6_14 + 1;
    fun_1197c(r4_33, r2, r2_34);
    r0_35 = fun_118c8(r4_33, r2, r2_34);
    ...
    if (!r4_33) {
        ...
        *reinterpret_cast<void***>(r3_37) = reinterpret_cast<void**>(1);
        ...
        while (r1_39 = g1189c, r0_40 = fun_11940(r4_33, r1_39, r2_34), r6_41 = reinterpret_cast<void*>(reinterpret_cast<unsigned char>(r4_33) + reinterpret_cast<uint32_t>(r0_40)), r0_42 = *reinterpret_cast<unsigned char*>(reinterpret_cast<unsigned char>(r4_33) + reinterpret_cast<uint32_t>(r0_40)), !!r0_42) {
            r2_34 = g118a0;
            ...
            *reinterpret_cast<void***>(r4_33) = reinterpret_cast<void**>(0);
            ...
            r0_50 = fun_11928(*reinterpret_cast<void***>(r7_48), r5_49);
            if (!r0_50) 
                goto label_32;
            ...
            *reinterpret_cast<void**>(reinterpret_cast<uint32_t>(r5_49) + reinterpret_cast<unsigned char>(r0_50) + 0xfffffffc) = r6_41;
            ...
            r0_53 = fun_1194c(r6_41, reinterpret_cast<int32_t>(r0_42 << 24) >> 24);
            r4_33 = r0_53;
            if (!r4_33) {
                r4_33 = r8_36;
            }
    ...
    *reinterpret_cast<void***>(r3_54) = r10_38;
    if (reinterpret_cast<signed char>(r10_38) >= reinterpret_cast<signed char>(0)) {
        ...
        addr_11838_48:
        fun_118b0(66, -1, r2_34, r3_54, v55, v56, v57, v58, v59);
    }
    while (1) {
    }
    label_32:
    ...
    *reinterpret_cast<void***>(r3_54) = reinterpret_cast<void**>(0xffffffff);
    goto addr_11838_48;
    addr_116cc_11:
    fun_118b0(r0_23 + 66, -1, 0x200, r3_24, v60, v61, v62, v63, v64);
    while (1) {
    }
}
...
int32_t fun_118f8(void** r0, int32_t r1, int32_t r2) {
    int32_t* r12_4;
...
void** fun_11524(int32_t r0, void** r1, void** r2, void** r3, void** a5, void** a6, int32_t a7, int32_t a8, void* a9) {
    fun_11514();
    fun_118b0(66, r0, r2, r3, a5, a6, a7, a8, a9);
    while (1) {
    }
}
...
void fun_11000(int32_t r0, int32_t r1, void** r2, void** r3) {
    ...
    r0_5 = fun_1153c();
    fun_11624(r0_5);
    r0_10 = fun_1164c(r0, r1, r2, r3, r4_6, r5_7, r6_8, r7_9, __return_address());
    fun_11514();
    fun_118b0(66, r0_10, r2, r3, r4_6, r5_7, r6_8, r7_9, __return_address());
    while (1) {
    }
}
...
void fun_113c0(int32_t r0) {
    ...
    fun_113b4();
    fun_118b0(66, r0, r2_2, r3_3, v4, v5, v6, v7, v8);
    while (1) {
    }
}
