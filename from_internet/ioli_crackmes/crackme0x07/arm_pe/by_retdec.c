...
int32_t function_11360(int32_t a1);
...
int32_t entry_point(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    // 0x11000
    _fpreset();
    int32_t v1 = function_11360((int32_t)&g9); // 0x11018
    function_11624(function_1153c(v1));
...
int32_t function_11458(void) {
    // 0x11458
    int32_t v1; // 0x11458
    return function_113e4(v1, &g4, &g5);
}

// Address range: 0x11474 - 0x11494
int32_t function_11474(int32_t * a1) {
    int32_t v1 = function_113e4((int32_t)a1, &g4, &g5); // 0x11480
    return v1 == 0;
}
...
int32_t function_1164c(int32_t a1, int32_t a2, int32_t wstr) {
    ...
    *mem2 = v4;
    ...
    int32_t v7 = g7 + 1; // 0x11704
    g7 = v7;
    int32_t v8 = v7; // 0x11710
    if (v3 < 1) {
        goto lab_0x11864;
    } else {
        int32_t str = *(int32_t *)g8; // 0x1171c
        ...
        if (v9 == 0) {
            ...
            while (c != 0) {
                ...
                *(char *)v16 = 0;
                ...
                int32_t * mem3 = realloc((int32_t *)g8, v21); // 0x11804
                if (mem3 == NULL) {
                    // 0x11848
                    g7 = -1;
                    goto lab_0x11838;
  ...
  lab_0x11864:
    // 0x11864
    *(int32_t *)(g8 + 4 * v8) = 0;
    return function_112f4(g7, g8, g8);
  lab_0x11838:
    // 0x11838
