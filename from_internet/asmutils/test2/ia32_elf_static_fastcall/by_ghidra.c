...

{
  ...
  if ((*unaff_retaddr != '\0') &&
     ((*unaff_retaddr < '\0' ||
      (__get_GOT(), iVar4 = param_1_00, **(char **)(unaff_EBX + 0x2d54) == '\0')))) {
    iVar4 = param_2;
  }
...

{
  ...
  uStack00000004 = 0x80493df;
  uVar1 = __get_GOT();
  **(undefined4 **)(unaff_EBX + 0x2c15) = extraout_ECX;
...

{
  ...
  uVar1 = __get_GOT();
  **(undefined4 **)(unaff_EBX + 0x2bfc) = uVar1;
  return;
}
...

{
  ...
  iVar9 = unaff_EBX;
  __get_GOT();
  if (**(char **)(unaff_EBX + 0x2b4d) == '\0') {
    __name = in_stack_00000004;
  }
  __get_GOT();
  ppcVar4 = (char **)**(undefined4 **)(iVar9 + 0x2b2a);
  uVar2 = 0xffffffff;
  pcVar5 = __name;
  do {
    if (uVar2 == 0) break;
