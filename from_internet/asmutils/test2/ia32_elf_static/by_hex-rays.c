...
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  int v14; // eax
  const char *v15; // eax
  _BYTE *v17; // [esp+0h] [ebp-28h] BYREF
  char v18[5]; // [esp+4h] [ebp-24h] BYREF
  _BYTE v19[3]; // [esp+9h] [ebp-1Fh] BYREF
  char v20[2]; // [esp+Eh] [ebp-1Ah] BYREF
  ...
  read((int)&argc);
  i = v3;
  memcpy(v18, v4, v5, v18, v20, v3);
  v7 = strtol(v18, (_BYTE *)(i - 1), v6, v18, &v17, 10);
  printf("You have entered %d\n", v7);
  printf("\n\tmemset() test\n");
  memset(v18, v8, v9, v18, 0, 0xAu);
  v17 = v19;
  for ( i = 9; i > 0; --i )
  {
    memset(v18, v10, v11, v18, i + 48, 5u);
    v14 = strtol(v18, v12, v13, v18, &v17, 10);
    printf("%d ", v14);
  }
  printf("\n\n\tvariable test\n");
  ((void (__cdecl *)(int, _DWORD, _DWORD))write)(-1, 0, 0);
  printf("errno: %d\n", errno);
...
// 8049066: bad sp value at call
// 8049089: bad sp value at call
// 80490BD: bad sp value at call
// 80490E7: bad sp value at call
// 80490FC: bad sp value at call
// 8049054: variable 'v3' is possibly undefined
// 8049066: variable 'v4' is possibly undefined
// 8049066: variable 'v5' is possibly undefined
// 8049089: variable 'v6' is possibly undefined
// 80490BD: variable 'v8' is possibly undefined
// 80490BD: variable 'v9' is possibly undefined
// 80490E7: variable 'v10' is possibly undefined
// 80490E7: variable 'v11' is possibly undefined
// 80490FC: variable 'v12' is possibly undefined
// 80490FC: variable 'v13' is possibly undefined
// 8049600: using guessed type int printf(const char *, ...);
...
// 8049326: positive sp value 4 has been found
// 80492A3: could not find valid save-restore pair for ebx
// 80492A3: could not find valid save-restore pair for esi
...
// 804933A: control flows out of bounds to 804933C
...
// 804934F: control flows out of bounds to 8049351
...
// 804935D: variable 'v2' is possibly undefined
...
// 8049364: control flows out of bounds to 8049366
...
// 8049372: variable 'v4' is possibly undefined
// 8049372: variable 'v3' is possibly undefined
...
// 8049387: variable 'v2' is possibly undefined
...
// 804938E: variable 'v2' is possibly undefined
...
// 8049395: control flows out of bounds to 8049397
...
// 80493AA: control flows out of bounds to 80493AC
...
// 80493C6: control flows out of bounds to 80493C8
...
// 80493E2: variable 'v5' is possibly undefined
...
// 80493E6: positive sp value 8 has been found
// 80493E6: variable 'v4' is possibly undefined
// 8049402: variable 'v3' is possibly undefined
...
// 8049453: could not find valid save-restore pair for ebx
...
// 80494B6: could not find valid save-restore pair for ebx
// 80494B6: could not find valid save-restore pair for esi
// 804C00C: using guessed type _DWORD edata;
...
// 804953C: could not find valid save-restore pair for ebx
...
// 804958B: could not find valid save-restore pair for esi

//----- (08049600) --------------------------------------------------------
#error "804961B: call analysis failed (funcsize=20)"
