...
undefined8
entry(undefined *param_1,undefined4 param_2,char *param_3,int param_4,undefined4 param_5,int param_6
     )
...
code_r0x080480d3:
    pcVar8 = param_3;
    if (param_6 != 0) goto code_r0x080480d3;
...
code_r0x080480d3:
  param_6 = param_6 + -1;
  cVar1 = *param_3;
  pcVar8 = param_3 + (uint)bVar11 * -2 + 1;
  param_3 = param_3 + (uint)bVar11 * -2 + 1;
  if (cVar1 == ':') {
code_r0x080480d5:
    do {
      pcVar6 = pcVar8;
    ...
    *pcVar7 = '\0';
    ...
    if (iVar5 != param_4) {
      do {
        ...
        if (param_6 == 0) break;
        param_6 = param_6 + -1;
        param_3 = pcVar7 + (uint)bVar11 * -2 + 1;
        cVar1 = *pcVar7;
        pcVar7 = param_3;
      } while (cVar1 != '\n');
...
LAB_08048117:
  ...
  for (; *unaff_ESI != 0; unaff_ESI = unaff_ESI + 1) {
    iVar4 = iVar4 * 10 + (*unaff_ESI & 0xffffffcf);
  }
  return CONCAT44(extraout_EDX,iVar4);
}
