...
unsigned int main(unsigned int* param0, unsigned int* param1) {
    ...
    len = v5;
    unsigned int v6 = (unsigned int)&open((int)fname, 66, 384);
    fd = v6;
    &write();
    &loc_804920E();
    unsigned int v7 = (unsigned int)&open((int)fname, 0);
    fd = v7;
    0x8049223();
    unsigned int v8 = (unsigned int)&read();
    len = v8;
    &loc_804920E();
    sub_804924D((int)__s, ptr3, ptr2, v4, ptr0, ptr1);
    &write();
    unsigned int v9 = (unsigned int)&read();
    len = v9;
    &write();
    return len;
}
...
int sub_804924D(int param0, unsigned int* param1, unsigned int* param2, int param3, unsigned int* param4, unsigned int* param5) {
    int v0;
    int* ptr0;
    int v1;
