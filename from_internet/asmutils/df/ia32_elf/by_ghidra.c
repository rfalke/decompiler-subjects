...

{
  ...
  if ((in_stack_00000008 == (short *)0x0) || (*in_stack_00000008 != 0x2d2d)) {
    ...
    if (iVar3 < 0) {
      ...
      in_stack_00000014 = 0x17;
      puVar8 = (undefined4 *)&stack0x00000018;
    }
  }
  else if ((*(int *)(in_stack_00000008 + 1) != 0x706c6568) &&
          (puVar8 = &stack0x0000000c, *(int *)(in_stack_00000008 + 1) != 0x73726576))
  goto LAB_0804847f;
