...
struct Eq_623 * g_ptr403040 = null; // 0000000000403040
...
void fn000000000040139B(Eq_98 rdx, word32 edi)
{
	...
	fn0000000000401AA1((byte) (uint64) (word32) (uint64) edi);
}

// 00000000004013C5: Register Eq_114 Win32CrtStartup()
Eq_114 Win32CrtStartup()
{
	word64 rax_31;
	...
	if ((word32) rax_31 != 0x00)
	{
		g_t403000.u2 = 0x04;
		GetCommandLineW();
		Eq_127 rax_64 = SEQ(dwLocE078, GetEnvironmentStringsW());
		...
		if ((word16) rax_97 <= 55295)
		{
			...
			eax_112 = (word32) (uint64) fn00000000004019FA((word64) fp - 0x0000E04C, rax_64);
		word64 rcx_118 = fp + ~0x8037;
		uint64 r8_123 = 0x00;
		Eq_127 rdx_125 = (word64) rax_64 + (uint64) eax_112 * 0x02;
		while (dwLocE04C != 0x00)
		{
			...
			{
				Eq_135 rax_254 = 0x00;
				if (rcx_118 < fp - (struct Eq_888 *) 0x3A)
					rax_254 = rcx_118;
				*((word64) fp + (r8_123 * 0x08 - 0x0000E040)) = rax_254;
			}
			do
			{
				up32 r9d_265 = (word32) (uint64) dwLocE04C;
				Eq_234 rax_267 = (int64) r9d_265;
				if (r9d_265 > 0x7F)
					rax_267 = fn0000000000401A09(rcx_118, (word32) (uint64) r9d_265);
				do
				{
				...
				word32 eax_316;
				uint64 rax_297 = (uint64) (word32) *rdx_125;
				word32 eax_310 = (word32) rax_297;
				if ((word16) rax_297 <= 55295)
				{
					...
					eax_316 = SLICE(CONVERT(fn00000000004019FA(fp + ~0xE04B, rdx_125), uint32, uint64), word32, 0);
		...
		if (rcx_148 > (struct Eq_247 *) 0x7FFE)
			rcx_148 = (struct Eq_247 *) 0x7FFE;
		if (r8_123 > 0x01FF)
			r8_123 = 0x01FF;
		...
		*((word64) fp + (r8_123 * 0x08 - 57400)) = 0x00;
		...
		fn000000000040139B(fp + ~0xE037, SLICE(CONVERT(SLICE(CONVERT(fn000000000040134D(), uint32, uint64), word32, 0), word32, uint64), word32, 0));
	}
	else
	{
...
// 0000000000401601: void fn0000000000401601(Register (ptr64 Eq_375) rdi)
// Called from:
//      fn000000000040165C
void fn0000000000401601(struct Eq_375 * rdi)
{
	word32 eax_22;
	Eq_127 rdi_6 = rdi->t0000;
	...
	if ((word16) rax_8 <= 55295)
	{
		...
		eax_22 = (word32) (uint64) fn00000000004019FA(&rdi->dw0018, rdi_6);
	rdi->t0000 = (word64) rdi->t0000 + (uint64) eax_22 * 0x02;
}

// 000000000040162C: Register Eq_135 fn000000000040162C(Register Eq_135 rcx, Register Eq_413 esi, Register (ptr64 Eq_414) rdi)
// Called from:
//      fn000000000040165C
Eq_135 fn000000000040162C(Eq_135 rcx, Eq_413 esi, struct Eq_414 * rdi)
{
	Eq_413 esi = (word32) rsi;
	word32 edi_14 = (word32) (uint64) esi;
	Eq_135 r8_10 = rdi->t0010;
	Eq_234 rax_11 = (int64) esi;
	if (esi > 0x7F)
		rax_11 = fn0000000000401A09(rcx, edi_14);
	do
	{
		byte al_29 = (byte) rax_69;
		Eq_135 rcx_23 = rdi->t0008;
		if (r8_10 <= rcx_23)
			return rcx_23;
...
// 000000000040165C: void fn000000000040165C(Register Eq_135 rcx, Register uint64 rdx, Register Eq_137 rsi, Register uint64 r8)
// Called from:
//      Win32CrtStartup
void fn000000000040165C(Eq_135 rcx, uint64 rdx, Eq_137 rsi, uint64 r8)
{
	fn0000000000401601(fp - 88);
	Eq_137 rax_8 = (word64) rsi.u1 + rdx;
	uint64 rbx_115 = 0x00;
	rcx_234 = rcx;
l00000000004016A3:
	Eq_135 rcx_234;
	if (dwLoc40 != 0x00)
	{
		while (true)
		{
			...
			if (eax_58 > 0x20 || __bt(0x100002600, rax_57))
			{
				...
				Eq_501 r14b_187 = 0x00;
				while (true)
				{
					Eq_413 rsi_182 = (uint64) dwLoc40;
					...
					rcx_234 = fn000000000040162C(rcx_234, rsi_182, fp - 88);
					fn0000000000401601(fp - 88);
				}
...
void fn0000000000401907(Eq_98 rdx, uint64 rdi)
{
	...
	{
l000000000040191B:
		struct Eq_623 * rdi_24 = g_ptr403040;
		if (rdi_24 == null)
			break;
l0000000000401928:
		...
		do
		{
			...
			if (rax_33 == 0x00)
			{
				struct Eq_623 * r13_43 = rdi_24->ptr0008;
				if (rdi != 0x00)
				{
					if (r13_43 == null)
						return;
...
// 00000000004019FA: Register word32 fn00000000004019FA(Register Eq_198 rsi, Register Eq_127 rdi)
// Called from:
//      Win32CrtStartup
//      fn0000000000401601
word32 fn00000000004019FA(Eq_198 rsi, Eq_127 rdi)
{
	__align(fp - 8);
	return (word32) (uint64) fn0000000000401A3C(rsi, rdi);
}

// 0000000000401A09: Register ui64 fn0000000000401A09(Register Eq_135 rcx, Register word32 edi)
// Called from:
//      Win32CrtStartup
//      fn000000000040162C
ui64 fn0000000000401A09(Eq_135 rcx, word32 edi)
{
	...
	if (edi_14 > 0x7F)
	{
		...
		do
		{
			...
			Eq_722 rax_36 = SEQ(rax_56_8_35, al_32 | 0x80 | (byte) ((uint64) edi_14) & 0x3F);
...
// 0000000000401A3C: Register word32 fn0000000000401A3C(Register Eq_198 rsi, Register Eq_127 rdi)
// Called from:
//      fn00000000004019FA
word32 fn0000000000401A3C(Eq_198 rsi, Eq_127 rdi)
{
	word32 eax_27 = 0x00;
	do
	{
...
Eq_877 g_a401AE9[] = // 0000000000401AE9
	{
	};
