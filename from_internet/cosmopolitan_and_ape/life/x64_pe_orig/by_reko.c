...
struct Eq_600 * g_ptr403040 = null; // 0000000000403040
...
Eq_111 Win32CrtStartup()
{
	...
	if ((word32) rax_31 != 0x00)
	{
		...
		while (dwLocE04C != 0x00)
		{
			...
			{
				Eq_132 rax_254 = 0x00;
				if (rcx_118 < fp - (struct Eq_853 *) 0x3A)
					rax_254 = rcx_118;
...
// 000000000040162C: Register Eq_132 fn000000000040162C(Register Eq_132 rcx, Register Eq_177 esi, Register (ptr64 Eq_394) rdi)
// Called from:
//      fn000000000040165C
Eq_132 fn000000000040162C(Eq_132 rcx, Eq_177 esi, struct Eq_394 * rdi)
{
	Eq_177 esi = (word32) rsi;
...
void fn0000000000401907(Eq_98 rdx, uint64 rdi)
{
	...
	{
l000000000040191B:
		struct Eq_600 * rdi_24 = g_ptr403040;
		if (rdi_24 == null)
			break;
l0000000000401928:
		...
		do
		{
			...
			if (rax_33 == 0x00)
			{
				struct Eq_600 * r13_43 = rdi_24->ptr0008;
				if (rdi != 0x00)
				{
					if (r13_43 == null)
						return;
...
// 0000000000401A09: Register ui64 fn0000000000401A09(Register Eq_132 rcx, Register Eq_177 edi)
// Called from:
//      Win32CrtStartup
//      fn000000000040162C
ui64 fn0000000000401A09(Eq_132 rcx, Eq_177 edi)
{
	...
	if (edi_14 > 0x7F)
	{
		...
		do
		{
			...
			Eq_695 rax_36 = SEQ(rax_56_8_35, al_34);
...
Eq_842 g_a401AE9[] = // 0000000000401AE9
	{
	};
