...
bb0x401218:
                ...
                if (*0x4064e8 != 0) {
                    *(__size32*)(esp_1 - 16) = 0x4064e8;
                    ...
                    if (eax != 0) {
                        ...
                        *(__size32*)(esp_1 - 20) = 2;
                        *(__size32*)(esp_1 - 24) = 0;
                        (*global_0x004064e8)(ax, cx, dl, eax, ecx, edx, 0, ebp, 1, 0x4064cc, LOGICALFLAGS32(eax), LOGICALFLAGS32(eax), LOGICALFLAGS32(eax), 16, 0x405148, pc);
                        local3 = esp;
                    }
                }
                esp = local3;
                ...
                *(__size32*)ecx = global_0x0040616c;
                ...
                eax = proc_0x00401010(); /* Warning: also results in esp, ebp */
...
__size32 proc_0x00401010()
{
    ...
    *(int*)0 = (esp - 16);
    _CxxThrowException((esp - 28), 0x405080);
    return 0x40106f; /* WARNING: Also returning: ebp := (esp - 4) */
}
