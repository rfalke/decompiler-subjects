...
void deregister_tm_clones() {
    ...
    r3_1 = d;
    if (reinterpret_cast<uint32_t>(r3_1 - 0x105a8) <= 6) {
        return;
    } else {
        if (1) {
            return;
...
void _start(int32_t r0) {
    ...
    r0_4 = abort();
    if (z5) {
        *reinterpret_cast<uint32_t*>(&v6) = reinterpret_cast<uint32_t>(r0_4) & (r4_7 >> r4_8 | r4_9 << reinterpret_cast<uint32_t>(32 - r4_10));
    }
    if (z11) {
        *r0_4 = v6;
    }
