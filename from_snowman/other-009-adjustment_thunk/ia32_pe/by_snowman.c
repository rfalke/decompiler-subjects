...
int32_t fun_4018f0(struct s12* a1) {
    ...
    if (a1->f0 != 0x5a4d || (eax2 = reinterpret_cast<struct s24*>(a1->f3c + reinterpret_cast<int32_t>(a1)), eax2->f0 != 0x4550)) {
        return 0;
    } else {
        edx3 = 0;
...
int32_t fun_40106e(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, struct s0* a7, struct s0* a8, struct s0* a9) {
    ...
    if (!eax10) {
        ...
        eax10->f4 = 10;
        eax10->f8 = 0x40374c;
        eax10->f10 = reinterpret_cast<int32_t*>(0x40375c);
        eax10->f0 = 0x40378c;
        eax10->f8 = 0x40377c;
        eax10->f10 = reinterpret_cast<int32_t*>(0x40376c);
        edx13 = *eax10->f10;
        edx13();
        return 0;
    }
...
void fun_40155d(int32_t ecx) {
    ...
    *reinterpret_cast<int32_t*>(ebp11 - 4) = -2;
    ...
    esp12->f0 = 0x401598;
    fun_401a95(ecx, esp12->f4, esp12->f8, esp12->fc, esp12->f10);
    goto esp12->f4;
}
