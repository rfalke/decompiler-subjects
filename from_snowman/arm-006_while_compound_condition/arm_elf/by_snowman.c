...
void deregister_tm_clones() {
    ...
    r3_1 = d;
    if (reinterpret_cast<uint32_t>(r3_1 - 0x10640) <= 6) {
        return;
    } else {
        if (1) {
            return;
...
void g(int32_t* r0, int32_t* r1, int32_t* r2) {
    *r0 = *r0 + 1;
    *r1 = *r1 - 1;
    *r2 = *r1 * *r0;
    return;
...
void f(int32_t r0, int32_t r1, int32_t r2) {
    ...
    while (v5) {
        ...
        if (!v7) 
            goto addr_8488_6;
        g(reinterpret_cast<int32_t>(r11_4) - 8, reinterpret_cast<int32_t>(r11_4) - 12, reinterpret_cast<int32_t>(r11_4) - 16);
    }
    addr_8488_6:
    return;
    label_4:
