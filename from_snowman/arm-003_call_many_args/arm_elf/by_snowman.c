...
void deregister_tm_clones() {
    ...
    r3_1 = d;
    if (reinterpret_cast<uint32_t>(r3_1 - 0x105e8) <= 6) {
        return;
    } else {
        if (1) {
            return;
...
int32_t f(int32_t r0, int32_t r1, int32_t r2, int32_t r3, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9) {
    return 0x18894;
}
...
void _start(int32_t r0) {
    ...
    if (z5) {
        *r0_4 = static_cast<int16_t>(r8_6);
        r0_4 = reinterpret_cast<int16_t*>(reinterpret_cast<int32_t>(r0_4) - r4_7);
    }
    if (z8) {
        *r0_4 = v9;
    }
