...
void deregister_tm_clones() {
    ...
    r3_1 = d;
    if (reinterpret_cast<uint32_t>(r3_1 - 0x106a0) <= 6) {
        return;
    } else {
        if (1) {
            return;
...
void _start(int32_t r0) {
    ...
    r0_4 = abort();
    if (z5) {
        *reinterpret_cast<uint32_t*>(&v6) = reinterpret_cast<uint32_t>(r0_4) & reinterpret_cast<uint32_t>(r4_7 >> r5_8);
    }
    if (z9) {
        *reinterpret_cast<uint32_t*>(&v6) = reinterpret_cast<uint32_t>(r0_4) & reinterpret_cast<uint32_t>(reinterpret_cast<int32_t>(r0_4) >> 9);
    }
    if (!z10) 
        goto "???";
    *r0_4 = v6;
...
int32_t main() {
    ...
    _Z1gb(static_cast<uint32_t>(*reinterpret_cast<unsigned char*>(&r3_2)));
    return 0;
}
