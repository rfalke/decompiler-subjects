...
undefined4 Catch_004010a3(void)
...
undefined4 Catch_004010cb(void)
...
undefined4 Catch_004010e1(void)

{
  int unaff_EBP;
  
  *(int *)(unaff_EBP + 8) = *(int *)(unaff_EBP + 8) + 10;
  *(undefined4 *)(unaff_EBP + -4) = 0xffffffff;
  return 0x4010fe;
}
...

{
  ...
  bVar1 = false;
  do {
    LVar2 = InterlockedCompareExchange((LONG *)&DAT_004064cc,Exchange,0);
    if (LVar2 == 0) {
LAB_0040127c:
      if (DAT_004064bc == 1) {
        _amsg_exit(0x1f);
        ...
        if (DAT_004064bc == 0) {
          DAT_004064bc = 1;
          Exchange = _initterm_e(&DAT_0040430c,&DAT_00404618);
          if (Exchange != 0) {
            return 0xff;
          }
        }
      ...
      if ((_DAT_004064e8 != (code *)0x0) &&
         (BVar3 = __IsNonwritableInCurrentImage(&DAT_004064e8), BVar3 != 0)) {
        (*_DAT_004064e8)(0,2,0);
      }
      *(undefined4 *)__initenv_exref = DAT_0040616c;
      DAT_00406180 = thunk_FUN_00401010(DAT_00406168);
      if (_DAT_00406174 != 0) {
        if (_DAT_00406184 == 0) {
          _cexit();
        }
...

{
  ...
  DAT_00406298 = local_res0;
  _DAT_0040629c = in_CS;
  _DAT_004062a8 = in_SS;
  _DAT_004061d8 = IsDebuggerPresent();
  _crt_debugger_hook(1);
  SetUnhandledExceptionFilter((LPTOP_LEVEL_EXCEPTION_FILTER)0x0);
  UnhandledExceptionFilter((_EXCEPTION_POINTERS *)&PTR_DAT_00404744);
  if (_DAT_004061d8 == 0) {
    _crt_debugger_hook(1);
  }
...

{
  int iVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x004017fe. Too many branches
                    // WARNING: Treating indirect jump as call
  iVar1 = _XcptFilter();
  return iVar1;
}
...

{
  ...
  *(uint *)((int)auStack28 + param_2 + 4) = DAT_00406020 ^ (uint)&param_2;
...
void __cdecl
FUN_004019c9(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
{
                    // WARNING: Could not recover jumptable at 0x00401af2. Too many branches
                    // WARNING: Treating indirect jump as call
  terminate();
  return;
}
...
{
                    // WARNING: Could not recover jumptable at 0x00401b04. Too many branches
                    // WARNING: Treating indirect jump as call
  __dllonexit();
  return;
}
...
{
                    // WARNING: Could not recover jumptable at 0x00401b10. Too many branches
                    // WARNING: Treating indirect jump as call
