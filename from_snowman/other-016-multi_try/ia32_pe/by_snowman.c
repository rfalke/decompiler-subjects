...
struct s12* fun_401850(struct s13* a1, uint32_t a2) {
    ...
    ecx3 = reinterpret_cast<struct s21*>(a1->f3c + reinterpret_cast<int32_t>(a1));
    eax4 = ecx3->f14;
    esi5 = ecx3->f6;
    edx6 = 0;
...
int32_t fun_401810(struct s11* a1) {
    ...
    if (a1->f0 != 0x5a4d || (eax2 = reinterpret_cast<struct s22*>(a1->f3c + reinterpret_cast<int32_t>(a1)), eax2->f0 != 0x4550)) {
        return 0;
    } else {
        edx3 = 0;
...
void fun_40136b(int32_t ecx) {
    ...
    *reinterpret_cast<int32_t*>(ebp11 - 4) = -2;
    ...
    esp12->f0 = 0x4013a6;
    fun_4019b5(ecx, esp12->f4, esp12->f8, esp12->fc, esp12->f10);
    goto esp12->f4;
}
