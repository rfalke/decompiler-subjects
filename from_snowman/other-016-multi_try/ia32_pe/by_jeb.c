...
int _IsNonwritableInCurrentImage(unsigned int param0) {
    ...
    int v6 = v5 ^ &gvar_405218;
    int* ptr0 = (int*)(v5 ^ (int)&v0);
    *(int**)__FS_BASE = &v3;
    int* ptr1 = &ptr0;
    int v7 = 0;  // __try{ (see __except:40193Eh)
...
void __report_gsfailure() {
    ...
    UnhandledExceptionFilter((_EXCEPTION_POINTERS*)&gvar_404744);
    if(!gvar_4061D8) {
        →MSVCR100.dll!_crt_debugger_hook();
    }
...
_onexit_t _onexit(_onexit_t _Func) {
    ...
    if(v4 == -1) {
        ...
        →MSVCR100.dll!_lock();
        v2 = 0;  // __try{ (see __finally:401786h)
...
unsigned int sub_401010(unsigned int param0) {
    char v0;
    int* ptr0;
    *(int*)&v0 = -1;
    int v1 = &unk_lib_sub3;
    ...
    *(int**)__FS_BASE = &v2;
    int* ptr1 = &ptr0;
    *(int*)&v0 = 0;  // try{ (see catch:4010CBh,catch:4010E1h)
    ++param0;
    if(param0 == 10) {
        int v3 = 0;
        /*NO_RETURN*/ →MSVCR100.dll!_CxxThrowException(&v3, (_ThrowInfo*)0x405084);
    }
    v0 = 1;  // try{ (see catch:4010A3h)
    param0 += 6;
    if(param0 == 7) {
        int v4 = 0;
        /*NO_RETURN*/ →MSVCR100.dll!_CxxThrowException(&v4, (_ThrowInfo*)0x405070);
    }
    *(int*)&v0 = 0;  // } (starts at 401070h)
    *(int*)&v0 = -1;  // } (starts at 40103Ch)
    *(int*)__FS_BASE = v2;
    return param0 + 3;
}

unsigned int sub_40121E() {
    unsigned int result;
    int v0;
    int v1;
    int v2;
    ...
    int v4 = 0;  // __try{ (see __except:40136Bh)
    ...
    loc_4012D1:
        ...
        *ptr0 = gvar_406168;
        --ptr0;
        *ptr0 = &loc_401340;
        unsigned int v10 = /*BAD_CALL!*/ sub_401010(*(ptr0 + 1));
        ptr0 += 3;
        gvar_406180 = v10;
        if(gvar_406174 == 0) {
            --ptr0;
...
int unk_lib_sub() {
    ...
    while((unsigned int)ptr0 < 4214112);
    return result;
}

int unk_lib_sub2() {
    int result;
    int* ptr0 = (int*)&gvar_404E68;
    do {
        result = *ptr0;
        if(result) {
            result = result();
    ...
    while((unsigned int)ptr0 < 4214632);
    return result;
}

int unk_lib_sub3(int param0, int param1) {
    __security_check_cookie((uintptr_t)((param1 + 12) ^ *(int*)(param1 - 28)));
