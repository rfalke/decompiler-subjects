...
__size32 proc_0x004018a0(unsigned int param1, unsigned char param2, unsigned int param3, unsigned int param4);
__size32 proc_0x00401010(__size32 param1);
void proc_0x004019b5(union { __size32; __size32 *; } param1);
__size32 proc_0x00401810(union { __size16 *; __size32; } param1, unsigned char param2, unsigned int param3);
...
void proc_0x00401a50(int param1, int param2)
{
    ...
    if (global_0x00406020 == 0xbb40e64e || (global_0x00406020 & ~0xffff) == 0) {
        ...
        eax = GetTickCount();
        esi_4 = 0 ^ eax_1 ^ eax_2 ^ eax;
        QueryPerformanceCounter();
        eax = param2 ^ param1;
        esi_1 = esi_4 ^ eax;
        local2 = esi_1;
        if ((esi_4 ^ eax) != 0xbb40e64e) {
            if (((esi_4 ^ eax) & ~0xffff) == 0) {
                esi = esi_4 ^ eax | (esi_4 ^ eax | 0x4711) << 16;
                local2 = esi;
            }
        }
        else {
