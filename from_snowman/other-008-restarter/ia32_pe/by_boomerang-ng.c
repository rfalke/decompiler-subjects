...
void proc_0x00401000(__size32 param1, __size32 param2)
{
    ...
    unsigned int esp_8; 		// r28{0}
    unsigned int esp_9; 		// r28{0}
    ...
    int local14; 		// m[esp_8 - 4]{0}
    int local15; 		// m[esp_8 - 4]{0}
    int local16; 		// m[esp_8 - 8]{0}
    int local17; 		// m[esp_8 - 8]{0}
    int local18; 		// m[esp_8 - 16]{0}
    int local19; 		// m[esp_8 - 16]{0}
    __size32 local2; 		// m[esp - 16]
    int local20; 		// m[esp_8 - 20]{0}
    int local21; 		// m[esp_8 - 20]{0}
    int local22; 		// m[esp_8 - 24]{0}
    int local23; 		// m[esp_8 - 24]{0}
    int local24; 		// m[esp_8 - 28]{0}
    int local25; 		// m[esp_8 - 28]{0}
    int local26; 		// m[esp_8 - 32]{0}
    int local27; 		// m[esp_8 - 32]{0}
    int local28; 		// m[esp_8 - 36]{0}
    int local29; 		// m[esp_8 - 36]{0}
    __size32 local3; 		// m[esp - 20]
    int local30; 		// m[esp_8 - 40]{0}
    int local31; 		// m[esp_8 - 40]{0}
    int local32; 		// m[esp_8 - 44]{0}
    int local33; 		// m[esp_8 - 44]{0}
    int local34; 		// m[esp_8 - 48]{0}
    int local35; 		// m[esp_8 - 48]{0}
    int local36; 		// m[esp_8 - 52]{0}
    int local37; 		// m[esp_8 - 52]{0}
    int local38; 		// m[esp_8 - 56]{0}
    int local39; 		// m[esp_8 - 56]{0}
    __size32 local4; 		// m[esp - 24]
    int local40; 		// m[esp_8 - 60]{0}
    int local41; 		// m[esp_8 - 60]{0}
    int local42; 		// %flags{0}
    int local43; 		// %flags{0}
    int local44; 		// %ZF{0}
    int local45; 		// %ZF{0}
    ...
    (*0x2404)(eax, param1, edx, param2, esp_8 - 4, 0x2404, eax_4, SUBFLAGS32(esp_8 - 4, 8, (esp_8 - 12)), esp_8 == 12, (unsigned int)(esp_8 - 4) < 8, ebp, param1, ebx, esi, edi, 0, 0, esp_8 - 8, 1024, eax_4, 0, 0x1300, param1, pc);
    ...
    *(__size32*)(esp_4 - 8) = 64;
    eax_1 = LocalAlloc(*(esp_4 - 8), *(esp_4 - 4));
    ecx = *(ebp + 8);
    eax_5 = *(ebp - 4);
    ...
    *(HLOCAL*)(esp_4 - 24) = eax_1;
    wsprintfW();
    *(__size32*)(esp_4 - 4) = 0;
    *(__size32*)(esp_4 - 8) = 0x402234;
    *(HLOCAL*)(esp_4 - 12) = eax_1;
    *(__size32*)(esp_4 - 16) = 0;
    *(__size16*)(eax_1 + 0x800) = 0;
    ecx = MessageBoxW(*(esp_4 - 16), *(esp_4 - 12), *(esp_4 - 8), *(esp_4 - 4)); /* Warning: also results in edx */
    eax_6 = *(ebp - 4);
    *(__size32*)(esp_4 - 4) = eax_6;
    (*0x2462)(0, eax_6, ecx, edx, 0x2462, ebp, eax_1, edi, <all>, LOGICALFLAGS32(0), LOGICALFLAGS32(0), LOGICALFLAGS32(0), local15, local17, local19, local21, local23, local25, local27, local29, local31, local33, local35, local37, local39, local41);
    *(__size32*)(esp_7 - 4) = esi;
    (*ebx)(dx, eax, ecx, edx, ebx, ebp, esi, edi, <all>, local43, local45, local47, *(esp_8 - 4), *(esp_8 - 8), *(esp_8 - 16), *(esp_8 - 20), *(esp_8 - 24), *(esp_8 - 28), *(esp_8 - 32), *(esp_8 - 36), *(esp_8 - 40), *(esp_8 - 44), *(esp_8 - 48), *(esp_8 - 52), *(esp_8 - 56), *(esp_8 - 60));
    local0 = edi;
    ExitProcess(*(esp - 4));
    return;
}
...
__size32 proc_0x004010a0()
{
    ...
    union { __size32 *; __size32; } local10; 		// esp{0}
    __size32 local11; 		// esp_7{0}
    __size32 local12; 		// esi{0}
    __size32 local13; 		// esp_16{0}
...
void _start(__size32 param2, unsigned int param2, __size32 param3)
{
    ...
    unsigned int eax_14; 		// r24{0}
    __size32 eax_17; 		// r24{0}
    unsigned int eax_18; 		// r24{0}
    LPWSTR eax_2; 		// r24{0}
    union { unsigned int; __size16 *; } eax_21; 		// r24{0}
    ...
    __size32 esp; 		// r28
    int local0; 		// m[esp - 4]
    union { __size16 *; unsigned int; } local1; 		// eax_21{0}
    unsigned int local2; 		// esi_1{0}
    unsigned int local3; 		// eax_13{0}
    __size32 local4; 		// ecx_1{0}
    __size32 local5; 		// ecx_4{0}
