...
// WARNING: Removing unreachable block (ram,0x000083b8)
// WARNING: Removing unreachable block (ram,0x000083a8)
...
// WARNING: Removing unreachable block (ram,0x000083e4)
// WARNING: Removing unreachable block (ram,0x000083f0)
// WARNING: Removing unreachable block (ram,0x000083f4)
...
// WARNING: Removing unreachable block (ram,0x00008450)
...

{
  if (*param_1 == (int *)0x0) {
    *param_1 = param_2;
    ...
    insert(*param_1 + 2,param_2);
  }
  else if (**param_1 < *param_2) {
    insert(*param_1 + 1,param_2);
  }
  return;
}
...
void printout(undefined4 *param_1)
...

{
  ...
  for (local_c = 1; local_c < 0xb; local_c = local_c + 1) {
    local_10 = (int *)malloc(0xc);
    local_10[1] = 0;
    local_10[2] = local_10[1];
    iVar1 = rand();
    *local_10 = iVar1;
    insert(&local_14,local_10);
  }
  printout(local_14);
  return 0;
}
...
// WARNING: Removing unreachable block (ram,0x0000863c)
