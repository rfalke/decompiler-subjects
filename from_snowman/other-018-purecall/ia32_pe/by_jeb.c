...
int _IsNonwritableInCurrentImage(unsigned int param0) {
    ...
    *(int**)__FS_BASE = &v3;
    int* ptr1 = &ptr0;
    int v7 = 0;  // __try{ (see __except:40175Eh)
...
_onexit_t _onexit(_onexit_t _Func) {
    ...
    if(v4 == -1) {
        ...
        →MSVCR100.dll!_lock();
        v2 = 0;  // __try{ (see __finally:4015A4h)
...
unsigned int sub_401142() {
    ...
    int v4 = 0;  // __try{ (see __except:40128Fh)
    ...
    loc_4011F5:
        ...
        *(unsigned int*)0x6304 = gvar_405174;
        --ptr0;
        *ptr0 = gvar_405174;
        --ptr0;
        *ptr0 = gvar_405178;
