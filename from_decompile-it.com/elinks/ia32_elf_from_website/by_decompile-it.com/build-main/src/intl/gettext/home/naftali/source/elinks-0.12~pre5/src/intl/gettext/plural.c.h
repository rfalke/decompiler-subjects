...
/******                                                                             ******/
/*****************************************************************************************/
void gettext_free_exp__( struct expression * );
struct expression  *new_exp( int , enum operator  , struct expression ** );
...
/******                                                                             ******/
/*****************************************************************************************/
static unsigned char yytranslate[263];
static unsigned char yyr1[14];
static unsigned char yyr2[14];
static unsigned char yydefact[27];
static yysigned_char yydefgoto[3];
static yysigned_char yypact[27];
static yysigned_char yypgoto[3];
static unsigned char yytable[55];
static yysigned_char yycheck[55];
/*****************************************************************************************/
/******                                                                             ******/
