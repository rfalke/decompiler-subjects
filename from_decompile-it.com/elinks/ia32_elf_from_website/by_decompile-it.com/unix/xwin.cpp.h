...
/******                                                                             ******/
/*****************************************************************************************/
char *UNIX_stradd( char *, char * );
bool HandleXEvents( bool  );
int XWIN_test_abort( void );
void XWIN_display_finished( void );
void GetBestIndex( long , long , long , struct XColor * );
struct XColor  *GetBestColor( long , long , long  );
void XWIN_display_plot_box( int , int , int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
void PlotPixel( int , int , unsigned char , unsigned char , unsigned char , unsigned char  );
void XWIN_display_plot_rect( int , int , int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
void XWIN_display_plot( int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
int HandleXIOError( Display * );
void GetBestGraymap( struct Visual * );
int HandleXError( Display *, struct XErrorEvent * );
void XWIN_finish_povray( void );
int XWIN_display_init( int , int  );
void XWIN_init_povray( int *, char *** );
namespace pov {
void Destroy_Image( IMAGE * );
IMAGE *Create_Image( void );
void pov_free( void *, char *, int  );
void *pov_malloc( size_t , char *, int , char * );
...
int pov_stricmp( char *, char * );
}
int XQueryColors( Display *, Colormap , void *, int  );
int XFree( void * );
int XStoreName( Display *, Window , void * );
int __cxa_guard_acquire( void * );
int __fprintf_chk( FILE *, int , char *, ... );
int XFreeColormap( Display *, Colormap  );
int __printf_chk( int , char *, ... );
XImage *XCreateImage( Display *, void *, unsigned int , int , int , char *, unsigned int , unsigned int , int , int  );
char *getenv( char * );
char *strncpy( char *, char *, unsigned int  );
int XpmCreatePixmapFromData( Display *, Drawable , char **, void *, void *, void * );
void XSetWMNormalHints( Display *, Window , void * );
int XSetClassHint( Display *, Window , void * );
Window XCreateWindow( Display *, Window , int , int , unsigned int , unsigned int , unsigned int , int , unsigned int , void *, unsigned int , void * );
...
char *XDisplayName( void * );
int XDrawRectangle( Display *, Drawable , GC , int , int , unsigned int , unsigned int  );
int XNextEvent( Display *, void * );
void *XSetWMProtocols( Display *, Window , void *, int  );
char *strcpy( char *, char * );
void *XSetIOErrorHandler( void * );
int XMapWindow( Display *, Window  );
int XSetWindowBackground( Display *, Window , unsigned int  );
int XSetIconName( Display *, Window , void * );
GC XCreateGC( Display *, Drawable , unsigned int , void * );
int XSelectInput( Display *, Window , long  );
time_t time( void * );
int XFlush( Display * );
int XStoreColors( Display *, Colormap , void *, int  );
void __stack_chk_fail( void );
int XPutImage( Display *, Drawable , GC , XImage *, int , int , int , int , unsigned int , unsigned int  );
KeySym XKeycodeToKeysym( Display *, unsigned int , void *, int  );
int XSetWindowBackgroundPixmap( Display *, Window , Pixmap  );
void *XAllocColor( Display *, Colormap , void * );
Atom XInternAtom( Display *, void *, void * );
void *XGetVisualInfo( Display *, long , void *, int * );
int XSetCommand( Display *, Window , char **, int  );
XImage *XGetSubImage( Display *, Drawable , int , int , unsigned int , unsigned int , unsigned int , int , XImage *, int , int  );
...
int XStoreColor( Display *, Colormap , void * );
void exit( int  );
int XSetWMHints( Display *, Window , void * );
int XPending( Display * );
int XParseGeometry( void *, int *, int *, int *, int * );
/*****************************************************************************************/
/******                                                                             ******/
...
static int theDispWidth;
static int theDispHeight;
static char *home;
static char *bg_filename;
static Pixmap bg_pixmap;
static int xpm_status;
static struct XpmAttributes  xpm_attributes;
static char *xpovicon[248];
static char *xbgmap[20];
static int *theErrors[3];
static char *theCLASS;
static int oargc;
static char **oargv;
static int nargc;
static char **nargv;
static char *theDisplayName;
static char *theName;
static char *theTitle;
static char *theCustomTitle;
static int theClass;
static int theXVal;
static int theYVal;
static int theCurrY;
static int theMaxY;
static int theParameters;
static unsigned int theBorderWidth;
...
static unsigned long theColorShift[3];
static unsigned long theColorSize[3];
static bool fastbig;
static bool fastlittle;
static Colormap theColormap;
static unsigned int theCells;
static int theMaxCell;
static unsigned long theMaxDist;
static struct XColor  *theColorCube;
static struct XColor  *theColors;
static IMAGE *theBackground;
extern struct pov_frontend::DefaultRenderFrontend  *globalDefaultRenderFrontendPointer;
static short size;
static int count;
/*****************************************************************************************/
/******                                                                             ******/
