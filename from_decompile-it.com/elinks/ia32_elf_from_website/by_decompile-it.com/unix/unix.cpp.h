...
int unix_parse_ini_file( char *, struct ProcessRenderOptions &, POVMSObjectPtr  );
void UNIX_abort_start( void );
void UNIX_timer_stop( void );
void UNIX_timer_start( void );
int UNIX_system( char * );
char *UNIX_strndup( char *, size_t  );
char *UNIX_strdup( char * );
char *UNIX_stradd( char *, char * );
char *UNIX_getcwd( void );
void UNIX_abort_handler( int  );
void UNIX_free_globals( void );
char *UNIX_canonicalize_path( char * );
void unix_parse_conf_file( FILE *, char *, bool  );
bool unix_subdir( char *, PathList *, bool  );
char *unix_try_temp_file( char * );
int main( int , char ** );
int UNIX_allow_file_write( char *, unsigned int  );
int UNIX_allow_file_read( char *, unsigned int  );
...
bool Write_Benchmark_File( char *, char * );
void pov_free( void *, char *, int  );
void *pov_malloc( size_t , char *, int , char * );
void *pov_realloc( void *, size_t , char *, int , char * );
...
namespace pov {
void POV_Std_Display_Plot_Box( int , int , int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
void POV_Std_Display_Plot( int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
void POV_Std_Display_Close( void );
int POV_Std_Display_Init( int , int  );
void POV_Std_Display_Finished( void );
void POV_Std_Display_Plot_Rect( int , int , int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
int PossibleError( char * );
int Warning( unsigned int , char * );
int Error( char * );
}
namespace pov_base {
bool File_Exist( char * );
}
int POVMS_GetContextAddress( POVMSContext , void ** );
int POVMS_OpenContext( POVMSContext * );
int POVMS_CloseContext( POVMSContext  );
int POVMSObject_New( POVMSObjectPtr , unsigned int  );
int POVMSUtil_GetStringLength( POVMSObjectPtr , unsigned int , int * );
int POVMSUtil_GetString( POVMSObjectPtr , unsigned int , char *, int * );
namespace pov_base {
char *pov_tsprintf( char * );
...
void exit( int  );
void *pov_frontend::DefaultRenderFrontend::~DefaultRenderFrontend( void * );
void *pov_frontend::ProcessRenderOptions::ProcessRenderOptions( void * );
void *pov_base::DefaultPlatformBase::~DefaultPlatformBase( void * );
void *POVMS_Object::~POVMS_Object( void * );
void *pov_frontend::ProcessRenderOptions::~ProcessRenderOptions( void * );
/*****************************************************************************************/
/******                                                                             ******/
...
static bool no_error_call;
static struct timeval  hstart;
static struct timeval  hstop;
extern POVMSContext POVMS_Render_Context;
extern bool Binary_POVMS_Stream_Mode;
extern void (*UNIX_finish_povray)( void );
extern int (*UNIX_display_init)( int , int  );
extern void (*UNIX_display_finished)( void );
extern void (*UNIX_display_close)( void );
extern void (*UNIX_display_plot)( int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
extern void (*UNIX_display_plot_rect)( int , int , int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
extern int (*UNIX_test_abort)( void );
extern void (*UNIX_display_plot_box)( int , int , int , int , unsigned int , unsigned int , unsigned int , unsigned int  );
/*****************************************************************************************/
/******                                                                             ******/
