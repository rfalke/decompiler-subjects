...
void elinks_cfmakeraw( struct termios * );
unsigned char *get_window_title( void );
void set_window_title( unsigned char *, int  );
...
ssize_t hard_read( int , unsigned char *, size_t  );
ssize_t hard_write( int , unsigned char *, size_t  );
void send_done_sequence( int , int  );
void unhandle_itrm_stdin( struct itrm * );
void block_itrm( void );
void handle_itrm_stdin( struct itrm * );
void set_kbd_interlink_event( struct interlink_event *, int , term_event_modifier_T  );
void send_init_sequence( int , int  );
void get_terminal_name( unsigned char * );
void free_itrm( struct itrm * );
void free_all_itrms( void );
void itrm_queue_event( struct itrm *, unsigned char *, int  );
void itrm_queue_write( struct itrm * );
int setraw( struct itrm *, int  );
int unblock_itrm( void );
void handle_trm( int , int , int , int , int , void *, int , int  );
void resize_terminal( void );
void dispatch_special( unsigned char * );
void unblock_itrm_x( void * );
void set_kbd_event( struct itrm *, struct interlink_event *, int , term_event_modifier_T  );
...
int decode_terminal_mouse_escape_sequence( struct itrm *, struct interlink_event *, int , int  );
void send_mouse_done_sequence( int  );
void disable_mouse( void );
void send_mouse_init_sequence( int  );
