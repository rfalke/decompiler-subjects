...
static struct rgb_cache_entry  cache[4096];
static struct rgb  palette16[16];
static struct rgb  palette88[88];
static struct rgb  palette256[256];
...
static struct color_mode_info  *color_modes[5];
