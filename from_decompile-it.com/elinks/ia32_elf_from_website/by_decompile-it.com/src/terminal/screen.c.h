...
int is_blocked( void );
void done_screen( struct terminal_screen * );
void done_screen_drivers( struct module * );
void resize_screen( struct terminal *, int , int  );
struct terminal_screen  *init_screen( void );
void beep_terminal( struct terminal * );
void erase_screen( struct terminal * );
void set_screen_driver_opt( struct screen_driver *, struct option_elinks * );
int screen_driver_change_hook( struct session *, struct option_elinks *, struct option_elinks * );
...
static unsigned char frame_vt100[48];
static unsigned char frame_vt100_u[48];
static unsigned char frame_freebsd[48];
static unsigned char frame_freebsd_u[48];
static unsigned char frame_koi[48];
static unsigned char frame_restrict[48];
static struct string  m11_hack_frame_seqs[2];
static struct string  vt100_frame_seqs[2];
static struct string  underline_seqs[2];
static struct screen_driver_opt  dumb_screen_driver_opt;
static struct screen_driver_opt  vt100_screen_driver_opt;
static struct screen_driver_opt  linux_screen_driver_opt;
static struct screen_driver_opt  koi8_screen_driver_opt;
static struct screen_driver_opt  freebsd_screen_driver_opt;
static struct screen_driver_opt  *screen_driver_opts[5];
static struct list_head_elinks  active_screen_drivers;
/* Warning:  conflicting decls for frame_dumb */
extern unsigned char frame_dumb[48];
/*****************************************************************************************/
/******                                                                             ******/
