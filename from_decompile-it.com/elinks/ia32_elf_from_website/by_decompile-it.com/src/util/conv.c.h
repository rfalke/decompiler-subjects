...
int elinks_longcat( unsigned char *, unsigned int *, long , unsigned int , unsigned char , unsigned int , unsigned int  );
...
struct string  *add_duration_to_string( struct string *, long  );
struct string  *add_timeval_to_string( struct string *, timeval_T * );
...
struct string  *add_xnum_to_string( struct string *, off_t  );
...
static unsigned char unum[17];
static unsigned char lnum[17];
/*****************************************************************************************/
/******                                                                             ******/
