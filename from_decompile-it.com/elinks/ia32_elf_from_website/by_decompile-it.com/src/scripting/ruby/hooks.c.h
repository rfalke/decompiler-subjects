...
enum evhook_status  script_hook_quit( va_list , void * );
VALUE do_erb_protected_method_call( VALUE  );
enum evhook_status  script_hook_get_proxy( va_list , void * );
enum evhook_status  script_hook_follow_url( va_list , void * );
enum evhook_status  script_hook_goto_url( va_list , void * );
enum evhook_status  script_hook_pre_format_html( va_list , void * );
void elinks_internal( unsigned char * );
void mem_free( void * );
unsigned char *memacpy( unsigned char *, int  );
VALUE rb_protect( void *, VALUE , int * );
