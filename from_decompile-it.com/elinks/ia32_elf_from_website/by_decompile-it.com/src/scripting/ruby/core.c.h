...
void report_scripting_error( struct module *, struct session *, unsigned char * );
VALUE erb_module_method_missing( VALUE , VALUE  );
VALUE erb_stdout_p( int , VALUE *, VALUE  );
VALUE erb_module_message( VALUE , VALUE  );
void alert_ruby_error( struct session *, unsigned char * );
void erb_report_error( struct session *, int  );
void init_ruby( struct module * );
...
void rb_define_global_function( char *, void *, int  );
char *strchr( char *, int  );
void ruby_init( void );
void *memset( void *, int , unsigned int  );
void ruby_init_loadpath( void );
void rb_define_singleton_method( VALUE , char *, void *, int  );
...
void rb_define_module_function( VALUE , char *, void *, int  );
