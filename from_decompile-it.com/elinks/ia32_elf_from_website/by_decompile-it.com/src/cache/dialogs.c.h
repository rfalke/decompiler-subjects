...
void lock_cache_entry( struct listbox_item * );
void unlock_cache_entry( struct listbox_item * );
int is_cache_entry_used( struct listbox_item * );
struct uri  *get_cache_entry_uri( struct listbox_item * );
struct listbox_item  *get_cache_entry_root( struct listbox_item * );
int can_delete_cache_entry( struct listbox_item * );
void delete_cache_entry_item( struct listbox_item *, int  );
enum listbox_match  match_cache_entry( struct listbox_item *, struct terminal *, unsigned char * );
unsigned char *_( unsigned char *, struct terminal * );
unsigned char *get_cache_entry_info( struct listbox_item *, struct terminal * );
unsigned char *get_cache_entry_text( struct listbox_item *, struct terminal * );
...
static struct hierbox_browser_button  cache_buttons[4];
/*****************************************************************************************/
/******                                                                             ******/
