...
struct fragment  *frag_alloc( size_t  );
...
struct cache_entry  *get_redirected_cache_entry( struct uri * );
struct cache_entry  *get_cache_entry( struct uri * );
void free_entry_to( struct cache_entry *, off_t  );
void remove_overlaps( struct cache_entry *, struct fragment *, int * );
...
void mem_mmap_free( void *, size_t  );
void *mem_mmap_alloc( size_t  );
void *mem_mmap_realloc( void *, size_t , size_t  );
void mem_free( void * );
...
void __udivdi3( int , int , int , int  );
...
static struct list_head_elinks  cache_entries;
