...
void dummy_close( struct stream_encoded * );
void close_encoded( struct stream_encoded * );
unsigned char *dummy_decode_buffer( unsigned char *, int , int * );
int dummy_read( struct stream_encoded *, unsigned char *, int  );
int dummy_open( struct stream_encoded *, int  );
struct stream_encoded  *open_encoded( int , enum stream_encoding   );
enum stream_encoding  guess_encoding( unsigned char * );
struct connection_state  read_file( struct stream_encoded *, int , struct string * );
...
static struct decoding_backend  *decoding_backends[5];
extern struct decoding_backend  bzip2_decoding_backend;
extern struct decoding_backend  deflate_decoding_backend;
