...
/******                                                                             ******/
/*****************************************************************************************/
void bzip2_close( struct stream_encoded * );
int bzip2_read( struct stream_encoded *, unsigned char *, int  );
int bzip2_open( struct stream_encoded *, int  );
unsigned char *bzip2_decode_buffer( unsigned char *, int , int * );
...
static unsigned char *bzip2_extensions[3];
/*****************************************************************************************/
/******                                                                             ******/
