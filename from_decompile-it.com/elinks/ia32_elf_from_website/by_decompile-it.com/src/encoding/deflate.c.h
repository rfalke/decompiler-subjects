...
/******                                                                             ******/
/*****************************************************************************************/
void deflate_close( struct stream_encoded * );
int deflate_read( struct stream_encoded *, unsigned char *, int  );
int deflate_gzip_open( struct stream_encoded *, int  );
unsigned char *deflate_decode_buffer( int , unsigned char *, int , int * );
unsigned char *deflate_gzip_decode_buffer( unsigned char *, int , int * );
unsigned char *deflate_raw_decode_buffer( unsigned char *, int , int * );
...
int inflateInit2_( void *, int , char *, int  );
...
static unsigned char *gzip_extensions[3];
/*****************************************************************************************/
/******                                                                             ******/
