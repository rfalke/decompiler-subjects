...
void bookmark_manager( struct session * );
void bookmark_terminal_tabs_dialog( struct terminal * );
...
struct action  *get_action( enum keymap_id  , action_id_T  );
...
void download_manager( struct session * );
void resource_info( struct terminal * );
void open_in_new_window( struct terminal *, void *, void * );
void send_open_new_window( struct terminal *, struct open_in_new *, struct session * );
void send_open_in_new_window( struct terminal *, struct open_in_new *, struct session * );
void dialog_goto_url( struct session *, unsigned char * );
void save_url_as( struct session * );
void activate_bfu_technology( struct session *, int  );
void tab_menu( struct session *, int , int , int  );
void exit_prog( struct session *, int  );
enum frame_event_status  pass_uri_to_command( struct session *, struct document_view *, int  );
void resize_terminal_dialog( struct terminal * );
void terminal_options( struct terminal *, void *, struct session * );
void print_screen_status( struct session * );
void toggle_document_option( struct session *, unsigned char * );
...
void go_history_by_n( struct session *, int  );
...
void open_current_link_in_new_tab( struct session *, int  );
void close_all_tabs_but_current( struct session * );
void move_current_tab( struct session *, int  );
void switch_current_tab( struct session *, int  );
void close_tab( struct terminal *, struct session * );
void exec_shell( struct terminal * );
void redraw_terminal_cls( struct terminal * );
void elinks_internal( unsigned char * );
void goto_url_action( struct session *, unsigned char *(*)( struct session *, unsigned char *, size_t  ) );
...
enum frame_event_status  enter( struct session *, struct document_view *, int  );
...
enum frame_event_status  find_next( struct session *, struct document_view *, int  );
enum frame_event_status  search_dlg( struct session *, struct document_view *, int  );
...
enum frame_event_status  move_cursor_down( struct session *, struct document_view * );
enum frame_event_status  move_cursor_up( struct session *, struct document_view * );
enum frame_event_status  move_cursor_right( struct session *, struct document_view * );
enum frame_event_status  move_cursor_left( struct session *, struct document_view * );
