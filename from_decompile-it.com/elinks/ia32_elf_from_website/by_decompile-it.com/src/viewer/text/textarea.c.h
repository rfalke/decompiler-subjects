...
int safe_mkstemp( unsigned char * );
unsigned char *get_tempdir_filename( unsigned char * );
void mem_free( void * );
...
struct string  *add_file_to_string( struct string *, unsigned char * );
...
struct line_info  T/*.210*/( int , int , int , int  );
int get_textarea_line_number( struct line_info *, int  );
int do_op_home( struct form_state *, struct line_info *, int , int  );
int do_op_bob( struct form_state *, struct line_info *, int , int  );
int do_op_eob( struct form_state *, struct line_info *, int , int  );
int do_op_right( struct form_state *, struct line_info *, int , int  );
int do_op_left( struct form_state *, struct line_info *, int , int  );
int do_op_end( struct form_state *, struct line_info *, int , int  );
enum frame_event_status  textarea_op_enter( struct form_state *, struct form_control *, int  );
void new_pos( struct form_state *, struct line_info *, int , int  );
int do_op_down( struct form_state *, struct line_info *, int , int  );
int do_op_up( struct form_state *, struct line_info *, int , int  );
...
struct line_info  *format_text( unsigned char *, int , enum form_wrap  , int  );
enum frame_event_status  textarea_op( struct form_state *, struct form_control *, int , int (*)( struct form_state *, struct line_info *, int , int  ) );
