...
void input_dialog( struct terminal *, struct memory_list *, unsigned char *, unsigned char *, void *, struct input_history *, int , unsigned char *, int , int , widget_handler_T *, void (*)( void *, unsigned char * ), void (*)( void * ) );
void menu_leds_info( struct terminal *, void *, void * );
...
void nowhere_box( struct terminal *, unsigned char * );
void activate_bfu_technology( struct session *, int  );
void tab_menu( struct session *, int , int , int  );
...
void release_document( struct document * );
...
int eat_kbd_repeat_count( struct session * );
void set_session_referrer( struct session *, struct uri * );
void goto_uri( struct session *, struct uri * );
void goto_url( struct session *, unsigned char * );
void set_cursor( struct terminal *, int , int , int  );
void term_send_event( struct terminal *, struct term_event * );
int get_tab_number_by_xpos( struct terminal *, int  );
struct window  *get_tab_by_number( struct terminal *, int  );
void switch_to_tab( struct terminal *, int , int  );
void switch_current_tab( struct session *, int  );
void close_tab( struct terminal *, struct session * );
void elinks_internal( unsigned char * );
void mem_free( void * );
enum frame_event_status  do_action( struct session *, enum main_action  , int  );
int dump_to_file( struct document *, int  );
void refresh_view( struct session *, struct document_view *, int  );
void draw_formatted( struct session *, int  );
enum frame_event_status  field_op( struct session *, struct document_view *, struct link *, struct term_event * );
void get_link_x_bounds( struct link *, int , int *, int * );
struct link  *get_link_at_coordinates( struct document_view *, int , int  );
int next_link_in_dir( struct document_view *, int , int  );
int next_link_in_view_y( struct document_view *, int , int  );
void find_link_page_down( struct document_view * );
void find_link_down( struct document_view * );
void find_link_page_up( struct document_view * );
void find_link_up( struct document_view * );
int current_link_is_visible( struct document_view * );
void link_menu( struct terminal *, void *, void * );
void jump_to_link_number( struct session *, struct document_view *, int  );
struct uri  *get_link_uri( struct session *, struct document_view *, struct link * );
enum frame_event_status  try_document_key( struct session *, struct document_view *, struct term_event * );
void goto_link_number( struct session *, unsigned char * );
void highlight_links_with_prefixes_that_start_with_n( struct terminal *, struct document_view *, int  );
void goto_mark( unsigned char , struct view_state * );
void set_mark( unsigned char , struct view_state * );
enum frame_event_status  search_typeahead( struct session *, struct document_view *, action_id_T  );
void set_textarea( struct document_view *, int  );
enum frame_event_status  save_formatted_dlg( struct session *, struct document_view *, int  );
struct document_view  *current_frame( struct session * );
void save_formatted( void *, unsigned char * );
void save_formatted_finish( struct terminal *, int , void *, int  );
enum frame_event_status  save_as( struct session *, struct document_view *, int  );
enum frame_event_status  view_image( struct session *, struct document_view *, int  );
enum frame_event_status  download_link( struct session *, struct document_view *, action_id_T  );
enum frame_event_status  horizontal_scroll( struct session *, struct document_view *, int  );
enum frame_event_status  vertical_scroll( struct session *, struct document_view *, int  );
enum frame_event_status  scroll_mouse_up( struct session *, struct document_view * );
enum frame_event_status  scroll_mouse_down( struct session *, struct document_view * );
enum frame_event_status  try_mark_key( struct session *, struct document_view *, struct term_event * );
enum frame_event_status  send_to_frame( struct session *, struct document_view *, struct term_event * );
enum frame_event_status  scroll_right( struct session *, struct document_view * );
enum frame_event_status  scroll_left( struct session *, struct document_view * );
enum frame_event_status  scroll_down( struct session *, struct document_view * );
enum frame_event_status  scroll_up( struct session *, struct document_view * );
int try_jump_to_link_number( struct session *, struct document_view * );
enum frame_event_status  copy_current_link_to_clipboard( struct session *, struct document_view *, int  );
enum frame_event_status  move_cursor( struct session *, struct document_view *, int , int  );
enum frame_event_status  move_cursor_rel( struct session *, struct document_view *, int , int  );
enum frame_event_status  move_cursor_line_start( struct session *, struct document_view * );
enum frame_event_status  move_link_next_line( struct session *, struct document_view * );
enum frame_event_status  move_link_prev_line( struct session *, struct document_view * );
enum frame_event_status  move_link_down_line( struct session *, struct document_view * );
enum frame_event_status  move_link_up_line( struct session *, struct document_view * );
enum frame_event_status  move_document_end( struct session *, struct document_view * );
enum frame_event_status  move_document_start( struct session *, struct document_view * );
void toggle_wrap_text( struct session *, struct document_view *, int  );
void toggle_plain_html( struct session *, struct document_view *, int  );
enum frame_event_status  set_frame( struct session *, struct document_view *, int  );
void move_down( struct session *, struct document_view *, int  );
enum frame_event_status  move_page_down( struct session *, struct document_view * );
void move_up( struct session *, struct document_view *, int  );
enum frame_event_status  move_link_dir( struct session *, struct document_view *, int , int  );
enum frame_event_status  move_page_up( struct session *, struct document_view * );
enum frame_event_status  move_link( struct session *, struct document_view *, int , int , int  );
