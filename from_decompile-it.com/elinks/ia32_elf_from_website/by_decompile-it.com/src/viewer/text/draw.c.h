...
int find_tag( struct document *, unsigned char *, int  );
...
void draw_line( struct terminal *, int , int , int , struct screen_char * );
void draw_border_char( struct terminal *, int , int , enum border_char  , struct color_pair * );
void draw_border_cross( struct terminal *, int , int , enum border_cross_direction  , struct color_pair * );
...
void draw_frame_lines( struct terminal *, struct frameset_desc *, int , int , struct color_pair * );
void draw_view_status( struct session *, struct document_view *, int  );
void draw_doc( struct session *, struct document_view *, int  );
