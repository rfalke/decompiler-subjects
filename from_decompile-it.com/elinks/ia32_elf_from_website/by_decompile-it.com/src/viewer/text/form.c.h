...
void add_to_menu( struct menu_item **, unsigned char *, unsigned char *, enum main_action  , menu_func_T , void *, enum menu_item_flags   );
struct menu_item  *new_menu( enum menu_item_flags   );
unsigned char *msg_text( struct terminal *, unsigned char * );
struct dialog_data  *info_box( struct terminal *, enum msgbox_flags  , unsigned char *, enum format_align  , unsigned char * );
action_id_T kbd_action( enum keymap_id  , struct term_event *, int * );
void add_keystroke_to_string( struct string *, struct term_event_keyboard *, int  );
unsigned char *get_keystroke( action_id_T , enum keymap_id   );
union option_value  *get_opt_( struct option_elinks *, unsigned char * );
void auto_complete_file( struct terminal *, int , unsigned char *, menu_func_T , menu_func_T , void * );
int has_form_submit( struct form * );
int get_form_control_link( struct document *, struct form_control * );
void memorize_form( struct session *, struct list_head_elinks *, struct form * );
unsigned char *get_form_history_value( unsigned char *, unsigned char * );
unsigned char *utf8_prevchar( unsigned char *, int , unsigned char * );
int unicode_to_cell( unicode_val_T  );
unsigned char *get_cp_mime_name( int  );
unicode_val_T utf8_to_unicode( unsigned char **, unsigned char * );
...
unsigned char *utf8_step_backward( unsigned char *, unsigned char *, int , enum utf8_step  , int * );
struct conv_table  *get_translation_table( int , int  );
int utf8_ptr2cells( unsigned char *, unsigned char * );
unsigned char *bind_textdomain_codeset( unsigned char *, unsigned char * );
unsigned char *gettext( unsigned char * );
unsigned char *get_extension_content_type( unsigned char * );
void set_bin( int  );
unsigned char *get_clipboard_text( void );
void set_clipboard_text( unsigned char * );
void done_uri( struct uri * );
void encode_uri_string( struct string *, unsigned char *, int , int  );
unsigned char *get_uri_string( struct uri *, enum uri_component   );
struct uri  *get_uri( unsigned char *, enum uri_component   );
struct string  *add_string_uri_to_string( struct string *, unsigned char *, enum uri_component   );
void goto_uri_frame( struct session *, struct uri *, unsigned char *, enum cache_mode   );
void draw_char_data( struct terminal *, int , int , unicode_val_T  );
int get_terminal_codepage( struct terminal * );
void redraw_terminal( struct terminal * );
void redraw_terminal_cls( struct terminal * );
int elinks_ulongcat( unsigned char *, unsigned int *, unsigned long , unsigned int , unsigned char , unsigned int , unsigned int  );
void elinks_internal( unsigned char * );
unsigned char *get_filename_position( unsigned char * );
...
void done_string( struct string * );
unsigned char *stracpy( unsigned char * );
unsigned char *straconcat( unsigned char * );
unsigned char *insert_in_string( unsigned char **, int , unsigned char *, int  );
struct string  *add_format_to_string( struct string *, unsigned char * );
...
struct string  *add_string_to_string( struct string *, struct string * );
void refresh_view( struct session *, struct document_view *, int  );
unsigned char *get_form_label( struct form_control * );
unsigned char *_( unsigned char *, struct terminal * );
void done_submitted_value( struct submitted_value * );
void done_submitted_value_list( struct list_head_elinks * );
void link_form_menu_func( struct terminal *, void *, void * );
enum frame_event_status  submit_form( struct session *, struct document_view *, int  );
void file_form_menu( struct terminal *, void *, void * );
void set_file_form_state( struct terminal *, void *, void * );
void fixup_select_state( struct form_control *, struct form_state * );
struct submitted_value  *init_submitted_value( unsigned char *, unsigned char *, enum form_type  , struct form_control *, int  );
unsigned char *encode_crlf( struct submitted_value * );
void *mem_align_alloc__( void **, size_t , size_t , size_t , size_t  );
struct string  *add_bytes_to_string__( struct string *, unsigned char *, int  );
void init_form_state( struct document_view *, struct form_control *, struct form_state * );
struct form_view  *find_form_view_in_vs( struct view_state *, int  );
struct form_state  *find_form_state( struct document_view *, struct form_control * );
enum frame_event_status  field_op( struct session *, struct document_view *, struct link *, struct term_event * );
void do_reset_form( struct document_view *, struct form * );
void draw_form_entry( struct terminal *, struct document_view *, struct link * );
void draw_forms( struct terminal *, struct document_view * );
enum frame_event_status  reset_form( struct session *, struct document_view *, int  );
int get_current_state( struct session * );
void selected_item( struct terminal *, void *, void * );
void add_form_attr_to_string( struct string *, struct terminal *, unsigned char *, unsigned char * );
void link_form_menu( struct session * );
void encode_multipart( struct session *, struct list_head_elinks *, struct string *, struct boundary_info *, int , int  );
struct uri  *get_form_uri( struct session *, struct document_view *, struct form_control * );
void submit_given_form( struct session *, struct document_view *, struct form *, int  );
void auto_submit_form( struct session * );
unsigned char *get_form_info( struct session *, struct document_view * );
struct link  *get_last_link( struct document_view * );
struct link  *get_first_link( struct document_view * );
...
enum frame_event_status  textarea_op_enter( struct form_state *, struct form_control *, int  );
void textarea_edit( int , struct terminal *, struct form_state *, struct document_view *, struct link * );
enum frame_event_status  textarea_op_right( struct form_state *, struct form_control *, int  );
enum frame_event_status  textarea_op_left( struct form_state *, struct form_control *, int  );
enum frame_event_status  textarea_op_eob( struct form_state *, struct form_control *, int  );
enum frame_event_status  textarea_op_bob( struct form_state *, struct form_control *, int  );
enum frame_event_status  textarea_op_end( struct form_state *, struct form_control *, int  );
enum frame_event_status  textarea_op_down( struct form_state *, struct form_control *, int  );
enum frame_event_status  textarea_op_up( struct form_state *, struct form_control *, int  );
enum frame_event_status  textarea_op_home( struct form_state *, struct form_control *, int  );
unsigned char *encode_textarea( struct submitted_value * );
void draw_textarea( struct terminal *, struct form_state *, struct document_view *, struct link * );
...
void *memrchr( void *, int , unsigned int  );
void *memmove( void *, void *, unsigned int  );
void *__rawmemchr( void *, int  );
int open64( char *, int , ... );
...
extern struct option_elinks  *config_options;
extern int current_charset;
extern struct option_elinks  *cmdline_options;
/*****************************************************************************************/
/******                                                                             ******/
