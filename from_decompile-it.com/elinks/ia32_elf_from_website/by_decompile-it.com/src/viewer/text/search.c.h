...
void input_field_line( struct session *, unsigned char *, void *, struct input_history *, input_line_handler_T  );
int save_input_history( struct input_history *, unsigned char * );
void add_to_input_history( struct input_history *, unsigned char *, int  );
int load_input_history( struct input_history *, unsigned char * );
...
struct color_pair  *get_bfu_color( struct terminal *, unsigned char * );
...
void checkout_option_values( struct option_resolver *, struct option_elinks *, union option_value *, int  );
int commit_option_values( struct option_resolver *, struct option_elinks *, union option_value *, int  );
...
void draw_char_color( struct terminal *, int , int , struct color_pair * );
...
int next_link_in_view( struct document_view *, int , int  );
void find_link_page_down( struct document_view * );
void find_link_page_up( struct document_view * );
void set_link( struct document_view * );
struct link  *goto_current_link( struct session *, struct document_view *, int  );
enum evhook_status  search_history_write_hook( va_list , void * );
void done_search_history( struct module * );
void init_search_history( struct module * );
int get_range( struct document *, int , int , int , struct search **, struct search ** );
widget_handler_status_T search_dlg_cancel( struct dialog_data *, struct widget_data * );
widget_handler_status_T search_dlg_ok( struct dialog_data *, struct widget_data * );
int strlen_u( unsigned char *, int  );
unicode_val_T *memacpy_u( unsigned char *, int , int  );
unicode_val_T *lowered_string( unsigned char *, int , int  );
void print_find_error_not_found( struct session *, unsigned char *, unsigned char *, unsigned char * );
void print_find_error( struct session *, enum find_error   );
enum frame_event_status  search_typeahead( struct session *, struct document_view *, action_id_T  );
int match_link_text( struct link *, unsigned char *, int , int  );
void draw_typeahead_match( struct terminal *, struct document_view *, int , int  );
enum input_line_code  link_typeahead_handler( struct input_line *, int  );
int get_srch( struct document * );
void get_search_data( struct document * );
void get_searched( struct document_view *, struct point **, int *, int  );
int find_next_link_in_search( struct document_view *, int  );
void draw_searched( struct terminal *, struct document_view * );
enum find_error  find_next_do( struct session *, struct document_view *, int  );
enum find_error  search_for_do( struct session *, unsigned char *, int , int  );
...
enum input_line_code  text_typeahead_handler( struct input_line *, int  );
...
/* Warning:  conflicting decls for resolvers */
static struct option_resolver  resolvers[1];
static char hash[4096];
...
static struct event_hook_info  search_history_hooks[2];
/*****************************************************************************************/
/******                                                                             ******/
