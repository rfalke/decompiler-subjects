...
void add_keystroke_action_to_string( struct string *, action_id_T , enum keymap_id   );
...
void set_term_color( struct screen_char *, struct color_pair *, enum color_flags  , enum color_mode   );
...
int next_link_in_view_( struct document_view *, int , int , int (*)( struct document_view *, struct link * ), void (*)( struct document_view *, struct link * ) );
...
int link_in_view_y( struct document_view *, struct link * );
int link_in_view( struct document_view *, struct link * );
...
unsigned char *get_current_link_info( struct session *, struct document_view * );
unsigned char *get_current_link_title( struct document_view * );
...
void goto_link_number_do( struct session *, struct document_view *, int  );
...
void clear_link( struct terminal *, struct document_view * );
void draw_current_link( struct session *, struct document_view * );
void menu_textarea_edit( struct terminal *, void *, void * );
int area_cursor( struct form_control *, struct form_state *, int  );
