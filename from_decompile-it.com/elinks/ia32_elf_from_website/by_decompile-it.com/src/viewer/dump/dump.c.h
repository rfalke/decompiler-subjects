...
void init_document_options( struct document_options * );
...
ssize_t hard_write( int , unsigned char *, size_t  );
...
void free_string_list( struct list_head_elinks * );
...
struct dump_output  *dump_output_alloc( int , struct string * );
int dump_output_flush( struct dump_output * );
int write_char( unsigned char , struct dump_output * );
int write_color_16( unsigned char , struct dump_output * );
int dump_nocolor( struct document *, struct dump_output * );
struct string  *add_document_to_string( struct string *, struct document * );
int write_color_256( unsigned char *, unsigned char , struct dump_output * );
int dump_256color( struct document *, struct dump_output * );
int dump_references( struct document *, int , unsigned char * );
int dump_to_file( struct document *, int  );
void dump_print( unsigned char *, struct string * );
void dump_next( struct list_head_elinks * );
void dump_loading_callback( struct download *, void * );
...
static struct term_event_keyboard  os2xtd[256];
static struct list_head_elinks  todo_list;
static struct list_head_elinks  done_list;
static int first;
static int dump_pos;
