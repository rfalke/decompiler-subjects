...
enum evhook_status  global_history_write_hook( va_list , void * );
...
static struct option_info  global_history_options[6];
static struct hash  *globhist_cache;
static int globhist_cache_entries;
extern struct hierbox_browser  globhist_browser;
extern struct input_history {
     struct list_head_elinks  entries;
     int size;
     unsigned int bits_at_12;
  } global_history;
extern struct list_head_elinks  global_history_reap_list;
extern struct event_hook_info  global_history_hooks[2];
/*****************************************************************************************/
/******                                                                             ******/
