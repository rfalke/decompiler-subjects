...
void lock_globhist_item( struct listbox_item * );
void unlock_globhist_item( struct listbox_item * );
int is_globhist_item_used( struct listbox_item * );
struct listbox_item  *get_globhist_item_root( struct listbox_item * );
int can_delete_globhist_item( struct listbox_item * );
void delete_globhist_item( struct listbox_item *, int  );
struct uri  *get_globhist_item_uri( struct listbox_item * );
unsigned char *_( unsigned char *, struct terminal * );
unsigned char *get_globhist_item_info( struct listbox_item *, struct terminal * );
unsigned char *get_globhist_item_text( struct listbox_item *, struct terminal * );
widget_handler_status_T push_toggle_display_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_search_button( struct dialog_data *, struct widget_data * );
void history_search_do( void * );
widget_handler_status_T push_bookmark_button( struct dialog_data *, struct widget_data * );
...
static struct hierbox_browser_button  globhist_buttons[7];
