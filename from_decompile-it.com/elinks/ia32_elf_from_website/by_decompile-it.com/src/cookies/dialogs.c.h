...
widget_handler_status_T push_hierbox_clear_button( struct dialog_data *, struct widget_data * );
...
struct cookie_server  *get_cookie_server( unsigned char *, int  );
struct cookie  *init_cookie( unsigned char *, unsigned char *, unsigned char *, unsigned char *, struct cookie_server * );
void done_cookie( struct cookie * );
void delete_cookie( struct cookie * );
void accept_cookie( struct cookie * );
void lock_cookie( struct listbox_item * );
void unlock_cookie( struct listbox_item * );
int is_cookie_used( struct listbox_item * );
struct listbox_item  *get_cookie_root( struct listbox_item * );
int can_delete_cookie( struct listbox_item * );
void delete_cookie_item( struct listbox_item *, int  );
unsigned char *get_cookie_text( struct listbox_item *, struct terminal * );
widget_handler_status_T push_save_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T set_cookie_domain( struct dialog_data *, struct widget_data * );
widget_handler_status_T set_cookie_value( struct dialog_data *, struct widget_data * );
widget_handler_status_T set_cookie_name( struct dialog_data *, struct widget_data * );
widget_handler_status_T set_cookie_secure( struct dialog_data *, struct widget_data * );
widget_handler_status_T set_cookie_expires( struct dialog_data *, struct widget_data * );
void add_server_do( void * );
void accept_cookie_in_msg_box( void * );
void cookie_manager( struct session * );
void reject_cookie_in_msg_box( void * );
widget_handler_status_T push_add_server_button( struct dialog_data *, struct widget_data * );
void build_edit_dialog( struct terminal *, struct cookie * );
...
void add_cookie_info_to_string( struct string *, struct cookie *, struct terminal * );
unsigned char *get_cookie_info( struct listbox_item *, struct terminal * );
void accept_cookie_dialog( struct session *, void * );
...
extern struct list_head_elinks  cookie_queries;
...
static struct hierbox_browser_button  cookie_buttons[7];
/*****************************************************************************************/
/******                                                                             ******/
