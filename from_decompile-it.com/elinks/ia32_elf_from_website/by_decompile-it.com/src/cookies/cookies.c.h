...
int secure_fprintf( struct secure_save_info *, char * );
...
static struct list_head_elinks  c_domains;
static struct list_head_elinks  cookie_servers;
static int cookies_dirty;
static struct option_info  cookies_options[7];
...
/* Warning:  conflicting decls for cookies */
static struct list_head_elinks  cookies;
/*****************************************************************************************/
/******                                                                             ******/
