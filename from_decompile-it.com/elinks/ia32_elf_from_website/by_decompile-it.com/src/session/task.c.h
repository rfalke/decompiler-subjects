...
struct cache_entry  *get_validated_cache_entry( struct uri *, enum cache_mode   );
...
void kill_document_refresh( struct document_refresh * );
...
int end_with_known_tld( unsigned char *, int  );
...
void del_from_history( struct ses_history *, struct location * );
void add_to_history( struct ses_history *, struct location * );
void clean_unhistory( struct ses_history * );
...
void do_follow_url( struct session *, struct uri *, unsigned char *, enum task_type  , enum cache_mode  , int  );
void follow_url( struct session *, struct uri *, unsigned char *, enum task_type  , enum cache_mode  , int  );
...
static int follow_url_event_id;
/*****************************************************************************************/
/******                                                                             ******/
