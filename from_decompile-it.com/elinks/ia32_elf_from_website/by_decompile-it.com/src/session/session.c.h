...
/******                                                                             ******/
/*****************************************************************************************/
void init_led_panel( struct led_panel * );
struct led  *register_led( struct session *, int  );
...
void open_bookmark_folder( struct session *, unsigned char * );
unsigned char *get_auto_save_bookmark_foldername_utf8( void );
struct bookmark  *add_bookmark_cp( struct bookmark *, int , int , unsigned char *, unsigned char * );
int cache_entry_is_valid( struct cache_entry * );
struct fragment  *get_cache_fragment( struct cache_entry * );
struct cache_entry  *follow_cached_redirects( struct cache_entry * );
...
void open_uri_in_new_window( struct session *, struct uri *, struct uri *, enum term_env_type  , enum cache_mode  , enum task_type   );
void dialog_goto_url( struct session *, unsigned char * );
void activate_bfu_technology( struct session *, int  );
void update_status( void );
void print_screen_status( struct session * );
void start_document_refreshes( struct session * );
...
int get_event_id( unsigned char * );
void kill_timer( timer_id_T * );
void install_timer( timer_id_T *, milliseconds_T , void (*)( void * ), void * );
int load_uri( struct uri *, struct uri *, struct download *, enum connection_priority  , enum cache_mode  , off_t  );
void cancel_download( struct download *, int  );
void move_download( struct download *, struct download *, enum connection_priority   );
unsigned char *get_state_message( struct connection_state , struct terminal * );
int can_open_in_new( struct terminal * );
protocol_external_handler_T *get_protocol_external_handler( struct terminal *, struct uri * );
void decode_uri( unsigned char * );
void done_uri( struct uri * );
void decode_uri_for_display( unsigned char * );
int compare_uri( struct uri *, struct uri *, enum uri_component   );
unsigned char *get_uri_string( struct uri *, enum uri_component   );
struct uri  *get_uri( unsigned char *, enum uri_component   );
void done_type_query( struct type_query * );
void destroy_downloads( struct session * );
int setup_download_handler( struct session *, struct download *, struct cache_entry *, int  );
void create_history( struct ses_history * );
void destroy_history( struct ses_history * );
struct download  *get_current_download( struct session * );
int eat_kbd_repeat_count( struct session * );
struct link  *get_current_session_link( struct session * );
...
void load_additional_file( struct file_to_load *, enum cache_mode   );
void process_file_requests( struct session * );
void abort_loading( struct session *, int  );
void reload( struct session *, enum cache_mode   );
void check_questions_queue( struct session * );
void free_files( struct session * );
void done_session_info( struct session_info * );
void session_info_timeout( int  );
void done_saved_session_info( void );
void dialog_goto_url_open( void * );
void init_remote_session( struct session *, enum remote_session_flags  *, struct uri * );
struct string  *encode_session_info( struct string *, struct list_head_elinks * );
struct session  *init_session( struct session *, struct terminal *, struct uri *, int  );
struct file_to_load  *request_additional_file( struct session *, unsigned char *, struct uri *, int  );
int session_is_loading( struct session * );
void add_questions_entry( void (*)( struct session *, void * ), void * );
int add_session_info( struct session *, struct uri *, struct uri *, enum cache_mode  , enum task_type   );
void request_frameset( struct session *, struct frameset_desc *, int  );
void print_error_dialog( struct session *, struct connection_state , struct uri *, enum connection_priority   );
int decode_session_info( struct terminal *, struct terminal_info * );
void load_frames( struct session *, struct document_view * );
void tabwin_func( struct window *, struct term_event * );
void display_timer( struct session * );
void doc_loading_callback( struct download *, struct session * );
void file_loading_callback( struct download *, struct file_to_load * );
struct uri  *get_hooked_uri( unsigned char *, struct session *, unsigned char * );
void ses_load( struct session *, struct uri *, unsigned char *, struct location *, enum cache_mode  , enum task_type   );
void ses_goto( struct session *, struct uri *, unsigned char *, struct location *, enum cache_mode  , enum task_type  , int  );
void goto_uri( struct session *, struct uri * );
int goto_url_home( struct session * );
...
void open_uri_in_new_tab( struct session *, struct uri *, int , int  );
void switch_to_tab( struct terminal *, int , int  );
struct window  *init_tab( struct terminal *, void *, window_handler_T * );
...
timeval_T *timeval_sub( timeval_T *, timeval_T *, timeval_T * );
milliseconds_T mult_ms( milliseconds_T , long  );
milliseconds_T timeval_to_milliseconds( timeval_T * );
timeval_T *timeval_now( timeval_T * );
...
void destroy_vs( struct view_state *, int  );
void init_vs( struct view_state *, struct uri *, int , struct window *, struct term_event * );
...
extern struct list_head_elinks  sessions;
extern struct list_head_elinks  questions_queue;
static int pre_format_html_event;
static struct list_head_elinks  session_info;
static int session_info_id;
