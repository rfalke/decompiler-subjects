...
void add_dlg_radio_do( struct dialog *, unsigned char *, int , int , int * );
...
struct widget_data  *select_widget_by_id( struct dialog_data *, int  );
...
void cached_header_dialog( struct session *, struct cache_entry * );
void done_download_display( struct file_download * );
void init_download_display( struct file_download * );
...
struct mime_handler  *get_mime_type_handler( unsigned char *, int  );
struct string  *add_mime_filename_to_string( struct string *, struct uri * );
unsigned char *get_content_type( struct cache_entry * );
...
int has_progress( struct progress * );
...
time_t parse_date( unsigned char **, unsigned char *, int , int  );
...
unsigned char *get_extension_from_uri( struct uri * );
int compare_uri( struct uri *, struct uri *, enum uri_component   );
unsigned char *get_uri_string( struct uri *, enum uri_component   );
struct uri  *get_composed_uri( struct uri *, enum uri_component   );
void lun_cancel( void * );
void lun_overwrite( void * );
void lun_alternate( void * );
widget_handler_status_T tp_show_header( struct dialog_data *, struct widget_data * );
unsigned char *subst_file( unsigned char *, unsigned char * );
void tp_save( struct type_query * );
void done_type_query( struct type_query * );
void tp_display( struct type_query * );
void tp_cancel( void * );
void lun_resume( void * );
void download_error_dialog( struct file_download *, int  );
void create_download_file_do( struct terminal *, unsigned char *, void *, int  );
...
struct file_download  *init_file_download( struct uri *, struct session *, unsigned char *, int  );
void continue_download_do( struct terminal *, int , void *, int  );
void common_download_do( struct terminal *, int , void *, int  );
void abort_download_and_beep( struct file_download *, struct terminal * );
void download_data_store( struct download *, struct file_download * );
void download_data( struct download *, struct file_download * );
int download_is_progressing( struct download * );
void create_download_file( struct terminal *, unsigned char *, unsigned char **, int , int , void (*)( struct terminal *, int , void *, int  ), void * );
void continue_download( void *, unsigned char * );
void tp_open( struct type_query * );
void common_download( struct session *, unsigned char *, int  );
...
void assert_terminal_ptr_not_dangling( struct terminal * );
struct string  *add_shell_safe_to_string( struct string *, unsigned char *, int  );
struct string  *add_shell_quoted_to_string( struct string *, unsigned char *, int  );
void elinks_internal( unsigned char * );
int mkalldirs( unsigned char * );
...
extern struct list_head_elinks  downloads;
