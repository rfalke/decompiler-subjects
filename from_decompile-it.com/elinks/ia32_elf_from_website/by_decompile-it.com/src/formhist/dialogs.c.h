...
unsigned char *form_type2str( enum form_type   );
void lock_formhist_data( struct listbox_item * );
void unlock_formhist_data( struct listbox_item * );
int is_formhist_data_used( struct listbox_item * );
struct listbox_item  *get_formhist_data_root( struct listbox_item * );
int can_delete_formhist_data( struct listbox_item * );
void delete_formhist_data( struct listbox_item *, int  );
struct uri  *get_formhist_data_uri( struct listbox_item * );
unsigned char *_( unsigned char *, struct terminal * );
unsigned char *get_formhist_data_info( struct listbox_item *, struct terminal * );
unsigned char *get_formhist_data_text( struct listbox_item *, struct terminal * );
widget_handler_status_T push_save_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_toggle_dontsave_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_login_button( struct dialog_data *, struct widget_data * );
void formhist_manager( struct session * );
void delete_formhist_item( struct formhist_data * );
...
static struct hierbox_browser_button  formhist_buttons[6];
