...
int str2form_type( unsigned char * );
struct formhist_data  *new_formhist_item( unsigned char * );
void done_formhist_item( struct formhist_data * );
void dont_remember_form( void * );
void delete_formhist_item( struct formhist_data * );
void done_form_history( struct module * );
int save_formhist_to_file( void );
void remember_form( void * );
void never_for_this_site( void * );
...
static struct option_info  forms_history_options[2];
extern struct hierbox_browser  formhist_browser;
extern struct list_head_elinks  saved_forms;
/* Warning:  conflicting decls for loaded */
static int loaded;
/*****************************************************************************************/
/******                                                                             ******/
