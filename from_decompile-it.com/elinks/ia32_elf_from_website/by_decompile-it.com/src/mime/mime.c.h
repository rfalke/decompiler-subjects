...
unsigned char *get_content_filename( struct uri *, struct cache_entry * );
struct string  *add_mime_filename_to_string( struct string *, struct uri * );
unsigned char *get_extension_content_type( unsigned char * );
unsigned char *get_cache_header_content_type( struct cache_entry * );
unsigned char *get_content_type( struct cache_entry * );
unsigned char *get_content_type_backends( unsigned char * );
struct mime_handler  *get_mime_handler_backends( unsigned char *, int  );
...
static struct option_info  mime_options[3];
static struct module  *mime_submodules[4];
