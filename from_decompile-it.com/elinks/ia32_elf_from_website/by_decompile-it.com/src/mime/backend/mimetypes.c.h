...
void done_mimetypes_entry( struct mimetypes_entry * );
void done_mimetypes( struct module * );
int change_hook_mimetypes( struct session *, struct option_elinks *, struct option_elinks * );
void init_mimetypes( struct module * );
void parse_mimetypes_file( unsigned char * );
unsigned char *get_content_type_mimetypes( unsigned char * );
...
static struct option_info  mimetypes_options[4];
