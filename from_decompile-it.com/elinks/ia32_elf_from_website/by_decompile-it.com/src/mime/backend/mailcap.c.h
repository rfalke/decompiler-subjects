...
struct mime_handler  *init_mime_handler( unsigned char *, unsigned char *, unsigned char *, int , int  );
unsigned char *get_next_path_filename( unsigned char **, unsigned char  );
void done_mailcap_entry( struct mailcap_entry * );
void init_mailcap( struct module * );
unsigned char *get_mailcap_field( unsigned char ** );
unsigned char *get_mailcap_field_text( unsigned char * );
unsigned char *format_command( unsigned char *, unsigned char *, int  );
struct mailcap_entry  *check_entries( struct mailcap_hash_item * );
void done_mailcap( struct module * );
int change_hook_mailcap( struct session *, struct option_elinks *, struct option_elinks * );
struct mime_handler  *get_mime_handler_mailcap( unsigned char *, int  );
...
static struct change_hook_info  mimetypes_change_hooks[2];
static struct option_info  mailcap_options[7];
