...
struct mime_handler  *get_mime_handler_default( unsigned char *, int  );
unsigned char *get_content_type_default( unsigned char * );
...
static struct option_info  default_mime_options[22];
/*****************************************************************************************/
/******                                                                             ******/
