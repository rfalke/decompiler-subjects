...
struct option_elinks  *get_real_opt( unsigned char *, unsigned char * );
void really_del_ext( void * );
void add_mime_extension( void * );
...
struct string  *add_string_replace( struct string *, unsigned char *, int , unsigned char , unsigned char  );
...
static struct menu_item  mi_no_ext[2];
/*****************************************************************************************/
/******                                                                             ******/
