...
void unregister_event_hooks( struct event_hook_info * );
void register_event_hooks( struct event_hook_info * );
void done_module( struct module * );
void done_modules( struct module ** );
void init_module( struct module * );
void init_modules( struct module ** );
void unregister_module_options( struct module * );
void unregister_modules_options( struct module ** );
void register_module_options( struct module * );
