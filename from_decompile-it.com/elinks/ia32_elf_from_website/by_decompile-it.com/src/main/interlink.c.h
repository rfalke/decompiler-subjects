...
int get_address( struct socket_info *, enum addr_type   );
void report_af_unix_error( unsigned char *, int  );
void unlink_unix( struct sockaddr * );
void done_interlink( void );
void af_unix_connection( struct socket_info * );
void elinks_usleep( unsigned long  );
