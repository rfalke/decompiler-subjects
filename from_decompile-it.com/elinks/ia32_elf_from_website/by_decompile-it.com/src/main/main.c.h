...
unsigned char *bindtextdomain( unsigned char *, unsigned char * );
unsigned char *textdomain( unsigned char * );
...
void check_stdio( struct list_head_elinks * );
void init( void );
void shrink_memory( int  );
int main( int , char ** );
void done_modules( struct module ** );
void init_modules( struct module ** );
void unregister_modules_options( struct module ** );
void register_modules_options( struct module ** );
...
struct terminal  *attach_terminal( int , int , int , void *, int  );
...
/* Warning:  conflicting decls for ac */
static int ac;
/*****************************************************************************************/
/******                                                                             ******/
