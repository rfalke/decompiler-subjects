...
unsigned char *strip_proxy_protocol( unsigned char *, unsigned char *, unsigned char * );
unsigned char *get_protocol_proxy( unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char * );
struct uri  *proxy_uri( struct uri *, unsigned char *, struct connection_state * );
