...
void about_protocol_handler( struct connection * );
void data_protocol_handler( struct connection * );
...
void generic_external_protocol_handler( struct session *, struct uri * );
unsigned char *get_user_program( struct terminal *, unsigned char *, int  );
void user_protocol_handler( struct session *, struct uri * );
void file_protocol_handler( struct connection * );
void finger_protocol_handler( struct connection * );
void ftp_protocol_handler( struct connection * );
void http_protocol_handler( struct connection * );
void proxy_protocol_handler( struct connection * );
...
static struct protocol_backend  protocol_backends[21];
static struct option_info  protocol_options[3];
static struct module  *protocol_submodules[9];
