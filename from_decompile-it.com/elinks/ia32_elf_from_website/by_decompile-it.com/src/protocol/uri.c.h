...
/******                                                                             ******/
/*****************************************************************************************/
int get_protocol_free_syntax( enum protocol   );
int get_protocol_keep_double_slashes( enum protocol   );
int get_protocol_need_slash_after_host( enum protocol   );
int get_protocol_need_slashes( enum protocol   );
int get_protocol_port( enum protocol   );
enum protocol  get_protocol( unsigned char *, int  );
void decode_uri( unsigned char * );
void decode_uri_string( struct string * );
void done_uri( struct uri * );
void free_uri_list( struct uri_list * );
...
int is_in_domain( unsigned char *, unsigned char *, int  );
int check_whether_file_exists( unsigned char * );
enum protocol  find_uri_protocol( unsigned char * );
int compare_component( unsigned char *, int , unsigned char *, int  );
int compare_uri( struct uri *, struct uri *, enum uri_component   );
int get_uri_port( struct uri * );
enum uri_errno  parse_uri( struct uri *, unsigned char * );
int is_ip_address( unsigned char *, int  );
unsigned char *normalize_uri( struct uri *, unsigned char * );
struct uri  *add_to_uri_list( struct uri_list *, struct uri * );
void encode_win32_uri_string( struct string *, unsigned char *, int  );
...
int idna_to_ascii_lz( char *, char **, int  );
...
static unsigned char *tld[16];
static unsigned char chars[4];
