...
/******                                                                             ******/
/*****************************************************************************************/
void convert_to_md5_digest_hex_T( unsigned char *, unsigned char * );
unsigned char *get_http_auth_digest_response( struct auth_entry *, struct uri * );
void elinks_internal( unsigned char * );
void init_md5( struct md5_context * );
void update_md5( struct md5_context *, unsigned char *, unsigned long  );
void done_md5( struct md5_context *, unsigned char * );
unsigned char *digest_md5( unsigned char *, unsigned long , unsigned char * );
