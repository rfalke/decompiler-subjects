...
void done_auth_entry( struct auth_entry * );
void del_auth_entry( struct auth_entry * );
void free_auth( void );
void done_auth( struct module * );
struct auth_entry  *find_auth_entry( struct uri *, unsigned char * );
void set_auth_user( struct auth_entry *, struct uri * );
void set_auth_password( struct auth_entry *, struct uri * );
...
static struct list_head_elinks  auth_entry_list;
