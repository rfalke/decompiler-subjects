...
void lock_auth_entry( struct listbox_item * );
void unlock_auth_entry( struct listbox_item * );
int is_auth_entry_used( struct listbox_item * );
struct listbox_item  *get_auth_entry_root( struct listbox_item * );
int can_delete_auth_entry( struct listbox_item * );
void delete_auth_entry( struct listbox_item *, int  );
void auth_cancel( void * );
struct uri  *get_auth_entry_uri( struct listbox_item * );
struct string  *add_bytes_to_string__( struct string *, unsigned char *, int  );
unsigned char *_( unsigned char *, struct terminal * );
unsigned char *get_auth_entry_info( struct listbox_item *, struct terminal * );
unsigned char *get_auth_entry_text( struct listbox_item *, struct terminal * );
void auth_manager( struct session * );
void auth_ok( void * );
void do_auth_dialog( struct session *, void * );
...
int elinks_strlcmp( unsigned char *, size_t , unsigned char *, size_t  );
...
static struct hierbox_browser_button  auth_buttons[4];
/*****************************************************************************************/
/******                                                                             ******/
