...
unsigned char *get_uri_rewrite_prefix( enum uri_rewrite_type  , unsigned char * );
enum evhook_status  goto_url_hook( va_list , void * );
...
static struct option_info  uri_rewrite_options[92];
extern struct event_hook_info  uri_rewrite_hooks[2];
/*****************************************************************************************/
/******                                                                             ******/
