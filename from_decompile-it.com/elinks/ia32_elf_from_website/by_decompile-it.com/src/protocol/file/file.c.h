...
struct connection_state  read_encoded_file( struct string *, struct string * );
...
void add_dir_entry( struct directory_entry *, struct string *, int , unsigned char * );
struct connection_state  connection_state( enum connection_basic_state   );
void file_protocol_handler( struct connection * );
...
struct string  *string_concat( struct string * );
...
static struct option_info  file_options[5];
/*****************************************************************************************/
/******                                                                             ******/
