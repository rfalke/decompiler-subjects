...
void close_pipe_and_read( struct socket * );
void send_post_data( struct connection * );
...
int env_set( unsigned char *, unsigned char *, int  );
...
static struct option_info  cgi_options[4];
