...
int get_pasv_socket( struct socket *, struct sockaddr_storage * );
...
void set_ip_tos_throughput( int  );
int set_nonblocking_fd( int  );
struct connection_state  init_directory_listing( struct string *, struct uri * );
...
int parse_psv_resp( unsigned char *, int *, int  );
void send_cmd( struct connection *, struct string *, void *, struct connection_state  );
int ftp_data_connect( struct connection *, int , struct sockaddr_storage *, int  );
int get_ftp_response( struct connection *, struct read_buffer *, int , struct sockaddr_storage * );
void ftp_end_request( struct connection *, struct connection_state  );
void ftp_data_accept( struct connection * );
int display_dir_entry( struct cache_entry *, off_t *, int *, struct ftp_dir_html_format *, struct ftp_file_info * );
int ftp_process_dirlist( struct cache_entry *, off_t *, unsigned char *, int , int , int *, struct ftp_dir_html_format * );
void got_something_from_data_connection( struct connection * );
void ftp_send_retr_req( struct connection *, struct connection_state  );
void ftp_protocol_handler( struct connection * );
void ftp_got_final_response( struct socket *, struct read_buffer * );
void ftp_retr_file( struct socket *, struct read_buffer * );
void prompt_username_pw( struct connection * );
void ftp_pass_info( struct socket *, struct read_buffer * );
void ftp_login( struct socket * );
void ftp_got_user_info( struct socket *, struct read_buffer * );
void ftp_got_info( struct socket *, struct read_buffer * );
struct ftp_file_info  *parse_ftp_file_info( struct ftp_file_info *, unsigned char *, int  );
void color_to_string( color_T , unsigned char * );
struct string  *add_long_to_string( struct string *, long  );
struct string  *add_cp_html_to_string( struct string *, int , unsigned char *, int  );
struct string  *add_html_to_string( struct string *, unsigned char *, int  );
...
char *inet_ntop( int , void *, char *, unsigned int  );
int connect( int , void *, unsigned int  );
void *localtime( time_t * );
...
extern struct option_info  ftp_options[7];
/*****************************************************************************************/
/******                                                                             ******/
