...
/******                                                                             ******/
/*****************************************************************************************/
int parse_year( unsigned char **, unsigned char * );
int parse_day( unsigned char **, unsigned char * );
int parse_time( unsigned char **, struct tm *, unsigned char * );
int parse_month( unsigned char **, unsigned char * );
time_t parse_date( unsigned char **, unsigned char *, int , int  );
struct ftp_file_info  *parse_ftp_winnt_response( struct ftp_file_info *, unsigned char *, int  );
