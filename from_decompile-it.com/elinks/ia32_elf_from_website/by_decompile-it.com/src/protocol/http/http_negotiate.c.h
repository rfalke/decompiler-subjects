...
struct negotiate  *http_negotiate_get( struct uri *, int *, int  );
int http_negotiate_create_context( struct negotiate * );
void http_negotiate_cleanup( struct negotiate *, int  );
int http_negotiate_output( struct uri *, struct string * );
int http_negotiate_get_name( struct connection *, struct negotiate * );
...
OM_uint32 gss_release_name( void *, void * );
OM_uint32 gss_release_buffer( void *, void * );
short **__ctype_b_loc( void );
void __stack_chk_fail( void );
OM_uint32 gss_delete_sec_context( void *, void *, void * );
OM_uint32 gss_import_name( void *, void *, gss_OID , void * );
int __snprintf_chk( char *, unsigned int , int , unsigned int , char *, ... );
OM_uint32 gss_init_sec_context( void *, void *, void *, gss_name_t , gss_OID , OM_uint32 , OM_uint32 , void *, void *, void *, void *, void *, void * );
/*****************************************************************************************/
/******                                                                             ******/
/******                        Forward Var Declarations                             ******/
/******                                                                             ******/
/*****************************************************************************************/
static struct list_head_elinks  negotiate_list;
