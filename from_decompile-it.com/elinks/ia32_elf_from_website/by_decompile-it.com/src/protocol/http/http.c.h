...
/******                                                                             ******/
/*****************************************************************************************/
struct uri  *redirect_cache( struct cache_entry *, unsigned char *, int , int  );
struct cache_entry  *find_in_cache( struct uri * );
struct cache_entry  *get_cache_entry( struct uri * );
void delete_entry_content( struct cache_entry * );
void normalize_cache_entry( struct cache_entry *, off_t  );
int add_fragment( struct cache_entry *, off_t , unsigned char *, ssize_t  );
union option_value  *get_opt_( struct option_elinks *, unsigned char * );
struct string  *send_cookies( struct uri * );
void set_cookie( struct uri *, unsigned char * );
int read_encoded( struct stream_encoded *, unsigned char *, int  );
unsigned char *get_encoding_name( enum stream_encoding   );
struct stream_encoded  *open_encoded( int , enum stream_encoding   );
enum stream_encoding  guess_encoding( unsigned char * );
unsigned char *get_cp_mime_name( int  );
unsigned char *language_to_iso639( int  );
void shutdown_connection_stream( struct connection * );
void set_connection_state( struct connection *, struct connection_state  );
int has_keepalive_connection( struct connection * );
void add_keepalive_connection( struct connection *, long , void (*)( struct connection * ) );
...
void complete_connect_socket( struct socket *, struct uri *, socket_connect_T  );
void read_from_socket( struct socket *, struct read_buffer *, struct connection_state , socket_read_T  );
void request_from_socket( struct socket *, unsigned char *, int , struct connection_state , enum socket_state  , socket_read_T  );
void make_connection( struct socket *, struct uri *, socket_connect_T , int  );
int c_pipe( int * );
...
struct string  *add_uri_to_string( struct string *, struct uri *, enum uri_component   );
unsigned char *get_uri_string( struct uri *, enum uri_component   );
struct auth_entry  *add_auth_entry( struct uri *, unsigned char *, unsigned char *, unsigned char *, unsigned int  );
struct auth_entry  *find_auth( struct uri * );
unsigned char *get_http_auth_digest_response( struct auth_entry *, struct uri * );
...
void http_error_document( struct connection *, int  );
void done_http( void );
struct connection_state  connection_state( enum connection_basic_state   );
void http_end_request( struct connection *, struct connection_state , int  );
unsigned char *decompress_data( struct connection *, unsigned char *, int , int * );
struct string  *add_bytes_to_string__( struct string *, unsigned char *, int  );
struct http_connection_info  *init_http_connection_info( struct connection *, int , int , int  );
void read_http_data_done( struct connection * );
void read_more_http_data( struct connection *, struct read_buffer *, int  );
void read_http_data( struct socket *, struct read_buffer * );
void add_url_to_http_string( struct string *, struct uri *, int  );
void http_got_header( struct socket *, struct read_buffer * );
unsigned char *subst_user_agent( unsigned char *, unsigned char *, unsigned char *, unsigned char * );
void http_send_header( struct socket * );
void http_protocol_handler( struct connection * );
int http_negotiate_output( struct uri *, struct string * );
int http_negotiate_input( struct connection *, struct uri *, int , unsigned char * );
...
int c_toupper( int  );
struct string  *add_long_to_string( struct string *, long  );
...
timeval_T *timeval_add_interval( timeval_T *, timeval_T * );
timeval_T *timeval_from_seconds( timeval_T *, long  );
timeval_T *timeval_now( timeval_T * );
int *__errno_location( void );
char *strchr( char *, int  );
int write( int , void *, unsigned int  );
void *memset( void *, int , unsigned int  );
void *__memcpy_chk( void *, void *, unsigned int , unsigned int  );
...
extern unsigned char system_name[1024];
static unsigned char *buggy_servers[4];
static struct auth_entry  proxy_auth;
static unsigned char *accept_charset;
static struct option_info  http_options[23];
/*****************************************************************************************/
/******                                                                             ******/
