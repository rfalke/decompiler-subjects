...
/******                                                                             ******/
/*****************************************************************************************/
struct css_selector  *reparent_selector( struct list_head_elinks *, struct css_selector *, struct css_selector ** );
void css_parse_properties( struct list_head_elinks *, struct scanner * );
void skip_css_block( struct scanner * );
...
void add_selector_properties( struct css_selector *, struct list_head_elinks * );
...
struct css_selector  *get_css_selector( struct list_head_elinks *, enum css_selector_type  , enum css_selector_relation  , unsigned char *, int  );
