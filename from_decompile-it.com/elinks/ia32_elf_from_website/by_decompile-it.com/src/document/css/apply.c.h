...
void css_apply_text_align( struct html_context *, struct html_element *, struct css_property * );
void css_apply_font_attribute( struct html_context *, struct html_element *, struct css_property * );
void css_apply_display( struct html_context *, struct html_element *, struct css_property * );
void css_apply_color( struct html_context *, struct html_element *, struct css_property * );
void css_apply_background_color( struct html_context *, struct html_element *, struct css_property * );
void examine_element( struct html_context *, struct css_selector *, enum css_selector_type  , enum css_selector_relation  , struct list_head_elinks *, struct html_element * );
...
void css_parse_properties( struct list_head_elinks *, struct scanner * );
void done_css_selector( struct css_selector * );
void merge_css_selectors( struct css_selector *, struct css_selector * );
struct css_selector  *init_css_selector( struct list_head_elinks *, enum css_selector_type  , unsigned char *, int  );
...
void mem_free( void * );
void init_scanner( struct scanner *, struct scanner_info *, unsigned char *, unsigned char * );
/*****************************************************************************************/
/******                                                                             ******/
...
static css_applier_T css_appliers[10];
