...
/******                                                                             ******/
/*****************************************************************************************/
int css_parse_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_display_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_white_space_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_text_decoration_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_text_align_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_font_style_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_font_weight_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_color_value( struct css_property_info *, union css_property_value *, struct scanner * );
int css_parse_background_value( struct css_property_info *, union css_property_value *, struct scanner * );
int decode_color( unsigned char *, int , color_T * );
void elinks_internal( unsigned char * );
struct scanner_token  *skip_scanner_tokens( struct scanner *, int , int  );
