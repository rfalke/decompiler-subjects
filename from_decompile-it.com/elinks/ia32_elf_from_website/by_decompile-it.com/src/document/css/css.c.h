...
void done_css( struct module * );
void import_css_file( struct css_stylesheet *, struct uri *, unsigned char *, int  );
void import_default_css( void );
void init_css( struct module * );
int change_hook_css( struct session *, struct option_elinks *, struct option_elinks * );
...
static struct change_hook_info  css_change_hooks[2];
extern struct option_info  css_options_info[5];
