...
/******                                                                             ******/
/*****************************************************************************************/
struct bookmark  *get_bookmark( unsigned char * );
...
struct css_selector  *find_css_selector( struct list_head_elinks *, enum css_selector_type  , enum css_selector_relation  , unsigned char *, int  );
struct screen_char  *realloc_line( struct document *, int , int  );
void render_dom_text( struct dom_renderer *, struct screen_char *, unsigned char *, int  );
void render_dom_flush( struct dom_renderer *, unsigned char * );
enum dom_code  render_dom_element_end_source( struct dom_stack *, struct dom_node *, void * );
struct dom_string  *get_rss_text( struct dom_node *, enum rss_element_type   );
enum dom_code  dom_rss_pop_element( struct dom_stack *, struct dom_node *, void * );
enum dom_code  dom_rss_push_element( struct dom_stack *, struct dom_node *, void * );
void render_dom_document( struct cache_entry *, struct document *, struct string * );
void render_rss_item( struct dom_renderer *, struct dom_node * );
enum dom_code  dom_rss_pop_document( struct dom_stack *, struct dom_node *, void * );
enum dom_code  render_dom_document_end( struct dom_stack *, struct dom_node *, void * );
enum dom_code  render_dom_node_source( struct dom_stack *, struct dom_node *, void * );
enum dom_code  render_dom_element_source( struct dom_stack *, struct dom_node *, void * );
enum dom_code  render_dom_cdata_source( struct dom_stack *, struct dom_node *, void * );
enum dom_code  render_dom_attribute_source( struct dom_stack *, struct dom_node *, void * );
struct dom_config  *add_dom_config_normalizer( struct dom_stack *, struct dom_config *, enum dom_config_flag   );
struct dom_string  *get_dom_node_type_name( enum dom_node_type   );
void done_dom_node_list( struct dom_node_list * );
struct dom_node_list  *add_to_dom_node_list( struct dom_node_list **, struct dom_node *, int  );
struct dom_node  *get_dom_node_child( struct dom_node *, enum dom_node_type  , int16_t  );
struct dom_node  *init_dom_node_at( struct dom_node *, enum dom_node_type  , struct dom_string *, int  );
void pop_dom_node( struct dom_stack * );
struct dom_stack_context  *add_dom_stack_context( struct dom_stack *, void *, struct dom_stack_context_info * );
void done_sgml_parser( struct sgml_parser * );
enum dom_code  parse_sgml( struct sgml_parser *, unsigned char *, size_t , int  );
struct sgml_parser  *init_sgml_parser( enum sgml_parser_type  , enum sgml_document_type  , struct dom_string *, enum sgml_parser_flag   );
...
static unsigned char default_colors[208];
