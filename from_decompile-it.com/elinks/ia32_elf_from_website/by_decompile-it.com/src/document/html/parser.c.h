...
struct conv_table  *get_convert_table( unsigned char *, int , int , int *, enum cp_status  *, int  );
void import_css( struct css_stylesheet *, struct uri * );
void done_css_stylesheet( struct css_stylesheet * );
void mirror_css_stylesheet( struct css_stylesheet *, struct css_stylesheet * );
void ln_break( struct html_context *, int  );
void add_fragment_identifier( struct html_context *, struct part *, unsigned char * );
void done_html_parser_state( struct html_context *, void * );
void done_html_parser( struct html_context * );
struct html_context  *init_html_parser( struct uri *, struct document_options *, unsigned char *, unsigned char *, struct string *, struct string *, void (*)( struct html_context *, unsigned char *, int  ), void (*)( struct html_context * ), void *(*)( struct html_context *, enum html_special_type   ) );
void *init_html_parser_state( struct html_context *, enum html_element_mortality_type  , int , int , int  );
void set_fragment_identifier( struct html_context *, unsigned char *, unsigned char * );
...
void import_css_stylesheet( struct css_stylesheet *, struct uri *, unsigned char *, int  );
unsigned char *get_target( struct document_options *, unsigned char * );
int get_image_map( unsigned char *, unsigned char *, unsigned char *, struct menu_item **, struct memory_list **, struct uri *, struct document_options *, unsigned char *, int , int , int  );
...
void map_selected( struct terminal *, void *, void * );
...
long timeval_to_seconds( timeval_T * );
