...
struct menu_item  *detach_menu( struct list_menu * );
void destroy_menu( struct list_menu * );
void new_menu_item( struct list_menu *, unsigned char *, int , int  );
void add_select_item( struct list_menu *, struct string *, struct string *, unsigned char **, int , int  );
void init_menu( struct list_menu * );
...
struct form_control  *init_form_control( enum form_type  , unsigned char *, struct html_context * );
