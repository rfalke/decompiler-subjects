...
/******                                                                             ******/
/*****************************************************************************************/
void css_apply( struct html_context *, struct html_element *, struct css_stylesheet *, struct list_head_elinks * );
void parse_frame_widths( unsigned char *, int , int , int **, int * );
void ln_break( struct html_context *, int  );
void html_skip( struct html_context *, unsigned char * );
void put_chrs( struct html_context *, unsigned char *, int  );
void html_focusable( struct html_context *, unsigned char * );
void process_head( struct html_context *, unsigned char * );
unsigned char *get_target( struct document_options *, unsigned char * );
int get_color( struct html_context *, unsigned char *, unsigned char *, color_T * );
int get_bgcolor( struct html_context *, unsigned char *, color_T * );
...
void html_h( int , unsigned char *, enum format_align  , struct html_context *, unsigned char *, unsigned char *, unsigned char ** );
...
void put_link_line( unsigned char *, unsigned char *, unsigned char *, unsigned char *, struct html_context * );
...
struct html_element  *search_html_stack( struct html_context *, unsigned char * );
...
void kill_html_stack_until( struct html_context *, int  );
void done_uri( struct uri * );
unsigned char *join_urls( struct uri *, unsigned char * );
