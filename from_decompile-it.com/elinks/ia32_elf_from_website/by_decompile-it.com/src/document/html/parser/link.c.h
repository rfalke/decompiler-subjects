...
unsigned char *truncate_label( unsigned char *, int  );
unsigned char *get_image_filename_from_src( int , unsigned char * );
void put_image_label( unsigned char *, unsigned char *, struct html_context * );
void html_img_do( unsigned char *, unsigned char *, struct html_context * );
...
void html_iframe_do( unsigned char *, unsigned char *, struct html_context * );
...
static struct lt_default_name  lt_names[32];
/*****************************************************************************************/
/******                                                                             ******/
