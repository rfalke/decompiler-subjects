...
void add_table_bad_html_end( struct table_elinks *, unsigned char * );
void free_table( struct table_elinks * );
void get_align( struct html_context *, unsigned char *, int * );
void get_valign( struct html_context *, unsigned char *, int * );
void set_td_width( struct table_elinks *, int , int , int  );
void get_column_width( unsigned char *, int *, int , struct html_context * );
struct table_cell  *new_cell( struct table_elinks *, int , int  );
void new_columns( struct table_elinks *, int , int , int , int , int  );
