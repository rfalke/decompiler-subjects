...
/******                                                                             ******/
/*****************************************************************************************/
struct line  *realloc_lines( struct document *, int  );
void get_screen_char_template( struct screen_char *, struct document_options *, struct text_style  );
void done_form_control( struct form_control * );
void done_form( struct form * );
struct form  *init_form( void );
void done_document_refresh( struct document_refresh * );
struct document_refresh  *init_document_refresh( unsigned char *, unsigned long  );
struct conv_table  *get_convert_table( unsigned char *, int , int , int *, enum cp_status  *, int  );
void add_frameset_entry( struct frameset_desc *, struct frameset_desc *, unsigned char *, unsigned char * );
struct frameset_desc  *create_frameset( struct frameset_param * );
...
void check_html_form_hierarchy( struct part * );
void *html_special( struct html_context *, enum html_special_type   );
void move_links( struct html_context *, int , int , int , int  );
void del_chars( struct html_context *, int , int  );
void *mem_align_alloc__( void **, size_t , size_t , size_t , size_t  );
int realloc_line( struct html_context *, struct document *, int , int  );
void draw_frame_hchars( struct part *, int , int , int , unsigned char , color_T , color_T , struct html_context * );
void expand_lines( struct html_context *, struct part *, int , int , int , color_T  );
void align_line( struct html_context *, int , int  );
void line_break( struct html_context * );
void free_table_cache( void );
struct part  *format_html_part( struct html_context *, unsigned char *, unsigned char *, int , int , int , struct document *, int , int , unsigned char *, int  );
void render_html_document( struct cache_entry *, struct document *, struct string * );
void draw_frame_vchars( struct part *, int , int , int , unsigned char , color_T , color_T , struct html_context * );
int split_line_at( struct html_context *, int  );
void put_chars( struct html_context *, unsigned char *, int  );
void put_chars_conv( struct html_context *, unsigned char *, int  );
void parse_html( unsigned char *, unsigned char *, struct part *, unsigned char *, struct html_context * );
int is_cp_utf8( int  );
int utf8charlen( unsigned char * );
...
struct uri  *add_to_uri_list( struct uri_list *, struct uri * );
...
struct hash_item  *get_hash_item( struct hash *, unsigned char *, unsigned int  );
struct hash_item  *add_hash_item( struct hash *, unsigned char *, unsigned int , void * );
...
static struct text_style  ta_cache;
