...
int get_hline_width( struct table_elinks *, int  );
void get_table_frames( struct table_elinks *, struct table_frames * );
void draw_table_frames( struct table_elinks *, int , int , struct html_context * );
...
void free_table( struct table_elinks * );
struct table_elinks  *parse_table( unsigned char *, unsigned char *, unsigned char **, unsigned char *, int , struct html_context * );
...
static unsigned char hltable[3];
static enum border_char  border_chars[81];
static unsigned char vltable[3];
/*****************************************************************************************/
/******                                                                             ******/
