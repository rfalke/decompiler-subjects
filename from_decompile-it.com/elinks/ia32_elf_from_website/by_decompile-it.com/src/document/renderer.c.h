...
unsigned long get_document_css_magic( struct document * );
void done_link_members( struct link * );
struct document  *get_cached_document( struct cache_entry *, struct document_options * );
struct document  *init_document( struct cache_entry *, struct document_options * );
void init_document_options( struct document_options * );
int comp_links( void *, void * );
...
void format_frames( struct session *, struct frameset_desc *, struct document_options *, int  );
void render_html_document( struct cache_entry *, struct document *, struct string * );
void render_plain_document( struct cache_entry *, struct document *, struct string * );
unsigned char *decode_encoded_buffer( enum stream_encoding  , unsigned char *, int , int * );
