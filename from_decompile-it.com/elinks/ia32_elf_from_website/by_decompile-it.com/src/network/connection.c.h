...
void notify_connection_callbacks( struct connection * );
enum connection_priority  get_priority( struct connection * );
...
struct connection  *init_connection( struct uri *, struct uri *, struct uri *, off_t , enum cache_mode  , enum connection_priority   );
struct host_connection  *get_host_connection( struct connection * );
int add_host_connection( struct connection * );
void set_connection_timeout( struct connection * );
void set_connection_socket_timeout( struct socket *, struct connection_state  );
...
void set_connection_socket_state( struct socket *, struct connection_state  );
void stat_timer( struct connection * );
int try_to_suspend_connection( struct connection *, struct uri * );
int load_uri( struct uri *, struct uri *, struct download *, enum connection_priority  , enum cache_mode  , off_t  );
void done_connection( struct connection * );
int do_keepalive_connection_callback( struct keepalive_connection * );
...
void done_connection_socket( struct socket *, struct connection_state  );
...
void retry_connection_socket( struct socket *, struct connection_state  );
void check_queue( void );
void update_progress( struct progress *, off_t , off_t , off_t  );
void done_progress( struct progress * );
struct progress  *init_progress( off_t  );
void start_update_progress( struct progress *, void (*)( void * ), void * );
struct socket  *init_socket( void *, struct socket_operations * );
void done_socket( struct socket * );
void timeout_socket( struct socket * );
unsigned char *get_ssl_connection_cipher( struct socket * );
protocol_handler_T *get_protocol_handler( enum protocol   );
int get_protocol_need_slash_after_host( enum protocol   );
struct uri  *get_proxied_uri( struct uri * );
struct uri  *get_proxy_uri( struct uri *, struct connection_state * );
...
int timeval_cmp( timeval_T *, timeval_T * );
...
static struct list_head_elinks  connection_queue;
static struct list_head_elinks  host_connections;
static struct list_head_elinks  keepalive_connections;
/*****************************************************************************************/
/******                                                                             ******/
