...
void ssl_want_read( struct socket * );
...
int gnutls_record_recv( gnutls_session_t , void *, unsigned int  );
int gnutls_record_send( gnutls_session_t , void *, unsigned int  );
int gnutls_handshake( gnutls_session_t  );
void gnutls_transport_set_ptr( gnutls_session_t , void * );
int gnutls_protocol_set_priority( gnutls_session_t , int * );
int gnutls_certificate_verify_peers( gnutls_session_t  );
int gnutls_bye( gnutls_session_t , void * );
/*****************************************************************************************/
/******                                                                             ******/
...
static int protocol_priority[2];
/*****************************************************************************************/
/******                                                                             ******/
