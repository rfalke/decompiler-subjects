...
void done_gnutls( struct module * );
void init_gnutls( struct module * );
unsigned char *get_ssl_connection_cipher( struct socket * );
void done_ssl_connection( struct socket * );
int init_ssl_connection( struct socket * );
...
void *gnutls_mac_get( gnutls_session_t  );
int gnutls_global_init( void );
char *gnutls_certificate_type_get_name( void * );
char *gnutls_protocol_get_name( void * );
int gnutls_certificate_set_x509_trust_file( gnutls_certificate_credentials_t , char *, void * );
void *gnutls_compression_get( gnutls_session_t  );
int gnutls_certificate_allocate_credentials( void * );
void gnutls_certificate_set_verify_flags( gnutls_certificate_credentials_t , unsigned int  );
int gnutls_cipher_set_priority( gnutls_session_t , int * );
void gnutls_anon_free_client_credentials( gnutls_anon_client_credentials_t  );
int gnutls_credentials_set( gnutls_session_t , void *, void * );
char *gnutls_cipher_get_name( void * );
int gnutls_init( gnutls_session_t *, void * );
int gnutls_kx_set_priority( gnutls_session_t , int * );
void *gnutls_protocol_get_version( gnutls_session_t  );
void gnutls_deinit( gnutls_session_t  );
int gnutls_anon_allocate_client_credentials( void * );
char *gnutls_mac_get_name( void * );
char *gnutls_compression_get_name( void * );
void gnutls_certificate_free_credentials( gnutls_certificate_credentials_t  );
void *gnutls_certificate_type_get( gnutls_session_t  );
int gnutls_priority_set_direct( gnutls_session_t , char *, char ** );
void *gnutls_kx_get( gnutls_session_t  );
char *gnutls_kx_get_name( void * );
void gnutls_global_deinit( void );
void *gnutls_cipher_get( gnutls_session_t  );
char *gnutls_strerror( int  );
/*****************************************************************************************/
/******                                                                             ******/
...
static struct option_info  gnutls_options[3];
static struct module  gnutls_module;
static struct option_info  ssl_options[2];
static struct module  *ssl_modules[2];
