...
void del_dns_cache_entry( struct dnsentry * );
void shrink_dns_cache( int  );
void done_dns_lookup( struct dnsquery *, enum dns_result   );
void kill_dns_request( void ** );
void async_dns_error( struct dnsquery * );
enum dns_result  read_dns_data( int , void *, size_t  );
void async_dns_reader( struct dnsquery * );
enum dns_result  write_dns_data( int , void *, size_t  );
enum dns_result  do_real_lookup( unsigned char *, struct sockaddr_storage **, int *, int  );
void async_dns_writer( void *, int  );
enum dns_result  init_dns_lookup( unsigned char *, void **, dns_callback_T , void * );
...
static struct list_head_elinks  dns_cache;
/*****************************************************************************************/
/******                                                                             ******/
