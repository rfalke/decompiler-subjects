...
select_handler_T get_handler( int , enum select_handler_type   );
void kill_dns_request( void ** );
enum dns_result  find_host( unsigned char *, void **, dns_callback_T , void *, int  );
struct connection_state  connection_state( enum connection_basic_state   );
void kill_buffer_data( struct read_buffer *, int  );
struct read_buffer  *alloc_read_buffer( struct socket * );
struct socket  *init_socket( void *, struct socket_operations * );
struct connect_info  *init_connection_info( struct uri *, struct socket *, socket_connect_T  );
void done_connection_info( struct socket * );
...
void exception( struct socket * );
void read_from_socket( struct socket *, struct read_buffer *, struct connection_state , socket_read_T  );
void read_response_from_socket( struct socket * );
void write_to_socket( struct socket *, unsigned char *, int , struct connection_state , socket_write_T  );
void read_select( struct socket * );
void write_select( struct socket * );
void connect_socket( struct socket *, struct connection_state  );
void dns_found( struct socket *, struct sockaddr_storage *, int  );
void timeout_socket( struct socket * );
void dns_exception( struct socket * );
void connected( struct socket * );
void make_connection( struct socket *, struct uri *, socket_connect_T , int  );
int ssl_close( struct socket * );
ssize_t ssl_read( struct socket *, unsigned char *, int  );
ssize_t ssl_write( struct socket *, unsigned char *, int  );
int ssl_connect( struct socket * );
void set_ip_tos_throughput( int  );
int set_nonblocking_fd( int  );
int get_protocol_need_ssl( enum protocol   );
...
static struct list_head_elinks  socket_weak_refs;
/*****************************************************************************************/
/******                                                                             ******/
