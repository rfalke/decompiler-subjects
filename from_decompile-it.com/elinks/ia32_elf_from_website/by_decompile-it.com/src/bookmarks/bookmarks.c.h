...
enum evhook_status  bookmark_change_hook( va_list , void * );
int change_hook_folder_state( struct session *, struct option_elinks *, struct option_elinks * );
void free_bookmarks( struct list_head_elinks *, struct list_head_elinks * );
struct bookmark  *get_bookmark_by_name( struct bookmark *, unsigned char * );
...
void bookmark_terminal( struct terminal *, struct bookmark * );
void bookmark_terminal_tabs( struct terminal *, unsigned char * );
void delete_bookmark( struct bookmark * );
void bookmark_auto_save_tabs( struct terminal * );
void write_bookmarks( void );
void done_bookmarks( struct module * );
enum evhook_status  bookmark_write_hook( va_list , void * );
void init_bookmarks( struct module * );
...
int sanitize_url( unsigned char * );
void sanitize_title( unsigned char * );
void elinks_internal( unsigned char * );
void del_hash_item( struct hash *, struct hash_item * );
...
static int update_bookmark_event_id;
static int delete_bookmark_event_id;
static struct change_hook_info  bookmarks_change_hooks[2];
static int bookmarks_dirty;
static struct hash  *bookmark_cache;
static struct bookmark  *bm_snapshot_last_folder;
static struct option_info  bookmark_options_info[5];
extern struct list_head_elinks  terminals;
extern struct hierbox_browser  bookmark_browser;
extern struct event_hook_info  bookmark_hooks[5];
