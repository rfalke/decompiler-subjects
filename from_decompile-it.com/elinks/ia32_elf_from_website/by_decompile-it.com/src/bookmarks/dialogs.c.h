...
widget_handler_status_T push_hierbox_goto_button( struct dialog_data *, struct widget_data * );
...
int update_bookmark( struct bookmark *, int , unsigned char *, unsigned char * );
struct bookmark  *add_bookmark_cp( struct bookmark *, int , int , unsigned char *, unsigned char * );
void bookmark_terminal_tabs( struct terminal *, unsigned char * );
void delete_bookmark( struct bookmark * );
void write_bookmarks( void );
void lock_bookmark( struct listbox_item * );
void unlock_bookmark( struct listbox_item * );
int is_bookmark_used( struct listbox_item * );
struct listbox_item  *get_bookmark_root( struct listbox_item * );
int can_delete_bookmark( struct listbox_item * );
void bookmark_edit_cancel( struct dialog * );
void update_depths( struct listbox_item * );
void delete_bookmark_item( struct listbox_item *, int  );
struct uri  *get_bookmark_uri( struct listbox_item * );
unsigned char *get_bookmark_text( struct listbox_item *, struct terminal * );
unsigned char *_( unsigned char *, struct terminal * );
unsigned char *get_bookmark_info( struct listbox_item *, struct terminal * );
void add_converted_bytes_to_string( void *, unsigned char *, int  );
void free_last_searched_bookmark( void );
widget_handler_status_T push_search_button( struct dialog_data *, struct widget_data * );
void launch_bm_add_dialog( struct terminal *, struct dialog_data *, struct session *, unsigned char *, unsigned char * );
...
void bookmark_search_do( void * );
int test_search( struct listbox_item *, void *, int * );
enum move_bookmark_flags  do_move_bookmark( struct bookmark *, int , struct list_head_elinks *, struct listbox_data * );
widget_handler_status_T push_move_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_add_folder_button( struct dialog_data *, struct widget_data * );
void do_add_bookmark( struct terminal *, struct dialog_data *, unsigned char *, unsigned char * );
void do_add_folder( struct dialog_data *, unsigned char * );
void bookmark_add_add( void * );
widget_handler_status_T push_add_separator_button( struct dialog_data *, struct widget_data * );
void bookmark_edit_done( void * );
void bookmark_terminal_tabs_ok( void *, unsigned char * );
...
void do_edit_dialog( struct terminal *, int , unsigned char *, unsigned char *, unsigned char *, struct session *, struct dialog_data *, done_handler_T *, void (*)( struct dialog * ), void *, enum edit_dialog_type   );
...
struct string  *add_date_to_string( struct string *, unsigned char *, time_t * );
...
static int move_bookmark_event_id;
...
static struct hierbox_browser_button  bookmark_buttons[8];
static unsigned char *bm_last_searched_title;
static unsigned char *bm_last_searched_url;
extern struct list_head_elinks  bookmarks;
/*****************************************************************************************/
/******                                                                             ******/
