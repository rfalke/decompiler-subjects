...
unsigned char *filename_bookmarks_default( int  );
void write_bookmarks_default_inner( struct write_bookmarks_default *, struct list_head_elinks * );
void write_bookmarks_default( struct secure_save_info *, struct list_head_elinks * );
void read_bookmarks_default( FILE * );
