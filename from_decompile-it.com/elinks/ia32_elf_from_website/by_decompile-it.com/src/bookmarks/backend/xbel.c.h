...
unsigned char *filename_bookmarks_xbel( int  );
void on_element_close( void *, char * );
void print_xml_entities( struct secure_save_info *, unsigned char * );
void write_bookmarks_list( struct secure_save_info *, struct list_head_elinks *, int , int  );
void write_bookmarks_xbel( struct secure_save_info *, struct list_head_elinks * );
void free_node( struct tree_node * );
void free_xbeltree( struct tree_node * );
void on_text( void *, XML_Char *, int  );
void on_element_open( void *, char *, char ** );
int xbeltree_to_bookmarks_list( struct read_bookmarks_xbel *, struct tree_node *, struct bookmark * );
void read_bookmarks_xbel( FILE * );
...
void *XML_GetCurrentColumnNumber( XML_Parser  );
unsigned int strlen( char * );
int feof( FILE * );
void *XML_GetCurrentLineNumber( XML_Parser  );
void *XML_ErrorString( int  );
void __stack_chk_fail( void );
void XML_ParserFree( XML_Parser  );
void XML_SetElementHandler( XML_Parser , void *, void * );
int XML_Parse( XML_Parser , char *, int , int  );
unsigned int fread( void *, unsigned int , unsigned int , FILE * );
int ferror( FILE * );
void XML_SetCharacterDataHandler( XML_Parser , void * );
/*****************************************************************************************/
/******                                                                             ******/
