...
void add_uri_command_to_menu( struct menu_item **, enum pass_uri_type  , unsigned char * );
void do_setup_menu( struct terminal *, void *, void * );
void do_submenu( struct terminal *, void *, void * );
void history_menu_common( struct terminal *, struct session *, int  );
void unhistory_menu( struct terminal *, void *, void * );
void history_menu( struct terminal *, void *, void * );
void do_pass_uri_to_command( struct terminal *, void *, void * );
void add_new_win_to_menu( struct menu_item **, unsigned char *, struct terminal * );
void open_in_new_window( struct terminal *, void *, void * );
void add_cmdline_bool_option( struct string *, unsigned char * );
...
void do_file_menu( struct terminal *, void *, void * );
void go_historywards( struct terminal *, void *, void * );
void tab_menu( struct session *, int , int , int  );
void really_exit_prog( void * );
void query_exit( struct session * );
...
void trigger_event_name( unsigned char * );
...
struct string  *add_shell_quoted_to_string( struct string *, unsigned char *, int  );
void elinks_internal( unsigned char * );
struct directory_entry  *get_directory_entries( unsigned char *, int  );
unsigned char *get_filename_position( unsigned char * );
int file_is_dir( unsigned char * );
int file_can_read( unsigned char * );
int file_exists( unsigned char * );
void mem_free( void * );
...
extern struct list_head_elinks  terminals;
extern struct program  program;
static struct menu_item  no_hist_menu[2];
static struct menu_item  file_menu11[7];
static struct menu_item  file_menu21[5];
static struct menu_item  file_menu22[5];
static struct menu_item  file_menu3[3];
static struct menu_item  view_menu[22];
static struct menu_item  help_menu[11];
static struct menu_item  ext_menu[4];
static struct menu_item  setup_menu[9];
static struct menu_item  setup_menu_anon[4];
static struct menu_item  tools_menu[8];
static struct menu_item  main_menu[7];
static struct input_history {
     struct list_head_elinks  entries;
     int size;
     unsigned int bits_at_12;
  } file_history;
static struct menu_item  empty_directory_menu[2];
extern struct input_history  goto_url_history;
extern struct open_in_new  open_in_new[];
/*****************************************************************************************/
/******                                                                             ******/
