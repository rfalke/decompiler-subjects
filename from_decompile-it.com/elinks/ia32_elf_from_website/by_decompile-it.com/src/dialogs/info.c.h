...
void refreshed_msg_box( struct terminal *, enum msgbox_flags  , unsigned char *, enum format_align  , unsigned char *(*)( struct terminal *, void * ), void * );
...
void push_toggle_keys_display_button( void * );
void menu_about( struct terminal *, void *, void * );
unsigned char *get_resource_info( struct terminal *, void * );
...
unsigned char *ngettext( unsigned char *, unsigned char *, unsigned long  );
unsigned char *gettext( unsigned char * );
int get_file_handles_count( void );
int get_timers_count( void );
unsigned char *get_dyn_full_version( struct terminal *, int  );
