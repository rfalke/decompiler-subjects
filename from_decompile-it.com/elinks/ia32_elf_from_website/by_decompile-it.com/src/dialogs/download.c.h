...
void refresh_dialog( struct dialog_data *, dialog_refresh_handler_T , void * );
void draw_dialog( struct dialog_data *, int , int  );
...
void dlg_format_text_do( struct terminal *, unsigned char *, int , int *, int , int *, struct color_pair *, enum format_align  , int  );
void download_abort_function( struct dialog_data * );
void lock_file_download( struct listbox_item * );
void unlock_file_download( struct listbox_item * );
int is_file_download_used( struct listbox_item * );
unsigned char *get_file_download_info( struct listbox_item *, struct terminal * );
struct uri  *get_file_download_uri( struct listbox_item * );
struct listbox_item  *get_file_download_root( struct listbox_item * );
int can_delete_file_download( struct listbox_item * );
void done_download_display( struct file_download * );
enum dlg_refresh_code  refresh_file_download( struct dialog_data *, void * );
void delete_file_download( struct listbox_item *, int  );
widget_handler_status_T push_delete_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T dlg_abort_download( struct dialog_data *, struct widget_data * );
widget_handler_status_T dlg_undisplay_download( struct dialog_data *, struct widget_data * );
void do_abort_download( struct file_download * );
unsigned char *get_file_download_text( struct listbox_item *, struct terminal * );
void draw_file_download( struct listbox_item *, struct listbox_context *, int , int , int  );
void init_download_display( struct file_download * );
void download_manager( struct session * );
void undisplay_download( struct file_download * );
widget_handler_status_T dlg_set_notify( struct dialog_data *, struct widget_data * );
void download_dialog_layouter( struct dialog_data * );
void display_download( struct terminal *, struct file_download *, struct session * );
widget_handler_status_T push_info_button( struct dialog_data *, struct widget_data * );
void draw_progress_bar( struct progress *, struct terminal *, int , int , int , unsigned char *, struct color_pair * );
unsigned char *get_download_msg( struct download *, struct terminal *, int , int , unsigned char * );
...
void draw_text( struct terminal *, int , int , unsigned char *, int , enum screen_char_attr  , struct color_pair * );
...
static struct hierbox_browser_button  download_buttons[3];
static struct hierbox_browser  download_browser;
/*****************************************************************************************/
/******                                                                             ******/
