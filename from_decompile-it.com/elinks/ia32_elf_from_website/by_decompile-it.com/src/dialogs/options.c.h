...
void push_resize_button( void * );
void menu_language_list( struct terminal *, void *, void * );
void menu_set_language( struct terminal *, void *, void * );
widget_handler_status_T push_ok_button( struct dialog_data *, struct widget_data * );
...
void display_codepage( struct terminal *, void *, void * );
...
static struct option_resolver  resolvers[8];
