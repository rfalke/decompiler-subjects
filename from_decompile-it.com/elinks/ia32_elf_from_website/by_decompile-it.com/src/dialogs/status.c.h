...
/******                                                                             ******/
/*****************************************************************************************/
void set_led_value( struct led *, unsigned char  );
void unset_led_value( struct led * );
void draw_leds( struct session * );
...
unsigned char *get_progress_msg( struct progress *, struct terminal *, int , int , unsigned char * );
...
void render_document_frames( struct session *, int  );
