...
/******                                                                             ******/
/*****************************************************************************************/
int _nl_explode_name( unsigned char *, unsigned char **, unsigned char **, unsigned char **, unsigned char **, unsigned char **, unsigned char **, unsigned char **, unsigned char ** );
struct loaded_l10nfile  *_nl_find_domain( unsigned char *, unsigned char *, unsigned char *, struct binding * );
struct loaded_l10nfile  *_nl_make_l10nflist( struct loaded_l10nfile **, unsigned char *, size_t , int , unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int  );
void _nl_load_domain( struct loaded_l10nfile *, struct binding * );
unsigned char *_nl_expand_alias( unsigned char * );
void free( void * );
