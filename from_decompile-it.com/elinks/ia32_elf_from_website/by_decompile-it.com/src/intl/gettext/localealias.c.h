...
/******                                                                             ******/
/*****************************************************************************************/
size_t read_alias_file( unsigned char *, int  );
unsigned char *_nl_expand_alias( unsigned char * );
int alias_compare( struct alias_map *, struct alias_map * );
void mem_free( void * );
...
/******                                                                             ******/
/*****************************************************************************************/
/* Warning:  conflicting decls for map */
static struct alias_map  *map;
static unsigned char *locale_alias_path;
