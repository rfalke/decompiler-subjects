...
/******                                                                             ******/
/*****************************************************************************************/
unsigned long plural_eval( struct expression *, unsigned long  );
int transcmp( void *, void * );
unsigned char *_nl_find_msg( struct loaded_l10nfile *, struct binding *, unsigned char *, size_t * );
unsigned char *plural_lookup( struct loaded_l10nfile *, unsigned long , unsigned char *, size_t  );
unsigned char *dcigettext__( unsigned char *, unsigned char *, unsigned char *, int , unsigned long , int  );
struct loaded_l10nfile  *_nl_find_domain( unsigned char *, unsigned char *, unsigned char *, struct binding * );
void _nl_free_domain_conv( struct loaded_domain * );
unsigned char *_nl_init_domain_conv( struct loaded_l10nfile *, struct loaded_domain *, struct binding * );
...
void *mempcpy( void *, void *, unsigned int  );
char *stpcpy( char *, char * );
void free( void * );
void *tfind( void *, void *, void * );
...
/******                                                                             ******/
/*****************************************************************************************/
/* Warning:  conflicting decls for root */
static void *root;
extern int _nl_msg_cat_cntr;
/* Warning:  conflicting decls for _nl_default_dirname__ */
extern unsigned char _nl_default_dirname__[18];
extern struct binding  *_nl_domain_bindings__;
static unsigned char *freemem;
static size_t freemem_size;
static int enable_secure;
extern unsigned char *LANGUAGE;
/* Warning:  conflicting decls for _nl_default_default_domain__ */
extern unsigned char _nl_default_default_domain__[9];
extern unsigned char *_nl_current_default_domain__;
/*****************************************************************************************/
/******                                                                             ******/
