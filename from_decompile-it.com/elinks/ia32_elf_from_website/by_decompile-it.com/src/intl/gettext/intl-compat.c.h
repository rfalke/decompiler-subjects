...
/******                                                                             ******/
/*****************************************************************************************/
unsigned char *bind_textdomain_codeset__( unsigned char *, unsigned char * );
unsigned char *bindtextdomain__( unsigned char *, unsigned char * );
unsigned char *dcgettext__( unsigned char *, unsigned char *, int  );
unsigned char *dcngettext__( unsigned char *, unsigned char *, unsigned char *, unsigned long , int  );
unsigned char *dgettext__( unsigned char *, unsigned char * );
unsigned char *dngettext__( unsigned char *, unsigned char *, unsigned char *, unsigned long  );
unsigned char *gettext__( unsigned char * );
unsigned char *ngettext__( unsigned char *, unsigned char *, unsigned long  );
unsigned char *textdomain__( unsigned char * );
/*****************************************************************************************/
/******                                                                             ******/
