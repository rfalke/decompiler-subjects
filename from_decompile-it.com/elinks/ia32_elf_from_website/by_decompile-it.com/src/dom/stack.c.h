...
void done_dom_stack_context( struct dom_stack *, struct dom_stack_context * );
int call_dom_stack_callbacks( struct dom_stack *, struct dom_stack_state *, enum dom_stack_action   );
void pop_dom_node( struct dom_stack * );
void pop_dom_state( struct dom_stack *, struct dom_stack_state * );
void pop_dom_nodes( struct dom_stack *, enum dom_node_type  , struct dom_string * );
