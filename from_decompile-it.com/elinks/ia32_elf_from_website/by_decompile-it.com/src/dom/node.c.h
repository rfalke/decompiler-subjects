...
struct dom_string  *get_dom_node_value( struct dom_node * );
struct dom_string  *get_dom_node_name( struct dom_node * );
int get_dom_node_list_pos( struct dom_node_list *, struct dom_node * );
struct dom_node  *get_dom_node_prev( struct dom_node * );
void del_from_dom_node_list( struct dom_node_list *, struct dom_node * );
void done_dom_node_data( struct dom_node * );
...
struct dom_node  *get_dom_node_next( struct dom_node * );
...
static struct dom_string  dom_node_type_names[13];
static struct dom_string  cdata_section_str;
static struct dom_string  comment_str;
static struct dom_string  document_str;
static struct dom_string  document_fragment_str;
static struct dom_string  text_str;
/*****************************************************************************************/
/******                                                                             ******/
