...
/******                                                                             ******/
/*****************************************************************************************/
int map_dom_scanner_string( struct dom_scanner *, unsigned char *, unsigned char *, int  );
unsigned char T/*.130*/( int , int , int , int  );
void skip_sgml_space( struct dom_scanner *, unsigned char ** );
unsigned char *skip_sgml_chars( struct dom_scanner *, unsigned char *, unsigned char  );
void set_sgml_incomplete( struct dom_scanner *, struct dom_scanner_token * );
struct dom_scanner_token  *set_sgml_error( struct dom_scanner *, unsigned char * );
struct dom_scanner_token  *scan_sgml_tokens( struct dom_scanner * );
...
static struct dom_scan_table_info  sgml_scan_table_info[11];
static struct dom_scanner_string_mapping  sgml_string_mappings[8];
/*****************************************************************************************/
/******                                                                             ******/
