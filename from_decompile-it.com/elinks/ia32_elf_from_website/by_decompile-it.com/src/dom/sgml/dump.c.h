...
enum dom_code  sgml_file_dumper_element_pop( struct dom_stack *, struct dom_node *, void * );
enum dom_code  sgml_file_dumper_comment_push( struct dom_stack *, struct dom_node *, void * );
enum dom_code  sgml_file_dumper_proc_instruction_push( struct dom_stack *, struct dom_node *, void * );
enum dom_code  sgml_file_dumper_entity_ref_push( struct dom_stack *, struct dom_node *, void * );
enum dom_code  sgml_file_dumper_cdata_section_push( struct dom_stack *, struct dom_node *, void * );
enum dom_code  sgml_file_dumper_text_push( struct dom_stack *, struct dom_node *, void * );
enum dom_code  sgml_file_dumper_element_push( struct dom_stack *, struct dom_node *, void * );
enum dom_code  sgml_file_dumper_attribute_push( struct dom_stack *, struct dom_node *, void * );
struct dom_stack_context  *add_sgml_file_dumper( struct dom_stack *, FILE * );
...
/******                                                                             ******/
/*****************************************************************************************/
extern struct dom_stack_context_info  sgml_file_dumper;
/*****************************************************************************************/
/******                                                                             ******/
