...
struct dom_stack_state  *search_dom_stack( struct dom_stack *, enum dom_node_type  , struct dom_string * );
...
struct dom_string  *add_to_dom_string( struct dom_string *, unsigned char *, size_t  );
enum dom_code  check_sgml_incomplete( struct dom_scanner *, struct dom_scanner_token *, struct dom_scanner_token * );
enum dom_code  parse_sgml( struct sgml_parser *, unsigned char *, size_t , int  );
enum dom_code  sgml_parsing_pop( struct dom_stack *, struct dom_node *, void * );
unsigned int get_sgml_parser_line_number( struct sgml_parser * );
enum dom_code  call_sgml_error_function( struct dom_stack *, struct dom_scanner_token * );
...
enum dom_code  parse_sgml_plain( struct dom_stack *, struct dom_scanner * );
enum dom_code  sgml_parsing_push( struct dom_stack *, struct dom_node *, void * );
struct sgml_info  *get_sgml_info( enum sgml_document_type   );
int sgml_info_strcmp( void *, void * );
