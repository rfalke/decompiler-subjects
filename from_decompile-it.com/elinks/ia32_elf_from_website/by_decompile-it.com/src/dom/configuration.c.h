...
/******                                                                             ******/
/*****************************************************************************************/
enum dom_config_flag  parse_dom_config( unsigned char *, unsigned char  );
struct dom_config  *add_dom_config_normalizer( struct dom_stack *, struct dom_config *, enum dom_config_flag   );
enum dom_code  normalize_text_node_whitespace( struct dom_node * );
enum dom_code  dom_normalize_text( struct dom_stack *, struct dom_node *, void * );
enum dom_code  append_node_text( struct dom_config *, struct dom_node * );
enum dom_code  dom_normalize_node_end( struct dom_stack *, struct dom_node *, void * );
...
static struct dom_config_info  dom_config_info[7];
/*****************************************************************************************/
/******                                                                             ******/
