...
/******                                                                             ******/
/*****************************************************************************************/
void done_dom_node( struct dom_node * );
int dom_node_casecmp( struct dom_node *, struct dom_node * );
struct dom_node  *get_dom_node_map_entry( struct dom_node_list *, enum dom_node_type  , uint16_t , struct dom_string * );
struct dom_node_list  *add_to_dom_node_list( struct dom_node_list **, struct dom_node *, int  );
int get_dom_node_list_index( struct dom_node *, struct dom_node * );
int get_dom_node_map_index( struct dom_node_list *, struct dom_node * );
struct dom_scanner_token  *skip_dom_scanner_tokens( struct dom_scanner *, int , int  );
void init_dom_scanner( struct dom_scanner *, struct dom_scanner_info *, struct dom_string *, int , int , int , int , int  );
struct dom_scanner_token  *get_next_dom_scanner_token( struct dom_scanner * );
enum dom_code  dom_select_pop_element( struct dom_stack *, struct dom_node *, void * );
void done_dom_select( struct dom_select * );
enum dom_code  dom_select_push_text( struct dom_stack *, struct dom_node *, void * );
struct dom_node_list  *select_dom_nodes( struct dom_select *, struct dom_node * );
enum dom_code  dom_select_push_element( struct dom_stack *, struct dom_node *, void * );
enum dom_code  parse_dom_select_nth_arg( struct dom_select_nth_match *, struct dom_scanner * );
enum dom_code  parse_dom_select( struct dom_select *, struct dom_stack *, struct dom_string * );
struct dom_select  *init_dom_select( enum dom_select_syntax  , struct dom_string * );
void init_dom_stack( struct dom_stack *, enum dom_stack_flag   );
void done_dom_stack( struct dom_stack * );
void pop_dom_node( struct dom_stack * );
void pop_dom_state( struct dom_stack *, struct dom_stack_state * );
enum dom_code  push_dom_node( struct dom_stack *, struct dom_node * );
struct dom_stack_context  *add_dom_stack_context( struct dom_stack *, void *, struct dom_stack_context_info * );
void walk_dom_nodes( struct dom_stack *, struct dom_node * );
void elinks_internal( unsigned char * );
void elinks_error( unsigned char * );
void elinks_wdebug( unsigned char * );
void mem_free( void * );
