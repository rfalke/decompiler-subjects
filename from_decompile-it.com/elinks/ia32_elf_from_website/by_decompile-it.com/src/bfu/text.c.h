...
widget_handler_status_T display_text( struct dialog_data *, struct widget_data * );
void dlg_format_text_do( struct terminal *, unsigned char *, int , int *, int , int *, struct color_pair *, enum format_align  , int  );
void dlg_format_text( struct terminal *, struct widget_data *, int , int *, int , int *, int , int  );
void format_and_display_text( struct widget_data *, struct dialog_data *, int  );
widget_handler_status_T kbd_text( struct dialog_data *, struct widget_data * );
widget_handler_status_T mouse_text( struct dialog_data *, struct widget_data * );
