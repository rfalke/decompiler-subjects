...
int calc_dist( struct listbox_item *, void *, int * );
int test_search( struct listbox_item *, void *, int * );
int check_old_state( struct listbox_item *, void *, int * );
struct listbox_data  *get_listbox_widget_data( struct widget_data * );
widget_handler_status_T init_listbox( struct dialog_data *, struct widget_data * );
void listbox_sel_move( struct widget_data *, int  );
widget_handler_status_T kbd_listbox( struct dialog_data *, struct widget_data * );
widget_handler_status_T mouse_listbox( struct dialog_data *, struct widget_data * );
int display_listbox_item( struct listbox_item *, void *, int * );
void dlg_format_listbox( struct terminal *, struct widget_data *, int , int *, int , int , int *, enum format_align  , int  );
int listbox_item_offset( struct listbox_data *, struct listbox_item * );
void listbox_sel( struct widget_data *, struct listbox_item * );
widget_handler_status_T display_listbox( struct dialog_data *, struct widget_data * );
