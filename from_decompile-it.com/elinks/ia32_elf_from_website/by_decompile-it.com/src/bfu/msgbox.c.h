...
void abort_refreshed_msg_box_handler( struct dialog_data * );
enum dlg_refresh_code  refresh_msg_box( struct dialog_data *, void * );
...
void add_one_to_ml( struct memory_list **, void * );
void mem_free( void * );
