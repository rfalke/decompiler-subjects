...
/******                                                                             ******/
/*****************************************************************************************/
void clear_hotkeys_cache( struct menu * );
void init_hotkeys( struct terminal *, struct menu * );
void refresh_hotkeys( struct terminal *, struct menu * );
int check_not_so_hot_keys( struct menu *, term_event_char_T , struct terminal * );
int check_hotkeys( struct menu *, term_event_char_T , struct terminal * );
void input_field_line( struct session *, unsigned char *, void *, struct input_history *, input_line_handler_T  );
void set_menu_selection( struct menu *, int  );
void scroll_menu( struct menu *, int , int  );
unsigned char *_( unsigned char *, struct terminal * );
void select_menu_item( struct terminal *, struct menu_item *, void * );
void free_menu_items( struct menu_item * );
...
void display_menu( struct terminal *, struct menu * );
void display_mainmenu( struct terminal *, struct menu * );
void do_mainmenu( struct terminal *, struct menu_item *, void *, int  );
void mainmenu_handler( struct window *, struct term_event * );
enum input_line_code  menu_search_handler( struct input_line *, int  );
void menu_handler( struct window *, struct term_event * );
...
void draw_box( struct terminal *, struct box *, unsigned char , enum screen_char_attr  , struct color_pair * );
void draw_shadow( struct terminal *, struct box *, struct color_pair *, int , int  );
void draw_char_data( struct terminal *, int , int , unicode_val_T  );
void draw_char( struct terminal *, int , int , unicode_val_T , enum screen_char_attr  , struct color_pair * );
void draw_border_char( struct terminal *, int , int , enum border_char  , struct color_pair * );
void draw_border( struct terminal *, struct box *, struct color_pair *, int  );
void draw_text( struct terminal *, int , int , unsigned char *, int , enum screen_char_attr  , struct color_pair * );
void fix_dwchar_around_box( struct terminal *, struct box *, int , int , int  );
...
void delete_window_ev( struct window *, struct term_event * );
