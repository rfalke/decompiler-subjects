...
enum evhook_status  goto_url_history_write_hook( va_list , void * );
void done_url_history( struct module * );
void init_url_history( struct module * );
void mem_free( void * );
/*****************************************************************************************/
/******                                                                             ******/
...
/******                                                                             ******/
/*****************************************************************************************/
static struct event_hook_info  goto_url_history_hooks[2];
