...
void free_keymaps( struct module * );
...
action_id_T get_action_from_string( enum keymap_id  , unsigned char * );
...
unsigned char *get_action_name_from_keystroke( enum keymap_id  , unsigned char * );
...
void init_keymaps( struct module * );
int bind_do( unsigned char *, unsigned char *, unsigned char *, int  );
int bind_key_to_event_name( unsigned char *, unsigned char *, unsigned char *, unsigned char ** );
void add_actions_to_string( struct string *, action_id_T *, enum keymap_id  , struct terminal * );
unsigned char *get_cp_mime_name( int  );
unsigned char *bind_textdomain_codeset( unsigned char *, unsigned char * );
unsigned char *gettext( unsigned char * );
int register_event( unsigned char * );
...
/* Warning:  conflicting decls for keymap_table */
static struct keymap  keymap_table[3];
static struct action_list  action_table[3];
static struct list_head_elinks  keymaps[3];
static struct named_key  key_table[28];
static struct action  main_action_table[120];
static struct action  edit_action_table[31];
static struct action  menu_action_table[22];
static struct default_kb  default_main_keymap[86];
static struct default_kb  default_edit_keymap[35];
static struct default_kb  default_menu_keymap[34];
static struct default_kb  *default_keybindings[3];
static struct action_alias  main_action_aliases[17];
static struct action_alias  edit_action_aliases[2];
static struct action_alias  *action_aliases[3];
