...
/******                                                                             ******/
/*****************************************************************************************/
unsigned char *version_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *remote_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *lookup_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *forcehtml_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *eval_cmd( struct option_elinks *, unsigned char ***, int * );
void print_full_help_inner( struct option_elinks *, unsigned char *, int  );
void print_full_help_outer( struct option_elinks *, unsigned char * );
unsigned char *printconfigdump_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *redir_cmd( struct option_elinks *, unsigned char ***, int * );
enum retval  parse_options( int , unsigned char **, struct list_head_elinks * );
unsigned char *printhelp_cmd( struct option_elinks *, unsigned char ***, int * );
...
enum dns_result  do_real_lookup( unsigned char *, struct sockaddr_storage **, int *, int  );
unsigned char *get_color_string( color_T , unsigned char * );
void usrerror( unsigned char * );
...
struct string  *add_to_string_list( struct list_head_elinks *, unsigned char *, int  );
