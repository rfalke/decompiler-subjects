...
void done_listbox_item( struct hierbox_browser *, struct listbox_item * );
union option_value  *get_opt_( struct option_elinks *, unsigned char * );
void prepare_mustsave_flags( struct list_head_elinks *, int  );
void untouch_options( struct list_head_elinks * );
int check_nonempty_tree( struct list_head_elinks * );
int change_hook_html( struct session *, struct option_elinks *, struct option_elinks * );
void call_change_hooks( struct session *, struct option_elinks *, struct option_elinks * );
void option_changed( struct session *, struct option_elinks * );
void delete_option_do( struct option_elinks *, int  );
void unregister_options( struct option_info *, struct option_elinks * );
void done_options( void );
void delete_option( struct option_elinks * );
struct list_head_elinks  *init_options_tree( void );
void toggle_option( struct session *, struct option_elinks * );
void mark_option_as_deleted( struct option_elinks * );
void update_visibility( struct list_head_elinks *, int  );
int change_hook_stemplate( struct session *, struct option_elinks *, struct option_elinks * );
void smart_config_string( struct string *, int , int , struct list_head_elinks *, unsigned char *, int , void (*)( struct string *, struct option_elinks *, unsigned char *, int , int , int , int  ) );
int change_hook_ui( struct session *, struct option_elinks *, struct option_elinks * );
int change_hook_insert_mode( struct session *, struct option_elinks *, struct option_elinks * );
int change_hook_language( struct session *, struct option_elinks *, struct option_elinks * );
int change_hook_terminal( struct session *, struct option_elinks *, struct option_elinks * );
int change_hook_cache( struct session *, struct option_elinks *, struct option_elinks * );
int change_hook_active_link( struct session *, struct option_elinks *, struct option_elinks * );
int change_hook_connection( struct session *, struct option_elinks *, struct option_elinks * );
struct option_elinks  *copy_option( struct option_elinks * );
...
void register_change_hooks( struct change_hook_info * );
void add_opt_rec( struct option_elinks *, unsigned char *, struct option_elinks * );
void register_options( struct option_info *, struct option_elinks * );
struct option_elinks  *add_opt( struct option_elinks *, unsigned char *, unsigned char *, unsigned char *, enum option_flags  , enum option_type  , long , long , longptr_T , unsigned char * );
void update_options_visibility( void );
void init_options( void );
struct option_elinks  *indirect_option( struct option_elinks * );
...
int decode_color( unsigned char *, int , color_T * );
...
/* Warning:  conflicting decls for change_hooks */
static struct change_hook_info  change_hooks[14];
static struct list_head_elinks  options_root_tree;
static struct option_elinks  options_root;
static int no_autocreate;
static struct option_info  config_options_info[414];
