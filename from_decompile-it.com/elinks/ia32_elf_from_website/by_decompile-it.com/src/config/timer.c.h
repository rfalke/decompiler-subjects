...
void done_timer( struct module * );
void periodic_save_handler( void * );
void init_timer( struct module * );
int periodic_save_change_hook( struct session *, struct option_elinks *, struct option_elinks * );
...
static int periodic_save_event_id;
static struct change_hook_info  timer_change_hooks[2];
