...
/******                                                                             ******/
/*****************************************************************************************/
void skip_quoted( struct conf_parsing_pos * );
void skip_option_value( struct conf_parsing_pos * );
struct string  *add_bytes_to_string__( struct string *, unsigned char *, int  );
void add_cfg_header_to_string( struct string *, unsigned char * );
void skip_white( struct conf_parsing_pos * );
enum parse_error  show_parse_error( struct conf_parsing_state *, enum parse_error   );
enum parse_error  parse_bind( struct option_elinks *, struct conf_parsing_state *, struct string *, int  );
enum parse_error  parse_unset( struct option_elinks *, struct conf_parsing_state *, struct string *, int  );
enum parse_error  parse_set( struct option_elinks *, struct conf_parsing_state *, struct string *, int  );
struct string  *wrap_option_desc( struct string *, unsigned char *, struct string *, int  );
void smart_config_output_fn( struct string *, struct option_elinks *, unsigned char *, int , int , int , int  );
unsigned char *read_config_file( unsigned char * );
void parse_config_file( struct option_elinks *, unsigned char *, unsigned char *, struct string *, int  );
int load_config_file( unsigned char *, unsigned char *, struct option_elinks *, struct string *, int  );
unsigned char *create_config_string( unsigned char *, unsigned char *, struct option_elinks * );
int write_config( struct terminal * );
void load_config( void );
enum parse_error  parse_include( struct option_elinks *, struct conf_parsing_state *, struct string *, int  );
...
int secure_fputs( struct secure_save_info *, char * );
...
struct string  *add_xchar_to_string( struct string *, unsigned char , int  );
...
int __fprintf_chk( FILE *, int , char *, ... );
...
extern enum secsave_errno  secsave_errno;
/* Warning:  conflicting decls for indentation */
static int indentation;
extern struct _IO_FILE  *stderr;
static unsigned char error_msg[6][40];
static struct parse_handler  parse_handlers[5];
static int comments;
/*****************************************************************************************/
/******                                                                             ******/
