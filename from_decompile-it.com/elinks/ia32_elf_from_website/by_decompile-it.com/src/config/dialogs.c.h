...
/******                                                                             ******/
/*****************************************************************************************/
void add_dlg_button_do( struct dialog *, unsigned char *, int , widget_handler_T *, void *, done_handler_T *, void * );
widget_handler_status_T cancel_dialog( struct dialog_data *, struct widget_data * );
void generic_dialog_layouter( struct dialog_data * );
void redraw_dialog( struct dialog_data *, int  );
...
widget_handler_status_T push_hierbox_search_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_hierbox_info_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_hierbox_delete_button( struct dialog_data *, struct widget_data * );
void update_hierbox_browser( struct hierbox_browser * );
struct listbox_item  *add_listbox_item( struct hierbox_browser *, struct listbox_item *, enum listbox_item_type  , void *, int  );
struct dialog_data  *hierbox_browser( struct hierbox_browser *, struct session * );
void add_dlg_field_do( struct dialog *, enum widget_type  , unsigned char *, int , int , widget_handler_T *, int , void *, struct input_history *, enum inpfield_flags   );
...
struct listbox_data  *get_listbox_widget_data( struct widget_data * );
void listbox_sel( struct widget_data *, struct listbox_item * );
unsigned char *msg_text( struct terminal *, unsigned char * );
struct dialog_data  *msg_box( struct terminal *, struct memory_list *, enum msgbox_flags  , unsigned char *, enum format_align  , unsigned char *, void *, int  );
struct dialog_data  *info_box( struct terminal *, enum msgbox_flags  , unsigned char *, enum format_align  , unsigned char * );
void add_dlg_text( struct dialog *, unsigned char *, enum format_align  , int  );
int write_config( struct terminal * );
void lock_option( struct listbox_item * );
void unlock_option( struct listbox_item * );
int is_option_used( struct listbox_item * );
struct listbox_item  *get_option_root( struct listbox_item * );
int can_delete_option( struct listbox_item * );
void lock_keybinding( struct listbox_item * );
void unlock_keybinding( struct listbox_item * );
int is_keybinding_used( struct listbox_item * );
int can_delete_keybinding( struct listbox_item * );
struct listbox_item  *get_keybinding_action_box_item( enum keymap_id  , action_id_T  );
struct listbox_item  *get_keybinding_root( struct listbox_item * );
void delete_keybinding_item( struct listbox_item *, int  );
unsigned char *_( unsigned char *, struct terminal * );
unsigned char *get_keybinding_info( struct listbox_item *, struct terminal * );
widget_handler_status_T push_kbdbind_save_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_kbdbind_toggle_display_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T check_option_name( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_kbdbind_add_button( struct dialog_data *, struct widget_data * );
widget_handler_status_T push_add_button( struct dialog_data *, struct widget_data * );
void really_really_add_keybinding( void * );
void really_add_keybinding( void *, unsigned char * );
widget_handler_status_T check_keystroke( struct dialog_data *, struct widget_data * );
void delete_option_item( struct listbox_item *, int  );
void done_keybinding_listboxes( void );
unsigned char *get_range_string( struct option_elinks * );
widget_handler_status_T push_save_button( struct dialog_data *, struct widget_data * );
void add_option_to_tree( void *, unsigned char * );
widget_handler_status_T check_valid_option( struct dialog_data *, struct widget_data * );
void keybinding_manager( struct session * );
void options_manager( struct session * );
void init_keybinding_listboxes( struct keymap *, struct action_list * );
void disable_success_msgbox( void * );
void write_config_dialog( struct terminal *, unsigned char *, int , int  );
unsigned char *get_option_text( struct listbox_item *, struct terminal * );
widget_handler_status_T push_edit_button( struct dialog_data *, struct widget_data * );
unsigned char *get_keybinding_text( struct listbox_item *, struct terminal * );
enum listbox_match  match_option( struct listbox_item *, struct terminal *, unsigned char * );
enum listbox_match  match_keybinding( struct listbox_item *, struct terminal *, unsigned char * );
unsigned char *get_option_info( struct listbox_item *, struct terminal * );
int keybinding_exists( enum keymap_id  , struct term_event_keyboard *, action_id_T * );
unsigned char *get_keymap_name( enum keymap_id   );
unsigned char *get_action_name( enum keymap_id  , action_id_T  );
...
struct keybinding  *add_keybinding( enum keymap_id  , action_id_T , struct term_event_keyboard *, int  );
union option_value  *get_opt_( struct option_elinks *, unsigned char * );
void option_changed( struct session *, struct option_elinks * );
void delete_option( struct option_elinks * );
struct option_elinks  *get_opt_rec( struct option_elinks *, unsigned char * );
struct option_elinks  *get_opt_rec_real( struct option_elinks *, unsigned char * );
...
unsigned char *safe_strncpy( unsigned char *, unsigned char *, size_t  );
...
static struct hierbox_browser_button  option_buttons[6];
...
static struct hierbox_browser_button  keybinding_buttons[5];
extern int commandline;
extern struct listbox_item  *keymap_box_item[3];
