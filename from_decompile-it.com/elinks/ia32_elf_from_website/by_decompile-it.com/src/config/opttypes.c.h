...
unsigned char *bool_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *exec_cmd( struct option_elinks *, unsigned char ***, int * );
int num_set( struct option_elinks *, unsigned char * );
int num_eq( struct option_elinks *, unsigned char * );
int long_set( struct option_elinks *, unsigned char * );
int long_eq( struct option_elinks *, unsigned char * );
int str_eq( struct option_elinks *, unsigned char * );
void tree_dup( struct option_elinks *, struct option_elinks * );
int redir_eq( struct option_elinks *, unsigned char * );
int redir_set( struct option_elinks *, unsigned char * );
void redir_wr( struct option_elinks *, struct string * );
unsigned char *redir_rd( struct option_elinks *, unsigned char **, int * );
unsigned char *redir_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *get_option_type_name( enum option_type   );
int color_eq( struct option_elinks *, unsigned char * );
int color_set( struct option_elinks *, unsigned char * );
void add_optstring_to_string( struct string *, unsigned char *, int  );
void color_wr( struct option_elinks *, struct string * );
void str_wr( struct option_elinks *, struct string * );
int lang_eq( struct option_elinks *, unsigned char * );
int lang_set( struct option_elinks *, unsigned char * );
void lang_wr( struct option_elinks *, struct string * );
int cp_eq( struct option_elinks *, unsigned char * );
int cp_set( struct option_elinks *, unsigned char * );
void cp_wr( struct option_elinks *, struct string * );
int str_set( struct option_elinks *, unsigned char * );
void str_dup( struct option_elinks *, struct option_elinks * );
unsigned char *str_rd( struct option_elinks *, unsigned char **, int * );
void long_wr( struct option_elinks *, struct string * );
void num_wr( struct option_elinks *, struct string * );
unsigned char *gen_cmd( struct option_elinks *, unsigned char ***, int * );
unsigned char *num_rd( struct option_elinks *, unsigned char **, int * );
unsigned char *get_cp_config_name( int  );
int get_cp_index( unsigned char * );
unsigned char *gettext( unsigned char * );
unsigned char *language_to_name( int  );
int name_to_language( unsigned char * );
void set_language( int  );
unsigned char *get_color_string( color_T , unsigned char * );
int decode_color( unsigned char *, int , color_T * );
long strtolx( unsigned char *, unsigned char ** );
struct string  *add_quoted_to_string( struct string *, unsigned char *, int  );
struct string  *add_knum_to_string( struct string *, long  );
...
/* Warning:  conflicting decls for option_types */
extern struct option_type_info  option_types[10];
