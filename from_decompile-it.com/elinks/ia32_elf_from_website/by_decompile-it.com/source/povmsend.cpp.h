...
int Send_RenderStarted( bool  );
void Send_InitInfo( void );
int BuildParseStatistics( POVMSObjectPtr  );
int BuildRenderTime( POVMSObjectPtr , unsigned int , int , int , int , int  );
int Send_RenderDone( bool  );
int Send_FrameStatistics( void );
int BuildCommand( POVMSObjectPtr , unsigned int , SHELLDATA * );
int AddOIStatistic( POVMSAttributeListPtr , int , COUNTER * );
int AddStatistic( POVMSObjectPtr , unsigned int , COUNTER * );
int BuildProgress( POVMSObjectPtr , int  );
int Send_ProgressUpdate( int , int  );
int Send_Progress( char *, int  );
int BuildRenderStatistics( POVMSObjectPtr , COUNTER * );
int Send_RenderStatistics( bool  );
int Send_ParseStatistics( void );
int BuildRenderOptions( POVMSObjectPtr  );
int Send_RenderOptions( void );
}
void *povray_getoutputcontext( void );
namespace pov {
int POVMSUtil_SetFormatString( POVMSObjectPtr , unsigned int , char * );
char *Extract_Version( char * );
int GetPhotonStat( unsigned int  );
}
int POVMSAttr_New( POVMSAttributePtr  );
int POVMSUtil_SetInt( POVMSObjectPtr , unsigned int , int  );
int POVMSAttrList_New( POVMSAttributeListPtr  );
int POVMSAttr_Set( POVMSAttributePtr , unsigned int , void *, int  );
int POVMSAttrList_Append( POVMSAttributeListPtr , POVMSAttributePtr  );
int POVMSAttr_Delete( POVMSAttributePtr  );
int POVMSObject_Set( POVMSObjectPtr , POVMSAttributePtr , unsigned int  );
int POVMSUtil_SetBool( POVMSObjectPtr , unsigned int , int  );
int POVMSUtil_SetFloat( POVMSObjectPtr , unsigned int , float  );
int POVMSUtil_SetLong( POVMSObjectPtr , unsigned int , long long  );
int POVMSMsg_SetDestinationAddress( POVMSObjectPtr , void * );
int POVMSUtil_SetString( POVMSObjectPtr , unsigned int , char * );
int POVMSObject_New( POVMSObjectPtr , unsigned int  );
int POVMSObject_Copy( POVMSObjectPtr , POVMSObjectPtr  );
int POVMS_Send( POVMSContext , POVMSObjectPtr , POVMSObjectPtr , int  );
int POVMSMsg_SetupMessage( POVMSObjectPtr , unsigned int , unsigned int  );
namespace pov_base {
...
time_t time( void * );
png_charp png_get_libpng_ver( png_structp  );
char *TIFFGetVersion( void );
/*****************************************************************************************/
/******                                                                             ******/
...
extern time_t tstop;
extern Opts opts;
extern long numberOfFiniteObjects;
extern long numberOfInfiniteObjects;
extern long numberOfLightSources;
extern long SuperSampleCount;
extern long RadiosityCount;
extern long MosaicPreviewSize;
extern int Current_Line_Number;
extern int Max_Trace_Level;
extern int Highest_Trace_Level;
extern COUNTER stats[126];
extern COUNTER totalstats[126];
extern double tparse;
extern double tphoton;
extern double trender;
extern double tparse_frame;
extern double tphoton_frame;
extern double trender_frame;
extern double tparse_total;
extern double tphoton_total;
extern double trender_total;
extern long long Current_Token_Count;
...
extern POVMSObject *gStartedStreamMessage;
extern double Previous_t;
}
/*****************************************************************************************/
/******                                                                             ******/
