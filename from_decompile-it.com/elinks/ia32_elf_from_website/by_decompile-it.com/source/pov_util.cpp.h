...
namespace pov {
char *Locate_Filename( char *, unsigned int , bool  );
struct pov_base::OStream  *New_Checked_OStream( char *, unsigned int , bool  );
struct pov_base::IStream  *New_Checked_IStream( char *, unsigned int  );
int POVMSUtil_SetFormatString( POVMSObjectPtr , unsigned int , char * );
struct pov_base::IStream  *Locate_File( char *, unsigned int , char *, bool  );
int PossibleError( char * );
}
namespace pov_base {
bool File_Exist( char * );
int Has_Extension( char * );
struct OStream  *New_OStream( char *, unsigned int , bool  );
struct IStream  *New_IStream( char *, unsigned int  );
}
...
namespace pov_base {
extern struct POV_File_Extensions  gPOV_File_Extensions[];
}
/*****************************************************************************************/
/******                                                                             ******/
