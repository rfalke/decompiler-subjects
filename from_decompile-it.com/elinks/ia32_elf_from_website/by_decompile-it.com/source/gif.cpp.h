...
int out_line( unsigned char *, int  );
void Read_Gif_Image( IMAGE *, char * );
short decoder( int  );
...
extern int Bitmap_Line;
extern struct pov_base::IStream  *Bit_File;
extern unsigned char *decoderline;
extern IMAGE_COLOUR *gif_colour_map;
extern int colourmap_size;
}
/*****************************************************************************************/
/******                                                                             ******/
