...
/*****************************************************************************************/
namespace pov {
void Read_Png_Image( IMAGE *, char * );
}
...
void png_write_flush( png_structp  );
...
png_voidp png_get_error_ptr( png_structp  );
void png_read_info( png_structp , png_infop  );
void png_set_flush( png_structp , int  );
/*****************************************************************************************/
/******                                                                             ******/
...
extern struct pov_base::IStream  *in_file;
extern struct pov_base::OStream  *out_file;
static png_structp png_ptr;
static png_info *info_ptr;
static png_struct *o_png_ptr;
static png_byte *row_ptr;
static int png_stride;
static char tmp_fname[4096];
static struct pov_base::IStream  *tmp_fp;
/*****************************************************************************************/
/******                                                                             ******/
