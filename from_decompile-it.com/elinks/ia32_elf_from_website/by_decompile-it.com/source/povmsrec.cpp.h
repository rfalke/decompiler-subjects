...
int Receive_RenderArea( POVMSObjectPtr , POVMSObjectPtr , int , void * );
bool Matches( char *, char * );
int SetCommandOption( POVMSObjectPtr , unsigned int , SHELLDATA * );
bool IsTrue( char * );
bool IsFalse( char * );
int Receive_RenderOptions( POVMSObjectPtr , POVMSObjectPtr , int , void * );
int Warning( unsigned int , char * );
int Error( char * );
}
int POVMSAttr_Size( POVMSAttributePtr , int * );
int POVMSUtil_GetInt( POVMSObjectPtr , unsigned int , int * );
int POVMSObject_Exist( POVMSObjectPtr , unsigned int  );
int POVMSAttrList_Count( POVMSAttributeListPtr , int * );
int POVMSAttr_Get( POVMSAttributePtr , unsigned int , void *, int * );
int POVMSObject_Delete( POVMSObjectPtr  );
...
int POVMSAttrList_GetNth( POVMSAttributeListPtr , int , POVMSAttributePtr  );
int POVMSObject_Get( POVMSObjectPtr , POVMSAttributePtr , unsigned int  );
int POVMSUtil_GetBool( POVMSObjectPtr , unsigned int , int * );
int POVMSUtil_GetFloat( POVMSObjectPtr , unsigned int , float * );
...
extern unsigned int gStreamTypeUtilData[6];
extern char *gStreamDefaultFile[6];
extern POVMSObject gStartedStreamMessageData;
extern int Quality_Values[12];
}
/*****************************************************************************************/
/******                                                                             ******/
