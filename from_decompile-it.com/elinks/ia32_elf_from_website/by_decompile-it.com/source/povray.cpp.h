...
void FrameLoop( void );
void close_all( void );
void init_output_file_handle( void );
void Destroy_Textures( TEXTURE * );
void pre_init_tokenizer( void );
void Terminate_Tokenizer( void );
SHELLRET pov_shellout( SHELLTYPE  );
int PossibleError( char * );
void Destroy_Camera( CAMERA * );
}
int POVMS_GetContextAddress( POVMSContext , void ** );
int POVMS_ProcessMessages( POVMSContext , int  );
int POVMS_OpenContext( POVMSContext * );
int POVMS_InstallReceiver( POVMSContext , int (*)( POVMSObjectPtr , POVMSObjectPtr , int , void * ), unsigned int , unsigned int , void * );
