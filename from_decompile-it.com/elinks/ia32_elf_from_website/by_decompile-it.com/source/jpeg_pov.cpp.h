...
void my_term_destination( j_compress_ptr  );
boolean my_empty_output_buffer( j_compress_ptr  );
namespace pov {
...
void jpeg_CreateDecompress( j_decompress_ptr , int , unsigned int  );
void jpeg_set_colorspace( j_compress_ptr , void * );
...
void jpeg_CreateCompress( j_compress_ptr , int , unsigned int  );
void *jpeg_std_error( void * );
void jpeg_finish_compress( j_compress_ptr  );
int _Unwind_Resume( void );
