...
/******                                                                             ******/
/*****************************************************************************************/
int is_infinitel( double long  );
char *vasnprintf( char *, size_t *, char *, va_list  );
size_t xsum4( size_t , size_t , size_t , size_t  );
size_t xmax( size_t , size_t  );
size_t xsum( size_t , size_t  );
int rpl_isnanl( double long  );
int printf_fetchargs( va_list , arguments * );
