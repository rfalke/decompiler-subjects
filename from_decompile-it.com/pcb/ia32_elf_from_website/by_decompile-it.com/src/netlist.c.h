...
int Netlist( int , char **, int , int  );
void netlist_norats( LibraryMenuType *, LibraryEntryType * );
void netlist_rats( LibraryMenuType *, LibraryEntryType * );
void netlist_select( LibraryMenuType *, LibraryEntryType * );
void netlist_find( LibraryMenuType *, LibraryEntryType * );
void register_netlist_action_list( void );
LibraryMenuTypePtr netname_to_netname( char * );
...
int regexec( regex_t *, char *, unsigned int , regmatch_t [0], int  );
int regcomp( regex_t *, char *, int  );
unsigned int strlen( char * );
int strcasecmp( char *, char * );
unsigned int regerror( int , regex_t *, char *, unsigned int  );
...
extern HID_Action netlist_action_list[2];
extern HID *gui;
/*****************************************************************************************/
/******                                                                             ******/
