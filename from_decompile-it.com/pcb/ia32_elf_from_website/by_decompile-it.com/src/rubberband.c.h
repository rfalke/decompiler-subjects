...
void CheckPinForRubberbandConnection( PinTypePtr  );
int rubber_callback( BoxType *, void * );
int rat_callback( BoxType *, void * );
void CheckLinePointForRat( LayerTypePtr , PointTypePtr  );
void LookupRatLines( int , void *, void *, void * );
void CheckLinePointForRubberbandConnection( LayerTypePtr , LineTypePtr , PointTypePtr , Boolean  );
