...
void SetPVColor( PinTypePtr , int  );
void RedrawOutput( BoxTypePtr  );
int EMark_callback( BoxType *, void * );
void DrawSpecialPolygon( HID *, hidGC , LocationType , LocationType , int  );
void DrawPinOrViaLowLevel( PinTypePtr , Boolean  );
int hole_callback( BoxType *, void * );
void ClearPin( PinTypePtr , int , int  );
void DrawLineLowLevel( LineTypePtr , Boolean  );
void DrawArcLowLevel( ArcTypePtr  );
...
int cp_callback( BoxType *, void * );
int poly_callback( BoxType *, void * );
void DrawElementPackage( ElementTypePtr , int  );
int frontE_callback( BoxType *, void * );
int backE_callback( BoxType *, void * );
void EraseRat( RatTypePtr  );
void EraseLine( LineTypePtr  );
void EraseArc( ArcTypePtr  );
void DrawMask( BoxType * );
void DrawTop( BoxType * );
void DrawLayer( LayerTypePtr , BoxType * );
void DrawSilk( int , int , BoxTypePtr  );
int DrawLayerGroup( int , BoxType * );
void PrintAssembly( BoxType *, int , int  );
void DrawPadLowLevel( hidGC , PadTypePtr , Boolean , Boolean  );
int clearPad_callback( BoxType *, void * );
void ErasePolygon( PolygonTypePtr  );
int thin_callback( PLINE *, LayerTypePtr , PolygonTypePtr  );
void DrawPolygon( LayerTypePtr , PolygonTypePtr , int  );
void DrawTextLowLevel( TextTypePtr , int  );
int text_callback( BoxType *, void * );
void DrawPinOrViaNameLowLevel( PinTypePtr  );
int pin_callback( BoxType *, void * );
...
void DrawPadNameLowLevel( PadTypePtr  );
...
int backPad_callback( BoxType *, void * );
...
int frontN_callback( BoxType *, void * );
int backN_callback( BoxType *, void * );
void DrawElement( ElementTypePtr , int  );
void hid_expose_callback( HID *, BoxType *, void * );
void DrawText( LayerTypePtr , TextTypePtr , int  );
void Draw( void );
int lowvia_callback( BoxType *, void * );
int via_callback( BoxType *, void * );
int clearPin_callback( BoxType *, void * );
void Message( char *, ... );
