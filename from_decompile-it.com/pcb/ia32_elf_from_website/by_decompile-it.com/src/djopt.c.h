...
int djopt_get_auto_only( int  );
void add_point_to_rect( rect_s *, int , int , int  );
void add_line_to_rect( rect_s *, line_s * );
int corner_radius( corner_s * );
int simple_corner( corner_s * );
corner_s *find_corner( int , int , int  );
void remove_line( line_s * );
void add_line_to_corner( line_s *, corner_s * );
int dist( int , int , int , int  );
void add_corner_to_rect_if( rect_s *, corner_s *, rect_s * );
int line_length( line_s * );
int dist_ltp2( int , int , int , int  );
LineType *create_pcb_line( int , int , int , int , int , int , int , FlagType  );
void dj_abort( char *, ... );
void new_line( corner_s *, corner_s *, int , LineType * );
corner_s *other_corner( line_s *, corner_s * );
void classify_corner( corner_s *, int  );
int split_line( line_s *, corner_s * );
void remove_via_at( corner_s * );
void merge_corners( corner_s *, corner_s * );
void move_corner( corner_s *, int , int  );
int connect_corners( corner_s *, corner_s * );
int orthopull_1( corner_s *, int , int , int  );
int canonicalize_line( line_s * );
...
extern HID_Flag djopt_flag_list[1];
extern HID_Action djopt_action_list[2];
/* Warning:  conflicting decls for lines */
extern HID *gui;
/*****************************************************************************************/
/******                                                                             ******/
