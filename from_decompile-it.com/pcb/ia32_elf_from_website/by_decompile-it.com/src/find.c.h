...
Boolean PrepareNextLoop( FILE * );
void DumpList( void );
void LocateError( LocationType *, LocationType * );
Boolean ADD_PV_TO_LIST( PinTypePtr  );
Boolean ADD_RAT_TO_LIST( RatTypePtr  );
Boolean ADD_LINE_TO_LIST( Cardinal , LineTypePtr  );
Boolean ADD_ARC_TO_LIST( Cardinal , ArcTypePtr  );
Boolean ADD_POLYGON_TO_LIST( Cardinal , PolygonTypePtr  );
Boolean ADD_PAD_TO_LIST( Cardinal , PadTypePtr  );
void pcb_drc_violation_free( DrcViolationType * );
void BuildObjectList( int *, long **, int ** );
Boolean ListStart( int , void *, void *, void * );
Boolean LookupPVConnectionsToPVList( void );
Boolean LookupLOConnectionsToPVList( Boolean  );
Boolean PVTouchesLine( LineTypePtr  );
int LOCtoPad_callback( BoxType *, void * );
int PolygonToRat_callback( BoxType *, void * );
int LOCtoRat_callback( BoxType *, void * );
int LOCtoLineRat_callback( BoxType *, void * );
int LOCtoPolyRat_callback( BoxType *, void * );
int LOCtoPadRat_callback( BoxType *, void * );
int pv_pv_callback( BoxType *, void * );
int LOCtoPVrat_callback( BoxType *, void * );
int pv_rat_callback( BoxType *, void * );
int LOCtoPVpoly_callback( BoxType *, void * );
int pv_poly_callback( BoxType *, void * );
int LOCtoPVarc_callback( BoxType *, void * );
int pv_arc_callback( BoxType *, void * );
int LOCtoPVpad_callback( BoxType *, void * );
int pv_pad_callback( BoxType *, void * );
int LOCtoArcArc_callback( BoxType *, void * );
Boolean LineArcIntersect( LineTypePtr , ArcTypePtr  );
int LOCtoLineArc_callback( BoxType *, void * );
int LOCtoArcLine_callback( BoxType *, void * );
int LOT_Arccallback( BoxType *, void * );
int LOCtoArcPad_callback( BoxType *, void * );
int LOCtoPadArc_callback( BoxType *, void * );
void append_drc_dialog_message( char *, ... );
int throw_drc_dialog( void );
void append_drc_violation( DrcViolationType * );
void ResetFoundLinesAndPolygons( Boolean  );
void ResetFoundPinsViasAndPads( Boolean  );
void ResetConnections( Boolean  );
void PrintElementNameList( ElementTypePtr , FILE * );
void PrintConnectionElementName( ElementTypePtr , FILE * );
void PrintConnectionListEntry( char *, ElementTypePtr , Boolean , FILE * );
void PrintPinConnections( FILE *, Boolean  );
void PrintPadConnections( Cardinal , FILE *, Boolean  );
Boolean IsLineInPolygon( LineTypePtr , PolygonTypePtr  );
Boolean LookupLOConnectionsToLine( LineTypePtr , Cardinal , Boolean  );
Boolean LookupLOConnectionsToPad( PadTypePtr , Cardinal  );
int LOCtoPolyLine_callback( BoxType *, void * );
Boolean LOTouchesLine( LineTypePtr , Cardinal  );
Boolean lineClear( LineTypePtr , Cardinal  );
Boolean IsPolygonInPolygon( PolygonTypePtr , PolygonTypePtr  );
Boolean LookupLOConnectionsToPolygon( PolygonTypePtr , Cardinal  );
int LOCtoPolyPad_callback( BoxType *, void * );
int LOCtoPadPoly_callback( BoxType *, void * );
Boolean IsArcInPolygon( ArcTypePtr , PolygonTypePtr  );
Boolean LookupLOConnectionsToArc( ArcTypePtr , Cardinal  );
int LOCtoPolyArc_callback( BoxType *, void * );
void form_slanted_rectangle( PointType *, LineTypePtr  );
Boolean LineLineIntersect( LineTypePtr , LineTypePtr  );
int LOCtoLineLine_callback( BoxType *, void * );
int LOT_Linecallback( BoxType *, void * );
int LOCtoLinePad_callback( BoxType *, void * );
int LOCtoPadPad_callback( BoxType *, void * );
int LOCtoPadLine_callback( BoxType *, void * );
int LOT_Padcallback( BoxType *, void * );
...
int LOCtoPVline_callback( BoxType *, void * );
int pv_line_callback( BoxType *, void * );
int pv_touch_callback( BoxType *, void * );
int drc_callback( DataTypePtr , LayerTypePtr , PolygonTypePtr , int , void *, void * );
Boolean LookupLOConnectionsToRatEnd( PointTypePtr , Cardinal  );
Boolean LookupPVConnectionsToLOList( Boolean  );
Boolean DoIt( Boolean , Boolean  );
Boolean DRCFind( int , void *, void *, void * );
int DRCAll( void );
void LookupUnusedPins( FILE * );
void RatFindHook( int , void *, void *, void *, Boolean , Boolean  );
Boolean PrintElementConnections( ElementTypePtr , FILE *, Boolean  );
...
Boolean IsRectangleInPolygon( LocationType , LocationType , LocationType , LocationType , PolygonTypePtr  );
int PlowsPolygon( DataType *, int , void *, void *, int (*)( DataTypePtr , LayerTypePtr , PolygonTypePtr , int , void *, void * ) );
