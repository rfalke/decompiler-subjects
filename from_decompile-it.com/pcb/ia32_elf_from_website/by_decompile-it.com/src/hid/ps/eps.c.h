...
void eps_calibrate( double , double  );
void use_gc( hidGC  );
void eps_fill_rect( hidGC , int , int , int , int  );
void eps_fill_polygon( hidGC , int , int *, int * );
void eps_fill_circle( hidGC , int , int , int  );
void eps_draw_rect( hidGC , int , int , int , int  );
void eps_draw_arc( hidGC , int , int , int , int , int , int  );
void eps_set_line_cap_angle( hidGC , int , int , int , int  );
void eps_use_mask( int  );
void eps_draw_line( hidGC , int , int , int , int  );
int eps_set_layer( char *, int , int  );
void eps_set_color( hidGC , char * );
hidGC eps_make_gc( void );
void register_eps_attribute_list( void );
void eps_parse_arguments( int *, char *** );
HID_Attribute *eps_get_export_options( int * );
int layer_sort( void *, void * );
void eps_hid_export_to_file( FILE *, HID_Attr_Val * );
void eps_do_export( HID_Attr_Val * );
void abort( void );
