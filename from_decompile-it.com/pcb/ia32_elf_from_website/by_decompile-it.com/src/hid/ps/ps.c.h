...
void use_gc( hidGC  );
void ps_fill_rect( hidGC , int , int , int , int  );
void ps_fill_polygon( hidGC , int , int *, int * );
void ps_fill_circle( hidGC , int , int , int  );
void ps_draw_rect( hidGC , int , int , int , int  );
void ps_draw_arc( hidGC , int , int , int , int , int , int  );
void ps_draw_line( hidGC , int , int , int , int  );
void ps_set_line_cap_angle( hidGC , int , int , int , int  );
void corner( int , int , int , int  );
void ps_start_file( FILE * );
void ps_set_color( hidGC , char * );
hidGC ps_make_gc( void );
int layer_sort( void *, void * );
FILE *psopen( char *, char * );
int ps_set_layer( char *, int , int  );
void register_ps_attribute_list( void );
void ps_parse_arguments( int *, char *** );
HID_Attribute *ps_get_export_options( int * );
void hid_ps_init( void );
void ps_calibrate_1( double , double , int  );
void ps_calibrate( double , double  );
void ps_hid_export_to_file( FILE *, HID_Attr_Val * );
void ps_do_export( HID_Attr_Val * );
...
extern HID *gui;
extern HID ps_hid;
extern HID_Attribute ps_attribute_list[18];
extern HID_Attribute ps_calib_attribute_list[1];
/*****************************************************************************************/
/******                                                                             ******/
