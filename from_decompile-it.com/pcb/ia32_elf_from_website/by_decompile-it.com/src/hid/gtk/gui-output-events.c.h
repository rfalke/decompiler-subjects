...
gboolean ghid_idle_cb( gpointer  );
void draw_crosshair( GdkGC *, gint , gint  );
...
void gtk_signal_emit_by_name( GtkObject *, gchar *, ... );
...
GtkAdjustment *gtk_range_get_adjustment( void * );
/*****************************************************************************************/
/******                                                                             ******/
...
extern gboolean cursor_in_viewport;
