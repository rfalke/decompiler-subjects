...
void bom_parse_arguments( int *, char *** );
double xyToAngle( double , double  );
StringList *string_insert( char *, StringList * );
char *CleanBOMString( char * );
void print_and_free( FILE *, BomList * );
HID_Attribute *bom_get_export_options( int * );
void bom_do_export( HID_Attr_Val * );
