...
void ChangeArcAngles( LayerTypePtr , ArcTypePtr , long , long  );
void *MoveObject( int , void *, void *, void *, LocationType , LocationType  );
int find_pair_line_callback( BoxType *, void * );
int find_pair_arc_callback( BoxType *, void * );
void adjust_pointers_1( Extra *, Extra *, int , Extra *, int  );
void adjust_pointers( Extra *, Extra *, int  );
void find_pairs_1( void *, Extra **, int , int  );
int find_pair( int , int  );
void fix_arc_extra( ArcTypePtr , Extra * );
double dist( int , int , int , int  );
double dist_lsp( int , int , int , int , int , int  );
int check_point_in_pin( PinTypePtr , int , int , End * );
int find_pair_pinarc_callback( BoxType *, void * );
int find_pair_pinline_callback( BoxType *, void * );
double dist_lp( int , int , int , int , int , int  );
int line_callback( BoxType *, void * );
int arc_endpoint_is( ArcTypePtr , int , int , int  );
int arc_callback( BoxType *, void * );
int within( int , int , int , int , int  );
void unlink_extras( Extra * );
void mark_arc_for_deletion( ArcTypePtr  );
void mark_line_for_deletion( LineTypePtr  );
int check_point_in_pad( PadTypePtr , int , int , End * );
int find_pair_padarc_callback( BoxType *, void * );
void print_extra( Extra *, Extra * );
void validate_pair( Extra *, End * );
void reverse_line( LineTypePtr  );
void reverse_arc( ArcTypePtr  );
int gp_point_force( int , int , int , End *, int , int , int , char * );
int gp_point_2( int , int , int , End *, int , int , char * );
int gp_pad_cb( BoxType *, void * );
int gp_pin_cb( BoxType *, void * );
int gp_poly_cb( BoxType *, void * );
int gp_text_cb( BoxType *, void * );
int gp_arc_cb( BoxType *, void * );
int gp_line_cb( BoxType *, void * );
void maybe_pull_1( LineTypePtr  );
int GlobalPuller( int , char **, int , int  );
int Puller( int , char **, int , int  );
void register_puller_action_list( void );
int find_pair_padline_callback( BoxType *, void * );
...
extern HID_Action puller_action_list[2];
extern HID *gui;
/* Warning:  conflicting decls for start_angle */
/* Warning:  conflicting decls for arcs */
/*****************************************************************************************/
/******                                                                             ******/
