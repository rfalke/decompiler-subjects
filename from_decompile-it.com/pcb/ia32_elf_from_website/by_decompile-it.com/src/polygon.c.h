...
void add_noholes_polyarea( PLINE *, void * );
int PolygonHoles( PolygonType *, BoxType *, int (*)( PLINE *, void * ), void * );
int plow_callback( BoxType *, void * );
void debug_pline( PLINE * );
void debug_polyarea( POLYAREA * );
void debug_polygon( PolygonType * );
...
int Unsubtract( POLYAREA *, PolygonType * );
POLYAREA *ContourToPoly( PLINE * );
POLYAREA *RoundRect( LocationType , LocationType , LocationType , LocationType , BDimension  );
...
POLYAREA *PinPoly( PinType *, BDimension , BDimension  );
POLYAREA *RectPoly( LocationType , LocationType , LocationType , LocationType  );
void r_NoHolesPolygonDicer( POLYAREA *, void (*)( PLINE *, void * ), void * );
void NoHolesPolygonDicer( PolygonTypePtr , BoxType *, void (*)( PLINE *, void * ), void * );
Boolean IsRectangleInPolygon( LocationType , LocationType , LocationType , LocationType , PolygonTypePtr  );
POLYAREA *BoxPolyBloated( BoxType *, BDimension  );
int clearPoly( DataTypePtr , LayerTypePtr , PolygonType *, BoxType *, BDimension  );
int add_plow( DataTypePtr , LayerTypePtr , PolygonTypePtr , int , void *, void * );
...
POLYAREA *SquarePadPoly( PadType *, BDimension  );
POLYAREA *LinePoly( LineType *, BDimension  );
POLYAREA *ArcPolyNoIntersect( ArcType *, BDimension  );
POLYAREA *ArcPoly( ArcType *, BDimension  );
int SubtractArc( ArcType *, PolygonType * );
int arc_sub_callback( BoxType *, void * );
int SubtractPad( PadType *, PolygonType * );
int pad_sub_callback( BoxType *, void * );
int SubtractLine( LineType *, PolygonType * );
int line_sub_callback( BoxType *, void * );
int SubtractPin( DataType *, PinType *, LayerType *, PolygonType * );
int pin_sub_callback( BoxType *, void * );
int SubtractText( TextType *, PolygonType * );
int text_sub_callback( BoxType *, void * );
int subtract_plow( DataTypePtr , LayerTypePtr , PolygonTypePtr , int , void *, void * );
BOOLp poly_InclContour( POLYAREA *, PLINE * );
