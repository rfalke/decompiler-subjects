...
int ActionToggleVendor( int , char **, int , int  );
int ActionEnableVendor( int , char **, int , int  );
int ActionDisableVendor( int , char **, int , int  );
int vendor_get_enabled( int  );
void register_vendor_flag_list( void );
void register_vendor_action_list( void );
int vendorDrillMap( int  );
Boolean rematch( char *, char * );
Boolean vendorIsElementMappable( ElementTypePtr  );
int ActionUnloadVendor( int , char **, int , int  );
void apply_vendor_map( void );
int ActionLoadVendorFrom( int , char **, int , int  );
int ActionApplyVendor( int , char **, int , int  );
int hid_action( char * );
...
extern HID_Action vendor_action_list[6];
extern HID_Flag vendor_flag_list[1];
extern HID *gui;
/*****************************************************************************************/
/******                                                                             ******/
