...
int CommandSaveLayout( int , char **, int , int  );
int CommandHelp( int , char **, int , int  );
int CommandLoadNetlist( int , char **, int , int  );
int CommandReallyQuit( int , char **, int , int  );
int CommandQuit( int , char **, int , int  );
int CommandSaveLayoutAndQuit( int , char **, int , int  );
int CommandLoadLayoutToBuffer( int , char **, int , int  );
int CommandLoadElementToBuffer( int , char **, int , int  );
int CommandLoadLayout( int , char **, int , int  );
...
/******                                                                             ******/
/*****************************************************************************************/
extern HID_Action command_action_list[10];
