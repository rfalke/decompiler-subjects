...
float drc_lines( PointTypePtr , Boolean  );
void EnforceLineDRC( void );
int drcArc_callback( BoxType *, void * );
int drcLine_callback( BoxType *, void * );
int drcPad_callback( BoxType *, void * );
int drcVia_callback( BoxType *, void * );
