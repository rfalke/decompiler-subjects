...
static int (*MenuKeymap[128])( char  );
static int (*MenuEscKeymap[128])( char  );
static int (*MenuEscBKeymap[128])( char  );
static int (*MenuEscDKeymap[128])( char  );
static Menu SelectMenu;
static int SelectV;
static Menu SelTabMenu;
static int SelTabV;
static Menu MainMenu;
static wc_ces MainMenuCharset;
static int MainMenuEncode;
static MenuItem MainMenuItem[21];
static MenuList *w3mMenuList;
static Menu *CurrentMenu;
static char *SearchString;
static char lmKeys[22];
static char lmKeys2[34];
extern int (*menuSearchRoutine)( Menu *, char *, int  );
extern char *graph_symbol[32];
extern int LINES;
extern int COLS;
