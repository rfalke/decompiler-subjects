...
static int is_infinitel( double long x );
int is_infinitel( double long x )
{
  return rpl_isnanl( x/*.1_4of16*/ ) != 0 || ( ( ( ( ( ( 0 & 1 ) == 1 ) & ( ( 0 & 1 ) == 0 ) ) ^ 1 ) & 255 ) == 0 && 1 == 0 ) ? 1 : 0;
}
    ...
    else
    {
      ...
      while ( dp->dir_start == cp )
      {
        if ( i != d.count )
        {
          if ( dp->conversion == '%' )
          {
            ...
            if ( allocated < augmented_length )
            {
              size_t memory_size;
              char *memory;
              allocated = allocated == 0 ? 12 : (int)allocated < 0 ? -1 : allocated * 2;
              if ( allocated < augmented_length )
                allocated = augmented_length;
              memory_size = allocated;
              if ( memory_size != -1 )
              {
                if ( resultbuf != result && result != 0 )
                {
                  memory = realloc( result, memory_size );
                }
                else
                {
          ...
          else
          {
            ...
            if ( dp->conversion == 'n' )
            {
              ...
              {
              case 18:
                a.arg[ dp->arg_index ].a.a_schar/*error:'c'*/ = length;
                break;
              case 19:
                a.arg[ dp->arg_index ].a.a_short/*error:'s'*/ = length;
                break;
              case 20:
                a.arg[ dp->arg_index ].a.a_int/*error:'i'*/ = length;
                break;
              case 21:
                a.arg[ dp->arg_index ].a.a_int/*error:'i'*/ = length;
                break;
              case 22:
                a.arg[ dp->arg_index ].a.a_int/*error:'i'*/ = length;
                a.arg[ dp->arg_index ].a.a_int/*error:'i'*/ = 0;
                break;
              default:
                abort( );
                break;
            ...
            {
              if ( ( dp->conversion == 'f' || dp->conversion == 'F' || dp->conversion == 'e' || dp->conversion == 'E' || dp->conversion == 'g' || dp->conversion == 'G' || dp->conversion == 'a' || dp->conversion == 'A' ) && a.arg[ dp->arg_index ].type == 12 && is_infinitel( a.arg[ dp->arg_index ].a.a_int ) != 0 )
              {
                int flags = dp->flags;
                int has_width = 0;
                size_t width = 0;
                ...
                if ( dp->width_end != dp->width_start )
                {
                  ...
                  else
                  {
                    ...
                    do
                    {
                      width = xsum( width <= 429496729 ? width * 10 : -1, digitp[0] - 48 );
                    }
                ...
                if ( dp->precision_end != dp->precision_start )
                {
                  ...
                  else
                  {
                    ...
                    precision = 0;
                    for ( ; dp->precision_end != digitp; precision = xsum( precision <= 429496729 ? precision * 10 : -1, digitp[0] - 48 ) )
                    {
                      digitp++;
                      //precision = xsum( precision <= 429496729 ? precision * 10 : -1, digitp[0] - 48 );
                    }
                    has_precision = 1;
                  }
                }
              ...
              {
                double long arg;
                arg/*.1_8of16*/ = a.arg[ dp->arg_index ].a.a_longlongint;
                arg/*.9_12of16*/ = a.arg[ dp->arg_index ].a.a_char/*error:'i'*/;
                if ( rpl_isnanl( arg/*.1_4of16*/ ) != 0 )
                {
                  ...
                  oldcw = ebp_936;
                {
                  ...
                  if ( ( ( ( ( 0 & 1 ) == 0 ) ^ 1 ) & 255 ) == 0 && ( ( ( ( ( 0 & 1 ) == 1 ) & ( ( 0 & 1 ) == 0 ) ) ^ 1 ) & 255 ) == 0 )
                  {
                    if ( dp->conversion > 64 && dp->conversion <= 90 )
                    {
                      p[0] = 'I';
                ...
                if ( has_width != 0 && p - tmp < width )
                {
                  ...
                  if ( ( flags & 32 ) != 0 && pad_ptr != 0 )
                  {
                    char *q = end;
                    for ( ; pad_ptr < p; q[0] = p[0] )
                    {
                      q = &q[ -1 ];
                      p = &p[ -1 ];
                      //q[0] = p[0];
                ...
                result[ length ] = 0;
              {
                while ( count = -1, retcount = 0, maxlen = allocated - length, (int)maxlen >= 0 )
                {
                  ...
                  case TYPE_SCHAR:
                  {
                    ...
                    if ( count >= 0 )
                    {
                      if ( count < maxlen && ( result[ length + count ] & 255 ) != 0 )
                      {
                        abort( );
                      }
                      if ( count < retcount )
                    ...
                    if ( retcount < 0 )
                    {
                      size_t bigger_need = xsum( (int)allocated < 0 ? -1 : allocated * 2, 12 );
                    ...
                    else
                    {
                      if ( maxlen <= count + 1 )
                      {
                        ...
                        {
                          size_t n = xmax( xsum( length, count + 2 ), (int)allocated < 0 ? -1 : allocated * 2 );
                          if ( n <= allocated )
                            continue;
                          else
                          {
                  ...
                  case TYPE_SHORT:
                    ...
                    break;
                  case TYPE_USHORT:
                    unsigned int arg = a.arg[ dp->arg_index ].a.a_short;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                  ...
                  case TYPE_INT:
                    ...
                    break;
                  case TYPE_UINT:
                    unsigned int arg = a.arg[ dp->arg_index ].a.a_int;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                    ...
                    break;
                  case TYPE_LONGINT:
                    long arg = a.arg[ dp->arg_index ].a.a_int;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                    ...
                    break;
                  case TYPE_ULONGINT:
                    unsigned long arg = a.arg[ dp->arg_index ].a.a_int;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                  ...
                  case TYPE_ULONGLONGINT:
                    unsigned long long arg = a.arg[ dp->arg_index ].a.a_longlongint;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                    ...
                    break;
                  case TYPE_DOUBLE:
                    double arg = a.arg[ dp->arg_index ].a.a_longlongint;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                  ...
                  case TYPE_CHAR:
                    ...
                    break;
                  case TYPE_WIDE_CHAR:
                    wint_t arg = a.arg[ dp->arg_index ].a.a_int;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                    ...
                    break;
                  case TYPE_STRING:
                    char *arg = &a.arg[ dp->arg_index ].a.a_int;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                  ...
                  case TYPE_WIDE_STRING:
                    wchar_t *arg = &a.arg[ dp->arg_index ].a.a_int;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
                    ...
                    break;
                  case TYPE_POINTER:
                    void *arg = &a.arg[ dp->arg_index ].a.a_int;
                    switch ( prefix_count )
                    {
                    default:
                      abort( );
        ...
        else
        {
          ...
          {
            char *memory = realloc( result, length + 1 );
            if ( memory != 0 )
              result = memory;
          }
          if ( buf_malloced != 0 )
