...
extern Config_Enum tbl_force_prompt[4];
extern Config_Enum tbl_keypad_mode[7];
extern Config_Enum tbl_multi_bookmarks[5];
extern Config_Enum tbl_preferred_encoding[7];
extern Config_Enum tbl_preferred_media[6];
extern Config_Enum tbl_transfer_rate[8];
extern Config_Enum tbl_user_mode[4];
