...
typedef struct _HTParentAnchor0 {
...
typedef struct _HTParentAnchor {
     HTParentAnchor0 *parent;
...
typedef struct _HTAtom {
     HTAtom *next;
     char *name;
  } HTAtom;
typedef HTAtom *HTFormat;
typedef struct _HTChunk {
     int size;
     int growby;
     int allocated;
     char *data;
...
typedef struct _CSOformgen_context {
     char *host;
     char *seek;
     CSOfield_info *fld;
     int port;
...
int fscanf( void *, char *, ... );

int strftime( char *, int, char *, void * );
...
BOOLEAN LYToggleSigDfl( int sig, struct sigaction {
     union {
...
struct addrinfo {
     ...
     char *ai_canonname;
     struct addrinfo  *ai_next;
  } *HTGetAddrInfo( char *str, int defport );
