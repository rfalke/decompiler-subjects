...

{
  ...
  *(undefined4 *)__nl_symbol_ptr::_errno = 0;
  ...
  __dyld_func_lookup(0x1f80,uVar4 - 0xc0);
  (*(code *)puVar6[-0x30])();
  return;
}
...

{
  ...
  *(undefined4 *)__nl_symbol_ptr::_errno = 0;
  ...
  uStack_64 = 0x196c;
  __dyld_func_lookup(0x1f80,apcStack_80);
  (*apcStack_80[0])();
  return;
}
...

{
  ...
  __dyld_func_lookup(0x1f80,local_20);
  (*local_20[0])();
  return;
}
...
{
                    // WARNING: Could not recover jumptable at 0x00001b80. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  if (2 < param_1) {
    ...
    bVar1 = (3 < param_1) << 2;
    do {
      if ((2 < param_1) || (!(bool)(bVar1 >> 2 & 1))) {
        __picsymbol_stub::_putchar(0x39);
LAB_00001d68:
...
{
                    // WARNING: Could not recover jumptable at 0x00001dd4. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  int iVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x00001df8. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001e1c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001e40. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001e64. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001e88. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001eac. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001ed0. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001ef4. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001f18. Too many branches
                    // WARNING: Treating indirect jump as call
...
int __picsymbol_stub::_putchar(int param_1)

{
  int iVar1;
  
                    // WARNING: Could not recover jumptable at 0x00001f60. Too many branches
                    // WARNING: Treating indirect jump as call
