...
void call_gmon_start() {
    ...
    fun_80482a6();
    eax1 = *reinterpret_cast<int32_t*>(eax2 + 0x12e6 + 20);
    if (eax1) {
        eax1();
    }
    return;
...
int32_t __do_global_ctors_aux() {
    ...
    v1 = edx2;
    eax3 = __CTOR_LIST__;
    ebx4 = reinterpret_cast<int32_t*>(0x8049578);
    if (eax3 != -1) {
        do {
            --ebx4;
            eax3();
...
/* p.0 */
int32_t* p_0 = reinterpret_cast<int32_t*>(0x8049584);
...
int32_t __libc_csu_init() {
    ...
    if (!1) {
        do {
            eax1 = reinterpret_cast<int32_t>(*reinterpret_cast<int32_t*>(ebx2 * 4 + 0x80494a4)());
            ++ebx2;
        } while (ebx2 < 0);
    }
    return eax1;
