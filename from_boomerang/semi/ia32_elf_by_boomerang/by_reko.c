...
{
	if (globals->b80495A4 == 0x00)
	{
		<anonymous> ** eax_25 = globals->ptr80494AC;
...
void frame_dummy()
{
	if (globals->dw8049588 != 0x00 && 0x00 != 0x00)
	{
		word32 esp_31;
		word32 ebp_32;
		byte SCZO_33;
...
{
	<anonymous> * eax_13 = globals->ptr8049578;
