...
// 0000000000000838: void main(Register int32 w0, Register word32 x0_32_32)
void main(int32 w0, word32 x0_32_32)
{
	if (w0 > 0x02)
	{
		do
		{
			...
			{
				x0_32_32 = SLICE((uint64) putchar(SEQ(x0_32_32, 0x39)), word32, 32);
l0000000000000894:
				x0_32_32 = SLICE((uint64) putchar(SEQ(x0_32_32, 0x35)), word32, 32);
			}
		} while (w0 <= 0x05);
	}
	else
