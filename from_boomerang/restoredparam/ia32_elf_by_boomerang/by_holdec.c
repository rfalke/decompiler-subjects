...
??? _start(???)
{
  ...
  (void) STORE(local + 24, 134513572);
  (void) STORE(local + 28, 134513652);
...
{
  (void) F_08048306();
  if(LOAD(InitValue(initial_value_of_ecx) + 4658)  !=  0) {
    (void) F_080482c8();
  }
...
??? __do_global_dtors_aux(???)
{
  ...
  if(LOAD(&g_0x08049560)  ==  0) {
    while(1) {
      ...
      (void) STORE(&g_0x0804955c, reg_result + 4);
      (void) intern_redirectCall(reg_ad);
    }
    (void) STORE(&g_0x08049560, 1);
  }
  return reg_result;
}
