...

{
  ...
  printf("Input number: ");
  __isoc99_scanf(&DAT_001009b0,&number);
  uVar1 = fib(number);
...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x0010091c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x10091c);
