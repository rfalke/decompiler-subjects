...
// 00000000000008D0: Register word64 fib(Register int32 w0, Register out ptr64 x19Out)
// Called from:
//      main
//      fib
word64 fib(int32 w0, ptr64 & x19Out)
{
