...
// WARNING: Removing unreachable block (ram,0x00100920)
// WARNING: Removing unreachable block (ram,0x0010092c)
...

{
  ...
  iVar3 = fib(iVar5);
  iVar4 = fib(iVar3 + -1);
  printf("%d",(ulong)(uint)(iVar3 + iVar4));
  printf("%d",(ulong)(uint)(iVar2 + iVar3));
  if (iVar5 < 2) {
    if (iVar5 != 1) {
      iVar3 = iVar2 + -3;
    ...
    iVar3 = iVar5 + -1;
    iVar4 = fib(iVar3);
    printf("%d",(ulong)(uint)(iVar5 + iVar4));
    if (1 < iVar3) {
      iVar3 = fib(iVar5 + -2);
      iVar4 = fib(iVar3 + -1);
      printf("%d",(ulong)(uint)(iVar3 + iVar4));
