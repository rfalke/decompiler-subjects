...

{
  ...
  if (1 < number) {
    if (number == 2) {
      ...
      x = uVar1 - 1;
      iVar2 = fib(x);
      printf("%d",(ulonglong)(uVar1 + iVar2));
    }
    x = fib(x);
    printf("%d",(ulonglong)(x + uVar1));
  }
  printf("fibonacci(%d) = %d\n",(ulonglong)(uint)number,(ulonglong)uVar1);
  return 0;
}
...

{
  ...
  x_00 = iVar2 + -1;
  iVar3 = fib(x_00);
  printf("%d",(ulonglong)(uint)(iVar2 + iVar3));
  if (x_00 < 2) {
    uVar4 = (ulonglong)(uint)(iVar2 + x_00);
    printf("%d",uVar4);
    goto LAB_0010098c;
  }
  x_01 = iVar2 - 2;
  x_00 = fib(x_01);
  iVar3 = fib(x_00 + -1);
  printf("%d",(ulonglong)(uint)(x_00 + iVar3));
  printf("%d",(ulonglong)(uint)(iVar2 + x_00));
  if ((int)x_01 < 2) {
    uVar1 = x_01;
    if (x_01 != 1) {
      x_00 = iVar2 + -3;
...
LAB_00100a4c:
  ...
  uVar4 = (ulonglong)(iVar2 + x_01);
  printf("%d",(ulonglong)uVar1);
LAB_0010098c:
  printf("%d",uVar4);
  return iVar2;
}
