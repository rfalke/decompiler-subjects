...

{
  ...
  if (local_c < 2) {
    ...
    uVar3 = extraout_EDX;
    iVar2 = local_c;
    if (local_c == 1) goto LAB_08048398;
  }
  else {
    iVar2 = fib(local_c + -1);
    iVar1 = fib(iVar2 + -1);
...

{
  ...
  if (param_1 < 2) {
    ...
    param_1 = fib(param_1 + -1);
    iVar1 = fib(param_1 + -1);
    printf("%d",iVar1 + param_1);
  }
  return param_1;
}
...
// WARNING: Removing unreachable block (ram,0x08048449)
// WARNING: Removing unreachable block (ram,0x0804844c)
...
// WARNING: Removing unreachable block (ram,0x08048480)
