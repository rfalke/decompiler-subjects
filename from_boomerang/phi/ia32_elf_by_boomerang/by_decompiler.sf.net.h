// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/phi/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (804835C (ptr code) ptr804835C) (804842C (ptr code) ptr804842C) (804845C (ptr code) ptr804845C))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x0804842C : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x0804845C : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr804835C, dwArg00, fp + 0x00000004, &globals->ptr804842C, &globals->ptr804845C, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	...
	code * ptr804842C;	// 804842C
	code * ptr804845C;	// 804845C
} Eq_1;
