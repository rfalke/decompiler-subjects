...
// 0000000000000888: Register int32 fib(Register int32 w0, Register out Eq_99 w19Out)
// Called from:
//      fib
//      main
int32 fib(int32 w0, union Eq_99 & w19Out)
{
	...
	if (w0 > 0x01)
	{
		...
		x0_32_32_w19_90 = SEQ(SLICE(0x09C0, word32, 32), (word32) x19_34);
	}
	w19Out.u0 = <invalid>;
