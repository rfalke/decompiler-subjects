...
{
                    // WARNING: Could not recover jumptable at 0x00001a9c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001aac. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  if ((int)local_20[0] < 2) {
    ...
    uVar1 = _fib(uVar3 - 1);
    lVar2 = _fib(uVar1 - 1);
    __picsymbol_stub::_printf("%d",uVar1 + lVar2);
    uVar3 = (ulonglong)local_20[0];
  }
...
longlong _fib(longlong param_1)

{
  ...
  if ((int)param_1 < 2) {
    ...
    param_1 = _fib(param_1 + -1);
    lVar1 = _fib(param_1 + -1);
    __picsymbol_stub::_printf("%d",param_1 + lVar1);
  }
  return param_1;
}
