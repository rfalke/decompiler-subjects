...
int32 fib(int32 w0, ptr64 & x29Out)
{
	...
	if (w0 > 0x01)
	{
		struct Eq_122 * x29_23;
		x29_23->dw001C = fib(w0, out x29_23);
		struct Eq_130 * x29_33;
		x29_33->dw002C = fib(w0, out x29_33);
		x0_69 = SEQ(SLICE((uint64) printf("%d", x29_33->dw001C + x29_33->dw002C), word32, 32), x29_33->dw001C);
	}
	else if (w0 == 0x01)
...
void main(int32 dwArg00)
{
	...
	word64 x29_54;
	x0_38 = (uint64) printf("fibonacci(%d) = %d\n", dwArg00, fib(dwArg00, out x29_54));
}
