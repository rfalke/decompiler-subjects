...
// 0000000000000888: Register word64 fib(Register word64 x0, Register out ptr64 x29Out)
// Called from:
//      fib
//      main
word64 fib(word64 x0, ptr64 & x29Out)
{
	int32 w0 = (word32) x0;
	...
	if (w0 > 0x01)
	{
		...
		x29_23->dw001C = (word32) fib(x0, out x29_23);
		struct Eq_118 * x29_33;
		x29_33->dw002C = (word32) fib(x0, out x29_33);
		fn0000000000000730();
