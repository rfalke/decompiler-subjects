...
// 0000000000000888: Register Eq_109 fib(Register Eq_109 w0, Register out ptr64 x29Out)
// Called from:
//      fib
//      main
Eq_109 fib(Eq_109 w0, ptr64 & x29Out)
{
	Eq_109 w0 = (word32) x0;
	...
	if (w0 > 0x01)
	{
		struct Eq_120 * x29_23;
		x29_23->dw001C = fib(w0, out x29_23);
		struct Eq_128 * x29_33;
		x29_33->dw002C = fib(w0, out x29_33);
		x0_69 = SEQ(SLICE((uint64) printf("%d", 0x00), word32, 32), x29_33->dw001C);
	}
	else if (w0 == 0x01)
		x0_69 = SEQ(x0_32_32, 0x01);
	else
		x0_69 = x0;
	x29Out = <invalid>;
	return (word32) x0_69;
...
void main(word32 dwArg00)
{
	...
	word64 x29_52;
	fib(SEQ(SLICE((uint64) __isoc99_scanf("%d", 0x00), word32, 32), dwArg00), out x29_52);
