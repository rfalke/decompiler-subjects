...
{
	ptr64 fp;
	struct Eq_94 * x29_36 = fp + -16;
	if (w0 > 0x01)
	{
		word64 x29_93;
		int32 w0_31 = fib(w0 - 0x01, out x29_93);
		printf("%d", w0_31 + fib(w0_31 - 0x01, out x29_36));
		x29_36->dwFFFFFFFC = w0_31;
	}
	x29Out = <invalid>;
	return x29_36->dwFFFFFFFC;
}

// 00000000004006D4: void main()
void main()
{
	ptr64 fp;
	int32 dwLoc18;
	...
	word64 x29_62;
	printf("fibonacci(%d) = %d\n", dwLoc18, fib(dwLoc18, out x29_62));
}
