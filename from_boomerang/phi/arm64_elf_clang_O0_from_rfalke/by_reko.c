...
// 0000000000400640: Register word64 fib(Register int32 w0, Register out ptr64 x29Out)
// Called from:
//      fib
//      main
word64 fib(int32 w0, ptr64 & x29Out)
{
	struct Eq_90 * x29_37 = fp + -8;
	if (w0 > 0x01)
	{
		struct Eq_98 * sp_25 = (struct Eq_98 *) <invalid>;
		word64 x29_97;
		sp_25->dw0008 = (word32) fib(w0 - 0x01, out x29_97);
		struct Eq_98 * sp_36 = (struct Eq_98 *) <invalid>;
		sp_36->dw0004 = (word32) fib(sp_25->dw0008 - 0x01, out x29_37);
		fn00000000004004E0();
		x29_37->dwFFFFFFFC = sp_36->dw0008;
		sp_36->dw0000 = (word32) 0x004007D8;
		x0_32_32 = SLICE(0x004007D8, word32, 32);
	}
	word64 x0_89 = SEQ(x0_32_32, x29_37->dwFFFFFFFC);
...
void main(word64 x29)
{
	fn00000000004004E0();
	fn00000000004004D0();
	struct Eq_155 * x29_31;
	x29_31->dwFFFFFFF4 = (word32) fib((word32) x29, out x29_31);
	fn00000000004004E0();
