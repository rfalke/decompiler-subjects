...
{
	struct Eq_89 * x29_37 = fp + -8;
	if (w0 > 0x01)
	{
		struct Eq_97 * sp_25 = (struct Eq_97 *) <invalid>;
		word64 x29_97;
		sp_25->dw0008 = (word32) (uint64) fib(w0 - 0x01, out x29_97);
		struct Eq_97 * sp_36 = (struct Eq_97 *) <invalid>;
		sp_36->dw0004 = (word32) (uint64) fib(sp_25->dw0008 - 0x01, out x29_37);
		fn00000000004004E0();
		x29_37->dwFFFFFFFC = sp_36->dw0008;
		sp_36->dw0000 = (word32) 0x004007D8;
	}
	x29Out = x29_37->ptr0000;
	return x29_37->dwFFFFFFFC;
}

// 00000000004006D4: void main(Register word32 w29)
void main(word32 w29)
{
	fn00000000004004E0();
	fn00000000004004D0();
	struct Eq_151 * x29_31;
	x29_31->dwFFFFFFF4 = (word32) (uint64) fib((word32) x29, out x29_31);
	fn00000000004004E0();
	struct Eq_97 * sp_28 = (struct Eq_97 *) <invalid>;
	sp_28->dw0008 = (word32) 0x004007EA;
}
