...
{
                    // WARNING: Could not recover jumptable at 0x00001a7c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001a8c. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  if ((int)param_1 < 2) {
    ...
    uStack00000018 = _fib((ulonglong)param_1 - 1);
    uVar1 = _fib((ulonglong)uStack00000018 - 1);
    __picsymbol_stub::_printf("%d",(ulonglong)uStack00000018 + (ulonglong)uVar1);
    local_1c = uStack00000018;
  }
  return local_1c;
}
...

{
  ...
  uStack4 = (undefined4)((ulonglong)unaff_r31 >> 0x20);
  __picsymbol_stub::_printf("Input number: ");
  __picsymbol_stub::_scanf("%d",&local_20);
  local_1c = _fib(local_20);
  __picsymbol_stub::_printf("fibonacci(%d) = %d\n",(ulonglong)local_20,(ulonglong)local_1c);
  return 0;
}
...
{
                    // WARNING: Could not recover jumptable at 0x00001d88. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  int iVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x00001f14. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  int iVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x00001f38. Too many branches
                    // WARNING: Treating indirect jump as call
