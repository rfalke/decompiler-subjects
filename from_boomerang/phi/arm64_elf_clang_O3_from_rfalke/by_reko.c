...
// 0000000000400640: Register Eq_87 fib(Register Eq_87 w0, Register out Eq_88 w19Out, Register out ptr64 x29Out)
// Called from:
//      fib
//      main
Eq_87 fib(Eq_87 w0, union Eq_88 & w19Out, ptr64 & x29Out)
{
	Eq_87 w0 = (word32) x0;
	word64 x0_78 = x0;
	if (w0 >= 0x02)
	{
		word32 w19_100;
		word64 x29_101;
		fib(w0, out w19_100, out x29_101);
		word32 w19_102;
		word64 x29_103;
		fib(w0, out w19_102, out x29_103);
		fn00000000004004E0();
...
void main(word64 x29)
{
	...
	word32 w19_52;
	word64 x29_53;
	fib(SEQ(SLICE(0x00400770, word32, 32), SLICE(x29, word32, 32)), out w19_52, out x29_53);
	fn00000000004004E0();
}
