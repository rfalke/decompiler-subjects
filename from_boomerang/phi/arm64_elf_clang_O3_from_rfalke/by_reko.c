...
// 0000000000400640: Register word64 fib(Register word64 x0, Register out ptr64 x19Out, Register out ptr64 x29Out)
// Called from:
//      fib
//      main
word64 fib(word64 x0, ptr64 & x19Out, ptr64 & x29Out)
{
	int32 w0 = (word32) x0;
	word64 x0_78 = x0;
	if (w0 >= 0x02)
