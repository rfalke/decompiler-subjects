...

{
  ...
  if (param_1 < 2) {
    ...
    local_20 = fib(param_1 + -1);
    iVar1 = fib(local_20 + -1);
    printf("%d",local_20 + iVar1);
  }
  return local_20;
}
...
// WARNING: Removing unreachable block (ram,0x100005c4)
...
// WARNING: Removing unreachable block (ram,0x10000658)
