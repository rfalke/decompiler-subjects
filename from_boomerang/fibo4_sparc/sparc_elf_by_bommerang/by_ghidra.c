...

{
  ...
  FUN_000208b0(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_000208bc(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
// WARNING: Inlined function: FUN_0001075c
...
{
  IllegalInstructionTrap(0x20880);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x2088c);
  return;
}
