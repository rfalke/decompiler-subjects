...

{
  ...
  *(undefined4 **)in_FS_OFFSET = &local_c;
  ...
  local_4 = 0;
  SetMapMode(local_60,2);
  CBrush(local_88,0xc0ffff);
  ...
  iVar2 = 0xb;
  do {
    MoveTo(local_60,(int)&local_70,x);
    LineTo((CDC *)(&local_70 + 0xc),cHeight + 700,-100);
    MoveTo((CDC *)(&local_70 + 0xc),(int)&stack0xffffff68,100);
    LineTo((CDC *)(&local_70 + 8),600,x + -700);
    x = x + 0x32;
    cHeight = cHeight + -0x32;
    iVar2 = iVar2 + -1;
  } while (iVar2 != 0);
  CPen(local_80,0,0x1e,0xff);
  local_c = CONCAT31(local_c._1_3_,2);
  local_84 = (undefined **)SelectObject((CDC *)(&local_70 + 8),local_80);
  MoveTo((CDC *)(&local_70 + 8),(int)&iStack124 + 4,100);
  LineTo((CDC *)(&local_70 + 4),100,-600);
  LineTo((CDC *)(&local_70 + 4),600,-600);
  LineTo((CDC *)(&local_70 + 4),600,-100);
  LineTo((CDC *)(&local_70 + 4),100,-100);
  if ((undefined *)register0x00000010 != (undefined *)0x88) {
    SelectObject(local_68,local_88);
  }
  x = 700;
  SetTextAlign((CDC *)(&local_70 + 4),0x18);
  SetBkMode((CDC *)(&local_70 + 4),1);
  iVar2 = 0;
  do {
    ...
    cWidth = 0;
    cHeight = _ftol();
    pHVar1 = CreateFontA(cHeight,cWidth,cEscapement,cOrientation,cWeight,bItalic,bUnderline,
                         bStrikeOut,iCharSet,iOutPrecision,iClipPrecision,iQuality,iPitchAndFamily,
                         pszFaceName);
    Attach((CGdiObject *)&stack0xffffff60,pHVar1);
    pCStack140 = SelectObject((CDC *)(&local_70 + 4),(CFont *)&stack0xffffff60);
    TextOutA(local_68,x,-600,s_Fading____00403020 + iVar2,1);
    GetTextExtentPointA(local_64,s_Fading____00403020 + iVar2,1,(LPSIZE)&iStack124);
    x = x + iStack124;
    if ((undefined *)register0x00000010 != (undefined *)0x8c) {
      SelectObject(local_68,&pCStack140);
    }
    local_10 = CONCAT31(local_10._1_3_,4);
    DeleteObject((CGdiObject *)&stack0xffffff60);
    iVar2 = iVar2 + 1;
  } while (iVar2 < 9);
  local_84 = &PTR_LAB_00402228;
  local_10._0_1_ = 5;
  DeleteObject((CGdiObject *)&local_84);
  appuStack148[0] = &PTR_LAB_00402228;
  local_84 = &PTR_LAB_00402210;
  local_10 = CONCAT31(local_10._1_3_,6);
  DeleteObject((CGdiObject *)appuStack148);
  appuStack148[0] = &PTR_LAB_00402210;
  local_10 = 0xffffffff;
  _CPaintDC((CPaintDC *)(&local_70 + 4));
...
CPen * __thiscall SelectObject(CDC *this,CPen *param_1)
...
void __thiscall CPen(CPen *this,int param_1,int param_2,ulong param_3)
...
int __thiscall LineTo(CDC *this,int param_1,int param_2)
...
CPoint __thiscall MoveTo(CDC *this,int param_1,int param_2)
...
int __thiscall SetMapMode(CDC *this,int param_1)
...

{
  ...
  *puVar1 = DAT_0040311c;
  ...
  local_6c = FUN_00401bfc((HINSTANCE__ *)pHVar3,pHVar4,(char *)pbVar5,local_30);
...

{
  ...
  _CDialog((CDialog *)(unaff_EBP + -0x70));
  return;
}
...

{
  ...
  *(undefined4 *)(unaff_EBP + -0x94) = 0x402210;
  return;
}
...

{
  ...
  *(undefined4 *)(unaff_EBP + -0x78) = 0x402210;
  return;
}
...

{
  ...
  *(undefined4 *)(unaff_EBP + -0x88) = 0x402210;
  return;
}
...

{
  ...
  **(undefined4 **)(unaff_EBP + -0x10) = 0x402210;
  return;
}
