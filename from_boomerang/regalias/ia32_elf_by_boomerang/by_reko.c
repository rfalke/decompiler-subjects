...
// 08048278: void __libc_start_main@@GLIBC_2.0()
...
// 08048288: void printf@@GLIBC_2.0()
...
{
	struct Eq_114 * ebx_19 = __i686.get_pc_thunk.bx(dwLoc20);
	_init(0x00, edi);
...
{
	struct Eq_114 * ebx_11 = __i686.get_pc_thunk.bx(dwLoc10);
