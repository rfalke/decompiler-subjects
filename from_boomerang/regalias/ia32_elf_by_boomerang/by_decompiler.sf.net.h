// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/regalias/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (8048364 (ptr code) ptr8048364) (80483A0 (ptr code) ptr80483A0) (8048400 (ptr code) ptr8048400))
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr8048364, dwArg00, fp + 0x00000004, &globals->ptr80483A0, &globals->ptr8048400, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr8048364;	// 8048364
	code * ptr80483A0;	// 80483A0
