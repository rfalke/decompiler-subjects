...
void call_gmon_start() {
    ...
    fun_80482ae();
    eax1 = *reinterpret_cast<int32_t*>(eax2 + 0x126a + 20);
    if (eax1) {
        eax1();
    }
    return;
...
int32_t frame_dummy() {
    ...
    if (eax1) {
        v2 = ebp3 + 0x11db;
        __gmon_start__(0x8049438, 0x8049534, 0, v2, fun_804833d);
    }
    eax4 = __JCR_END__;
    if (eax4 && (eax4 = 0, !1)) {
        eax4 = __gmon_start__(0x8049514, 0x8049534, 0, v2, fun_804833d);
    }
    return eax4;
}
...
int32_t __do_global_ctors_aux() {
    ...
    eax1 = __CTOR_LIST__;
    ebx2 = reinterpret_cast<int32_t*>(0x8049504);
    if (eax1 != -1) {
        do {
            --ebx2;
            eax1();
...
void fun_80482ae() {
    ...
    eax1 = *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(__return_address()) + 0x126a + 20);
    if (eax1) {
        eax1();
    }
    goto ebp2->f4;
...
int32_t fun_804833d() {
    ...
    if (eax1) {
        v2 = reinterpret_cast<int32_t>(__return_address()) + 0x11db;
        __gmon_start__(0x8049438, 0x8049534, 0, v2, v3);
    }
    eax4 = __JCR_END__;
    if (eax4 && !1) {
        __gmon_start__(0x8049514, 0x8049534, 0, v2, v5);
    }
    goto ebp6->f4;
}
...
/* p.0 */
int32_t* p_0 = reinterpret_cast<int32_t*>(0x8049510);
...
int32_t __do_global_dtors_aux(int32_t a1) {
    ...
    if (zf5) {
        ...
        eax8 = 0;
        if (!1) {
            eax8 = __gmon_start__(0x8049438, v9, v3, v2, a1);
        }
        _edata = 1;
    }
    return eax8;
...
void _fini() {
    ...
    fun_804840a(edx1, ebx2, ebp3, __return_address());
}
