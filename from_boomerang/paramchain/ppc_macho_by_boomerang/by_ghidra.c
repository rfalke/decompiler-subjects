...
void _passem(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  param_13 = param_3;
  param_14 = param_4;
  _addem((ulonglong)param_1,(ulonglong)param_2,(ulonglong)param_3,(ulonglong)param_4);
  return;
}
