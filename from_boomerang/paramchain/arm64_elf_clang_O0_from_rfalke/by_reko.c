...
// 0000000000400618: Register word64 passem(Register word32 w0, Register word32 w1, Register word32 w2, Register (ptr64 word32) x3)
// Called from:
//      main
...
void main()
{
	...
	fn0000000000400480();
	struct Eq_115 * sp_16 = (struct Eq_115 *) <invalid>;
