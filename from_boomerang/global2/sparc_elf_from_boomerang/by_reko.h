...
/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (FFFFFFFF code tFFFFFFFF) (209B8 word32 dw209B8) (209F8 ptr32 ptr209F8))
...
Eq_172: (struct "Eq_172" (18 (ptr Eq_177) ptr0018))
	...
	T_176 (in fn00010790(o7, 0x0001009C) : word32)
...
T_21: (in fp + 0x00000044 + ((_init(o7) << 0x00000002) + 0x00000004) : word32)
  ...
  DataType: ptr32
  OrigDataType: ptr32
T_22: (in 0x000209F8 : word32)
  Class: Eq_22
  DataType: (ptr ptr32)
  OrigDataType: (ptr (struct (0 T_23 t0000)))
T_23: (in Mem24[0x000209F8:word32] : word32)
  Class: Eq_21
  DataType: ptr32
  OrigDataType: word32
T_24: (in main : ptr32)
...
T_152: (in 0x0000000C : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_153: (in 0x000209B8 : word32)
  Class: Eq_153
  DataType: (ptr word32)
  OrigDataType: (ptr (struct (0 T_154 t0000)))
T_154: (in Mem22[0x000209B8:word32] : word32)
  Class: Eq_152
  DataType: word32
  OrigDataType: word32
T_155: (in printf : ptr32)
...
typedef struct Globals {
	...
	word32 dw209B8;	// 209B8
	ptr32 ptr209F8;	// 209F8
} Eq_1;
