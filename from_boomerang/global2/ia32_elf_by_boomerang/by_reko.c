...
{
	<anonymous> * eax_15 = globals->ptr8049564;
	if (eax_15 != null)
	{
		word32 esp_29;
		word32 ebp_30;
...
{
	if (globals->b8049568 == 0x00)
	{
		<anonymous> ** eax_25 = globals->ptr8049460;
		...
		if (edx_26 != null)
		{
			do
			{
				...
				word32 esi_53;
				edx_26();
				eax_25 = globals->ptr8049460;
			} while (*eax_25 != null);
		}
		globals->b8049568 = 0x01;
	}
}
...
void frame_dummy()
{
	if (globals->dw804954C != 0x00 && 0x00 != 0x00)
	{
		word32 esp_31;
		word32 ebp_32;
		byte SCZO_33;
...
void foo2()
{
	globals->dw8049470 = 0x0C;
	printf("a = %f\n", DPB(rLoc18, globals->dw8049468, 0));
}
...
{
	<anonymous> * eax_13 = globals->ptr804953C;
