...
int32_t __do_global_ctors_aux() {
    ...
    v1 = edx2;
    eax3 = __CTOR_LIST__;
    ebx4 = reinterpret_cast<int32_t*>(0x804953c);
    if (eax3 != -1) {
        do {
            --ebx4;
            eax3();
...
/* p.0 */
int32_t* p_0 = reinterpret_cast<int32_t*>(0x8049548);
...
int32_t g804946c = 0x4014cccc;

int32_t a = 0xcccccccd;
...
void __libc_csu_fini() {
    ...
    if (0) {
        do {
            *reinterpret_cast<int32_t*>(ebx8 * 4 + 0x8049458)(v6);
            edx9 = ebx8;
            --ebx8;
        } while (edx9);
    }
...
int32_t __libc_csu_init() {
    ...
    if (!1) {
        do {
            eax1 = reinterpret_cast<int32_t>(*reinterpret_cast<int32_t*>(ebx2 * 4 + 0x8049458)());
            ++ebx2;
        } while (ebx2 < 0);
    }
    return eax1;
