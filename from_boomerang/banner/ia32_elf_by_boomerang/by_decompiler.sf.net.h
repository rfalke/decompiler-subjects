// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/banner/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (8048390 (ptr code) ptr8048390) (804856C (ptr code) ptr804856C) (804859C (ptr code) ptr804859C))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x0804856C : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x0804859C : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr8048390, dwArg00, fp + 0x00000004, &globals->ptr804856C, &globals->ptr804859C, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	...
	code * ptr804856C;	// 804856C
	code * ptr804859C;	// 804859C
} Eq_1;
