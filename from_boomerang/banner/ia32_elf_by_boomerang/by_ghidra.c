...
// WARNING! conflicting data type names: /DWARF/stddef.h/anon_subr/size_t - /stddef.h/size_t
...

{
  ...
  local_14 = (char **)malloc(0xc);
  local_14[1] = "HelloWorld";
  local_10 = 2;
  while( true ) {
    local_14 = local_14 + 1;
    local_10 = local_10 + -1;
    if (local_10 == 0) break;
    local_24 = strlen(*local_14);
    if (10 < (int)local_24) {
      local_24 = 10;
    }
    for (local_18 = 0; local_18 < 7; local_18 = local_18 + 1) {
      for (local_1c = 0; local_1c < (int)local_24; local_1c = local_1c + 1) {
        local_28 = (*local_14)[local_1c] + -0x20;
        if ((*local_14)[local_1c] + -0x20 < 0) {
          local_28 = 0;
        }
        for (local_20 = 0; local_20 < 7; local_20 = local_20 + 1) {
          ...
          local_7c[local_20 + local_1c * 8] =
               *(char *)((local_28 + (local_90 >> 3) * -8) * 7 + local_20 +
                        *(int *)(glyphs + (local_18 + (local_84 >> 3) * 7) * 4));
        }
        auStack117[local_1c * 8] = 0x20;
      }
      for (local_1c = local_24 * 8 + -1; (-1 < local_1c && (local_7c[local_1c] == ' '));
          local_1c = local_1c + -1) {
        local_7c[local_1c] = '\0';
      }
      puts(local_7c);
...
// WARNING: Removing unreachable block (ram,0x08048589)
// WARNING: Removing unreachable block (ram,0x0804858c)
...
// WARNING: Removing unreachable block (ram,0x080485ce)
