...

{
  ...
  iVar10 = 1;
  pvVar3 = malloc(0xc);
  ppcVar12 = (char **)((int)pvVar3 + 4);
  *ppcVar12 = "HelloWorld";
  do {
    sVar4 = strlen(*ppcVar12);
    if (10 < (int)sVar4) {
      sVar4 = 10;
    }
    iVar11 = 0;
    do {
      iVar5 = 0;
      puVar1 = &stack0xffffff80;
      iVar2 = sVar4 * 8;
      if (0 < (int)sVar4) {
        do {
          uVar8 = (uint)(byte)(*ppcVar12)[iVar5] - 0x20 &
                  (int)~((uint)(byte)(*ppcVar12)[iVar5] - 0x20) >> 0x1f;
          iVar6 = ((int)uVar8 >> 3) + (uint)((int)uVar8 < 0 && (uVar8 & 7) != 0);
          iVar13 = 7;
          iVar7 = *(int *)(glyphs + (iVar6 * 7 + iVar11) * 4);
          iVar9 = 0;
          do {
            (puVar1 + 8)[iVar9 + 8] = *(undefined *)(iVar7 + (uVar8 + iVar6 * -8) * 7 + iVar9);
            iVar13 = iVar13 + -1;
            iVar9 = iVar9 + 1;
          } while (iVar13 != 0);
          iVar5 = iVar5 + 1;
...
// WARNING: Removing unreachable block (ram,0x10000640)
// WARNING: Removing unreachable block (ram,0x1000063c)
...
// WARNING: Removing unreachable block (ram,0x100006d0)
// WARNING: Removing unreachable block (ram,0x100006d4)
