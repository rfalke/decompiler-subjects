...

{
  ...
  while( true ) {
    ...
    local_88 = local_88 + -1;
    if (local_88 == 0) break;
    local_74 = strlen(*local_84);
    if (10 < (int)local_74) {
      local_74 = 10;
    }
    for (local_80 = 0; local_80 < 7; local_80 = local_80 + 1) {
      for (local_7c = 0; local_7c < (int)local_74; local_7c = local_7c + 1) {
        local_70 = (byte)(*local_84)[local_7c] - 0x20;
        if ((int)local_70 < 0) {
          local_70 = 0;
        }
...
// WARNING: Removing unreachable block (ram,0x10000730)
// WARNING: Removing unreachable block (ram,0x1000072c)
...
// WARNING: Removing unreachable block (ram,0x100007c0)
// WARNING: Removing unreachable block (ram,0x100007c4)
