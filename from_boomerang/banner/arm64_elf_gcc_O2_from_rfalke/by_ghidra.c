...

{
  ...
  pvVar2 = malloc(0xc);
  iVar7 = 0;
  *(undefined8 *)((longlong)pvVar2 + 8) = 0x1011f0;
  do {
    pcVar4 = "HelloWorld";
    pcVar5 = line;
    do {
      lVar3 = 0;
      uVar1 = (uint)(byte)*pcVar4 - 0x20;
      if ((int)uVar1 < 0) {
        uVar1 = 0;
      }
      pcVar6 = glyphs[iVar7 + ((int)uVar1 >> 3) * 7];
      do {
        pcVar5[lVar3] = pcVar6[lVar3 + (int)((uVar1 & 7) * 7)];
        lVar3 = lVar3 + 1;
      } while (lVar3 != 7);
      pcVar4 = (char *)((byte *)pcVar4 + 1);
      pcVar5[7] = ' ';
      pcVar5 = pcVar5 + 8;
    } while ((byte *)pcVar4 != (byte *)0x1011fa);
    pcVar4 = line + 0x4f;
    do {
      if (*pcVar4 != ' ') break;
      pcVar5 = pcVar4 + -1;
...
// WARNING: Removing unreachable block (ram,0x00101080)
...
// WARNING: Removing unreachable block (ram,0x001010c8)
