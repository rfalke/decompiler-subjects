...

{
  ...
  pvVar4 = malloc(0xc);
  iVar8 = 0;
  *(undefined8 *)((longlong)pvVar4 + 8) = 0x101220;
  do {
    pcVar6 = line;
    pbVar7 = (byte *)"HelloWorld";
    do {
      pbVar7 = pbVar7 + 1;
      uVar2 = (uint)*pbVar7 - 0x20;
      if ((int)uVar2 < 0) {
        uVar2 = 0;
      }
      iVar3 = (uVar2 & 7) * 7;
      pcVar5 = glyphs[iVar8 + ((int)uVar2 >> 3) * 7];
      *pcVar6 = pcVar5[iVar3];
      pcVar6[1] = pcVar5[iVar3 + 1];
      pcVar6[2] = pcVar5[iVar3 + 2];
      pcVar6[3] = pcVar5[iVar3 + 3];
      pcVar6[4] = pcVar5[iVar3 + 4];
      pcVar6[5] = pcVar5[iVar3 + 5];
      cVar1 = pcVar5[iVar3 + 6];
      pcVar6[7] = ' ';
      pcVar6[6] = cVar1;
      pcVar6 = pcVar6 + 8;
      pbVar7 = pbVar7;
    } while (pbVar7 != (byte *)0x10122a);
    pcVar6 = line + 0x4f;
    do {
      if (*pcVar6 != ' ') break;
      pcVar5 = pcVar6 + -1;
...
// WARNING: Removing unreachable block (ram,0x001010bc)
