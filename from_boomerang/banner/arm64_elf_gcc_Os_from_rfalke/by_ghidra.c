...

{
  ...
  iVar7 = 0;
  pvVar2 = malloc(0xc);
  *(undefined8 *)((longlong)pvVar2 + 8) = 0x1011e0;
  do {
    lVar4 = 0;
    pcVar5 = line + 7;
    do {
      uVar1 = (uint)(byte)"HelloWorld"[lVar4] - 0x20;
      if ((int)uVar1 < 0) {
        uVar1 = 0;
      }
...
// WARNING: Removing unreachable block (ram,0x00101078)
// WARNING: Removing unreachable block (ram,0x00101084)
