...

{
  ...
  do {
    ...
    do {
      ...
      lVar6 = lVar6 + 1;
      uVar3 = 0;
      if (-1 < (int)((uint)*pbVar1 - 0x20)) {
        uVar3 = (uint)*pbVar1 - 0x20;
      }
      uVar4 = uVar3 + 7;
      if (-1 < (int)uVar3) {
        uVar4 = uVar3;
      ...
      *(undefined *)((longlong)puVar7 + 6) = *(undefined *)((longlong)puVar2 + 6);
      *(undefined2 *)(puVar7 + 1) = *(undefined2 *)(puVar2 + 1);
      uVar5 = *puVar2;
      *(undefined *)((longlong)puVar7 + 7) = 0x20;
      *puVar7 = uVar5;
      lVar8 = 0x4f;
      puVar7 = puVar7 + 2;
    } while (lVar6 < 10);
    do {
      if (*(char *)((longlong)&uStack144 + lVar8) != ' ') break;
      *(undefined *)((longlong)&uStack144 + lVar8) = 0;
      lVar6 = lVar8 + 1;
      lVar8 = lVar8 + -1;
    } while (1 < lVar6);
    puts((char *)&uStack144);
