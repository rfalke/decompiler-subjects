...

{
  ...
  puVar1 = (undefined *)FUN_00021fc0(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...

{
  ...
  while( true ) {
    ...
    for (local_1c = 0; local_1c < 7; local_1c = local_1c + 1) {
      for (local_20 = 0; local_20 < (int)local_28; local_20 = local_20 + 1) {
        local_2c = (*local_18)[local_20] + -0x20;
        if ((*local_18)[local_20] + -0x20 < 0) {
          local_2c = 0;
        }
