...

{
  ...
  do {
    ...
    do {
      ...
      lVar7 = lVar7 + 1;
      uVar4 = 0;
      if (-1 < (int)((uint)*pbVar2 - 0x20)) {
        uVar4 = (uint)*pbVar2 - 0x20;
      }
      uVar5 = uVar4 + 7;
      if (-1 < (int)uVar4) {
        uVar5 = uVar4;
      ...
      *(undefined *)((longlong)puVar8 + 6) = *(undefined *)((longlong)puVar3 + 6);
      *(undefined2 *)(puVar8 + 1) = *(undefined2 *)(puVar3 + 1);
      uVar6 = *puVar3;
      *(undefined *)((longlong)puVar8 + 7) = 0x20;
      *puVar8 = uVar6;
      puVar8 = puVar8 + 2;
      lVar9 = 0x4f;
    } while (lVar7 < 10);
    do {
      if (*(char *)((longlong)&uStack144 + lVar9) != ' ') break;
      *(undefined *)((longlong)&uStack144 + lVar9) = 0;
      bVar1 = 0 < lVar9;
      lVar9 = lVar9 + -1;
    } while (bVar1);
    puts((char *)&uStack144);
