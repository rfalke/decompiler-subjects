...
byte g_b411035 = 0x00; // 0000000000411035
// subject_data.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
Eq_141 g_t411030 = // 0000000000411030
	{
		0x02
	};
Eq_160 g_t411031 = // 0000000000411031
	{
		0x04
	};
byte g_b411032 = 0x06; // 0000000000411032
byte g_b411033 = 0x08; // 0000000000411033
byte g_b411034 = 0x0A; // 0000000000411034
// subject_fini.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
// 00000000004005E0: void mid(Register (ptr64 Eq_101) x0)
void mid(struct Eq_101 * x0)
{
	x0_11 = (uint64) printf("Middle elment is %d\n", (word32) x0->b0002);
}

// 00000000004005F0: void fst(Register (ptr64 Eq_114) x0)
void fst(struct Eq_114 * x0)
{
	x0_11 = (uint64) printf("First element is %d\n", (word32) x0->b000A);
}

// 0000000000400600: void main()
void main()
{
	x0_23 = (uint64) printf("Middle elment is %d\n", (word32) g_b411032);
	x0_30 = (uint64) printf("First element is %d\n", (word32) g_t411030);
	x0_49 = CONVERT(printf("Sum is %d\n", CONVERT(Mem14[0x0000000000411034<p64>:byte], byte, word32) + (CONVERT(Mem14[0x0000000000411033<p64>:byte], byte, word32) + (CONVERT(Mem14[0x0000000000411032<p64>:byte], byte, word32) + (Mem14[0x0000000000411031<p64>:byte] + Mem14[0x0000000000411030<p64>:byte])))), int32, uint64);
}

// 0000000000400678: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
...
// 00000000004006F0: void __libc_csu_fini()
