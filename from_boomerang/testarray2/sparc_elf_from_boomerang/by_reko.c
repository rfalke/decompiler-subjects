...
// 000104FC: void _start(Register word32 g1, Register word32 o7, Stack word32 dwArg40)
...
{
	struct Eq_39 * l7_114 = fn00010570(o7, 66392);
...
{
	struct Eq_39 * l7_22 = fn00010570(o7, 66200);
...
void main()
{
	...
	{
		byte * o1_52 = fp->ptrFFFFFFE4;
		fp->dwFFFFFFE8 = fp->dwFFFFFFE8 + (((word32) (*o1_52) << 0x18) >> 0x18);
		fp->ptrFFFFFFE4 = o1_52 + 0x01;
...
{
	word32 * l0_30;
	struct Eq_215 * l7_22 = fn00010800(o7, 0x000100C8);
	struct Eq_220 * o1_25 = l7_22->ptr0018;
...
// 00020904: void _PROCEDURE_LINKAGE_TABLE_()
...
// 00020958: void fn00020958()
void fn00020958()
{
	_PROCEDURE_LINKAGE_TABLE_();
}

// 00020964: void fn00020964()
void fn00020964()
{
	_PROCEDURE_LINKAGE_TABLE_();
}

// 00020970: void fn00020970()
void fn00020970()
{
	_PROCEDURE_LINKAGE_TABLE_();
}
