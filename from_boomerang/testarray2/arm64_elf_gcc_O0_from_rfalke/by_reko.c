...
byte g_b11038 = 0x02; // 0000000000011038
// subject_fini.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
// 000000000000086C: Register word64 fst()
// Called from:
//      main
word64 fst()
{
...
{
	mid();
	struct Eq_106 * x29_27 = fst();
	x29_27->ptr0010 = &g_b11038;
	x29_27->dw001C = 0x00;
	while (x29_27->dw001C <= 0x04)
	{
		byte * x0_38 = x29_27->ptr0010;
		x29_27->ptr0010 = x0_38 + 1;
		x29_27->dw0018 += (word32) *x0_38;
		++x29_27->dw001C;
	}
	fn00000000000006E0();
}
