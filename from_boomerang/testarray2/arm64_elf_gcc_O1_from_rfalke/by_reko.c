...
Eq_158 g_t11038 = // 0000000000011038
	{
		0x02
	};
Eq_160 g_t11039 = // 0000000000011039
	{
		0x04
	};
...
{
	x0_16 = (uint64) printf("Middle elment is %d\n", (word32) x0->b0002);
}

// 0000000000000858: void fst(Register (ptr64 Eq_124) x0)
// Called from:
//      main
void fst(struct Eq_124 * x0)
{
	x0_16 = (uint64) printf("First element is %d\n", (word32) x0->b000A);
}
