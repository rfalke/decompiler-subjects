...
void mid()
{
	x0_18 = (uint64) printf("Middle elment is %d\n", 0x00);
}
...
word64 fst()
{
	x0_18 = (uint64) printf("First element is %d\n", 0x00);
	return x30;
}
...
{
	mid();
	struct Eq_117 * x29_27 = fst();
	struct Eq_121 * sp_24 = (struct Eq_121 *) <invalid>;
	sp_24->ptr0008 = &g_b411030;
	x29_27->dwFFFFFFF8 = 0x00;
	while (x29_27->dwFFFFFFF8 < 0x05)
	{
		byte * x8_54 = sp_24->ptr0008;
		sp_24->ptr0008 = x8_54 + 1;
