...
// 0000000000400614: Register word64 fst()
// Called from:
//      main
word64 fst()
{
...
{
	mid();
	struct Eq_95 * x29_31 = fst();
	struct Eq_99 * sp_26 = (struct Eq_99 *) <invalid>;
	sp_26->ptr0008 = &g_b411030;
	x29_31->dwFFFFFFF8 = 0x00;
	while (x29_31->dwFFFFFFF8 < 0x05)
	{
		byte * x8_58 = sp_26->ptr0008;
		sp_26->ptr0008 = x8_58 + 1;
		x29_31->dwFFFFFFF4 += (word32) *x8_58;
		++x29_31->dwFFFFFFF8;
	}
	fn0000000000400480();
	sp_26->dw0004 = (word32) 0x004007AA;
}
