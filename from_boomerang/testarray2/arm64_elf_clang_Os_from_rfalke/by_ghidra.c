...

{
  ...
  uVar2 = 0;
  do {
    pbVar1 = (byte *)(gca + lVar3);
    lVar3 = lVar3 + 1;
    uVar2 = (ulong)((uint)*pbVar1 + (int)uVar2);
  } while (lVar3 != 5);
  printf("Sum is %d\n",uVar2);
  return 0;
}
...
void FUN_0040066c(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x0040066c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x40066c);
