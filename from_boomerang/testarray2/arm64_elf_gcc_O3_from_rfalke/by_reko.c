...
Eq_25 g_t11040 = // 0000000000011040
	{
		0x02
	};
Eq_46 g_t11041 = // 0000000000011041
	{
		0x04
	};
...
void main()
{
	...
	x0_49 = CONVERT(printf("Sum is %d\n", CONVERT(Mem16[0x0000000000011044<p64>:byte], byte, word32) + (CONVERT(Mem16[0x0000000000011043<p64>:byte], byte, word32) + (CONVERT(Mem16[0x0000000000011042<p64>:byte], byte, word32) + (Mem16[0x0000000000011040<p64>:byte] + Mem16[0x0000000000011041<p64>:byte])))), int32, uint64);
}
...
// 000000000000079C: void call_weak_fn()
// Called from:
//      _init
void call_weak_fn()
{
...
// 00000000000007B0: void deregister_tm_clones()
// Called from:
...
// 00000000000007E8: void register_tm_clones()
// Called from:
//      frame_dummy
