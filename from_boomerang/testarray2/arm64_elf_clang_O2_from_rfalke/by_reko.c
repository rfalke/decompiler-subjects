...
Eq_124 g_t411030 = // 0000000000411030
	{
		0x02
	};
Eq_140 g_t411031 = // 0000000000411031
	{
		0x04
	};
...
{
	Eq_48 x1_7 = 0x00411038 - 0x00411038;
...
// 00000000004005E0: void mid(Register (ptr64 Eq_92) x0)
void mid(struct Eq_92 * x0)
{
	printf("Middle elment is %d\n", (word32) x0->b0002);
}

// 00000000004005F0: void fst(Register (ptr64 Eq_103) x0)
void fst(struct Eq_103 * x0)
{
...
void main()
{
	printf("Middle elment is %d\n", (word32) g_b411032);
	printf("First element is %d\n", (word32) g_t411030.u0);
	printf("Sum is %d\n", (word32) g_b411034 + ((word32) g_b411033 + ((byte) (g_t411031.u0 + g_t411030.u0) + (word32) g_b411032)));
}

// 0000000000400678: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
