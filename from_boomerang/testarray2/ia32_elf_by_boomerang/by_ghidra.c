...
// WARNING: Removing unreachable block (ram,0x08048354)
...

{
  ...
  for (local_8 = 0; local_8 < 5; local_8 = local_8 + 1) {
    local_c = local_c + *(char *)local_10;
    local_10 = (undefined5 *)((int)local_10 + 1);
  }
  printf("Sum is %d\n",local_c);
  return 0;
}
...
// WARNING: Removing unreachable block (ram,0x0804846c)
