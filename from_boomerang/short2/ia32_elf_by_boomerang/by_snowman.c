...
int32_t call_gmon_start(int32_t ecx) {
    ...
    if (*reinterpret_cast<int32_t*>(ecx + 0x12ee - 4)) {
        fun_80482c8();
    }
    return ebx2;
}
...
/* p.4576 */
int32_t* p_4576 = reinterpret_cast<int32_t*>(0x8049520);
...
void fun_8048306(int32_t a1, int32_t a2) {
    ...
    if (*reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(__return_address()) + 0x12ee - 4)) {
        fun_80482c8();
    }
    goto ebp3->f4;
}
...
void fun_8048496(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    struct s1* ebp5;
...
int32_t test(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    if (a1 >= a2 || a2 >= a3) {
        return 0;
    } else {
        return 1;
...
void _fini() {
    ...
    fun_8048496(eax1, ebx2, ebp3, __return_address());
}
...
int32_t main() {
    ...
    eax5 = test(4, 5, 6, v1, v2, v3, v4);
    fun_80482b8("Result for 4, 5, 6: %d\n", eax5, 5, 6);
    eax6 = test(6, 5, 4, "Result for 4, 5, 6: %d\n", eax5, 5, 6);
    fun_80482b8("Result for 6, 5, 4: %d\n", eax6, 5, 6);
    eax7 = test(4, 6, 5, "Result for 6, 5, 4: %d\n", eax6, 5, 6);
    fun_80482b8("Result for 4, 6, 5: %d\n", eax7, 5, 6);
    eax8 = test(6, 4, 5, "Result for 4, 6, 5: %d\n", eax7, 5, 6);
