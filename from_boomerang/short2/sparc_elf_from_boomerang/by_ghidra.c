...

{
  ...
  FUN_000208c0(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_000208cc(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
bool test(int param_1,int param_2,int param_3)

{
  return param_1 < param_2 && param_2 < param_3;
}
...
// WARNING: Inlined function: FUN_00010740
...
// WARNING: Removing unreachable block (ram,0x000107a0)
...
{
  IllegalInstructionTrap(0x208d8);
  return (int)__format;
}
