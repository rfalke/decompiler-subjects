...

{
  ...
  uVar1 = FUN_000208cc(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
...
uint test(int param_1,int param_2,int param_3)

{
  return (uint)(param_1 < param_2 && param_2 < param_3);
}
