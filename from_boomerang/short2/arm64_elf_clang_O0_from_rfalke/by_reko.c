...
// 000000000040062C: void main()
void main()
{
	test(0x04, 0x05, 0x06);
	x0_27 = (uint64) printf("Result for 4, 5, 6: %d\n", 0x00);
	test(0x06, 0x05, 0x04);
	x0_49 = (uint64) printf("Result for 6, 5, 4: %d\n", 0x00);
	test(0x04, 0x06, 0x05);
	x0_69 = (uint64) printf("Result for 4, 6, 5: %d\n", 0x00);
	test(0x06, 0x04, 0x05);
	x0_89 = (uint64) printf("Result for 6, 4, 5: %d\n", 0x00);
}
