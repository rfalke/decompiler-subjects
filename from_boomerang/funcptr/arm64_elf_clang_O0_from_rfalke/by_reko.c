...
// 00000000004005E0: void hello()
void hello()
{
	fn0000000000400480();
}

// 0000000000400608: void world()
void world()
{
	fn0000000000400480();
}

// 0000000000400630: void main(Register word32 w29, Register word64 x30)
void main(word32 w29, word64 x30)
{
	<anonymous> ** sp_16;
	word64 x29_17;
	word64 x30_18;
	g_t4005E0();
	*sp_16 = (<anonymous> **) &g_t400608;
	<anonymous> * x8_25 = *sp_16;
	x8_25();
}
