// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/funcptr/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (8048230 (ptr code) ptr8048230) (8048358 (ptr code) ptr8048358) (80483AC (ptr code) ptr80483AC))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x08048230 : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x080483AC : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr8048358, dwArg00, fp + 0x00000004, &globals->ptr8048230, &globals->ptr80483AC, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr8048230;	// 8048230
	code * ptr8048358;	// 8048358
	code * ptr80483AC;	// 80483AC
} Eq_1;
