...
void call_gmon_start() {
    ...
    fun_80482a6();
    eax1 = *reinterpret_cast<int32_t*>(eax2 + 0x1226 + 20);
    if (eax1) {
        eax1();
    }
    return;
...
int32_t __do_global_ctors_aux() {
    ...
    v1 = edx2;
    eax3 = __CTOR_LIST__;
    ebx4 = reinterpret_cast<int32_t*>(0x80494b8);
    if (eax3 != -1) {
        do {
            --ebx4;
            eax3();
...
void fun_80482a6() {
    ...
    eax1 = *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(__return_address()) + 0x1226 + 20);
    if (eax1) {
        eax1();
    }
    goto ebp2->f4;
...
void fun_80483b6(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    struct s1* ebp5;
...
/* p.0 */
int32_t* p_0 = reinterpret_cast<int32_t*>(0x80494c4);
...
void _fini() {
    ...
    fun_80483b6(edx1, ebx2, ebp3, __return_address());
}
