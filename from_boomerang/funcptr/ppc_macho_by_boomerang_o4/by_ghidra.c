...
{
                    // WARNING: Could not recover jumptable at 0x00001b50. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
  (*(code *)PTR__hello_00002024)();
  (*(code *)PTR__world_00002020)();
  return 0;
}
...

{
  ...
  iVar1 = __picsymbol_stub::_printf("Hello, ");
  return iVar1;
}
...

{
  ...
  iVar1 = __picsymbol_stub::_puts("world!");
  return iVar1;
}
