...

{
  ...
  FUN_00020860(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_0002086c(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
undefined4 hello(undefined4 param_1)
...
undefined4 world(undefined4 param_1)
...
// WARNING: Inlined function: FUN_00010728
...
{
  IllegalInstructionTrap(0x20830);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x2083c);
  return;
}
...
{
  IllegalInstructionTrap(0x20848);
  return;
}



void FUN_00020854(void)
