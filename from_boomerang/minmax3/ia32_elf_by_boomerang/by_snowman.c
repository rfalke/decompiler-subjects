...
void call_gmon_start() {
    ...
    fun_80482a6();
    eax1 = *reinterpret_cast<int32_t*>(eax2 + 0x12ce + 20);
    if (eax1) {
        eax1();
    }
    return;
...
void fun_80482a6() {
    ...
    eax1 = *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(__return_address()) + 0x12ce + 20);
    if (eax1) {
        eax1();
    }
    goto ebp2->f4;
...
void printf(int32_t a1, uint32_t a2) {
    goto printf;
}
...
void test(uint32_t a1) {
    int32_t eax2;
    uint32_t edx3;
    uint32_t ebx4;

    eax2 = reinterpret_cast<int32_t>(a1) >> 31;
    edx3 = -2 - (0xfffffffe - a1 & 0xffffffff - (eax2 + reinterpret_cast<uint1_t>(0xffffffff < eax2 + reinterpret_cast<uint1_t>(0xfffffffe < a1))));
    ebx4 = reinterpret_cast<uint32_t>(reinterpret_cast<int32_t>(edx3) >> 31);
    printf("MinMax result %d\n", (edx3 - 3 & ebx4 - reinterpret_cast<uint1_t>(ebx4 < static_cast<uint32_t>(reinterpret_cast<uint1_t>(edx3 < 3)))) + 3);
    return;
}
