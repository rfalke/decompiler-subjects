...
??? _start(???)
{
  ...
  (void) STORE(local + 20, 134513572);
  (void) STORE(local + 24, 134513644);
...
{
  (void) F_080482ed();
  reg_result = LOAD(InitValue(initial_value_of_ebx) + 4723);
  if(reg_result  !=  0) {
    reg_result = intern_redirectCall(reg_result);
  }
  return reg_result;
