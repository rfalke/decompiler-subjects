...
void main(int32 w0)
{
	...
	{
		word32 w0_118;
		if (x0_25 - 0x0000000000000828<p64> == 0x00 && (x0_35 - 0x0838 == 0x00 && (x0_45 - 0x0848 == 0x00 && x0_55 - 0x0858 == 0x00)))
			w0_118 = 0x01;
		else
			w0_118 = 0x00;
		dwArg04_182 = w0_118;
	...
	{
		word32 w0_88;
		if (x0_25 - 0x0830 == 0x00 && (x0_35 - 0x0000000000000840<p64> == 0x00 && (x0_45 - 0x0000000000000850<p64> == 0x00 && x0_55 - 0x0000000000000860<p64> == 0x00)))
			w0_88 = 0x01;
		else
			w0_88 = 0x00;
		dwArg04_182 = w0_88;
