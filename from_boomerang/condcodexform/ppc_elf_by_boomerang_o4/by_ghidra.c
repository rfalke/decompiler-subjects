...
// WARNING: Removing unreachable block (ram,0x100003e4)
...

{
  ...
  if (bVar1) {
    ...
    pcVar5 = func4;
    pcVar4 = func6;
    if (!bVar1) goto LAB_100004d4;
LAB_10000478:
    pcVar3 = func8;
    if (!bVar1) goto LAB_100004e0;
LAB_10000484:
    bVar1 = false;
    if (pcVar2 != func2) {
      bVar6 = 2;
    ...
    pcVar5 = func3;
    pcVar4 = func5;
    if (bVar1) goto LAB_10000478;
LAB_100004d4:
    pcVar3 = func7;
    if (bVar1) goto LAB_10000484;
LAB_100004e0:
    bVar1 = false;
    bVar6 = 2;
    if (pcVar2 != func1) goto LAB_1000049c;
    if ((pcVar5 == func3) && (pcVar5 = func7, pcVar4 == func5)) {
LAB_10000584:
      bVar1 = false;
      if (pcVar3 == pcVar5) {
        bVar1 = true;
...
// WARNING: Removing unreachable block (ram,0x10000600)
// WARNING: Removing unreachable block (ram,0x100005fc)
...
// WARNING: Removing unreachable block (ram,0x10000690)
// WARNING: Removing unreachable block (ram,0x10000694)
