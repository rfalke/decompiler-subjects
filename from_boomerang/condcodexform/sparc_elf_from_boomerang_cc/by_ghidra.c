...
// WARNING: Removing unreachable block (ram,0x000109e8)
...

{
  ...
  _init(ctx);
  __status = main(local_res40,auStackX_44,puVar1,0x20c00);
...
// WARNING: Removing unreachable block (ram,0x00010c5c)
...

{
  ...
  iVar1 = FUN_00010c90(ctx);
  IllegalInstructionTrap(0x101a0);
  return iVar1;
}



void FUN_00010c90(void)
...
{
  FUN_00010cc8();
  IllegalInstructionTrap(0x10168);
  return;
}



void FUN_00010cc8(void)
...
{
  IllegalInstructionTrap(0x20d40);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x20d4c);
  return;
}
...
{
  IllegalInstructionTrap(0x20d58);
  return;
}
...
{
  IllegalInstructionTrap(0x20d64);
  return (int)__format;
}
