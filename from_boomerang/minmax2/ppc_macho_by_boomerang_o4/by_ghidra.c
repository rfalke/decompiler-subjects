...
{
                    // WARNING: Could not recover jumptable at 0x00001b24. Too many branches
                    // WARNING: Treating indirect jump as call
...
undefined8 _main(undefined8 param_1)
...

{
  ...
  iVar1 = __picsymbol_stub::_printf("MinMax result %d\n",param_1);
  return iVar1;
}
