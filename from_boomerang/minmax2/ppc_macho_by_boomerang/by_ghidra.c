...
{
                    // WARNING: Could not recover jumptable at 0x00001b18. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  if ((int)param_1 < -2) {
    uStack00000018 = 0xfffffffe;
  }
  uVar1 = (ulonglong)uStack00000018;
  if (3 < (int)uStack00000018) {
    uVar1 = 3;
    uStack00000018 = 3;
  }
  __picsymbol_stub::_printf("MinMax result %d\n",(ulonglong)uStack00000018);
  return uVar1;
}
...

{
  ...
  uStack00000018 = param_1;
  _test(0xfffffffffffffffb);
  _test(0xfffffffffffffffe);
  _test(0);
  _test(uStack00000018);
  _test(5);
  return 0;
}
