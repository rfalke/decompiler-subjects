// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/minmax2/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (804835D (ptr code) ptr804835D) (80483B8 (ptr code) ptr80483B8) (80483E8 (ptr code) ptr80483E8))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x080483B8 : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x080483E8 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr804835D, dwArg00, fp + 0x00000004, &globals->ptr80483B8, &globals->ptr80483E8, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	...
	code * ptr80483B8;	// 80483B8
	code * ptr80483E8;	// 80483E8
} Eq_1;
