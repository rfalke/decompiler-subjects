...
// 00000000004005E0: void test(Register int32 w0)
void test(int32 w0)
{
	int32 w8_8 = w0 < 0x02 ? ~0x01 : w0;
	x0_17 = (uint64) printf("MinMax result %d\n", w8_8 > 0x03 ? 0x03 : w8_8);
}

// 0000000000400604: void main(Register int32 w0)
void main(int32 w0)
{
	x0_30 = (uint64) printf("MinMax result %d\n", ~0x01);
	x0_35 = (uint64) printf("MinMax result %d\n", ~0x01);
	int32 w8_45 = w0 < 0x02 ? ~0x01 : w0;
	x0_40 = (uint64) printf("MinMax result %d\n", 0x00);
	x0_52 = (uint64) printf("MinMax result %d\n", w8_45 > 0x03 ? 0x03 : w8_45);
	x0_59 = (uint64) printf("MinMax result %d\n", 0x03);
}

// 0000000000400688: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
