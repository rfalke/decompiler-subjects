...

{
  ...
  iVar1 = FUN_000106b4(ctx);
  IllegalInstructionTrap(0x101e8);
  return iVar1;
}



void FUN_000106b4(void)
...
{
  FUN_00010704();
  IllegalInstructionTrap(0x10198);
  return;
}
...
{
  IllegalInstructionTrap(0x20794);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x207a0);
  return;
}
...
{
  IllegalInstructionTrap(0x207ac);
  return;
}
