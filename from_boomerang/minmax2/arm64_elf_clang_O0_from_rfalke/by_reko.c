...
{
	ptr64 fp;
	struct Eq_93 * sp_18 = SEQ(SLICE(fp - 0x20, word32, 32), w0 + 0x02);
	if (w0 < ~0x01)
		sp_18->dw0008 = ~0x01;
	if (sp_18->dw0008 > 0x03)
		sp_18->dw0008 = 0x03;
	sp_18->dw0004 = printf("MinMax result %d\n", sp_18->dw0008);
}

// 0000000000400640: void main(Register int32 w0)
void main(int32 w0)
{
	test(~0x04);
	test(~0x01);
...
// 00000000004006B8: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
