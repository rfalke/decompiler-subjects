...
int32 test(int32 w0, ptr64 & x29Out)
{
	...
	struct Eq_90 * sp_19 = SEQ(SLICE(fp - 0x18, word32, 32), w0 + 0x02);
	if (w0 < 0x02)
		sp_19->dw0008 = ~0x01;
	if (sp_19->dw0008 > 0x03)
		sp_19->dw0008 = 0x03;
	fn0000000000400480();
	sp_19->dw0004 = (word32) 0x00400748;
	x29Out = x30;
	return dwLoc0C_52;
}
...
void main()
{
	struct Eq_122 * x29_22;
	x29_22->dwFFFFFFF4 = (word32) (uint64) test(~0x04, out x29_22);
	struct Eq_133 * sp_32 = (struct Eq_133 *) <invalid>;
	word64 x29_108;
	sp_32->dw0010 = (word32) (uint64) test(~0x01, out x29_108);
	struct Eq_145 * x29_54;
	word32 w0_61 = (word32) (uint64) test(0x00, out x29_54);
	struct Eq_133 * sp_48 = (struct Eq_133 *) <invalid>;
	int32 w8_60 = x29_54->dwFFFFFFF8;
	sp_48->dw000C = w0_61;
	struct Eq_133 * sp_64 = (struct Eq_133 *) <invalid>;
	word64 x29_109;
	sp_64->dw0008 = (word32) (uint64) test(w8_60, out x29_109);
	struct Eq_133 * sp_80 = (struct Eq_133 *) <invalid>;
	word64 x29_110;
	sp_80->dw0004 = (word32) (uint64) test(0x05, out x29_110);
}
