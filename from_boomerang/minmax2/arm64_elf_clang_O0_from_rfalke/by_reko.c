...
// 00000000004005E0: Register word64 test(Register int32 w0, Register out ptr64 x29Out)
// Called from:
//      main
word64 test(int32 w0, ptr64 & x29Out)
{
	word32 dwLoc0C_52 = SLICE(x29, word32, 32);
	struct Eq_91 * sp_19 = SEQ(SLICE(fp - 0x18, word32, 32), w0 + 0x02);
	if (w0 < 0x02)
		sp_19->dw0008 = ~0x01;
	...
	x29Out = x30;
	return SEQ(SLICE(0x00400748, word32, 32), dwLoc0C_52);
}

// 0000000000400640: void main()
void main()
{
	struct Eq_126 * x29_22;
	x29_22->dwFFFFFFF4 = (word32) test(~0x04, out x29_22);
	struct Eq_136 * sp_32 = (struct Eq_136 *) <invalid>;
	word64 x29_108;
	sp_32->dw0010 = (word32) test(~0x01, out x29_108);
	struct Eq_147 * x29_54;
	word32 w0_61 = (word32) test(0x00, out x29_54);
	struct Eq_136 * sp_48 = (struct Eq_136 *) <invalid>;
	int32 w8_60 = x29_54->dwFFFFFFF8;
	sp_48->dw000C = w0_61;
	struct Eq_136 * sp_64 = (struct Eq_136 *) <invalid>;
	word64 x29_109;
