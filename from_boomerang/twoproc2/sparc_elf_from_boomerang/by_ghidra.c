...

{
  ...
  FUN_0002084c(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_00020858(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}



// WARNING: Removing unreachable block (ram,0x00010690)
...
int proc1(int param_1,int param_2)
...
// WARNING: Inlined function: FUN_00010720
...
{
  IllegalInstructionTrap(0x2081c);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x20828);
  return;
}
...
{
  IllegalInstructionTrap(0x20834);
  return;
}



void FUN_00020840(void)
...
{
  IllegalInstructionTrap(0x20864);
  return (int)__format;
}
