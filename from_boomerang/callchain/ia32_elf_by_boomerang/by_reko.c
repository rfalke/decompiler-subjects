...
ptr32 extract_cie_info(struct Eq_486 * dwArg04, struct Eq_487 * dwArg08)
{
	...
	struct Eq_582 * eax_110 = eax_86 - 0x01 + ~ecx_101;
...
// 08048E38: Register (ptr32 byte) execute_cfa_insn(Stack (ptr32 byte) dwArg04, Stack Eq_684 dwArg08, Stack (ptr32 Eq_685) dwArg0C, Stack (ptr32 word32) dwArg10, Register out (ptr32 Eq_687) ebpOut, Register out (ptr32 Eq_685) ediOut)
// Called from:
//      __frame_state_for
...
{
	struct Eq_828 * ecx_14 = &g_ptr804AAC4;
