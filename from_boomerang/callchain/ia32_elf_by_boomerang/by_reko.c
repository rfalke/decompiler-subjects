...
// 080489E4: Register (ptr32 byte) decode_uleb128(Stack (ptr32 byte) dwArg04, Stack (ptr32 ui32) dwArg08)
...
// 08048A20: Register (ptr32 byte) decode_sleb128(Stack (ptr32 byte) dwArg04, Stack (ptr32 uint32) dwArg08)
...
// 08048A7C: void fde_insert(Stack (ptr32 Eq_188) dwArg04, Stack ui32 dwArg08, Stack (ptr32 Eq_190) dwArg0C)
void fde_insert(Eq_188 * dwArg04, ui32 dwArg08, Eq_190 * dwArg0C)
{
	*((char *) dwArg04 + dwArg08 * 0x04) = (union Eq_188 *) dwArg0C;
	ui32 edx_14 = dwArg08;
	if (dwArg08 != 0x00)
	{
		...
		do
		{
			struct Eq_201 * esi_53 = (dwArg04 - 0x04)[edx_14];
			struct Eq_205 * edi_50 = *ecx_45;
...
// 08048AD4: Register word32 count_fdes(Stack (ptr32 Eq_190) dwArg04)
word32 count_fdes(Eq_190 * dwArg04)
{
	struct Eq_190 * edx_25 = dwArg04;
	word32 ecx_13 = 0x00;
	if (dwArg04->dw0000 != 0x00)
	{
		do
		{
			if (edx_25[0x01] != 0x00 && edx_25[0x02] != 0x00)
				++ecx_13;
			struct Eq_244 * eax_32 = edx_25 + edx_25->dw0000 / 0x04;
			edx_25 = (struct Eq_190 *) &eax_32->dw0004;
		} while (eax_32->dw0004 != 0x00);
	}
	return ecx_13;
}

// 08048B04: void add_fdes(Stack (ptr32 Eq_190) dwArg04, Stack (ptr32 Eq_188) dwArg08, Stack (ptr32 ui32) dwArg0C, Stack (ptr32 up32) dwArg10, Stack (ptr32 up32) dwArg14)
void add_fdes(Eq_190 * dwArg04, Eq_188 * dwArg08, ui32 * dwArg0C, up32 * dwArg10, up32 * dwArg14)
{
	struct Eq_190 * esi_19 = dwArg04;
	...
	if (dwArg04->dw0000 != 0x00)
	{
		do
		{
			...
			struct Eq_300 * eax_95 = esi_19 + esi_19->dw0000 / 0x04;
			esi_19 = (struct Eq_190 *) &eax_95->dw0004;
...
// 08048B94: void frame_init(Stack (ptr32 Eq_338) dwArg04)
void frame_init(Eq_338 * dwArg04)
{
	uint32 dwLoc10_114;
	union Eq_188 * eax_21 = dwArg04->ptr000C;
	if (eax_21 != null)
	{
		union Eq_188 * esi_113 = eax_21;
		dwLoc10_114 = 0x00;
		if (*eax_21 != 0x00)
		{
			do
			{
				...
				esi_113 = (union Eq_188 *) ((char *) esi_113 + 0x04);
			} while (*esi_113 != 0x00);
		}
	}
	else
	...
	union Eq_188 * eax_34 = malloc(dwLoc10_114 << 0x02);
	union Eq_188 * eax_42 = dwArg04->ptr000C;
	if (eax_42 != null)
	{
		union Eq_188 * esi_69 = eax_42;
		if (*eax_42 != 0x00)
		{
			do
			{
				add_fdes(*esi_69, eax_34, fp - 0x10, fp - 0x0C, fp - 0x08);
				esi_69 = (union Eq_188 *) ((char *) esi_69 + 0x04);
			} while (*esi_69 != 0x00);
		}
	}
	else
...
// 08048C80: Register (ptr32 Eq_436) find_fde(Stack (ptr32 ui32) dwArg04)
Eq_436 * find_fde(ui32 * dwArg04)
{
	struct Eq_436 * eax_115;
	struct Eq_338 * esi_118 = globals->ptr804AAC4;
	if (esi_118 != null)
	{
		do
		{
		...
		if (esi_118 != null)
		{
			...
			if (0x00 < ecx_86)
			{
				union Eq_188 * esi_90 = esi_118->ptr000C;
				do
				{
					uint32 eax_95 = dwLoc08_104 + edi_106;
					struct Eq_436 * ecx_98 = *((char *) esi_90 + (eax_95 >> 0x01) * 0x04);
...
// 08048D20: Register ptr32 extract_cie_info(Stack (ptr32 Eq_507) dwArg04, Stack (ptr32 Eq_508) dwArg08)
ptr32 extract_cie_info(Eq_507 * dwArg04, Eq_508 * dwArg08)
{
	struct Eq_509 * edx_23 = dwArg04 - (dwArg04->dw0004 + ~0x03);
	dwArg08->ptr0000 = (byte *) &edx_23->b0009;
	byte al_31 = (byte) 0x080494CA;
	byte * esi_237 = &edx_23->b0009;
	word32 ecx_239 = 0x01;
	byte * edi_238 = &globals->b80494CA;
	...
	struct Eq_612 * eax_102 = eax_84 - 0x01 + ~ecx_193;
	byte * edx_106 = &eax_102->dw0001;
	byte * esi_107 = eax_84;
	byte * edi_109 = &globals->b80494CB;
	word32 ecx_111 = 0x03;
...
// 08048E38: Register (ptr32 byte) execute_cfa_insn(Stack (ptr32 byte) dwArg04, Stack (ptr32 ui32) dwArg08, Stack (ptr32 Eq_721) dwArg0C, Stack (ptr32 word32) dwArg10)
byte * execute_cfa_insn(byte * dwArg04, ui32 * dwArg08, Eq_721 * dwArg0C, word32 * dwArg10)
{
...
// 080491C8: void __register_frame_info(Stack ptr32 dwArg04, Stack (ptr32 Eq_83) dwArg08)
...
// 08049210: void __register_frame_info_table(Stack word32 dwArg04, Stack (ptr32 Eq_848) dwArg08)
void __register_frame_info_table(word32 dwArg04, Eq_848 * dwArg08)
{
...
{
	struct Eq_878 * ecx_13 = &globals->ptr804AAC4;
	if (globals->ptr804AAC4 != 0x00)
	{
		do
		{
			struct Eq_888 * edx_23 = ecx_13->dw0000;
			...
			ecx_13 = (struct Eq_878 *) &edx_23->dw0014;
		} while (edx_23->dw0014 != 0x00);
	}
	abort();
}

// 080492AC: void __frame_state_for(Register word32 ebp, Stack (ptr32 ui32) dwArg04)
void __frame_state_for(word32 ebp, ui32 * dwArg04)
{
	struct Eq_507 * eax_23 = find_fde(dwArg04);
	if (eax_23 != null)
	{
