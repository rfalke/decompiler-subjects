...
void fini_dummy();
void init_dummy();
int __cdecl add5(int);
int __cdecl add10(int);
int __cdecl add15(int);
int __cdecl printarg(int);
...
// nfuncs=47 queued=22 decompiled=22 lumina nreq=0 worse=0 better=0
