...
// 00000000004005E8: Register word32 add10(Register word32 w0)
// Called from:
//      main
...
// 00000000004005F0: Register word32 add15(Register word32 w0)
// Called from:
//      main
...
// 00000000004005F8: void printarg(Sequence word64 x1_32_32_w0)
// Called from:
//      main
void printarg(word64 x1_32_32_w0)
{
	int32 w0 = (word32) x1_32_32_w0;
	x0_10 = (uint64) printf("Fifty five is %d\n", w0);
}

// 000000000040060C: void main(Register word32 x1_32_32)
void main(word32 x1_32_32)
{
	printarg(SEQ(x1_32_32, add5(add10(add15(0x19)))));
}

// 0000000000400638: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
