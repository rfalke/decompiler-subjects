...
// addr = 0804892a.0
// signature= func(F_0804892a, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_0804892a(???)
{
...
// addr = 08048952.0
// signature= func(F_08048952, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08048952(???)
{
  reg_result = InitValue(initial_value_of_eax);
