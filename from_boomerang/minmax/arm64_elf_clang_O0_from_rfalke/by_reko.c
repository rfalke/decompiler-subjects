...
// 00000000004005E0: void main(Register int32 w0, Stack word64 qwArg00)
void main(int32 w0, word64 qwArg00)
{
	struct Eq_141 * sp_17 = DPB(fp - 0x18, w0 + 0x02, 0);
	if (w0 < 0x02)
		sp_17->dw0008 = ~0x01;
	if (sp_17->dw0008 > 0x03)
		sp_17->dw0008 = 0x03;
	fn0000000000400480();
	sp_17->dw0004 = (word32) 0x004006D8;
}
