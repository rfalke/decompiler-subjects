...
// 00000000004005E0: void main(Register int32 w0)
void main(int32 w0)
{
	ptr64 fp;
	struct Eq_93 * sp_19 = SEQ(SLICE(fp - 0x20, word32, 32), w0 + 0x02);
	if (w0 < ~0x01)
		sp_19->dw0008 = ~0x01;
	if (sp_19->dw0008 > 0x03)
		sp_19->dw0008 = 0x03;
	sp_19->dw0004 = printf("MinMax adjusted number of arguments is %d\n", sp_19->dw0008);
}
