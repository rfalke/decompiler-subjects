...
// WARNING: Removing unreachable block (ram,0x000108dc)
...
// WARNING: Removing unreachable block (ram,0x0001094c)
...

{
  ...
  iVar1 = FUN_000109d0(ctx);
  IllegalInstructionTrap(0x101c4);
  return iVar1;
}
...
// WARNING: Removing unreachable block (ram,0x000109f8)
// WARNING: Removing unreachable block (ram,0x000109fc)
...
{
  IllegalInstructionTrap(0x20aa4);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x20ab0);
  return;
}
...
{
  IllegalInstructionTrap(0x20abc);
  return;
}
...
{
  IllegalInstructionTrap(0x20ac8);
  return (int)__format;
}
