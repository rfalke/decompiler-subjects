...
{// addr = 0x00010914
    ...
    _exit();
    L4();
    _t27 =  *((void*)(0x10d00 + __o7 + ("/usr/lib/ld.so.1" | 4)));
...
{// addr = 0x00010B28
    ...
    _t33 = _t72 << 2;
    _t51 =  *((void*)(__r6 - 4056));
    if(_t72 - "/usr/lib/ld.so.1") {
        _t52 = _t33 + _t51;
        while(1) {
            asm("bpos 0x00000018");
            asm("addcc %o1, -1, %o1");
            _t53 =  *((void*)(__r6 - 4056));
            if( *((void*)( *_t52 + 8)) -  *((void*)( *((void*)(_t52 - 4)) + 8))) {
                break;
            }
        }
        _t54 = _t53 + 4294967292;
    }
    _t55 =  *((void*)(__r6 - 4056));
    if( *_t54 - ("/usr/lib/ld.so.1" | _t72)) {
    } else {
        while(1) {
            asm("be,a 0x0000001c");
            asm("bne,a 0x00000008");
            if( *((void*)(_t55 +  *_t55 + 4)) - "/usr/lib/ld.so.1") {
                break;
            }
        }
    }
...
L16:
    _t95 =  *__i3;
    if( *_t98 - "/usr/lib/ld.so.1") {
        goto L18;
        do {
L18:
            asm("be,a 0x00000050");
            if( *((void*)(_t98 + 8)) - "/usr/lib/ld.so.1") {
            } else {
                L6();
                if( !( *((void*)(_t98 + 8)) - _t95)) {
                }
            ...
            goto L22;
L22:
        } while( *((void*)(_t98 +  *_t98 + 4)) - "/usr/lib/ld.so.1");
    }
    goto (__i7 + 8);
    asm("restore %g0, %g0, %g0");
L15:
...
{// addr = 0x00010B74
    ...
    _t57 = __o1;
    _t25 = _t57 << 2;
    _t36 =  *((void*)(__r4 + "/usr/lib/ld.so.1"));
    if(_t57 - "/usr/lib/ld.so.1") {
        _t37 = _t25 + _t36;
        while(1) {
            asm("bpos 0x00000018");
            asm("addcc %o1, -1, %o1");
            _t38 =  *((void*)(__r4 + "/usr/lib/ld.so.1"));
            if( *((void*)( *_t37 + 8)) -  *((void*)( *((void*)(_t37 - 4)) + 8))) {
                break;
            }
        }
        _t39 = _t38 + 4294967292;
    }
    _t40 =  *((void*)(__r4 + "/usr/lib/ld.so.1"));
    if( *_t39 - ("/usr/lib/ld.so.1" | _t57)) {
    } else {
        while(1) {
            asm("be,a 0x0000001c");
            asm("bne,a 0x00000008");
            if( *((void*)(_t40 +  *_t40 + 4)) - "/usr/lib/ld.so.1") {
                break;
            }
        }
    }
...
L10:
    _t69 =  *__i2;
    _t75 =  *__i3;
    if( *_t78 - "/usr/lib/ld.so.1") {
        goto L12;
        do {
L12:
            asm("be,a 0x00000050");
            if( *((void*)(_t78 + 8)) - "/usr/lib/ld.so.1") {
            } else {
                fde_insert(__i1, _t69, __o7, _t78, __i1, __i2, __i3, __i4, __i7);
                if( !( *((void*)(_t78 + 8)) - _t75)) {
                }
                asm("bgu,a 0x00000008");
            }
            goto L16;
L16:
        } while( *((void*)(_t78 +  *_t78 + 4)) - "/usr/lib/ld.so.1");
    }
    goto (__i7 + 8);
    asm("restore %g0, %g0, %g0");
L9:
...
{// addr = 0x00010DBC
    ...
    _t23 = __o3;
    L1();
    _t25 =  *((void*)( *((void*)(0x108cc + __o7 + ("/usr/lib/ld.so.1" | 24)))));
...
)
{
    ...
    _t37 = __i0;
    _t29 = __o3;
    _t31 =  *((void*)( *((void*)((_t34 | 204) + __o7 + ("/usr/lib/ld.so.1" | 24)))));
    if(_t31 - "/usr/lib/ld.so.1") {
        __l1 = _t37;
        if( *_t31 - "/usr/lib/ld.so.1") {
...
{// addr = 0x00011408
    ...
    __i0 = __i0;
    L1();
    _t22 =  *((void*)(( &_START_ | 640) + __o7 + ("/usr/lib/ld.so.1" | 24)));
    if( *_t22 - "/usr/lib/ld.so.1") {
L8:
        abort();
    } else {
...
)
{
    ...
    __i7 = __i7;
    __i0 = __i0;
    _t18 =  *((void*)((__l7 | 640) + __o7 + ("/usr/lib/ld.so.1" | 24)));
...
{// addr = 0x000115B0
    ...
    __i7 = __i7;
    L1();
    _t7 =  *((void*)(( &_START_ | 216) + __o7 + ("/usr/lib/ld.so.1" | 28)));
...
)
{
    ...
    __i7 = __i7;
    if( *((void*)( *((void*)((__l7 | 216) + __o7 + ("/usr/lib/ld.so.1" | 28))) - 4)) - 4294967295) {
        _t12 = 0x1201ffffc;
        while(1) {
