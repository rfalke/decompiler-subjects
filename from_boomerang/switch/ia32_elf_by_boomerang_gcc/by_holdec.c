...
/* The decompilation of 0x08048790 / atexit failed: java.lang.AssertionError: Block L0 calls block L1 which isn't available */

/* The decompilation of 0x080487b0 / exit failed: java.lang.AssertionError: Block L0 calls block L1 which isn't available */

/* The decompilation of 0x080487c0 / printf failed: java.lang.AssertionError: Block L0 calls block L1 which isn't available */

/* The decompilation of 0x080487d0 / malloc failed: java.lang.AssertionError: Block L0 calls block L1 which isn't available */

/* The decompilation of 0x080487e0 / free failed: java.lang.AssertionError: Block L0 calls block L1 which isn't available */

/* The decompilation of 0x080487f0 / abort failed: java.lang.AssertionError: Block L0 calls block L1 which isn't available */

/* The decompilation of 0x08048800 / memset failed: java.lang.AssertionError: Block L0 calls block L1 which isn't available */

// addr = 08048889.0
// signature= func(F_08048889, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08048889(???)
{
  while(1) {
    reg_ab = LOAD(InitStackPointer);
    reg_ac = LOAD(LOAD(InitStackPointer) + 7375);
    if(LOAD(LOAD(LOAD(InitStackPointer) + 7375))  ==  0) {
      break;
    }
    (void) STORE(reg_ab + 7375, reg_ac + 4);
    (void) intern_redirectCall(LOAD(reg_ac));
  }
  (void) STORE(InitStackPointer, reg_ab + 7395);
  reg_result = __deregister_frame_info();
  return reg_result;
}

// addr = 080488c9.0
// signature= func(F_080488c9, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_080488c9(???)
{
...
// addr = 080488e1.0
// signature= func(F_080488e1, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_080488e1(???)
{
  (void) STORE(InitStackPointer, LOAD(InitStackPointer) + 8587);
  reg_result = __register_frame_info();
  return reg_result;
}

// addr = 08048909.0
// signature= func(F_08048909, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08048909(???)
{
  return InitValue(initial_value_of_eax);
}

/* The decompilation of 0x08048918 / F_08048918 failed: java.lang.AssertionError: self=08048918[0,1].0 first=08048918[0,1].0 */

// addr = 08048aba.0
// signature= func(F_08048aba, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08048aba(???)
{
  reg_result = InitValue(initial_value_of_eax);
/* The decompilation of 0x08048aba / F_08048aba failed: java.lang.AssertionError */

// addr = 08048b4a.0
// signature= func(F_08048b4a, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08048b4a(???)
{
...
/* The decompilation of 0x08048c36 / F_08048c36 failed: java.lang.RuntimeException: A non-current expression of a variable is used in block L4 in if(CMP(LOAD(ADD(InitValue(initial_value_of_ebp), 8)), <, LOAD(reg_pp24))) goto L6: The current setter is reg_var13 while [reg_pp24] was found. Related expressions are [reg_var14, reg_var13, reg_var10, reg_pp25, reg_pp24, reg_pp23] */

// addr = 08048cd6.0
// signature= func(F_08048cd6, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08048cd6(???)
{
  ...
  (void) STORE(InitValue(initial_value_of_ebp) + -16, reg_am + 1972);
  ...
  if(reg_var2  ==  0) {
    ...
    (void) STORE(InitValue(initial_value_of_ebp) + -16, reg_am + 1973);
    (void) STORE(InitValue(initial_value_of_ebp) + -8, reg_am + 1973);
    if(!UNDEF) {
...
// addr = 08048dee.0
// signature= func(F_08048dee, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08048dee(???)
{
...
// addr = 08049179.0
// signature= func(F_08049179, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08049179(???)
{
  reg_ab = LOAD(InitStackPointer);
  ...
  (void) STORE(reg_ac, 0);
  reg_result = LOAD(reg_ab + 6411);
  (void) STORE(reg_ac + 20, LOAD(reg_ab + 6411));
  (void) STORE(reg_ab + 6411, reg_ac);
  return reg_result;
}

// addr = 080491c1.0
// signature= func(F_080491c1, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_080491c1(???)
{
  ...
  (void) STORE(reg_ad, 0);
  reg_result = LOAD(reg_ac + 6339);
  (void) STORE(reg_ad + 20, LOAD(reg_ac + 6339));
  (void) STORE(reg_ac + 6339, reg_ad);
  return reg_result;
}

// addr = 08049205.0
// signature= func(F_08049205, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08049205(???)
{
  reg_var1 = LOAD(InitStackPointer) + 6271;
  while(1) {
...
// addr = 08049265.0
// signature= func(F_08049265, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_08049265(???)
{
...
// addr = 080493ca.0
// signature= func(F_080493ca, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_080493ca(???)
{
/* The decompilation of 0x080493ca / F_080493ca failed: java.lang.AssertionError */

// addr = 080493f4.0
// signature= func(init_dummy0, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? init_dummy0(???)
{
  reg_result = F_080493fd();
  return reg_result;
}

// addr = 080493fd.0
// signature= func(F_080493fd, ret=[<0, int(undef, 4),null,reg[eax]>], para=[], varargs=false)
??? F_080493fd(???)
{
  return InitValue(initial_value_of_eax);
}
