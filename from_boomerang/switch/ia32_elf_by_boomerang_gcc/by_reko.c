...
ptr32 extract_cie_info(struct Eq_471 * dwArg04, struct Eq_472 * dwArg08)
{
	...
	struct Eq_576 * eax_110 = eax_86 - 0x01 + ~ecx_101;
...
// 08048DE0: Register (ptr32 byte) execute_cfa_insn(Stack (ptr32 byte) dwArg04, Stack Eq_684 dwArg08, Stack (ptr32 Eq_685) dwArg0C, Stack (ptr32 word32) dwArg10, Register out (ptr32 Eq_687) ebpOut, Register out (ptr32 Eq_685) ediOut)
// Called from:
//      __frame_state_for
byte * execute_cfa_insn(byte * dwArg04, Eq_684 dwArg08, struct Eq_685 * dwArg0C, word32 * dwArg10, struct Eq_687 & ebpOut, struct Eq_685 & ediOut)
{
	...
	else
	{
		if ((al_32 & 0xC0) == 0x00)
		{
			...
			{
				<anonymous> * ecx_44 = 0x0804A490 - g_a8048EA0[eax_23 * 0x04];
				byte * eax_48;
				ecx_44();
				ebpOut = fp - 4;
				ediOut = dwArg0C;
...
{
	struct Eq_828 * ecx_14 = &g_ptr804AA84;
	if (g_ptr804AA84 != null)
	{
		do
		{
			struct Eq_836 * edx_19 = ecx_14->dw0000;
			...
			ecx_14 = (struct Eq_828 *) &edx_19->dw0014;
	...
	if (eax_24 != null)
	{
		...
		if (eax_43 != null)
		{
			...
			if (eax_43 < (ecx_74 + *ecx_74) + 1)
			{
				do
				{
					struct Eq_931 * esp_85 = esp_110 - 4;
					esp_85->ptr0000 = null;
			...
			struct Eq_916 * esi_115 = ebp_113->ptrFFFFFF6C;
			byte * esi_116 = &esi_115->dw0008 + 2;
			if (*ebp_113->ptrFFFFFFEC == 122)
			{
				struct Eq_999 * esp_122 = esp_110 - 4;
			...
			struct Eq_916 * eax_139 = ebp_113->ptrFFFFFF6C;
			...
			if (esi_116 < eax_140 + 0x04)
			{
				...
				{
					struct Eq_1037 * esp_157 = esp_156 - 4;
