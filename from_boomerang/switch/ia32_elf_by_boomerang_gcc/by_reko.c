...
// 08049410: Register word32 _init()
// Called from:
//      _start
word32 _init()
{
...
// 08048810: void _start(Register (ptr32 Eq_2) edx, Stack uint32 dwArg00)
void _start(void (* edx)(), uint32 dwArg00)
{
	if (0x08048780 != 0x00)
		atexit(&g_t8048780);
	if (0x0804A4C0 != 0x00)
		atexit(edx);
	atexit(&g_t8049440);
	g_ptr804AA88 = fp + 0x08 + dwArg00 * 0x04;
	__fpstart();
	exit(main(dwArg00));
}
...
void __do_global_dtors_aux()
{
	...
	__deregister_frame_info(134522220);
}
...
// 080488D8: Register word32 frame_dummy()
// Called from:
//      _init
word32 frame_dummy()
{
	return __register_frame_info(&g_t804A56C, &g_t804AA6C);
}
...
word32 main(uint32 dwArg04)
{
	...
	if (dwArg04 <= 0x07)
	{
		...
		case 0x02:
			...
			break;
		case 0x03:
			dwLoc08_38 = (char *) "Three!\n";
			break;
		case 0x04:
			dwLoc08_38 = (char *) "Four!\n";
			break;
		case 0x05:
			dwLoc08_38 = (char *) "Five!\n";
			break;
		case 0x06:
			dwLoc08_38 = (char *) "Six!\n";
			break;
		case 0x07:
			dwLoc08_38 = (char *) "Seven!\n";
			break;
		}
	}
	else
		dwLoc08_38 = (char *) "Other!\n";
	printf(dwLoc08_38);
	return 0x00;
}
...
// 08048A24: void fde_insert(Stack (ptr32 Eq_61) dwArg04, Stack ui32 dwArg08, Stack (ptr32 Eq_61) dwArg0C)
// Called from:
//      add_fdes
void fde_insert(struct Eq_61 * dwArg04, ui32 dwArg08, struct Eq_61 * dwArg0C)
{
	dwArg04[dwArg08] = (struct Eq_61) dwArg0C;
	ui32 edx_15 = dwArg08;
	if (dwArg08 != 0x00)
	{
		...
		do
		{
			struct Eq_167 * esi_30 = (dwArg04 - 0x04)[edx_15];
			struct Eq_171 * edi_25 = *ecx_22;
...
// 08048A7C: Register word32 count_fdes(Stack (ptr32 Eq_61) dwArg04)
// Called from:
//      frame_init
word32 count_fdes(struct Eq_61 * dwArg04)
{
	struct Eq_61 * edx_12 = dwArg04;
	word32 ecx_18 = 0x00;
	if (dwArg04->t0000 != 0x00)
	{
		do
		{
			...
			edx_12 = (struct Eq_61 *) &eax_24->dw0004;
		} while (eax_24->dw0004 != 0x00);
	}
	return ecx_18;
}

// 08048AAC: void add_fdes(Stack (ptr32 Eq_61) dwArg04, Stack (ptr32 Eq_61) dwArg08, Stack (ptr32 ui32) dwArg0C, Stack (ptr32 up32) dwArg10, Stack (ptr32 up32) dwArg14)
// Called from:
//      frame_init
void add_fdes(struct Eq_61 * dwArg04, struct Eq_61 * dwArg08, ui32 * dwArg0C, up32 * dwArg10, up32 * dwArg14)
{
	struct Eq_61 * esi_20 = dwArg04;
	ui32 edi_22 = *dwArg0C;
	...
	if (dwArg04->t0000 != 0x00)
	{
		do
		{
			...
			esi_20 = (struct Eq_61 *) &eax_72->dw0004;
...
// 08048B3C: void frame_init(Stack (ptr32 Eq_62) dwArg04)
// Called from:
//      find_fde
void frame_init(struct Eq_62 * dwArg04)
{
	uint32 dwLoc10_165;
	struct Eq_61 * eax_21 = dwArg04->ptr000C;
	if (eax_21 != null)
	{
		struct Eq_61 * esi_39 = eax_21;
		dwLoc10_165 = 0x00;
	...
	struct Eq_61 * eax_72 = malloc(dwLoc10_165 << 0x02);
	struct Eq_61 * eax_80 = dwArg04->ptr000C;
	if (eax_80 != null)
	{
		struct Eq_61 * esi_106 = eax_80;
...
// 08048C28: Register (ptr32 Eq_402) find_fde(Stack up32 dwArg04)
// Called from:
//      __frame_state_for
struct Eq_402 * find_fde(up32 dwArg04)
{
	struct Eq_402 * eax_163;
	struct Eq_62 * esi_20 = g_ptr804AA84;
	if (esi_20 != null)
	{
		do
		{
		...
		if (esi_20 != null)
		{
			...
			if (ecx_61 > 0x00)
			{
				struct Eq_61 * esi_67 = esi_20->ptr000C;
				do
				{
					uint32 eax_72 = dwLoc08_119 + edi_59;
					struct Eq_402 * ecx_76 = esi_67[eax_72 >> 0x01];
...
// 08048CC8: Register ptr32 extract_cie_info(Stack (ptr32 Eq_471) dwArg04, Stack (ptr32 Eq_472) dwArg08)
// Called from:
//      __frame_state_for
ptr32 extract_cie_info(struct Eq_471 * dwArg04, struct Eq_472 * dwArg08)
{
	struct Eq_473 * edx_23 = dwArg04 - (dwArg04->dw0004 + ~0x03);
	dwArg08->ptr0000 = &edx_23->b0009;
	byte * esi_24 = &edx_23->b0009;
	word32 ecx_31 = 0x01;
	byte * edi_32 = &g_b804948A;
	bool v19_240 = 0x00 == 0x00;
	while (ecx_31 != 0x00)
	{
	...
	if (!v19_240)
	{
		...
		byte * edi_55 = &g_b804948B;
		word32 ecx_56 = 0x03;
		bool v23_244 = 0x00 == 0x00;
		while (ecx_56 != 0x00)
		{
	...
	struct Eq_567 * eax_110 = eax_86 - 0x01 + ~ecx_101;
	byte * edx_113 = &eax_110->dw0001;
	byte * esi_114 = eax_86;
	byte * edi_121 = &g_b804948B;
	word32 ecx_123 = 0x03;
	bool v27_248 = false;
	while (ecx_123 != 0x00)
	{
...
// 08048DE0: Register (ptr32 byte) execute_cfa_insn(Stack (ptr32 byte) dwArg04, Stack Eq_669 dwArg08, Stack (ptr32 Eq_670) dwArg0C, Stack (ptr32 word32) dwArg10, Register out (ptr32 Eq_672) ebpOut, Register out (ptr32 Eq_670) ediOut)
// Called from:
//      __frame_state_for
byte * execute_cfa_insn(byte * dwArg04, Eq_669 dwArg08, struct Eq_670 * dwArg0C, word32 * dwArg10, struct Eq_672 & ebpOut, struct Eq_670 & ediOut)
{
	...
	else
	{
		if ((al_32 & 0xC0) == 0x00)
		{
			...
			{
				<anonymous> * ecx_42 = 0x0804A490 - g_a8048EA0[eax_23 * 0x04];
				byte * eax_46;
				ecx_42();
				ebpOut = fp - 4;
				ediOut = dwArg0C;
...
// 08049170: Register (ptr32 Eq_62) __register_frame_info(Stack (ptr32 Eq_61) dwArg04, Stack (ptr32 Eq_62) dwArg08)
// Called from:
//      frame_dummy
struct Eq_62 * __register_frame_info(struct Eq_61 * dwArg04, struct Eq_62 * dwArg08)
{
	...
	dwArg08->dw0010 = 0x00;
	dwArg08->ptr0014 = g_ptr804AA84;
	g_ptr804AA84 = dwArg08;
	return dwArg08;
}

// 080491B8: void __register_frame_info_table(Stack (ptr32 Eq_61) dwArg04, Stack (ptr32 Eq_62) dwArg08)
void __register_frame_info_table(struct Eq_61 * dwArg04, struct Eq_62 * dwArg08)
{
	dwArg08->ptr0008 = dwArg04;
...
{
	struct Eq_813 * ecx_14 = &g_ptr804AA84;
	if (g_ptr804AA84 != null)
	{
		do
		{
			struct Eq_821 * edx_19 = ecx_14->dw0000;
			...
			ecx_14 = (struct Eq_813 *) &edx_19->dw0014;
...
{
	struct Eq_855 * ebp_113 = fp - 4;
	struct Eq_471 * eax_24 = find_fde(dwArg04);
	if (eax_24 != null)
	{
		...
		if (eax_43 != null)
		{
			...
			if (eax_43 < (ecx_74 + *ecx_74) + 1)
			{
				do
				{
					struct Eq_916 * esp_85 = esp_110 - 4;
					esp_85->ptr0000 = null;
			...
			struct Eq_901 * esi_115 = ebp_113->ptrFFFFFF6C;
			byte * esi_116 = &esi_115->dw0008 + 2;
			if (*ebp_113->ptrFFFFFFEC == 122)
			{
				struct Eq_984 * esp_122 = esp_110 - 4;
			...
			struct Eq_901 * eax_139 = ebp_113->ptrFFFFFF6C;
			...
			if (esi_116 < eax_140 + 0x04)
			{
				...
				{
					struct Eq_1022 * esp_157 = esp_156 - 4;
