...
char* execute_cfa_insn(char* param0, char* param1, int param2, unsigned int* param3) {
    ...
    int* ptr6 = ptr3;
    void* ptr7 = (void*)&loc_8048DEE;
    int* ptr8 = &ptr6;
    void* ptr9 = (void*)&loc_8048DEE;
            ...
            *(int*)&ptr0[(int*)((int)ptr17 * 4) + 16] = v1;
            ...
            if(v29) {
                if((unsigned int)ptr13 <= 46) {
                    ...
                    ptr0 = (char*)((int)(int*)&_GLOBAL_OFFSET_TABLE_ - *((int*)((int)ptr13 * 4) + 0x20123a8));
                    char v34 = ptr0 ? 0: 1;
                    char v35 = (int)ptr0 < 0;
                    char v36 = __parity__((unsigned char)ptr0);
                    char v37 = (int*)((int)(int*)((int)(int*)((int)(int*)(*((int*)((int)ptr13 * 4) + 0x20123a8) ^ (int)(int*)&_GLOBAL_OFFSET_TABLE_) ^ (int)ptr0) >>> 4) & 0x1);
                    char v38 = *(unsigned int*)((int*)((int)ptr13 * 4) + 0x20123a8) > (unsigned int)(int*)&_GLOBAL_OFFSET_TABLE_;
                    char v39 = (int)(int*)((int)(int*)(*((int*)((int)ptr13 * 4) + 0x20123a8) ^ (int)(int*)&_GLOBAL_OFFSET_TABLE_) & (int)(int*)((int)ptr0 ^ (int)(int*)&_GLOBAL_OFFSET_TABLE_)) < 0;
                    jump ptr0;
                }
                /*NO_RETURN*/ →abort();
            }
...
char* extract_cie_info(unsigned int param0, unsigned int* param1) {
    ...
    *param1 = ptr1;
    unsigned char* ptr3 = (unsigned char*)&gvar_804948A;
    int v5 = 1;
    unsigned char* ptr4 = (unsigned char*)&gvar_804948A;
    char v6 = 1;
    while(v5 != 0) {
        v6 = *ptr1 == *ptr4;
        ++ptr1;
    ...
    if(!v6) {
        ...
        unsigned char* ptr6 = (unsigned char*)&gvar_804948B;
        int v7 = 3;
        char v8 = 1;
        while(v7 != 0) {
            v8 = *ptr5 == *ptr6;
    ...
    loc_8048D37:
        ...
        unsigned char* ptr12 = (unsigned char*)&gvar_804948B;
        ptr3 = (unsigned char*)&gvar_804948B;
        int v10 = 3;
        char v11 = 1;
        while(v10 != 0) {
            v11 = *ptr11 == *ptr12;
...
int frame_init(int* param0) {
    ...
    int v1;
    int v2 = v1;
    unsigned int* ptr2 = (unsigned int*)&loc_8048B4A;
