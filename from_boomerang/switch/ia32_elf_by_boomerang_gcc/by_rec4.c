...
{// addr = 0x08048918
    ...
    _t5 =  *((intOrPtr*)(__ebp + "/ld.so.1")) + -2;
    if(_t5 >  &M00000005) {
        _push("Other!\n");
    } else {
        switch( *((intOrPtr*)(_t5 * "/lib/ld.so.1" +  &M08048934))) {
            case 0:
                _push(134517848);
                goto L9;
            case 1:
...
L08048A24(signed int _a8, intOrPtr _a12)
{
    char _v20;
    _unknown_ __edi;
    _unknown_ __esi;
...
L08048AAC(_unknown_ _a8, intOrPtr* _a12, intOrPtr* _a16, intOrPtr* _a20)
{
    char _v24;
    _unknown_ __ebx;
    _unknown_ __edi;
...
L7:
    ...
    if(_t39 == "/usr/lib/ld.so.1") {
        ...
        if( *_t57 != "/usr/lib/ld.so.1") {
            ...
            while(1) {
L10:
                L08048AAC( *_t57, __edi,  &_v16, __ebp - "/ld.so.1", _v20);
...
L6:
    ...
    if(_t39 == "/usr/lib/ld.so.1") {
        ...
        if( *__esi != "/usr/lib/ld.so.1") {
            ...
            while(1) {
L9:
                L08048AAC( *__esi, __edi, __ebp - 12, __ebp - "/ld.so.1",  *((intOrPtr*)(__ebp - 16)));
                __esi = __esi + "/lib/ld.so.1";
                if( *__esi == "/usr/lib/ld.so.1") {
                    break;
                }
...
L08048CC8(_unknown_ __eax, signed int* _a8)
{
    signed int _v16;
    signed int _v20;
    char _v40;
...
L5:
        ...
        if( *( *_t89) == 122) {
            _push(__ebp - "/lib/ld.so.1");
            _push(_t75);
            _t75 = L0804898C() +  *(__ebp - "/lib/ld.so.1");
        }
        _t57 = _t75;
    } else {
        asm("cld ");
...
L08048DE0(_unknown_ __eax, _unknown_ __eflags, intOrPtr _a8, intOrPtr _a12, intOrPtr* _a16)
{
    signed int _v20;
    char _v32;
    _unknown_ __ebx;
...
L08048DEE(_unknown_ __eax, _unknown_ __eflags)
{
    _unknown_ _t40;
    signed int _t41;
    _unknown_ _t42;
...
L4:
            ...
            if( *((char*)( *((intOrPtr*)(__ebp - 20)))) == 122) {
                _push(__ebp + -140);
                _push(_t81);
                _t81 = L0804898C() +  *((intOrPtr*)(__ebp + -140));
                __esp = __esp + "/ld.so.1";
            }
...
L08049410()
{
    @rec 0x080488D8@L080488D8@();
    0;
    0;
    @rec 0x080493C0@L080493C0@();
    0;
    0;
    return;
}
