...
{
                    // WARNING: Could not recover jumptable at 0x00001ad4. Too many branches
                    // WARNING: Treating indirect jump as call
...
undefined8 _main(undefined4 param_1)

{
  ...
  switch(param_1) {
  default:
    __picsymbol_stub::_printf("Other!\n");
    break;
  case 2:
    __picsymbol_stub::_printf("Two!\n");
    break;
  case 3:
    __picsymbol_stub::_printf("Three!\n");
    break;
  case 4:
    __picsymbol_stub::_printf("Four!\n");
    break;
  case 5:
    __picsymbol_stub::_printf("Five!\n");
    break;
  case 6:
    __picsymbol_stub::_printf("Six!\n");
    break;
  case 7:
    __picsymbol_stub::_printf("Seven!\n");
  }
  return 0;
}
...
{
                    // WARNING: Could not recover jumptable at 0x00001d9c. Too many branches
                    // WARNING: Treating indirect jump as call
