...
Eq_6394 g_a40638C[] = // 0040638C
	{
	};
Eq_6395 g_a406390[] = // 00406390
	{
	};
Eq_6396 g_a406394[] = // 00406394
	{
	};
...
Eq_5672 g_t408BC0 = null; // 00408BC0
Eq_5672 g_t408BC4 = null; // 00408BC4
Eq_5672 g_t408BC8 = null; // 00408BC8
...
Eq_6409 g_a40533C[] = // 0040533C
	{
	};
byte g_b405358 = 0x2E; // 00405358
Eq_6406 g_a40535C[] = // 0040535C
	{
	};
// subject_text.c
// Generated by decompiling subject.exe
...
l004018B2:
						...
						if ((bl_195 & 0x40) != 0x00 && (edx_212 <= 0x00 && (edx_212 < 0x00 || Test(ULT,false))))
						{
							*((word32) esp_100 + 16) = SEQ(ebx_16_16_307, bh_191 | 0x01, bl_195);
							esi_288 = -eax_205;
							bh_191 |= 0x01;
							edi_290 = -((word32) edx_212.u0 + (word32) (eax_205 != 0x00));
						}
						else
						{
							esi_288 = eax_205;
			...
			do
			{
				...
				if (ecx_139 != (void *) ~0x00)
				{
					...
					if ((al_143 & 0x01) != 0x00 && ((al_143 & 0x08) != 0x00 || GetFileType(ecx_139) != 0x00))
					{
						...
						Eq_6403 ecx_167[] = *((char *) &g_t408BE0 + (esi_134 >> 0x05) * 0x04);
...
Eq_5151 fn00403940(Eq_93 dwArg04, union Eq_93 & ecxOut)
{
	...
	do
	{
		if (*((word32) ebp_170 + 16) != ~0x00 && *((word32) ebp_170 + 0x0C) != null)
		{
			...
			*((word32) ebp_170 + 0x0C) = 0x00 - (word32) (ecx_233 < eax_256) & ecx_261;
	...
	if (eax_19 < dwArg0C)
	{
		...
		if (eax_32 < (word32) dwArg04 + 0x00F8)
		{
			do
			{
				...
				if (al_41 == 0x00)
				{
					Eq_5458 eax_51 = (word32) esi_101 + 1;
					Eq_93 ecx_52 = 0x01;
...
l00403CD6:
		...
		do
		{
			...
			if (al_126 == 0x00)
			{
				Eq_5458 eax_136 = (word32) esi_101 + 1;
				Eq_93 ecx_137 = 0x01;
				if (*((word32) esi_101 + 1) == 0x00)
				{
					do
...
void fn00403D00()
{
	...
	if (g_t408BC0 == null)
	{
		Eq_2427 eax_21 = LoadLibraryA("user32.dll");
		if (eax_21 == null)
			return;
		Eq_5672 eax_32 = GetProcAddress(eax_21, "MessageBoxA");
		g_t408BC0 = eax_32;
		if (eax_32 == null)
			return;
		g_t408BC4 = GetProcAddress(eax_21, "GetActiveWindow");
		g_t408BC8 = GetProcAddress(eax_21, "GetLastActivePopup");
	}
	struct Eq_5675 * esp_102 = fp - 0x0C;
	Eq_5672 eax_64 = g_t408BC4;
	if (eax_64 != null)
	{
		word32 eax_74;
		word32 ecx_75;
	...
	struct Eq_5730 * esp_107 = esp_102 - 4;
...
l00403DD5:
	...
	do
	{
		Eq_5790 edx_74 = *esi_172;
		Eq_5794 eax_70 = *esi_172;
...
word32 fn00403F10(Eq_111 dwArg04, Eq_93 dwArg08, Eq_47 dwArg0C)
{
	if (dwArg04 < g_t408CE0)
	{
		struct Eq_6093 * esi_28 = (dwArg04 & 0x1F) << 0x03;
		Eq_6093 (** edi_27)[] = (dwArg04 >> 0x05) * 0x04 + 0x00408BE0;
...
void fn00404140(Eq_111 dwArg04, Eq_4703 dwArg08, Eq_47 dwArg0C)
{
	if (dwArg04 < g_t408CE0)
	{
		struct Eq_6182 ** ebx_23 = (dwArg04 >> 0x05) * 0x04 + 0x00408BE0;
...
word32 fn00404380(Eq_111 dwArg04)
{
	if (dwArg04 < g_t408CE0)
	{
		struct Eq_6282 * edx_12 = *((char *) &g_t408BE0 + (dwArg04 >> 0x05) * 0x04);
...
void fn004043D0(Eq_47 dwArg04)
{
	g_t408918 = dwArg04;
	ui32 ecx_16 = 0x00;
	struct Eq_6312 * eax_10 = g_a408790;
	do
	{
