...
bb0x40149d:
        esp_11 = local3;
        esp_4 = dll_crt0__FP11per_process();
        local4 = esp_4;
        goto bb0x4014a3;
    }
...
void _start(unsigned short param1)
{
    ...
    proc_0x00401470((unsigned short) eax | 831, eax | 831, esp - 4, (unsigned short) eax | 831, LOGICALFLAGS32(eax | 831), LOGICALFLAGS32(eax | 831), LOGICALFLAGS32(eax | 831), ebp, (unsigned short) eax | 831, 0x401080, pc);
    return;
}
...
bb0x401544:
            ...
            *(__size32*)(ebx + 68) = 0x4016e0;
            eax = GetModuleHandleA(); /* Warning: also results in %edx */
