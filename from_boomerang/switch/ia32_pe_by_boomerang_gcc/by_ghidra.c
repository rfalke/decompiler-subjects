...
uint __cdecl ___w32_sharedptr_set(int *param_1)
...

{
  ...
  piVar3 = (int *)___w32_sharedptr_set(___w32_sharedptr);
  if ((short)piVar3 != 0) {
    return piVar3;
  }
  _abort();
...

{
  ...
  param_2[0x20] = 0;
  param_2[0x21] = 0x70;
  param_2[0xb] = 0x4017a0;
  param_2[0xc] = 0x4017ac;
  param_2[5] = 0x403020;
  if (bVar1) {
  ...
  param_2[0x1e] = 0;
  param_2[0x12] = 0x401730;
  param_2[0x13] = 0x401720;
  param_2[10] = param_1;
  param_2[0x14] = 0x401710;
  param_2[0x15] = 0x401700;
  param_2[9] = 0x403028;
  *param_2 = local_4;
  param_2[6] = 0x401510;
  param_2[7] = 0x4014f0;
  param_2[8] = 0x4016f0;
  param_2[0x11] = 0x4016e0;
  pHVar2 = _GetModuleHandleA_4((LPCSTR)0x0);
  *(HMODULE *)(param_2 + 0x1f) = pHVar2;
  param_2[0xd] = 0x402000;
  param_2[0xe] = 0x402010;
  param_2[0xf] = 0x403000;
  param_2[0x10] = 0x403080;
