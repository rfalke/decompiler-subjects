...
void main(up32 w0, word64 x8, word64 qwArg00)
{
	...
	if (w0 <= 0x07 && w0 >= 0x02)
	{
		switch ((word32) globals->a400700[x8_12 * 0x08])
		{
		case 0x00:
			break;
		case 0x01:
...
// 0000000000400668: void __libc_csu_init(Register word64 x30, Stack word64 qwArg00)
...
// 00000000004006E4: void _fini(Stack word64 qwArg00)
