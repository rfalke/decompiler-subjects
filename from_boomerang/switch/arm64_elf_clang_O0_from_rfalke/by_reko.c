...
<anonymous> * g_a400758[] = // 0000000000400758
	{
	};
// subject_text.c
// Generated by decompiling subject.exe
...
// 00000000004005E0: void main(Register up32 w0, Register word32 x9_32_32, Register word64 x30, Stack word64 qwArg00)
void main(up32 w0, word32 x9_32_32, word64 x30, word64 qwArg00)
{
	ui64 x9_20 = SEQ(x9_32_32, w0 - 0x02);
	if (w0 > 0x07)
		fn0000000000400480();
	else
	{
		<anonymous> * x8_41 = *((char *) g_a400758 + x9_20 * 8);
		x8_41();
	}
}

// 00000000004006C0: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
