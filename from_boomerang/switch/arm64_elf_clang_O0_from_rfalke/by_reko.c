...
// 00000000004005E0: void main(Register up32 w0, Register word32 x9_32_32, Register word64 x30)
void main(up32 w0, word32 x9_32_32, word64 x30)
{
	ptr64 fp;
	ui64 x9_19 = SEQ(x9_32_32, w0 - 0x02);
	if (w0 > 0x07)
		printf("Other!\n");
	else
	{
		<anonymous> * x8_38 = *((char *) g_a400758 + x9_19 * 0x08);
		x8_38();
	}
}

// 00000000004006C0: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
