...
// 00000000004005E0: void main(Register up32 w0, Register word64 x9, Stack word64 qwArg00)
void main(up32 w0, word64 x9, word64 qwArg00)
{
	ui64 x9_17 = DPB(x9, w0 - 0x02, 0);
	if (w0 > 0x07)
		fn0000000000400480();
	else
	{
		<anonymous> * x8_39 = *((char *) globals->a400758 + x9_17 * 0x08);
		word64 sp_42;
		word64 x29_43;
		word64 x30_44;
		word32 w8_45;
...
// 00000000004006C0: void __libc_csu_init(Register word64 x30, Stack word64 qwArg00)
...
// 0000000000400738: void __libc_csu_fini()
void __libc_csu_fini()
{
}

// 000000000040073C: void _fini(Stack word64 qwArg00)
