...
undefined8 __regparm2 fib(undefined4 param_1_00,int param_2,int param_1)

{
  ...
  if (param_1 < 2) {
    ...
    local_c = (int)uVar2;
    param_2 = param_1 + -2;
    iVar1 = fib(param_2,uVar2,(int)((ulonglong)uVar2 >> 0x20));
...
// WARNING: Removing unreachable block (ram,0x0804849c)
// WARNING: Removing unreachable block (ram,0x080484a0)
// WARNING: Removing unreachable block (ram,0x080484ab)
