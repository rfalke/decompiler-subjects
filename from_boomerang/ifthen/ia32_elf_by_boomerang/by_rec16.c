 ...
 *	Input file: './from_boomerang/ifthen/ia32_elf_by_boomerang/subject.exe'
 */
...
/*	Procedure: 0x08048328 - 0x080483B1
 *	Argument size: -20
 *	Local size: 24
 *	Save regs size: 0
 */
...
/*	Procedure: 0x080483B2 - 0x080483B3
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
