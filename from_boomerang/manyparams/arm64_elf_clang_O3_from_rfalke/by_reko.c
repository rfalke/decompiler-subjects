...
real64 g_r4006C8 = 1.1; // 00000000004006C8
real64 g_r4006D0 = 2.2; // 00000000004006D0
real64 g_r4006D8 = 3.3; // 00000000004006D8
real64 g_r4006E0 = 4.4; // 00000000004006E0
// subject_text.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
void main()
{
	x0_39 = (uint64) printf("Many parameters: %d, %.1f, %d, %.1f, %d, %.1f, %d, %.1f\n", 0x01, 1.1, 0x02, 2.2, 0x03, 3.3, 0x04, 4.4);
}
