...
/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (FFFFFFFF code tFFFFFFFF) (804825E code t804825E) (804826E code t804826E) (804947C (ptr code) ptr804947C) (8049488 (ptr (ptr code)) ptr8049488) (8049554 (ptr code) ptr8049554) (8049560 (ptr code) ptr8049560) (8049564 word32 dw8049564) (8049574 (ptr code) ptr8049574) (8049578 (ptr code) ptr8049578) (804957C (ptr code) ptr804957C) (8049580 byte b8049580))
...
T_11: (in esp_3 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_12: (in 0x08049574 : ptr32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: (ptr (struct (0 T_13 t0000)))
T_13: (in Mem0[0x08049574:word32] : word32)
  Class: Eq_13
  DataType: (ptr code)
...
T_14: (in esp_3 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_15: (in 0x08049578 : ptr32)
  Class: Eq_15
  DataType: (ptr (ptr code))
  OrigDataType: (ptr (struct (0 T_16 t0000)))
T_16: (in Mem0[0x08049578:word32] : word32)
  Class: Eq_16
  DataType: (ptr code)
  OrigDataType: (ptr code)
...
T_30: (in 0x00000000 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_31: (in 0x0804957C + 0x00000000 : word32)
  Class: Eq_31
  DataType: ptr32
  OrigDataType: ptr32
T_32: (in Mem0[0x0804957C + 0x00000000:word32] : word32)
  Class: Eq_28
  DataType: (ptr code)
  OrigDataType: word32
...
T_42: (in Z_36 : byte)
  ...
  DataType: byte
  OrigDataType: byte
T_43: (in 0x08049580 : ptr32)
  Class: Eq_43
  DataType: (ptr byte)
  OrigDataType: (ptr (struct (0 T_44 t0000)))
T_44: (in Mem0[0x08049580:byte] : byte)
  Class: Eq_44
  DataType: byte
  OrigDataType: byte
T_45: (in 0x00 : byte)
  ...
  DataType: byte
  OrigDataType: byte
T_46: (in globals->b8049580 != 0x00 : bool)
  Class: Eq_46
  DataType: bool
  OrigDataType: bool
...
T_48: (in 0x08049488 : word32)
  Class: Eq_48
  DataType: (ptr (ptr (ptr code)))
  OrigDataType: (ptr (struct (0 T_49 t0000)))
T_49: (in Mem0[0x08049488:word32] : word32)
  Class: Eq_47
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_56: (in 0x01 : byte)
  ...
  DataType: byte
  OrigDataType: byte
T_57: (in 0x08049580 : ptr32)
  Class: Eq_57
  DataType: (ptr byte)
  OrigDataType: (ptr (struct (0 T_58 t0000)))
T_58: (in Mem39[0x08049580:byte] : byte)
  Class: Eq_44
  DataType: byte
  OrigDataType: byte
...
T_61: (in eax_25 + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr code))
  OrigDataType: ptr32
T_62: (in 0x08049488 : word32)
  Class: Eq_62
  DataType: (ptr (ptr (ptr code)))
  OrigDataType: (ptr (struct (0 T_63 t0000)))
T_63: (in Mem44[0x08049488:word32] : word32)
  Class: Eq_47
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_72: (in esi_53 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_73: (in 0x08049488 : word32)
  Class: Eq_73
  DataType: (ptr (ptr (ptr code)))
  OrigDataType: (ptr (struct (0 T_74 t0000)))
T_74: (in Mem44[0x08049488:word32] : word32)
  Class: Eq_47
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_79: (in *eax_25 != null : bool)
  ...
  DataType: bool
  OrigDataType: bool
T_80: (in 0x08049564 : word32)
  Class: Eq_80
  DataType: (ptr word32)
  OrigDataType: (ptr (struct (0 T_81 t0000)))
T_81: (in Mem0[0x08049564:word32] : word32)
  Class: Eq_81
  DataType: word32
  OrigDataType: word32
T_82: (in 0x00000000 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_83: (in globals->dw8049564 == 0x00000000 : bool)
  Class: Eq_83
  DataType: bool
  OrigDataType: bool
...
T_118: (in edx_43 : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_119: (in 0x0804947C : word32)
  Class: Eq_119
  DataType: (ptr (ptr code))
  OrigDataType: (ptr (struct (0 T_120 t0000)))
T_120: (in Mem0[0x0804947C:word32] : word32)
  Class: Eq_120
  DataType: (ptr code)
  OrigDataType: (ptr code)
...
T_126: (in eax_13 : (ptr code))
  ...
  DataType: (ptr code)
  OrigDataType: (ptr code)
T_127: (in 0x08049554 : word32)
  Class: Eq_127
  DataType: (ptr (ptr code))
  OrigDataType: (ptr (struct (0 T_128 t0000)))
T_128: (in Mem0[0x08049554:word32] : word32)
  Class: Eq_126
  DataType: (ptr code)
  OrigDataType: word32
