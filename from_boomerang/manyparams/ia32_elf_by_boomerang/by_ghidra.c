...
{
  printf("Many parameters: %d, %.1f, %d, %.1f, %d, %.1f, %d, %.1f\n",1,0x9999999a,0x3ff19999,2,
         0x9999999a,0x40019999,3,0x66666666,0x400a6666,4,0x9999999a,0x40119999);
  return 0;
}
...
// WARNING: Removing unreachable block (ram,0x08048394)
...
// WARNING: Removing unreachable block (ram,0x080483d6)
