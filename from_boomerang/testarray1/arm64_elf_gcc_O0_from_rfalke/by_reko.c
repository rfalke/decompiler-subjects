...
Eq_121 g_t11038 = // 0000000000011038
	{
...
void main()
{
	int32 dwArg00_48 = 0x00;
	int32 dwArg04_49;
	for (dwArg04_49 = 0x00; dwArg04_49 <= 0x04; ++dwArg04_49)
		dwArg00_48 += (word32) (&g_t11038)[(int64) dwLoc0A];
	x0_37 = (uint64) printf("Sum is %d\n", dwArg00_48);
}
