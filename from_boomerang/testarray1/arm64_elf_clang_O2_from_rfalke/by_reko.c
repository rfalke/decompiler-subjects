...
Eq_118 g_t411030 = // 0000000000411030
	{
		0x02
	};
Eq_116 g_t411031 = // 0000000000411031
	{
		0x04
	};
...
void main()
{
	x0_29 = CONVERT(printf("Sum is %d\n", CONVERT(Mem8[0x0000000000411034<p64>:byte], byte, word32) + (CONVERT(Mem8[0x0000000000411033<p64>:byte], byte, word32) + (CONVERT(Mem8[0x0000000000411032<p64>:byte], byte, word32) + (Mem8[0x0000000000411031<p64>:byte] + Mem8[0x0000000000411030<p64>:byte])))), int32, uint64);
}

// 0000000000400630: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
