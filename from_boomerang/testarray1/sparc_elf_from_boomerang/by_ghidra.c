...

{
  ...
  FUN_00020844(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_00020850(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...

{
  ...
  for (local_14 = 0; local_14 < 5; local_14 = local_14 + 1) {
    local_18 = local_18 + *(char *)((int)&gca + local_14);
  }
  printf("Sum is %d\n",local_18);
  return 0;
}
...
// WARNING: Inlined function: FUN_0001070c
...
{
  IllegalInstructionTrap(0x20814);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x2085c);
  return (int)__format;
}
