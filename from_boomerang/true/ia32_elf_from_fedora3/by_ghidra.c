...

{
  ...
  setlocale(6,"");
  bindtextdomain(0x804a28d,"/usr/share/locale");
  textdomain(0x804a28d);
...

{
  ...
  if (-1 < iVar5) {
    ...
    if (DAT_0804ba04 == 0) {
      error(exit_failure,iVar5,0x804a2ac,uVar2);
      return;
    }
...

{
  ...
  uVar2 = (&DAT_0804bb24)[(uint)(param_2 >> 5)];
  (&DAT_0804bb24)[(uint)(param_2 >> 5)] =
...
uint FUN_08048ff6(char *param_1,uint param_2,uint param_3)
...
LAB_0804933e:
      ...
      do {
        uVar6 = local_34 + local_60;
        sVar4 = mbrtowc((wchar_t *)&local_28,param_1 + uVar6,param_2 - uVar6,local_24);
...
undefined * FUN_08049721(undefined4 param_1,undefined4 param_2)

{
  ...
  if (DAT_0804b9dc <= in_EAX) {
    uVar7 = in_EAX + 1;
    if (0x1fffffff < uVar7) {
                    // WARNING: Subroutine does not return
      FUN_08049d10();
    }
    puVar5 = (undefined4 *)PTR_DAT_0804b9e8;
    if ((undefined4 *)PTR_DAT_0804b9e8 == &DAT_0804b9e0) {
      puVar5 = (undefined4 *)FUN_08049dc5(8);
      puVar8 = PTR_DAT_0804b9e4;
      PTR_DAT_0804b9e8 = (undefined *)puVar5;
      *puVar5 = DAT_0804b9e0;
      *(undefined **)(puVar5 + 1) = puVar8;
    }
    PTR_DAT_0804b9e8 = (undefined *)FUN_08049e3f(puVar5,uVar7 * 8);
    memset(PTR_DAT_0804b9e8 + DAT_0804b9dc * 8,0,(uVar7 - DAT_0804b9dc) * 8);
    DAT_0804b9dc = uVar7;
  }
  uVar7 = *(uint *)(PTR_DAT_0804b9e8 + in_EAX * 8);
  puVar8 = *(undefined **)(PTR_DAT_0804b9e8 + in_EAX * 8 + 4);
  uVar3 = FUN_080496c3(puVar8,uVar7,in_EDX,param_1,param_2);
  puVar6 = PTR_DAT_0804b9e8;
  if (uVar7 <= uVar3) {
    iVar4 = uVar3 + 1;
    *(int *)(PTR_DAT_0804b9e8 + in_EAX * 8) = iVar4;
    if (puVar8 != &DAT_0804ba20) {
      FUN_08049fe0(puVar8);
      puVar6 = PTR_DAT_0804b9e8;
    }
    puVar8 = (undefined *)FUN_08049dc5(iVar4);
    *(undefined **)(puVar6 + in_EAX * 8 + 4) = puVar8;
    FUN_080496c3(puVar8,iVar4,in_EDX,param_1,param_2);
  }
  piVar2 = __errno_location();
  *piVar2 = iVar1;
  return puVar8;
...

{
  ...
  if (uVar2 < 10) {
                    ...
                    // WARNING: Treating indirect jump as call
    (*(code *)((int)&__DT_PLTGOT + (&DAT_0804a7ec)[uVar2]))();
    return;
  }
  __format = (char *)dcgettext(0,"Written by %s, %s, %s,\n%s, %s, %s, %s,\n%s, %s, and others.\n",5)
  ;
  vfprintf(param_1,__format,param_5);
  ...
  __format = (char *)dcgettext(0,
                               ...
                               ,5);
  fputs_unlocked(__format,param_1);
  return;
}
...

{
  ...
  error(exit_failure,0,0x804a2ac,uVar1);
                    // WARNING: Subroutine does not return
  abort();
}
