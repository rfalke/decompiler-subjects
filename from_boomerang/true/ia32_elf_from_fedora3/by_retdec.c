...
int32_t function_8048d64(int32_t a1);
  ...
  lab_dec_label_pc_unknown:
    if (*(char *)v10 == *(char *)v9) {
        ...
        if (v13 == 0) {
            ...
            function_8049ccd(v14, v2 + 0x1642, v2 + 0x1634, v2 + 0x162e);
            goto lab_0x8048cbb;
        } else {
            goto lab_dec_label_pc_unknown;
        }
...
int32_t function_8048fa3(void) {
    ...
    int32_t v2 = (int32_t)dcgettext(NULL, (char *)function_8048d64(v1), 5); // 0x8048fce
...
int32_t function_8048ff6(int32_t a1, int32_t a2, uint32_t a3, int32_t a4) {
    ...
    int32_t v2 = function_8048d64(v1); // 0x8048ffc
...
int32_t function_8049721(int32_t a1, int32_t a2) {
    ...
    int32_t v2 = function_8048d64(v1); // 0x8049727
...
int32_t function_80499f0(int32_t a1, int32_t a2) {
    ...
    function_8048d64(v1);
    int32_t v2 = *(int32_t *)(v1 + 0x2126); // bp-60, 0x8049a10
    function_8048f36(&v2, 0x1000000 * a2 >> 24, 1);
    return function_8049721(-1, (int32_t)&v2);
}
...
int32_t function_8049f60(uint32_t nmemb, uint32_t size) {
    ...
    if (function_8048d64(v1) / size < nmemb) {
        // 0x8049f9d
        function_8049d10();
        // UNREACHABLE
    }
