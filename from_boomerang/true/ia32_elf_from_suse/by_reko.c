...
Eq_1199 (* nslots.1)[] = &g_a0001; // 0804B7D8
Eq_1199 g_t804B7DC = // 0804B7DC
	{
		0x0100,
		0x0804B7DC,
	};
Eq_1203 g_t804B7E0 = // 0804B7E0
	{
		0x0804A3C4,
	};
Eq_1199 (* slotvec.3)[] = &g_a804B7DC; // 0804B7E4
...
l08049372:
				...
				case 0x3F:
					...
					{
						Eq_615 cl_273 = *((word32) ecx + ((word32) dwLoc38_1005 + 2));
						Eq_777 eax_274 = (int32) cl_273;
						if (eax_274 <= 0x3E)
						{
							switch (eax_274)
							{
				...
				do
				{
					...
					if (eax_477 == ~0x01)
					{
						...
						if (ebx_469 < dwArg04 && *eax_473 != 0x00)
						{
							do
							{
								Eq_714 v43_495 = (word32) dwLoc60_1116.u0 + 1;
...
// 080495C0: Register ptr32 quotearg_n_options(Register (arr Eq_1199) eax, Register size_t edx)
// Called from:
//      quotearg_char
//      quotearg_n_style_mem
//      quotearg_n_style
//      quotearg_n
ptr32 quotearg_n_options(Eq_1199 eax[], size_t edx)
{
	...
	else
	{
		if (nslots.1 <= eax)
		{
			...
			if (slotvec.3 == &g_t804B7DC)
			{
				...
				xmalloc(stackArg4);
				slotvec.3 = eax;
				Eq_1199 eax_47 = g_t804B7DC.dw0000;
				*((word32) &eax[0].dw0000 + 4) = (Eq_1199 (*)[]) g_t804B7E0;
			...
			Eq_1199 eax_54[] = (eax + 0x01) * 0x08;
			slotvec.3 = eax_54;
			Eq_1199 (* eax_59)[] = nslots.1;
		...
		if (esi_89 <= edx)
		{
			...
			Eq_269 stackArg4 = <invalid>;
			xmalloc(stackArg4);
			*((word32) &ebx_103[eax].dw0000 + 4) = (Eq_1199 (*)[]) edx;
			// Failed to bind call argument.
			// Please report this issue at https://github.com/uxmal/reko
			// Failed to bind call argument.
			// Please report this issue at https://github.com/uxmal/reko
...
// 08049800: void quotearg_n_style_mem(Stack (ptr32 (arr Eq_1199)) dwArg04, Stack word32 dwArg08, Stack Eq_269 dwArg0C)
void quotearg_n_style_mem(Eq_1199 (* dwArg04)[], word32 dwArg08, Eq_269 dwArg0C)
{
	quoting_options_from_style(fp - 0x3C, dwArg08);
	quotearg_n_options(dwArg04, dwArg0C);
}

// 08049830: void quotearg_n_style(Stack (ptr32 (arr Eq_1199)) dwArg04, Stack word32 dwArg08, Stack Eq_269 dwArg0C)
// Called from:
//      quotearg_style
void quotearg_n_style(Eq_1199 (* dwArg04)[], word32 dwArg08, Eq_269 dwArg0C)
{
	quoting_options_from_style(fp - 0x3C, dwArg08);
	quotearg_n_options(dwArg04, dwArg0C);
}
...
// 08049890: Register word32 quotearg_n(Stack (ptr32 (arr Eq_1199)) dwArg04, Stack Eq_269 dwArg08)
// Called from:
//      quotearg
word32 quotearg_n(Eq_1199 (* dwArg04)[], Eq_269 dwArg08)
{
...
// 080498D0: void version_etc_va(Stack (ptr32 Eq_99) dwArg04, Stack (ptr32 char) dwArg08, Stack (ptr32 char) dwArg0C, Stack (ptr32 char) dwArg10, Stack Eq_1282 dwArg14)
// Called from:
//      version_etc
void version_etc_va(FILE * dwArg04, char * dwArg08, char * dwArg0C, char * dwArg10, Eq_1282 dwArg14)
{
	up32 ebx_18 = 0x00;
...
// 08049C30: void x2nrealloc(Stack Eq_269 dwArg04, Stack (ptr32 Eq_1480) dwArg08, Stack Eq_1479 dwArg0C)
// Called from:
//      x2realloc
void x2nrealloc(Eq_269 dwArg04, union Eq_1480 * dwArg08, Eq_1479 dwArg0C)
{
	Eq_1480 ecx_19 = *dwArg08;
	if (dwArg04 != 0x00)
	{
	...
	*dwArg08 = (union Eq_1480 *) ecx_19;
	Eq_269 ecx_54 = ecx_19 *s dwArg0C;
	xrealloc(dwArg04, ecx_54);
}

// 08049CA0: void xnrealloc(Stack Eq_269 dwArg04, Stack Eq_1513 dwArg08, Stack Eq_1514 dwArg0C)
// Called from:
//      x2nrealloc
void xnrealloc(Eq_269 dwArg04, Eq_1513 dwArg08, Eq_1514 dwArg0C)
{
...
// 08049D80: void xnmalloc(Stack Eq_1556 dwArg04, Stack Eq_1557 dwArg08)
void xnmalloc(Eq_1556 dwArg04, Eq_1557 dwArg08)
{
