...
{
                    // WARNING: Could not recover jumptable at 0x00001b9c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001bac. Too many branches
                    // WARNING: Treating indirect jump as call
...
ulonglong _main(int param_1)

{
  __picsymbol_stub::_printf("Result is %d\n",(ulonglong)(1 < param_1));
  return (ulonglong)(1 < param_1);
}
