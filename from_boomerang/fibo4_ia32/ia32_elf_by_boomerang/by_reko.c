...
void _start( * edx, int32 dwArg00)
{
	...
	__libc_start_main(&globals->t80483DF, dwArg00, (char *) fp + 0x04, &globals->t8048448, &globals->t8048498, edx, fp);
	__hlt();
}
...
{
	word32 edx_15 = globals->dw80495FC;
	if (edx_15 != 0x00)
	{
		word32 esp_33;
		word32 ebp_34;
...
{
	_init();
	word32 eax_21 = 0x080496D8 - 0x080496D8;
	if (eax_21 >> 0x02 != 0x00)
	{
		do
		{
