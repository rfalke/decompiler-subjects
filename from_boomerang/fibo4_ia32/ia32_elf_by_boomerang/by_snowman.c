...
int32_t call_gmon_start(int32_t ecx) {
    ...
    if (*reinterpret_cast<int32_t*>(ecx + 0x12be - 4)) {
        fun_80482fc();
    }
    return ebx2;
}
...
/* p.4582 */
int32_t* p_4582 = reinterpret_cast<int32_t*>(0x8049524);
...
void fun_804833a(int32_t a1, int32_t a2) {
    ...
    if (*reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(__return_address()) + 0x12be - 4)) {
        fun_80482fc();
    }
    goto ebp3->f4;
}
