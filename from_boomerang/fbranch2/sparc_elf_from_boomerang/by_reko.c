...
{
	struct Eq_40 * l7_139 = fn00010544(o7, 66544);
...
{
	struct Eq_40 * l7_22 = fn00010544(o7, 66360);
...
{
	word32 * l0_30;
	struct Eq_233 * l7_22 = fn00010830(o7, 0x00010104);
	struct Eq_238 * o5_25 = l7_22->ptr0018;
