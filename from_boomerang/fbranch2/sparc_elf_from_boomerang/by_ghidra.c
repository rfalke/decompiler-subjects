...
// WARNING: Inlined function: FUN_00010544
...

{
  ...
  FUN_000209d0(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  uVar1 = FUN_000209dc(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
...
// WARNING: Removing unreachable block (ram,0x000106b8)
...

{
  ...
  local_14 = 5.00000000;
  scanf("%f",&local_18,param_3,param_4,(int)((ulonglong)in_o4_5 >> 0x20));
  local_10 = (double)local_18;
  printf("a is %f, b is %f\n",(int)((ulonglong)(double)local_14 >> 0x20),SUB84((double)local_14,0),
         (int)((ulonglong)local_10 >> 0x20),SUB84(local_10,0));
  if ((char)((local_14 < local_18) + (local_18 < local_14) * '\x02') == '\0') {
    printf("Equal\n");
  }
  cVar1 = (local_14 < local_18) + (local_18 < local_14) * '\x02';
  if ((cVar1 == '\x01' || cVar1 == '\x02') || cVar1 == '\x03') {
    printf("Not Equal\n");
  }
  if ((char)((local_14 < local_18) + (local_18 < local_14) * '\x02') == '\x02') {
    printf("Greater\n");
  }
  if ((byte)((local_14 < local_18) + (local_18 < local_14) * '\x02') < 2) {
  ...
  if ((char)((local_14 < local_18) + (local_18 < local_14) * '\x02') == '\x01') {
    printf("Less\n");
  }
  return 0;
}
...
// WARNING: Inlined function: FUN_00010830
...
{
  IllegalInstructionTrap(0x209a0);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x209ac);
  return;
}
...
{
  IllegalInstructionTrap(0x209b8);
  return;
}



void FUN_000209c4(void)
...
{
  IllegalInstructionTrap(0x209e8);
  return (int)__format;
}
...
{
  IllegalInstructionTrap(0x209f4);
  return (int)__format;
}
