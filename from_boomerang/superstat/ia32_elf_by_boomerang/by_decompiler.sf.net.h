...
/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (804835C (ptr code) ptr804835C) (8048454 (ptr code) ptr8048454) (8048484 (ptr code) ptr8048484))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x08048454 : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x08048484 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr804835C, dwArg00, fp + 0x00000004, &globals->ptr8048454, &globals->ptr8048484, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	...
	code * ptr8048454;	// 8048454
	code * ptr8048484;	// 8048484
} Eq_1;
