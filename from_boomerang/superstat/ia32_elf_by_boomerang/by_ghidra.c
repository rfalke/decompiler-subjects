...
main(undefined4 param_1_00,undefined4 param_2_00,undefined4 param_3,undefined4 param_1,int param_2)

{
  ...
  undefined4 local_48;
  __off_t local_40;
  __blksize_t local_3c;
  __blkcnt_t local_38;
  __time_t local_34;
  __time_t local_2c;
  __time_t local_24;
  
  __stat_buf = (stat *)&local_6c;
  iVar1 = __xstat(3,*(char **)(param_2 + 4),__stat_buf);
  printf("res: %i\n",iVar1,__stat_buf,param_3);
  printf("dev: %i\n",local_6c,local_68);
  printf("ino: %i\n",local_60);
  printf("mode: %i\n",local_5c);
  printf("nlink: %i\n",local_58);
...
// WARNING: Removing unreachable block (ram,0x08048471)
...
// WARNING: Removing unreachable block (ram,0x080484b6)
