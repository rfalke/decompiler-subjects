...
void main(struct Eq_98 * x1)
{
	...
	x0_43 = (uint64) printf("mode: %i\n", 0x00);
	x0_47 = (uint64) printf("nlink: %i\n", 0x00);
	x0_55 = (uint64) printf("uid: %i\n", 0x00);
	x0_59 = (uint64) printf("gid: %i\n", 0x00);
	x0_64 = (uint64) printf("rdev: %i\n", 0x00);
	x0_69 = (uint64) printf("size: %i\n", 0x00);
	x0_74 = (uint64) printf("blksize: %i\n", 0x00);
	x0_79 = (uint64) printf("blocks: %i\n", 0x00);
	x0_84 = (uint64) printf("atime: %i\n", 0x00);
	x0_89 = (uint64) printf("mtime: %i\n", 0x00);
	x0_94 = (uint64) printf("ctime: %i\n", 0x00);
}
...
// 00000000004007D0: void stat(Register (ptr64 char) x0, Register (ptr64 Eq_102) x1)
// Called from:
//      main
