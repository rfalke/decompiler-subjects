...

{
  ...
  local_20 = stat(*(char **)(param_2 + 4),&local_80);
  printf("res: %i\n",local_20);
  printf("dev: %i\n");
  printf("ino: %i\n",local_80.st_ino);
  printf("mode: %i\n",local_80.st_mode);
  ...
  printf("blksize: %i\n",local_80.st_blksize);
  printf("blocks: %i\n",local_80.st_blocks);
  printf("atime: %i\n",local_80.st_atim.tv_sec);
  printf("mtime: %i\n",local_80.st_mtim.tv_sec);
  printf("ctime: %i\n",local_80.st_ctim.tv_sec);
  return 0;
}



// WARNING: Removing unreachable block (ram,0x1000060c)
// WARNING: Removing unreachable block (ram,0x10000608)
...
// WARNING: Removing unreachable block (ram,0x1000069c)
// WARNING: Removing unreachable block (ram,0x100006a0)
