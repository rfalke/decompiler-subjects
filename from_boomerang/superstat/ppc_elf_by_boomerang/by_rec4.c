...
{// addr = 0x1000034C
    __lr = __lr;
    __r1 = {;
    if(cr7 -  *((void*)(0x10010bac))) {
        while(cr7 -  *((void*)(0 +  *((void*)(0x10010b28))))) {
            asm("bllr ");
        }
    }
    __r1 = __r1 + 32;
...
{// addr = 0x10000440
    __lr = __lr;
    __r1 = {;
    __stat( *((void*)(0 +  *((void*)(12 + ({))) + 4)), ({) + 16, __lr);
