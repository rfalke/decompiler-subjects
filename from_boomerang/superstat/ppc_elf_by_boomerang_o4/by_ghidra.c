...
ulonglong main(undefined4 param_1,int param_2)

{
  ...
  __gid_t local_44;
  __off_t local_34;
  __blksize_t local_30;
  __blkcnt_t local_2c;
  __time_t local_28;
  __time_t local_20;
  __time_t local_18;
  
  iVar1 = __xstat(3,*(char **)(param_2 + 4),(stat *)&local_60);
  printf("res: %i\n",iVar1);
  printf("dev: %i\n",0x10000000,local_60,local_5c);
  printf("ino: %i\n",local_54);
  printf("mode: %i\n",local_50);
  printf("nlink: %i\n",local_4c);
  printf("uid: %i\n",local_48);
...
// WARNING: Removing unreachable block (ram,0x100005e0)
// WARNING: Removing unreachable block (ram,0x100005dc)
...
// WARNING: Removing unreachable block (ram,0x10000670)
// WARNING: Removing unreachable block (ram,0x10000674)
