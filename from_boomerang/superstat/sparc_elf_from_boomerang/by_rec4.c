...
{// addr = 0x00010554
    ...
    _t35 = _t34 + 956;
    "/usr/lib/ld.so.1" = __r5 & 4294963341;
...
)
{
    ...
    goto ( &_a8);
    _t14 =  &_START_;
    L000107A0(__o7, _t14, __i7);
    __o1 =  *((void*)(_t14 + 360 + ("/usr/lib/ld.so.1" | 24)));
    _t8 =  *((void*)(__o1 - 4));
    2348971984();
    if(_t8 - 4294967295) {
...
{// addr = 0x000107A8
    ...
    __i7 = __i7;
    _t12 =  &_START_;
    L000107A0(__o7, _t12, __i7);
    __o1 =  *((void*)(_t12 + 360 + ("/usr/lib/ld.so.1" | 24)));
    _t7 =  *((void*)(__o1 - 4));
    4028966864();
    if(_t7 - 4294967295) {
        _t9 = __o1 + 4294967292;
