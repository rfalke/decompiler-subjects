...

{
  ...
  uVar1 = __xstat(0,argv[1],(stat *)&local_90);
  printf("res: %i\n",(ulong)uVar1);
  printf("dev: %i\n",CONCAT71(uStack143,local_90));
  printf("ino: %i\n",local_88);
  printf("mode: %i\n",(ulong)local_80);
  printf("nlink: %i\n",(ulong)local_7c);
  printf("uid: %i\n",(ulong)local_78);
...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x0040074c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x40074c);
