...

{
  ...
  uVar1 = __xstat(0,argv[1],(stat *)&st);
  printf("res: %i\n",(ulonglong)uVar1);
  printf("dev: %i\n",st.st_dev);
  printf("ino: %i\n",st.st_ino);
  printf("mode: %i\n",(ulonglong)st.st_mode);
  printf("nlink: %i\n",(ulonglong)st.st_nlink);
  printf("uid: %i\n",(ulonglong)st.st_uid);
  printf("gid: %i\n",(ulonglong)st.st_gid);
  printf("rdev: %i\n",st.st_rdev);
  printf("size: %i\n",st.st_size);
  printf("blksize: %i\n",(ulonglong)(uint)st.st_blksize);
  printf("blocks: %i\n",st.st_blocks);
  printf("atime: %i\n",st.st_atim.tv_sec);
  printf("mtime: %i\n",st.st_mtim.tv_sec);
  printf("ctime: %i\n",st.st_ctim.tv_sec);
...
// WARNING: Removing unreachable block (ram,0x0010087c)
