...

{
  ...
  param_11 = param_1;
  param_12 = param_2;
  local_20 = __picsymbol_stub::_stat(*(char **)(param_2 + 4),(stat *)local_80);
  __picsymbol_stub::_printf("res: %i\n",(ulonglong)local_20);
  __picsymbol_stub::_printf("dev: %i\n",(ulonglong)(uint)local_80._0_4_);
  __picsymbol_stub::_printf("ino: %i\n",(ulonglong)(uint)local_80._4_4_);
  __picsymbol_stub::_printf("mode: %i\n",(ulonglong)(ushort)local_80._8_2_);
