...
void main(word64 qwArg00)
{
	...
	if (0x05 < dwLoc1C)
		fn00000000004004E0();
	if ((0x05 - dwLoc14 & 0x00) != 0x00)
		fn00000000004004E0();
	if ((0x05 - dwLoc14 & 0x00) != 0x00)
		fn00000000004004E0();
}

// 0000000000400820: void __libc_csu_init(Register word64 x30, Stack word64 qwArg00)
...
// 000000000040089C: void _fini(Stack word64 qwArg00)
