...

{
  ...
  __isoc99_scanf(&DAT_00100a90,&b);
  __isoc99_scanf(&DAT_00100a90,&v);
...
void FUN_001009f4(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x001009f4. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x1009f4);
