// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/branch/ia32_elf_by_boomerang_linux/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (804829C (ptr code) ptr804829C) (8048410 (ptr code) ptr8048410) (8048690 (ptr code) ptr8048690))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x0804829C : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x08048690 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr8048410, dwArg00, fp + 0x00000004, &globals->ptr804829C, &globals->ptr8048690, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr804829C;	// 804829C
	code * ptr8048410;	// 8048410
	code * ptr8048690;	// 8048690
} Eq_1;
