...
// WARNING: Removing unreachable block (ram,0x0804838e)
...
// WARNING: Removing unreachable block (ram,0x080483cb)
// WARNING: Removing unreachable block (ram,0x080483fd)
...

{
  ...
  scanf("%d",&local_c);
  scanf("%d",&local_10);
  if ((local_c != 5) || (fwrite("Equal\n",1,6,stdout), local_c != 5)) {
    fwrite("Not Equal\n",1,10,stdout);
  }
  if ((((4 < local_c) || (fwrite("Greater\n",1,8,stdout), 4 < local_c)) &&
      (fwrite("Less or Equal\n",1,0xe,stdout), 5 < local_c)) ||
     (fwrite("Greater or Equal\n",1,0x11,stdout), 5 < local_c)) {
    fwrite("Less\n",1,5,stdout);
  }
  if ((((4 < local_10) || (fwrite("Greater Unsigned\n",1,0x11,stdout), 4 < local_10)) &&
      (fwrite("Less or Equal Unsigned\n",1,0x17,stdout), 5 < local_10)) ||
     (fwrite("Carry Clear\n",1,0xc,stdout), 5 < local_10)) {
    fwrite("Carry Set\n",1,10,stdout);
  }
  if (-1 < 5 - local_c) {
    fwrite("Minus\n",1,6,stdout);
