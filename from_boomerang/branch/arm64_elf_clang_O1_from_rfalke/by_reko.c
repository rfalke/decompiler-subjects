...
// 0000000000400640: void main(Register word64 x20)
void main(word64 x20)
{
	fn00000000004004E0();
	fn00000000004004E0();
	int32 dwLoc1C_157 = SLICE(x20, word32, 32);
	up32 dwLoc20_164 = (word32) x20;
	if (dwLoc1C_157 == 0x05)
	{
		fn00000000004004D0();
		if (dwLoc1C_157 == 0x05)
...
// 00000000004007A8: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
