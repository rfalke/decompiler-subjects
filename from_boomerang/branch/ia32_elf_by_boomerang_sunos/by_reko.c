...
{
	*((char *) dwArg04 + dwArg08 * 0x04) = (union Eq_245 *) dwArg0C;
	ui32 edx_14 = dwArg08;
	if (dwArg08 != 0x00)
	{
		...
		do
		{
			struct Eq_258 * esi_53 = (dwArg04 - 0x04)[edx_14];
			struct Eq_262 * edi_50 = *ecx_45;
...
// 08048B78: void add_fdes(Stack (ptr Eq_247) dwArg04, Stack (ptr Eq_245) dwArg08, Stack (ptr ui32) dwArg0C, Stack (ptr uint32) dwArg10, Stack (ptr uint32) dwArg14)
void add_fdes(Eq_247 * dwArg04, Eq_245 * dwArg08, ui32 * dwArg0C, uint32 * dwArg10, uint32 * dwArg14)
{
...
{
	struct Eq_493 * eax_115;
	struct Eq_395 * esi_118 = globals->ptr804ACC8;
	if (esi_118 != null)
	{
		do
		{
		...
		if (esi_118 != null)
		{
			...
			if (0x00 < ecx_86)
			{
				union Eq_245 * esi_90 = esi_118->ptr000C;
				do
				{
					uint32 eax_95 = dwLoc08_104 + edi_106;
					struct Eq_493 * ecx_98 = *((char *) esi_90 + (eax_95 >> 0x01) * 0x04);
...
{
	struct Eq_566 * edx_23 = dwArg04 - (dwArg04->dw0004 + ~0x03);
	...
	struct Eq_665 * eax_100 = eax_83 - 0x01 + ~ecx_191;
...
{
	struct Eq_929 * ecx_13 = &globals->ptr804ACC8;
	if (globals->ptr804ACC8 != 0x00)
	{
		do
		{
			struct Eq_939 * edx_23 = ecx_13->dw0000;
			...
			ecx_13 = (struct Eq_929 *) &edx_23->dw0014;
...
{
	struct Eq_564 * eax_23 = find_fde(dwArg04);
	if (eax_23 != null)
	{
