...
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  if ( v5 == 5 )
    printf("Equal\n");
  if ( (v5 == 5 || (printf("Not Equal\n"), v5 >= 5) || (printf("Greater\n"), v5 >= 5))
    && (printf("Less or Equal\n"), v5 > 5)
    || (printf("Greater or Equal\n"), v5 > 5) )
  {
    printf("Less\n");
  }
  if ( (v4 >= 5 || (printf("Greater Unsigned\n"), v4 >= 5)) && (printf("Less or Equal Unsigned\n"), v4 > 5)
    || (printf("Carry Clear\n"), v4 > 5) )
  {
    printf("Carry Set\n");
  }
  if ( 5 - v5 < 0 || (printf("Minus\n"), 5 - v5 < 0) )
    printf("Plus\n");
  return 0;
}
...
// 804ACC8: using guessed type int objects;
...
char *__cdecl extract_cie_info(int a1, int *a2)
{
  ...
  v2 = a1 - (*(_DWORD *)(a1 + 4) - 4);
  *a2 = v2 + 9;
  if ( strcmp((const char *)(v2 + 9), (const char *)&unk_80495BC)
