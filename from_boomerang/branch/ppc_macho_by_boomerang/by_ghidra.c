...

{
  ...
  __picsymbol_stub::_scanf("%d",local_14);
  if (local_1c == 5) {
    __picsymbol_stub::_printf("Equal\n");
  }
  if (local_1c != 5) {
    __picsymbol_stub::_printf("Not Equal\n");
  }
  if ((int)local_1c < 5) {
    __picsymbol_stub::_printf("Greater\n");
  }
  if (4 < (int)local_1c) {
    __picsymbol_stub::_printf("Less or Equal\n");
  }
  if ((int)local_1c < 6) {
    __picsymbol_stub::_printf("Greater or Equal\n");
  }
  if (5 < (int)local_1c) {
    __picsymbol_stub::_printf("Less\n");
  }
  if (local_14[0] < local_18) {
    __picsymbol_stub::_printf("Greater Unsigned\n");
  }
  if (local_18 <= local_14[0]) {
    __picsymbol_stub::_printf("Less or Equal Unsigned\n");
  }
  if (local_14[0] <= local_18) {
    __picsymbol_stub::_printf("Carry Clear\n");
  }
  if (local_18 < local_14[0]) {
    __picsymbol_stub::_printf("Carry Set\n");
  }
  if (-1 < (int)(5 - local_1c)) {
    __picsymbol_stub::_printf("Minus\n");
  }
  lVar1 = 5 - (ulonglong)local_1c;
  if ((int)lVar1 < 0) {
    __picsymbol_stub::_printf("Plus\n");
  }
  return lVar1;
}
