...

{
  ...
  FUN_000207e8(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_000207f4(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
// WARNING: Inlined function: FUN_000106ac
...
{
  IllegalInstructionTrap(0x207b8);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x207c4);
  return;
}
...
{
  IllegalInstructionTrap(0x207d0);
  return;
}



void FUN_000207dc(void)
