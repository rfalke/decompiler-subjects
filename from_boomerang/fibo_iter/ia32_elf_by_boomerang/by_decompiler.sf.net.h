// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/fibo_iter/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (804838C (ptr code) ptr804838C) (80483D0 (ptr code) ptr80483D0) (8048400 (ptr code) ptr8048400))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x080483D0 : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x08048400 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr804838C, dwArg00, fp + 0x00000004, &globals->ptr80483D0, &globals->ptr8048400, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr804838C;	// 804838C
	code * ptr80483D0;	// 80483D0
	code * ptr8048400;	// 8048400
} Eq_1;
