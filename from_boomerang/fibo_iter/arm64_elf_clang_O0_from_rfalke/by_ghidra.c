...

{
  ...
  if (1 < in_w0) {
    local_10 = 1;
    local_14 = 1;
    for (local_c = 2; local_c < in_w0; local_c = local_c + 1) {
...

{
  ...
  printf("Input number: ");
  __isoc99_scanf(&DAT_004007df,&stack0xffffffffffffffe8);
  uVar1 = fib(in_stack_ffffffffffffffe8);
  printf("fibonacci(%d) = %d\n",(ulong)in_stack_ffffffffffffffe8,(ulong)uVar1);
  return 0;
}
