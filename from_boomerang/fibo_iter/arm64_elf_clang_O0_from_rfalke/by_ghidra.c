...

{
  ...
  if (1 < x) {
    local_10 = 1;
    local_14 = 1;
    for (local_c = 2; local_c < x; local_c = local_c + 1) {
...
// WARNING: Variable defined which should be unmapped: value
...

{
  ...
  local_14 = 0;
  printf("Input number: ");
  __isoc99_scanf(&DAT_004007df,&local_18);
  uVar1 = fib(local_18);
  printf("fibonacci(%d) = %d\n",(ulong)local_18,(ulong)uVar1);
  return 0;
}
