...
// 0000000000400678: void main(Stack word64 qwArg00)
void main(word64 qwArg00)
{
	fn00000000004004E0();
	fn00000000004004D0();
	int32 dwLoc0C_5 = SLICE(x29, word32, 32);
	word32 w8_18 = dwLoc0C_5 - 0x02;
	if (dwLoc0C_5 >= 0x02 && dwLoc0C_5 >= 0x03)
	{
		do
			--w8_18;
		while (w8_18 != 0x00);
