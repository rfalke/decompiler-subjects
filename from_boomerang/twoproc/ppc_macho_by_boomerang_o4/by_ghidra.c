...
{
                    // WARNING: Could not recover jumptable at 0x00001b78. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001b88. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
                    ...
                    // WARNING: Treating indirect jump as call
  (*(code *)__la_symbol_ptr::_printf)("%i\n",7);
  return;
}



longlong _proc1(longlong param_1,longlong param_2)
