...
{
  __init_keymgr();
  if ((*(int *)(___keymgr_global + 8) == 0) || (*(ushort *)(*(int *)(___keymgr_global + 8) + 4) < 3)
     ) {
    __dyld_register_func_for_add_image(ZEXT48(PTR__darwin_unwind_dyld_add_image_hook_0000201c));
    __dyld_register_func_for_remove_image
              (ZEXT48(PTR__darwin_unwind_dyld_remove_image_hook_00002018));
  }
  return;
}
...

{
                    ...
                    // WARNING: Treating indirect jump as call
  (*(code *)__dyld_register_func_for_remove_image)();
  return;
}
