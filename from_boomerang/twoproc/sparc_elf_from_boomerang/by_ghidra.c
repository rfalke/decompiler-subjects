...

{
  ...
  uVar1 = proc1(0xb,4);
  printf(&DAT_00020858,uVar1,param_3,param_4,param_5,param_6);
  return;
}
...

{
  ...
  iVar1 = FUN_00010650(ctx);
  IllegalInstructionTrap(0x101d4);
  return iVar1;
}



void FUN_00010650(void)
...
{
  FUN_000106a0();
  IllegalInstructionTrap(0x10184);
  return;
}



void FUN_000106a0(void)
...
{
  IllegalInstructionTrap(0x2071c);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x20728);
  return;
}
...
{
  IllegalInstructionTrap(0x20734);
  return;
}
...
{
  IllegalInstructionTrap(0x20740);
  return (int)__format;
}
