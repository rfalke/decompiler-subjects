...
{
                    // WARNING: Could not recover jumptable at 0x00001b1c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001b2c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
  __picsymbolstub1::__init_keymgr();
  if ((*(int *)(__nl_symbol_ptr::___keymgr_global + 8) == 0) ||
     (*(ushort *)(*(int *)(__nl_symbol_ptr::___keymgr_global + 8) + 4) < 3)) {
    __picsymbolstub1::__dyld_register_func_for_add_image
              (PTR__darwin_unwind_dyld_add_image_hook_0000201c);
    __picsymbolstub1::__dyld_register_func_for_remove_image
...
longlong _proc1(uint param_1,uint param_2)
...
void __picsymbolstub1::__dyld_register_func_for_remove_image(void)
...
void __picsymbolstub1::__dyld_register_func_for_add_image(void)

{
                    // WARNING: Could not recover jumptable at 0x00001f1c. Too many branches
                    // WARNING: Treating indirect jump as call
...
void __picsymbolstub1::__init_keymgr(void)

{
                    // WARNING: Could not recover jumptable at 0x00001f3c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001f5c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001f7c. Too many branches
                    // WARNING: Treating indirect jump as call
...
void __picsymbolstub1::__keymgr_set_and_unlock_processwide_ptr(void)

{
                    // WARNING: Could not recover jumptable at 0x00001f9c. Too many branches
                    // WARNING: Treating indirect jump as call
...
void __picsymbolstub1::__keymgr_get_and_lock_processwide_ptr(void)

{
                    // WARNING: Could not recover jumptable at 0x00001fbc. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  void *pvVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x00001fdc. Too many branches
                    // WARNING: Treating indirect jump as call
...
int __picsymbolstub1::_printf(char *param_1,...)

{
  int iVar1;
  
                    // WARNING: Could not recover jumptable at 0x00001ffc. Too many branches
                    // WARNING: Treating indirect jump as call
