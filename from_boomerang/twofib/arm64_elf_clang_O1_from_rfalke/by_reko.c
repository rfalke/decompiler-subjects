...
// 0000000000400640: Register ui64 twofib(Register word32 w0, Register out Eq_89 x9Out)
// Called from:
//      twofib
//      main
ui64 twofib(word32 w0, union Eq_89 & x9Out)
{
	if (w0 == 0x00)
	{
		x9Out.u0 = 0x00;
	...
	{
		word64 x9_20;
		uint64 x0_16 = twofib(w0 - 0x01, out x9_20);
		ui64 x9_26 = SEQ(SLICE(x9_20, word32, 32), (word32) ((x0_16 >> 32) + x0_16));
		x9Out = x9_26 << 32;
		return x9_26 << 32 | x0_16 >> 32;
	}
}
...
void main(word64 x20)
{
	...
	fn00000000004004A0();
	word64 x9_58;
	twofib(SLICE(x20, word32, 32), out x9_58);
	fn00000000004004E0();
}
