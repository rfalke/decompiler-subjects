...
void main(word32 dwArg04)
{
	...
	word64 x1_51;
	twofib(SEQ(SLICE(fp + 0x04, word32, 32), dwArg04), SLICE((uint64) scanf("%d", 0x00), word32, 32), out x1_51);
...
// 00000000000008C8: Register ui64 twofib(Sequence Eq_21 x1_32_32_w0, Register word32 x0_32_32, Register out Eq_21 x1Out)
// Called from:
//      main
//      twofib
ui64 twofib(Eq_21 x1_32_32_w0, word32 x0_32_32, union Eq_21 & x1Out)
{
	...
	else
	{
		...
		Eq_21 x1_36 = SEQ(SLICE(x1_21, word32, 32), w2_26);
		x1Out = x1_36;
