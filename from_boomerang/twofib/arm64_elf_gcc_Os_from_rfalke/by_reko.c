...
// 00000000000008C8: Register ui64 twofib(Sequence Eq_29 x1_32_32_w0, Register word32 x0_32_32, Register out Eq_29 x1Out)
// Called from:
//      main
//      twofib
ui64 twofib(Eq_29 x1_32_32_w0, word32 x0_32_32, union Eq_29 & x1Out)
{
	...
	{
		word64 x1_21;
		int64 x0_20 = twofib(SEQ(x1_32_32, w0), x0_32_32, out x1_21);
		word32 w2_26 = (word32) (x0_20 >> 32);
		Eq_29 x1_36 = SEQ(SLICE(x1_21, word32, 32), w2_26);
		x1Out = x1_36;
		return x1_36 | SEQ(SLICE(x0_20, word32, 32), w2_26 + (word32) x0_20) << 32;
	}
}
