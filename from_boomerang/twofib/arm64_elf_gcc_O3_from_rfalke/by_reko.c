...
void main(word32 dwArg04)
{
	...
	fn00000000000006D0();
	word64 x1_54;
	twofib(SEQ(SLICE(fp + 0x04, word32, 32), dwArg04), SLICE(0x09E8, word32, 32), out x1_54);
	fn0000000000000720();
}
...
// 00000000000008C8: Register ui64 twofib(Sequence Eq_29 x1_32_32_w0, Register ui32 x0_32_32, Register out Eq_29 x1Out)
// Called from:
//      main
//      twofib
ui64 twofib(Eq_29 x1_32_32_w0, ui32 x0_32_32, union Eq_29 & x1Out)
{
	uint32 w0 = (word32) x1_32_32_w0;
	word32 x1_32_32 = SLICE(x1_32_32_w0, word32, 64);
	Eq_29 x1_51 = SEQ(x1_32_32, 0x01);
	if (w0 != 0x00)
	{
		...
		if (w0 != 0x01)
		{
			if (w0 != 0x02)
			{
				...
				Eq_29 x1_42 = SEQ(SLICE(x1_20, word32, 32), w0_29 + w2_30);
				x1Out = x1_42;
