...

{
  ...
  if (n == 0) {
    ...
    pVar1 = twofib(n + -1);
    local_30 = SUB84(pVar1,0);
    iStack44 = (int)((ulonglong)pVar1 >> 0x20);
    local_28 = iStack44;
    local_24 = iStack44 + local_30;
  }
  return (pair)CONCAT44(local_24,local_28);
}
...

{
  ...
  printf("Enter number: ");
  scanf("%d",&local_18);
  pVar1 = twofib(local_18);
  printf("Fibonacci of %d is %d\n",(ulonglong)local_18,(ulonglong)pVar1 & 0xffffffff);
  return 0;
}
