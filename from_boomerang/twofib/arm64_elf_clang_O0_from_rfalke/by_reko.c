...
// 0000000000400640: Register Eq_87 twofib(Register word32 w0, Register out ptr64 x29Out)
// Called from:
//      twofib
//      main
Eq_87 twofib(word32 w0, ptr64 & x29Out)
{
	struct Eq_90 * x29_17 = fp + -8;
	struct Eq_94 * sp_10 = fp - 0x38;
	if (w0 != 0x00)
	{
		sp_10 = (struct Eq_94 *) <invalid>;
