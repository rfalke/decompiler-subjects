...
{// addr = 0x1000034C
    __lr = __lr;
    __r1 = {;
    if(cr7 -  *((void*)(0x10010ab4))) {
        while(cr7 -  *((void*)(0 +  *((void*)(0x10010a30))))) {
            asm("bllr ");
        }
    }
    __r1 = __r1 + 32;
