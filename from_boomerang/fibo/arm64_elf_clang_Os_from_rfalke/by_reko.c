...
// 0000000000400640: Register int32 fib(Register int32 w0, Register out Eq_88 w19Out, Register out Eq_88 w20Out, Register out ptr64 x29Out)
// Called from:
//      fib
//      main
int32 fib(int32 w0, union Eq_88 & w19Out, union Eq_88 & w20Out, ptr64 & x29Out)
{
	if (w0 >= 0x02)
	{
		word32 w19_82;
		word32 w20_83;
		word64 x29_84;
		fib(w0 - 0x01, out w19_82, out w20_83, out x29_84);
		word64 x19_25 = <invalid>;
		word64 x20_36 = <invalid>;
		word32 w19_85;
		word32 w20_86;
		word64 x29_87;
		w0 = fib((word32) x19_25, out w19_85, out w20_86, out x29_87) + (word32) x20_36;
	}
	w19Out.u0 = <invalid>;
	w20Out.u0 = <invalid>;
	x29Out = qwLoc10;
...
// 0000000000400678: void main(Register word64 x20)
void main(word64 x20)
{
	...
	word32 w20_62;
	word64 x29_63;
	fib(SLICE(x20, word32, 32), out w19_61, out w20_62, out x29_63);
	fn00000000004004E0();
}
