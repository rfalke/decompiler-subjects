...

{
  ...
  int extraout_w9;
  ulonglong uVar8;
  ulonglong extraout_x10;
  int number;
  
  printf("Input number: ");
  __isoc99_scanf(&DAT_00100df0,&number);
  uVar8 = (ulonglong)(uint)number;
  if (number < 2) {
    x = 0;
  }
  else {
    ...
    do {
      ...
      if (uVar1 == 1) {
        ...
        uVar6 = (ulonglong)(number - 2);
        uVar3 = (ulonglong)((number + -4) - (uVar4 & 0xfffffffe));
        iVar2 = 0;
        uVar8 = uVar6;
        do {
          x = (int)uVar6;
  ...
  printf("fibonacci(%d) = %d\n",uVar8 & 0xffffffff,(ulonglong)(uint)(x + number));
  return 0;
}
