...
// 0000000000000888: Register int32 fib(Register int32 w0, Register out Eq_99 w19Out, Register out Eq_99 x29Out)
// Called from:
//      fib
//      main
int32 fib(int32 w0, union Eq_99 & w19Out, union Eq_99 & x29Out)
{
	int32 w0_17;
	if (w0 > 0x01)
	{
...
void main(int32 dwArg00)
{
	...
	word32 w19_48;
	word64 x29_49;
	fib(dwArg00, out w19_48, out x29_49);
	fn0000000000000730();
}
