...
void main(int32 dwArg04)
{
	...
	word32 w19_50;
	word32 w20_51;
	x0_35 = (uint64) printf("fibonacci(%d) = %d\n", dwArg04, fib(dwArg04, out w19_50, out w20_51));
}
...
// 00000000000008D0: Register int32 fib(Register int32 w0, Register out Eq_38 w19Out, Register out Eq_38 w20Out)
// Called from:
//      main
//      fib
int32 fib(int32 w0, union Eq_38 & w19Out, union Eq_38 & w20Out)
{
