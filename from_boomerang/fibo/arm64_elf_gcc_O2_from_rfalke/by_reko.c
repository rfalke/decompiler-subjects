...
void main(int32 dwArg04)
{
	...
	if (dwArg04 > 0x01)
	{
		do
		{
			...
			word64 x20_92;
			word64 x21_93;
			fib(w3_22 - 0x01, out x19_91, out x20_92, out x21_93);
			w3_22 -= 0x02;
		} while (w3_22 > 0x01);
	}
	fn0000000000000730();
...
// 00000000000008F8: Register int32 fib(Register int32 w0, Register out ptr64 x19Out, Register out ptr64 x20Out, Register out ptr64 x21Out)
// Called from:
//      main
//      fib
