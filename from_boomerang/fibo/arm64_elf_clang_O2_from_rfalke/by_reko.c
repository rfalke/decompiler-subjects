...
int32 fib(int32 w0, ptr64 & x19Out, ptr64 & x20Out, ptr64 & x29Out)
{
	if (w0 >= 0x02)
	{
		...
		word64 x20_82;
		word64 x29_83;
		fib(w0 - 0x01, out x19_25, out x20_82, out x29_83);
		word64 x20_36;
		word64 x19_84;
		word64 x29_85;
		w0 = fib((word32) x19_25, out x19_84, out x20_36, out x29_85) + (word32) x20_36;
	}
	x19Out = <invalid>;
	x20Out = <invalid>;
	x29Out = qwLoc10;
...
void main(word64 x20)
{
	...
	word64 x20_62;
	word64 x29_63;
	fib(SLICE(x20, word32, 32), out x19_61, out x20_62, out x29_63);
	fn00000000004004E0();
}
