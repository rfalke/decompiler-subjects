...
{
                    // WARNING: Could not recover jumptable at 0x00001ac0. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001ad0. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  if (1 < (int)param_1) {
    ...
    iVar1 = _fib((ulonglong)param_1 - 1);
    iVar2 = _fib((ulonglong)uStack00000018 - 2);
