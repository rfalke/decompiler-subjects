...
{// addr = 0x0001095C
    ...
    _exit();
    L4();
    _t27 =  *((void*)(0x10cf0 + __o7 + ("/usr/lib/ld.so.1" | 12)));
...
)
{
    ...
    _t37 = __i0;
    _t29 = __o3;
    _t31 =  *((void*)( *((void*)((_t34 | 200) + __o7 + ("/usr/lib/ld.so.1" | 24)))));
    if(_t31 - "/usr/lib/ld.so.1") {
        __l1 = _t37;
        if( *_t31 - "/usr/lib/ld.so.1") {
...
{// addr = 0x00011444
    ...
    __i0 = __i0;
    L1();
    _t14 =  *((void*)(( &_START_ | 636) + __o7 + ("/usr/lib/ld.so.1" | 24)));
...
)
{
    ...
    __i7 = __i7;
    __i0 = __i0;
    _t18 =  *((void*)((__l7 | 636) + __o7 + ("/usr/lib/ld.so.1" | 24)));
...
{// addr = 0x000115EC
    ...
    __i7 = __i7;
    L1();
    _t7 =  *((void*)(( &_START_ | 212) + __o7 + ("/usr/lib/ld.so.1" | 28)));
...
)
{
    ...
    __i7 = __i7;
    if( *((void*)( *((void*)((__l7 | 212) + __o7 + ("/usr/lib/ld.so.1" | 28))) - 4)) - 4294967295) {
        _t12 = 0x1201ffffc;
        while(1) {
