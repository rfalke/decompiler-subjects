...
// 0000000000000888: Register int32 fib(Register int32 w0, Register out Eq_99 w19Out, Register out Eq_99 w20Out)
// Called from:
//      fib
//      main
int32 fib(int32 w0, union Eq_99 & w19Out, union Eq_99 & w20Out)
{
	if (w0 <= 0x01)
	{
		w19Out.u0 = <invalid>;
...
// 00000000000008C8: void main(Stack int32 dwArg04)
void main(int32 dwArg04)
{
	...
	word32 w19_53;
	word32 w20_54;
	fib(dwArg04, out w19_53, out w20_54);
	fn0000000000000730();
}
