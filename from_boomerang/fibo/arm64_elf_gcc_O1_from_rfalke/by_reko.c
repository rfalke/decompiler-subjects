...
// 0000000000000888: Register int32 fib(Register int32 w0, Register out Eq_112 w19Out, Register out Eq_112 w20Out)
// Called from:
//      fib
//      main
...
void main(int32 dwArg04)
{
	...
	word32 w19_56;
	word32 w20_57;
	x0_39 = (uint64) printf("fibonacci(%d) = %d\n", (word32) x19_24, fib(dwArg04, out w19_56, out w20_57));
}
