...
{
	struct Eq_89 * x29_31 = fp + -8;
	if (w0 > 0x01)
	{
		word64 x29_66;
		word32 w0_23 = fib(w0 - 0x01, out x29_66);
		struct Eq_103 * sp_20 = (struct Eq_103 *) <invalid>;
		word32 w8_26 = sp_20->dw0008;
		sp_20->dw0004 = w0_23;
		struct Eq_103 * sp_30 = (struct Eq_103 *) <invalid>;
...
void main(word32 w29)
{
	fn00000000004004E0();
	fn00000000004004D0();
	struct Eq_139 * x29_30;
	x29_30->dwFFFFFFF4 = fib((word32) x29, out x29_30);
	fn00000000004004E0();
	struct Eq_103 * sp_28 = (struct Eq_103 *) <invalid>;
	sp_28->dw0008 = (word32) 0x004007BA;
}
