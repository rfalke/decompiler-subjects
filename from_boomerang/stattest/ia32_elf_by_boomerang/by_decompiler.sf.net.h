// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/stattest/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (804835C (ptr code) ptr804835C) (8048394 (ptr code) ptr8048394) (80483C4 (ptr code) ptr80483C4))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x08048394 : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x080483C4 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr804835C, dwArg00, fp + 0x00000004, &globals->ptr8048394, &globals->ptr80483C4, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr804835C;	// 804835C
	code * ptr8048394;	// 8048394
	code * ptr80483C4;	// 80483C4
} Eq_1;
