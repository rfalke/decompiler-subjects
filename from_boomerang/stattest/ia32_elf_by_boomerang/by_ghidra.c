...
int __regparm3 main(undefined4 param_1,undefined4 param_2)

{
  int iVar1;
  stat local_6c;
  
  iVar1 = __xstat(3,"test/source/stattest.c",&local_6c);
  printf("Stat returns %d; size of file is %d\n",iVar1,local_6c.st_size,param_2);
  return iVar1;
}



// WARNING: Removing unreachable block (ram,0x080483b1)
// WARNING: Removing unreachable block (ram,0x080483b4)
...
// WARNING: Removing unreachable block (ram,0x080483f6)
