...

{
  ...
  auStack112._100_4_ = (undefined4)((ulonglong)unaff_r29 >> 0x20);
  uStack8 = (undefined4)((ulonglong)unaff_r30 >> 0x20);
  uStack4 = (undefined4)((ulonglong)unaff_r31 >> 0x20);
  iVar1 = __picsymbol_stub::_stat("test/source/stattest.c",(stat *)auStack112);
  __picsymbol_stub::_printf
            ("Stat returns %d; size of file is %d\n",iVar1,(ulonglong)auStack112._48_4_,
             (ulonglong)auStack112._52_4_);
  return iVar1;
}
