...

{
  ...
  iVar1 = __picsymbol_stub::_stat("test/source/stattest.c",&sStack_70);
  __picsymbol_stub::_printf
            ("Stat returns %d; size of file is %d\n",iVar1,
             (ulonglong)(uint)sStack_70.st_ctimespec.tv_nsec,
             (ulonglong)(uint)sStack_70.st_birthtimespec.tv_sec);
  return iVar1;
}
