...

{
  undefined4 param_11;
  undefined4 param_12;
  undefined auStack_80 [128];
  
  param_11 = param_1;
  param_12 = param_2;
  auStack_80._96_4_ = __picsymbol_stub::_stat("test/source/stattest.c",(stat *)auStack_80);
  __picsymbol_stub::_printf
            ("Stat returns %d; size of file is %d\n",(ulonglong)(uint)auStack_80._96_4_,
             (ulonglong)(uint)auStack_80._48_4_,(ulonglong)(uint)auStack_80._52_4_);
  return auStack_80._96_4_;
}
