...
void main()
{
	__stat("test/source/stattest.c", fp + ~0x7F);
	x0_27 = (uint64) printf("Stat returns %d; size of file is %d\n", 0x00);
}
...
// 0000000000000940: void __stat(Register (ptr64 char) x0, Register (ptr64 Eq_112) x1)
// Called from:
//      main
