...

{
  ...
  FUN_00020848(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_00020854(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...

{
  ...
  iVar1 = stat("test/source/stattest.c",&sStack152);
  printf("Stat returns %d; size of file is %d\n",iVar1,sStack152.st_blksize);
  return iVar1;
}
...
// WARNING: Inlined function: FUN_000106e0
...
{
  IllegalInstructionTrap(0x20818);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x20824);
  return;
}
...
{
  IllegalInstructionTrap(0x20860);
  return (int)__file;
}
...
{
  IllegalInstructionTrap(0x2086c);
  return (int)__format;
}
