...
{
	struct Eq_39 * l7_114 = fn0001054C(o7, 66144);
...
// 000106E8: Register (ptr word32) __do_global_ctors_aux(Register word32 o7)
word32 * __do_global_ctors_aux(word32 o7)
{
	word32 * l0_30;
	struct Eq_164 * l7_22 = fn000106E0(o7, 0x000100CC);
	struct Eq_169 * o1_25 = l7_22->ptr0018;
...
// 000207E8: void _PROCEDURE_LINKAGE_TABLE_()
