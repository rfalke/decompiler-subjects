...

{
  ...
  uVar1 = stat("test/source/stattest.c",(stat *)&stack0xffffffffffffff60);
  printf("Stat returns %d; size of file is %d\n",(ulong)uVar1,local_70);
  return (int)uVar1;
}



void FUN_0040068c(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x0040068c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x40068c);
