...
void main()
{
	word64 qwLocA0;
	word64 qwLoc70;
	printf("Stat returns %d; size of file is %d\n", stat("test/source/stattest.c", &qwLocA0), (int32) qwLoc70);
}

// 0000000000400690: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
...
// 0000000000400710: Register int32 stat(Register (ptr64 char) x0, Register (ptr64 Eq_102) x1)
// Called from:
//      main
