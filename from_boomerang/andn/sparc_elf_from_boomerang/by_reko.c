...
void _start( * g1, word32 o7, word32 dwArg40)
{
	if (g1 == null)
	{
		atexit(&globals->t10748);
		int32 l0_18 = _init(o7);
		globals->ptr20944 = fp + 0x44 + ((l0_18 << 0x02) + 0x04);
		main();
		exit(l0_18);
	}
	else
...
{
	struct Eq_40 * l7_136 = fn00010510(o7, 66164);
...
{
	struct Eq_40 * l7_22 = fn00010510(o7, 0x000101B4);
...
{
	word32 * l0_30;
	struct Eq_231 * l7_22 = fn000106C4(o7, 0x000100C0);
