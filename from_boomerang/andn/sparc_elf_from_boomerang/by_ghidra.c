...
// WARNING: Inlined function: FUN_00010510
...

{
  ...
  FUN_00020820(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_0002082c(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
// WARNING: Inlined function: FUN_000106c4
...
{
  IllegalInstructionTrap(0x207f0);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x207fc);
  return;
}
...
{
  IllegalInstructionTrap(0x20808);
  return;
}



void FUN_00020814(void)
