...
void main()
{
	x0_12 = (uint64) printf("a andn b is %d\n", 0x00);
	x0_17 = (uint64) printf("b orn  a is %d\n", 0x00);
	x0_23 = (uint64) printf("a xorn c is %d\n", 0x00);
}

// 0000000000000740: void _start(Register (ptr64 Eq_29) x0, Stack Eq_30 qwArg00)
