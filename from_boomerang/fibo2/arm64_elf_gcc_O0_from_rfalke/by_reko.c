...
// 0000000000000888: Register int32 fib1(Register out Eq_112 w19Out, Register out Eq_112 x29Out)
// Called from:
//      fib2
//      main
int32 fib1(union Eq_112 & w19Out, union Eq_112 & x29Out)
{
	int32 w0_16 = fib2(w0);
	w19Out.u0 = <invalid>;
	x29Out.u0 = <invalid>;
...
// 00000000000008F4: void main(Stack int32 dwArg00)
void main(int32 dwArg00)
{
	x0_12 = (uint64) printf("Input number: ");
	x0_17 = (uint64) __isoc99_scanf("%d", fp);
	word32 w19_46;
	word64 x29_47;
	x0_30 = (uint64) printf("fibonacci(%d) = %d\n", dwArg00, fib1(out w19_46, out x29_47));
}
