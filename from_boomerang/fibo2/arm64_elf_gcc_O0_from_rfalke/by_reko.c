...
// 0000000000000888: Register int32 fib1(Register out ptr64 x19Out, Register out ptr64 x29Out)
// Called from:
//      fib2
//      main
int32 fib1(ptr64 & x19Out, ptr64 & x29Out)
{
	int32 w0_16 = fib2(w0);
	x19Out = <invalid>;
	x29Out = <invalid>;
