...
// 0000000000000888: Register int32 fib1(Register out Eq_110 w19Out, Register out Eq_110 x29Out)
// Called from:
//      fib2
//      main
int32 fib1(union Eq_110 & w19Out, union Eq_110 & x29Out)
{
	int32 w0_16 = fib2(w0);
	w19Out.u0 = <invalid>;
	x29Out.u0 = <invalid>;
...
void main()
{
	...
	word32 w19_44;
	word64 x29_45;
	fib1(out w19_44, out x29_45);
	x0_26 = (uint64) printf("fibonacci(%d) = %d\n", 0x00);
}
