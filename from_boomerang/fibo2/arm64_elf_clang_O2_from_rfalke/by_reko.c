...
// 0000000000400644: Register int32 fib2(Register int32 w0, Register out Eq_105 w19Out, Register out Eq_105 w20Out, Register out ptr64 x29Out)
// Called from:
//      fib1
//      fib2
//      main
int32 fib2(int32 w0, union Eq_105 & w19Out, union Eq_105 & w20Out, ptr64 & x29Out)
{
	if (w0 >= 0x02)
	{
		word32 w19_82;
...
void main()
{
	x0_19 = (uint64) printf("Input number: ", 0x00);
	x0_24 = (uint64) __isoc99_scanf("%d", 0x00);
	word32 w19_60;
	word32 w20_61;
	word64 x29_62;
	fib2(dwLoc2C, out w19_60, out w20_61, out x29_62);
