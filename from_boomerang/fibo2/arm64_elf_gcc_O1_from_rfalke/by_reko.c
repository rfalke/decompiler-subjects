...
// 0000000000000888: Register int32 fib2(Register int32 w0, Register out Eq_110 w19Out, Register out Eq_110 w20Out)
// Called from:
//      fib2
//      fib1
//      main
int32 fib2(int32 w0, union Eq_110 & w19Out, union Eq_110 & w20Out)
{
	if (w0 <= 0x01)
	{
		w19Out.u0 = <invalid>;
...
void main(int32 dwArg04)
{
	...
	word32 w19_54;
	word32 w20_55;
	fib2(dwArg04, out w19_54, out w20_55);
