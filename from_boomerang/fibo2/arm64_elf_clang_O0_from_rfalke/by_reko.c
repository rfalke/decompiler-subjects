...
{
	ptr64 * x29_15;
	int32 w0_17 = fib2(w0, out x29_15);
	x29Out = *x29_15;
	return w0_17;
}
...
int32 fib2(int32 w0, ptr64 & x29Out)
{
	...
	{
		word64 x29_69;
		x29_31->dwFFFFFFFC = fib1(out x29_69) + fib1(out x29_31);
	}
...
void main()
{
	fn00000000004004E0();
	fn00000000004004D0();
	struct Eq_131 * x29_30;
	x29_30->dwFFFFFFF4 = fib1(out x29_30);
	fn00000000004004E0();
	struct Eq_140 * sp_28 = (struct Eq_140 *) <invalid>;
	sp_28->dw0008 = (word32) 0x004007E2;
}
