...
void fib1(int32 w0)
{
	...
	word64 x20_12;
	word64 x29_13;
	fib2(w0, out x19_11, out x20_12, out x29_13);
}

// 0000000000400644: Register int32 fib2(Register int32 w0, Register out ptr64 x19Out, Register out ptr64 x20Out, Register out ptr64 x29Out)
// Called from:
//      fib1
//      fib2
//      main
int32 fib2(int32 w0, ptr64 & x19Out, ptr64 & x20Out, ptr64 & x29Out)
{
	if (w0 >= 0x02)
	{
		word64 x20_24;
