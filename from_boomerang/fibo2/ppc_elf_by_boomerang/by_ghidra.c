...
undefined4 fib1(undefined4 param_1)
...

{
  ...
  local_14 = param_1;
  if (1 < param_1) {
    local_14 = fib1(param_1 + -1);
    iVar1 = fib1(param_1 + -2);
...
// WARNING: Removing unreachable block (ram,0x100005d0)
...
// WARNING: Removing unreachable block (ram,0x10000664)
