...
{
                    // WARNING: Could not recover jumptable at 0x00001a94. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001aa4. Too many branches
                    // WARNING: Treating indirect jump as call
...
longlong _fib1(longlong param_1)

{
  longlong lVar1;
  
  if (1 < (int)param_1) {
    lVar1 = _fib1(param_1 + -1);
    param_1 = _fib1(param_1 + -2);
...
longlong _fib2(longlong param_1)
