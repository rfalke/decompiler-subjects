...
// WARNING: Inlined function: FUN_00010598
...

{
  ...
  FUN_000208dc(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_000208e8(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
int fib1(int param_1)

{
  int iVar1;
  
  if (1 < param_1) {
    iVar1 = fib1(param_1 + -1);
    param_1 = fib1(param_1 + -2);
...
// WARNING: Inlined function: FUN_00010784
...
// WARNING: Removing unreachable block (ram,0x000107ec)
...
{
  IllegalInstructionTrap(0x208c4);
  return;
}
...
{
  IllegalInstructionTrap(0x208f4);
  return (int)__format;
}
...
{
  IllegalInstructionTrap(0x20900);
  return (int)__format;
}
