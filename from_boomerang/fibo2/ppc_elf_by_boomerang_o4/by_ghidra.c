...

{
  ...
  iVar1 = fib2(param_1 + -1);
  iVar2 = fib2(param_1 + -2);
  return iVar1 + iVar2;
}
...
// WARNING: Removing unreachable block (ram,0x10000568)
// WARNING: Removing unreachable block (ram,0x10000564)
...
// WARNING: Removing unreachable block (ram,0x100005f8)
