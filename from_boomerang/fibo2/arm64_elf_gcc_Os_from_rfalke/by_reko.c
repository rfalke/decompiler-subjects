...
void main(int32 dwArg04)
{
	...
	word64 x19_47;
	word64 x20_48;
	fib2(dwArg04, out x19_47, out x20_48);
	fn0000000000000730();
}
...
// 00000000000008D0: Register int32 fib2(Register int32 w0, Register out ptr64 x19Out, Register out ptr64 x20Out)
// Called from:
//      main
//      fib2
//      fib1
int32 fib2(int32 w0, ptr64 & x19Out, ptr64 & x20Out)
{
	...
	while (true)
	{
		...
		word64 x19_46;
		word64 x20_47;
		x20_71 = SEQ(SLICE(x20_47, word32, 32), (word32) x20_47 + fib2(w19_17 - 0x01, out x19_46, out x20_47));
	}
	x19Out = qwLoc10;
	x20Out = x19;
