...
void foo2(undefined4 param_1,undefined4 param_2)

{
  b = 0xc;
  printf("a = %lld\n",param_2,a._0_4_,a._4_4_);
  return;
}
...
// WARNING: Removing unreachable block (ram,0x10000540)
// WARNING: Removing unreachable block (ram,0x1000053c)
