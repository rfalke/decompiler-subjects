...
{
                    // WARNING: Could not recover jumptable at 0x00001b7c. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001b8c. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  do {
    lVar1 = lVar1 + 1;
    __picsymbol_stub::_printf("%d ",lVar1);
  } while ((int)lVar1 < 10);
