...
void call_gmon_start() {
    ...
    fun_80482a6();
    eax1 = *reinterpret_cast<int32_t*>(eax2 + 0x126e + 20);
    if (eax1) {
        eax1();
    }
    return;
...
int32_t __do_global_ctors_aux() {
    ...
    v1 = edx2;
    eax3 = __CTOR_LIST__;
    ebx4 = reinterpret_cast<int32_t*>(0x8049500);
    if (eax3 != -1) {
        do {
            --ebx4;
            eax3();
...
void fun_80482a6() {
    ...
    eax1 = *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(__return_address()) + 0x126e + 20);
    if (eax1) {
        eax1();
    }
    goto ebp2->f4;
...
/* p.0 */
int32_t* p_0 = reinterpret_cast<int32_t*>(0x804950c);
...
int32_t __libc_csu_init() {
    ...
    if (!1) {
        do {
            eax1 = reinterpret_cast<int32_t>(*reinterpret_cast<int32_t*>(ebx2 * 4 + 0x804942c)());
            ++ebx2;
        } while (ebx2 < 0);
    }
    return eax1;
...
void __libc_csu_fini() {
    ...
    if (0) {
        do {
            *reinterpret_cast<int32_t*>(ebx8 * 4 + 0x804942c)(v6);
            edx9 = ebx8;
            --ebx8;
        } while (edx9);
    }
    fun_80483f6(edx9, v4, v2, v1);
}
