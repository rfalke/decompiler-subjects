 ...
 *	Input file: './from_boomerang/fromssa2/sparc_elf_from_boomerang/subject.exe'
 */
...
/*	Procedure: 0x00010684 - 0x000106CF
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
main()
{
    ...
    *ecx = *ecx & al;
    ...
    asm("xchg eax,edx");
    asm("adc [eax],al");
    asm("sbb [eax+0x40920a6],al");
    edi = 277937151;
    *eax = *eax + bl;
    eax = eax + *eax;
    *(ecx - 110) = *(ecx - 110) + al;
    asm("adc [eax],al");
    asm("sbb [eax+edx+0x401800],dl");
    eax = eax + 1;
    (restore)ebx;
    asm("adc [ebx+0x70],ah");
    edi = edi + -393148192;
...
/*	Procedure: 0x000106D0 - 0x0001071F
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/* DEST BLOCK NOT FOUND: 00010721 -> 000106e2 */
/*	Procedure: 0x00010720 - 0x0001072F
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/*	Procedure: 0x00010730 - 0x0001074B
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/*	Procedure: 0x0001074C - 0x0001075F
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/* 0x00010684      76 */ /* unknown */ void 	main;
/* 0x000106d0      80 */ /* unknown */ void 	__do_global_ctors_aux;
/* 0x00010720      16 */ /* unknown */ void 	call___do_global_ctors_aux;
/* 0x00010730      28 */ /* unknown */ void 	_init;
/* 0x0001074c       1 */ /* unknown */ void 	_fini;
/* 0x00010760       4 */ /* unknown */ void 	_lib_version;
/* 0x00010782       0 */ /* unknown */ void 	_etext;
