...
{
	struct Eq_39 * l7_114 = fn00010528(o7, 66120);
...
{
	struct Eq_39 * l7_22 = fn00010528(o7, 0x00010188);
...
{
	word32 * l0_30;
	struct Eq_170 * l7_22 = fn000106C8(o7, 0x000100A8);
	struct Eq_175 * o1_25 = l7_22->ptr0018;
...
// 000207AC: void _PROCEDURE_LINKAGE_TABLE_()
