...
void main()
{
	x0_18 = (uint64) printf("%d ", 0x00);
	x0_21 = (uint64) printf("%d ", 0x00);
	x0_24 = (uint64) printf("%d ", 0x00);
	x0_27 = (uint64) printf("%d ", 0x00);
	x0_30 = (uint64) printf("%d ", 0x00);
	x0_33 = (uint64) printf("%d ", 0x00);
	x0_36 = (uint64) printf("%d ", 0x00);
	x0_39 = (uint64) printf("%d ", 0x00);
	x0_42 = (uint64) printf("%d ", 0x00);
	x0_45 = (uint64) printf("%d ", 0x00);
	x0_51 = (uint64) printf("a is %d, x is %d\n", 0x00);
}
