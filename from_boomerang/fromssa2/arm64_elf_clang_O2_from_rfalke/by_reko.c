...
void main()
{
	x0_21 = (uint64) printf("%d ", 0x01);
	x0_26 = (uint64) printf("%d ", 0x02);
	x0_31 = (uint64) printf("%d ", 0x03);
	x0_36 = (uint64) printf("%d ", 0x04);
	x0_41 = (uint64) printf("%d ", 0x05);
	x0_46 = (uint64) printf("%d ", 0x06);
	x0_51 = (uint64) printf("%d ", 0x07);
	x0_56 = (uint64) printf("%d ", 0x08);
	x0_61 = (uint64) printf("%d ", 0x09);
	x0_66 = (uint64) printf("%d ", 0x0A);
	x0_75 = (uint64) printf("a is %d, x is %d\n", 0x0A, 0x0A);
}
