...
{
                    // WARNING: Could not recover jumptable at 0x00001b60. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  do {
    local_20 = local_20 + 1;
    __picsymbol_stub::_printf("%d ",(ulonglong)local_20);
  } while ((int)local_20 < 10);
  __picsymbol_stub::_printf("a is %d, x is %d\n",(ulonglong)local_20,(ulonglong)local_20);
  return 0;
}
