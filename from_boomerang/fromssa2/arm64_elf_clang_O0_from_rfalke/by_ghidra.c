...

{
  ...
  printf("a is %d, x is %d\n",(ulong)local_18,(ulong)local_18);
  return 0;
}



void FUN_00400654(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x00400654. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x400654);
