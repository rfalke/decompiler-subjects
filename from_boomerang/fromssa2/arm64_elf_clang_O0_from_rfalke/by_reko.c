...
void main()
{
	...
	do
	{
		++dwLoc18_53;
		printf("%d ", dwLoc18_53);
	} while (dwLoc18_53 < 0x0A);
	printf("a is %d, x is %d\n", dwLoc18_53, dwLoc18_53);
}

// 0000000000400658: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
