 ...
 *	Input file: './from_boomerang/sumarray/ia32_elf_by_boomerang/subject.exe'
 */
...
/*	Procedure: 0x08048328 - 0x0804837D
 *	Argument size: -8
 *	Local size: 8
 *	Save regs size: 0
 */
...
main()
{
    ...
    esp = esp;
    Vfffffffc = 0;
    for(Vfffffff8 = 0; Vfffffff8 <= 9; *( & Vfffffff8) = *( & Vfffffff8) + 1) {
        *( & Vfffffffc) = *( & Vfffffffc) + *(Vfffffff8 * 4 + a);
    }
    esp = esp - 8;
    (save)Vfffffffc;
    (save)0x804842c;
...
/*	Procedure: 0x0804837E - 0x0804837F
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/* 0x08048328      88 */ /* unknown */ void 	main;
...
/* 0x08048438       0 */ /* unknown */ void 	__EH_FRAME_BEGIN__;
/* 0x08048438       0 */ /* unknown */ void 	__FRAME_END__;
/* 0x08049440       0 */ /* unknown */ void 	data_start;
/* 0x08049440       0 */ /* unknown */ void 	__data_start;
/* 0x08049444       0 */ /* unknown */ void 	__dso_handle;
/* 0x08049448       0 */ /* unknown */ void 	p.0;
/* 0x08049460      40 */ /* unknown */ void 	a;
