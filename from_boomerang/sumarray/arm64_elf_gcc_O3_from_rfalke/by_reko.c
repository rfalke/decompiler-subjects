...
Eq_20 g_t11050 = // 0000000000011050
	{
...
void main()
{
	x0_31 = (uint64) printf("Sum is %d\n", __sum_i32(__add_i32(g_t11040, g_t11050)) + g_dw11060 + g_dw11064);
}

// 0000000000000738: void _start(Register (ptr64 Eq_36) x0, Stack word32 dwArg00)
