...

{
  ...
  _iVar1 = a._0_8_;
  iVar1 = (int)a._0_8_ + (int)a._16_8_;
  iVar1 = (int)((ulonglong)a._0_8_ >> 0x20) + (int)((ulonglong)a._16_8_ >> 0x20);
  uVar2 = (int)_iVar1 + (int)((ulonglong)_iVar1 >> 0x20) +
          (int)a._8_8_ + (int)a._24_8_ +
          (int)((ulonglong)a._8_8_ >> 0x20) + (int)((ulonglong)a._24_8_ >> 0x20);
  printf((char *)(ulonglong)uVar2,a._16_8_,"Sum is %d\n",(ulonglong)(uVar2 + a[8] + a[9]));
  return 0;
}
