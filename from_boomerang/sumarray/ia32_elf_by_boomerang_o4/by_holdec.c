...
??? _start(???)
{
  ...
  (void) STORE(local + 24, 134513496);
  (void) STORE(local + 28, 134513544);
...
??? __libc_csu_init(???)
{
  ...
  if(reg_var1  <  reg_result) {
    do {
      reg_result = intern_redirectCall(LOAD(reg_var1 * 4 + 134517780));
      reg_var1++;
