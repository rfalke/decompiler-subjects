...
// WARNING: Inlined function: FUN_00010540
...

{
  ...
  FUN_00020854(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_00020860(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...

{
  ...
  local_18 = 0;
  while (local_18 < 10) {
    local_14 = local_14 + *(int *)(a + local_18 * 4);
    local_18 = local_18 + 1;
  }
  printf("Sum is %d\n",local_14);
  return 0;
...
// WARNING: Inlined function: FUN_0001071c
