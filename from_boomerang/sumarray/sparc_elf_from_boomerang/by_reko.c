...
{
	struct Eq_40 * l7_136 = fn00010540(o7, 66168);
...
{
	struct Eq_40 * l7_22 = fn00010540(o7, 0x000101B8);
...
void main()
{
	...
	int32 dwLoc18_20;
	for (dwLoc18_20 = 0x00; dwLoc18_20 <= 0x09; ++dwLoc18_20)
		dwLoc14_19 += globals->a2093C[dwLoc18_20 * 0x04];
	printf("Sum is %d\n", dwLoc14_19);
}
...
// 00010724: Register (ptr32 word32) __do_global_ctors_aux(Register word32 o7)
word32 * __do_global_ctors_aux(word32 o7)
{
	word32 * l0_30;
	struct Eq_240 * l7_22 = fn0001071C(o7, 0x0001009C);
