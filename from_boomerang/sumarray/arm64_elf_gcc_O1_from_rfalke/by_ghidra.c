...

{
  ...
  uVar2 = 0;
  do {
    uVar2 = (ulong)(uint)((int)uVar2 + *(int *)((long)a + lVar1));
    lVar1 = lVar1 + 4;
  } while (lVar1 != 0x28);
  printf("Sum is %d\n",uVar2);
  return 0;
...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x0010087c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x10087c);
