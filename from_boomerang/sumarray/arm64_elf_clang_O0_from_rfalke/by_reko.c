...
word32 g_a411030[] = // 0000000000411030
	{
	};
// subject_fini.c
// Generated by decompiling subject.exe
...
{
	word16 wLoc1E;
	int32 dwLoc18_52 = 0x00;
	int32 dwLoc1C_53 = 0x00;
	while (true)
	{
		int32 dwLoc1E_61 = SEQ((word16) dwLoc1C_53, wLoc1E);
		if (dwLoc1C_53 >= 0x0A)
			break;
		dwLoc18_52 += g_a411030[(int64) dwLoc1E_61 * 0x04];
		++dwLoc1C_53;
	}
	printf("Sum is %d\n", dwLoc18_52);
}

// 0000000000400668: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
