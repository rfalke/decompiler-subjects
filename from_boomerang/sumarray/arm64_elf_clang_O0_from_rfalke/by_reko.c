...
void main()
{
	int32 dwLoc10_55 = 0x00;
	int32 dwLoc14_56 = 0x00;
	while (true)
	{
		int32 dwLoc16_64 = SEQ((word16) dwLoc14_56, wLoc16);
		if (dwLoc14_56 >= 0x0A)
			break;
		dwLoc10_55 += g_a411030[(int64) dwLoc16_64 * 0x00];
		++dwLoc14_56;
	}
	x0_24 = (uint64) printf("Sum is %d\n", dwLoc10_55);
}
