...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x00400664. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x400664);
