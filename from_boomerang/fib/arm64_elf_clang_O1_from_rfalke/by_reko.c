...
// 000000000040060C: Register int32 fib(Register int32 w0, Register out Eq_103 w19Out, Register out Eq_103 w20Out)
// Called from:
//      main
//      fib
int32 fib(int32 w0, union Eq_103 & w19Out, union Eq_103 & w20Out)
{
	if (w0 >= 0x02)
	{
		word32 w20_82;
