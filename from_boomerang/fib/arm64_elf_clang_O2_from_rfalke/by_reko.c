...
// 000000000040060C: Register int32 fib(Register int32 w0, Register out Eq_90 w19Out, Register out Eq_90 w20Out)
// Called from:
//      main
//      fib
int32 fib(int32 w0, union Eq_90 & w19Out, union Eq_90 & w20Out)
{
	if (w0 >= 0x02)
	{
		word32 w20_82;
		...
		word32 w19_83;
		word32 w20_84;
		w0 = fib((word32) x19_25, out w19_83, out w20_84) + (word32) x20_36;
	}
	w19Out.u0 = <invalid>;
	w20Out.u0 = <invalid>;
	return w0;
