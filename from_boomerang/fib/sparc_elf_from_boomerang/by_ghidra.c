...

{
  ...
  FUN_00020824(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_00020830(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
// WARNING: Inlined function: FUN_000106f4
...
{
  IllegalInstructionTrap(0x2080c);
  return;
}
