...
{
	struct Eq_40 * l7_136 = fn00010540(o7, 66120);
...
{
	struct Eq_40 * l7_22 = fn00010540(o7, 0x00010188);
...
{
	word32 * l0_30;
	struct Eq_263 * l7_22 = fn000106F4(o7, 0x00010094);
	struct Eq_268 * o1_25 = l7_22->ptr0018;
