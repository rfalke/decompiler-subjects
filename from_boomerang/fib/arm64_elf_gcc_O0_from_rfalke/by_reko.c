...
void main()
{
	word32 w19_34;
	word64 x29_35;
	x0_22 = (uint64) printf("%i\n", fib(0x0A, out w19_34, out x29_35));
}

// 0000000000000864: Register int32 fib(Register int32 w0, Register out Eq_121 w19Out, Register out Eq_121 x29Out)
// Called from:
//      main
//      fib
int32 fib(int32 w0, union Eq_121 & w19Out, union Eq_121 & x29Out)
{
	int32 w0_37;
	if (w0 <= 0x01)
		w0_37 = w0;
