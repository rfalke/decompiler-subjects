...
void main()
{
	word32 w19_32;
	word64 x29_33;
	fib(0x0A, out w19_32, out x29_33);
	x0_20 = (uint64) printf("%i\n", 0x00);
}

// 0000000000000864: Register int32 fib(Register int32 w0, Register out Eq_114 w19Out, Register out Eq_114 x29Out)
// Called from:
//      main
//      fib
int32 fib(int32 w0, union Eq_114 & w19Out, union Eq_114 & x29Out)
{
	int32 w0_37;
	if (w0 <= 0x01)
		w0_37 = w0;
