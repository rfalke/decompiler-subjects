...
void main()
{
	...
	for (w2_12 = 0x09; w2_12 != 0x01; w2_12 -= 0x02)
	{
		...
		word64 x20_50;
		word64 x21_51;
		fib(w2_12, out x19_49, out x20_50, out x21_51);
	}
	fn00000000000006E0();
}
...
// 0000000000000878: Register int32 fib(Register int32 w0, Register out ptr64 x19Out, Register out ptr64 x20Out, Register out ptr64 x21Out)
// Called from:
//      main
//      fib
int32 fib(int32 w0, ptr64 & x19Out, ptr64 & x20Out, ptr64 & x21Out)
{
	word32 w20_22;
	int32 w21_14 = w0;
	if (w0 > 0x01)
	{
		...
		do
		{
			...
			word64 x19_40;
			word64 x20_41;
			w20_22 = (word32) x20_41 + fib(w19_23 - 0x01, out x19_40, out x20_41, out x21_39);
		} while (w19_23 > 0x01);
		w21_14 = w21_48 & 0x01;
	}
	else
