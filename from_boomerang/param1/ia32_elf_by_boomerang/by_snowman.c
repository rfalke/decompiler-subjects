...
int32_t call_gmon_start(int32_t ecx) {
    ...
    if (*reinterpret_cast<int32_t*>(ecx + 0x126e - 4)) {
        fun_80482c8();
    }
    return ebx2;
}
...
/* p.4582 */
int32_t* p_4582 = reinterpret_cast<int32_t*>(0x80494a0);
...
void fun_8048306(int32_t a1, int32_t a2) {
    ...
    if (*reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(__return_address()) + 0x126e - 4)) {
        fun_80482c8();
    }
    goto ebp3->f4;
}
...
void fun_8048466(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    struct s1* ebp5;
...
void _fini() {
    ...
    fun_8048466(eax1, ebx2, ebp3, __return_address());
}
