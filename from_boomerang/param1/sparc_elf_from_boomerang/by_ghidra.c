...
// WARNING: Inlined function: FUN_00010538
...

{
  ...
  FUN_000207f8(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_00020804(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
int cparam(int param_1,int param_2)
...
// WARNING: Inlined function: FUN_000106c8
...
// WARNING: Removing unreachable block (ram,0x00010734)
...
{
  IllegalInstructionTrap(0x207c8);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x207d4);
  return;
}
...
{
  IllegalInstructionTrap(0x207e0);
  return;
}



void FUN_000207ec(void)
...
{
  IllegalInstructionTrap(0x20810);
  return (int)__format;
}
