...
// 0000000000000810: void main(Register int32 w0, Register (ptr64 Eq_10) x1)
void main(int32 w0, struct Eq_10 * x1)
{
	if (w0 <= 0x01)
		return;
	word32 x1_32_32_34 = SLICE(2712, word32, 32);
	FILE * x0_26 = fopen(x1->ptr0008, "r");
	if (x0_26 != null)
	{
		FILE * x19_36 = chomp(fp - 1016, SEQ(x1_32_32_34, 0x0400), x0_26);
		if (fp != 1016)
			x0_39 = (uint64) puts(fp - 1016);
		x0_43 = (uint64) fclose(x19_36);
	}
}
