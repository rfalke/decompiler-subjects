// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/line1/ia32_elf_by_boomerang_o4/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (8048450 (ptr code) ptr8048450) (8048540 (ptr code) ptr8048540) (80485A0 (ptr code) ptr80485A0))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x08048540 : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x080485A0 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr8048450, dwArg00, fp + 0x00000004, &globals->ptr8048540, &globals->ptr80485A0, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr8048450;	// 8048450
	code * ptr8048540;	// 8048540
	code * ptr80485A0;	// 80485A0
} Eq_1;
