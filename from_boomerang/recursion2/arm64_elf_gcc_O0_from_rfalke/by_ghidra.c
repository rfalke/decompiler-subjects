...

{
  b_c = b_c - 1;
  if (-1 < b_c) {
    c((void *)(ulong)(uint)b_c,(void *)(ulong)(uint)b_c);
  }
  res = res + 2;
  return;
}
...

{
  e_c = e_c - 1;
  if (-1 < e_c) {
    c((void *)(ulong)(uint)e_c,(void *)(ulong)(uint)e_c);
  }
  res = res + 7;
  return;
}
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x100d5c);
