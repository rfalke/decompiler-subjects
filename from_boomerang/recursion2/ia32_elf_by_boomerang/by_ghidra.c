...

{
  ...
  void *in_stack_fffffff8;
  
  b_c = b_c + -1;
  if (-1 < b_c) {
    c(in_stack_fffffff4,in_stack_fffffff8);
  }
  res = res + 2;
  return;
}
...
// WARNING: Removing unreachable block (ram,0x0804867c)
// WARNING: Removing unreachable block (ram,0x08048687)
