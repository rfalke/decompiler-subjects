...
// 00000000000008C8: void main(Stack Eq_111 dwArg00)
void main(Eq_111 dwArg00)
{
	x0_15 = (uint64) __isoc99_scanf("%f", fp);
	x0_29 = (uint64) printf("a is %f, b is %f\n", (real64) 7e-45F, (real64) dwArg00);
	if (dwArg00 == 5.0F)
		x0_37 = (uint64) puts("Equal");
	if (dwArg00 != 5.0F)
		x0_47 = (uint64) puts("Not Equal");
	if (dwArg00 < 5.0F)
		x0_58 = (uint64) puts("Greater");
	if (dwArg00 >= 5.0F)
		x0_69 = (uint64) puts("Less or Equal");
	if (dwArg00 <= 5.0F)
