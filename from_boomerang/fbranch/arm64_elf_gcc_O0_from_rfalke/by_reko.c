...
// 00000000000008C8: void main(Stack Eq_109 dwArg00)
void main(Eq_109 dwArg00)
{
	x0_15 = (uint64) __isoc99_scanf("%f", 0x00);
	x0_25 = (uint64) printf("a is %f, b is %f\n", 0x00);
	if (dwArg00 == 5.0F)
		x0_33 = (uint64) puts("Equal");
	if (dwArg00 != 5.0F)
		x0_43 = (uint64) puts("Not Equal");
	if (dwArg00 < 5.0F)
		x0_54 = (uint64) puts("Greater");
	if (dwArg00 >= 5.0F)
		x0_65 = (uint64) puts("Less or Equal");
	if (dwArg00 <= 5.0F)
