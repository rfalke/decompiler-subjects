...
{
                    // WARNING: Could not recover jumptable at 0x00001a00. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001a10. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  lVar1 = ZEXT48(register0x0000000c) - 0x2c;
  __picsymbol_stub::_scanf("%f",lVar1);
  dVar2 = (double)local_2c;
  __picsymbol_stub::_printf
            ((char *)0x4014000000000000,dVar2,"a is %f, b is %f\n",0x40140000,0,
             (ulonglong)dVar2 >> 0x20,(ulonglong)dVar2 & 0xffffffff);
  if (local_2c == 5.0) {
