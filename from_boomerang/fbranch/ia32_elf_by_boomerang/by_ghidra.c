...

{
  ...
  if ((char)((uint)(ushort)((ushort)(local_8 < 5.00000000) << 8 |
                           (ushort)(local_8 == 5.00000000) << 0xe) >> 8) == '@') {
    puts("Equal");
  }
  if ((char)((uint)(ushort)((ushort)(5.00000000 < local_8) << 8 |
                           (ushort)(local_8 == 5.00000000) << 0xe) >> 8) != '@') {
    puts("Not Equal");
  }
  if ((char)((uint)(ushort)((ushort)(5.00000000 < local_8) << 8 |
                           (ushort)(local_8 == 5.00000000) << 0xe) >> 8) == '\0') {
    puts("Greater");
  }
  if (5.00000000 <= local_8) {
    puts("Less or Equal");
  }
  if (local_8 <= 5.00000000) {
...
// WARNING: Removing unreachable block (ram,0x080484f1)
// WARNING: Removing unreachable block (ram,0x080484f4)
...
// WARNING: Removing unreachable block (ram,0x08048528)
// WARNING: Removing unreachable block (ram,0x08048536)
