...
// WARNING: Inlined function: FUN_00010574
...
// WARNING: Removing unreachable block (ram,0x0001062c)
...

{
  ...
  FUN_000209c4(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  uVar1 = FUN_000209d0(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
...
// WARNING: Removing unreachable block (ram,0x000107d8)
...

{
  ...
  scanf("%f",&local_14);
  local_10 = 0x4014000000000000;
  printf("a is %f, b is %f\n",0x40140000,0,(int)((ulonglong)(double)local_14 >> 0x20),
         SUB84((double)local_14,0));
  iVar2 = 0x10800;
  cVar1 = (5.00000000 < local_14) + (local_14 < 5.00000000) * '\x02';
  if (((cVar1 == '\x01' || cVar1 == '\x02') || cVar1 == '\x03') ||
     (puts("Equal"),
     (char)((*(float *)(iVar2 + 0x138) < local_14) + (local_14 < *(float *)(iVar2 + 0x138)) * '\x02'
           ) != '\0')) {
    puts("Not Equal");
  }
  if ((char)((5.00000000 < local_14) + (local_14 < 5.00000000) * '\x02') == '\x02') {
    iVar2 = 0x10800;
    puts("Greater");
  }
  else {
  ...
  if ((byte)((*(float *)(iVar2 + 0x138) < local_14) +
            (local_14 < *(float *)(iVar2 + 0x138)) * '\x02') < 2) {
    puts("Less or Equal");
  }
  cVar1 = (5.00000000 < local_14) + (local_14 < 5.00000000) * '\x02';
...
// WARNING: Inlined function: FUN_00010824
...
{
  IllegalInstructionTrap(0x20994);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x209dc);
  return (int)__format;
}
