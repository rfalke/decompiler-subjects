...

{
  ...
  puVar1 = (undefined *)FUN_000209d0(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...

{
  ...
  iVar2 = 0x10800;
  cVar1 = (5.0 < local_14) + (local_14 < 5.0) * '\x02';
  ...
  if ((char)((5.0 < local_14) + (local_14 < 5.0) * '\x02') == '\x02') {
    iVar2 = 0x10800;
    puts("Greater");
  }
  else {
