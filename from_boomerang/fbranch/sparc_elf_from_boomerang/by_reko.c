...
// 00010500: void _start(Register word32 g1, Register word32 o7, Stack word32 dwArg40)
void _start(word32 g1, word32 o7, word32 dwArg40)
{
	if (g1 == 0x00)
	{
		atexit();
		globals->ptr20B00 = fp + 0x44 + ((_init(o7) << 0x02) + 0x04);
		main();
		exit();
		_exit();
	}
...
{
	struct Eq_39 * l7_114 = fn00010574(o7, 66484);
...
{
	struct Eq_39 * l7_22 = fn00010574(o7, 66292);
...
// 0001082C: Register (ptr word32) __do_global_ctors_aux(Register word32 o7)
word32 * __do_global_ctors_aux(word32 o7)
{
	word32 * l0_30;
	struct Eq_161 * l7_22 = fn00010824(o7, 0x00010104);
...
// 00020964: void _PROCEDURE_LINKAGE_TABLE_()
