...
)
{
    ...
    asm("andis. r19,r3,0x730000");
    __r1 = __r27 | 28262;
    asm("?");
    asm("rlwnm r19,r27,r14,17,18");
    asm("xori r14,r11,0x5f75");
    asm("rlwnm. r31,r26,r13,17,20");
    asm("andis. r1,r3,0x72740000");
    asm("rlwnm. r13,r27,r12,5,20");
    asm("xoris r0,r16,0x5f5f0000");
    asm("oris r13,r27,0x6f6e0000");
...
{// addr = 0x10000374
    __lr = __lr;
    __r1 = {;
    if(cr7 -  *((void*)(0x10010b08))) {
        while(cr7 -  *((void*)(0 +  *((void*)(0x10010a78))))) {
            asm("bllr ");
        }
    }
    __r1 = __r1 + 32;
...
{// addr = 0x10000408
    ...
    __lr = __lr;
    __r1 = {;
    _t13 = cr7 -  *((void*)(0x10010998));
    if(_t13 && _t13) {
        L10000000(__r19, __r25, __r27, __lr);
    }
    __r1 = __r1 + 16;
    return __lr;
}
