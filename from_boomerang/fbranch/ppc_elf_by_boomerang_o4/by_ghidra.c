...

{
  ...
  scanf("%f",local_18);
  dVar2 = 5.0;
  printf((char *)0x4014000000000000,(double)local_18[0],"a is %f, b is %f\n");
  if (dVar2 == (double)local_18[0]) {
    puts("Equal");
    dVar1 = (double)local_18[0];
    if (dVar2 != dVar1) goto LAB_100004c8;
  }
  else {
LAB_100004c8:
    puts("Not Equal");
  ...
  if (dVar2 <= dVar1) {
    puts("Less or Equal");
    dVar1 = (double)local_18[0];
    if (dVar2 < dVar1) goto LAB_10000508;
  }
  else if (dVar2 < dVar1) goto LAB_10000508;
...
// WARNING: Removing unreachable block (ram,0x100005cc)
// WARNING: Removing unreachable block (ram,0x100005c8)
...
// WARNING: Removing unreachable block (ram,0x1000065c)
// WARNING: Removing unreachable block (ram,0x10000660)
