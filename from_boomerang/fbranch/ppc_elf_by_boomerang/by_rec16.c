 ...
 *	Input file: './from_boomerang/fbranch/ppc_elf_by_boomerang/subject.exe'
 */
...
/* DEST BLOCK NOT FOUND: 10000308 -> 10010adc */
/* DEST BLOCK NOT FOUND: 10000308 -> 10010adc */
...
/*	Procedure: 0x10000440 - 0x1000057F
 *	Argument size: -32
 *	Local size: 32
 *	Save regs size: 0
 */
...
main()
{
    ...
    asm("lfs fr13,8(r31)");
    asm("lfs fr0,0xc(r31)");
    asm("fcmpu crf7,fr13,fr0");
    == ? L100004ac : ;
    goto L100004b8;
    printf(0x10000934);
L100004b8:
    asm("lfs fr0,8(r31)");
    asm("lfs fr13,0xc(r31)");
    asm("fcmpu crf7,fr0,fr13");
    != ? L100004cc : ;
    goto L100004d8;
    printf(0x1000093c);
L100004d8:
...
/*	Procedure: 0x10010A78 - 0x10010A8B
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/*	Procedure: 0x10010AD4 - 0x10010ADB
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/*	Procedure: 0x10010ADC - 0x10010AE3
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/*	Procedure: 0x10010AE4 - 0x10010AF7
 *	Argument size: 0
 *	Local size: 0
 *	Save regs size: 0
 */
...
/* 0x10000440     320 */ /* unknown */ void 	main;
...
/* 0x10000980       0 */ /* unknown */ void 	__FRAME_END__;
/* 0x10008980       0 */ /* unknown */ void 	_SDA2_BASE_;
/* 0x10010984       0 */ /* unknown */ void 	__CTOR_LIST__;
/* 0x10010988       0 */ /* unknown */ void 	__CTOR_END__;
/* 0x1001098c       0 */ /* unknown */ void 	__DTOR_LIST__;
/* 0x10010990       0 */ /* unknown */ void 	__DTOR_END__;
/* 0x10010994       0 */ /* unknown */ void 	__JCR_LIST__;
/* 0x10010994       0 */ /* unknown */ void 	__JCR_END__;
/* 0x100109a8       0 */ /* unknown */ void 	_DYNAMIC;
/* 0x10010a70       0 */ /* unknown */ void 	__dso_handle;
/* 0x10010a70       0 */ /* unknown */ void 	data_start;
/* 0x10010a70       0 */ /* unknown */ void 	__data_start;
/* 0x10010a74       0 */ /* unknown */ void 	p.0;
/* 0x10010a7c       0 */ /* unknown */ void 	_GLOBAL_OFFSET_TABLE_;
/* 0x10010ad4       8 */ /* unknown */ void 	scanf;
/* 0x10010adc       8 */ /* unknown */ void 	__libc_start_main;
/* 0x10010ae4       1 */ /* unknown */ void 	printf;
/* 0x10010af8       1 */ /* unknown */ void 	completed.1;
/* 0x10018a8c       0 */ /* unknown */ void 	_SDA_BASE_;
