...

{
  printf("c(%d)\n",(ulong)(uint)x);
  if (x - 2U < 4 || x == 6) {
                    // WARNING: Could not recover jumptable at 0x004006c8. Too many branches
                    // WARNING: Treating indirect jump as call
    (*(code *)(&PTR_LAB_00400a10)[x - 2U])();
    return;
  }
  return;
}
...
void FUN_00400974(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x00400974. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x400974);
