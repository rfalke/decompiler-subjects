...
Eq_19 g_t095C = // 000000000000095C
	{
...
{
	if (w0 > 0x07)
		x0_37 = (uint64) puts("Other!");
	else
	{
		char * x0_19 = 1828 + (int64) (&g_t095C)[(uint64) (w0 - 0x02)];
		switch ((word32) x0_19)
		{
		case 0x00:
...
l0000000000000728:
			x0_19 += 0x0988;
l000000000000072C:
			x0_31 = (uint64) puts(x0_19);
l0000000000000730:
			return;
		}
		x0_27 = (uint64) puts(x0_19 + 0x0990);
	}
}

// 0000000000000784: void _start(Register (ptr64 Eq_44) x0, Stack word32 dwArg00)
