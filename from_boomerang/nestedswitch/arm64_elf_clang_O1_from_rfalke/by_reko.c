...
word64 g_a400768[] = // 0000000000400768
	{
	};
Eq_154 g_a400798[] = // 0000000000400798
	{
	};
// subject_text.c
// Generated by decompiling subject.exe
...
// 00000000004005E0: void main(Register up32 w0, Register word32 x8_32_32)
void main(up32 w0, word32 x8_32_32)
{
	ui64 x8_19 = SEQ(x8_32_32, w0 - 0x02);
	if (w0 <= 0x07)
	{
		word64 x8_20 = g_a400768[x8_19 * 8];
		word32 x8_32_32_36 = SLICE(x8_20, word32, 32);
		switch ((word32) x8_20)
		{
		case 0x00:
			break;
		...
		case 0x02:
			up32 w8_29 = 0x07 - w0;
			ui64 x8_37 = SEQ(x8_32_32_36, w8_29);
			if (w8_29 <= 0x05)
			{
				switch (g_a400798[x8_37])
				{
				case 0x00:
					break;
				case 0x01:
...
// 00000000004006D0: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
