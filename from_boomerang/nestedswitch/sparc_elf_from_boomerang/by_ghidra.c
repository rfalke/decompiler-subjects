...

{
  ...
  FUN_000208a8(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_000208b4(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...

{
  ...
  switch(param_1) {
  case 2:
switchD_000106c8_caseD_2:
    __s = "Two!";
    break;
  case 3:
switchD_000106c8_caseD_3:
    __s = "Three!";
    break;
  case 4:
    switch(-param_1) {
    case -7:
      goto switchD_000106c8_caseD_7;
    case -6:
      goto switchD_000106c8_caseD_6;
    case -5:
      goto switchD_000106c8_caseD_5;
    case -4:
      __s = "Four!";
      goto LAB_00010744;
    case -3:
      goto switchD_000106c8_caseD_3;
    case -2:
      goto switchD_000106c8_caseD_2;
    }
  default:
    __s = "Other!";
    break;
  case 5:
switchD_000106c8_caseD_5:
    __s = "Five!";
    break;
  case 6:
switchD_000106c8_caseD_6:
    __s = "Six!";
    break;
  case 7:
switchD_000106c8_caseD_7:
    __s = "Seven!";
  }
LAB_00010744:
  puts(__s);
...
// WARNING: Inlined function: FUN_00010754
...
{
  IllegalInstructionTrap(0x20878);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x20884);
  return;
}
...
{
  IllegalInstructionTrap(0x20890);
  return;
}



void FUN_0002089c(void)
...
{
  IllegalInstructionTrap(0x208c0);
  return (int)__s;
}
