...
// 00000000004005E0: void main(Register up32 w0, Register word64 x1, Stack word64 qwArg00)
void main(up32 w0, word64 x1, word64 qwArg00)
{
	ui64 x1_23 = DPB(x1, w0 - 0x02, 0);
	if (w0 > 0x07)
		fn0000000000400480();
	else
	{
		<anonymous> * x8_46 = *((char *) globals->a400818 + x1_23 * 0x08);
		word64 sp_49;
		word64 x29_50;
		word64 x30_51;
		word32 w8_52;
