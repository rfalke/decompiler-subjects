...
// 00000000004005E0: void main(Register up32 w0, Register word64 x1, Register word64 x30)
void main(up32 w0, word64 x1, word64 x30)
{
	ptr64 fp;
	word32 x1_32_32_25 = SLICE(x1, word32, 32);
	ui64 x1_26 = SEQ(x1_32_32_25, w0 - 0x02);
	if (w0 > 0x07)
		printf("Other!\n");
	else
	{
		<anonymous> * x8_45 = *((char *) g_a400818 + x1_26 * 0x08);
		x8_45();
	}
}
