...
<anonymous> * g_a400818[] = // 0000000000400818
	{
	};
// subject_text.c
// Generated by decompiling subject.exe
...
// 00000000004005E0: void main(Register up32 w0, Register word64 x1, Register word64 x30, Stack word64 qwArg00)
void main(up32 w0, word64 x1, word64 x30, word64 qwArg00)
{
	word32 x1_32_32_26 = SLICE(x1, word32, 32);
	ui64 x1_27 = SEQ(x1_32_32_26, w0 - 0x02);
	if (w0 > 0x07)
		fn0000000000400480();
	else
	{
		<anonymous> * x8_48 = *((char *) g_a400818 + x1_27 * 8);
		x8_48();
	}
}
