...
{
	test(0x04, 0x05, 0x06);
	x0_21 = (uint64) printf("Result for 4, 5, 6: %d\n", 0x00);
	test(0x06, 0x05, 0x04);
	x0_34 = (uint64) printf("Result for 6, 5, 4: %d\n", 0x00);
	test(0x04, 0x06, 0x05);
	x0_47 = (uint64) printf("Result for 4, 6, 5: %d\n", 0x00);
	test(0x06, 0x04, 0x05);
	x0_61 = (uint64) printf("Result for 6, 4, 5: %d\n", 0x00);
}
