...
void main()
{
	x0_29 = (uint64) printf("Result for 4, 5, 6: %d\n", test(0x04, 0x05, 0x06));
	x0_52 = (uint64) printf("Result for 6, 5, 4: %d\n", test(0x06, 0x05, 0x04));
	x0_73 = (uint64) printf("Result for 4, 6, 5: %d\n", test(0x04, 0x06, 0x05));
	x0_94 = (uint64) printf("Result for 6, 4, 5: %d\n", test(0x06, 0x04, 0x05));
}
