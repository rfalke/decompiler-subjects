...

{
  ...
  FUN_00020930(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_0002093c(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...
undefined4 test(int param_1,int param_2,int param_3)
...
// WARNING: Inlined function: FUN_000107ac
...
{
  IllegalInstructionTrap(0x2090c);
  return;
}
...
{
  IllegalInstructionTrap(0x20918);
  return;
}



void FUN_00020924(void)
...
{
  IllegalInstructionTrap(0x20948);
  return (int)__format;
}
