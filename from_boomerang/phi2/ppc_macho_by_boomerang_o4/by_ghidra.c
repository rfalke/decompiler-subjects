...
undefined8 _main(int param_1,int param_2)

{
  ...
  if (param_1 < 3) {
    sVar3 = __picsymbol_stub::_strlen(pcVar1);
    lVar2 = (longlong)(int)sVar3;
  }
  else {
    sVar3 = __picsymbol_stub::_strlen(pcVar1);
    lVar2 = (longlong)(int)sVar3;
    sVar3 = __picsymbol_stub::_strlen(pcVar1);
    unaff_r28 = (longlong)(int)sVar3;
    __picsymbol_stub::_printf("%d",lVar2 + unaff_r28);
  }
  __picsymbol_stub::_printf("%d, %d",lVar2,unaff_r28);
...
longlong _proc1(int param_1,char *param_2)

{
  ...
  if (param_1 < 3) {
    sVar2 = __picsymbol_stub::_strlen(param_2);
    lVar1 = (longlong)(int)sVar2;
  }
  else {
    sVar2 = __picsymbol_stub::_strlen(param_2);
    lVar1 = (longlong)(int)sVar2;
    sVar2 = __picsymbol_stub::_strlen(param_2);
    unaff_r28 = (longlong)(int)sVar2;
    __picsymbol_stub::_printf("%d",lVar1 + unaff_r28);
  }
  __picsymbol_stub::_printf("%d, %d",lVar1,unaff_r28);
  return lVar1;
}
