...
{
	int32 w19_23 = (word32) strlen(x1);
	if (w0 >= 0x03)
		printf("%d", w19_23 << 1);
	printf("%d, %d", w19_23, w19_23);
}

// 0000000000400698: void main(Register int32 w0, Register (ptr64 Eq_116) x1)
void main(int32 w0, struct Eq_116 * x1)
{
	int32 w19_24 = (word32) strlen(x1->ptr0008);
	if (w0 >= 0x03)
		printf("%d", w19_24 << 1);
	printf("%d, %d", w19_24, w19_24);
	printf("%d\n", w19_24);
}

// 0000000000400708: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
