...
undefined8 proc1(int param_1,char *param_2)

{
  ...
  if (param_1 < 3) {
    ...
    printf("%d, %d",sVar1,unaff_r30);
    return CONCAT44(sVar1,local_res4);
  }
  sVar1 = strlen(param_2);
  printf("%d",sVar1 << 1);
  printf("%d, %d",sVar1,sVar1);
  return CONCAT44(sVar1,local_res4);
}



ulonglong main(int param_1,int param_2)

{
  ...
  if (param_1 < 3) {
    ...
    unaff_r30 = strlen(*(char **)(param_2 + 4));
    printf("%d",unaff_r30 << 1);
    sVar1 = unaff_r30;
  }
  printf("%d, %d",sVar1,unaff_r30);
  printf("%d\n",sVar1);
  return (ulonglong)local_res4;
}



// WARNING: Removing unreachable block (ram,0x100005d8)
// WARNING: Removing unreachable block (ram,0x100005d4)
...
// WARNING: Removing unreachable block (ram,0x10000668)
// WARNING: Removing unreachable block (ram,0x1000066c)
