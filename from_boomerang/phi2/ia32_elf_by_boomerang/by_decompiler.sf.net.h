// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/phi2/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (80483CF (ptr code) ptr80483CF) (804840C (ptr code) ptr804840C) (804843C (ptr code) ptr804843C))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x0804840C : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x0804843C : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr80483CF, dwArg00, fp + 0x00000004, &globals->ptr804840C, &globals->ptr804843C, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr80483CF;	// 80483CF
	code * ptr804840C;	// 804840C
	code * ptr804843C;	// 804843C
} Eq_1;
