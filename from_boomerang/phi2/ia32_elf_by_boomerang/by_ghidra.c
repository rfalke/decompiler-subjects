...
size_t proc1(size_t param_1,char *param_2)

{
  size_t local_8;
  
  if ((int)param_1 < 3) {
    param_1 = strlen(param_2);
  }
  else {
    param_1 = strlen(param_2);
    local_8 = strlen(param_2);
    printf("%d",local_8 + param_1);
  }
  printf("%d, %d",param_1,local_8);
  return param_1;
}
...
// WARNING: Removing unreachable block (ram,0x0804842c)
...
// WARNING: Removing unreachable block (ram,0x0804846e)
