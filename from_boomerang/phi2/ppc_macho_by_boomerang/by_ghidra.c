...
ulonglong _proc1(int param_1,char *param_2)

{
  ...
  param_12 = param_2;
  if (param_1 < 3) {
    param_11 = _strlen(param_2);
  }
  else {
    param_11 = _strlen(param_2);
    local_20 = _strlen(param_12);
    _printf("%d",(ulonglong)param_11 + (ulonglong)local_20);
  }
  _printf("%d, %d",(ulonglong)param_11,(ulonglong)local_20);
  return (ulonglong)param_11;
}



undefined8 _main(uint param_1,int param_2)

{
  ...
  param_11 = param_1;
  param_12 = param_2;
  uVar1 = _proc1((ulonglong)param_1,(ulonglong)*(uint *)(param_2 + 4));
  _printf("%d\n",uVar1);
  return 0;
}
