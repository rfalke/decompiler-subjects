...

{
  ...
  param_12 = param_2;
  if (param_1 < 3) {
    param_11 = __picsymbol_stub::_strlen(param_2);
  }
  else {
    param_11 = __picsymbol_stub::_strlen(param_2);
    local_20 = __picsymbol_stub::_strlen(param_12);
    __picsymbol_stub::_printf("%d",(ulonglong)param_11 + (ulonglong)local_20);
  }
  __picsymbol_stub::_printf("%d, %d",(ulonglong)param_11,(ulonglong)local_20);
  return param_11;
}
