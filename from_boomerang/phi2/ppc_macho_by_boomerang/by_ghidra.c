...
{
                    // WARNING: Could not recover jumptable at 0x00001abc. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001acc. Too many branches
                    // WARNING: Treating indirect jump as call
...
uint _proc1(int param_1,char *param_2)

{
  size_t sStack00000018;
  char *pcStack0000001c;
  size_t local_20;
  
  sStack00000018 = param_1;
  pcStack0000001c = param_2;
  if (param_1 < 3) {
    sStack00000018 = __picsymbol_stub::_strlen(param_2);
  }
  else {
    sStack00000018 = __picsymbol_stub::_strlen(param_2);
    local_20 = __picsymbol_stub::_strlen(pcStack0000001c);
    __picsymbol_stub::_printf("%d",(ulonglong)sStack00000018 + (ulonglong)local_20);
  }
  __picsymbol_stub::_printf("%d, %d",(ulonglong)sStack00000018,(ulonglong)local_20);
  return sStack00000018;
}
...

{
  ...
  uVar1 = _proc1(param_1,*(undefined4 *)(param_2 + 4));
  __picsymbol_stub::_printf("%d\n",uVar1);
  return 0;
}
...
{
                    // WARNING: Could not recover jumptable at 0x00001ee4. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  void *pvVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x00001f08. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  int iVar1;
                    ...
                    // WARNING: Could not recover jumptable at 0x00001f2c. Too many branches
                    // WARNING: Treating indirect jump as call
...
size_t __picsymbol_stub::_strlen(char *param_1)

{
  size_t sVar1;
  
                    // WARNING: Could not recover jumptable at 0x00001f50. Too many branches
                    // WARNING: Treating indirect jump as call
  sVar1 = (*(code *)__la_symbol_ptr::_strlen)(param_1);
  return sVar1;
}
