...

{
  ...
  if (x < 3) {
    ...
    sVar1 = strlen(s);
    local_24 = (uint)sVar1;
    printf("%d",(ulong)(local_14 + local_24));
  }
  printf("%d, %d",(ulong)local_14,(ulong)local_24);
  return (int)local_14;
}
...
void FUN_00400734(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x00400734. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x400734);
