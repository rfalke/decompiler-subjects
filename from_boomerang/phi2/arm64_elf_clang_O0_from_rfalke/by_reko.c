...
int32 proc1(int32 w0, char * x1)
{
	...
	if (w0 > 0x02)
	{
		int32 w0_24 = (word32) strlen(x1);
		word32 w0_29 = (word32) strlen(x1);
		printf("%d", w0_24 + w0_29);
		dwLoc14_68 = w0_24;
	}
	else
		dwLoc14_68 = (word32) strlen(x1);
	return dwLoc14_68;
}

// 00000000004006DC: void main(Register int32 w0, Register (ptr64 Eq_121) x1)
void main(int32 w0, struct Eq_121 * x1)
{
	printf("%d\n", proc1(w0, x1->ptr0008));
}

// 0000000000400738: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
