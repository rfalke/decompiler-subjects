...
// 0000000000400640: Register int32 proc1(Register int32 w0, Register out ptr64 x29Out)
// Called from:
//      main
int32 proc1(int32 w0, ptr64 & x29Out)
{
	int32 dwLoc0C_68;
	if (w0 > 0x02)
	{
...
// 00000000004006DC: void main(Register int32 w0)
void main(int32 w0)
{
	struct Eq_109 * sp_19 = (struct Eq_109 *) <invalid>;
	word64 x29_60;
	sp_19->dw000C = (word32) (uint64) proc1(w0, out x29_60);
	fn00000000004004E0();
