...
// 0000000000400640: Register word64 proc1(Register int32 w0, Register out ptr64 x29Out)
// Called from:
//      main
word64 proc1(int32 w0, ptr64 & x29Out)
{
	word32 dwLoc0C_68;
	if (w0 > 0x02)
	{
	...
	fn00000000004004E0();
	x29Out = x30;
	return SEQ(SLICE(0x004007C8, word32, 32), dwLoc0C_68);
}
