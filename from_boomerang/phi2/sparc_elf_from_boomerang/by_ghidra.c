...
// WARNING: Inlined function: FUN_00010568
...

{
  ...
  FUN_000208ec(&__FRAME_END__,object_2);
  if (___JCR_END__ == 0) {
    return &__JCR_END__;
  }
  puVar1 = (undefined *)FUN_000208f8(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
  return puVar1;
}
...

{
  ...
  if (param_1 < 3) {
    local_res44 = strlen(param_2);
  }
  else {
    local_res44 = strlen(param_2);
    local_14 = strlen(param_2);
    printf("%d",local_res44 + local_14);
  }
  printf("%d, %d",local_res44,local_14);
  return local_res44;
}



// WARNING: Removing unreachable block (ram,0x00010794)
...

{
  ...
  uVar1 = proc1(param_1,*(undefined4 *)(param_2 + 4));
  printf("%d\n",uVar1);
  return 0;
}
...
// WARNING: Inlined function: FUN_000107b0
...
// WARNING: Removing unreachable block (ram,0x00010834)
...
{
  IllegalInstructionTrap(0x208bc);
  return (int)__func;
}
...
{
  IllegalInstructionTrap(0x208c8);
  return;
}
...
{
  IllegalInstructionTrap(0x208d4);
  return;
}



void FUN_000208e0(void)
...
{
  IllegalInstructionTrap(0x20904);
  return (size_t)__s;
}
...
{
  IllegalInstructionTrap(0x20910);
  return (int)__format;
}
