...
// 0000000000400640: Register ptr64 proc1(Register int32 w0, Register word32 w19, Stack word64 qwArg00)
ptr64 proc1(int32 w0, word32 w19, word64 qwArg00)
{
	fn00000000004004A0();
	if (w0 >= 0x03)
		fn00000000004004E0();
...
// 0000000000400698: void main(Register int32 w0, Register word64 x1, Register word32 w19, Register word64 x30)
void main(int32 w0, word64 x1, word32 w19, word64 x30)
{
	proc1(w0, w19, x30);
	fn00000000004004E0();
}
