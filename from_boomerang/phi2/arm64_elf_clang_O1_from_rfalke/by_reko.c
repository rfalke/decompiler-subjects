...
// 0000000000400698: void main(Register int32 w0, Register (ptr64 Eq_110) x1)
void main(int32 w0, struct Eq_110 * x1)
{
	printf("%d\n", proc1(w0, x1->ptr0008));
}

// 00000000004006C8: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
