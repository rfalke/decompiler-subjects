...

{
  ...
  if (param_1 < 3) {
    ...
    printf("%d",local_28 + local_20);
  }
  printf("%d, %d",local_28,local_20);
  return local_28;
}
...
// WARNING: Removing unreachable block (ram,0x100005ac)
// WARNING: Removing unreachable block (ram,0x100005a8)
