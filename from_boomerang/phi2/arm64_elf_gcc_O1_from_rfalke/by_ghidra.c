...

{
  ...
  if (x < 3) {
    ...
    unaff_x20 = strlen(s);
    printf("%d",(ulong)(uint)((int)unaff_x20 << 1));
    sVar1 = unaff_x20;
  }
  printf("%d, %d",sVar1 & 0xffffffff,unaff_x20 & 0xffffffff);
...
void FUN_0010090c(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x0010090c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x10090c);
