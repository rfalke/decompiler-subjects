...
{
                    // WARNING: Could not recover jumptable at 0x00001adc. Too many branches
                    // WARNING: Treating indirect jump as call
...
{
                    // WARNING: Could not recover jumptable at 0x00001aec. Too many branches
                    // WARNING: Treating indirect jump as call
...

{
  ...
  if (3999999999 < param_1) {
    __picsymbol_stub::_printf("Population exceeds %u\n",0xffffffffee6b2800);
  }
  if (uStack00000018 < 0xf0000000) {
    __picsymbol_stub::_printf("The mask is %x\n",0xfffffffff0000000);
  }
  if (1 < uStack00000018) {
    __picsymbol_stub::_printf("Arguments supplied\n");
  }
  if ((int)-uStack00000018 < -2) {
    __picsymbol_stub::_printf("Three or more arguments\n");
  }
  return 0;
}
