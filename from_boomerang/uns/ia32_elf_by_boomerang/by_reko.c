...
{
	if (globals->b80495B8 == 0x00)
	{
		<anonymous> ** eax_25 = globals->ptr80494C0;
...
void frame_dummy()
{
	if (globals->dw804959C != 0x00 && 0x00 != 0x00)
	{
		word32 esp_31;
		word32 ebp_32;
		byte SCZO_33;
...
{
	<anonymous> * eax_13 = globals->ptr804958C;
