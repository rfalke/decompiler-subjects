...
// 80494C0: using guessed type int *p_0;
// 80495B8: using guessed type char completed_1;
...
// 804959C: using guessed type int _JCR_LIST__;
...
// 804958C: using guessed type int _CTOR_LIST__;
