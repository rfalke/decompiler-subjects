...
)
{
    ...
    asm("subfic r0,r0,0");
    asm("?");
    asm("oris r0,r16,0x70750000");
    asm("andis. r19,r3,0x5f0000");
    asm("bla 0x14f5f70");
...
{// addr = 0x1000034C
    __lr = __lr;
    __r1 = {;
    if(cr7 -  *((void*)(0x10010a54))) {
        while(cr7 -  *((void*)(0 +  *((void*)(0x100109d0))))) {
            asm("bllr ");
        }
    }
    __r1 = __r1 + 32;
...
{// addr = 0x10000440
    ...
    __r1 = {;
    __r0 = -294977536;
    if((__r3 - 0xffffffffee6b27ff) * 0) {
        asm("crxor cr1:eq,cr1:eq,cr1:eq");
        printf();
        if((__r3 - 0xffffffffefffffff) * 0) {
            goto L2;
        } else {
            switch(L1) {
            }
