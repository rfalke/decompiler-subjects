...
int main(int param_1,uint param_2,byte *param_3)
  ...
  if (param_1 < 2) {
    if (param_1 < 0) {
      if (param_1 < -0x48) {
        ...
        if (param_1 < -0x32) {
          if (param_2 == (uint)*param_3) {
            local_1c = putchar((uint)param_3[0x1f]);
          }
          else {
            local_1c = main(0xffffffbf,param_2,param_3 + 1);
          }
        }
        else {
          local_1c = main((uint)(*param_3 == 0x2f) + param_1,param_2,param_3 + 1);
        }
      }
    }
    else {
      if (param_1 < 1) {
        if (*param_3 != 0x2f) {
          uVar2 = main(0xffffffc3,(uint)*param_3,
                       "!ek;dc i@bK\'(q)-[w]*%n+r3#l,{}:\nuwloca-O;m .vpbks,fxntdCeghiry");
          iVar1 = main(0,uVar2,param_3 + 1);
          if (iVar1 == 0) {
            return 0;
          }
        }
        ...
        local_1c = main(2,2,&DAT_10000c58);
      }
    }
  }
  else {
    if (param_1 < 3) {
      iVar1 = main(0xffffffaa,0,param_3 + 1);
      iVar1 = main(0xffffffa9,1 - param_2,param_3 + iVar1);
      main(0xffffffb1,0xfffffff3,param_3 + iVar1);
    }
    if (param_1 < (int)param_2) {
      main(param_1 + 1,param_2,param_3);
    }
    iVar1 = main(0xffffffa2,param_1 + -0x1b,param_3);
    if ((iVar1 == 0) || (param_1 != 2)) {
      local_1c = 0x10;
    }
    else {
      if ((int)param_2 < 0xd) {
        local_1c = main(2,param_2 + 1,"%s %d %d\n");
      }
      else {
        local_1c = 9;
      }
...
// WARNING: Removing unreachable block (ram,0x10000760)
// WARNING: Removing unreachable block (ram,0x1000075c)
...
// WARNING: Removing unreachable block (ram,0x100007f0)
// WARNING: Removing unreachable block (ram,0x100007f4)
