...

{
  ...
  uVar1 = FUN_00020bb8(&__JCR_END__,param_2,param_3,param_4,param_5,param_6);
...

{
  ...
  if (param_1 < 2) {
    if (param_1 < 0) {
      if (param_1 < -0x48) {
        ...
        if (param_1 < -0x32) {
          ...
          if (param_2 == (int)*param_3) {
            ...
            uVar3 = __flsbuf((int)param_3[0x1f],0x20cf0,pcVar4);
            return uVar3;
          }
          iVar2 = -0x41;
          param_1 = param_2;
          ...
          pcVar4 = param_3 + 1;
          iVar2 = (param_1 + 1) - (uint)((int)*param_3 != 0x2f);
          param_1 = param_2;
        }
      }
    }
      ...
      if (param_1 < 1) {
        if ((int)*param_3 != 0x2f) {
          uVar3 = main(0xffffffc3,(int)*param_3,
                       "!ek;dc i@bK\'(q)-[w]*%n+r3#l,{}:\nuwloca-O;m .vpbks,fxntdCeghiry");
          iVar2 = main(0,uVar3,param_3 + 1);
          if (iVar2 == 0) {
            return 0;
          }
        }
  ...
  uVar3 = main(iVar2,param_1,pcVar4);
  return uVar3;
}
