...
// WARNING: Removing unreachable block (ram,0x10000414)
...
int main(uint param_1,uint param_2,byte *param_3)

{
  ...
  if ((int)param_1 < 2) {
    if ((int)param_1 < 0) {
      if ((int)param_1 < -0x48) {
        ...
        if ((int)param_1 < -0x32) {
          if (param_2 == (uint)*param_3) {
            iVar1 = _IO_putc((uint)param_3[0x1f],stdout);
            return iVar1;
          }
      ...
      if ((int)param_1 < 1) {
        if (*param_3 != 0x2f) {
          uVar3 = main(0xffffffc3,(uint)*param_3,
                       "!ek;dc i@bK\'(q)-[w]*%n+r3#l,{}:\nuwloca-O;m .vpbks,fxntdCeghiry");
          iVar1 = main(0,uVar3,param_3 + 1);
          if (iVar1 == 0) {
            return 0;
          }
        }
  ...
  uVar3 = main(uVar2,param_1,pcVar4);
  return uVar3;
}



// WARNING: Removing unreachable block (ram,0x100006cc)
// WARNING: Removing unreachable block (ram,0x100006c8)
