...
uint _main(longlong param_1,longlong param_2,char *param_3)

{
      ...
      if (iVar8 < -0x48) {
        ...
        if (iVar9 == *param_3) {
          ...
          *(int *)(__nl_symbol_ptr::___sF + 0x60) = iVar8;
          if ((iVar8 < 0) && ((iVar8 < *(int *)(puVar3 + 0x70) || ((char)bVar1 == 10)))) {
            uVar7 = __picsymbol_stub::___swbuf((int)(char)bVar1,pFVar10);
            return uVar7;
          }
          pbVar2 = pFVar10->_p;
          *pbVar2 = bVar1;
  ...
  uVar7 = _main(lVar4,param_2,pcVar11);
  return uVar7;
}
...
{
                    // WARNING: Could not recover jumptable at 0x00001c54. Too many branches
                    // WARNING: Treating indirect jump as call
