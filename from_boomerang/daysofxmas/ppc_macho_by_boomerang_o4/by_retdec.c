        ...
        if (v2 > -1) {
            ...
            if (v2 > -73) {
                if (v2 > -51) {
                    ...
                    v5 = v1;
                    if (v1 == (int32_t)v6) {
                        unsigned char result2 = *(char *)(v3 + 31); // 0x1ac0
                        int32_t v8 = *(int32_t *)0x2060; // 0x1ac8
                        int32_t * v9 = (int32_t *)(v8 + 96); // 0x1ad4
                        int32_t v10 = *v9 - 1; // 0x1ad8
                        *v9 = v10;
                        if (v10 <= 0xffffffff) {
                            // 0x1ae8
                            if (result2 == 10 | v10 < *(int32_t *)(v8 + 112)) {
                                // 0x1ba8
                                result = function_1d54();
                                __asm_lmw(v1, v3);
                                __asm_mtcrf(8, v2);
                                return result;
                            }
                        }
                        int32_t * v11 = (int32_t *)(v8 + 88); // 0x1afc
                        int32_t v12 = *v11; // 0x1afc
                        *(char *)v12 = result2;
                        int32_t v13 = v12 + 1; // 0x1b08
                        *v11 = v13;
                        // 0x1ba8
                        __asm_lmw(v13, v3);
                        __asm_mtcrf(8, v2);
