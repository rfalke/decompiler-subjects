// subject.h
// Generated on TIMESTAMP by decompiling from_boomerang/daysofxmas/ia32_elf_by_boomerang/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (8048258 (ptr code) ptr8048258) (8048350 (ptr code) ptr8048350) (80484F0 (ptr code) ptr80484F0))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x08048258 : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x080484F0 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr8048350, dwArg00, fp + 0x00000004, &globals->ptr8048258, &globals->ptr80484F0, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr8048258;	// 8048258
	code * ptr8048350;	// 8048350
	code * ptr80484F0;	// 80484F0
} Eq_1;
