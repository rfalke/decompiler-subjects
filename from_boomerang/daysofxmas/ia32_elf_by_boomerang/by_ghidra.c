...

{
  ...
  if (param_1 < 2) {
    ...
    if (param_1 < 3) {
      ...
      in_EAX = main(0xffffffb1,0xfffffff3,param_3 + iVar1);
    }
    if (param_1 < param_2) {
      in_EAX = main(param_1 + 1,param_2,param_3,in_EAX);
    }
    iVar1 = main(0xffffffa2,param_1 + -0x1b,param_3,in_EAX);
  ...
  iVar1 = 2;
LAB_080483ba:
  uVar2 = main(iVar1,param_2,pcVar3);
  return uVar2;
}
