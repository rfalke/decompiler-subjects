...
// WARNING: Removing unreachable block (ram,0x0804833c)
...
int __regparm3
main(undefined4 param_1_00,char *param_2_00,char *param_3_00,char *param_1,char *param_2,
    char *param_3)

{
  ...
  if ((int)param_1 < 2) {
    if ((int)param_1 < 0) {
      if ((int)param_1 < -0x48) {
        ...
        if (param_2 == (char *)(int)*param_3) {
          iVar1 = _IO_putc((int)param_3[0x1f],stdout);
          return iVar1;
        }
        pcVar4 = param_3 + 1;
        pcVar3 = (char *)0xffffffbf;
        param_3_00 = param_1;
      }
      else {
        pcVar4 = param_3 + 1;
    ...
    if ((int)param_1 < 1) {
      if (*param_3 != '/') {
        pcVar4 = param_3 + 1;
        uVar2 = main(0xffffffc3,(int)*param_3,
                     "!ek;dc i@bK\'(q)-[w]*%n+r3#l,{}:\nuwloca-O;m .vpbks,fxntdCeghiry");
        iVar1 = main(0,uVar2,pcVar4,param_1_00);
        if (iVar1 == 0) {
          return 0;
        }
      }
    ...
    if ((int)param_1 < 3) {
      iVar1 = main(0xffffffaa,0,param_3 + 1,param_1_00);
      iVar1 = main(0xffffffa9,1 - (int)param_2,param_3 + iVar1);
      param_1_00 = main(0xffffffb1,0xfffffff3,param_3 + iVar1);
    }
    if ((int)param_1 < (int)param_2) {
      param_1_00 = main(param_1 + 1,param_2,param_3,param_1_00);
    }
    param_2_00 = (char *)main(0xffffffa2,param_1 + -0x1b,param_3,param_1_00);
    if ((param_2_00 == (char *)0x0) || (param_1 != (char *)0x2)) {
      return 0x10;
    }
    if (0xc < (int)param_2) {
      return 9;
  ...
  pcVar3 = (char *)0x2;
  param_3_00 = param_2_00;
LAB_080483ba:
  iVar1 = main(pcVar3,param_2,pcVar4,param_3_00);
  return iVar1;
}
