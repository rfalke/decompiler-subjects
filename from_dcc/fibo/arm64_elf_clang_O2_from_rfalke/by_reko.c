...
void main(word64 x24)
{
	...
	if (dwLoc3C_97 >= 0x01)
	{
		...
		do
		{
			...
			word64 x19_119;
			word64 x20_120;
			fib(dwLoc40_100, out x19_119, out x20_120);
			fn0000000000400530();
			++w23_44;
	...
	word64 x19_121;
	word64 x20_122;
	fib(0x00, out x19_121, out x20_122);
}

// 0000000000400734: Register int32 fib(Register int32 w0, Register out ptr64 x19Out, Register out ptr64 x20Out)
// Called from:
//      main
//      fib
