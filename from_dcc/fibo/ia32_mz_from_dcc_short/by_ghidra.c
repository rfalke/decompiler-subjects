...

{
  ...
  puVar13 = (undefined *)&DAT_11d8_0080;
                    // WARNING: Read-only address (ram,0x000101f8) is written
  uRam000101f8 = 0x11d8;
  pcVar6 = (code *)swi(0x21);
  uVar28 = (*pcVar6)();
  uVar27 = s_Turbo_C___Copyright__c__1988_Bor_11d8_0004._40_2_;
  iVar10 = DAT_11d8_0002;
  iVar11 = (int)((ulong)uVar28 >> 0x10);
  *(undefined2 *)&DAT_11d8_0092 = (int)uVar28;
  *(undefined2 *)&DAT_11d8_0090 = unaff_ES;
  *(undefined2 *)&DAT_11d8_008c = uVar27;
  *(int *)&DAT_11d8_00ac = iVar10;
  *(undefined2 *)&DAT_11d8_0096 = 0xffff;
  *(undefined2 *)(puVar13 + -2) = 0x2e;
  FUN_1000_0162();
  uVar28 = *(undefined4 *)&DAT_11d8_008a;
  ...
  *(uint *)&DAT_11d8_008e = (int)piVar23 * 2 + 8U & 0xfff8;
  ...
  if ((uVar9 < 0xf9d0) && (puVar2 = (uint *)&DAT_11d8_023c, !CARRY2(uVar9 + 0x630,*puVar2))) {
    bVar8 = 4;
    ...
    if (uVar9 <= uVar21) {
      ...
      iVar12 = uVar9 + iVar11;
      *(int *)&DAT_11d8_00a4 = iVar12;
      *(int *)&DAT_11d8_00a8 = iVar12;
      iVar12 = iVar12 - *(int *)&DAT_11d8_0090;
      piVar14 = (int *)(puVar13 + -2);
      *(uint *)(puVar13 + -2) = uVar9;
      pcVar6 = (code *)swi(0x21);
      (*pcVar6)();
      iVar25 = *piVar14 << (bVar8 & 0x1f);
      puVar26 = (undefined *)&DAT_11d8_05ea;
      ...
      *(int *)&DAT_11d8_009a = iVar10;
      pcVar5 = *(code **)&DAT_11d8_05e0;
      puVar17 = puVar16 + -2;
      *(undefined2 *)(puVar16 + -2) = 0x10e;
      (*pcVar5)();
      *(undefined2 *)(puVar17 + -2) = *(undefined2 *)&DAT_11d8_0088;
      *(undefined2 *)(puVar17 + -4) = *(undefined2 *)&DAT_11d8_0086;
      *(undefined2 *)(puVar17 + -6) = *(undefined2 *)&DAT_11d8_0084;
      ...
      *(byte **)(puVar20 + -8) = pbVar22;
      *(undefined **)(puVar20 + -10) = puVar26;
      *(undefined2 *)(puVar20 + -0xc) = 0x194;
      *(undefined2 *)(puVar20 + -0xe) = 0x209;
      FUN_1000_0e11();
      *(undefined **)(puVar20 + -0xc) = puVar20 + -6;
      *(undefined2 *)(puVar20 + -0xe) = 0x1b1;
      *(undefined2 *)(puVar20 + -0x10) = 0x215;
      FUN_1000_169a();
      for (iVar10 = 1; iVar10 <= *(int *)(puVar20 + -6); iVar10 = iVar10 + 1) {
        *(undefined2 *)(puVar20 + -0xc) = 0x1b4;
        *(undefined2 *)(puVar20 + -0xe) = 0x223;
        FUN_1000_0e11();
        *(undefined **)(puVar20 + -0xc) = puVar20 + -4;
        *(undefined2 *)(puVar20 + -0xe) = 0x1c3;
        *(undefined2 *)(puVar20 + -0x10) = 0x22f;
        FUN_1000_169a();
        *(undefined2 *)(puVar20 + -0xc) = *(undefined2 *)(puVar20 + -4);
        *(undefined2 *)(puVar20 + -0xe) = 0x237;
        uVar27 = FUN_1000_025b();
        *(undefined2 *)(puVar20 + -0xc) = uVar27;
        *(undefined2 *)(puVar20 + -0xe) = *(undefined2 *)(puVar20 + -4);
        *(undefined2 *)(puVar20 + -0x10) = 0x1c6;
        *(undefined2 *)(puVar20 + -0x12) = 0x245;
        FUN_1000_0e11();
      }
      *(undefined2 *)(puVar20 + -0xc) = 0;
      *(undefined2 *)(puVar20 + -0xe) = 0x254;
      FUN_1000_02c7();
      return;
    }
  }
...

{
  ...
  *pbVar1 = *pbVar1 + cVar3;
  ...
  FUN_1000_0e11(0x194);
  FUN_1000_169a(0x1b1,&iStack_2);
  for (iVar4 = 1; iVar4 <= iStack_2; iVar4 = iVar4 + 1) {
    FUN_1000_0e11(0x1b4);
    FUN_1000_169a(0x1c3,&stack0x0000);
    uVar5 = FUN_1000_025b(0x1f8);
    FUN_1000_0e11(0x1c6,0x1f8,uVar5);
  }
  FUN_1000_02c7(0);
  return;
}
...

{
  ...
  *pcVar1 = *pcVar1 + cVar2;
  FUN_1000_0e11(0x194);
  FUN_1000_169a(0x1b1,&iStack_6);
  for (iVar4 = 1; iVar4 <= iStack_6; iVar4 = iVar4 + 1) {
    FUN_1000_0e11(0x1b4);
    FUN_1000_169a(0x1c3,&uStack_4);
    uVar3 = FUN_1000_025b(uStack_4);
    FUN_1000_0e11(0x1c6,uStack_4,uVar3);
  }
  FUN_1000_02c7(0);
  return;
}
...

{
  ...
  else if (param_1 < 0x59) goto LAB_1000_029e;
  param_1 = 0x57;
LAB_1000_029e:
...

{
  ...
  pcVar9 = (char *)(DAT_11d8_008a + 2);
  uVar6 = 1;
  uVar11 = DAT_11d8_0090;
  ...
  if (2 < DAT_11d8_0092) {
    ...
    if (uVar6 == 0) goto LAB_1000_03ad;
    uVar6 = uVar6 ^ 0x7f;
    uVar11 = DAT_11d8_008c;
  }
  puVar5 = (undefined *)(*(byte *)&DAT_11d8_0080 + 2 + uVar6 & 0xfffe);
  iVar3 = -(int)puVar5;
  ...
  if (puVar5 <= &stack0x0000) {
    ...
    *pcVar10 = '\0';
    uVar13 = uVar6 == 0;
LAB_1000_0369:
    *(undefined2 *)((int)auStack_4 + iVar3) = 0x36c;
    bVar4 = 0;
    FUN_1000_0385();
    iVar7 = extraout_DX;
    if (bVar12 || (bool)uVar13) {
      do {
        uVar11 = DAT_1000_02f8;
        if (bVar12) {
          iVar7 = *(int *)((int)auStack_4 + iVar3 + 2) + iVar7;
          *(uint *)&DAT_11d8_0084 = uVar6;
          ppcVar8 = (char **)(&stack0x0000 + (uVar6 + 1) * -2);
          if (&stack0x0000 < (undefined *)((uVar6 + 1) * 2)) goto LAB_1000_03ad;
          *(int **)&DAT_11d8_0086 = (int *)ppcVar8;
          goto LAB_1000_03cd;
        }
        *(undefined2 *)((int)auStack_4 + iVar3) = 0x373;
        bVar4 = 0;
        FUN_1000_0385();
...

{
  ...
  if (pcVar4 != (char *)0x0) {
    ...
    ppcVar5 = (char **)FUN_1000_0536(DAT_11d8_008e);
    DAT_11d8_0088 = ppcVar5;
    if (ppcVar5 != (char **)0x0) {
      iVar6 = -1;
      do {
        *ppcVar5 = pcVar4;
...

{
  ...
  if ((((int *)param_1[7] == param_1) && (param_3 < 3)) && (param_4 < 0x8000)) {
    ...
    else if ((DAT_11d8_04ac == 0) && (param_1 == (int *)0x344)) {
      DAT_11d8_04ac = 1;
    }
    if (*param_1 != 0) {
...
void __cdecl16near FUN_1000_0c98(int param_1,undefined2 param_2,int param_3)

{
  ...
  FUN_1000_0c19(0x61,1,param_3,param_2,param_1,iVar1);
  return;
}
...

{
  ...
  if ((param_1[1] & 8U) == 0) {
    ...
    else if ((*param_1 == 0) || (iVar3 = FUN_1000_0d93(param_1), iVar3 == 0)) {
...
void FUN_1000_1039(void)

{
  undefined2 unaff_SI;
  
  FUN_1000_1093(unaff_SI);
  return;
}
...
LAB_1000_10a3:
  pcVar22 = pcVar21 + 1;
  cVar11 = *pcVar21;
  if (cVar11 == '\0') goto LAB_1000_1538;
  if (cVar11 == '%') {
    *(char **)(unaff_BP + -0x8a) = pcVar22;
    pcVar1 = pcVar22;
    pcVar22 = pcVar21 + 2;
    cVar11 = *pcVar1;
    if (cVar11 != '%') goto code_r0x000110c5;
  }
  *pcVar23 = cVar11;
  pcVar23 = pcVar23 + 1;
  pcVar1 = (char *)(unaff_BP + -0x55);
...
code_r0x000110c5:
  ...
  *(undefined2 *)(unaff_BP + -0x90) = 0xffff;
  do {
    if (0x5f < (byte)(cVar11 - 0x20U)) goto switchD_1000_1106_caseD_13;
    ...
    switch(cVar5) {
    case '\0':
      if (bVar18 != 0) goto switchD_1000_1106_caseD_13;
      ...
      *piVar2 = *piVar2 + 2;
      if (bVar18 < 2) {
        *(undefined2 *)(unaff_BP + -0x92) = uVar14;
        ...
        if (bVar18 != 4) goto switchD_1000_1106_caseD_13;
    ...
    case '\x03':
      ...
      *puVar3 = *puVar3 | 2;
      break;
    case '\x04':
      if (3 < bVar18) goto switchD_1000_1106_caseD_13;
      uVar15 = 0x400;
      break;
    case '\x05':
...
LAB_1000_1538:
    ...
    case '\b':
      ...
      *puVar3 = *puVar3 | 0x80;
      ...
      break;
    case '\t':
      if (bVar18 != 0) goto switchD_1000_1106_caseD_5;
...
LAB_1000_1245:
    ...
    case '\x0f':
      ...
      *(char *)(unaff_BP + -0x94) = cVar11;
      ...
      thunk_FUN_1000_0d04(uVar13,uVar7 & 1,cVar11,unaff_BP + -0x87,uVar15,uVar14);
      piVar2 = (int *)(unaff_BP + 4);
    ...
    case '\x12':
      ...
      *piVar27 = (uint)(byte)(0x50 - *(char *)(unaff_BP + -0x55)) + *(int *)(unaff_BP + -0x58);
      goto LAB_1000_109c;
    default:
      goto switchD_1000_1106_caseD_13;
    case '\x16':
      puVar3 = (uint *)(unaff_BP + -0x98);
...
LAB_1000_1268:
  ...
  *(int **)(unaff_BP + 4) = piVar24;
  ...
  FUN_1000_0c19(uVar14,*(undefined *)(unaff_BP + -0x93),(char)((uint)uVar14 >> 8),puVar26,iVar20,
                iVar16);
...
undefined2 __cdecl16near FUN_1000_16e7(void)
...
LAB_1000_16ec:
  ...
  pbVar13 = pbVar13 + 1;
  bVar11 = *pbVar3;
  if (bVar11 == 0) goto LAB_1000_1ac5;
  if (bVar11 != 0x25) goto LAB_1000_16f5;
...
LAB_1000_175a:
  ...
  *(byte **)(unaff_BP + 10) = pbVar13;
  if ((int)puVar8 < 0) goto LAB_1000_1ac5;
  ...
  case 2:
    goto LAB_1000_1ac5;
  case 3:
    goto switchD_1000_1778_caseD_3;
  case 4:
  ...
  case 5:
    ...
    *piVar1 = (int)(puVar8 + -0x18);
    ...
    goto LAB_1000_175a;
  case 6:
    goto switchD_1000_1778_caseD_6;
  case 7:
  case 8:
    uVar10 = 10;
    break;
  case 9:
    ...
    break;
  case 10:
    thunk_FUN_1000_0d09(*(undefined2 *)(unaff_BP + 4),*(undefined2 *)(unaff_BP + 6),
    ...
    if (iVar6 < 1) {
      thunk_FUN_1000_0d09();
      if (cVar17 == cVar5) goto LAB_1000_1ac5;
    ...
    if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
      ...
      *piVar1 = *piVar1 + 1;
      ...
      thunk_FUN_1000_0d09(puVar8,uVar10);
    }
    else {
      thunk_FUN_1000_0d09();
    }
  ...
  case 0xf:
    ...
    goto LAB_1000_1acc;
  case 0x10:
    goto switchD_1000_1778_caseD_10;
  case 0x11:
    pbVar14 = pbVar13;
    if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) goto LAB_1000_1844;
    goto LAB_1000_175a;
  case 0x12:
    uVar10 = 0x10;
    break;
  ...
  case 0x14:
    ...
    *pbVar3 = *pbVar3 & 0xdf;
    ...
    goto LAB_1000_175a;
  case 0x15:
    goto switchD_1000_1778_caseD_15;
  default:
    goto switchD_1000_1778_caseD_16;
  }
  ...
  FUN_1000_1b92(*(undefined2 *)(unaff_BP + 4),*(undefined2 *)(unaff_BP + 6),
                *(undefined2 *)(unaff_BP + 8),uVar10,*(uint *)(unaff_BP + -0x22) & 0x7fff,
                unaff_BP + -0x26,unaff_BP + -0x24);
  iVar6 = *(int *)(unaff_BP + -0x24);
  if (iVar6 < 1) {
    if (-1 < iVar6) goto LAB_1000_1ac5;
    goto switchD_1000_1778_caseD_16;
  }
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    piVar1 = (int *)(unaff_BP + -0x28);
...
LAB_1000_1844:
  ...
  goto LAB_1000_16e9;
switchD_1000_1778_caseD_15:
  pbVar3 = (byte *)(unaff_BP + -0x29);
  *pbVar3 = *pbVar3 | 0x20;
  pbVar14 = pbVar13;
  goto LAB_1000_175a;
switchD_1000_1778_caseD_10:
  ...
  *pbVar3 = *pbVar3 | bVar11;
  ...
  while( true ) {
    ...
    if (((bVar11 != 0x2d) ||
       ...
       (*pbVar13 == 0x5d)) goto LAB_1000_19e9;
    pbVar14 = pbVar14 + 2;
  ...
  while (iVar7 = iVar6 + -1, 0 < iVar6) {
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if ((*(byte *)(unaff_BP + (uVar9 >> 3) + -0x20) & '\x01' << ((byte)uVar9 & 7)) == 0) {
      if ((*(byte *)(unaff_BP + -0x29) & 0x10) == 0) goto LAB_1000_1a7c;
    }
...
LAB_1000_1ae7:
  ...
  if (((char)iVar7 < '\0') || (*(char *)(iVar7 + 0x55c) != '\x01')) goto LAB_1000_1ae7;
  goto LAB_1000_1acc;
switchD_1000_1778_caseD_6:
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    FUN_1000_16ce();
  }
  iVar6 = *(int *)(unaff_BP + -0x22);
...
LAB_1000_19a3:
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if (iVar7 < 0) goto switchD_1000_1778_caseD_16;
  }
LAB_1000_19bd:
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    piVar1 = (int *)(unaff_BP + -0x28);
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if ((iVar6 < 0) || (*(char *)(iVar6 + 0x55c) != '\x01')) {
    ...
    while ((-1 < (char)iVar7 && (*(char *)(iVar7 + 0x55c) == '\x01'))) {
      ...
      *piVar1 = *piVar1 + 1;
      iVar7 = (**(code **)(unaff_BP + 4))(*(undefined2 *)(unaff_BP + 8));
      if (iVar7 < 1) goto switchD_1000_1778_caseD_16;
    }
    (**(code **)(unaff_BP + 6))(iVar7,*(undefined2 *)(unaff_BP + 8));
    piVar1 = (int *)(unaff_BP + -0x26);
    *piVar1 = *piVar1 + -1;
