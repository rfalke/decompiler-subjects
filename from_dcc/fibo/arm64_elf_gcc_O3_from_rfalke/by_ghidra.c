...

{
  ...
  __isoc99_scanf(&DAT_00100cf0,&numtimes);
  if (0 < numtimes) {
    iVar9 = 1;
    do {
      printf("Input number: ");
      __isoc99_scanf(&DAT_00100cf0,&number);
      ...
      if (number < 3) {
        ...
        do {
          ...
          uVar8 = (ulong)uVar3;
          uVar7 = (ulong)(uint)(iVar6 + iVar2);
        } while (2 < (int)uVar3);
        uVar7 = (ulong)(iVar6 + iVar2 + 1);
        uVar8 = uVar5;
      }
      iVar9 = iVar9 + 1;
      printf("fibonacci(%d) = %u\n",uVar8 & 0xffffffff,uVar7);
    } while (iVar9 <= numtimes);
  }
                    // WARNING: Subroutine does not return
  exit(0);
}
...
// WARNING: Removing unreachable block (ram,0x001008f4)
...
// WARNING: Removing unreachable block (ram,0x001009a0)
