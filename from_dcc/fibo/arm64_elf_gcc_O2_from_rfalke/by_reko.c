...
// 0000000000000988: Register int32 fib(Register int32 w0, Register out ptr64 x19Out, Register out ptr64 x20Out, Register out ptr64 x29Out)
// Called from:
//      main
//      fib
int32 fib(int32 w0, ptr64 & x19Out, ptr64 & x20Out, ptr64 & x29Out)
{
	if (w0 <= 0x02)
	{
		x19Out = x19;
	...
	else
	{
		...
		do
		{
			...
			word64 x20_36;
			word64 x29_91;
			word32 w20_39 = (word32) x20_36 + fib(w19_20 - 0x01, out x19_35, out x20_36, out x29_91);
		} while (w19_20 > 0x02);
		x19Out = qwLoc10;
		x20Out = x19;
		x29Out = <invalid>;
