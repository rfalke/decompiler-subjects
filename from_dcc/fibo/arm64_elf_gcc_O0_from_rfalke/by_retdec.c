...
void (*g4)() = (void (*)())2592; // 0x10fa8
int64_t g5 = 0; // 0x10fb0
int64_t g6 = 0; // 0x10fc0
void (*g7)() = (void (*)())2472; // 0x10fc8
...
// Address range: 0x8c8 - 0x958
// Line range:    5 - 18
int main() {
    // 0x8c8
    printf("Input number of iterations: ");
    int32_t i; // bp-4, 0x8c8
    scanf("%d", &i);
    int32_t v1 = 1; // 0x94c
    if (i == 0) {
        // 0x950
    ...
    printf("Input number: ");
    int32_t value; // bp-8, 0x8c8
    scanf("%d", &value);
    printf("fibonacci(%d) = %u\n", (int64_t)value, fib(value));
    v1++;
    while (v1 <= i) {
        // 0x8f8
        printf("Input number: ");
...
// From module:   /mnt/from_dcc/./fibo/source.c
// Address range: 0x958 - 0x9a8
// Line range:    21 - 28
int32_t fib(uint32_t x) {
    int32_t result = 1; // 0x970
    if (x >= 3) {
        int32_t v1 = fib(x - 1); // 0x97c
        result = fib(x - 2) + v1;
    }
    // 0x99c
    return result;
...
// Address range: 0x9a8 - 0xa20
int64_t __libc_csu_init(void) {
    // 0x9a8
    int64_t v1; // 0x9a8
    int64_t result = _init(v1); // 0x9dc
...
// Address range: 0xa24 - 0xa34
int64_t _fini(int64_t a1) {
    // 0xa24
    int64_t result; // 0xa24
    return result;
}
