...

{
  ...
  uVar23 = 0x23f;
  puVar11 = (undefined *)&DAT_11dc_0080;
                    // WARNING: Read-only address (ram,0x000101f8) is written
  uRam000101f8 = 0x11dc;
  pcVar5 = (code *)swi(0x21);
  uVar24 = (*pcVar5)();
  uVar22 = s_Turbo_C___Copyright__c__1988_Bor_11dc_0004._40_2_;
  puVar17 = DAT_11dc_0002;
  iVar7 = (int)((ulong)uVar24 >> 0x10);
  *(undefined2 *)&DAT_11dc_0092 = (int)uVar24;
  *(undefined2 *)&DAT_11dc_0090 = unaff_ES;
  *(undefined2 *)&DAT_11dc_008c = uVar22;
  *(int *)&DAT_11dc_00ac = (int)puVar17;
  *(undefined2 *)&DAT_11dc_0096 = 0xffff;
  *(undefined2 *)(puVar11 + -2) = 0x2e;
  FUN_1000_0162();
  uVar24 = *(undefined4 *)&DAT_11dc_008a;
  ...
  *(int **)&DAT_11dc_008e = piVar18;
  ...
  if ((uVar9 < 0xf9d0) && (puVar2 = (uint *)&DAT_11dc_023c, !CARRY2(uVar9 + 0x630,*puVar2))) {
    bVar8 = 4;
    puVar20 = (undefined *)((uVar9 + 0x630 + *puVar2 >> 4) + 1);
    if (puVar20 <= puVar17) {
      ...
      *(int *)&DAT_11dc_00a4 = (int)puVar17;
      *(int *)&DAT_11dc_00a8 = (int)puVar17;
      piVar18 = (int *)(puVar17 + -*(int *)&DAT_11dc_0090);
      piVar12 = (int *)(puVar11 + -2);
      *(undefined **)(puVar11 + -2) = puVar20;
      pcVar5 = (code *)swi(0x21);
      (*pcVar5)();
      iVar21 = *piVar12 << (bVar8 & 0x1f);
      puVar17 = (undefined *)&DAT_11dc_05ea;
      ...
      *(undefined2 *)(puVar14 + -2) = 0x10e;
      (**(code **)&DAT_11dc_05e0)();
      *(undefined2 *)(puVar15 + -2) = *(undefined2 *)&DAT_11dc_0088;
      *(undefined2 *)(puVar15 + -4) = *(undefined2 *)&DAT_11dc_0086;
      *(undefined2 *)(puVar15 + -6) = *(undefined2 *)&DAT_11dc_0084;
...
LAB_1000_01e9:
  ...
  *(byte **)(puVar16 + -0x10) = unaff_SI;
  *(undefined2 *)(puVar16 + -0x12) = 0x194;
  *(undefined2 *)(puVar16 + -0x14) = 0x208;
  FUN_1000_0e5b();
  *(undefined **)(puVar16 + -0x12) = puVar16 + -6;
  *(undefined2 *)(puVar16 + -0x14) = 0x1b0;
  *(undefined2 *)(puVar16 + -0x16) = 0x214;
  FUN_1000_16e4();
  *(undefined2 *)(puVar16 + -0x12) = *(undefined2 *)(puVar16 + -4);
  *(undefined2 *)(puVar16 + -0x14) = *(undefined2 *)(puVar16 + -6);
  *(undefined2 *)(puVar16 + -0x16) = 0x1b4;
  *(undefined2 *)(puVar16 + -0x18) = 0x223;
  FUN_1000_0e5b();
  *(undefined **)(puVar16 + -0x12) = puVar16 + -0xe;
  *(undefined2 *)(puVar16 + -0x14) = 0x1ce;
  *(undefined2 *)(puVar16 + -0x16) = 0x231;
  FUN_1000_16e4();
  *(undefined **)(puVar16 + -0x12) = puVar16 + -0xc;
  *(undefined2 *)(puVar16 + -0x14) = 0x1d1;
  *(undefined2 *)(puVar16 + -0x16) = 0x23e;
  FUN_1000_16e4();
  ...
  *(undefined2 *)(puVar16 + -10) = 1;
  while( true ) {
    ...
    for (iVar7 = 1; iVar7 < 0x29; iVar7 = iVar7 + 1) {
      *(int *)(puVar16 + -0xe) =
           *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) *
           *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) *
           *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) *
           *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) *
           *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) * *(int *)(puVar16 + -0xe) *
  ...
  *(undefined2 *)(puVar16 + -0x12) = *(undefined2 *)(puVar16 + -0xe);
  *(undefined2 *)(puVar16 + -0x14) = 0x1d4;
  *(undefined2 *)(puVar16 + -0x16) = 0x2ce;
  FUN_1000_0e5b();
  return;
}
...

{
  ...
  if (puVar8 <= register0x00000010) {
    *(uint *)((int)&ppcStack2 + iVar12) = uVar9;
    while (uVar9 - 1 != 0) {
      pcVar2 = pcVar14;
      pcVar14 = pcVar14 + 1;
      pcVar1 = pcVar13;
    ...
    *pcVar14 = '\0';
    uVar17 = uVar9 == 0;
LAB_1000_03b3:
    *(undefined2 *)((int)&iStack4 + iVar12) = 0x3b6;
    bVar5 = FUN_1000_03cf();
    iVar10 = extraout_DX;
    if (bVar16 || (bool)uVar17) {
      do {
        uVar3 = DAT_1000_0342;
        if (bVar16) {
          iVar10 = *(int *)((int)&ppcStack2 + iVar12) + iVar10;
          *(uint *)&DAT_11dc_0084 = uVar9;
          ...
          *(int **)&DAT_11dc_0086 = (int *)ppcVar11;
          goto LAB_1000_0417;
        }
        *(undefined2 *)((int)&iStack4 + iVar12) = 0x3bd;
        bVar5 = FUN_1000_03cf();
...
LAB_1000_01e2:
  ...
  *pcVar1 = *pcVar1 + cVar4;
  ...
  while( true ) {
    ...
    for (iVar12 = 1; iVar12 < 0x29; iVar12 = iVar12 + 1) {
...

{
  ...
  FUN_1000_0c63(param_1 & 0xff00 | 0x61,1,param_3,param_2,param_1,iVar1);
  return;
}
...
void FUN_1000_0d4e(uint param_1,int param_2)
...
void FUN_1000_0d53(uint param_1,int param_2)
...
int FUN_1000_1083(undefined4 *param_1,char *param_2)
  ...
  if (cVar15 != '\0') {
    ...
    if (cVar15 == '%') {
      ...
      if (cVar15 != '%') {
        ...
        do {
          bVar13 = false;
          if (0x5f < (byte)(cVar15 - 0x20U)) goto LAB_1000_157a;
          ...
          switch(cVar4) {
          case '\0':
            if (bVar20 != 0) goto LAB_1000_157a;
            if (local_8f != '+') {
              local_8f = cVar15;
            }
            break;
          ...
          case '\x02':
            ...
            if (bVar20 < 2) {
              ...
              if (bVar20 != 4) goto LAB_1000_157a;
              pcVar19 = (char *)0x500;
            }
            break;
          case '\x03':
            ...
            break;
          case '\x04':
            if (3 < bVar20) goto LAB_1000_157a;
            pcVar19 = (char *)0x400;
            break;
          case '\x05':
switchD_1000_1150_caseD_5:
          ...
          case '\b':
            ...
            break;
          case '\t':
            if (bVar20 != 0) goto switchD_1000_1150_caseD_5;
            if (!bVar7) {
              bVar9 = true;
              pcVar19 = (char *)0x100;
            }
...
LAB_1000_128f:
          ...
          case '\x0f':
            pcVar19 = local_92;
            if ((int)local_92 < 0) {
              pcVar19 = (char *)((int)s_Turbo_C___Copyright__c__1988_Bor_11dc_0004 + 2);
            }
            if (bVar11) {
              uVar28 = 2;
              local_6 = 4;
            ...
            thunk_FUN_1000_0d4e(uVar28,local_9a,cVar15,local_89,pcVar19,param_1);
            puVar25 = local_89;
...
LAB_1000_12b2:
  ...
  FUN_1000_0c63(uVar28,local_95,(char)((uint)uVar28 >> 8),puVar25,pcVar17,pcVar21);
  if ((int)local_92 < 1) {
LAB_1000_1437:
    if ((!bVar9) || ((int)local_94 < 1)) goto LAB_1000_1459;
  }
  FUN_1000_109c();
  if (*(char *)puVar25 == '-') {
    pcVar19 = pcVar19 + -1;
...
LAB_1000_17a4:
    ...
    case 10:
      ...
      if (bVar3) {
        ...
        thunk_FUN_1000_0d53(puVar7,uVar11);
      }
      goto LAB_1000_1736;
    case 0xb:
      bVar16 = true;
    ...
    FUN_1000_1bdc(param_1,param_2,param_3,uVar11,(uint)local_24 & 0x7fff,&local_28,&local_26);
    if (local_26 < 1) {
      if (-1 < local_26) {
        return local_2a;
      }
...
LAB_1000_1ac6:
        ...
        local_28 = local_28 + -1;
        if ((int)local_24 <= (int)puVar12) goto LAB_1000_1ae3;
        goto LAB_1000_1ada;
      }
    }
    puVar12 = puVar7;
