...

{
  ...
  if (puVar8 <= register0x00000010) {
    *(char ***)((int)&ppcStack2 + iVar12) = (char **)uVar9;
    while (uVar9 - 1 != 0) {
      pcVar2 = pcVar14;
      pcVar14 = pcVar14 + 1;
      pcVar1 = pcVar13;
    ...
    *(int *)((int)&iStack4 + iVar12) = 0x3b6;
    ...
    if (bVar16 || (bool)uVar17) {
      do {
        uVar3 = DAT_1000_0342;
        if (bVar16) {
          iVar10 = (int)*(char ***)((int)&ppcStack2 + iVar12) + iVar10;
...

{
  ...
  if ((param_3 + 1U < 2) || ((*(uint *)(param_1 * 2 + 0x484) & 0x200) != 0)) {
    ...
    do {
      pcVar5 = (char *)FUN_1000_0ac3(param_1,param_2,param_3);
      if (pcVar5 + 1 < (char *)&DAT_11dc_0002) {
        return pcVar5;
      }
      pcVar7 = param_2;
      pcVar3 = param_2;
      ...
      do {
        while( true ) {
          ...
          pcVar6 = param_2;
          if (cVar2 == '\x1a') {
            FUN_1000_0c38(param_1,-(int)pcVar5,-(uint)(pcVar5 != (char *)0x0),2);
          ...
          *pcVar4 = cVar2;
          ...
          pcVar7 = pcVar7 + 1;
          pcVar3 = pcVar4 + 1;
          if (pcVar5 == (char *)0x0) goto LAB_1000_0a8f;
        }
        pcVar5 = pcVar5 + -1;
        pcVar7 = pcVar7 + 1;
        pcVar3 = pcVar4;
  ...
  if (cVar13 != '\0') {
    ...
    if (cVar13 == '%') {
      ...
      if (cVar13 != '%') {
        ...
        do {
          bVar12 = false;
          if (0x5f < (byte)(cVar13 - 0x20U)) goto LAB_1000_157a;
...
LAB_1000_128f:
          ...
          case '\x0f':
            ...
            thunk_FUN_1000_0d4e(uVar27,local_9a,cVar13,local_89,puVar17,param_1);
            puVar24 = local_89;
...
LAB_1000_12b2:
  ...
  FUN_1000_0c63(uVar27,local_95,(char)((uint)uVar27 >> 8),puVar24,pcVar15,pcVar20);
  if ((int)local_92 < 1) {
LAB_1000_1437:
