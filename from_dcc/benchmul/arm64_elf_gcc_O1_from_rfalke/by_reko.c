...
{
	x0_14 = (uint64) puts("enter number of iterations");
	x0_19 = (uint64) __isoc99_scanf("%ld", fp + -1);
	x0_24 = (uint64) printf("executing %ld iterations\n", (int32) qwLoc08);
	x0_30 = (uint64) __isoc99_scanf("%d", (char *) fp + 4);
	x0_34 = (uint64) __isoc99_scanf("%d", fp);
	if (qwLoc08 > 0x00)
	{
		int32 w1_105 = dwArg04;
		int64 x3_40 = 0x01;
		do
		{
			word32 w2_41;
