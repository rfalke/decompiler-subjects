...

{
  ...
  puVar13 = (undefined *)&DAT_11da_0080;
                    // WARNING: Read-only address (ram,0x000101f8) is written
  uRam000101f8 = 0x11da;
  pcVar6 = (code *)swi(0x21);
  uVar28 = (*pcVar6)();
  uVar27 = s_Turbo_C___Copyright__c__1988_Bor_11da_0004._40_2_;
  iVar10 = DAT_11da_0002;
  iVar11 = (int)((ulong)uVar28 >> 0x10);
  *(undefined2 *)&DAT_11da_0092 = (int)uVar28;
  *(undefined2 *)&DAT_11da_0090 = unaff_ES;
  *(undefined2 *)&DAT_11da_008c = uVar27;
  *(int *)&DAT_11da_00ac = iVar10;
  *(undefined2 *)&DAT_11da_0096 = 0xffff;
  *(undefined2 *)(puVar13 + -2) = 0x2e;
  FUN_1000_0162();
  uVar28 = *(undefined4 *)&DAT_11da_008a;
  ...
  *(int *)&DAT_11da_008a = -(uVar9 | 0x8000);
  *(uint *)&DAT_11da_008e = (int)piVar23 * 2 + 8U & 0xfff8;
  uVar21 = iVar10 - iVar11;
  uVar9 = *(uint *)&DAT_11da_024c;
  if (uVar9 < 0x200) {
    uVar9 = 0x200;
    *(undefined2 *)&DAT_11da_024c = 0x200;
  }
  if ((uVar9 < 0xf9c2) && (puVar2 = (uint *)&DAT_11da_024a, !CARRY2(uVar9 + 0x63e,*puVar2))) {
    bVar8 = 4;
    uVar9 = (uVar9 + 0x63e + *puVar2 >> 4) + 1;
    if (uVar9 <= uVar21) {
      ...
      iVar12 = uVar9 + iVar11;
      *(int *)&DAT_11da_00a4 = iVar12;
      *(int *)&DAT_11da_00a8 = iVar12;
      iVar12 = iVar12 - *(int *)&DAT_11da_0090;
      piVar14 = (int *)(puVar13 + -2);
      *(uint *)(puVar13 + -2) = uVar9;
      pcVar6 = (code *)swi(0x21);
      (*pcVar6)();
      iVar25 = *piVar14 << (bVar8 & 0x1f);
      puVar26 = (undefined *)&DAT_11da_05f8;
      ...
      *(int *)&DAT_11da_009a = iVar10;
      pcVar5 = *(code **)&DAT_11da_05ee;
      puVar17 = puVar16 + -2;
      *(undefined2 *)(puVar16 + -2) = 0x10e;
      (*pcVar5)();
      *(undefined2 *)(puVar17 + -2) = *(undefined2 *)&DAT_11da_0088;
      *(undefined2 *)(puVar17 + -4) = *(undefined2 *)&DAT_11da_0086;
      *(undefined2 *)(puVar17 + -6) = *(undefined2 *)&DAT_11da_0084;
      *(undefined2 *)(puVar17 + -8) = 0x11d;
      uVar27 = FUN_1000_01fa();
      ...
      *(byte **)(puVar20 + -0xe) = pbVar22;
      *(undefined **)(puVar20 + -0x10) = puVar26;
      *(undefined2 *)(puVar20 + -0x12) = 0x1a8;
      *(undefined2 *)(puVar20 + -0x14) = 0x209;
      FUN_1000_0e2d();
      *(undefined **)(puVar20 + -0x12) = puVar20 + -6;
      *(undefined2 *)(puVar20 + -0x14) = 0x1c4;
      *(undefined2 *)(puVar20 + -0x16) = 0x215;
      FUN_1000_16b6();
      *(undefined2 *)(puVar20 + -0x12) = *(undefined2 *)(puVar20 + -4);
      *(undefined2 *)(puVar20 + -0x14) = *(undefined2 *)(puVar20 + -6);
      *(undefined2 *)(puVar20 + -0x16) = 0x1c8;
      *(undefined2 *)(puVar20 + -0x18) = 0x224;
      FUN_1000_0e2d();
      uVar27 = 0x14;
      *(undefined2 *)(puVar20 + -0xc) = 0x14;
      *(undefined2 *)(puVar20 + -8) = 0;
      *(undefined2 *)(puVar20 + -10) = 1;
      while( true ) {
        if ((*(int *)(puVar20 + -4) <= *(int *)(puVar20 + -8)) &&
           ((*(int *)(puVar20 + -4) < *(int *)(puVar20 + -8) ||
            (*(uint *)(puVar20 + -6) <= *(uint *)(puVar20 + -10) &&
             *(uint *)(puVar20 + -10) != *(uint *)(puVar20 + -6))))) break;
        for (iVar10 = 1; iVar10 < 0x29; iVar10 = iVar10 + 1) {
          uVar27 = 0;
        }
        puVar2 = (uint *)(puVar20 + -10);
        uVar9 = *puVar2;
        *puVar2 = *puVar2 + 1;
        *(uint *)(puVar20 + -8) = *(int *)(puVar20 + -8) + (uint)(0xfffe < uVar9);
      }
      *(undefined2 *)(puVar20 + -0x12) = uVar27;
      *(undefined2 *)(puVar20 + -0x14) = 0x1e2;
      *(undefined2 *)(puVar20 + -0x16) = 0x29f;
      FUN_1000_0e2d();
      return;
    }
  }
...

{
  ...
  *pbVar1 = *pbVar1 + cVar3;
  ...
  FUN_1000_0e2d(0x1a8);
  FUN_1000_16b6(0x1c4,&uStack_2);
  FUN_1000_0e2d(0x1c8,uStack_2,0x1f8);
  uVar7 = 0x14;
  iStack_4 = 0;
  uStack_6 = 1;
  while( true ) {
    ...
    bVar8 = 0xfffe < uStack_6;
    uStack_6 = uStack_6 + 1;
    iStack_4 = iStack_4 + (uint)bVar8;
  }
...

{
  ...
  *pcVar1 = *pcVar1 + cVar2;
  FUN_1000_0e2d(0x1a8);
  FUN_1000_16b6(0x1c4,&uStack_6);
  FUN_1000_0e2d(0x1c8,uStack_6,iStack_4);
  uVar3 = 0x14;
  iStack_8 = 0;
  uStack_a = 1;
  while( true ) {
    ...
    bVar5 = 0xfffe < uStack_a;
    uStack_a = uStack_a + 1;
    iStack_8 = iStack_8 + (uint)bVar5;
  }
  FUN_1000_0e2d(0x1e2,uVar3);
  return;
}
...

{
  ...
  else if (param_1 < 0x59) goto LAB_1000_02ba;
  param_1 = 0x57;
LAB_1000_02ba:
...

{
  ...
  pcVar9 = (char *)(DAT_11da_008a + 2);
  uVar6 = 1;
  uVar11 = DAT_11da_0090;
  DAT_1000_0312 = in_stack_00000000;
  if (2 < (byte)DAT_11da_0092) {
    uVar6 = 0x7f;
    pcVar10 = pcVar9;
    do {
      if (uVar6 == 0) break;
    ...
    if (uVar6 == 0) goto LAB_1000_03c9;
    uVar6 = uVar6 ^ 0x7f;
    uVar11 = _DAT_11da_008c;
  }
  puVar5 = (undefined *)(*(byte *)&DAT_11da_0080 + 2 + uVar6 & 0xfffe);
  iVar3 = -(int)puVar5;
  ...
  if (puVar5 <= &stack0x0000) {
    ...
    *pcVar10 = '\0';
    uVar13 = uVar6 == 0;
LAB_1000_0385:
    *(undefined2 *)((int)auStack_4 + iVar3) = 0x388;
    bVar4 = 0;
    FUN_1000_03a1();
    iVar7 = extraout_DX;
    if (bVar12 || (bool)uVar13) {
      do {
        ...
        if (bVar12) {
          ...
          *(uint *)&DAT_11da_0084 = uVar6;
          ppcVar8 = (char **)(&stack0x0000 + (uVar6 + 1) * -2);
          if (&stack0x0000 < (undefined *)((uVar6 + 1) * 2)) goto LAB_1000_03c9;
          *(int **)&DAT_11da_0086 = (int *)ppcVar8;
          goto LAB_1000_03e9;
        }
        *(undefined2 *)((int)auStack_4 + iVar3) = 0x38f;
        bVar4 = 0;
        FUN_1000_03a1();
...

{
  ...
  if (pcVar4 != (char *)0x0) {
    ...
    ppcVar5 = (char **)FUN_1000_0552(DAT_11da_008e);
    DAT_11da_0088 = ppcVar5;
    if (ppcVar5 != (char **)0x0) {
      iVar6 = -1;
      do {
        *ppcVar5 = pcVar4;
...

{
  ...
  if ((((int *)param_1[7] == param_1) && (param_3 < 3)) && (param_4 < 0x8000)) {
    ...
    else if ((DAT_11da_04ba == 0) && (param_1 == (int *)0x352)) {
      DAT_11da_04ba = 1;
    }
    if (*param_1 != 0) {
...

{
  ...
  else if ((*(uint *)(param_1 * 2 + 0x492) & 0x8000) == 0) {
    puVar1 = (uint *)(param_1 * 2 + 0x492);
...
void __cdecl16near FUN_1000_0cb4(int param_1,undefined2 param_2,int param_3)

{
  ...
  FUN_1000_0c35(0x61,1,param_3,param_2,param_1,iVar1);
  return;
}
...

{
  ...
  if ((param_1[1] & 8U) == 0) {
    ...
    else if ((*param_1 == 0) || (iVar3 = FUN_1000_0daf(param_1), iVar3 == 0)) {
...
void FUN_1000_1055(void)

{
  undefined2 unaff_SI;
  
  FUN_1000_10af(unaff_SI);
  return;
}
...
LAB_1000_10bf:
  pcVar22 = pcVar21 + 1;
  cVar11 = *pcVar21;
  if (cVar11 == '\0') goto LAB_1000_1554;
  if (cVar11 == '%') {
    *(char **)(unaff_BP + -0x8a) = pcVar22;
    pcVar1 = pcVar22;
    pcVar22 = pcVar21 + 2;
    cVar11 = *pcVar1;
    if (cVar11 != '%') goto code_r0x000110e1;
  }
  *pcVar23 = cVar11;
  pcVar23 = pcVar23 + 1;
  pcVar1 = (char *)(unaff_BP + -0x55);
...
code_r0x000110e1:
  ...
  *(undefined2 *)(unaff_BP + -0x90) = 0xffff;
  do {
    if (0x5f < (byte)(cVar11 - 0x20U)) goto switchD_1000_1122_caseD_13;
    cVar5 = *(char *)((byte)(cVar11 - 0x20U) + 0x509);
    cVar19 = cVar5 * '\x02';
    bVar18 = (byte)(uVar15 >> 8);
    uVar28 = unaff_SS;
    switch(cVar5) {
    case '\0':
      if (bVar18 != 0) goto switchD_1000_1122_caseD_13;
      ...
      *piVar2 = *piVar2 + 2;
      if (bVar18 < 2) {
        *(undefined2 *)(unaff_BP + -0x92) = uVar14;
        ...
        if (bVar18 != 4) goto switchD_1000_1122_caseD_13;
    ...
    case '\x03':
      ...
      *puVar3 = *puVar3 | 2;
      break;
    case '\x04':
      if (3 < bVar18) goto switchD_1000_1122_caseD_13;
      uVar15 = 0x400;
      break;
    case '\x05':
...
LAB_1000_1554:
    ...
    case '\b':
      ...
      *puVar3 = *puVar3 | 0x80;
      ...
      break;
    case '\t':
      if (bVar18 != 0) goto switchD_1000_1122_caseD_5;
...
LAB_1000_1261:
    ...
    case '\x0f':
      ...
      *(char *)(unaff_BP + -0x94) = cVar11;
      ...
      thunk_FUN_1000_0d20(uVar13,uVar7 & 1,cVar11,unaff_BP + -0x87,uVar15,uVar14);
      piVar2 = (int *)(unaff_BP + 4);
    ...
    case '\x12':
      ...
      *piVar27 = (uint)(byte)(0x50 - *(char *)(unaff_BP + -0x55)) + *(int *)(unaff_BP + -0x58);
      goto LAB_1000_10b8;
    default:
      goto switchD_1000_1122_caseD_13;
    case '\x16':
      puVar3 = (uint *)(unaff_BP + -0x98);
...
LAB_1000_1284:
  ...
  *(int **)(unaff_BP + 4) = piVar24;
  ...
  FUN_1000_0c35(uVar14,*(undefined *)(unaff_BP + -0x93),(char)((uint)uVar14 >> 8),puVar26,iVar20,
                iVar16);
...
undefined2 __cdecl16near FUN_1000_1703(void)
...
LAB_1000_1708:
  ...
  pbVar13 = pbVar13 + 1;
  bVar11 = *pbVar3;
  if (bVar11 == 0) goto LAB_1000_1ae1;
  if (bVar11 != 0x25) goto LAB_1000_1711;
...
LAB_1000_1776:
  ...
  *(byte **)(unaff_BP + 10) = pbVar13;
  if ((int)puVar8 < 0) goto LAB_1000_1ae1;
  bVar11 = *(byte *)(puVar8 + 0x2b5);
  switch(bVar11) {
  case 0:
  case 1:
  case 2:
    goto LAB_1000_1ae1;
  case 3:
    goto switchD_1000_1794_caseD_3;
  case 4:
  ...
  case 5:
    ...
    *piVar1 = (int)(puVar8 + -0x18);
    ...
    goto LAB_1000_1776;
  case 6:
    goto switchD_1000_1794_caseD_6;
  case 7:
  case 8:
    uVar10 = 10;
    break;
  case 9:
    ...
    break;
  case 10:
    thunk_FUN_1000_0d25(*(undefined2 *)(unaff_BP + 4),*(undefined2 *)(unaff_BP + 6),
    ...
    if (iVar6 < 1) {
      thunk_FUN_1000_0d25();
      if (cVar17 == cVar5) goto LAB_1000_1ae1;
    ...
    if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
      ...
      *piVar1 = *piVar1 + 1;
      ...
      thunk_FUN_1000_0d25(puVar8,uVar10);
    }
    else {
      thunk_FUN_1000_0d25();
    }
  ...
  case 0xf:
    ...
    goto LAB_1000_1ae8;
  case 0x10:
    goto switchD_1000_1794_caseD_10;
  case 0x11:
    pbVar14 = pbVar13;
    if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) goto LAB_1000_1860;
    goto LAB_1000_1776;
  case 0x12:
    uVar10 = 0x10;
    break;
  ...
  case 0x14:
    ...
    *pbVar3 = *pbVar3 & 0xdf;
    ...
    goto LAB_1000_1776;
  case 0x15:
    goto switchD_1000_1794_caseD_15;
  default:
    goto switchD_1000_1794_caseD_16;
  }
  ...
  FUN_1000_1bae(*(undefined2 *)(unaff_BP + 4),*(undefined2 *)(unaff_BP + 6),
                *(undefined2 *)(unaff_BP + 8),uVar10,*(uint *)(unaff_BP + -0x22) & 0x7fff,
                unaff_BP + -0x26,unaff_BP + -0x24);
  iVar6 = *(int *)(unaff_BP + -0x24);
  if (iVar6 < 1) {
    if (-1 < iVar6) goto LAB_1000_1ae1;
    goto switchD_1000_1794_caseD_16;
  }
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    piVar1 = (int *)(unaff_BP + -0x28);
...
LAB_1000_1860:
  ...
  goto LAB_1000_1705;
switchD_1000_1794_caseD_15:
  pbVar3 = (byte *)(unaff_BP + -0x29);
  *pbVar3 = *pbVar3 | 0x20;
  pbVar14 = pbVar13;
  goto LAB_1000_1776;
switchD_1000_1794_caseD_10:
  ...
  *pbVar3 = *pbVar3 | bVar11;
  ...
  while( true ) {
    ...
    if (((bVar11 != 0x2d) ||
       ...
       (*pbVar13 == 0x5d)) goto LAB_1000_1a05;
    pbVar14 = pbVar14 + 2;
  ...
  while (iVar7 = iVar6 + -1, 0 < iVar6) {
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if ((*(byte *)(unaff_BP + (uVar9 >> 3) + -0x20) & '\x01' << ((byte)uVar9 & 7)) == 0) {
      if ((*(byte *)(unaff_BP + -0x29) & 0x10) == 0) goto LAB_1000_1a98;
    }
...
LAB_1000_1b03:
  ...
  if (((char)iVar7 < '\0') || (*(char *)(iVar7 + 0x56a) != '\x01')) goto LAB_1000_1b03;
  goto LAB_1000_1ae8;
switchD_1000_1794_caseD_6:
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    FUN_1000_16ea();
  }
  iVar6 = *(int *)(unaff_BP + -0x22);
...
LAB_1000_19bf:
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if (iVar7 < 0) goto switchD_1000_1794_caseD_16;
  }
LAB_1000_19d9:
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    piVar1 = (int *)(unaff_BP + -0x28);
...
LAB_1000_1711:
  ...
  *piVar1 = *piVar1 + 1;
  iVar7 = (**(code **)(unaff_BP + 4))(*(undefined2 *)(unaff_BP + 8));
  if (iVar7 < 0) goto switchD_1000_1794_caseD_16;
  if ((iVar6 < 0) || (*(char *)(iVar6 + 0x56a) != '\x01')) {
    if (iVar7 != iVar6) {
    ...
    while ((-1 < (char)iVar7 && (*(char *)(iVar7 + 0x56a) == '\x01'))) {
      piVar1 = (int *)(unaff_BP + -0x26);
      *piVar1 = *piVar1 + 1;
      iVar7 = (**(code **)(unaff_BP + 4))(*(undefined2 *)(unaff_BP + 8));
      if (iVar7 < 1) goto switchD_1000_1794_caseD_16;
    }
    (**(code **)(unaff_BP + 6))(iVar7,*(undefined2 *)(unaff_BP + 8));
    piVar1 = (int *)(unaff_BP + -0x26);
    *piVar1 = *piVar1 + -1;
