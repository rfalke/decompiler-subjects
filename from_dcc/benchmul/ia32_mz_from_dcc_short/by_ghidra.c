...

{
  ...
  *(int **)&DAT_11da_008e = piVar18;
  ...
  piVar20 = (int *)(uVar9 + 0x63e);
  if ((uVar9 < 0xf9c2) &&
     (puVar2 = (uint *)&DAT_11da_024a, bVar23 = CARRY2((uint)piVar20,*puVar2),
    ...
    if (piVar20 <= piVar16) {
      ...
      *(int *)&DAT_11da_00a4 = iVar10;
      *(int *)&DAT_11da_00a8 = iVar10;
      piVar18 = (int *)(iVar10 - *(int *)&DAT_11da_0090);
      piVar12 = (int *)((undefined *)piVar11 + -2);
      *(int **)((undefined *)piVar11 + -2) = piVar20;
      pcVar5 = (code *)swi(0x21);
      (*pcVar5)();
      iVar19 = *piVar12 << (bVar8 & 0x1f);
      piVar20 = (int *)&DAT_11da_05f8;
      iVar10 = 0x46;
      while (iVar10 != 0) {
        iVar10 = iVar10 + -1;
        piVar1 = piVar20;
...
LAB_1000_01e9:
  ...
  *(byte **)(puVar17 + -0xe) = unaff_SI;
  *(int **)(puVar17 + -0x10) = piVar20;
  *(undefined2 *)(puVar17 + -0x12) = 0x1a8;
  *(undefined2 *)(puVar17 + -0x14) = 0x209;
  FUN_1000_0e2d();
  *(undefined **)(puVar17 + -0x12) = puVar17 + -6;
  *(undefined2 *)(puVar17 + -0x14) = 0x1c4;
  *(undefined2 *)(puVar17 + -0x16) = 0x215;
  FUN_1000_16b6();
  *(undefined2 *)(puVar17 + -0x12) = *(undefined2 *)(puVar17 + -4);
  *(undefined2 *)(puVar17 + -0x14) = *(undefined2 *)(puVar17 + -6);
  *(undefined2 *)(puVar17 + -0x16) = 0x1c8;
  *(undefined2 *)(puVar17 + -0x18) = 0x224;
  FUN_1000_0e2d();
  uVar21 = 0x14;
  *(undefined2 *)(puVar17 + -0xc) = 0x14;
  ...
  *(undefined2 *)(puVar17 + -10) = 1;
  while( true ) {
    ...
    uVar9 = *puVar2;
    *puVar2 = *puVar2 + 1;
    *(uint *)(puVar17 + -8) = *(int *)(puVar17 + -8) + (uint)(0xfffe < uVar9);
  }
  *(undefined2 *)(puVar17 + -0x12) = uVar21;
  *(undefined2 *)(puVar17 + -0x14) = 0x1e2;
  *(undefined2 *)(puVar17 + -0x16) = 0x29f;
  FUN_1000_0e2d();
  return;
}
...

{
  ...
  if (puVar6 <= register0x00000010) {
    *(uint *)(char ***)((int)&ppcStack2 + iVar13) = uVar7;
    while (uVar7 - 1 != 0) {
      pcVar2 = pcVar14;
      pcVar14 = pcVar14 + 1;
      pcVar1 = pcVar12;
    ...
    *(int *)((int)&iStack4 + iVar13) = 0x388;
    ...
    if (bVar16 || bVar17) {
      do {
        ...
        if (bVar16) {
          iVar8 = (int)*(char ***)((int)&ppcStack2 + iVar13) + iVar8;
          *(uint *)&DAT_11da_0084 = uVar7;
          ...
          *(char ***)(int **)&DAT_11da_0086 = ppcVar10;
          goto LAB_1000_03e9;
        }
        *(int *)((int)&iStack4 + iVar13) = 0x38f;
        bVar4 = FUN_1000_03a1();
...

{
  ...
  *pcVar1 = *pcVar1 + cVar3;
  FUN_1000_0e2d(0x1a8,pcVar6,unaff_SI);
  FUN_1000_16b6(0x1c4,&uStack6);
  FUN_1000_0e2d(0x1c8,uStack6,iStack4);
  uVar8 = 0x14;
  iStack8 = 0;
  ...
  FUN_1000_0e2d(0x1e2,uVar8,pcVar6,unaff_SI,0x14);
  return;
}



uint __cdecl16near FUN_1000_044d(undefined2 param_1)
...

{
  ...
  if ((param_1 == 0) || (0xfff4 < param_1)) {
    ...
    if (DAT_11da_063c == 0) {
      uVar2 = FUN_1000_0518(uVar3);
    }
    else {
      puVar4 = DAT_11da_063a;
      if (DAT_11da_063a != (uint *)0x0) {
        do {
          if (uVar3 + 0x28 <= *puVar4) {
            uVar2 = FUN_1000_04a1(puVar4,uVar3);
            return (uint *)uVar2;
          }
          if (uVar3 <= *puVar4) {
            FUN_1000_0473(puVar4);
            puVar1 = puVar4;
            *puVar1 = *puVar1 + 1;
            return puVar4 + 2;
          }
          puVar4 = (uint *)puVar4[3];
        } while (puVar4 != DAT_11da_063a);
      }
      uVar2 = FUN_1000_04db(uVar3);
    }
  }
  return (uint *)uVar2;
}
...
long __cdecl16near FUN_1000_06e8(int *param_1)

{
  ...
  if (iVar1 == 0) {
    lVar2 = FUN_1000_1d30((int)*(char *)(param_1 + 2));
    if (0 < *param_1) {
      iVar1 = FUN_1000_063d(param_1);
      lVar2 = lVar2 - iVar1;
    }
  }
  else {
  ...
  while( true ) {
    ...
    *piVar1 = *piVar1 + 1;
    ...
    while (puVar2 = (uint *)(param_1 + 1), *puVar2 = *puVar2 | 0x80, param_1[3] == 0) {
      ...
      FUN_1000_08e6(0x352,0,(uint)((DAT_11da_0354 & 0x200) != 0),0x200);
    }
...
char * __cdecl16near FUN_1000_09d9(int param_1,char *param_2,int param_3)

{
  ...
  if ((param_3 + 1U < 2) || ((*(uint *)(param_1 * 2 + 0x492) & 0x200) != 0)) {
    ...
    do {
      iVar5 = FUN_1000_0a95(param_1,param_2,param_3);
      if (iVar5 + 1U < (uint)&DAT_11da_0002) {
        return (char *)iVar5;
      }
      pcVar7 = param_2;
      pcVar3 = param_2;
      ...
      do {
        while( true ) {
          ...
          pcVar6 = param_2;
          if (cVar2 == '\x1a') {
            FUN_1000_0c0a(param_1,-iVar5,-(uint)(iVar5 != 0),2);
...
char * __cdecl16near FUN_1000_0ab1(int param_1,char *param_2,char *param_3)
  ...
  if (param_3 + 1 < (char *)0x2) {
    ...
    if ((*(uint *)(param_1 * 2 + 0x492) & 0x8000) == 0) {
      ...
      *puVar1 = *puVar1 & 0xfdff;
      ...
      while (local_8a != (char *)0x0) {
        ...
        *pcVar4 = cVar2;
        ...
        if (0x7f < (int)(pcVar4 + -(int)local_84)) {
          ...
          pcVar3 = (char *)FUN_1000_0bc4(param_1,local_84,pcVar4);
          if (pcVar3 != pcVar4) {
      ...
      pcVar4 = pcVar4 + -(int)local_84;
      if ((pcVar4 != (char *)0x0) &&
         (pcVar3 = (char *)FUN_1000_0bc4(param_1,local_84,pcVar4), pcVar3 != pcVar4)) {
        param_3 = pcVar3 + (int)(param_3 + -(int)pcVar4);
      }
    }
    else {
      param_3 = (char *)FUN_1000_0bc4(param_1,param_2,param_3);
    }
  }
  return param_3;
}
...

{
  ...
  FUN_1000_0c35(param_1 & 0xff00 | 0x61,CONCAT11((char)(param_1 >> 8),1),param_3,param_2,param_1,
                iVar1);
  return;
}
...

{
  ...
  FUN_1000_0c35(CONCAT11((char)(in_AX >> 8),0x61),in_AX & 0xff00,param_4,param_3,param_1,param_2);
  return;
}
...
{
  FUN_1000_0c35(0x61,(uint)(param_4 == 10),param_4,param_3,param_1,param_2);
  return;
}



void FUN_1000_0d20(uint param_1,int param_2,undefined2 param_3)
...
void FUN_1000_0d25(uint param_1,int param_2,undefined2 param_3)
...
uint __cdecl16near FUN_1000_0e5f(undefined param_1,int *param_2)

{
    ...
    *piVar1 = *piVar1 + 1;
    if (SCARRY2(iVar4,1) != *piVar1 < 0) {
      ...
      *(byte *)(piVar3[5] + -1) = local_3;
      if (((piVar3[1] & 8U) != 0) &&
         (((local_3 == 10 || (local_3 == 0xd)) && (iVar4 = FUN_1000_0daf(piVar3), iVar4 != 0)))) {
        return 0xffff;
      }
      return (uint)local_3;
    }
  ...
  if (((((local_3 == 10) && ((piVar3[1] & 0x40U) == 0)) &&
       (iVar4 = FUN_1000_0bc4((int)*(char *)(piVar3 + 2),0x4f0,1), iVar4 != 1)) ||
      (iVar4 = FUN_1000_0bc4((int)*(char *)(piVar3 + 2),&param_1,1), iVar4 != 1)) &&
     ((piVar3[1] & 0x200U) == 0)) {
    puVar2 = (uint *)(piVar3 + 1);
    *puVar2 = *puVar2 | 0x10;
    return 0xffff;
...

{
  ...
  *unaff_DI = *(undefined *)(ulong)((uint)(bVar1 >> 4) + 0x4f9);
  unaff_DI[1] = *(undefined *)(ulong)((uint)(bVar1 & 0xf) + 0x4f9);
  unaff_DI[2] = *(undefined *)(ulong)((uint)(byte)((byte)param_1 >> 4) + 0x4f9);
  unaff_DI[3] = *(undefined *)(ulong)((uint)((byte)param_1 & 0xf) + 0x4f9);
  return;
}



int FUN_1000_1055(undefined4 *param_1,byte *param_2)
  ...
  if (bVar13 != 0) {
    ...
    if (bVar13 == 0x25) {
      ...
      if (bVar13 != 0x25) {
        ...
        do {
          bVar12 = false;
          if (0x5f < (byte)(bVar13 - 0x20)) goto LAB_1000_154c;
          cVar4 = *(char *)((uint)(byte)(bVar13 - 0x20) + 0x509);
          cVar21 = cVar4 * '\x02';
          ...
          switch(cVar4) {
          case '\0':
            if (bVar19 != 0) goto LAB_1000_154c;
            if (local_8f != 0x2b) {
              local_8f = bVar13;
            }
            break;
          ...
          case '\x02':
            ...
            if (bVar19 < 2) {
              ...
              if (bVar19 != 4) goto LAB_1000_154c;
              puVar17 = (uint *)(s_0123456789ABCDEF_11da_04f9 + 7);
            }
            break;
          case '\x03':
            if (bVar19 != 0) goto LAB_1000_154c;
            ...
            break;
          case '\x04':
            if (3 < bVar19) goto LAB_1000_154c;
            puVar17 = (uint *)0x400;
            break;
          case '\x05':
switchD_1000_1122_caseD_5:
          ...
          case '\b':
            ...
            break;
          case '\t':
            if (bVar19 != 0) goto switchD_1000_1122_caseD_5;
            if (!bVar6) {
              local_9a = local_9a | 8;
              bVar8 = true;
              puVar17 = (uint *)0x100;
...
LAB_1000_1261:
          ...
          case '\x0f':
            puVar17 = local_92;
            if ((int)local_92 < 0) {
              puVar17 = (uint *)(s_Turbo_C___Copyright__c__1988_Bor_11da_0004 + 2);
            }
            if (bVar10) {
              uVar29 = 2;
              local_6 = 4;
            ...
            thunk_FUN_1000_0d20(uVar29,local_9a & 1,(uint)bVar13,local_89,puVar17,param_1);
            puVar26 = local_89;
...
LAB_1000_1284:
  ...
  FUN_1000_0c35(uVar29,(uint)local_95,(int)(char)((uint)uVar29 >> 8),puVar26,pcVar15,pcVar20);
  if ((int)local_92 < 1) {
LAB_1000_1409:
    if ((!bVar8) || ((int)local_94 < 1)) goto LAB_1000_142b;
  }
  FUN_1000_106e();
...
LAB_1000_1776:
    ...
    case 10:
      ...
      if (bVar3) {
        ...
        thunk_FUN_1000_0d25(puVar14,uVar8);
      }
      goto LAB_1000_1708;
    case 0xb:
      bVar16 = true;
    ...
    FUN_1000_1bae(param_1,param_2,param_3,uVar8,(uint)local_24 & 0x7fff,&local_28,&local_26);
    if (local_26 < 1) {
      if (-1 < local_26) {
        return local_2a;
      }
...
LAB_1000_1a98:
        ...
        local_28 = local_28 + -1;
        if ((int)local_24 <= (int)puVar11) goto LAB_1000_1ab5;
        goto LAB_1000_1aac;
      }
    }
    puVar11 = puVar14;
