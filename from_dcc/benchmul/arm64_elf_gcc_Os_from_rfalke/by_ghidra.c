...

{
  ...
  __isoc99_scanf(&DAT_00100a83,&major);
  printf("executing %ld iterations\n",major);
  __isoc99_scanf(&DAT_00100aa1,&a);
  __isoc99_scanf(&DAT_00100aa1,&b);
  bVar1 = false;
  iVar2 = a;
  for (lVar3 = 1; lVar3 <= major; lVar3 = lVar3 + 1) {
    iVar4 = 0x28;
    do {
      iVar4 = iVar4 + -1;
      iVar2 = iVar2 * iVar2 * 3 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 *
                      iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2 * iVar2
                      * iVar2 * iVar2 * iVar2 * iVar2 * iVar2;
    } while (iVar4 != 0);
    bVar1 = true;
  }
  if (bVar1) {
...
// WARNING: Removing unreachable block (ram,0x00100900)
// WARNING: Removing unreachable block (ram,0x0010090c)
