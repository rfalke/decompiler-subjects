...

{
  ...
  __isoc99_scanf(&DAT_00100b18,&major);
  printf("executing %ld iterations\n",major);
  __isoc99_scanf(&DAT_00100b40,&a);
  __isoc99_scanf(&DAT_00100b40,&b);
  for (d = 1; d <= major; d = d + 1) {
    for (c = 1; c < 0x29; c = c + 1) {
      a = a * 3 * a * a * a * a * a * a * a * a * a * a * a * a * a * a * a * a * a * a * a * a * a
          * a * a * a;
    }
  }
  printf("a=%d\n",(ulong)(uint)a);
