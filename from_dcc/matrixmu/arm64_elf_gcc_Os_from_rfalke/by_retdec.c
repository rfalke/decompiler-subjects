...
int64_t function_7e8(int64_t a1, int64_t a2);
int64_t register_tm_clones(int64_t * a1, int64_t a2);

// --------------------- Global Variables ---------------------

int64_t g1 = 1976; // 0x10da8
int64_t g2 = 1904; // 0x10db0
...
// Address range: 0x730 - 0x76c
int64_t register_tm_clones(int64_t * a1, int64_t a2) {
    // 0x730
    return &g11;
}

// Address range: 0x770 - 0x7b8
int64_t __do_global_dtors_aux(void) {
    unsigned char result = *(char *)&g11; // 0x780
    if (result != 0) {
        // 0x7ac
        return result;
    }
