...
l0800_0D51:
						...
						if (ax_1108 == 0x00 && dx_1092 == 0x00)
						{
							if (wLoc92_245 == 0x00)
							{
								if (wLoc94_244 != 0x00 && wLoc94_244 != ~0x00)
								{
									...
									} while (fn0800_0B48(dl_1073, fp - 0x02, di_1413, ds, out dx_1079, out bx_1080, out di_1047, out es_1082) != 0x01);
								}
								goto l0800_0B89;
							}
						}
					...
					case 0x0E:
						...
						if ((wLoc9A_1036 & 0x20) != 0x00)
						{
							...
							Eq_891 di_1198 = fn0800_0AF7(fp - 0x8A, es_1196, ds, wArg00);
						...
						Eq_891 di_1169 = fn0800_0AF7(di_1145, es_1022, ds, wArg00);
						ds->*di_1169 = 0x00;
...
l0800_0ED6:
						if ((wLoc9A_1036 & 0x08) != 0x00)
						{
							...
							{
l0800_0EE6:
								Eq_3 cx_908 = fn0800_0B3B(di_1179, es_1022);
						...
						cx_1296 = fn0800_0B3B(di_1179, es_1022);
						goto l0800_0F17;
					case 0x10:
...
l0800_0F64:
								...
								if ((wLoc9A_1036 & 0x02) == 0x00)
								{
									while (bx_533 > cx_552)
									{
										word16 dx_784;
										word16 bx_785;
										cx_552 = fn0800_0B48(0x20, fp - 0x02, di_1047, ds, out dx_784, out bx_785, out di_1047, out es_1022);
										sp_1024 = (union Eq_3 Eq_3::*) ((char *) sp_1024 + 0x0000FFFE);
										bx_533 = bx_785 - 0x01;
									}
								}
								if ((wLoc9A_1036 & 0x40) != 0x00)
								{
									...
									fn0800_0B48(0x30, fp - 0x02, di_1047, ds, out dx_755, out bx_756, out di_757, out es_758);
									word16 dx_762;
									cx_552 = fn0800_0B48(dl_265, fp - 0x02, di_757, ds, out dx_762, out bx_533, out di_1047, out es_1022);
								...
								if (wLoc8E_241 > 0x00)
								{
									...
									if (al_682 == 0x2D || (al_682 == 0x20 || al_682 == 0x2B))
									{
										...
										cx_676 = fn0800_0B48(ds->*di_1179.u0, fp - 0x02, di_1047, ds, out dx_582, out bx_738, out di_1047, out es_740) - 0x01;
										bx_533 = bx_738 - 0x01;
									}
									Eq_3 dx_703 = cx_676;
									if (dx_582 != 0x00)
									{
										...
										} while (fn0800_0B48(0x30, fp - 0x02, di_1412, ds, out dx_703, out bx_533, out di_1047, out es_728) != 0x01);
									}
									cx_552 = dx_703;
								}
								if (cx_552 != 0x00)
								{
									...
									do
									{
										...
										if (v42_658 <= 0x00)
										{
											...
											cx_552 = fn0800_0B50(fp - 0x02, di_1047, out dx_669, out bx_533, out di_1047, out es_672);
										}
										--cx_552;
									} while (cx_552 != 0x00);
								}
								if (bx_533 > 0x00)
								{
									...
									} while (fn0800_0B48(0x20, fp - 0x02, di_1411, ds, out dx_633, out bx_634, out di_1047, out es_636) != 0x01);
								}
								goto l0800_0B89;
							}
							if (wLoc8E_241 <= 0x00)
...
l0800_100F:
						...
						do
						{
							...
							fn0800_0B48(al_287, fp - 0x02, di_1047, ds, out dx_296, out bx_297, out di_1047, out es_299);
...
l0800_0C24:
		...
		if (v15_220 <= 0x00)
		{
			...
			fn0800_0B50(fp - 0x02, di_1047, out dx_223, out bx_224, out di_1047, out es_226);
		}
	}
l0800_1021:
	if (bLoc57_124 < 0x50)
	{
		...
		fn0800_0B50(fp - 0x02, di_1047, out dx_203, out bx_204, out di_205, out es_206);
	}
}
...
// 0800:0B48: Register Eq_3 fn0800_0B48(Register byte al, Register (memptr (ptr16 Eq_1042) Eq_225) bp, Register (memptr Eq_3 byte) di, Register Eq_3 ds, Register out Eq_308 dxOut, Register out Eq_309 bxOut, Register out Eq_310 diOut, Register out (ptr16 Eq_311) esOut)
Eq_3 fn0800_0B48(byte al, Eq_225 Eq_1042::*bp, byte Eq_3::*di, Eq_3 ds, Eq_308 & dxOut, Eq_309 & bxOut, Eq_310 & diOut, Eq_311 * & esOut)
{
	*dxOut = dx;
	*bxOut = bx;
	*esOut = es;
...
// 0800:0B50: Register word16 fn0800_0B50(Register (memptr (ptr16 Eq_1042) Eq_225) bp, Register (memptr Eq_3 byte) di, Register out ptr16 dxOut, Register out Eq_228 bxOut, Register out Eq_229 diOut, Register out (ptr16 Eq_230) esOut)
word16 fn0800_0B50(Eq_225 Eq_1042::*bp, byte Eq_3::*di, ptr16 & dxOut, Eq_228 & bxOut, Eq_229 & diOut, Eq_230 * & esOut)
{
