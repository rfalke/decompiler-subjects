...

{
  ...
  *(undefined **)(int *)&DAT_1105_00ac = puVar18;
  ...
  *(int **)&DAT_1105_008e = piVar19;
  ...
  if ((uVar10 < 0xfb8c) && (puVar2 = (uint *)&DAT_1105_0206, !CARRY2(uVar10 + 0x474,*puVar2))) {
    ...
    if (puVar21 <= puVar18) {
      ...
      *(undefined **)(int *)&DAT_1105_00a4 = puVar18;
      *(undefined **)(int *)&DAT_1105_00a8 = puVar18;
...

{
  if ((int)param_1 < 0) {
    ...
    if (param_1 < 0x59) goto LAB_1000_0269;
  }
  param_1 = 0x57;
LAB_1000_0269:
...

{
  ...
  if (puVar8 <= register0x00000010) {
    ...
    *pcVar14 = '\0';
    bVar17 = uVar9 == 0;
LAB_1000_0334:
    *(char ***)((int)&ppcStack4 + iVar3) = 0x337;
    bVar6 = FUN_1000_0350();
    iVar10 = extraout_DX;
    if (bVar16 || bVar17) {
      do {
        ...
        if (bVar16) {
          ...
          *(char ***)(int **)&DAT_1105_0086 = ppcVar12;
          goto LAB_1000_0398;
        }
        *(char ***)((int)&ppcStack4 + iVar3) = 0x33e;
        bVar6 = FUN_1000_0350();
...
uint __cdecl16near FUN_1000_03fc(undefined2 param_1)
...

{
  ...
  if ((param_1 == 0) || (0xfff4 < param_1)) {
    ...
    if (DAT_1105_0472 == 0) {
      uVar2 = FUN_1000_04c7(uVar3);
    }
    else {
      puVar4 = DAT_1105_0470;
      if (DAT_1105_0470 != (uint *)0x0) {
        do {
          if (uVar3 + 0x28 <= *puVar4) {
            uVar2 = FUN_1000_0450(puVar4,uVar3);
            return (uint *)uVar2;
          }
          if (uVar3 <= *puVar4) {
            FUN_1000_0422(puVar4);
            puVar1 = puVar4;
            *puVar1 = *puVar1 + 1;
            return puVar4 + 2;
          }
          puVar4 = (uint *)puVar4[3];
        } while (puVar4 != DAT_1105_0470);
      }
      uVar2 = FUN_1000_048a(uVar3);
    }
  }
  return (uint *)uVar2;
}
...
char * __cdecl16near FUN_1000_05ec(int param_1,char *param_2,char *param_3)
  ...
  if (param_3 + 1 < (char *)0x2) {
    ...
    if ((*(uint *)(param_1 * 2 + 0x34c) & 0x8000) == 0) {
      ...
      *puVar1 = *puVar1 & 0xfdff;
      ...
      while (local_8a != (char *)0x0) {
        ...
        *pcVar4 = cVar2;
        ...
        if (0x7f < (int)(pcVar4 + -(int)local_84)) {
          ...
          pcVar3 = (char *)FUN_1000_06ff(param_1,local_84,pcVar4);
          if (pcVar3 != pcVar4) {
      ...
      pcVar4 = pcVar4 + -(int)local_84;
      if ((pcVar4 != (char *)0x0) &&
         (pcVar3 = (char *)FUN_1000_06ff(param_1,local_84,pcVar4), pcVar3 != pcVar4)) {
        param_3 = pcVar3 + (int)(param_3 + -(int)pcVar4);
      }
    }
    else {
      param_3 = (char *)FUN_1000_06ff(param_1,param_2,param_3);
    }
  }
  return param_3;
}
...

{
  ...
  FUN_1000_0770(param_1 & 0xff00 | 0x61,CONCAT11((char)(param_1 >> 8),1),param_3,param_2,param_1,
                iVar1);
  return;
}
...

{
  ...
  FUN_1000_0770(CONCAT11((char)(in_AX >> 8),0x61),in_AX & 0xff00,param_4,param_3,param_1,param_2);
  return;
}
...
{
  FUN_1000_0770(0x61,(uint)(param_4 == 10),param_4,param_3,param_1,param_2);
  return;
}
...
uint __cdecl16near FUN_1000_092c(undefined param_1,int *param_2)

{
    ...
    *piVar1 = *piVar1 + 1;
    if (SCARRY2(iVar4,1) != *piVar1 < 0) {
      ...
      *(byte *)(piVar3[5] + -1) = local_3;
      if (((piVar3[1] & 8U) != 0) &&
         (((local_3 == 10 || (local_3 == 0xd)) && (iVar4 = FUN_1000_087c(piVar3), iVar4 != 0)))) {
        return 0xffff;
      }
      return (uint)local_3;
    }
  ...
  if (((((local_3 == 10) && ((piVar3[1] & 0x40U) == 0)) &&
       (iVar4 = FUN_1000_06ff((int)*(char *)(piVar3 + 2),0x3a6,1), iVar4 != 1)) ||
      (iVar4 = FUN_1000_06ff((int)*(char *)(piVar3 + 2),&param_1,1), iVar4 != 1)) &&
     ((piVar3[1] & 0x200U) == 0)) {
    puVar2 = (uint *)(piVar3 + 1);
    *puVar2 = *puVar2 | 0x10;
    return 0xffff;
...

{
  ...
  if ((param_1[1] & 8U) == 0) {
    if ((((param_1[1] & 0x40U) == 0) || (param_1[3] == 0)) || (param_2 <= (uint)param_1[3])) {
      ...
      if ((*param_1 == 0) || (iVar3 = FUN_1000_087c(param_1), iVar3 == 0)) {
...
int FUN_1000_0b22(undefined4 *param_1,byte *param_2)
  ...
  if (bVar13 != 0) {
    ...
    if (bVar13 == 0x25) {
      ...
      if (bVar13 != 0x25) {
        ...
        do {
          bVar12 = false;
          if (0x5f < (byte)(bVar13 - 0x20)) goto LAB_1000_1019;
          ...
          switch(cVar4) {
          case '\0':
            if (bVar19 != 0) goto LAB_1000_1019;
            if (local_8f != 0x2b) {
              local_8f = bVar13;
            }
            break;
          ...
          case '\x02':
            ...
            if (bVar19 < 2) {
              ...
              if (bVar19 != 4) goto LAB_1000_1019;
              puVar17 = (uint *)0x500;
            }
            break;
          case '\x03':
            ...
            break;
          case '\x04':
            if (3 < bVar19) goto LAB_1000_1019;
            puVar17 = (uint *)0x400;
            break;
          case '\x05':
switchD_1000_0bef_caseD_5:
          ...
          case '\b':
            ...
            break;
          case '\t':
            if (bVar19 != 0) goto switchD_1000_0bef_caseD_5;
            if (!bVar6) {
              local_9a = local_9a | 8;
              bVar8 = true;
              puVar17 = (uint *)0x100;
...
LAB_1000_0d2e:
          ...
          case '\x0f':
            puVar17 = local_92;
            if ((int)local_92 < 0) {
              puVar17 = (uint *)(s_Turbo_C___Copyright__c__1988_Bor_1105_0004 + 2);
            }
            if (bVar10) {
              uVar29 = 2;
              local_6 = 4;
            ...
            thunk_FUN_1000_085b(uVar29,local_9a & 1,(uint)bVar13,local_89,puVar17,param_1);
            puVar26 = local_89;
...
LAB_1000_0d51:
  ...
  FUN_1000_0770(uVar29,(uint)local_95,(int)(char)((uint)uVar29 >> 8),puVar26,pcVar15,pcVar20);
  if ((int)local_92 < 1) {
LAB_1000_0ed6:
    if ((!bVar8) || ((int)local_94 < 1)) goto LAB_1000_0ef8;
  }
  FUN_1000_0b3b();
