...
void main(word64 x29, word64 qwArg00)
{
	...
	if (dwLoc10_5 != dwLoc14)
	{
		max(dwLoc10_5, dwLoc14);
		fn00000000004004E0();
	}
}
...
// 0000000000400700: void __libc_csu_init(Register word64 x30, Stack word64 qwArg00)
...
// 000000000040077C: void _fini(Stack word64 qwArg00)
