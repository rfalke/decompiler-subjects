...
void main()
{
	...
	scanf("%d %d", fp + ~0x17, fp + ~0x1B);
	if (dwLoc18 != dwLoc1C)
		printf("Maximum: %d\n", max(dwLoc18, dwLoc1C));
}

// 00000000004006C4: Register int32 max(Register int32 w0, Register int32 w1)
// Called from:
//      main
...
// 0000000000400700: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
