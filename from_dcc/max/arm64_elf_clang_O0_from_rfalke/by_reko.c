...
{
	x0_14 = (uint64) printf("Enter 2 numbers: ");
	int32 dwLoc10_63 = (word32) x29;
	x0_23 = (uint64) scanf("%d %d", fp - 0x10, fp - 0x14);
	if (dwLoc10_63 != dwLoc14)
		x0_46 = (uint64) printf("Maximum: %d\n", max(dwLoc10_63, dwLoc14));
}
