...
// 000000000040069C: void max(Register word32 w0, Register word32 w1)
void max(word32 w0, word32 w1)
{
}

// 00000000004006A8: void __libc_csu_init(Register word64 x30, Stack word64 qwArg00)
...
// 0000000000400724: void _fini(Stack word64 qwArg00)
