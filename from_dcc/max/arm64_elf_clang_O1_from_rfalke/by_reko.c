...
// 0000000000400640: void main(Register word64 x29, Stack word64 qwArg00)
void main(word64 x29, word64 qwArg00)
{
	fn00000000004004E0();
	fn00000000004004A0();
	word32 dwLoc0C_5 = SLICE(x29, word32, 32);
	word32 dwLoc10_6 = (word32) x29;
	if (dwLoc0C_5 != dwLoc10_6)
	{
		max(dwLoc0C_5, dwLoc10_6);
		fn00000000004004E0();
	}
}

// 00000000004006A0: void max(Register word32 w0, Register word32 w1)
