...
// 0000000000000D80: Register int32 fib(Register int32 w0, Register out Eq_218 w19Out, Register out Eq_218 w20Out)
// Called from:
//      fib
int32 fib(int32 w0, union Eq_218 & w19Out, union Eq_218 & w20Out)
{
	if (w0 <= 0x02)
	{
		w19Out.u0 = <invalid>;
...
// 0000000000000DD0: Register word32 stest(Register (ptr64 byte) x0, Register (arr byte) x1, Register out Eq_27 w7Out)
// Called from:
//      main
...
void mcopy()
{
	...
	union Eq_372 * x0_40 = fopen("zyxw.vut", "w");
	...
	else
	{
		...
		for (w21_54 = 999; w21_54 != 0x00; --w21_54)
		{
			...
			Eq_407 x0_109 = SEQ(x0_32_32_106, w22_53);
			if (w22_53 != 0x00)
			{
				do
				{
					x0_105 = SEQ(x0_32_32_104, w0_68);
					x0_32_32_104 = SLICE((uint64) _IO_putc(x0_109, x0_40), word32, 32);
