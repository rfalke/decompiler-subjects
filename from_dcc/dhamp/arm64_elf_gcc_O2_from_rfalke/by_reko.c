...
// 0000000000000D80: Register int32 fib(Register int32 w0, Register out Eq_200 w19Out, Register out Eq_200 w20Out)
// Called from:
//      fib
...
void mcopy()
{
	struct Eq_337 * x0_11 = null;
	do
	{
		word32 w2_32 = (word32) x0_11[0x00001050];
		x0_11[(word64) fp - 96] = (struct Eq_337) (byte) w2_32;
		++x0_11;
	} while (w2_32 != 0x00);
	fn0000000000000810();
	if (4200 == 0x00)
