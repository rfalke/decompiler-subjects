...

{
  ...
  do {
    ...
    case 1:
      ...
      printf("\niresult = %d\n",(ulonglong)(uint)results.iresult);
      break;
    case 2:
      results.uresult = fib(0x18);
      printf("\nuresult = %u\n",(ulonglong)results.uresult);
      break;
    case 3:
...

{
  ...
  temp2 = num / 2.00000000;
  temp1 = num;
  while (temp2 * 0.00000100 < temp1) {
    temp1 = abs(num / temp2 - temp2);
    temp2 = (num / temp2 + temp2) / 2.00000000;
  }
  return temp2;
}
...

{
  ...
  while( true ) {
    if (*local_8 != *local_10) {
      return (int)((uint)*local_8 - (uint)*local_10);
    }
    if (*local_8 == 0) break;
    local_8 = local_8 + 1;
    local_10 = local_10 + 1;
...

{
  ...
  while (i = i + 1, i < 1000) {
    j = 0;
    while (buf[j] != '\0') {
      _IO_putc((uint)(byte)buf[j],(_IO_FILE *)__stream);
      j = j + 1;
    }
  }
  fclose(__stream);
