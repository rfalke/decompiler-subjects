...

{
  ...
  iVar2 = (*(code *)(&UNK_0010091c + (long)(char)(&DAT_00101224)[uVar1] * 4))();
  return iVar2;
}
...

{
  ...
  if (__fp != (FILE *)0x0) {
    uVar5 = 999;
    uVar3 = (uint)(byte)buf[0];
    while (__c = (uint)(byte)buf[0], pbVar2 = (byte *)buf, uVar3 != 0) {
      do {
        _IO_putc(__c,__fp);
        __c = (uint)pbVar2[1];
        pbVar2 = pbVar2 + 1;
