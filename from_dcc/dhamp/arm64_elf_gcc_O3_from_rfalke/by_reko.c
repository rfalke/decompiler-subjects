...
// 0000000000000D70: Register int32 fib(Register int32 w0, Register out Eq_199 w19Out, Register out Eq_199 w20Out, Register out Eq_199 w21Out, Register out Eq_199 w22Out, Register out Eq_199 w23Out, Register out Eq_199 w24Out, Register out Eq_199 w25Out, Register out Eq_199 w26Out, Register out Eq_199 w27Out, Register out Eq_199 w28Out, Register out Eq_199 x29Out)
// Called from:
//      fib
int32 fib(int32 w0, union Eq_199 & w19Out, union Eq_199 & w20Out, union Eq_199 & w21Out, union Eq_199 & w22Out, union Eq_199 & w23Out, union Eq_199 & w24Out, union Eq_199 & w25Out, union Eq_199 & w26Out, union Eq_199 & w27Out, union Eq_199 & w28Out, union Eq_199 & x29Out)
{
	...
	{
		struct Eq_232 * x29_103 = fp + -0x0098;
		...
		do
		{
			...
			if (w25_277 != 0x02)
			{
				...
				do
				{
					...
					if (w1_266 != 0x03)
					{
						x29_103[56] = (struct Eq_232) (w1_266 & 0x01);
						ui32 w0_63 = w1_266 - 0x02;
						struct Eq_262 * v26_66 = x29_103 + 64;
						v26_66->dw0000 = w0_63;
						v26_66->dw0004 = w0_63;
						x29_103[78] = (struct Eq_232) 0x00;
						do
						{
							word32 w0_248;
							...
							if (w0_244 != 0x02)
							{
								x29_103[72] = (struct Eq_232) 0x00;
								do
								{
									word32 w0_237;
									if (w0_244 != 0x03)
									{
										struct Eq_287 * v28_87 = x29_103 + 58;
										v28_87->dw0000 = w0_244 & 0x01;
										ui32 w1_84 = w0_244 - 0x02;
										v28_87->dw0004 = w1_84;
										x29_103[70] = (struct Eq_232) 0x00;
										...
										do
										{
											...
											if (w27_221 != 0x02)
											{
												x29_103[0x0044] = (struct Eq_232) 0x00;
												...
												do
												{
													...
													if (w24_210 != 0x03)
													{
														...
														x29_103[62] = (struct Eq_232) w0_105;
												...
												w0_216 = 0x01;
											x29_103[70] = (struct Eq_232) ((word16) x29_103[70] + w0_216);
									...
									{
										x29_103[60] = (struct Eq_232) 0x01;
										w0_237 = 0x01;
									}
									x29_103[72] = (struct Eq_232) ((word16) x29_103[72] + w0_237);
							...
							x29_103[78] = (struct Eq_232) ((word16) x29_103[78] + w0_248);
							word32 w0_257 = x29_103[56];
							x29_103[66] = (struct Eq_232) (w1_252 - 0x02);
						} while (w0_257 != w1_252 - 0x02);
						w0_262 = (word32) ((word16) x29_103[78] + 1);
					}
					else
					{
						x29_103[64] = (struct Eq_232) 0x01;
						w0_262 = 0x01;
					}
					w1_266 = (int32) x29_103[64];
					word32 w0_268 = (word16) x29_103[74] + w0_262;
					x29_103[74] = (struct Eq_232) w0_268;
				...
				w0_272 = 0x01;
			x29_103[76] = (struct Eq_232) ((word16) x29_103[76] + w0_272);
...
// 0000000000000FE0: Register word32 stest(Register (ptr64 byte) x0, Register (arr byte) x1, Register out Eq_38 w7Out)
// Called from:
//      main
