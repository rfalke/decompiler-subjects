...

{
  ...
  local_28 = num / 2.00000000;
  local_20 = num;
  while (local_28 * 0.00000100 < local_20) {
    local_20 = abs(num / local_28 - local_28);
    local_28 = (num / local_28 + local_28) / 2.00000000;
  }
  return local_28;
}
...

{
  ...
  while( true ) {
    if (*local_10 != *local_18) {
      return (int)((uint)*local_10 - (uint)*local_18);
    }
    if (*local_10 == 0) break;
    local_10 = local_10 + 1;
    local_18 = local_18 + 1;
...

{
  ...
  if (local_18 != (FILE *)0x0) {
    ...
    while (local_80 = local_80 + 1, local_80 < 1000) {
      local_84 = 0;
      while (abStack124[local_84] != 0) {
        _IO_putc((uint)abStack124[local_84],(_IO_FILE *)local_18);
        local_84 = local_84 + 1;
      }
    }
    fclose(local_18);
