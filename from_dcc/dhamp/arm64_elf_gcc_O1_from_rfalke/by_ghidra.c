...
typedef struct anon_struct.conflict31a anon_struct.conflict31a, *Panon_struct.conflict31a;

struct anon_struct.conflict31a {
    int cresult;
    int iresult;
    int cprsult;
    uint uresult;
...
// WARNING: Removing unreachable block (ram,0x001008e0)
// WARNING: Removing unreachable block (ram,0x001008ec)
...
// WARNING: Removing unreachable block (ram,0x0010091c)
...

{
  ...
  do {
    lVar1 = lVar1 + -2;
  } while (lVar1 != sq::j + -0x4652);
  lVar1 = 4 - sq::j;
  sq::j = sq::j + -18000;
  return lVar1 * 8999 + 0x4d38cca + (big - lVar2);
}
...

{
  ...
  if (__fp != (FILE *)0x0) {
    do {
      while (bVar1 != 0) {
        pbVar2 = pbVar2 + 1;
        _IO_putc((uint)bVar1,(_IO_FILE *)__fp);
        bVar1 = *pbVar2;
      }
      iVar3 = iVar3 + -1;
      pbVar2 = (byte *)buf;
