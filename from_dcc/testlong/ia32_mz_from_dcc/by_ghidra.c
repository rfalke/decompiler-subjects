  ...
  *(int **)&DAT_11d3_008e = piVar19;
  ...
  if ((uVar10 < 0xfa02) && (puVar2 = (uint *)&DAT_11d3_020a, !CARRY2(uVar10 + 0x5fe,*puVar2))) {
    ...
    if (puVar21 <= puVar18) {
      ...
      *(int *)&DAT_11d3_00a4 = (int)puVar18;
      *(int *)&DAT_11d3_00a8 = (int)puVar18;
...

{
  ...
  if (puVar9 <= register0x00000010) {
    *(char ***)((int)(appcStack4 + 1) + iVar3) = (char **)uVar10;
    while (uVar10 - 1 != 0) {
      pcVar2 = pcVar14;
      pcVar14 = pcVar14 + 1;
      pcVar1 = pcVar13;
    ...
    *pcVar14 = '\0';
    uVar17 = uVar10 == 0;
LAB_1000_0324:
    *(char ***)((int)appcStack4 + iVar3) = (char **)0x327;
    bVar6 = FUN_1000_0340();
    iVar11 = extraout_DX;
    if (bVar16 || (bool)uVar17) {
      do {
        uVar4 = DAT_1000_02b3;
        if (bVar16) {
          iVar11 = (int)*(char ***)((int)(appcStack4 + 1) + iVar3) + iVar11;
        ...
        *(char ***)((int)appcStack4 + iVar3) = (char **)0x32e;
        bVar6 = FUN_1000_0340();
...

{
  ...
  if ((param_3 + 1U < 2) || ((*(uint *)(param_1 * 2 + 0x452) & 0x200) != 0)) {
    ...
    do {
      pcVar5 = (char *)FUN_1000_0a34(param_1,param_2,param_3);
      if (pcVar5 + 1 < (char *)&DAT_11d3_0002) {
        return pcVar5;
      }
      pcVar7 = param_2;
      pcVar3 = param_2;
      ...
      do {
        while( true ) {
          ...
          pcVar6 = param_2;
          if (cVar2 == '\x1a') {
            FUN_1000_0ba9(param_1,-(int)pcVar5,-(uint)(pcVar5 != (char *)0x0),2);
          ...
          *pcVar4 = cVar2;
          ...
          pcVar7 = pcVar7 + 1;
          pcVar3 = pcVar4 + 1;
          if (pcVar5 == (char *)0x0) goto LAB_1000_0a00;
        }
        pcVar5 = pcVar5 + -1;
        pcVar7 = pcVar7 + 1;
        pcVar3 = pcVar4;
  ...
  if (cVar13 != '\0') {
    ...
    if (cVar13 == '%') {
      ...
      if (cVar13 != '%') {
        ...
        do {
          bVar12 = false;
          if (0x5f < (byte)(cVar13 - 0x20U)) goto LAB_1000_14eb;
          cVar4 = *(char *)((byte)(cVar13 - 0x20U) + 0x4c9);
          cVar21 = cVar4 * '\x02';
...
LAB_1000_1200:
          ...
          case '\x0f':
            ...
            thunk_FUN_1000_0cbf(uVar27,local_9a,cVar13,local_89,puVar17,param_1);
            puVar24 = local_89;
...
LAB_1000_1223:
  ...
  FUN_1000_0bd4(uVar27,local_95,(char)((uint)uVar27 >> 8),puVar24,pcVar15,pcVar20);
  if ((int)local_92 < 1) {
LAB_1000_13a8:
