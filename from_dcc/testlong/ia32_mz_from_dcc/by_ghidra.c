...

{
  ...
  uVar24 = 0x233;
  puVar12 = (undefined *)&DAT_11d3_0080;
                    // WARNING: Read-only address (ram,0x000101f8) is written
  uRam000101f8 = 0x11d3;
  pcVar6 = (code *)swi(0x21);
  uVar25 = (*pcVar6)();
  uVar23 = s_Turbo_C___Copyright__c__1988_Bor_11d3_0004._40_2_;
  puVar18 = DAT_11d3_0002;
  iVar8 = (int)((ulong)uVar25 >> 0x10);
  *(undefined2 *)&DAT_11d3_0092 = (int)uVar25;
  *(undefined2 *)&DAT_11d3_0090 = unaff_ES;
  *(undefined2 *)&DAT_11d3_008c = uVar23;
  *(undefined **)(int *)&DAT_11d3_00ac = puVar18;
  *(undefined2 *)&DAT_11d3_0096 = 0xffff;
  *(undefined2 *)(puVar12 + -2) = 0x2e;
  FUN_1000_0162();
  uVar25 = *(undefined4 *)&DAT_11d3_008a;
  ...
  *(int *)&DAT_11d3_008a = -(uVar10 | 0x8000);
  piVar19 = (int *)((int)piVar19 * 2 + 8U & 0xfff8);
  *(int **)&DAT_11d3_008e = piVar19;
  puVar18 = puVar18 + -iVar8;
  uVar10 = *(uint *)&DAT_11d3_020c;
  if (uVar10 < 0x200) {
    uVar10 = 0x200;
    *(undefined2 *)&DAT_11d3_020c = 0x200;
  }
  if ((uVar10 < 0xfa02) && (puVar2 = (uint *)&DAT_11d3_020a, !CARRY2(uVar10 + 0x5fe,*puVar2))) {
    bVar9 = 4;
    puVar21 = (undefined *)((uVar10 + 0x5fe + *puVar2 >> 4) + 1);
    if (puVar21 <= puVar18) {
      ...
      *(undefined **)(int *)&DAT_11d3_00a4 = puVar18;
      *(undefined **)(int *)&DAT_11d3_00a8 = puVar18;
      piVar19 = (int *)(puVar18 + -*(int *)&DAT_11d3_0090);
      piVar13 = (int *)(puVar12 + -2);
      *(undefined **)(puVar12 + -2) = puVar21;
      pcVar6 = (code *)swi(0x21);
      (*pcVar6)();
      iVar22 = *piVar13 << (bVar9 & 0x1f);
      puVar18 = (undefined *)&DAT_11d3_05b8;
      iVar11 = 0x46;
      while (iVar11 != 0) {
        iVar11 = iVar11 + -1;
        puVar5 = puVar18;
      ...
      *(int *)&DAT_11d3_009a = iVar11;
      puVar16 = puVar15 + -2;
      *(undefined2 *)(puVar15 + -2) = 0x10e;
      (**(code **)&DAT_11d3_05ae)();
      *(undefined2 *)(puVar16 + -2) = *(undefined2 *)&DAT_11d3_0088;
      *(undefined2 *)(puVar16 + -4) = *(undefined2 *)&DAT_11d3_0086;
      *(undefined2 *)(puVar16 + -6) = *(undefined2 *)&DAT_11d3_0084;
...
LAB_1000_01e9:
  ...
  *(undefined **)(puVar17 + -0xc) = puVar17 + -6;
  *(undefined2 *)(puVar17 + -0xe) = 0x194;
  *(undefined2 *)(puVar17 + -0x10) = 0x20b;
  FUN_1000_1655();
  *(undefined **)(puVar17 + -0xc) = puVar17 + -10;
  *(undefined2 *)(puVar17 + -0xe) = 0x197;
  *(undefined2 *)(puVar17 + -0x10) = 0x218;
  FUN_1000_1655();
  *(undefined **)(puVar17 + -0xc) = puVar17 + -6;
  *(undefined **)(puVar17 + -0xe) = puVar17 + -10;
  *(undefined2 *)(puVar17 + -0x10) = 0x19a;
  *(undefined2 *)(puVar17 + -0x12) = 0x229;
  FUN_1000_1655();
  *(undefined2 *)(puVar17 + -0xc) = *(undefined2 *)(puVar17 + -4);
  *(undefined2 *)(puVar17 + -0xe) = *(undefined2 *)(puVar17 + -6);
  *(undefined2 *)(puVar17 + -0x10) = *(undefined2 *)(puVar17 + -8);
  *(undefined2 *)(puVar17 + -0x12) = *(undefined2 *)(puVar17 + -10);
  *(undefined2 *)(puVar17 + -0x14) = 0x1a0;
  *(undefined2 *)(puVar17 + -0x16) = 0x23f;
  FUN_1000_0dcc();
  return;
}
...

{
  ...
  if (puVar8 <= register0x00000010) {
    ...
    *pcVar14 = '\0';
    bVar17 = uVar9 == 0;
LAB_1000_0324:
    *(char ***)((int)&ppcStack4 + iVar3) = 0x327;
    bVar6 = FUN_1000_0340();
    iVar10 = extraout_DX;
    if (bVar16 || bVar17) {
      do {
        ...
        if (bVar16) {
          ...
          *(char ***)(int **)&DAT_11d3_0086 = ppcVar12;
          goto LAB_1000_0388;
        }
        *(char ***)((int)&ppcStack4 + iVar3) = 0x32e;
        bVar6 = FUN_1000_0340();
...
LAB_1000_01e2:
  ...
  *pcVar1 = *pcVar1 + cVar5;
  ...
  FUN_1000_0dcc(0x1a0,uStack10,uStack8,uStack6,ppcStack4);
  return;
code_r0x00010338:
  bVar16 = bVar6 < 9;
  bVar17 = bVar6 == 9;
...
uint __cdecl16near FUN_1000_03ec(undefined2 param_1)
...

{
  ...
  if ((param_1 == 0) || (0xfff4 < param_1)) {
    ...
    if (DAT_11d3_05fc == 0) {
      uVar2 = FUN_1000_04b7(uVar3);
    }
    else {
      puVar4 = DAT_11d3_05fa;
      if (DAT_11d3_05fa != (uint *)0x0) {
        do {
          if (uVar3 + 0x28 <= *puVar4) {
            uVar2 = FUN_1000_0440(puVar4,uVar3);
            return (uint *)uVar2;
          }
          if (uVar3 <= *puVar4) {
            FUN_1000_0412(puVar4);
            puVar1 = puVar4;
            *puVar1 = *puVar1 + 1;
            return puVar4 + 2;
          }
          puVar4 = (uint *)puVar4[3];
        } while (puVar4 != DAT_11d3_05fa);
      }
      uVar2 = FUN_1000_047a(uVar3);
    }
  }
  return (uint *)uVar2;
}
...
long __cdecl16near FUN_1000_0687(int *param_1)

{
  ...
  if (iVar1 == 0) {
    lVar2 = FUN_1000_1ccf((int)*(char *)(param_1 + 2));
    if (0 < *param_1) {
      iVar1 = FUN_1000_05dc(param_1);
      lVar2 = lVar2 - iVar1;
    }
  }
  else {
  ...
  while( true ) {
    ...
    *piVar1 = *piVar1 + 1;
    ...
    while (puVar2 = (uint *)(param_1 + 1), *puVar2 = *puVar2 | 0x80, param_1[3] == 0) {
      ...
      FUN_1000_0885(0x312,0,(uint)((DAT_11d3_0314 & 0x200) != 0),0x200);
    }
...
char * __cdecl16near FUN_1000_0978(int param_1,char *param_2,int param_3)

{
  ...
  if ((param_3 + 1U < 2) || ((*(uint *)(param_1 * 2 + 0x452) & 0x200) != 0)) {
    ...
    do {
      iVar5 = FUN_1000_0a34(param_1,param_2,param_3);
      if (iVar5 + 1U < (uint)&DAT_11d3_0002) {
        return (char *)iVar5;
      }
      pcVar7 = param_2;
      pcVar3 = param_2;
      ...
      do {
        while( true ) {
          ...
          pcVar6 = param_2;
          if (cVar2 == '\x1a') {
            FUN_1000_0ba9(param_1,-iVar5,-(uint)(iVar5 != 0),2);
...
char * __cdecl16near FUN_1000_0a50(int param_1,char *param_2,char *param_3)
  ...
  if (param_3 + 1 < (char *)0x2) {
    ...
    if ((*(uint *)(param_1 * 2 + 0x452) & 0x8000) == 0) {
      ...
      *puVar1 = *puVar1 & 0xfdff;
      ...
      while (local_8a != (char *)0x0) {
        ...
        *pcVar4 = cVar2;
        ...
        if (0x7f < (int)(pcVar4 + -(int)local_84)) {
          ...
          pcVar3 = (char *)FUN_1000_0b63(param_1,local_84,pcVar4);
          if (pcVar3 != pcVar4) {
      ...
      pcVar4 = pcVar4 + -(int)local_84;
      if ((pcVar4 != (char *)0x0) &&
         (pcVar3 = (char *)FUN_1000_0b63(param_1,local_84,pcVar4), pcVar3 != pcVar4)) {
        param_3 = pcVar3 + (int)(param_3 + -(int)pcVar4);
      }
    }
    else {
      param_3 = (char *)FUN_1000_0b63(param_1,param_2,param_3);
    }
  }
  return param_3;
}
...

{
  ...
  FUN_1000_0bd4(param_1 & 0xff00 | 0x61,CONCAT11((char)(param_1 >> 8),1),param_3,param_2,param_1,
                iVar1);
  return;
}
...

{
  ...
  FUN_1000_0bd4(CONCAT11((char)(in_AX >> 8),0x61),in_AX & 0xff00,param_4,param_3,param_1,param_2);
  return;
}
...
{
  FUN_1000_0bd4(0x61,(uint)(param_4 == 10),param_4,param_3,param_1,param_2);
  return;
}



void FUN_1000_0cbf(undefined2 param_1,undefined2 param_2,undefined2 param_3)
...
void FUN_1000_0cc4(undefined2 param_1,undefined2 param_2,undefined2 param_3)
...
uint __cdecl16near FUN_1000_0dfe(undefined param_1,int *param_2)

{
    ...
    *piVar1 = *piVar1 + 1;
    if (SCARRY2(iVar4,1) != *piVar1 < 0) {
      ...
      *(byte *)(piVar3[5] + -1) = local_3;
      if (((piVar3[1] & 8U) != 0) &&
         (((local_3 == 10 || (local_3 == 0xd)) && (iVar4 = FUN_1000_0d4e(piVar3), iVar4 != 0)))) {
        return 0xffff;
      }
      return (uint)local_3;
    }
  ...
  if (((((local_3 == 10) && ((piVar3[1] & 0x40U) == 0)) &&
       (iVar4 = FUN_1000_0b63((int)*(char *)(piVar3 + 2),0x4b0,1), iVar4 != 1)) ||
      (iVar4 = FUN_1000_0b63((int)*(char *)(piVar3 + 2),&param_1,1), iVar4 != 1)) &&
     ((piVar3[1] & 0x200U) == 0)) {
    puVar2 = (uint *)(piVar3 + 1);
    *puVar2 = *puVar2 | 0x10;
    return 0xffff;
...

{
  ...
  *unaff_DI = *(undefined *)(ulong)((uint)(bVar1 >> 4) + 0x4b9);
  unaff_DI[1] = *(undefined *)(ulong)((uint)(bVar1 & 0xf) + 0x4b9);
  unaff_DI[2] = *(undefined *)(ulong)((uint)(byte)((byte)param_1 >> 4) + 0x4b9);
  unaff_DI[3] = *(undefined *)(ulong)((uint)((byte)param_1 & 0xf) + 0x4b9);
  return;
}



int FUN_1000_0ff4(undefined4 *param_1,byte *param_2)
  ...
  if (bVar13 != 0) {
    ...
    if (bVar13 == 0x25) {
      ...
      if (bVar13 != 0x25) {
        ...
        do {
          bVar12 = false;
          if (0x5f < (byte)(bVar13 - 0x20)) goto LAB_1000_14eb;
          cVar4 = *(char *)((uint)(byte)(bVar13 - 0x20) + 0x4c9);
          cVar21 = cVar4 * '\x02';
          ...
          switch(cVar4) {
          case '\0':
            if (bVar19 != 0) goto LAB_1000_14eb;
            if (local_8f != 0x2b) {
              local_8f = bVar13;
            }
            break;
          ...
          case '\x02':
            ...
            if (bVar19 < 2) {
              ...
              if (bVar19 != 4) goto LAB_1000_14eb;
              puVar17 = (uint *)0x500;
            }
            break;
          case '\x03':
            ...
            break;
          case '\x04':
            if (3 < bVar19) goto LAB_1000_14eb;
            puVar17 = (uint *)0x400;
            break;
          case '\x05':
switchD_1000_10c1_caseD_5:
          ...
          case '\b':
            ...
            break;
          case '\t':
            if (bVar19 != 0) goto switchD_1000_10c1_caseD_5;
            if (!bVar6) {
              local_9a = local_9a | 8;
              bVar8 = true;
              puVar17 = (uint *)0x100;
...
LAB_1000_1200:
          ...
          case '\x0f':
            puVar17 = local_92;
            if ((int)local_92 < 0) {
              puVar17 = (uint *)(s_Turbo_C___Copyright__c__1988_Bor_11d3_0004 + 2);
            }
            if (bVar10) {
              uVar29 = 2;
              local_6 = 4;
            ...
            thunk_FUN_1000_0cbf(uVar29,local_9a & 1,(uint)bVar13,local_89,puVar17,param_1);
            puVar26 = local_89;
...
LAB_1000_1223:
  ...
  FUN_1000_0bd4(uVar29,(uint)local_95,(int)(char)((uint)uVar29 >> 8),puVar26,pcVar15,pcVar20);
  if ((int)local_92 < 1) {
LAB_1000_13a8:
    if ((!bVar8) || ((int)local_94 < 1)) goto LAB_1000_13ca;
  }
  FUN_1000_100d();
...
LAB_1000_1715:
    ...
    case 10:
      ...
      if (bVar3) {
        ...
        thunk_FUN_1000_0cc4(puVar14,uVar8);
      }
      goto LAB_1000_16a7;
    case 0xb:
      bVar16 = true;
    ...
    FUN_1000_1b4d(param_1,param_2,param_3,uVar8,(uint)local_24 & 0x7fff,&local_28,&local_26);
    if (local_26 < 1) {
      if (-1 < local_26) {
        return local_2a;
      }
...
LAB_1000_1a37:
        ...
        local_28 = local_28 + -1;
        if ((int)local_24 <= (int)puVar11) goto LAB_1000_1a54;
        goto LAB_1000_1a4b;
      }
    }
    puVar11 = puVar14;
