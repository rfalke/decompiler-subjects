...
void main()
{
	...
	__isoc99_scanf("%d %d", fp + ~0x17, fp - 0x20);
	printf("%ld %ld", (int32) qwLoc18, (int32) qwLoc20);
}

// 00000000004006D0: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
...
// 0000000000400748: void __libc_csu_fini()
