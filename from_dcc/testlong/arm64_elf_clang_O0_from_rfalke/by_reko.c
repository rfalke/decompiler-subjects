...
{
	x0_14 = (uint64) __isoc99_scanf("%d", fp - 0x18);
	int32 w0_29 = __isoc99_scanf("%d", fp - 0x10);
	x0_33 = (uint64) __isoc99_scanf("%d %d", fp - 0x10, fp - 0x28);
	x0_42 = (uint64) printf("%ld %ld", (int32) x29, w0_29);
}
