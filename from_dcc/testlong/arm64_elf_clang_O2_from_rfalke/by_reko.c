...
void main()
{
	...
	word64 qwLoc30;
	word64 qwLoc28;
	__isoc99_scanf("%d", fp + ~0x2F);
	__isoc99_scanf("%d", fp + ~0x27);
	__isoc99_scanf("%d %d", fp + ~0x27, fp + ~0x2F);
	printf("%ld %ld", (int32) qwLoc28, (int32) qwLoc30);
}

// 00000000004006A8: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
...
// 0000000000400720: void __libc_csu_fini()
