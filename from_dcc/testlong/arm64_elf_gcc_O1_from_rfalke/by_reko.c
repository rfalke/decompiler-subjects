...
{
	x0_23 = (uint64) __isoc99_scanf("%d", fp + -1);
	x0_28 = (uint64) __isoc99_scanf("%d", fp);
	x0_34 = (uint64) __isoc99_scanf("%d %d", fp, fp + -1);
	x0_40 = (uint64) printf("%ld %ld", (int32) qwArg00, (int32) qwLoc08);
}
