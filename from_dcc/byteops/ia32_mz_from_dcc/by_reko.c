...
// 0800:0796: void __LONGTOA(Register Eq_6 ds, Stack Eq_6 bArg02, Stack Eq_22 bArg04, Stack Eq_6 wArg06, Stack (memptr Eq_6 byte) wArg08, Stack Eq_6 wArg0A, Stack Eq_6 wArg0C)
// Called from:
//      __VPRINTER
...
// 0800:0920: void _printf(Register Eq_6 cx, Register Eq_6 dx, Register Eq_6 bx, Register Eq_6 ds, Stack (memptr Eq_6 byte) wArg02)
// Called from:
//      _main
...
// 0800:0B1D: Register word16 fn0800_0B1D(Sequence (ptr32 Eq_136) es_di, Register Eq_6 ds, Stack Eq_6 wArg02)
// Called from:
//      __VPRINTER
word16 fn0800_0B1D(struct Eq_136 * es_di, Eq_6 ds, Eq_6 wArg02)
{
...
// 0800:0B48: void __VPRINTER(Register Eq_6 cx, Register Eq_6 dx, Register Eq_6 bx, Register Eq_6 ds, Stack Eq_6 wArg02, Stack (memptr Eq_6 byte) wArg04)
// Called from:
//      _printf
void __VPRINTER(Eq_6 cx, Eq_6 dx, Eq_6 bx, Eq_6 ds, Eq_6 wArg02, byte Eq_6::* wArg04)
{
	ci8 bLoc57_1215 = 0x50;
	struct Eq_184 Eq_6::* sp_1133 = fp - 0xA0;
	byte Eq_6::* wLoc98_1218 = fp - 0x56;
l0800_0BAB:
	byte Eq_6::* di_1006 = wLoc98_1218;
l0800_0BAF:
	byte Eq_6::* si_1114 = wArg04;
	while (true)
	{
		...
		if (al_37 == 0x25)
		{
			...
			if (al_1060 != 0x25)
			{
				wLoc98_1218 = di_1006;
				cu8 ch_1149 = 0x00;
				Eq_6 wLoc8E_1223 = 0x00;
				cui16 wLoc9A_1224 = 0x00;
				byte bLoc8F_1225 = 0x00;
				Eq_6 wLoc94_1226 = ~0x00;
				Eq_6 wLoc92_1227 = ~0x00;
				while (true)
				{
					Eq_6 ax_65 = (uint16) al_1060;
...
l0800_0CD5:
							dx = bx;
							Eq_6 ax_898 = (int16) ((byte) ax_65 - 0x30);
							if (ch_1149 <= 0x02)
							{
								ch_1149 = 0x02;
								wLoc94_1226 = ax_898;
							...
							if (wLoc92_1227 == 0x00)
							{
								...
								if (wLoc94_1226 != 0x00 && wLoc94_1226 != ~0x00)
								{
									...
									do
									{
										...
										sp_1133 = (struct Eq_184 Eq_6::*) ((char *) &sp_1133->t0000 + 0x0000FFFE);
										--cx;
									} while (cx != 0x00);
								}
								goto l0800_0BAF;
...
l0800_0DC6:
						...
						struct Eq_561 Eq_6::* sp_414 = sp_1133 - 2;
						...
						sp_1133 = (struct Eq_184 Eq_6::*) ((char *) &sp_414->t0000 + 2);
						dx = wLoc92_1227;
						if (wLoc92_1227 > 0x00)
						{
					...
					case 0x0E:
						struct Eq_382 Eq_6::* sp_266 = sp_1133 - 2;
						...
						if ((wLoc9A_1224 & 0x20) != 0x00)
						{
							...
							byte Eq_6::* di_289 = fn0800_0B1D(SEQ(es_283, fp - 0x8A), ds, (ss->*sp_266).tFFFFFFFE);
							es_283->*di_289 = 0x3A;
						...
						byte Eq_6::* di_312 = fn0800_0B1D(SEQ(es_304, di_263), ds, (ss->*sp_266).t0000);
						ds->*di_312 = 0x00;
						sp_1133 = (struct Eq_184 Eq_6::*) ((char *) &sp_266->t0000 + 2);
						wLoc9A_1224 &= ~0x04;
						...
						goto l0800_0EFC;
					case 0x0F:
						Eq_6 cx_207 = wLoc92_1227;
						if (wLoc92_1227 < 0x00)
							cx_207.u0 = 0x06;
						int16 wLoc06_1253;
						Eq_6 ax_239;
						struct Eq_824 Eq_6::* sp_213 = sp_1133 - 2;
...
l0800_0F0C:
								...
								Eq_6 cx_491 = fn0800_0B61(di_484, es_487);
								if (*es_di_1893 == 0x2D)
									--cx_491;
								dx -= cx_491;
								if (dx > 0x00)
						...
						if (bLoc8F_1225 != 0x00 && es_487->*di_484 != 0x2D)
						{
							...
							Eq_778 v40_527 = wLoc8E_1223 - 0x01;
						...
						goto l0800_0F3D;
					case 0x10:
						union Eq_6 Eq_6::* sp_191 = sp_1133 - 2;
						ss->*sp_191 = ss;
						wArg02 = (word16) wArg02 + 2;
						sp_1133 = (struct Eq_184 Eq_6::*) ((char *) sp_191 + 2);
						cx_172.u0 = 0x01;
					...
					case 0x11:
						...
						if ((wLoc9A_1224 & 0x20) == 0x00)
						{
							...
							union Eq_6 Eq_6::* sp_149 = sp_1133 - 2;
							ss->*sp_149 = ds;
							wArg02 = (word16) wArg02 + 2;
						...
						if (!v70_1208)
						{
							union Eq_6 Eq_6::* sp_160 = sp_1133 - 2;
							ss->*sp_160 = ds;
							es_di_1899 = SEQ(Mem163[ss:sp_160 + 0x00:selector], 0x03A8);
						}
...
l0800_0F3D:
						byte Eq_6::* di_545 = (word16) es_di_1889;
						wArg04 = si_1114;
						byte Eq_6::* si_1134 = di_545;
						Eq_6 bx_558 = wLoc94_1226;
...
l0800_0F8A:
								...
								if ((wLoc9A_1224 & 0x40) != 0x00)
								{
									...
									sp_1133 = (struct Eq_184 Eq_6::*) ((char *) &sp_1133->t0000 + 0x0000FFFC);
								}
								dx = wLoc8E_1223;
								if (wLoc8E_1223 > 0x00)
								{
									Eq_6 cx_700 = cx - wLoc8E_1223;
									bx_558 -= wLoc8E_1223;
					...
					case 0x12:
						...
						if ((wLoc9A_1224 & 0x20) == 0x00)
						{
							...
							union Eq_6 Eq_6::* sp_111 = sp_1133 - 2;
							ss->*sp_111 = ds;
							wArg02 = (word16) wArg02 + 2;
...
// 0800:0B61: Register word16 fn0800_0B61(Register (memptr (ptr16 Eq_284) byte) di, Register (ptr16 Eq_284) es)
// Called from:
//      __VPRINTER
word16 fn0800_0B61(byte Eq_284::* di, struct Eq_284 * es)
{
	word16 cx_12 = ~0x00;
	while (cx_12 != 0x00)
	{
...
// 0800:0B6E: Register (memptr Eq_6 byte) fn0800_0B6E(Sequence (ptr32 byte) ds_di, Sequence (ptr32 Eq_223) ss_bp, Register byte al, Register Eq_6 cx, Register Eq_6 dx, Register Eq_6 bx)
// Called from:
//      __VPRINTER
byte Eq_6::* fn0800_0B6E(byte * ds_di, struct Eq_223 * ss_bp, byte al, Eq_6 cx, Eq_6 dx, Eq_6 bx)
{
...
// 0800:0B76: Register (memptr Eq_6 byte) fn0800_0B76(Sequence (ptr32 Eq_223) ss_bp, Register Eq_6 cx, Register Eq_6 dx, Register Eq_6 bx, Register (memptr Eq_6 byte) di)
// Called from:
//      __VPRINTER
//      fn0800_0B6E
byte Eq_6::* fn0800_0B76(struct Eq_223 * ss_bp, Eq_6 cx, Eq_6 dx, Eq_6 bx, byte Eq_6::* di)
{
