							...
							if (wLoc92_1219 == 0x00)
							{
								...
								if (wLoc94_1218 != 0x00 && wLoc94_1218 != ~0x00)
								{
									...
									do
									{
										...
										di_1004 = fn0800_0B6E(SEQ(ds, di_1004), SEQ(ss, fp - 2), dl_814, cx, dx, bx_1878);
										--cx;
									} while (cx != 0x00);
								}
								goto l0800_0BAF;
...
l0800_0F0C:
					...
					case 0x11:
						...
						cx_172 = fn0800_0B61((word16) es_di_1891, SLICE(es_di_1891, selector, 16));
...
l0800_0F8A:
								...
								if ((wLoc9A_1216 & 0x02) == 0x00)
								{
									for (; bx_558 > cx; --bx_558)
										di_1004 = fn0800_0B6E(SEQ(ds, di_1004), SEQ(ss, fp - 2), 0x20, cx, dx, bx_558);
								}
								if ((wLoc9A_1216 & 0x40) != 0x00)
									di_1004 = fn0800_0B6E(SEQ(ds, fn0800_0B6E(SEQ(ds, di_1004), SEQ(ss, fp - 2), 0x30, cx, dx, bx_558)), SEQ(ss, fp - 2), dl_131, cx, dx, bx_558);
								dx = wLoc8E_1215;
								if (wLoc8E_1215 > 0x00)
								{
									...
									{
										si_1109 = di_545 + 1;
										di_1004 = fn0800_0B6E(SEQ(ds, di_1004), SEQ(ss, fp - 2), ds->*di_545, cx_683, wLoc8E_1215, bx_558);
										--cx_683;
										--bx_558;
									}
									...
									if (wLoc8E_1215 != 0x00)
									{
										do
										{
											di_1004 = fn0800_0B6E(SEQ(ds, di_1004), SEQ(ss, fp - 2), 0x30, cx_733, cx_683, bx_558);
											--cx_733;
										} while (cx_733 != 0x00);
									}
									dx = cx_733;
								...
								if (cx != 0x00)
								{
									...
									do
									{
										...
										bLoc57_1207 = v42_770;
										if (v42_770 <= 0x00)
											di_1004 = fn0800_0B76(SEQ(ss, fp - 2), cx, dx, bx_558, di_1004);
										--cx;
									} while (cx != 0x00);
								}
								bx = bx_558;
...
l0800_1035:
				...
				do
				{
					di_1004 = fn0800_0B6E(SEQ(ds, di_1004), SEQ(ss, fp - 2), al_969, cx, dx, bx);
		...
		if (v15_1044 <= 0x00)
			di_1004 = fn0800_0B76(SEQ(ss, fp - 2), cx, dx, bx, di_1004);
	}
	if (bLoc57_1207 < 0x50)
		fn0800_0B76(SEQ(ss, fp - 2), cx, dx, bx, di_1004);
}
