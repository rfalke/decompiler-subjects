...

{
  ...
  uVar23 = 0x14f;
  puVar11 = (undefined *)&DAT_1107_0080;
                    // WARNING: Read-only address (ram,0x000101f8) is written
  uRam000101f8 = 0x1107;
  pcVar5 = (code *)swi(0x21);
  uVar24 = (*pcVar5)();
  uVar22 = s_Turbo_C___Copyright__c__1988_Bor_1107_0004._40_2_;
  puVar17 = DAT_1107_0002;
  iVar7 = (int)((ulong)uVar24 >> 0x10);
  *(undefined2 *)&DAT_1107_0092 = (int)uVar24;
  *(undefined2 *)&DAT_1107_0090 = unaff_ES;
  *(undefined2 *)&DAT_1107_008c = uVar22;
  *(int *)&DAT_1107_00ac = (int)puVar17;
  *(undefined2 *)&DAT_1107_0096 = 0xffff;
  *(undefined2 *)(puVar11 + -2) = 0x2e;
  FUN_1000_0162();
  uVar24 = *(undefined4 *)&DAT_1107_008a;
  ...
  *(int **)&DAT_1107_008e = piVar18;
  ...
  if ((uVar9 < 0xfb8c) && (puVar2 = (uint *)&DAT_1107_0206, !CARRY2(uVar9 + 0x474,*puVar2))) {
    bVar8 = 4;
    puVar20 = (undefined *)((uVar9 + 0x474 + *puVar2 >> 4) + 1);
    if (puVar20 <= puVar17) {
      ...
      *(int *)&DAT_1107_00a4 = (int)puVar17;
      *(int *)&DAT_1107_00a8 = (int)puVar17;
      piVar18 = (int *)(puVar17 + -*(int *)&DAT_1107_0090);
      piVar12 = (int *)(puVar11 + -2);
      *(undefined **)(puVar11 + -2) = puVar20;
      pcVar5 = (code *)swi(0x21);
      (*pcVar5)();
      iVar21 = *piVar12 << (bVar8 & 0x1f);
      puVar17 = (undefined *)&DAT_1107_042e;
      ...
      *(undefined2 *)(puVar14 + -2) = 0x10e;
      (**(code **)&DAT_1107_0424)();
      *(undefined2 *)(puVar15 + -2) = *(undefined2 *)&DAT_1107_0088;
      *(undefined2 *)(puVar15 + -4) = *(undefined2 *)&DAT_1107_0086;
      *(undefined2 *)(puVar15 + -6) = *(undefined2 *)&DAT_1107_0084;
...
LAB_1000_01e9:
  ...
  *(undefined **)(puVar16 + -2) = puVar17;
  puVar16[-4] = 0xff;
  puVar16[-3] = 0x8f;
  puVar16[-3] = puVar16[-4] + puVar16[-3];
  puVar16[-4] = puVar16[-4] - puVar16[-3];
  puVar16[-4] = puVar16[-4] * puVar16[-3];
  puVar16[-3] = (char)((ulong)(byte)puVar16[-3] / (ulong)(long)(int)(uint)(byte)puVar16[-4]);
  puVar16[-3] = (char)((ulong)(byte)puVar16[-3] % (ulong)(long)(int)(uint)(byte)puVar16[-4]);
  puVar16[-4] = puVar16[-4] << 5;
  puVar16[-3] = (byte)puVar16[-3] >> (puVar16[-4] & 0x1f);
  *(uint *)(puVar16 + -6) = (uint)(byte)puVar16[-3];
  *(uint *)(puVar16 + -8) = (uint)(byte)puVar16[-4];
  *(undefined2 *)(puVar16 + -10) = 0x194;
  *(undefined2 *)(puVar16 + -0xc) = 0x275;
  FUN_1000_0920();
  return;
}
...

{
  ...
  if (puVar9 <= register0x00000010) {
    ...
    *pcVar14 = '\0';
    uVar17 = uVar10 == 0;
LAB_1000_035a:
    *(undefined2 *)((int)appcStack4 + iVar3) = 0x35d;
    bVar6 = FUN_1000_0376();
    iVar11 = extraout_DX;
    if (bVar16 || (bool)uVar17) {
      do {
        ...
        if (bVar16) {
          ...
          *(int **)&DAT_1107_0086 = (int *)ppcVar12;
          goto LAB_1000_03be;
        }
        *(undefined2 *)((int)appcStack4 + iVar3) = 0x364;
        bVar6 = FUN_1000_0376();
...

{
  ...
  FUN_1000_0796(param_1 & 0xff00 | 0x61,1,param_3,param_2,param_1,iVar1);
  return;
}
...
int FUN_1000_0b48(undefined4 *param_1,char *param_2)
  ...
  if (cVar15 != '\0') {
    ...
    if (cVar15 == '%') {
      ...
      if (cVar15 != '%') {
        ...
        do {
          bVar13 = false;
          if (0x5f < (byte)(cVar15 - 0x20U)) goto LAB_1000_103f;
          ...
          switch(cVar4) {
          case '\0':
            if (bVar20 != 0) goto LAB_1000_103f;
            if (local_8f != '+') {
              local_8f = cVar15;
            }
            break;
          ...
          case '\x02':
            ...
            if (bVar20 < 2) {
              ...
              if (bVar20 != 4) goto LAB_1000_103f;
              pcVar19 = (char *)0x500;
            }
            break;
          case '\x03':
            ...
            break;
          case '\x04':
            if (3 < bVar20) goto LAB_1000_103f;
            pcVar19 = (char *)0x400;
            break;
          case '\x05':
switchD_1000_0c15_caseD_5:
          ...
          case '\b':
            ...
            break;
          case '\t':
            if (bVar20 != 0) goto switchD_1000_0c15_caseD_5;
            if (!bVar7) {
              bVar9 = true;
              pcVar19 = (char *)0x100;
            }
...
LAB_1000_0d54:
          ...
          case '\x0f':
            pcVar19 = local_92;
            if ((int)local_92 < 0) {
              pcVar19 = (char *)((int)s_Turbo_C___Copyright__c__1988_Bor_1107_0004 + 2);
            }
            if (bVar11) {
              uVar28 = 2;
              local_6 = 4;
            ...
            thunk_FUN_1000_0881(uVar28,local_9a,cVar15,local_89,pcVar19,param_1);
            puVar25 = local_89;
...
LAB_1000_0d77:
  ...
  FUN_1000_0796(uVar28,local_95,(char)((uint)uVar28 >> 8),puVar25,pcVar17,pcVar21);
  if ((int)local_92 < 1) {
LAB_1000_0efc:
    if ((!bVar9) || ((int)local_94 < 1)) goto LAB_1000_0f1e;
  }
  FUN_1000_0b61();
  if (*(char *)puVar25 == '-') {
    pcVar19 = pcVar19 + -1;
