    ...
    *(uint *)((int)auStack4 + iVar3) = 0x3a6;
    ...
    if (bVar15 || (bool)uVar16) {
      do {
        ...
        if (bVar15) {
          iVar10 = *(uint *)((int)(auStack4 + 1) + iVar3) + iVar10;
...

{
  ...
  if ((param_3 + 1U < 2) || ((*(uint *)(param_1 * 2 + 0x482) & 0x200) != 0)) {
    ...
    do {
      pcVar5 = (char *)FUN_1000_0ab3(param_1,param_2,param_3);
      if (pcVar5 + 1 < (char *)&DAT_11db_0002) {
        return pcVar5;
      }
      pcVar7 = param_2;
      pcVar3 = param_2;
      ...
      do {
        while( true ) {
          ...
          pcVar6 = param_2;
          if (cVar2 == '\x1a') {
            FUN_1000_0c28(param_1,-(int)pcVar5,-(uint)(pcVar5 != (char *)0x0),2);
          ...
          *pcVar4 = cVar2;
          ...
          pcVar7 = pcVar7 + 1;
          pcVar3 = pcVar4 + 1;
          if (pcVar5 == (char *)0x0) goto LAB_1000_0a7f;
        }
        pcVar5 = pcVar5 + -1;
        pcVar7 = pcVar7 + 1;
        pcVar3 = pcVar4;
  ...
  if (cVar13 != '\0') {
    ...
    if (cVar13 == '%') {
      ...
      if (cVar13 != '%') {
        ...
        do {
          bVar12 = false;
          if (0x5f < (byte)(cVar13 - 0x20U)) goto LAB_1000_156a;
          cVar4 = *(char *)((byte)(cVar13 - 0x20U) + 0x4f9);
          cVar21 = cVar4 * '\x02';
...
LAB_1000_127f:
          ...
          case '\x0f':
            ...
            thunk_FUN_1000_0d3e(uVar27,local_9a,cVar13,local_89,puVar17,param_1);
            puVar24 = local_89;
...
LAB_1000_12a2:
  ...
  FUN_1000_0c53(uVar27,local_95,(char)((uint)uVar27 >> 8),puVar24,pcVar15,pcVar20);
  if ((int)local_92 < 1) {
LAB_1000_1427:
