...

{
  ...
  puVar13 = (undefined *)&DAT_11db_0080;
                    // WARNING: Read-only address (ram,0x000101f8) is written
  uRam000101f8 = 0x11db;
  pcVar6 = (code *)swi(0x21);
  uVar27 = (*pcVar6)();
  uVar26 = s_Turbo_C___Copyright__c__1988_Bor_11db_0004._40_2_;
  iVar10 = DAT_11db_0002;
  iVar11 = (int)((ulong)uVar27 >> 0x10);
  *(undefined2 *)&DAT_11db_0092 = (int)uVar27;
  *(undefined2 *)&DAT_11db_0090 = unaff_ES;
  *(undefined2 *)&DAT_11db_008c = uVar26;
  *(int *)&DAT_11db_00ac = iVar10;
  *(undefined2 *)&DAT_11db_0096 = 0xffff;
  *(undefined2 *)(puVar13 + -2) = 0x2e;
  FUN_1000_0162();
  uVar27 = *(undefined4 *)&DAT_11db_008a;
  ...
  *(int *)&DAT_11db_008a = -(uVar9 | 0x8000);
  *(uint *)&DAT_11db_008e = (int)piVar22 * 2 + 8U & 0xfff8;
  uVar20 = iVar10 - iVar11;
  uVar9 = *(uint *)&DAT_11db_023c;
  if (uVar9 < 0x200) {
    uVar9 = 0x200;
    *(undefined2 *)&DAT_11db_023c = 0x200;
  }
  if ((uVar9 < 0xf9d2) && (puVar2 = (uint *)&DAT_11db_023a, !CARRY2(uVar9 + 0x62e,*puVar2))) {
    bVar8 = 4;
    uVar9 = (uVar9 + 0x62e + *puVar2 >> 4) + 1;
    if (uVar9 <= uVar20) {
      ...
      iVar12 = uVar9 + iVar11;
      *(int *)&DAT_11db_00a4 = iVar12;
      *(int *)&DAT_11db_00a8 = iVar12;
      iVar12 = iVar12 - *(int *)&DAT_11db_0090;
      piVar14 = (int *)(puVar13 + -2);
      *(uint *)(puVar13 + -2) = uVar9;
      pcVar6 = (code *)swi(0x21);
      (*pcVar6)();
      iVar24 = *piVar14 << (bVar8 & 0x1f);
      puVar25 = (undefined *)&DAT_11db_05e8;
      ...
      *(int *)&DAT_11db_009a = iVar10;
      pcVar5 = *(code **)&DAT_11db_05de;
      puVar17 = puVar16 + -2;
      *(undefined2 *)(puVar16 + -2) = 0x10e;
      (*pcVar5)();
      *(undefined2 *)(puVar17 + -2) = *(undefined2 *)&DAT_11db_0088;
      *(undefined2 *)(puVar17 + -4) = *(undefined2 *)&DAT_11db_0086;
      *(undefined2 *)(puVar17 + -6) = *(undefined2 *)&DAT_11db_0084;
      *(undefined2 *)(puVar17 + -8) = 0x11d;
      uVar26 = FUN_1000_0265();
...

{
  ...
  pcVar9 = (char *)(DAT_11db_008a + 2);
  uVar6 = 1;
  uVar11 = DAT_11db_0090;
  ...
  if (2 < DAT_11db_0092) {
    ...
    if (uVar6 == 0) goto LAB_1000_03e7;
    uVar6 = uVar6 ^ 0x7f;
    uVar11 = DAT_11db_008c;
  }
  puVar5 = (undefined *)(*(byte *)&DAT_11db_0080 + 2 + uVar6 & 0xfffe);
  iVar3 = -(int)puVar5;
...
LAB_1000_03a3:
    *(undefined2 *)((int)auStack_4 + iVar3) = 0x3a6;
    ...
    if (bVar12 || (bool)uVar13) {
      do {
        uVar11 = DAT_1000_0332;
        if (bVar12) {
          iVar7 = *(int *)((int)auStack_4 + iVar3 + 2) + iVar7;
          *(uint *)&DAT_11db_0084 = uVar6;
          ppcVar8 = (char **)(&stack0x0000 + (uVar6 + 1) * -2);
          if (&stack0x0000 < (undefined *)((uVar6 + 1) * 2)) goto LAB_1000_03e7;
          *(int **)&DAT_11db_0086 = (int *)ppcVar8;
          goto LAB_1000_0407;
        }
        *(undefined2 *)((int)auStack_4 + iVar3) = 0x3ad;
        bVar4 = 0;
        FUN_1000_03bf();
        iVar7 = extraout_DX_00;
      } while (!bVar12 && !(bool)uVar13);
    }
    if ((bVar4 != 0x20) && (bVar4 != 0xd)) goto code_r0x000103b7;
    goto LAB_1000_03bb;
  }
LAB_1000_03e7:
  FUN_1000_01e2();
...

{
  ...
  if (pcVar4 != (char *)0x0) {
    ...
    ppcVar5 = (char **)FUN_1000_0570(DAT_11db_008e);
    DAT_11db_0088 = ppcVar5;
    if (ppcVar5 != (char **)0x0) {
      iVar6 = -1;
      do {
        *ppcVar5 = pcVar4;
...
void __cdecl16near FUN_1000_0cd2(int param_1,undefined2 param_2,int param_3)

{
  ...
  FUN_1000_0c53(0x61,1,param_3,param_2,param_1,iVar1);
  return;
}
...
void FUN_1000_1073(void)

{
  undefined2 unaff_SI;
  
  FUN_1000_10cd(unaff_SI);
  return;
}
...
LAB_1000_10dd:
  pcVar22 = pcVar21 + 1;
  cVar11 = *pcVar21;
  if (cVar11 == '\0') goto LAB_1000_1572;
  if (cVar11 == '%') {
    *(char **)(unaff_BP + -0x8a) = pcVar22;
    pcVar1 = pcVar22;
    pcVar22 = pcVar21 + 2;
    cVar11 = *pcVar1;
    if (cVar11 != '%') goto code_r0x000110ff;
  }
  *pcVar23 = cVar11;
  pcVar23 = pcVar23 + 1;
  pcVar1 = (char *)(unaff_BP + -0x55);
...
code_r0x000110ff:
  ...
  *(undefined2 *)(unaff_BP + -0x90) = 0xffff;
  do {
    if (0x5f < (byte)(cVar11 - 0x20U)) goto switchD_1000_1140_caseD_13;
    cVar5 = *(char *)((byte)(cVar11 - 0x20U) + 0x4f9);
    cVar19 = cVar5 * '\x02';
    bVar18 = (byte)(uVar15 >> 8);
    uVar28 = unaff_SS;
    switch(cVar5) {
    case '\0':
      if (bVar18 != 0) goto switchD_1000_1140_caseD_13;
      ...
      *piVar2 = *piVar2 + 2;
      if (bVar18 < 2) {
        *(undefined2 *)(unaff_BP + -0x92) = uVar14;
        ...
        if (bVar18 != 4) goto switchD_1000_1140_caseD_13;
    ...
    case '\x03':
      ...
      *puVar3 = *puVar3 | 2;
      break;
    case '\x04':
      if (3 < bVar18) goto switchD_1000_1140_caseD_13;
      uVar15 = 0x400;
      break;
    case '\x05':
...
LAB_1000_1572:
    ...
    case '\b':
      ...
      *puVar3 = *puVar3 | 0x80;
      ...
      break;
    case '\t':
      if (bVar18 != 0) goto switchD_1000_1140_caseD_5;
...
LAB_1000_127f:
    ...
    case '\x0f':
      ...
      *(char *)(unaff_BP + -0x94) = cVar11;
      ...
      thunk_FUN_1000_0d3e(uVar13,uVar7 & 1,cVar11,unaff_BP + -0x87,uVar15,uVar14);
      piVar2 = (int *)(unaff_BP + 4);
    ...
    case '\x12':
      ...
      *piVar27 = (uint)(byte)(0x50 - *(char *)(unaff_BP + -0x55)) + *(int *)(unaff_BP + -0x58);
      goto LAB_1000_10d6;
    default:
      goto switchD_1000_1140_caseD_13;
    case '\x16':
      puVar3 = (uint *)(unaff_BP + -0x98);
...
LAB_1000_12a2:
  ...
  *(int **)(unaff_BP + 4) = piVar24;
  ...
  FUN_1000_0c53(uVar14,*(undefined *)(unaff_BP + -0x93),(char)((uint)uVar14 >> 8),puVar26,iVar20,
                iVar16);
...
undefined2 __cdecl16near FUN_1000_1721(void)
...
LAB_1000_1726:
  ...
  pbVar13 = pbVar13 + 1;
  bVar11 = *pbVar3;
  if (bVar11 == 0) goto LAB_1000_1aff;
  if (bVar11 != 0x25) goto LAB_1000_172f;
...
LAB_1000_1794:
  ...
  *(byte **)(unaff_BP + 10) = pbVar13;
  if ((int)puVar8 < 0) goto LAB_1000_1aff;
  bVar11 = *(byte *)(puVar8 + 0x2ad);
  switch(bVar11) {
  case 0:
  case 1:
  case 2:
    goto LAB_1000_1aff;
  case 3:
    goto switchD_1000_17b2_caseD_3;
  case 4:
  ...
  case 5:
    ...
    *piVar1 = (int)(puVar8 + -0x18);
    ...
    goto LAB_1000_1794;
  case 6:
    goto switchD_1000_17b2_caseD_6;
  case 7:
  case 8:
    uVar10 = 10;
    break;
  case 9:
    ...
    break;
  case 10:
    thunk_FUN_1000_0d43(*(undefined2 *)(unaff_BP + 4),*(undefined2 *)(unaff_BP + 6),
    ...
    if (iVar6 < 1) {
      thunk_FUN_1000_0d43();
      if (cVar17 == cVar5) goto LAB_1000_1aff;
    ...
    if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
      ...
      *piVar1 = *piVar1 + 1;
      ...
      thunk_FUN_1000_0d43(puVar8,uVar10);
    }
    else {
      thunk_FUN_1000_0d43();
    }
  ...
  case 0xf:
    ...
    goto LAB_1000_1b06;
  case 0x10:
    goto switchD_1000_17b2_caseD_10;
  case 0x11:
    pbVar14 = pbVar13;
    if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) goto LAB_1000_187e;
    goto LAB_1000_1794;
  case 0x12:
    uVar10 = 0x10;
    break;
  ...
  case 0x14:
    ...
    *pbVar3 = *pbVar3 & 0xdf;
    ...
    goto LAB_1000_1794;
  case 0x15:
    goto switchD_1000_17b2_caseD_15;
  default:
    goto switchD_1000_17b2_caseD_16;
  }
  ...
  FUN_1000_1bcc(*(undefined2 *)(unaff_BP + 4),*(undefined2 *)(unaff_BP + 6),
                *(undefined2 *)(unaff_BP + 8),uVar10,*(uint *)(unaff_BP + -0x22) & 0x7fff,
                unaff_BP + -0x26,unaff_BP + -0x24);
  iVar6 = *(int *)(unaff_BP + -0x24);
  if (iVar6 < 1) {
    if (-1 < iVar6) goto LAB_1000_1aff;
    goto switchD_1000_17b2_caseD_16;
  }
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    piVar1 = (int *)(unaff_BP + -0x28);
...
LAB_1000_187e:
  ...
  goto LAB_1000_1723;
switchD_1000_17b2_caseD_15:
  pbVar3 = (byte *)(unaff_BP + -0x29);
  *pbVar3 = *pbVar3 | 0x20;
  pbVar14 = pbVar13;
  goto LAB_1000_1794;
switchD_1000_17b2_caseD_10:
  ...
  *pbVar3 = *pbVar3 | bVar11;
  ...
  while( true ) {
    ...
    if (((bVar11 != 0x2d) ||
       ...
       (*pbVar13 == 0x5d)) goto LAB_1000_1a23;
    pbVar14 = pbVar14 + 2;
  ...
  while (iVar7 = iVar6 + -1, 0 < iVar6) {
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if ((*(byte *)(unaff_BP + (uVar9 >> 3) + -0x20) & '\x01' << ((byte)uVar9 & 7)) == 0) {
      if ((*(byte *)(unaff_BP + -0x29) & 0x10) == 0) goto LAB_1000_1ab6;
    }
...
LAB_1000_1b21:
  ...
  if (((char)iVar7 < '\0') || (*(char *)(iVar7 + 0x55a) != '\x01')) goto LAB_1000_1b21;
  goto LAB_1000_1b06;
switchD_1000_17b2_caseD_6:
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    FUN_1000_1708();
  }
  iVar6 = *(int *)(unaff_BP + -0x22);
...
LAB_1000_19dd:
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if (iVar7 < 0) goto switchD_1000_17b2_caseD_16;
  }
LAB_1000_19f7:
  if ((*(byte *)(unaff_BP + -0x29) & 1) == 0) {
    piVar1 = (int *)(unaff_BP + -0x28);
...
LAB_1000_172f:
  ...
  *piVar1 = *piVar1 + 1;
  iVar7 = (**(code **)(unaff_BP + 4))(*(undefined2 *)(unaff_BP + 8));
  if (iVar7 < 0) goto switchD_1000_17b2_caseD_16;
  if ((iVar6 < 0) || (*(char *)(iVar6 + 0x55a) != '\x01')) {
    if (iVar7 != iVar6) {
    ...
    while ((-1 < (char)iVar7 && (*(char *)(iVar7 + 0x55a) == '\x01'))) {
      piVar1 = (int *)(unaff_BP + -0x26);
      *piVar1 = *piVar1 + 1;
      iVar7 = (**(code **)(unaff_BP + 4))(*(undefined2 *)(unaff_BP + 8));
      if (iVar7 < 1) goto switchD_1000_17b2_caseD_16;
    }
    (**(code **)(unaff_BP + 6))(iVar7,*(undefined2 *)(unaff_BP + 8));
    piVar1 = (int *)(unaff_BP + -0x26);
    *piVar1 = *piVar1 + -1;
