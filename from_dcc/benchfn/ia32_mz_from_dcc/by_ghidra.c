...

{
  ...
  uVar23 = 0x23e;
  puVar11 = (undefined *)&DAT_11db_0080;
                    // WARNING: Read-only address (ram,0x000101f8) is written
  uRam000101f8 = 0x11db;
  pcVar5 = (code *)swi(0x21);
  uVar24 = (*pcVar5)();
  uVar22 = s_Turbo_C___Copyright__c__1988_Bor_11db_0004._40_2_;
  puVar17 = DAT_11db_0002;
  iVar7 = (int)((ulong)uVar24 >> 0x10);
  *(undefined2 *)&DAT_11db_0092 = (int)uVar24;
  *(undefined2 *)&DAT_11db_0090 = unaff_ES;
  *(undefined2 *)&DAT_11db_008c = uVar22;
  *(int *)&DAT_11db_00ac = (int)puVar17;
  *(undefined2 *)&DAT_11db_0096 = 0xffff;
  *(undefined2 *)(puVar11 + -2) = 0x2e;
  FUN_1000_0162();
  uVar24 = *(undefined4 *)&DAT_11db_008a;
  ...
  *(int **)&DAT_11db_008e = piVar18;
  ...
  if ((uVar9 < 0xf9d2) && (puVar2 = (uint *)&DAT_11db_023a, !CARRY2(uVar9 + 0x62e,*puVar2))) {
    bVar8 = 4;
    puVar20 = (undefined *)((uVar9 + 0x62e + *puVar2 >> 4) + 1);
    if (puVar20 <= puVar17) {
      ...
      *(int *)&DAT_11db_00a4 = (int)puVar17;
      *(int *)&DAT_11db_00a8 = (int)puVar17;
      piVar18 = (int *)(puVar17 + -*(int *)&DAT_11db_0090);
      piVar12 = (int *)(puVar11 + -2);
      *(undefined **)(puVar11 + -2) = puVar20;
      pcVar5 = (code *)swi(0x21);
      (*pcVar5)();
      iVar21 = *piVar12 << (bVar8 & 0x1f);
      puVar17 = (undefined *)&DAT_11db_05e8;
      ...
      *(undefined2 *)(puVar14 + -2) = 0x10e;
      (**(code **)&DAT_11db_05de)();
      *(undefined2 *)(puVar15 + -2) = *(undefined2 *)&DAT_11db_0088;
      *(undefined2 *)(puVar15 + -4) = *(undefined2 *)&DAT_11db_0086;
      *(undefined2 *)(puVar15 + -6) = *(undefined2 *)&DAT_11db_0084;
      *(undefined2 *)(puVar15 + -8) = 0x11d;
      uVar22 = FUN_1000_0265();
...

{
  ...
  if (puVar8 <= register0x00000010) {
    *(uint *)((int)(auStack4 + 1) + iVar3) = uVar9;
    while (uVar9 - 1 != 0) {
      pcVar2 = pcVar13;
      pcVar13 = pcVar13 + 1;
      pcVar1 = pcVar12;
    ...
    *(undefined2 *)((int)auStack4 + iVar3) = 0x3a6;
    ...
    if (bVar15 || (bool)uVar16) {
      do {
        ...
        if (bVar15) {
          iVar10 = *(int *)((int)(auStack4 + 1) + iVar3) + iVar10;
