...
void main()
{
	...
	int64 qwLoc28_71;
	for (qwLoc28_71 = 0x01; qwLoc28_71 <= qwLoc30; ++qwLoc28_71)
		f0();
	printf("finished\n");
}

// 0000000000400848: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
