...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x001008ec. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x1008ec);
