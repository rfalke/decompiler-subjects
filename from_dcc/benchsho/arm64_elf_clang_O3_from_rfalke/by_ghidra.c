...

{
  ...
  if (0 < CONCAT71(uStack47,local_30)) {
    ...
    do {
      ...
      do {
        uVar3 = uVar7;
        if (((uint)(uVar7 == (int)((uVar7 + (int)uVar4 + (int)uVar5) * 0x10000) >> 0x11) |
            uVar7 & 0xffff) == 0) {
          uVar3 = uVar7 + 1;
        }
      ...
      bVar1 = lVar6 < CONCAT71(uStack47,local_30);
      lVar6 = lVar6 + 1;
    } while (bVar1);
    local_22 = (ushort)bVar2;
  }
  printf("a=%d\n",(ulonglong)(uint)(int)(short)local_22);
  return 0;
}
