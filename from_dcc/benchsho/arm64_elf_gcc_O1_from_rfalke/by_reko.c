...
void main(int16 wArg04, int16 wArg06)
{
	...
	word32 x0_32_32_107 = SLICE((uint64) __isoc99_scanf("%ld", 0x00), word32, 32);
	if (qwLoc08 > 0x00)
	{
		word32 w0_104 = (word32) wArg06;
		int32 w3_105 = (word32) wArg04;
		int64 x4_36 = 0x01;
		do
		{
			int32 w1_39 = 0x01;
			do
			{
				uint32 w2_41 = (uint32) (uint16) w1_39;
				word64 x0_48 = __sbfm(SEQ(x0_32_32_107, w2_41 + (w0_104 + w3_105)), 1, 1);
				x0_32_32_107 = SLICE(x0_48, word32, 32);
				ui32 w0_53 = w1_39 | (word32) ((word32) x0_48 == w1_39);
				if (w0_53 != 0x00)
					w0_53 = w2_41 + 0x01;
				w3_105 = (int32) (int16) w0_53;
				w0_104 = (word32) (w3_105 > w1_39);
				w1_39 = (int32) ((int16) w2_41 + 1);
			} while (w1_39 != 0x29);
			++x4_36;
		} while (x4_36 - qwLoc08 <= 0x00);
	}
