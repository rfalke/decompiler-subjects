...

{
  ...
  if (0 < CONCAT71(uStack47,local_30)) {
    uVar6 = (ulonglong)local_22;
    uVar4 = (ulonglong)local_24;
    lVar5 = 1;
    do {
      uVar7 = 1;
      do {
        uVar3 = uVar7;
        if (((uint)(uVar7 == (int)((uVar7 + (int)uVar6 + (int)uVar4) * 0x10000) >> 0x11) |
            uVar7 & 0xffff) == 0) {
          uVar3 = uVar7 + 1;
        }
        uVar4 = (ulonglong)uVar3;
        local_24 = (ushort)uVar3;
        uVar3 = uVar7 + 1;
        bVar2 = (int)uVar7 < (int)(short)local_24;
        uVar6 = (ulonglong)bVar2;
        uVar7 = uVar3;
      } while (uVar3 != 0x29);
      bVar1 = lVar5 < CONCAT71(uStack47,local_30);
      lVar5 = lVar5 + 1;
    } while (bVar1);
    local_22 = (ushort)bVar2;
  }
  printf("a=%d\n",(longlong)(short)local_22);
  return 0;
}
