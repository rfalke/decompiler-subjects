...
// 0000000000400640: void main(Register word64 x10, Register word64 x20)
void main(word64 x10, word64 x20)
{
	...
	fn00000000004004D0();
	fn00000000004004D0();
	word16 wLoc1A_119 = SLICE(x20, word16, 48);
	word16 wLoc1C_120 = SLICE(x20, word16, 32);
	if (qwLoc28 >= 0x01)
	{
		word32 w11_110 = (word32) wLoc1A_119;
		int32 w9_111 = (word32) wLoc1C_120;
		int64 x10_113 = SEQ(x10_32_32, 0x01);
		do
		{
			int32 w12_45 = 0x01;
			do
			{
				w9_111 = (word32) (w12_45 == (w12_45 + (w11_110 + w9_111) << 16) >> 0x0011) | w12_45;
				if ((w9_111 & 0xFFFF) != 0x00)
					w9_111 = w12_45 + 0x01;
				++w12_45;
				w11_110 = (word32) ((int32) (int16) w9_111 > w12_45);
			} while (w12_45 != 0x29);
			x10_113 = x10_174 + 0x01;
			x10_174 = x10_113;
		} while (x10_174 - qwLoc28 < 0x00);
	}
	fn00000000004004E0();
}

// 0000000000400720: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
