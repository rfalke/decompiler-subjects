...
void main()
{
	x0_19 = (uint64) __isoc99_scanf("%ld", fp - 0x30);
	x0_27 = (uint64) printf("executing %ld iterations\n", (int32) qwLoc38);
	x0_36 = (uint64) __isoc99_scanf("%ld", fp - 0x1A);
	x0_45 = (uint64) __isoc99_scanf("%ld", fp - 0x1C);
	int64 qwLoc48_165 = 0x00;
	while (qwLoc48_165 - qwLoc50 <= 0x00)
	{
		do
			;
