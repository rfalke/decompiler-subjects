...

{
  ...
  local_20 = av;
  iStack24 = ac;
  __isoc99_scanf(&DAT_00400878,&local_38);
  printf("executing %ld iterations\n",local_38);
  __isoc99_scanf(&DAT_00400878,&local_22);
  __isoc99_scanf(&DAT_00400878,&local_24);
  for (local_30 = 1; local_30 <= local_38; local_30 = local_30 + 1) {
    for (local_26 = 1; (short)local_26 < 0x29; local_26 = local_26 + 1) {
      local_24 = ((ushort)((short)(local_22 + local_24 + local_26) >> 1 == local_26 | local_26) != 0
                 ^ 1) + local_26;
      local_22 = (ushort)((short)local_26 < local_24);
    }
  }
  printf("a=%d\n",(long)(short)local_22);
  return _b;
