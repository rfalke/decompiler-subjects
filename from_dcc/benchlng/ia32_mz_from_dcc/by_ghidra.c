  ...
  *(int **)&DAT_11ef_008e = piVar20;
  ...
  if ((uVar11 < 0xf9ea) && (puVar2 = (uint *)&DAT_11ef_0222, !CARRY2(uVar11 + 0x616,*puVar2))) {
    ...
    if (puVar22 <= puVar19) {
      ...
      *(int *)&DAT_11ef_00a4 = (int)puVar19;
      *(int *)&DAT_11ef_00a8 = (int)puVar19;
...

{
  ...
  if ((param_3 + 1U < 2) || ((*(uint *)(param_1 * 2 + 0x46a) & 0x200) != 0)) {
    ...
    do {
      pcVar5 = (char *)FUN_1000_0b47(param_1,param_2,param_3);
      if (pcVar5 + 1 < (char *)&DAT_11ef_0002) {
        return pcVar5;
      }
      pcVar7 = param_2;
      pcVar3 = param_2;
      ...
      do {
        while( true ) {
          ...
          pcVar6 = param_2;
          if (cVar2 == '\x1a') {
            FUN_1000_0cbc(param_1,-(int)pcVar5,-(uint)(pcVar5 != (char *)0x0),2);
          ...
          *pcVar4 = cVar2;
          ...
          pcVar7 = pcVar7 + 1;
          pcVar3 = pcVar4 + 1;
          if (pcVar5 == (char *)0x0) goto LAB_1000_0b13;
        }
        pcVar5 = pcVar5 + -1;
        pcVar7 = pcVar7 + 1;
        pcVar3 = pcVar4;
  ...
  if (cVar13 != '\0') {
    ...
    if (cVar13 == '%') {
      ...
      if (cVar13 != '%') {
        ...
        do {
          bVar12 = false;
          if (0x5f < (byte)(cVar13 - 0x20U)) goto LAB_1000_15fe;
...
LAB_1000_1313:
          ...
          case '\x0f':
            ...
            thunk_FUN_1000_0dd2(uVar27,local_9a,cVar13,local_89,puVar17,param_1);
            puVar24 = local_89;
...
LAB_1000_1336:
  ...
  FUN_1000_0ce7(uVar27,local_95,(char)((uint)uVar27 >> 8),puVar24,pcVar15,pcVar20);
  if ((int)local_92 < 1) {
LAB_1000_14bb:
