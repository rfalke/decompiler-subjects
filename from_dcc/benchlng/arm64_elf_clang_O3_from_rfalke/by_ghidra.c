...

{
  ...
  __isoc99_scanf(&DAT_00400760,&local_38);
  printf("executing %ld iterations\n",local_38);
  __isoc99_scanf(&DAT_00400760,&local_28);
  __isoc99_scanf(&DAT_00400760,&local_30);
  if (0 < local_38) {
    local_30 = 0x28;
    local_28 = 0;
  }
...
void FUN_004006cc(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x004006cc. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x4006cc);
