...

{
  ...
  __isoc99_scanf(&DAT_001009e8,&major);
  printf("executing %ld iterations\n",major);
  __isoc99_scanf(&DAT_001009e8,&a);
  __isoc99_scanf(&DAT_001009e8,&b);
  if (0 < major) {
    lVar3 = 1;
    do {
      uVar2 = 1;
      do {
        lVar1 = b + a;
        b = uVar2;
        if ((uVar2 == (longlong)(lVar1 + uVar2) >> 1 | uVar2) == 0) {
          b = uVar2 + 1;
        }
        a = ZEXT18((longlong)uVar2 < b);
        uVar2 = uVar2 + 1;
      } while (uVar2 != 0x29);
      lVar3 = lVar3 + 1;
    } while (lVar3 <= major);
