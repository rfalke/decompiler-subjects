// subject.h
// Generated on TIMESTAMP by decompiling from_pouet.net/with_source_343/ia32_com/subject.exe
...
Eq_2: (segment "Eq_2")
	T_2 (in cs : selector)
Eq_5: (segment "Eq_5" (534 word16 w0534))
	T_5 (in ds : (ptr Eq_5))
Eq_8: (fn void (byte))
...
Eq_19: (union "Eq_19" (uint8 u0) (uint16 u1))
	T_19 (in al_22 : Eq_19)
...
T_5: (in ds : (ptr Eq_5))
  Class: Eq_5
  DataType: (ptr Eq_5)
  OrigDataType: (ptr (segment (534 T_7 t0534)))
T_6: (in 0x0534 : word16)
  Class: Eq_6
  DataType: (memptr (ptr Eq_5) word16)
  OrigDataType: (memptr T_5 (struct (0 T_7 t0000)))
T_7: (in Mem5[ds:0x0534:word16] : word16)
  Class: Eq_4
  DataType: word16
  OrigDataType: word16
T_8: (in bios_video_set_mode : ptr32)
...
T_32: (in -(al_22 >>u 0x01) : byte)
  Class: Eq_32
  DataType: int16
  OrigDataType: int16
T_33: (in -(al_22 >>u 0x01) + al_22 : byte)
  Class: Eq_33
  DataType: byte
  OrigDataType: byte
T_34: (in __outb(0x03C9, -(al_22 >>u 0x01) + al_22) : void)
  Class: Eq_34
  DataType: void
  OrigDataType: void
T_35: (in 0x01 : byte)
