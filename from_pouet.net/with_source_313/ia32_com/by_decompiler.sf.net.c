...
void fn0C00_0219(Eq_27 * ds)
{
	...
	if (ds->t01A7 >= 0x00E6)
	{
		Eq_81 ax_72 = ds->t01A9;
		bx_11 = ds->t01A3;
		if (ax_72 >= bx_11 + 0x0005)
			if (ax_72 <= bx_11 + 0x0005)
				;
			else
				bx_11 = bx_11 + 0x0001;
	...
	{
		Eq_81 ax_34 = Mem19[ds:0x01A9:word16] + Mem19[ds:0x01AD:word16];
		ds->t01A9 = ax_34;
		if (ax_34 == 0x0002)
			ds->w01AD = 0x0001;
		if (ax_34 == 0x00C6)
			ds->w01AD = 0xFFFF;
		Eq_82 cx_41 = Mem35[ds:0x01A7:word16] + Mem35[ds:0x01AB:word16];
		ds->t01A7 = cx_41;
		if (cx_41 == 0x0002 && (ax_34 >= bx_18 && ax_34 < bx_18.u0))
			ds->w01AB = 0x0001;
		Eq_81 bx_46 = ds->t01A3;
		if (cx_41 == 0x013D && (ax_34 >= bx_46 && ax_34 < bx_46.u0))
			ds->w01AB = 0xFFFF;
		if (cx_41 == 0x0000)
		{
			fn0C00_01E0(ax_34, &Eq_27::w01B7, ds);
			return;
		}
		else
		{
			if (cx_41 == 0x013F)
				fn0C00_01E0(ax_34, &Eq_27::w01B5, ds);
			return;
		}
	}
}
