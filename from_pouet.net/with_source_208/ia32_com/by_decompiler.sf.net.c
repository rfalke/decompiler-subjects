...
void fn0C00_0100(uint16 dx, byte bl, Eq_111 * ds)
{
	...
	do
	{
		...
		do
		{
			...
			word32 dx_ax_182 = SEQ(dx, ax_63 >>u 0x0002);
			byte al_180 = (byte) (ax_63 >>u 0x0002);
			ah_14 = SLICE(ax_63 >>u 0x0002, byte, 8);
			if (ax_63 >>u 0x0002 >u 0x0007)
			{
				al_180 = al_180 - 0x07;
				ax_11 = DPB(ax_63 >>u 0x0002, al_180 - 0x07, 0, 8);
				dx_ax_182 = DPB(dx_ax_182, al_180 - 0x07, 0, 8);
			}
			if (di_33 >=u 0x1FE0)
			{
				al_180 = __inb(0x40);
				ax_11 = DPB(ax_11, al_180, 0, 8);
				dx_ax_182 = DPB(dx_ax_182, al_180, 0, 8);
			}
			Mem78[0x9000:di_33 - 0x00A0:byte] = al_180;
		...
		do
		{
			if (Mem105[0x8000:di_109 + 0x0001:byte] == 0x00)
			{
				word16 cx_173 = (0x8000->*si_112).w0000;
				Mem174[0x8000:di_109 + 0x0000:word16] = cx_173;
				Eq_159 di_175 = -di_109;
				Mem176[0x8000:di_175 + 0x1F3E:word16] = cx_173;
				di_109 = -di_175;
			}
			word16 si_132 = &si_112->w0000;
			di_109 = di_109 + 0x00A0;
			bl_114 = bl_114 + 0x01;
			si_112 = si_132 + 0x0001;
			if (bl_114 <u 0x33)
				continue;
			di_109 = di_109 - 0x1FDE;
			si_112 = si_132 + 0x003B;
			bl_114 = 0x00;
			bh_115 = bh_115 + 0x01;
		} while (bh_115 != 0x19);
		byte Eq_28::*di_150 = Eq_28::a0000;
		do
		{
			0xB800->*di_150 = 0x8000->*di_150;
			di_150 = di_150 + 1;
		} while (di_150 != Eq_28::a0000);
		Mem164[ss:fp - 0x0002:word16] = 0x9000;
		byte al_168;
		ah_14 = bios_kbd_check_keystroke(out al_168);
