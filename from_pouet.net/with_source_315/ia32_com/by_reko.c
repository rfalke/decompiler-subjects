...
void fn0C00_0100(struct Eq_2 * ds)
{
	...
	do
	{
		...
		byte dh_166 = SLICE((uint16) (uint8) fn0C00_01CB(ds->t01A3, SEQ(SLICE((uint16) (uint8) fn0C00_01CB(ds->t01A1, 778, 0x01, 0xA000, ds), byte, 8), 0x0C), 0x013E, 0xA000, ds), byte, 8);
		Eq_87 bx_112 = 0x00;
		word16 cx_115;
...
{
	Eq_85 bx_13 = ds->t01A3;
	if (ds->t01A7 >= 0xE6)
	{
		Eq_85 ax_10 = ds->t01A9;
		bx_13 = ds->t01A3;
	...
	Eq_85 bx_31 = fn0C00_0207((word16) ds->t01A1 + ds->w01A5);
	ds->t01A1 = bx_31;
	if (ds->w01B3 == 0x00)
	{
		Eq_85 ax_40 = (word16) ds->t01A9 + ds->w01AD;
		ds->t01A9 = ax_40;
		if (ax_40 == 0x02)
			ds->w01AD = 0x01;
		if (ax_40 == 0xC6)
			ds->w01AD = ~0x00;
		Eq_87 cx_54 = (word16) ds->t01A7 + ds->w01AB;
		ds->t01A7 = cx_54;
		if (cx_54 == 0x02 && (ax_40 >= bx_31 && ax_40 < (word16) bx_31.u0 + 0x0A))
			ds->w01AB = 0x01;
		Eq_85 bx_69 = ds->t01A3;
		if (cx_54 == 0x013D && (ax_40 >= bx_69 && ax_40 < (word16) bx_69.u0 + 0x0A))
			ds->w01AB = ~0x00;
		if (cx_54 != 0x00)
		{
			if (cx_54 == 0x013F)
				fn0C00_01E0(ax_40, &Eq_2::w01B5, ds);
		}
		else
			fn0C00_01E0(ax_40, &Eq_2::w01B7, ds);
	}
	else
		--ds->w01B3;
}
