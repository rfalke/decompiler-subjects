...
void fn0C00_0100(struct Eq_3 * ds)
{
	...
	do
	{
		uint8 cl_14 = (byte) cx_152;
		__out<byte>(0x03C8, cl_14);
		__out<byte>(969, cl_14);
		__out<byte>(969, cl_14);
		uint8 al_22 = (cl_14 >> 0x01) * 0x03;
		if ((cl_14 >> 0x01) * 0x03 >= 0x3F)
			al_22 = 0x3F;
		__out<byte>(969, al_22);
		byte cl_115 = cl_14 - 0x01;
		cx_149 = SEQ(SLICE(cx_152 - 0x01, byte, 8), cl_14 - 0x01);
		cx_152 = cx_149;
	} while (cx_152 != 0x01);
	do
	{
		...
		struct Eq_77 Eq_81::* cx_109 = SEQ(~0x05, cl_115);
		do
		{
			...
			--cx_109;
			cl_115 = (byte) cx_109;
		} while (cx_109 != &Eq_81::t0000);
	} while (__in<byte>(0x60) != 0x01);
	msdos_terminate_program20();
}

// 0C00:0192: Register word16 fn0C00_0192(Sequence (ptr32 real32) ds_bx, FpuStack real64 rArg0, FpuStack real64 rArg1, FpuStack Eq_15 rArg2, FpuStack out Eq_126 rLoc1Out)
// Called from:
//      fn0C00_0100
word16 fn0C00_0192(real32 * ds_bx, real64 rArg0, real64 rArg1, Eq_15 rArg2, union Eq_126 & rLoc1Out)
{
	struct Eq_167 * ds = SLICE(ds_bx, selector, 16);
...
// 0C00:01C3: void fn0C00_01C3(Sequence (ptr32 Eq_64) ds_bx, FpuStack Eq_15 rArg0)
// Called from:
//      fn0C00_0100
void fn0C00_01C3(struct Eq_64 * ds_bx, Eq_15 rArg0)
{
