...
void fn0C00_0100(struct Eq_2 * ds)
{
	...
	{
		word16 si_256;
		ah_14 = SLICE((uint16) fn0C00_021B(ah_14, cx_11, ds, out si_256), byte, 8);
	}
	while (true)
	{
		ui16 cx_132;
		for (cx_132 = 0x0800; cx_132 != 0x00; --cx_132)
		{
			...
			if (ds->b02F6 < 0x04)
			{
				Eq_35 v12_46 = ds->a22F7[cx_132] - 0x01;
				ds->a22F7[cx_132] = v12_46;
				if (v12_46 == 0x00)
					goto l0C00_013B;
			}
			else
			{
				ds->a22F7[cx_132] = (word16) ds->a22F7[cx_132] + 1;
				if (ds->a22F7[cx_132] >= 200)
				{
l0C00_013B:
...
byte fn0C00_0208(byte ah, struct Eq_2 * ds)
{
	...
	Eq_35 bx_11 = ds->t6302;
	Eq_391 dx_ax_13 = (uint32) SEQ(ah_6, al_7);
...
// 0C00:0277: Register byte fn0C00_0277(Register Eq_65 si, Register (ptr16 Eq_240) es, Register (ptr16 Eq_2) ds)
// Called from:
//      fn0C00_0100
byte fn0C00_0277(Eq_65 si, struct Eq_240 * es, struct Eq_2 * ds)
{
	...
	struct Eq_516 Eq_240::* ax_39 = (word16) ds->t62FD + (word16) (ds->t62FF *s 0x0140);
	byte ah_67 = SLICE(ax_39, byte, 8);
	if (ds->t62FD <= 0x013F && ds->t62FF <= 199)
	{
		Eq_68 al_45 = ds->t6301;
