...
void fn0C00_0100(Eq_2 si, struct Eq_3 * ds)
{
	...
	do
	{
		...
		do
		{
			...
			Eq_149 ax_81 = bp_193 - 0xA0;
			ds->w01C2 = ((word16) (ax_70 *s ax_81) >> 0x07) + ax_58;
			Eq_70 dx_297 = ax_58 *s ax_81;
			ds->w01C6 = -((word16) dx_297 >> 0x07) + ax_70;
			...
			do
			{
				byte dh_107 = SLICE(dx_297, byte, 8);
				bcu8 Eq_94::* ax_110 = SEQ(SLICE(si_105, byte, 8), dh_107);
				int16 cx_104 = cx_103 + 0x01;
				byte ah_121 = Mem119[cs + 0x2000:ax_110 + 0x00:byte];
				Eq_81 ax_129 = (int16) ((uint32) (uint16) (SEQ(ah_121, dh_107) + 0x1900) / cx_104);
				cu8 ch_185 = SLICE(cx_104, byte, 8);
				cu8 al_139 = (byte) ax_129;
				byte ah_145 = SLICE(ax_129, byte, 8);
				word16 bx_244 = SEQ(bh_102, ah_121);
				if (ax_129 <= 199)
				{
					bx_244 = SEQ(bh_102, ah_121);
					if (al_139 < bh_102)
					{
						int16 si_154 = (ax_129 << 0x06) + SEQ(al_139, ah_145) + 1000;
						cu8 dl_155 = bh_102 - al_139;
						bx_244 = SEQ(al_139, ah_121);
						if (bl_132 == ah_121)
						{
							byte al_161 = (Mem124[cs + 0x1000:ax_110 + 0x00:byte] >>u 0x04) + 0x13;
							do
							{
								bp_193[si_154] = al_161;
								si_154 += 0x0140;
								--dl_155;
							} while (dl_155 != 0x00);
						}
				...
				bl_132 = (byte) bx_244;
				bh_102 = SLICE(bx_244, byte, 8);
				si_105 += ~0x00;
				cx_103 = cx_104;
				byte cl_270 = (byte) cx_104;
				dx_297.u1 = (word16) dx_297 + 0x0000FFFF;
			} while (ch_185 < 0x02);
			si = si_50;
			--bp_193;
		} while (bp_193 != Eq_103::a0000);
		struct Eq_173 Eq_3::* di_196 = Eq_3::a0000;
		word16 cx_213;
		do
		{
			byte v35_206 = di_196[1000];
			di_196[1000] = 0x00;
			(0xA000->*di_196).b0000 = v35_206;
			++di_196;
			--cx_213;
		} while (cx_213 != 0x00);
