...
T_18: (in 0x13 : byte)
  ...
  DataType: byte
  OrigDataType: byte
T_19: (in DPB(ax, 0x13, 0, 8) : word16)
  Class: Eq_16
  DataType: cups16
  OrigDataType: word16
T_20: (in di : (memptr (ptr Eq_2) byte))
  Class: Eq_20
  DataType: (memptr (ptr Eq_2) byte)
  OrigDataType: (memptr T_2 (struct 0001 (0 T_23 t0000)))
...
T_22: (in di + 0x0000 : word16)
  ...
  DataType: word16
  OrigDataType: word16
T_23: (in Mem18[es_6:di + 0x0000:byte] : byte)
  Class: Eq_14
  DataType: byte
  OrigDataType: byte
...
T_27: (in C : byte)
  ...
  DataType: byte
  OrigDataType: byte
T_28: (in ax_15 - di - C : word16)
  Class: Eq_16
  DataType: cups16
  OrigDataType: word16
T_29: (in (byte) ax_15 : byte)
  Class: Eq_14
  DataType: byte
  OrigDataType: byte
T_30: (in cond(ax_15) : byte)
  Class: Eq_27
  DataType: byte
  OrigDataType: byte
T_31: (in cx : word16)
...
T_37: (in 0x0000 : word16)
  ...
  DataType: cups16
  OrigDataType: cups16
T_38: (in ax_15 <u 0x0000 : bool)
  Class: Eq_38
  DataType: bool
  OrigDataType: bool
T_39: (in ax_15 + di + (ax_15 <u 0x0000) : word16)
  Class: Eq_16
  DataType: cups16
  OrigDataType: word16
T_40: (in (byte) ax_15 : byte)
  Class: Eq_14
  DataType: byte
  OrigDataType: byte
T_41: (in cond(ax_15) : byte)
  Class: Eq_27
  DataType: byte
  OrigDataType: byte
*/
