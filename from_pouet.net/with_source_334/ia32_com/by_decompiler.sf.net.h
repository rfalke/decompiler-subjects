// subject.h
// Generated on TIMESTAMP by decompiling from_pouet.net/with_source_334/ia32_com/subject.exe
...
Eq_2: (segment "Eq_2")
	T_2 (in cs : selector)
Eq_5: (segment "Eq_5" (4F8 word16 w04F8))
	T_5 (in ds : (ptr Eq_5))
Eq_8: (fn void (byte))
...
T_5: (in ds : (ptr Eq_5))
  Class: Eq_5
  DataType: (ptr Eq_5)
  OrigDataType: (ptr (segment (4F8 T_7 t04F8)))
T_6: (in 0x04F8 : word16)
  Class: Eq_6
  DataType: (memptr (ptr Eq_5) word16)
  OrigDataType: (memptr T_5 (struct (0 T_7 t0000)))
T_7: (in Mem5[ds:0x04F8:word16] : word16)
  Class: Eq_4
  DataType: word16
  OrigDataType: word16
T_8: (in bios_video_set_mode : ptr32)
