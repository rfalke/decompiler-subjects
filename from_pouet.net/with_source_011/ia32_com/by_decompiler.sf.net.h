...
T_18: (in di : (memptr (ptr Eq_2) byte))
  ...
  OrigDataType: (memptr T_2 (struct (0 T_23 t0000)))
T_19: (in ax_14 + di : word16)
  Class: Eq_14
  DataType: word16
  OrigDataType: word16
...
T_22: (in di + 0x0000 : word16)
  ...
  DataType: word16
  OrigDataType: word16
T_23: (in Mem19[es_6:di + 0x0000:byte] : byte)
  Class: Eq_20
  DataType: byte
  OrigDataType: byte
