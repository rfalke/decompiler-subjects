...
// WARNING: Instruction at (ram,0x00927ffb) overlaps instruction at (ram,0x00927ffa)
// 
                ...
                *puVar14 = (uint)(&DAT_00401000 +
                ...
                if (iVar7 == 0) {
                  ...
                  do {
                    ...
                    hModule = LoadLibraryA((LPCSTR)((int)&DWORD_00929000 + *lpProcName));
                    while( true ) {
                      cVar3 = *(char *)piVar17;
                      lpProcName = (int *)((int)piVar17 + 1);
                      if (cVar3 == '\0') break;
                      if (cVar3 < '\0') {
                        lpProcName = (int *)(uint)*(ushort *)lpProcName;
                        piVar17 = (int *)((int)piVar17 + 3);
                      }
                      else {
                        piVar8 = lpProcName;
                        piVar16 = lpProcName;
