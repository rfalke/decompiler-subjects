...
// 0C00:0100: void fn0C00_0100(Sequence (ptr32 Eq_12) ds_bx, Register Eq_4 si)
void fn0C00_0100(union Eq_12 * ds_bx, Eq_4 si)
{
	int16 bx = (word16) ds_bx;
	__syscall<byte>(0x10);
	Eq_12 ds_cx_8 = ds_bx->u1;
	uint16 cx_10 = (word16) ds_cx_8;
	struct Eq_18 * ds_91 = SLICE(ds_cx_8, selector, 16);
	do
	{
		uint8 al_13 = (byte) cx_10;
		__out<byte>(969, al_13);
		__out<byte>(969, al_13 >> 0x01);
		__out<byte>(969, al_13 >> 0x02);
	...
	do
	{
		...
		int16 ax_81 = (int16) __in<byte>(0x60);
