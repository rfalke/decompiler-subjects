...
;mov al,es:[di+32000-160];[di+32000-20*320-180];grab from starfield (vscreen)

adc al,es:[di+32000-160];[di+32000-20*320-180];grab from starfield (vscreen)
adc ah,0
adc al,offset vflame+di
adc ah,0
shr ax,1
dec ax


mov offset vflame+di-320-1,al
stosb;mov es:[di],al
loop waste
inc bx
add di,320-40
