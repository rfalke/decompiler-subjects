// subject.c
// Generated on TIMESTAMP by decompiling from_pouet.net/with_source_084/ia32_com/subject.exe
...
void fn0C00_0100(word16 ax, word16 bx, int16 bp, Eq_22 Eq_21::*di)
{
	...
	do
	{
		...
		(0xA000->*di).t0000 = (byte) ax_21 + 0x1E;
		bp = ax_18 + 0x0001;
		di = di + 1;
		cx_17 = cx_17 - 0x0001;
	} while (cx_17 != 0x0000);
	Mem30[ss:fp - 0x0002:word16] = 0xA000;
	word16 cx_35 = DPB(cx_17, 0x06, 0, 8);
	do
	{
