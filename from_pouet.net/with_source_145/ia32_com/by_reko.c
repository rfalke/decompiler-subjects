...
void fn0C00_0100(word16 * es_di, word16 ax, word16 cx, struct Eq_5 * ds)
{
	...
	struct Eq_8 Eq_5::* si_28 = Eq_5::a017A;
	do
	{
	...
	*es_di = ax;
	...
	for (si_120 = 199; si_120 != 0x00; --si_120)
	{
		...
		do
		{
			Eq_77 ax_53 = 0xA0 - cx_117;
			if (ax_53 < 0x00)
				ax_53 = -ax_53;
			int16 ax_74 = si_120 - 100;
			int32 dx_ax_75 = ax_74 *s ax_74;
			word16 dx_184 = SLICE(dx_ax_75, word16, 16);
			uint16 bp_77 = (word16) (ax_53 * ax_53 + dx_ax_75);
			do
			{
				--dx_184;
				bu8 dl_81 = (byte) dx_184;
			} while (dl_81 * dl_81 - bp_77 > 0x00);
	...
	word16 cx_143 = SEQ(0x02, cl_188);
	do
	{
		byte al_126 = __inb(0x03DA);
	} while ((al_126 & 0x08) == 0x00);
	__outb(0x03C8, al_126 & 0x08);
	for (; cx_143 != 0x00; --cx_143)
		__outb(969, al_126 & 0x08);
}
