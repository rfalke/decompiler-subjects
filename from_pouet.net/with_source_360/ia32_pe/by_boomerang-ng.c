    ...
    if (eax != 0) {
        ...
        if (eax != 0) {
            ...
            if (eax_1 != 0) {
                ...
                proc_0x00401020(al, bl, eax_4, ecx, edx, LOGICALFLAGS32(eax_1), LOGICALFLAGS32(eax_1), LOGICALFLAGS32(eax_1), 0xf4240, 0, 0x4020a4, eax_1, pc, 0, 0, 400, 540, 0x8000, 0x8000, 0x10cf0000, 0x402012, 0x402000, 0, pc);
            }
        }
    }
    local14 = 16;
