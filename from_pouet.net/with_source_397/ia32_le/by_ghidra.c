...

{
  ...
  if ((piVar5 != (int *)0x0) && (in_AX != (char *)0x0)) {
    ...
    for (; iVar3 = *piVar5, iVar3 != 0; piVar5 = piVar5 + 1) {
      iVar2 = FUN_1000_05fe();
...

{
  ...
  if (iVar2 == 0) {
    ...
    pcVar3 = (char *)FUN_1000_00ba();
    if (pcVar3 != (char *)0x0) {
      for (; pcVar4 = in_BX, *pcVar3 != '\0'; pcVar3 = pcVar3 + 1) {
        for (; (*pcVar3 != '\0' && (cVar1 = *pcVar3, cVar1 != ';')); pcVar3 = pcVar3 + 1) {
          *pcVar4 = cVar1;
          pcVar4 = pcVar4 + 1;
        }
        if (pcVar4 != in_BX) {
...
uint __cdecl16near FUN_1000_02d0(void)
...
int __cdecl16near FUN_1000_0337(void)
...

{
  ...
  *pcVar17 = '\0';
  ...
  for (iVar10 = 0x62; iVar10 != 0; iVar10 = iVar10 + -1) {
    puVar4 = puVar18;
    puVar18 = puVar18 + 1;
    *puVar4 = 0;
  }
...

{
  ...
  pcVar17 = DAT_1291_022c;
  if (!(bool)uVar20) {
    for (iVar9 = uVar10 + 1; iVar9 != 0; iVar9 = iVar9 + -1) {
      pcVar3 = pcVar17;
      pcVar17 = pcVar17 + 1;
      pcVar2 = pcVar16;
      pcVar16 = pcVar16 + 1;
  ...
  *pcVar17 = '\0';
  ...
  DAT_1291_0234 = unaff_BP;
  DAT_1291_024a = pcVar17;
  for (iVar9 = 0x62; iVar9 != 0; iVar9 = iVar9 + -1) {
    puVar4 = puVar18;
    puVar18 = puVar18 + 1;
    *puVar4 = 0;
  }
...

{
  ...
  while( true ) {
    ...
    bVar3 = (byte)(uVar2 >> 8);
    if ((0x40 < bVar3) && (bVar3 < 0x5b)) {
      uVar2 = CONCAT11(bVar3 + 0x20,(char)uVar2);
    }
    bVar3 = (byte)(uVar2 >> 8);
...
LAB_1000_0699:
    ...
    local_9a = 0x5c;
    puVar6 = &local_9c;
    local_9c = CONCAT11(0x3a,cVar3 + 'A');
    iVar5 = -1;
    do {
      if (iVar5 == 0) break;
      iVar5 = iVar5 + -1;
...
int __cdecl16near FUN_1000_08b4(void)

{
  ...
  pcVar4 = in_AX;
  do {
    if (*pcVar4 == '\0') goto LAB_1000_08fa;
    pcVar4 = pcVar4 + 1;
    iVar2 = FUN_1000_0924();
  } while (iVar2 != -1);
  iVar3 = -1;
...

{
  ...
  uVar9 = FUN_1000_05f4();
  while( true ) {
    uVar3 = (uint)(byte)(uVar9 >> 0x10);
    pbVar5 = unaff_DI;
    for (pbVar6 = unaff_SI; pbVar6 < unaff_DI; pbVar6 = pbVar6 + 6) {
      pbVar1 = pbVar6;
      bVar7 = *pbVar1 < 2;
      bVar8 = *pbVar1 == 2;
      if ((!bVar8) && (uVar3 = (*in_CX)(), bVar7 || bVar8)) {
        uVar4 = (undefined)(uVar3 >> 8);
        uVar3 = CONCAT11(uVar4,uVar4);
        pbVar5 = pbVar6;
      }
    }
    bVar7 = pbVar5 < unaff_DI;
    bVar8 = pbVar5 == unaff_DI;
    if (bVar8) break;
    uVar9 = (*in_CX)();
    if (bVar7 || bVar8) {
      uVar3 = *(uint *)(pbVar5 + 2);
      if (*pbVar5 == 1) {
        if ((uVar3 | *(uint *)(pbVar5 + 4)) != 0) {
...

{
  ...
  puVar4 = (undefined2 *)FUN_1000_0d39();
  if (puVar4 == (undefined2 *)0x0) {
    ...
    *(undefined2 *)0x21c = (undefined *)((int)puVar4 + uVar6);
    ...
    **(undefined2 **)0x21c = *(undefined2 *)0x24a;
    FUN_1000_0b05();
    *(undefined2 *)(*(int *)0x21c + iVar3 * 2) = 0;
    iVar5 = iVar3;
  }
  *(int *)0x21a = iVar5;
  *(int *)0x444 = iVar3;
...
LAB_1000_0bbc:
        ...
        else if (pcVar5[1] == '\"') goto LAB_1000_0bbc;
      }
      if (in_DX == 0) {
        pcVar5 = pcVar5 + 1;
      }
...

{
  ...
  FUN_1000_17a3();
  piVar3 = extraout_DX;
  FUN_1000_0de6(in_BX,extraout_DX,in_AX);
  FUN_1000_17d7();
  iVar1 = FUN_1000_1285();
  if (iVar1 == 0) {
    FUN_1000_074a();
    iVar1 = FUN_1000_17fb(local_80,0x200,0);
...
LAB_1000_0eaf:
  ...
  if (iVar1 == -1) {
    ...
    FUN_1000_1aa6();
    *piVar3 = (int)local_80;
    iVar1 = FUN_1000_1bec(local_14,local_10,1);
    if (iVar1 != -1) {
      FUN_1000_06f2();
      FUN_1000_1d16();
      iVar1 = FUN_1000_1087();
      ...
      FUN_1000_1e9e(0x1000,local_80,local_100,local_c,local_22,local_20,local_1a,local_1c);
      FUN_1000_13f7();
    }
  }
  return 0xffff;
...
LAB_1000_1126:
          *(uint *)0x2c = uVar8;
          ...
          FUN_1000_107c();
          do {
            for (uVar5 = FUN_1000_0fc1();
                ((uVar1 = *(uint *)0x1, uVar1 != *(uint *)0x226 || (uVar5 == uVar1)) ||
...

{
  ...
  if ((iVar3 != iVar6) || (puVar2 != (undefined *)0x18)) {
    ...
    pcVar8 = puVar2 + 0x14;
    for (uVar4 = 0x14; uVar1 = *(undefined2 *)0x226, uVar4 < *(uint *)0x32; uVar4 = uVar4 + 1) {
      if (*pcVar8 != -1) {
        FUN_1000_1aa6();
        uVar4 = extraout_DX;
      }
...

{
  ...
  if (in_AX != 0) {
    ...
    if (((uVar2 == 0) || (in_AX < uVar2)) || (*(uint *)(uVar2 + 4) <= in_AX)) {
      for (uVar2 = *(uint *)0x380;
          (*(int *)(uVar2 + 4) != 0 && ((in_AX < uVar2 || (*(uint *)(uVar2 + 4) <= in_AX))));
          uVar2 = *(uint *)(uVar2 + 4)) {
      }
    }
    FUN_1000_14f2();
...

{
  ...
  if ((*(int *)0x398 != 0) && (*(int *)0x224 != -2)) {
    ...
    puVar6 = (uint *)(in_AX + *(int *)0x224);
    if (puVar6 < *(uint **)0x224) {
      puVar6 = (uint *)0xfffe;
    }
    ...
    local_a = (int)puVar6 - (int)puVar4;
    uVar1 = local_a - 2;
    if (local_a < uVar1) {
      return 0;
    }
    for (puVar6 = *(uint **)0x380;
        ((puVar6 != (uint *)0x0 && (puVar6[2] != 0)) &&
        ((puVar4 < puVar6 || ((uint *)puVar6[2] <= puVar4)))); puVar6 = (uint *)puVar6[2]) {
    }
    if (puVar6 != (uint *)0x0) {
      puVar5 = (uint *)(*puVar6 + (int)puVar6);
      if (puVar4 + -1 == puVar5) {
        puVar2 = puVar6;
        *puVar2 = *puVar2 + local_a;
        *(undefined2 *)((int)(puVar4 + -1) + local_a) = 0xffff;
        puVar4 = puVar6;
        goto LAB_1000_1741;
      }
    }
...
char * __cdecl16near FUN_1000_17a3(void)

{
  ...
  bVar14 = in_AX < &stack0x0000;
  bVar16 = in_AX == &stack0x0000;
  if (bVar14) {
    pcVar8 = (char *)-((int)in_AX - (int)&stack0x0000);
    ppcVar3 = (char **)0x22c;
    if (*ppcVar3 <= pcVar8 && -(int)*ppcVar3 != (int)in_AX - (int)&stack0x0000) {
      return pcVar8;
    }
    ppcVar3 = (char **)0x38a;
...
int FUN_1000_181a(char *param_1,uint param_2,int param_3)
  ...
  if ((uVar2 == 0) || ((uVar2 & 1) == 0)) {
    ...
    if ((uVar2 & 0x40) == 0) {
      ...
      while( true ) {
        ...
        iVar5 = 0;
        for (pcVar6 = local_16; pcVar6 < local_16 + iVar4; pcVar6 = pcVar6 + 1) {
          cVar8 = *pcVar6;
          if (cVar8 == '\x1a') {
            FUN_1000_1abd();
            return iVar3;
...

{
  ...
  if ((-1 < (int)in_AX) && (puVar1 = (uint *)0x39c, in_AX < *puVar1 || in_AX == *puVar1)) {
    uVar2 = FUN_1000_2270();
    return uVar2;
  }
  FUN_1000_0780();
...
ulong __cdecl16near FUN_1000_1b47(void)
...
LAB_1000_1ba7:
        ...
        if (!bVar7 || uVar1 > uVar2) {
          do {
            bVar6 = CARRY2(uVar3,uVar3);
            uVar3 = uVar3 * 2;
            uVar5 = uVar5 * 2 + (uint)bVar6;
            iVar4 = iVar4 + -1;
            if (iVar4 < 0) goto LAB_1000_1bc9;
            uVar1 = in_CX & 1;
            in_CX = in_CX >> 1;
            in_BX = in_BX >> 1 | (uint)(uVar1 != 0) << 0xf;
  ...
  *(undefined2 *)0x386 = 0x10;
  ...
  if (((int)uVar6 == 0) && (uVar6 = FUN_1000_0d39(), (int)uVar6 == 0)) {
    ...
    *puVar5 = 0;
    ...
    uVar4 = 0;
    if (*in_AX != 0) {
      for (piVar3 = in_AX + 1; *piVar3 != 0; piVar3 = piVar3 + 1) {
        uVar6 = FUN_1000_06f2();
...

{
  ...
  *(int *)0x392 = iVar10;
  ...
  pcVar16 = (char *)0x130;
  for (iVar12 = *(int *)0x394; iVar12 != 0; iVar12 = iVar12 + -1) {
    pcVar7 = pcVar16;
    pcVar16 = pcVar16 + 1;
    pcVar5 = param_1;
    param_1 = param_1 + 1;
...
void FUN_1000_2045(uint param_1)
...
undefined4 __cdecl16near FUN_1000_2270(void)
