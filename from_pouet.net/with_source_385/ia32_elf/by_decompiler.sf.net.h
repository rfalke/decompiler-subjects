// subject.h
// Generated on TIMESTAMP by decompiling from_pouet.net/with_source_385/ia32_elf/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (80487FC (ptr code) ptr80487FC) (8048CBE (ptr code) ptr8048CBE) (8048DE8 (ptr code) ptr8048DE8))
...
T_18: (in fp + 0x00000004 : word32)
  ...
  DataType: (ptr (ptr char))
  OrigDataType: word32
T_19: (in 0x080487FC : word32)
  Class: Eq_12
  DataType: (ptr (ptr code))
  OrigDataType: word32
T_20: (in 0x08048DE8 : word32)
  Class: Eq_13
  DataType: (ptr (ptr code))
  OrigDataType: word32
...
T_23: (in fp - 0x00000004 : word32)
  ...
  DataType: (ptr void)
  OrigDataType: word32
T_24: (in __libc_start_main(&globals->ptr8048CBE, dwArg00, fp + 0x00000004, &globals->ptr80487FC, &globals->ptr8048DE8, edx, fp - 0x00000004) : word32)
  Class: Eq_24
  DataType: word32
  OrigDataType: word32
T_25: (in __hlt : ptr32)
...
typedef code Eq_1code Eq_1code Eq_1struct Globals {
	code * ptr80487FC;	// 80487FC
	code * ptr8048CBE;	// 8048CBE
	code * ptr8048DE8;	// 8048DE8
} Eq_1;
