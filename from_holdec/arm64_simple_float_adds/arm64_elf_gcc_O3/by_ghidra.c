...
{
  printf("float:       %2ld %f\n",0x3ff19999a0000000,4);
  printf("double:      %2ld %f\n",0x3ff199999999999a,8);
  printf("long double: %2ld %Lf\n",0x9a00000000000000,0x10);
  return 0;
}
...
LAB_00100c40:
            ...
            else if ((uVar11 != 0x800000) || (uVar20 == 0)) goto LAB_00100c40;
            uVar13 = 0;
            uVar11 = 0;
          }
LAB_001010b8:
...
LAB_00100c04:
        ...
        else if ((uVar22 != 0x800000) || (uVar20 == 0)) goto LAB_00100c04;
        uVar13 = 0;
        uVar11 = 0;
      }
LAB_001010ac:
...
LAB_00100edc:
        ...
        if ((uVar10 | uVar18) != 0) goto LAB_00100f6c;
        uVar22 = 0;
LAB_00100ea4:
        uVar20 = (ulong)((uVar5 & 0xc00000) == 0x800000);
LAB_00100eb0:
