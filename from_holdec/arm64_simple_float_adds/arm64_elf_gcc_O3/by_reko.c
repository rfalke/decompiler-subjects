...
real64 g_r12D8 = 1.100000023841858; // 00000000000012D8
real64 g_r12E0 = 1.1; // 00000000000012E0
real128 g_r12F0 = // 00000000000012F0
	{
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9A, 0x99, 0x99, 0x99, 0x99, 0x99, 0x19, 0xFF, 0x3F, 
	};
// subject_text.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
void main()
{
	x0_16 = (uint64) printf("float:       %2ld %f\n", 4, 1.100000023841858);
	x0_24 = (uint64) printf("double:      %2ld %f\n", 8, 1.1);
	x0_32 = (uint64) printf("long double: %2ld %Lf\n", 16, g_r12F0);
}

// 0000000000000680: void _start(Register (ptr64 void) x6)
void _start(void * x6)
{
	_start_c(fp, x6);
}

// 000000000000069C: void _start_c(Register (ptr64 int32) x0, Register (ptr64 void) x6)
// Called from:
//      _start
...
// 0000000000000730: void __do_global_dtors_aux(Register word64 x30)
void __do_global_dtors_aux(word64 x30)
{
	if ((word32) g_b12008 != 0x00)
		return;
	ptr64 x29_13 = fp + -24;
	struct Eq_103 * x19_16 = &g_t12000;
	if (g_qw11FC0 != 0x00)
	{
		word64 x1_66;
		word64 x31_67;
...
// 0000000000000798: void frame_dummy(Register word64 x29, Register word64 x30)
...
// 000000000000120C: void __sfp_handle_exceptions(Register ui32 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
