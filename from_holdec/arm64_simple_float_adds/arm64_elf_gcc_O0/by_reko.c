...
// 00000000000006D0: void __do_global_dtors_aux(Register word64 x30)
...
// 0000000000000738: void frame_dummy(Register word64 x29, Register word64 x30)
...
// 00000000000007A8: Register Eq_117 add_long_double(Register Eq_117 q0, Register word128 q1, Register word64 sysreg3_3_4_4_0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      main
Eq_117 add_long_double(Eq_117 q0, word128 q1, word64 sysreg3_3_4_4_0, word64 sysreg3_3_4_4_1)
{
	return __addtf3(q0, q1, sysreg3_3_4_4_0, sysreg3_3_4_4_1);
}
...
{
	x0_22 = (uint64) printf("float:       %2ld %f\n", 4, (real64) add_float(1.0F, 0.1F));
	x0_33 = (uint64) printf("double:      %2ld %f\n", 8, add_double(1.0, 0.1));
	x0_70 = (uint64) printf("long double: %2ld %Lf\n", 16, add_long_double(g_t1360, g_ow1350, sysreg3_3_4_4_0, sysreg3_3_4_4_1));
}

// 0000000000000854: Register Eq_117 __addtf3(Register Eq_117 q0, Register word128 q1, Register word64 sysreg3_3_4_4_0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      add_long_double
Eq_117 __addtf3(Eq_117 q0, word128 q1, word64 sysreg3_3_4_4_0, word64 sysreg3_3_4_4_1)
{
	Eq_117 q0;
	q0_64_64_1180.u1 = SLICE(q0, word64, 64);
	word128 q1;
		...
		if (w0_32 > 0x00)
		{
			if (x12_25 == 0x00)
			{
				...
				if (w0_32 == 0x01)
				{
					...
					x7_765 = x1_763;
					x3_767 = x3_38 + x2_35 + (word64) (x1_763 < 0x00);
...
l00000000000009A4:
			...
			x7_747 = x1_745;
			x3_753 = x2_748 + x3_38 + (word64) (x1_745 < 0x00);
			goto l0000000000000908;
		}
		if (w0_32 != 0x00)
		{
			...
			if (x0_24 == 0x00)
			{
				...
				if (w0_32 == 0x01)
				{
					...
					x7_658 = x1_656;
					x3_660 = x3_38 + x2_35 + (word64) (x1_656 < 0x00);
...
l0000000000000A94:
			...
			x7_649 = x1_647;
			x3_655 = x0_650 + x2_35 + (word64) (x1_647 < 0x00);
l0000000000000A48:
		...
		if (x0_24 == 0x00)
		{
			if (x12_494 != 0x00)
			{
				...
				if (x0_573 != 0x00)
				{
					...
					x7_576 = x1_574;
					x3_578 = x3_38 + x2_35 + (word64) (x1_574 < 0x00);
					w0_581 = 0x00;
					x4_582 = 0x01;
...
l00000000000008CC:
			...
			if (w0_32 == 0x01)
			{
				...
				x3_354 = x3_38 - x2_35 - (word64) (x7_351 < 0x00);
...
l0000000000000D30:
		...
		x3_350 = x3_38 - x2_348 - (word64) (x7_343 < 0x00);
		goto l0000000000000CE0;
	}
	if (w0_32 != 0x00)
	{
		...
		if (x0_24 == 0x00)
		{
			...
			if (w0_32 == 0x01)
			{
				...
				x3_247 = x2_35 - x3_38 - (word64) (x7_244 < 0x00);
...
l0000000000000E2C:
		...
		x3_243 = x2_35 - x0_241 - (word64) (x7_236 < 0x00);
l0000000000000DDC:
...
l0000000000000CE0:
	...
	if (x0_24 == 0x00)
	{
		...
		else
		{
			...
			x0_146 = x3_38 - x2_35 - (word64) (x31_143 < 0x00);
			x7_156 = (qwLoc08_1501 << 3) - (qwLoc08_1498 << 3);
			x3_159 = x2_35 - x3_38 - (word64) (x7_156 < 0x00);
		}
...
l0000000000000B3C:
		...
		if (w0_1237 != 0x00)
			__sfp_handle_exceptions((word32) x0_1358, sysreg3_3_4_4_1);
		q0_64_64_1635 = q0_64_64_1180;
		return q0_64_64_1635;
	}
	x0_32_32_1340 = 0x00;
	if (x0_24 == 0x7FFF)
	{
...
// 0000000000001274: void __sfp_handle_exceptions(Register ui32 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
void __sfp_handle_exceptions(ui32 w0, word64 sysreg3_3_4_4_1)
{
	ui32 w0 = (word32) x0;
	if ((w0 & 0x01) != 0x00)
