...
word128 g_ow1360 = // 0000000000001360
	{
...
// 000000000000063C: void _start_c(Register (ptr64 Eq_12) x0, Register (ptr64 void) x6)
// Called from:
//      _start
...
{
	add_float();
	x0_19 = (uint64) printf("float:       %2ld %f\n", 0x00);
	add_double();
	x0_29 = (uint64) printf("double:      %2ld %f\n", 0x00);
	add_long_double(g_ow1360, g_ow1350, sysreg3_3_4_4_0, sysreg3_3_4_4_1);
	x0_66 = (uint64) printf("long double: %2ld %Lf\n", 0x00);
}
...
// 0000000000001274: void __sfp_handle_exceptions(Register Eq_864 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
void __sfp_handle_exceptions(Eq_864 w0, word64 sysreg3_3_4_4_1)
{
	Eq_864 w0 = (word32) x0;
	if ((w0 & 0x01) != 0x00)
	{
