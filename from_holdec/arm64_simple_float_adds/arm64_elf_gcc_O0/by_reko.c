...
// 0000000000001274: void __sfp_handle_exceptions(Register Eq_819 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
void __sfp_handle_exceptions(Eq_819 w0, word64 sysreg3_3_4_4_1)
{
	Eq_819 w0 = (word32) x0;
	if ((w0 & 0x01) != 0x00)
	{
