...
{
	add_float();
	x0_29 = (uint64) printf("float:       %2ld %f\n", 0x00);
	add_double();
	x0_41 = (uint64) printf("double:      %2ld %f\n", 0x00);
	add_long_double(g_ow1340, g_ow1350, sysreg3_3_4_4_0, sysreg3_3_4_4_1);
	x0_76 = (uint64) printf("long double: %2ld %Lf\n", 0x00);
}
...
// 00000000000012B0: void __sfp_handle_exceptions(Register Eq_864 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
