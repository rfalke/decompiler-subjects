...
Eq_117 g_t1340 = // 0000000000001340
	{
...
{
	x0_34 = (uint64) printf("float:       %2ld %f\n", 0x04, (real64) add_float(1.0F, 0.1F));
	x0_48 = (uint64) printf("double:      %2ld %f\n", 0x08, add_double(1.0, 0.1));
	x0_85 = (uint64) printf("long double: %2ld %Lf\n", 0x10, add_long_double(g_t1340, g_ow1350, sysreg3_3_4_4_0, sysreg3_3_4_4_1));
}

// 0000000000000890: Register Eq_117 __addtf3(Register Eq_117 q0, Register word128 q1, Register word64 sysreg3_3_4_4_0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      add_long_double
...
// 00000000000012B0: void __sfp_handle_exceptions(Register ui32 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
