...
struct Eq_89 g_t12000 = // 0000000000012000
	{
		0x00,
	};
// subject_fini.c
...
void main()
{
	x0_13 = (uint64) printf("float:       %2ld %f\n", 0x00);
	x0_19 = (uint64) printf("double:      %2ld %f\n", 0x00);
	x0_27 = (uint64) printf("long double: %2ld %Lf\n", 0x00);
}
...
// 000000000000069C: void _start_c(Register (ptr64 Eq_32) x0, Register (ptr64 void) x6)
// Called from:
//      _start
void _start_c(union Eq_32 * x0, void * x6)
{
...
// 000000000000120C: void __sfp_handle_exceptions(Register Eq_849 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
void __sfp_handle_exceptions(Eq_849 w0, word64 sysreg3_3_4_4_1)
{
	Eq_849 w0 = (word32) x0;
	if ((w0 & 0x01) != 0x00)
	{
