...
word128 g_ow12C0 = // 00000000000012C0
	{
...
{
	add_float();
	x0_18 = (uint64) printf("float:       %2ld %f\n", 0x00);
	add_double();
	x0_27 = (uint64) printf("double:      %2ld %f\n", 0x00);
	add_long_double(g_ow12C0, g_ow12D0, sysreg3_3_4_4_0, sysreg3_3_4_4_1);
	x0_62 = (uint64) printf("long double: %2ld %Lf\n", 0x00);
}
...
// 000000000000122C: void __sfp_handle_exceptions(Register Eq_864 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
