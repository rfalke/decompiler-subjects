...
real64 g_r12B0 = 0.1; // 00000000000012B0
Eq_117 g_t12C0 = // 00000000000012C0
	{
...
word128 g_ow12D0 = // 00000000000012D0
	{
...
// 0000000000000770: Register real64 add_double(Register real64 d0, Register real64 d1)
// Called from:
//      main
...
// 0000000000000778: Register Eq_117 add_long_double(Register Eq_117 q0, Register word128 q1, Register word64 sysreg3_3_4_4_0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      main
...
{
	x0_23 = (uint64) printf("float:       %2ld %f\n", 0x04, (real64) add_float(1.0F, 0.1F));
	x0_34 = (uint64) printf("double:      %2ld %f\n", 0x08, add_double(1.0, 0.1));
	x0_71 = (uint64) printf("long double: %2ld %Lf\n", 0x10, add_long_double(g_t12C0, g_ow12D0, sysreg3_3_4_4_0, sysreg3_3_4_4_1));
}

// 000000000000080C: Register Eq_117 __addtf3(Register Eq_117 q0, Register word128 q1, Register word64 sysreg3_3_4_4_0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      add_long_double
...
// 000000000000122C: void __sfp_handle_exceptions(Register ui32 w0, Register word64 sysreg3_3_4_4_1)
// Called from:
//      __addtf3
