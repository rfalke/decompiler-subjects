...

{
  ...
  uVar1 = printf((char *)(double)fVar2,0x1012e0,4);
  add_double(0x3ff0000000000000,0x3fb999999999999a,(ulonglong)uVar1);
  uVar1 = printf("double:      %2ld %f\n",8);
  add_long_double(0,0xa000000000000000,(ulonglong)uVar1);
