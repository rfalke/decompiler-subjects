...
void main(word32 dwArg00)
{
	...
	do
	{
		f(ptrLoc24, ebx_16, ebx_16);
		ebx_16 = (word32) ebx_16 + 0x01;
	} while (ebx_16 != 0x0A);
}

// 0804833F: void _start(Register (ptr32 Eq_33) edx, Stack int32 dwArg00)
...
// 0804843B: void f(Stack (ptr32 char) ptrArg00, Stack Eq_20 dwArg04, Stack Eq_20 dwArg08)
void f(char * ptrArg00, Eq_20 dwArg04, Eq_20 dwArg08)
{
	if (dwArg04 <= 0x07 && dwArg04 >= 0x02)
		printf("%d signed in range\n", dwArg04);
	if (dwArg08 > 0x07 || dwArg08 < 0x02)
		return;
	printf(ptrArg00, 0x08048518);
}
