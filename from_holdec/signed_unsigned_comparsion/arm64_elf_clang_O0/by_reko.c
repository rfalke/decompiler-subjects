...
// 00000000004005E0: Register ptr64 f(Register Eq_86 w0, Register Eq_87 w1, Register out ptr64 x29Out)
// Called from:
//      main
ptr64 f(Eq_86 w0, Eq_87 w1, ptr64 & x29Out)
{
	Eq_86 w0 = (word32) x0;
	ptr64 x0_23 = x0;
	if (w0 >= 0x02 && w0 <= 0x07)
