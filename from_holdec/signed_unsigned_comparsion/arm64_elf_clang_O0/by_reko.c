...
uint64 f(Eq_92 w0, Eq_92 w1, ptr64 & x1Out)
{
	...
	ptr64 x1_40 = SEQ(x1_32_32, w1_20);
	if (w1 >= 0x02)
	{
		x1_40 = SEQ(x1_32_32, w1_20);
		if (w1 <= 0x07)
		{
			x1_40 = x1;
			x0_25 = (uint64) printf("%d unsigned in range\n", w1);
		}
	}
	x1Out = x1_40;
	return x0_25;
...
// 0000000000400658: void main(Register word32 x0_32_32, Register word64 x1)
void main(word32 x0_32_32, word64 x1)
{
	Eq_92 dwLoc24_54 = 0x00;
	while (dwLoc24_54 < 0x0A)
	{
		word64 x1_37;
		f(dwLoc24_54, dwLoc24_54, out x1_37);
		dwLoc24_54 = (word32) dwLoc24_54.u0 + 1;
	}
}
