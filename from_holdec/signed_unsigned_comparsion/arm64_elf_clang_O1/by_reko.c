...
// 00000000004005E0: Register uint64 f(Register Eq_92 w0, Register Eq_92 w1, Register out ptr64 x1Out)
// Called from:
//      main
uint64 f(Eq_92 w0, Eq_92 w1, ptr64 & x1Out)
{
	ptr64 x1;
	uint64 x0;
	Eq_92 w0 = (word32) x0;
	...
	ptr64 x1_77 = SEQ(x1_32_32, w1_23);
	if (w1 > 0x07 || w1 < 0x02)
	{
		x1Out = x1_77;
		return x0_26;
	...
	{
		uint64 x0_52 = (uint64) printf("%d unsigned in range\n", w1);
		x1Out = x1;
		return x0_52;
	}
}

// 0000000000400640: void main(Register word32 x0_32_32, Register word32 x1_32_32)
void main(word32 x0_32_32, word32 x1_32_32)
{
	word64 x1_32_32_w19_59 = SEQ(x1_32_32, 0x00);
	do
	{
		Eq_92 w19_15 = (word32) x1_32_32_w19_59;
		word64 x1_25;
		f(w19_15, (word32) x1_32_32_w19_59, out x1_25);
		x1_32_32_w19_59 = SEQ(SLICE(x1_25, word32, 32), (word32) w19_15 + 1);
	} while (w19_15 != 0x09);
}
