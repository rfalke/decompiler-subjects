...
// 00000000004005E0: Register ptr64 f(Register Eq_86 w0, Register up32 w1, Register out Eq_88 w19Out)
// Called from:
//      main
ptr64 f(Eq_86 w0, up32 w1, union Eq_88 & w19Out)
{
	Eq_86 w0 = (word32) x0;
	ptr64 x0_24 = x0;
	if (w0 <= 0x07)
...
// 0000000000400640: void main(Register word32 x0_32_32)
void main(word32 x0_32_32)
{
	Eq_86 x0_32_32_w19_64 = SEQ(x0_32_32, 0x00);
	do
	{
		word64 x19_26 = <invalid>;
		word32 w19_34 = (word32) x19_26;
		word32 w19_67;
		x0_32_32_w19_64 = SEQ(SLICE(f(x0_32_32_w19_64, (word32) x0_32_32_w19_64, out w19_67), word32, 32), w19_34 + 0x01);
	} while (w19_34 != 0x09);
}
