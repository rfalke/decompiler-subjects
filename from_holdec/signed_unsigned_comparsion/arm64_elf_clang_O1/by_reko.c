...
// 00000000004005E0: Register ptr64 f(Register ptr64 x0, Register up32 w1, Register out ptr64 x19Out)
// Called from:
//      main
ptr64 f(ptr64 x0, up32 w1, ptr64 & x19Out)
{
	up32 w0 = (word32) x0;
	ptr64 x0_24 = x0;
	if (w0 <= 0x07)
...
{
	ptr64 x0_32_32_w19_64 = SEQ(x0_32_32, 0x00);
	do
	{
		word32 w19_34 = (word32) x19_26;
		word64 x19_26;
		x0_32_32_w19_64 = SEQ(SLICE(f(x0_32_32_w19_64, (word32) x0_32_32_w19_64, out x19_26), word32, 32), w19_34 + 0x01);
	} while (w19_34 != 0x09);
}
