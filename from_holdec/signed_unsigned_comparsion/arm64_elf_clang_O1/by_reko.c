...
// 00000000004005E0: Register word32 f(Register up32 w0, Register up32 w1, Stack word64 qwArg00, Register out ptr64 spOut)
word32 f(up32 w0, up32 w1, word64 qwArg00, ptr64 & spOut)
{
	if (w0 <= 0x07 && w0 >= 0x02)
		fn0000000000400480();
	if (w1 > 0x07 || w1 < 0x02)
		return (word32) qwLoc10;
	word32 w19_50 = (word32) qwLoc10;
	fn0000000000400480();
	return w19_50;
}
...
void main(word64 qwArg00)
{
	...
	{
		word64 sp_21;
		word32 w19_22 = f(w19_15, w19_15, x30, out sp_21);
		w19_15 = w19_22 + 0x01;
	} while (w19_22 != ~0x08);
}

// 0000000000400678: void __libc_csu_init(Register word64 x30, Stack word64 qwArg00)
...
// 00000000004006F4: void _fini(Stack word64 qwArg00)
