...
/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (80497A0 (ptr code) ptr80497A0))
	globals_t (in globals : (ptr (struct "Globals")))
Eq_4: (fn void (word32))
	T_4 (in __align : ptr32)
Eq_9: (fn void ())
	T_9 (in fn08048328 : ptr32)
	T_10 (in signature of fn08048328 : void)
Eq_12: (fn void ())
	T_12 (in __hlt : ptr32)
// Type Variables ////////////
globals_t: (in globals : (ptr (struct "Globals")))
...
T_2: (in 0x080497A0 : ptr32)
  Class: Eq_2
  DataType: (ptr (ptr code))
  OrigDataType: (ptr (struct (0 T_3 t0000)))
T_3: (in Mem0[0x080497A0:word32] : word32)
  Class: Eq_3
  DataType: (ptr code)
