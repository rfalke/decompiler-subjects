...
int __fastcall sum3_thiscall(int a1, int a2, int a3, int a4);
...
int __cdecl __noreturn main(int argc, const char **argv, const char **envp)
{
  ...
  v3 = argc;
  basic_1_multiple_calling_conventions_3_ints(argc);
...
int __cdecl basic_1_multiple_calling_conventions_3_ints(int a1)
{
  ...
  v1 = time(0);
  if ( sum3_cdecl(a1, v1, 42) > 123 )
    puts("cdecl");
  if ( sum3_fastcall(a1, v1, 42) > 123 )
    puts("fastcall");
  if ( sum3_thiscall(a1, v2, v1, 42) > 123 )
    puts("thiscall");
  if ( sum3_ms_abi(a1, v1, 42) > 123 )
    puts("ms_abi");
  if ( sum3_sysv_abi(a1, v1, 42) > 123 )
    puts("sysv_abi");
  if ( sum3_stdcall(a1, v1, 42) > 123 )
    puts("stdcall");
  return 0;
}
// 80486CC: variable 'v2' is possibly undefined
