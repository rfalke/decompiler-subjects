...

{
  ...
  basic_9_dead_block();
  intermediate_1_short_circuit_and(4 < (int)param_1,~param_1 & 1);
  intermediate_2_short_circuit_or(4 < (int)param_1,~param_1 & 1);
...
// WARNING: Removing unreachable block (ram,0x08048590)
...

{
  ...
  local_24[1] = (code *)&LAB_08049030;
  local_24[2] = (code *)&LAB_08049010;
  local_24[3] = (code *)&LAB_08048ff0;
  local_24[4] = (code *)&LAB_08048fd0;
  local_24[5] = (code *)&LAB_08048fb0;
  if (param_1 < 6) {
...
{
  puts("before");
  for (; param_1 != 0x2a; param_1 = param_1 + 1) {
    puts("body");
  }
  puts("after");
  return 0;
