...
void _start() {
    ...
    fun_80482f0(main, __return_address(), esp1, __libc_csu_init, 0x8048520, edx2, (reinterpret_cast<uint32_t>(esp1) & 0xfffffff0) - 4 - 4, eax3);
    __asm__("hlt ");
}
...
void __libc_csu_init(int32_t a1, int32_t a2) {
    ...
    if (esi6) {
        ...
        esi8 = esi6;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi7 * 4 - 0xf8)(ebp5, a1, a2, 0x80484e1);
            ++edi7;
        } while (esi8 != edi7);
    }
    return;
