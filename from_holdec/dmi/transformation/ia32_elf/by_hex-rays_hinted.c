...
signed int __cdecl basic_2_ternary_other(int a1);
...
signed int __cdecl intermediate_2_other_in_blocks(int a1);
// signed __int64 __cdecl _divdi3(__int64 a1, __int64 a2);
// int __cdecl _moddi3(__int64 a1, __int64 a2);
// signed int __cdecl _udivdi3(unsigned __int64 a1, unsigned int a2, unsigned int a3);
// int __cdecl _umoddi3(unsigned __int64 a1, __int64 a2);
...
int __cdecl intermediate_10_double_word_signed_math(__int64 a1, __int64 a2, __int64 a3)
{
  // fixme: improve recognition of 64-bit arithmetics
  if ( (signed int)((unsigned __int64)(a1 + a2) >> 32) >= SHIDWORD(a3) )
  {
    if ( (signed int)((unsigned __int64)(a1 + a2) >> 32) <= SHIDWORD(a3) )
    {
      if ( (signed int)a1 + (signed int)a2 > (unsigned int)a3 )
        puts("add");
    }
    else
    {
  ...
  if ( SHIDWORD(a3) <= (signed int)((unsigned __int64)(a1 - a2) >> 32) )
  {
    if ( SHIDWORD(a3) >= (signed int)((unsigned __int64)(a1 - a2) >> 32) )
    {
      if ( (unsigned int)a3 < (signed int)a1 - (signed int)a2 )
        puts("sub");
    }
    else
    {
