...
bool basic_1_ternary_simple(int param_1)
...

{
  ...
  if (param_6 <= iVar1) {
    ...
    else if (param_5 < param_3 + param_1) {
      puts("add");
    }
  }
  ...
  if (param_6 <= iVar1) {
    ...
    else if (param_5 < param_1 - param_3) {
      puts("sub");
    }
  }
  ...
  if (param_6 <= iVar1) {
    ...
    else if (param_5 < (uint)((ulonglong)param_3 * (ulonglong)param_1)) {
      puts("mult");
    }
  }
...
bool intermediate_1_ternary_blocks(int param_1)
...
// WARNING: Removing unreachable block (ram,0x08048c39)
...
// WARNING: Removing unreachable block (ram,0x08048eba)
