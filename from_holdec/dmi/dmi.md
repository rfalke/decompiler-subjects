...
|-------------------------------------------|--------------------------------|-------------------------------------|--------------------------------|----------------------------------|------------------------------------------------------|----------------------------|
| basic1: if                                | 1/2 (value should be inverted) | +                                   | 1/2 (value should be inverted) | +                                | 1/2 (double return)                                  | +                          |
| basic2: if-else                           | +                              | +                                   | +                              | 1/2 (double return)              | 1/2 (double return)                                  | +                          |
| basic3: if-elseif                         | 1/2 (double return)            | 1/2 (double return, else-string)    | 1/2 (value should be inverted) | 1/2 (switch-case)                | 1/2 (double return)                                  | +                          |
...
| inter12: loop with break block            | 1/2 (double return)            | 1/2 (double return)                 | +                              | 0 (noise)                        | - (call duplicated, also goto)                       | +                          |
| inter13: loop with continue               | +                              | +                                   | +                              | 0 (noise, extra goto)            | +                                                    | +                          |
| inter14: loop with continues              | 1/2 (3 nested loops)           | +                                   | +                              | 0 (noise, extra goto)            | - (call duplicated)                                  | +                          |
| inter15: loop with continue block         | 1/2 (3 nested loops)           | +                                   | +                              | 0 (noise, extra goto)            | - (call duplicated)                                  | +                          |
...
| **Sum all**                               | 22                             | 21                                  | 22.5                           | 9.5                              | 13.5                                                 | 23                         |
...
| inter4: swap with xor       | 0                        | 0                        | 0    | 0                 | 0       | +      |
| advan1: table minization    | 0                        | 0                        | 0    | 0                 | 0       | +      |
| **Sum all**                 | 1.5                      | 2                        | 0    | 2/3               | 0       | 5      |
...
| basic4: reg in 2 blocks incr   | +               | +        | +                      | 3/4 (unused declar) | +                             | ?      |
...
| inter5: merge writes in blocks | 0               | 0        | 0                      | +                   | 0                             | ?      |
| inter6: mem overwrite in block | +               | +        | 0                      | +                   | 0                             | ?      |
| inter10: subregs               | 1/2 (noise)     | +        | 0                      | 1/2 (noise)         | 0                             | ?      |
| advan1: merge writes           | 0               | 0        | 0                      | 0                   | 0                             | ?      |
| advan2: prop value             | 0               | +        | 0                      | 0                   | 0                             | ?      |
| advan3: value analysis         | 1/2 (== cmp ok) | +        | 0                      | 3/4 (partial)       | 0                             | ?      |
| **Sum all**                    | 8               | 10       | 4                      | 8                   | 2.5                           | ?      |
...
| advan1: unrolled loop      | 0           | 0           | 0      | - (c isn't updated) | 0           | 0      |
| **Sum all**                | 2.5         | 2.5         | 1.5    | 4-1                 | 0.75        | 4      |
