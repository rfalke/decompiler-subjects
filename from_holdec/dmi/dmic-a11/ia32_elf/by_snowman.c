...
void fun_8049072() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    ebx7 = ebx8 + 0x2f7c;
    fun_8049040(main, *reinterpret_cast<int16_t*>(&v1), esp3, ebx7 - 0x2e70, ebx7 - 0x2e10, edx5, v4, eax6);
    __asm__("hlt ");
}
...
void fun_8049192() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    if (esi7) {
        ...
        esi9 = esi7;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi8 * 4 - 0xf4)(*reinterpret_cast<int32_t*>(&v1), *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(&v1) + 4), ebp5, 0x80491af);
            ++edi8;
        } while (esi9 != edi8);
    }
    goto *reinterpret_cast<int32_t*>(&v1);
