...

{
  ...
  iVar5 = advanced_1_boolean_minization
                    ((uint)(param_1 == 0),~param_1 & 1,(uint)(param_1 == ((int)param_1 / 3) * 3));
                    // WARNING: Subroutine does not return
...
undefined4 intermediate_4_swap_with_xor(uint param_1,uint param_2)

{
  uint __c;
  
  __c = param_2 ^ param_1 ^ param_2;
  putchar(param_1 ^ param_2 ^ __c);
  putchar(__c);
  return 0;
}
