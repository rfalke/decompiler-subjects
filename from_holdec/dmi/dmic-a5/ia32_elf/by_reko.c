...
word32 _fp_hw = 0x03; // 080484C8
word32 _IO_stdin_used = 0x00020001; // 080484CC
// subject_text.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
void main(int32 dwArg04, char * dwArg08[])
{
	...
	if (dwArg04 > 0x00)
	{
		...
		do
		{
			puts(dwArg08[ebx_32]);
			++ebx_32;
		} while (dwArg04 != ebx_32);
	}
}

// 08048353: void _start(Register (ptr32 Eq_31) edx, Stack int32 dwArg00, Stack (ptr32 char) ptrArg04)
void _start(void (* edx)(), int32 dwArg00, char * ptrArg04)
{
	void * fp;
	__align_stack<word32>(&ptrArg04);
	__libc_start_main(&g_t8048310, dwArg00, &ptrArg04, &g_t8048450, &g_t80484B0, edx, fp);
	__halt();
}
