...

{
  ...
  if (have_table == 0) {
    ...
    while ((int)local_24 < 0x100) {
      ...
      ((uint32_t *)&ram0x0041103c)[(int)local_24] = local_1c;
      local_24 = local_24 + 1;
    }
  }
  local_4 = crc ^ 0xffffffff;
  local_30 = (byte *)buf;
  while (local_30 < buf + len) {
    local_4 = local_4 >> 8 ^ *(uint *)((ulonglong)(local_4 & 0xff ^ (uint)*local_30) * 4 + 0x41103c)
    ;
    local_30 = local_30 + 1;
  }
  return (uint32_t)(local_4 ^ 0xffffffff);
}
...

{
  ...
  sVar1 = strlen("The quick brown fox jumps over the lazy dog");
  uVar2 = rc_crc32(0,"The quick brown fox jumps over the lazy dog",(ulonglong)sVar1);
  printf("%X\n",(ulonglong)uVar2);
  return 0;
}
