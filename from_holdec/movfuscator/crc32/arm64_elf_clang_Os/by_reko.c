...
Eq_168 g_t411034 = // 0000000000411034
	{
...
word32 rc_crc32(word32 w0, byte * x1, int64 x2)
{
	if (((word32) g_b411434 & 0x01) != 0x00)
	{
		...
		do
		{
			uint32 w9_12 = (word32) x9_145;
			word32 w12_11;
			uint32 w13_13 = w9_12;
			for (w12_11 = 0x08; w12_11 != 0x00; --w12_11)
				w13_13 = (w13_13 & 0x01) == 0x00 ? w13_13 >> 1 : w13_13 >> 1 ^ 0x8320;
			(&g_t411034)[x9_145] = (struct Eq_168) w13_13;
			x9_142 = SEQ(SLICE(x9_145 + 0x01, word32, 32), w9_12 + 0x01);
			x9_145 = x9_142;
		} while (x9_145 != 0xFF);
		g_b411434 = 0x01;
	}
