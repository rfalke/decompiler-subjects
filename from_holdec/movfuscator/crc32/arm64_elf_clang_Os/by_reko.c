...
word32 rc_crc32(word32 w0, byte * x1, int64 x2)
{
	if (((word32) g_b411434 & 0x01) != 0x00)
	{
		...
		do
		{
			uint32 w9_13 = (word32) x9_146;
			word32 w12_12;
			uint32 w13_14 = w9_13;
			for (w12_12 = 0x08; w12_12 != 0x00; --w12_12)
				w13_14 = (w13_14 & 0x01) == 0x00 ? w13_14 >> 1 : w13_14 >> 1 ^ 3988292384;
			g_a411034[x9_146 * 0x04] = w13_14;
			x9_143 = SEQ(SLICE(x9_146 + 0x01, word32, 32), w9_13 + 0x01);
			x9_146 = x9_143;
		} while (x9_146 != 0xFF);
		g_b411434 = 0x01;
	}
