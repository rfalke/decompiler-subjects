...

{
  ...
  if ((rc_crc32_have_table & 1) == 0) {
    ...
    do {
      ...
      do {
        uVar3 = (uint)(uVar6 >> 1);
        if ((uVar6 & 1) != 0) {
          uVar3 = (uint)uVar6 >> 1 ^ 0xedb88320;
        }
        uVar6 = (ulong)uVar3;
        iVar5 = iVar5 + -1;
      } while (iVar5 != 0);
      rc_crc32::table[uVar4] = uVar3;
      uVar4 = uVar4 + 1;
    } while (uVar4 != 0x100);
  ...
  if (0 < (long)len) {
    ...
    do {
      pbVar1 = pbVar2 + 1;
      uVar3 = rc_crc32::table[(uint)*pbVar2 ^ uVar3 & 0xff] ^ uVar3 >> 8;
      pbVar2 = pbVar1;
...
void FUN_004006ac(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x004006ac. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x4006ac);
