...
Eq_167 g_t411034 = // 0000000000411034
	{
...
word32 rc_crc32(word32 w0, byte * x1, int64 x2)
{
	if (((word32) g_b411434 & 0x01) != 0x00)
	{
		...
		do
		{
			uint32 w9_12 = (word32) x9_141;
			word32 w12_11;
			uint32 w13_13 = w9_12;
			for (w12_11 = 0x08; w12_11 != 0x00; --w12_11)
			{
				uint32 w14_15 = w13_13 >> 1;
				w13_13 = (w13_13 & 0x01) == 0x00 ? w14_15 : w14_15 ^ 0x8320;
			}
			(&g_t411034)[x9_141] = (struct Eq_167) w13_13;
			x9_138 = SEQ(SLICE(x9_141 + 0x01, word32, 32), w9_12 + 0x01);
			x9_141 = x9_138;
		} while (x9_141 != 0xFF);
		g_b411434 = 0x01;
	}
	...
	if (x2 >= 0x01)
	{
		...
		{
			++x1;
			w8_43 = (&g_t411034)[(uint64) ((word32) *x1 ^ w8_43 & 0xFF) /64 4] ^ w8_43 >> 8;
		} while (x1 - x9_55 < 0x00);
	}
	return ~w8_43;
}
