...

{
  ...
  for (f = -3.141593; f <= 3.151593; f = f + 0.1963495) {
    dVar1 = sin((double)(ulong)(uint)f);
    printf("sin(%.4f): %.4f\n",(double)f,(double)SUB84(dVar1,0));
  }
  return 0;
}
...

{
  ...
  return (double)(ulong)(uint)(((1.0 - fVar2 / 210.0) * fVar4 * fVar3) / 6.227021e+09 +
