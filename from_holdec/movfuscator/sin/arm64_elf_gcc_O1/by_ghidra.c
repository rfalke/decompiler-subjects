...

{
  ...
  return (double)(ulong)(uint)((1.0 - fVar2 / 6.0) * fVar1 +
                              ((1.0 - fVar2 / 42.0) * fVar1 * fVar3) / 120.0 +
                              ((1.0 - fVar2 / 210.0) * fVar3 * fVar4) / 6.227021e+09 +
                              ((1.0 - fVar2 / 110.0) * fVar4) / 362880.0);
}
