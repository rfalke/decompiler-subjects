...
struct Eq_122 * g_a411068[] = // 0000000000411068
	{
	};
...
{
	struct Eq_177 * x9_22 = *((char *) g_a411068 + (word64) w0 * 0x00);
	--x9_22->dw0008;
	text(w2);
...
// 0000000000400A10: Register word64 move(Register Eq_199 w0)
// Called from:
//      move
//      main
word64 move(Eq_199 w0)
{
	Eq_199 w0 = (word32) x0;
	struct Eq_202 * x29_75 = fp + -8;
	if (w0 != 0x00)
	{
		struct Eq_202 * x29_26 = move(w0);
		...
		int32 w0_51 = (word32) (uint64) remove_disk(w8_34);
...
// 0000000000400A9C: void main(Register int32 w0, Register (ptr64 Eq_251) x1)
void main(int32 w0, struct Eq_251 * x1)
{
	fn0000000000400620();
	struct Eq_255 * x29_108 = fp + -8;
