...

{
  ...
  if (1 < c) {
    uVar1 = atoi(v[1]);
    uVar3 = (ulong)uVar1;
    if (0 < (int)uVar1) goto LAB_00400a00;
  }
  uVar3 = 8;
LAB_00400a00:
  lVar4 = 0;
  height = (int)uVar3;
  do {
    plVar2 = (long *)calloc(1,(-(uVar3 >> 0x1f) & 0xfffffffc00000000 | uVar3 << 2) + 0x10);
    *(long **)((long)t + lVar4) = plVar2;
    lVar4 = lVar4 + 8;
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x400aa4);
