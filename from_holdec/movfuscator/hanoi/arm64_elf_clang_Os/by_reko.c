...
{
	Eq_151 x10_14 = (&g_t411068)[(int64) (int32) w0 / 8];
	ui64 x11_20 = (word64) (&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&x10_14.a0000[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0];
	...
	fn0000000000400640();
	struct Eq_186 * sp_29 = (struct Eq_186 *) <invalid>;
...
{
	Eq_151 x9_20 = (&g_t411068)[(int64) (int32) w0 / 8];
	...
	text(w0_24, w0, x10_25[(int64) (int32) (w0_24 - 0x01) / 4]);
}

// 0000000000400908: Register word64 move(Register word64 x0, Register out ptr64 x20Out, Register out (ptr64 Eq_186) x25Out)
// Called from:
//      move
//      main
word64 move(word64 x0, ptr64 & x20Out, struct Eq_186 & x25Out)
{
	word32 w0 = (word32) x0;
	if (w0 != 0x00)
	{
	...
	x20Out = x21;
	x25Out = (struct Eq_186 *) <invalid>;
	return x20;
}

// 00000000004009B8: void main(Register int32 w0, Register (ptr64 Eq_286) x1)
void main(int32 w0, struct Eq_286 * x1)
{
	word64 x19_46;
	fn0000000000400620();
	word32 x0_32_32_159 = SLICE(0x00400B4A, word32, 32);
	x19_32_32_47 = SLICE(x1, word32, 32);
	...
	if (w0 >= 0x02)
	{
		...
		x0_32_32_159 = SLICE(x0_38, word32, 32);
		x19_46 = SEQ(x19_32_32_47, w0_41);
		if (w0_41 > 0x00)
		{
l0000000000400A00:
			__sbfiz(x19_46, 2);
			word32 w19_58 = (word32) x19_46;
			g_dw411080 = w19_58;
			int64 x22_54;
			for (x22_54 = 0x00; x22_54 != 0x18; x22_54 += 0x08)
			{
				fn00000000004005F0();
				word64 * x0_66 = SEQ(x0_32_32_159, 0x01);
				4264040 + x22_54 = x0_66;
				*x0_66 = x0_66 + 2;
			}
			word64 x0_102;
			if (w19_58 != 0x00)
			{
				do
				{
					struct Eq_345 * x21_89;
					word32 x0_32_32_103 = SLICE(add_disk(0x00, w19_58, out x21_89), word32, 32);
					--w19_58;
				} while (w19_58 != 0x00);
				x0_102 = SEQ(x0_32_32_103, x21_89->dw0080);
			}
			else
				x0_102 = SEQ(x0_32_32_159, 0x00);
			word64 x20_238;
			word64 x25_239;
			move(x0_102, out x20_238, out x25_239);
			text(0x01, 0x00, 0x01);
			return;
		}
	}
