...
struct Eq_130 * g_a12068[] = // 0000000000012068
	{
	};
...
struct Eq_130 * (* g_ptr11FA8)[] = &g_a12068; // 0000000000011FA8
...
// 0000000000000BD8: Register word32 remove_disk()
// Called from:
//      move
word32 remove_disk()
{
	...
	--x0_22->dw0008;
	return text(w2)->dw002C;
}

// 0000000000000C6C: Register word64 move(Register Eq_195 w0)
// Called from:
//      move
//      main
word64 move(Eq_195 w0)
{
	Eq_195 w0 = (word32) x0;
	if (w0 != 0x00)
	{
...
// 0000000000000CE4: void main(Register int32 w0, Register (ptr64 Eq_214) x1)
void main(int32 w0, struct Eq_214 * x1)
{
	fn00000000000008C0();
	struct Eq_218 * x29_44 = fp + -24;
	if (w0 > 0x01)
	{
