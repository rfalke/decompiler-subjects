...
Eq_179 stdout = // 0000000000411058
	{
		0x00
	};
byte g_b411060 = 0x00; // 0000000000411060
Eq_363 g_t411068 = // 0000000000411068
	{
...
// 0000000000400860: Register word64 add_disk(Register word32 w0, Register word32 w1, Register word64 x19, Register word64 x20, Register (ptr64 Eq_131) x21, Register ptr64 x29, Register word64 x30, Register out ptr64 x19Out, Register out ptr64 x20Out, Register out ptr64 x21Out, Register out ptr64 x29Out, Register out ptr64 x30Out)
// Called from:
//      move
//      main
word64 add_disk(word32 w0, word32 w1, word64 x19, word64 x20, struct Eq_131 * x21, ptr64 x29, word64 x30, ptr64 & x19Out, ptr64 & x20Out, ptr64 & x21Out, ptr64 & x29Out, ptr64 & x30Out)
{
	struct Eq_139 * x8_25 = (&g_t411068)[(int64) w0 /64 8];
...
{
	struct Eq_199 * x8_25 = (&g_t411068)[(int64) w0 /64 8];
...
// 00000000004009B0: Register ptr64 move(Register Eq_236 w0, Register out ptr64 x20Out, Register out ptr64 x21Out, Register out ptr64 x28Out, Register out ptr64 x29Out, Register out ptr64 x30Out)
// Called from:
//      move
//      main
ptr64 move(Eq_236 w0, ptr64 & x20Out, ptr64 & x21Out, ptr64 & x28Out, ptr64 & x29Out, ptr64 & x30Out)
{
	Eq_236 w0 = (word32) x0;
	if (w0 != 0x00)
	{
		do
		{
			struct Eq_131 * x21_88;
			word64 x20_89;
			ptr64 x29_91;
			word64 x30_92;
			word64 x28_337;
			word64 x19_90 = move(w0, out x20_89, out x21_88, out x28_337, out x29_91, out x30_92);
			struct Eq_290 * x8_105 = (&g_t411068)[(int64) (word32) x20_89 /64 8];
...
// 0000000000400AA8: void main(Register int32 w0, Register (ptr64 Eq_321) x1, Register word64 x30)
void main(int32 w0, struct Eq_321 * x1, word64 x30)
{
	word64 x19_217;
	fn0000000000400620();
...
l0000000000400AF4:
			...
			fn00000000004005F0();
			Eq_363 x0_61 = SEQ(x0_32_32_57, 0x01);
			*x0_61.t0000 = (Eq_363) ((word64) x0_61.t0000 + 16);
			...
			*x0_78 = x0_78 + 2;
			g_ptr411078 = x0_78;
			struct Eq_131 * x21_100 = &g_ptr411000;
			do
			{
