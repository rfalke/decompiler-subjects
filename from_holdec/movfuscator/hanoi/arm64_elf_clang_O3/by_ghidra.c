...

{
  ...
  if (n != 0) {
    do {
      ...
      ptVar2->n = iVar3;
      iVar1 = ptVar2->x[lVar4];
      printf("\x1b[%d;%dH",(ulong)(uint)(height - iVar3),
             (ulong)((height + 1) * (from << 1 | 1U) - iVar1));
      for (iVar3 = iVar1; iVar3 != 0; iVar3 = iVar3 + -1) {
        printf("%s",&DAT_00400d7f);
      }
      ptVar2 = t[to];
      iVar3 = ptVar2->n;
      ptVar2->n = iVar3 + 1;
      ptVar2->x[iVar3] = iVar1;
      printf("\x1b[%d;%dH",(ulong)(uint)((1 - ptVar2->n) + height),
             (ulong)((height + 1) * (to << 1 | 1U) - iVar1));
...

{
  ...
  puts("\x1b[H\x1b[J");
  if ((c < 2) || (uVar1 = strtol(v[1],(char **)0x0,10), (int)uVar1 < 1)) {
    uVar1 = 8;
  }
  __size = (-(uVar1 >> 0x1f & 1) & 0xfffffffc00000000 | (uVar1 & 0xffffffff) << 2) + 0x10;
  height = (int)uVar1;
  ptVar2 = (tower *)calloc(1,__size);
  ptVar2->x = (int *)(ptVar2 + 1);
  t[0] = ptVar2;
  ...
  do {
    ...
    ptVar2->n = iVar4 + 1;
    iVar3 = (int)uVar1;
    ptVar2->x[iVar4] = iVar3;
    printf("\x1b[%d;%dH",(ulong)(uint)((1 - ptVar2->n) + height),(ulong)(uint)((1 - iVar3) + height)
          );
    iVar4 = 0;
    do {
      printf("%s",&DAT_00400d7c);
