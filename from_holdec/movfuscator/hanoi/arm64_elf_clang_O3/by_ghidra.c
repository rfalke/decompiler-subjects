...

{
  ...
  if (n != 0) {
    do {
      ...
      iVar1 = ptVar2->x[lVar4];
      printf("\x1b[%d;%dH",(ulonglong)(uint)(height - iVar3),
             (ulonglong)((height + 1) * (from << 1 | 1U) - iVar1));
      iVar3 = iVar1;
      while (iVar3 != 0) {
        iVar3 = iVar3 + -1;
        printf("%s",&DAT_00400d7f);
      ...
      printf("\x1b[%d;%dH",(ulonglong)(uint)((1 - ptVar2->n) + height),
             (ulonglong)((height + 1) * (to << 1 | 1U) - iVar1));
      while (iVar1 != 0) {
        iVar1 = iVar1 + -1;
        printf("%s",&DAT_00400d7c);
      }
...

{
  ...
  if (1 < c) {
    ...
    if (0 < (int)uVar1) goto LAB_00400b88;
  }
  uVar3 = 8;
LAB_00400b88:
  __size = (int)(uVar3 << 2) + 0x10;
  height = (int)uVar3;
  ptVar5 = (tower *)calloc(1,__size);
  *(tower **)&ptVar5->x = ptVar5 + 1;
  t[0] = ptVar5;
  ...
  *(tower **)&t[2]->x = t[2] + 1;
  do {
    ...
    ptVar5->n = iVar4 + 1;
    iVar2 = (int)uVar3;
    ptVar5->x[iVar4] = iVar2;
    printf("\x1b[%d;%dH",(ulonglong)(uint)((1 - ptVar5->n) + height),
           (ulonglong)(uint)((1 - iVar2) + height));
    iVar4 = 0;
    do {
      printf("%s",&DAT_00400d7c);
      iVar4 = iVar4 + 1;
