...
word64 stdout = 0x00; // 0000000000411058
word32 g_dw41105C = 0x00; // 000000000041105C
byte g_b411060 = 0x00; // 0000000000411060
Eq_376 g_t411068 = // 0000000000411068
	{
...
word64 * g_ptr411070 = null; // 0000000000411070
word64 * g_ptr411078 = null; // 0000000000411078
...
<anonymous> * g_ptr411000 = &g_t4005C0; // 0000000000411000
<anonymous> * g_ptr411008 = &g_t4005C0; // 0000000000411008
<anonymous> * g_ptr411010 = &g_t4005C0; // 0000000000411010
<anonymous> * g_ptr411018 = &g_t4005C0; // 0000000000411018
<anonymous> * g_ptr411020 = &g_t4005C0; // 0000000000411020
<anonymous> * g_ptr411028 = &g_t4005C0; // 0000000000411028
<anonymous> * g_ptr411030 = &g_t4005C0; // 0000000000411030
<anonymous> * g_ptr411038 = &g_t4005C0; // 0000000000411038
<anonymous> * g_ptr411040 = &g_t4005C0; // 0000000000411040
// subject_init.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
<anonymous> g_t4005C0 = <code>; // 00000000004005C0
...
{
	struct Eq_130 * x8_25 = (&g_t411068)[(int64) w0 /64 8];
...
{
	struct Eq_171 * x8_25 = (&g_t411068)[(int64) w0 /64 8];
...
// 00000000004009B0: Register word32 move(Register Eq_208 w0, Register Eq_209 w2, Register out Eq_210 w21Out, Register out Eq_210 w22Out, Register out ptr64 x24Out, Register out (ptr64 (arr (ptr64 Eq_248))) x28Out, Register out ptr64 x29Out)
// Called from:
//      move
//      main
word32 move(Eq_208 w0, Eq_209 w2, union Eq_210 & w21Out, union Eq_210 & w22Out, ptr64 & x24Out, struct Eq_248 * (& x28Out, ptr64 & x29Out)
{
	Eq_208 w0 = (word32) x0;
	Eq_209 w2 = (word32) x2;
	...
	if (w0 != 0x00)
	{
		...
		do
		{
			struct Eq_248 * x28_90[];
			word32 w21_393;
			word32 w22_394;
			word64 x24_395;
			struct Eq_248 * x8_111 = x28_90[(int64) (word32) (uint64) move(w0, w2, out w21_393, out w22_394, out x24_395, out x28_90, out x29_100) /64 8].ptr0000;
			...
			struct Eq_248 * x8_148 = x28_90[x8_50].ptr0000;
	...
	struct Eq_225 * sp_210 = x29_100 - 0x50;
	ptr64 x29_213 = sp_210->ptr0050;
	word64 x20_217 = sp_210->qw0040;
	ptr64 x24_225 = sp_210->ptr0020;
	struct Eq_248 * (* x28_233)[] = sp_210->ptr0000;
	w21Out.u0 = <invalid>;
	w22Out.u0 = <invalid>;
	x24Out = x24_225;
	x28Out = x28_233;
	x29Out = x29_213;
	return (word32) x20_217;
}

// 0000000000400B30: void main(Register int32 w0, Register (ptr64 Eq_340) x1, Register word32 x2_32_32)
void main(int32 w0, struct Eq_340 * x1, word32 x2_32_32)
{
	word64 x19_55;
	fn0000000000400620();
...
l0000000000400B88:
			...
			g_dw411080 = w19_120;
			fn00000000004005F0();
			Eq_376 x0_79 = SEQ(x0_32_32_75, 0x01);
			*x0_79.t0000 = (Eq_376) ((word64) x0_79.t0000 + 16);
			...
			*x0_90 = x0_90 + 2;
			...
			g_ptr411078 = x0_98;
			*x0_98 = x0_98 + 2;
			Eq_376 x23_110 = x0_79;
			while (true)
			{
				int64 x8_113 = (int64) *((word64) x23_110.t0000 + 4);
				word32 x9_114[] = *x23_110.t0000;
				*((word64) x23_110.t0000 + 8) = (Eq_376) ((word32) x8_113 + 0x01);
				...
				if (w19_120 == 0x00)
					break;
				x23_110 = (Eq_376) g_t411068.t0000;
			}
			word32 w22_307;
			word64 x24_308;
			word64 x28_309;
			word64 x29_310;
			word32 w21_306;
			move(SEQ(x0_32_32_168, g_dw411080), SEQ(x2_32_32, 0x02), out w21_306, out w22_307, out x24_308, out x28_309, out x29_310);
			fn0000000000400660();
			fn0000000000400660();
			return;
		}
