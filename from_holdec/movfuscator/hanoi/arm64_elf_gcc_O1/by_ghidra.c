...
// WARNING: Removing unreachable block (ram,0x0010097c)
...

{
  ...
  puts("\x1b[H\x1b[J");
  if (1 < c) {
    lVar1 = strtol(v[1],(char **)0x0,10);
    height = (int)lVar1;
    if (0 < height) goto LAB_00100c88;
  }
  height = 8;
LAB_00100c88:
  lVar1 = 0;
  do {
    ptVar2 = new_tower(height);
    *(tower **)((long)t + lVar1) = ptVar2;
    lVar1 = lVar1 + 8;
    d = height;
  } while (lVar1 != 0x18);
  for (; d != 0; d = d + -1) {
