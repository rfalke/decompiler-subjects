...
struct Eq_129 * g_a12068[] = // 0000000000012068
	{
	};
...
struct Eq_129 * (* g_ptr11FA8)[] = &g_a12068; // 0000000000011FA8
...
int32 remove_disk(int32 w0)
{
	...
	int32 w19_22 = x5_18[(int64) (w3_19 - 0x01) /64 4];
	text(w19_22);
	return w19_22;
}

// 0000000000000BB8: Register word32 move(Register Eq_191 w0, Register out Eq_192 w21Out)
// Called from:
//      move
//      main
word32 move(Eq_191 w0, union Eq_192 & w21Out)
{
	Eq_191 w0 = (word32) x0;
	if (w0 != 0x00)
	{
		...
		word32 w21_194;
		add_disk((word32) (uint64) move(w0, out w21_194), (word32) (uint64) remove_disk((word32) x21_47));
		word32 w21_195;
		move(w0, out w21_195);
		w21Out.u0 = <invalid>;
		return (word32) x19;
...
// 0000000000000C28: void main(Register int32 w0, Register (ptr64 Eq_225) x1)
void main(int32 w0, struct Eq_225 * x1)
{
	fn00000000000008B0();
	if (w0 > 0x01)
	{
...
l0000000000000C88:
			...
			for (x19_44 = 0x00; x19_44 != 0x18; x19_44 += 0x08)
				x20_49[x19_44 /64 8].ptr0000 = new_tower();
			int32 w19_69;
			for (w19_69 = *g_ptr11FD0; w19_69 != 0x00; --w19_69)
				add_disk(0x00, w19_69);
			int32 * x0_96 = g_ptr11FD0;
			word32 w21_196;
			move(SEQ(SLICE(x0_96, word32, 32), *x0_96), out w21_196);
			text(0x01);
			return;
		}
	}
