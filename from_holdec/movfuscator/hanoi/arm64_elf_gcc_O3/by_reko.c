...
{
	struct Eq_291 * x3_31 = g_ptr11FA8[(int64) w0 / 8].t0000;
	word32 w5_34 = x3_31->dw0008;
	word32 x6_36[] = x3_31->ptr0000;
	x3_31->dw0008 = w5_34 - 0x01;
	word32 w22_41 = x6_36[(int64) (w5_34 - 0x01) / 4];
	fn00000000000008F0();
	if (w22_41 != 0x00)
	{
...
ptr64 move(int32 w0, ptr64 & x24Out, ptr64 & x26Out, struct Eq_89 & x28Out, struct Eq_90 & x29Out)
{
	...
	if (w0 != 0x00)
	{
		do
		{
			...
			word64 x26_464;
			Eq_334 x3_112 = (&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&x28_99->ptr0FA8[(int64) (word32) move(w24_17 - 0x01, out x24_89, out x26_464, out x28_99, out x29_86) / 8].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0];
			...
			word32 w19_122 = x6_116[(int64) (w5_114 - 0x01) / 4];
			fn00000000000008F0();
