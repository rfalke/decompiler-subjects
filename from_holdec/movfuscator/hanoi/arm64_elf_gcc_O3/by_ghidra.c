...

{
  ...
  puts("\x1b[H\x1b[J");
  if (1 < c) {
    lVar4 = strtol(v[1],(char **)0x0,10);
    height = (int)lVar4;
    if (0 < height) goto LAB_00100964;
  }
  height = 8;
LAB_00100964:
  iVar7 = height;
  ...
  lVar6 = (long)height;
  do {
    plVar5 = (long *)calloc(1,(lVar6 + 4) * 4);
    *(long **)((long)t + lVar4) = plVar5;
    lVar4 = lVar4 + 8;
  ...
  for (; iVar7 != 0; iVar7 = iVar7 + -1) {
    while( true ) {
      ...
      t[0]->n = iVar1 + 1;
      (*ppiVar2)[iVar1] = iVar7;
      printf("\x1b[%d;%dH",(ulong)((height - ptVar3->n) + 1),(ulong)(uint)((height + 1) - iVar7));
      iVar1 = iVar7;
      if (iVar7 != 0) break;
      iVar7 = -1;
      usleep(100000);
...
{
  printf("\x1b[%d;%dH",(ulong)((height - y) + 1),
         (ulong)(uint)((height + 1 + i * 2 * (height + 1)) - d));
  if (d != 0) {
    do {
      printf("%s",s);
      d = d + -1;
...

{
  ...
  ptVar2->n = iVar1 + 1;
  ptVar2->x[iVar1] = d;
  printf("\x1b[%d;%dH",(ulong)((height - ptVar2->n) + 1),
         (ulong)(uint)((height + 1 + i * 2 * (height + 1)) - d));
  if (d != 0) {
    do {
      printf("%s",&DAT_00101078);
...

{
  ...
  printf("\x1b[%d;%dH",(ulong)(iVar3 + 1),(ulong)(uint)((iVar1 + i * 2 * iVar1) - iVar2));
...

{
  ...
  if (param_1 != 0) {
    ...
    do {
      ...
      printf("\x1b[%d;%dH",(ulong)((iVar5 - iVar3) + 1),
             (ulong)(uint)((iVar2 + from * 2 * iVar2) - iVar4));
      ...
      printf("\x1b[%d;%dH",(ulong)((height - ptVar6->n) + 1),
             (ulong)(uint)((iVar1 + height * iVar1) - iVar4));
...

{
  ...
  if (n != 0) {
    ...
    do {
      ...
      iVar4 = ptVar6->x[iVar4];
      printf("\x1b[%d;%dH",(ulong)((iVar5 - iVar3) + 1),
             (ulong)(uint)((iVar2 + from_00 * 2 * iVar2) - iVar4));
      for (iVar2 = iVar4; iVar2 != 0; iVar2 = iVar2 + -1) {
        printf("%s",&DAT_00101080);
      }
      ptVar6 = t[to];
