...
int64_t g3 = 3056; // 0x11d90
int64_t g4 = 2984; // 0x11d98
int64_t g5 = 0; // 0x11da0
void (*g6)() = (void (*)())0x1040; // 0x11f90
int64_t g7 = 0; // 0x11f98
int64_t g8 = 0; // 0x11fa0
int64_t g10 = 0; // 0x11fb0
int32_t g11 = 0; // 0x11fb1
int64_t g12 = 0; // 0x11fb8
void (*g13)() = (void (*)())4040; // 0x11fc0
int64_t g14 = 2304; // 0x11fc8
int32_t g15 = 0x12080; // 0x11fd0
int32_t g16 = 0; // 0x11fd4
int64_t g17 = 0; // 0x11fd8
int64_t g18 = 2112; // 0x12000
int64_t g19 = 0; // 0x12060
int64_t g20 = 0; // 0x12067
int32_t * t[3]; // 0x12068
int32_t g21;
int32_t * (*g9)[3] = &t; // 0x11fa8
...
int main(int c, char ** v) {
    ...
    if (c < 2) {
        // 0xab4
        *(int32_t *)(int64_t)(uint32_t)g15 = 8;
        goto lab_0x964;
    } else {
        int32_t str_as_l = strtol((char *)*(int64_t *)((int64_t)v + 8), NULL, 10); // 0x950
        *(int32_t *)(int64_t)g15 = str_as_l;
        if (str_as_l < 1) {
            // 0xab4
            *(int32_t *)(int64_t)g15 = 8;
            goto lab_0x964;
        } else {
            goto lab_0x964;
        }
  ...
  lab_0x964:;
    int64_t v1 = 0; // 0x984
    int64_t * mem = calloc(1, (int32_t)(4 * (int64_t)&g16)); // 0x990
    int64_t v2 = (int64_t)mem; // 0x990
    *(int64_t *)(v1 + (int64_t)g9) = v2;
    int64_t v3 = v1 + 8; // 0x998
    *mem = v2 + 16;
    v1 = v3;
    while (v3 != 24) {
        // 0x988
        mem = calloc(1, (int32_t)(4 * (int64_t)&g16));
        v2 = (int64_t)mem;
        *(int64_t *)(v1 + (int64_t)g9) = v2;
        v3 = v1 + 8;
        *mem = v2 + 16;
    ...
    int32_t v4 = g10; // 0x9d8
    int64_t v5 = g15; // 0x9d8
    while (true) {
        int64_t v6 = v5;
        *(int32_t *)&g10 = (int32_t)&g11;
        *(int32_t *)((int64_t)g9 + (int64_t)(4 * v4)) = (int32_t)v6;
        printf((char *)&g1);
        int64_t v7 = v6; // 0xa14
        int64_t v8; // 0x900
        if (v6 == 0) {
            // 0xac8
            usleep(0x186a0);
            fflush((struct _IO_FILE *)*(int64_t *)g10);
            v8 = 0xffffffff;
        } else {
            int64_t v9 = v7;
            printf("%s", "==");
...
int64_t _start(int64_t a1) {
    ...
    int64_t v1; // 0xae4
    int64_t v2; // 0xae4
    __libc_start_main(g14, (int32_t)a1, (char **)&v1, g13, g6, (void (*)())v2);
    abort();
    return &g21;
}
...
int64_t call_weak_fn(void) {
    ...
    // 0xb28
    return function_890(g12);
}

// Address range: 0xb30 - 0xb64
int64_t deregister_tm_clones(void) {
    if ((int64_t)&g20 - (int64_t)&g19 == 14 || (uint64_t)((int64_t)&g20 - (int64_t)&g19) < 14 || g7 == 0) {
        // 0xb60
        return &g19;
    }
    // 0xb5c
    return _ITM_deregisterTMCloneTable(&g19, g7);
}
...
int64_t __do_global_dtors_aux(void) {
    unsigned char result = *(char *)&g19; // 0xbb8
    if (result != 0) {
        // 0xbe4
        return result;
    }
    ...
    if (g8 != 0) {
        // 0xbcc
        function_860(*(int64_t *)((int64_t)&g18 + 88));
    }
    // 0xbd8
...
int64_t frame_dummy(void) {
    ...
    // 0xc14
    return _Jv_RegisterClasses(&g5, g17);
}
...
int64_t text(void) {
    int32_t chars_printed = printf((char *)&g1); // 0xca0
    int64_t v1; // 0xc58
    if ((int32_t)v1 == 0) {
        // 0xcc0
    ...
    chars_printed = printf("%s", (char *)v1);
    // 0xcac
    while ((int32_t)v3 != 1) {
        // 0xcac
        v3 = v2;
...
int64_t add_disk(void) {
    // 0xcd0
    int64_t v1; // 0xcd0
    int64_t v2 = *(int64_t *)((8 * v1 & 0xfffffff8) + (int64_t)g9); // 0xd00
    ...
    *(int32_t *)(*(int64_t *)v2 + (int64_t)(4 * v4)) = v5;
    ...
    if (v5 == 0) {
        // 0xd64
        usleep(0x186a0);
        return fflush((struct _IO_FILE *)*(int64_t *)g10);
    }
    int64_t v6; // 0xcd0
    int64_t v7 = v6;
    printf("%s", "==");
...
int64_t remove_disk(void) {
    // 0xd90
    int64_t v1; // 0xd90
    int64_t v2 = *(int64_t *)((8 * v1 & 0xfffffff8) + (int64_t)g9); // 0xdc0
...
void move(uint32_t n, uint32_t from, int32_t to, uint32_t via) {
    ...
    int64_t v5 = *(int64_t *)((8 * v2 & 0xfffffff8) + (int64_t)g9); // 0xec0
    ...
    *v6 = v7;
    ...
    int64_t v12 = *(int64_t *)(8 * (int64_t)to + (int64_t)g9); // 0xf2c
    ...
    *(int32_t *)(*(int64_t *)v12 + (int64_t)(4 * v14)) = v8;
    ...
    while (v4 != 0) {
        ...
        v4 = v3;
        move(v4, (int32_t)v2, (int32_t)v1, to);
        v5 = *(int64_t *)((8 * v2 & 0xfffffff8) + (int64_t)g9);
        v6 = (int32_t *)(v5 + 8);
        v7 = *v6 - 1;
        *v6 = v7;
        ...
        // 0xf10
        v12 = *(int64_t *)(8 * (int64_t)to + (int64_t)g9);
        v13 = (int32_t *)(v12 + 8);
        v14 = *v13;
        *v13 = v14 + 1;
        *(int32_t *)(*(int64_t *)v12 + (int64_t)(4 * v14)) = v8;
