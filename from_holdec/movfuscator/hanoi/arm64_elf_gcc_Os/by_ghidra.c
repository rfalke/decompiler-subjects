...

{
  ...
  puts("\x1b[H\x1b[J");
  if ((c < 2) || (height = atoi(v[1]), height < 1)) {
    height = 8;
  }
  lVar2 = 0;
  do {
...
// WARNING: Removing unreachable block (ram,0x00100a5c)
...
// WARNING: Removing unreachable block (ram,0x00100a8c)
// WARNING: Removing unreachable block (ram,0x00100a98)
...
// WARNING: Removing unreachable block (ram,0x00100b14)
...

{
  ...
  while (from_00 = from, n != 0) {
    n = n + -1;
    move(n,from_00,via,to);
    d = remove_disk(from_00);
    add_disk(to,d);
    from = via;
    via = from_00;
  }
