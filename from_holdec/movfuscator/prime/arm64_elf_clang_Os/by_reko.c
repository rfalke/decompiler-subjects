...
void is_prime(int32 w0)
{
	...
	if (w0 != 0x02 && w0 >= 0x04)
	{
		...
		do
		{
			if (w0 - (w0 / w8_33) * w8_33 == 0x00)
				return;
			++w8_33;
		} while (w8_33 * w8_33 <= w0);
	}
}

// 00000000004006C8: void main(Stack word64 qwArg00)
void main(word64 qwArg00)
{
	...
	do
	{
		...
		if (w8_88 != 0x02 && w8_88 >= 0x04)
		{
			int32 w8_78 = 0x02;
			do
			{
				if (w8_88 - (w8_88 / w8_78) * w8_78 == 0x00)
					goto l0000000000400740;
				++w8_78;
			} while (w8_78 * w8_78 <= w8_88);
		}
		fn0000000000400510();
l0000000000400740:
		w8_24 = w8_88 + 0x01;
