...

{
  ...
  if (in_w0 == 1) {
    ...
    for (local_c = 2; local_c * local_c <= in_w0; local_c = local_c + 1) {
      iVar1 = 0;
      if (local_c != 0) {
        iVar1 = in_w0 / local_c;
      }
      if (in_w0 == iVar1 * local_c) {
        return 0;
      }
    }
    local_4 = 1;
...

{
  ...
  for (local_18 = 1; (int)local_18 < 10000; local_18 = local_18 + 1) {
    iVar1 = is_prime(in_stack_ffffffffffffffd8);
    if (iVar1 != 0) {
