...
void main()
{
	x0_12 = (uint64) puts("primes, 1-100000: ");
	int32 dwArg04_64;
	for (dwArg04_64 = 0x01; dwArg04_64 <= 9999; ++dwArg04_64)
	{
		if (is_prime(dwArg04_64) != 0x00)
			x0_37 = (uint64) printf("%d ", dwArg04_64);
	}
	x0_51 = (uint64) putchar(0x0A);
}
