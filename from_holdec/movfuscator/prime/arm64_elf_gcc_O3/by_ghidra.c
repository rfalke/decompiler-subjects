...
LAB_001007ec:
        ...
        do {
          iVar2 = iVar2 + 1;
          if ((int)uVar3 < iVar2 * iVar2) goto LAB_001007ec;
          iVar1 = 0;
          if (iVar2 != 0) {
            iVar1 = (int)uVar3 / iVar2;
          }
        } while (uVar3 != iVar1 * iVar2);
      }
      if (iVar4 == 10000) {
        putchar(10);
        return 0;
...
void FUN_001009cc(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x001009cc. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x1009cc);
