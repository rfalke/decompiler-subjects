...
int64_t __do_global_dtors_aux(void) {
    ...
    if (g13 != 0) {
        // 0xf1c
        v1 = function_d50(*(int64_t *)((int64_t)&g40 + 128));
    }
    // 0xf28
...
int32_t av(void) {
    ...
    *(int32_t *)(int64_t)g27 = g33;
    ...
    if (am() != 0) {
        ...
        *(int32_t *)(int64_t)g27 = v5;
        ...
        if (*(int32_t *)(int64_t)v5 == 1) {
            // 0x12e8
            *g11 = *(int32_t *)((0x100000000 * v6 + 0x400000000) / 0x100000000);
            *g39 = g33;
            w();
            result2 = av();
        }
    ...
    unsigned char v12 = *(char *)(v11 / 0x100000000); // 0x1434
    while (v12 != 0) {
        unsigned char v13 = *(char *)(0x100000000 * v10 / 0x100000000); // 0x1440
        *v7 = 0;
        int64_t v14 = (int64_t)*(char *)((v11 + 0x200000000) / 0x100000000) + 0xffffff9e; // 0x1458
        ...
        *v7 = (int32_t)v16 + 64 + 64 * g22;
        int64_t v17 = (int64_t)*(char *)((v11 + 0x300000000) / 0x100000000) + 0xffffff9e; // 0x1480
...
int32_t aw(int32_t d) {
    ...
    *(char *)(int64_t)g15 = (char)d;
    ...
    int32_t v2 = result;
    *v1 = (int32_t)&g16;
    *(char *)(int64_t)g15 = (char)v2;
    int32_t result2 = v2 / 256; // 0x14dc
...
int32_t ap(int32_t a, uint32_t z) {
    ...
    if (*(char *)((0x100000000 * v2 - 0x100000000) / 0x100000000) == 5) {
        // 0x15a4
...
int32_t W(int32_t s, uint32_t a) {
    ...
    if (v2 == 0 || v2 > 511) {
        int32_t * v3 = (int32_t *)((0x100000000 * (int64_t)a + 0x400000000) / 0x100000000); // 0x17a8
...
int32_t ab(int32_t s) {
    ...
    if (v1 == 34) {
        ...
        // 0x196c
        *(char *)(0x100000000 * (int64_t)g29 / 0x100000000) = 0;
        *g29 = (int32_t)&g32;
        w();
        av();
        v7 = v2;
  ...
  lab_0x1c74:
    ...
    goto lab_0x1c88;
  lab_0x1bc8:;
    int32_t * v22 = (int32_t *)((0x100000000 * v10 + 0x400000000) / 0x100000000); // 0x1bd0
    *v22 = x(232, *v22);
    v19 = v5;
    goto lab_0x1c88;
  lab_0x1c88:
...
int32_t ae(int32_t s) {
    ...
    while (true) {
        ...
        int64_t v3 = 0x100000000 * v1 / 0x100000000; // 0x2334
        ...
        if (*(char *)v3 != 32) {
            ...
            if (v2 < v7) {
                ...
                v6 = v5 & 0xffffffff;
                v4 = v6;
                while (*(char *)(0x100000000 * v5 / 0x100000000) != 32 == v6 < v7) {
                    // 0x2358
                    v5 = v6 + 1;
                    v6 = v5 & 0xffffffff;
                    v4 = v6;
            ...
            *(int32_t *)(int64_t)g27 = v13;
            ...
            if (v14 != 1 && v15 != 0) {
                if (v14 == 0) {
                    ...
                    // 0x22bc
                    memcpy((int64_t *)(0x100000000 * (int64_t)g29 / 0x100000000), (int64_t *)v3, v10 - v11);
...
int main(int d, char ** a) {
    if (d < 3) {
        ...
        *g26 = (int32_t)v1;
        int64_t v2 = 0x100000000 * v1 / 0x100000000; // 0x28e4
        ...
        *g8 = (int32_t)(int64_t)calloc(1, 0x1869f);
        ...
        int32_t file_path = *(int32_t *)((v5 + 0x400000000) / 0x100000000); // 0x298c
        struct _IO_FILE * file = fopen((char *)(int64_t)file_path, "r"); // 0x2990
        ...
        *v4 = (int32_t)&g20;
        ...
        av();
        ar(0);
        au(*(int32_t *)((v5 + 0x800000000) / 0x100000000));
    }
    // 0x29f4
    return 0;
}
