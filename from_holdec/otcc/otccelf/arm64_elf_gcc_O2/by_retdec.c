...
int64_t __do_global_dtors_aux(void) {
    ...
    if (g14 != 0) {
        // 0x109c
        v1 = function_d50(*(int64_t *)((int64_t)&g55 + 128));
    }
    // 0x10a8
...
int32_t av(void) {
        ...
        if ((isspace(g45) || (int32_t)(g45 == 35)) != 0) {
            ...
            if (g45 == 35) {
                ...
                if (g45 != 10) {
                    // 0x1428
                    *g6 = (int32_t)&g7;
                    *(char *)(0x100000000 * v8 / 0x100000000) = (char)g45;
                    w((int64_t)&g60);
                    if (g45 != 10) {
                        *g6 = (int32_t)&g7;
        ...
        *v3 = c;
        if ((isalnum(c) || (int32_t)(c == 95)) == 0) {
            ...
            *v19 = v20;
            ...
            // 0x13d0
            *g12 = *(int32_t *)((0x100000000 * v21 + 0x400000000) / 0x100000000);
            *g54 = g45;
            w((int64_t)&g60);
            goto lab_0x125c_2;
        }
  ...
  lab_0x15d8:;
    ...
    int64_t v23 = v22 / 0x100000000; // 0x15d8
    ...
    if (v24 == 0) {
        ...
        *v1 = 0;
        int64_t v27 = (int64_t)*(char *)((v22 + 0x200000000) / 0x100000000) + 0xffffff9e; // 0x1604
  ...
  lab_0x1610:;
    int64_t v29 = (v22 + 0x400000000) / 0x100000000; // 0x1618
    *v1 = (int32_t)v26 + 64;
...
int64_t ao(void) {
    ...
    unsigned char v4 = *(char *)((v3 + 0x200000000) / 0x100000000); // 0x1748
    unsigned char v5 = *(char *)((v3 + 0x100000000) / 0x100000000); // 0x174c
    unsigned char v6 = *(char *)((v3 + 0x300000000) / 0x100000000); // 0x1750
...
int64_t W(int64_t a1) {
    ...
    if (v2 == -131 || v2 == -132) {
        ...
        *(char *)(int64_t)g16 = (char)v5;
        int32_t v7 = v5; // 0x1aa4
        if (v7 >= 0xffffff01 == v7 >= 256) {
            int32_t v8 = v7 / 256;
            *v6 = (int32_t)&g17;
            *(char *)(int64_t)g16 = (char)v8;
            int32_t v9 = v8; // 0x1ab0
            while (v8 >= 0xffffff01 == v8 >= 256) {
                // 0x1a90
                v8 = v9 / 256;
                *v6 = (int32_t)&g17;
                *(char *)(int64_t)g16 = (char)v8;
    ...
    if (v10 == 0 || v10 > 511) {
        int32_t * v11 = (int32_t *)((0x100000000 * v4 + 0x400000000) / 0x100000000); // 0x1adc
...
int32_t ab(int32_t s) {
    ...
    if (v1 == 34) {
        ...
        // 0x1f10
        *(char *)(0x100000000 * g37 / 0x100000000) = 0;
            ...
            if (g8 == 2) {
                ...
                if (v1 == 33) {
                    ...
                    if ((int32_t)&g26 == 1 || (int32_t)&g26 < 1) {
                        ...
                        int32_t * v16 = (int32_t *)(int64_t)g16; // 0x204c
                        *v16 = (int32_t)&g17;
                        *(char *)(int64_t)g16 = (char)v15;
                        v8 = v2;
                        if (v15 >= 0xffffff01 == v15 >= 256) {
                            int32_t v17 = v15 / 256;
                            *v16 = (int32_t)&g17;
                            *(char *)(int64_t)g16 = (char)v17;
                            int32_t v18 = v17; // 0x2060
                            v8 = v2;
                            while (v17 >= 0xffffff01 == v17 >= 256) {
                                // 0x2040
                                v17 = v18 / 256;
                                *v16 = (int32_t)&g17;
                                *(char *)(int64_t)g16 = (char)v17;
                        ...
                        if (((int32_t)(g35 == 61) & s) == 0) {
                            ...
                            if (g35 == 40) {
                                ...
                                if (g8 == 11) {
                                    ...
                                    int64_t v21; // 0x1ce8
                                    if ((int32_t)&g26 != 1 && (int32_t)&g26 >= 1) {
                                        int32_t v22 = g25; // 0x21e8
                                        int32_t * v23 = (int32_t *)(int64_t)g16; // 0x220c
                                        *v23 = (int32_t)&g17;
                                        *(char *)(int64_t)g16 = (char)v22;
                                        v21 = (int64_t)&g17;
                                        if (v22 >= 0xffffff01 == v22 >= 256) {
                                            int32_t v24 = v22 / 256;
                                            *v23 = (int32_t)&g17;
                                            *(char *)(int64_t)g16 = (char)v24;
                                            int32_t v25 = v24; // 0x2220
                                            v21 = (int64_t)&g17;
                                            while (v24 >= 0xffffff01 == v24 >= 256) {
                                                // 0x2200
                                                v24 = v25 / 256;
                                                *v23 = (int32_t)&g17;
                                                *(char *)(int64_t)g16 = (char)v24;
  ...
  lab_0x1da4:;
    ...
    *(char *)((v39 + 0x100000000) / 0x100000000) = v33;
    *(char *)((v39 + 0x200000000) / 0x100000000) = v32;
    *(char *)((v39 + 0x300000000) / 0x100000000) = v31;
    av();
    if (v10 != 0) {
        // 0x1e58
    ...
    int32_t * v40 = (int32_t *)((0x100000000 * v6 + 0x400000000) / 0x100000000); // 0x1f6c
    *v40 = x(232, *v40);
    if (v35 == 0) {
        // 0x1f44
        return 0;
...
int64_t ax(void) {
    ...
    *(char *)(0x100000000 * g37 / 0x100000000) = (char)v1;
...
int32_t ae(int32_t s) {
    ...
    while (true) {
      lab_0x29b8_2:;
        ...
        int64_t v16 = 0x100000000 * v14 / 0x100000000; // 0x29bc
    ...
    *(int32_t *)(int64_t)(uint32_t)g35 = v31;
    ...
    if (v32 == 0 || v33 == 1) {
        ...
        if (v33 == 0) {
            if (s == 0) {
                // 0x2bf4
                memcpy((int64_t *)(0x100000000 * g37 / 0x100000000), (int64_t *)v28, v25 - v29);
                *(int32_t *)g37 = v25 + 1 - v29 + *(int32_t *)&g37;
                ...
                if (s == 1) {
                    ...
                    *(char *)(0x100000000 * g37 / 0x100000000) = (char)v35;
                    ...
                    *v37 = (int32_t)&g41;
                    ...
                    char v41 = *(char *)((v40 - 0x100000000) / 0x100000000); // 0x2a98
                    char * v42 = (char *)((v40 + 0x200000000) / 0x100000000); // 0x2a9c
                    unsigned char v43 = *v42; // 0x2a9c
                    char * v44 = (char *)((v40 + 0x300000000) / 0x100000000); // 0x2aa4
                    unsigned char v45 = *v44; // 0x2aa4
                    char * v46 = (char *)(v40 / 0x100000000); // 0x2aac
                    unsigned char v47 = *v46; // 0x2aac
                    uint64_t v48 = (int64_t)(v41 != 5); // 0x2ab0
                    char * v49 = (char *)((v40 + 0x100000000) / 0x100000000); // 0x2ab4
                    ...
                    *(int32_t *)g37 = (int32_t)&g41;
                    while (v55 != 0) {
                        ...
                        v39 = v55;
                        v40 = 0x100000000 * v39;
                        v41 = *(char *)((v40 - 0x100000000) / 0x100000000);
                        v42 = (char *)((v40 + 0x200000000) / 0x100000000);
                        v43 = *v42;
                        v44 = (char *)((v40 + 0x300000000) / 0x100000000);
                        v45 = *v44;
                        v46 = (char *)(v40 / 0x100000000);
                        v47 = *v46;
                        v48 = (int64_t)(v41 != 5);
                        v49 = (char *)((v40 + 0x100000000) / 0x100000000);
                        v50 = *v49;
  ...
  lab_0x2ba0:;
    ...
    int64_t v69 = 0x100000000 * v67 / 0x100000000; // 0x2ba4
