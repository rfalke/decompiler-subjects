...
Eq_148 g_t1206C = // 000000000001206C
	{
		0
	};
// subject_fini.c
...
union Eq_148 * g_ptr11FA0 = &g_t1206C; // 0000000000011FA0
...
void main(Eq_199 w0, word32 w1, word64 x21)
{
	...
	if (w0 <= 0x03)
	{
		int32 w0_27 = null[(int64) (w1 + 0x04) /64 4];
		fn0000000000000880();
		*g_ptr11FA0 = (union Eq_148 *) 0x0A;
		if (w0 > 0x02)
		{
			Eq_148 w0_39 = null[(int64) (w1 + 0x08) /64 4];
			fn0000000000000880();
