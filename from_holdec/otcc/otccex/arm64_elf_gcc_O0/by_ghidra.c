...
// WARNING: Removing unreachable block (ram,0x00100968)
...
// WARNING: Removing unreachable block (ram,0x00100990)
// WARNING: Removing unreachable block (ram,0x0010099c)
...
// WARNING: Removing unreachable block (ram,0x001009cc)
...

{
  ...
  while (p != iVar2) {
    p = p + -1;
    putchar((uint)*(byte *)(longlong)p);
  }
  free((void *)(longlong)iVar2);
  return iVar2;
}
...

{
  ...
  if ((argc == 2) || (argc == 3)) {
    n_00 = atoi((char *)(ulonglong)*(uint *)(longlong)(argv + 4));
    base = 10;
    if ((2 < argc) &&
       ((base = atoi((char *)(ulonglong)*(uint *)(longlong)(argv + 8)), base < 2 || (0x24 < base))))
    {
      fwrite("Invalid base\n",1,0xd,stderr);
      return 1;
    }
    printf("fib(%d) = ",(ulonglong)n_00);
    n_01 = fib(n_00);
    print_num(n_01,base);
    putchar(10);
    printf("fact(%d) = ",(ulonglong)n_00);
    if ((int)n_00 < 0xd) {
      n_01 = fact(n_00);
      print_num(n_01,base);
    }
