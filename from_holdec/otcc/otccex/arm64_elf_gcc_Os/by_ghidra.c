...

{
  ...
  if (argc - 2U < 2) {
    ...
    base = 10;
    if (argc == 3) {
      base = atoi((char *)(ulonglong)*(uint *)(longlong)(argv + 8));
      if (0x22 < base - 2U) {
        fputs("Invalid base\n",stderr);
        goto LAB_0010093c;
      }
...

{
  ...
  uVar3 = iVar5 - (int)pvVar6;
  pbVar8 = (byte *)((longlong)iVar5 + -1);
  while (pbVar8 != (byte *)((longlong)iVar5 + -1) + -(ulonglong)uVar3) {
    putchar((uint)*pbVar8);
    pbVar8 = pbVar8 + -1;
  }
  iVar5 = iVar5 - uVar3;
  free((void *)(longlong)iVar5);
  return iVar5;
}
