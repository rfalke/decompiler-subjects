...
// 0000000000001628: Register word32 s(Register Eq_110 w1, Register out (ptr64 Eq_871) x29Out)
// Called from:
//      H
//      B
//      S
...
//      T
//      ab
word32 s(Eq_110 w1, struct Eq_871 & x29Out)
{
	ae();
...
{
	word64 x29_32;
	return (word32) (uint64) s(w0, out x29_32);
}

// 00000000000016D8: Register word32 S(Register Eq_110 w1)
// Called from:
//      O
//      U
word32 S(Eq_110 w1)
{
	ae();
	word64 x29_45;
	return (word32) (uint64) s(w1, out x29_45);
}
...
word64 T(ui32 w0)
{
	...
	else
	{
		...
		{
			Eq_110 w0_59 = null[(int64) dwLoc1C /64 4];
	...
	if (*g_ptr12F50 == 0x28)
	{
		if (x29_147->t003C == 0x01)
			ae();
		struct Eq_1072 * x29_553;
		x29_553->dw0030 = (word32) (uint64) s(0x00, out x29_553);
		ad();
		...
		struct Eq_1133 * x29_655;
		null[(int64) x29_553->dw0018 /64 4] = x29_553->t002C;
		ad();
		if (x29_553->dw003C == 0x00)
		{
			x29_553->dw0038 += 0x04;
			null[(int64) x29_553->dw001C /64 4] = (word32) (uint64) s(null[(int64) x29_553->dw001C /64 4], out x29_655);
		}
...
word64 O(int32 w0)
{
	...
	{
		struct Eq_233 * x29_119 = O(w0 - 0x01);
		...
		while (x29_119->dw001C == *g_ptr12F98)
		{
			...
			{
				x29_119->t0028 = (word32) (uint64) S(x29_119->t0028);
...
// 0000000000001DE4: Register word32 U(Register out ptr64 x29Out)
// Called from:
//      I
...
// 0000000000001E04: Register word64 I(Register word64 x19, Register out (ptr64 Eq_1550) x29Out)
// Called from:
//      I
//      ab
word64 I(word64 x19, struct Eq_1550 & x29Out)
{
	struct Eq_1551 * x29_228 = fp + -56;
	int32 dwLoc22_481 = SEQ(wLoc20, SLICE(x19, word16, 48));
	if (*g_ptr12F50 == 288)
	{
		ad();
		ad();
		struct Eq_1595 * x29_377;
		x29_377->dw0034 = (word32) (uint64) U(out x29_377);
		ad();
		struct Eq_1607 * x29_396;
		word64 x19_398 = I(x19, out x29_396);
		if (*g_ptr12F50 == 0x0138)
		{
			ad();
			x29_396->dw003C = (word32) (uint64) B(0x00);
			A(x29_396->t0034);
			struct Eq_1640 * x29_447;
	...
	else if ((uint32) (uint8) ((uint32) (uint8) (word32) (*g_ptr12F50 == 0x0160) | (uint32) ((uint8) ((word32) (*g_ptr12F50 == 0x01F8)))) != 0x00)
	{
		...
		if (w0_174 == 0x0160)
		{
			struct Eq_1677 * x29_295;
			x29_295->dw0034 = (word32) (uint64) U(out x29_295);
		}
		else
		{
			if (*g_ptr12F50 != 0x3B)
			...
			ad();
			if (*g_ptr12F50 != 0x3B)
				x29_228->dw0034 = (word32) (uint64) U(out x29_228);
			ad();
			if (*g_ptr12F50 != 0x29)
			{
				x29_228->t0038 = (word32) (uint64) B(0x00);
				w();
	...
	else if (*g_ptr12F50 == 0x7B)
	{
		...
		word64 x29_534;
		word64 x30_535;
		word64 x19_135 = ab(out x29_534, out x30_535);
	...
	else
	{
		if (*g_ptr12F50 == 448)
		{
			...
			if (*g_ptr12F50 != 0x3B)
				w();
			*g_ptr12FB0 = (union Eq_110 *) (word32) (uint64) B(*g_ptr12FB0);
		}
		else if (*g_ptr12F50 == 400)
		{
			ad();
			null[(int64) dwLoc22_481 /64 4] = (word32) (uint64) B(null[(int64) dwLoc22_481 /64 4]);
		}
		else if (*g_ptr12F50 != 0x3B)
			w();
		ad();
	}
	x29Out = (struct Eq_1550 *) <invalid>;
	return qwLoc30;
}
...
word64 ab(ptr64 & x29Out, ptr64 & x30Out)
{
	...
	struct Eq_1869 * x29_170 = fp + -40;
	while (true)
	{
		Eq_110 w0_23 = *g_ptr12F50;
		struct Eq_1877 * sp_293 = SEQ(sp_32_32_288, (word32) w0_23 + 1);
		...
		else
		{
			...
			while (*g_ptr12F50 != 0x29)
			{
				null[(int64) *g_ptr12F50 /64 4] = x29_170->dw002C;
				x29_170->dw002C += 0x04;
				ad();
				if (*g_ptr12F50 == 44)
					ad();
			...
			*g_ptr12FB0 = *g_ptr12FA0;
			ae();
			struct Eq_2031 * x29_160;
			x29_160->dw002C = (word32) (uint64) s(0x00, out x29_160);
			I(x19, out x29_170);
			A(*g_ptr12FB0);
			ae();
			null[(int64) x29_170->dw0016 /64 4] = *g_ptr12FA0;
			word64 sp_156 = <invalid>;
...
void main(int32 w0)
{
	*g_ptr12FC0 = *g_ptr12F78;
	if (w0 > 0x01)
	{
		word32 w0_41 = (word32) (int64) null[(int64) dwLoc0C /64 4];
		fn0000000000000C60();
		*g_ptr12FC0 = w0_41;
	}
	fn0000000000000CB0();
	*g_ptr12F40 = 0x01;
	struct Eq_2156 * x0_60 = (int64) *g_ptr12F40;
	...
	*g_ptr12F38 = 0x01;
	...
	<anonymous> * x0_174 = (int64) null[(int64) (*g_ptr12F38 + 0x0250) /64 4];
	word64 x2_185;
	x0_174();
}
