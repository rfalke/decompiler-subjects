...

{
  ...
  iVar1 = 0;
  for (uVar2 = 0x7ec2ad4f; (uVar2 & 1) == 0; uVar2 = uVar2 >> 1 | 0x80000000) {
    iVar1 = iVar1 + 1;
  }
  return iVar1;
}
...
// WARNING: Removing unreachable block (ram,0x08049415)
...

{
  ...
  for (uVar1 = 0x1e23872e; (uVar1 & 1) == 0; uVar1 = uVar1 >> 1 | 0x80000000) {
  }
  return 0;
}
