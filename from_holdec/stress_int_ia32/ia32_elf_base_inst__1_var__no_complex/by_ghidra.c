...

{
  ...
  return ((uint)(ushort)(CONCAT11(in_AF << 4 | in_PF << 2,0xd0) | 0x300) | 0x38be0000) + 0xc741fc30;
}
...

{
  ...
  return CONCAT31(0x35e764,in_PF) + -0x35e76401;
}
...

{
  ...
  return CONCAT31(0x7a4867,!in_PF) + -0x7a486701;
}
