...
void fun_8049087(int32_t ecx) {
    int32_t ebp2;

    fun_8049040("0x%08x: eip\n", __return_address());
    goto *reinterpret_cast<int32_t*>(*reinterpret_cast<int32_t*>(ebp2 - 4) - 4);
}
...
void fun_80490a2() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    ebx7 = ebx8 + 0x2f4c;
    fun_8049050(main, *reinterpret_cast<int16_t*>(&v1), esp3, ebx7 - 0x2e40, ebx7 - 0x2de0, edx5, v4, eax6);
    __asm__("hlt ");
}
...
void fun_80491c2() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    if (esi7) {
        ...
        esi9 = esi7;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi8 * 4 - 0xf4)(*reinterpret_cast<int32_t*>(&v1), *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(&v1) + 4), ebp5, 0x80491df);
            ++edi8;
        } while (esi9 != edi8);
    }
    goto *reinterpret_cast<int32_t*>(&v1);
...
void main() {
    fun_8049040("0x%08x: address of main\n", main);
    fun_8049087(main);
}
