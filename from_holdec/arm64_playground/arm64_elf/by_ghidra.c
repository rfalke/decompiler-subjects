...
{
  return (int)(dest & 0xfffffe00U | src & 0x1ffU);
}
...
{
  return (int)(dest & 0xfffffe00U | (uint)src >> 5 & 0x1ff);
}
...
{
  return (int)(dest & 0xffffc000U | dest & 0x1fU | (src & 0x1ffU) << 5);
}
