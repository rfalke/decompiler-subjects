...

{
  ...
  case 0:
    while( true ) {
      ...
      from = from + 1;
      *to = sVar2;
switchD_00100928_caseD_3:
      sVar2 = *from;
      psVar4 = psVar3 + 1;
      from = from + 1;
      *psVar3 = sVar2;
switchD_00100928_caseD_2:
      sVar2 = *from;
      to = psVar4 + 1;
      from = from + 1;
      *psVar4 = sVar2;
switchD_00100928_caseD_1:
      iVar5 = iVar5 + -1;
      *to = *from;
      if (iVar5 < 1) break;
      to = to + 1;
    ...
    break;
  case 1:
    goto switchD_00100928_caseD_1;
  case 2:
    goto switchD_00100928_caseD_2;
  case 3:
    goto switchD_00100928_caseD_3;
  }
  return;
}
...

{
  ...
  case 0:
    while( true ) {
      ...
      from = from + 1;
      *to = sVar2;
switchD_001009b8_caseD_7:
      sVar2 = *from;
      psVar3 = psVar4 + 1;
      from = from + 1;
      *psVar4 = sVar2;
switchD_001009b8_caseD_6:
      sVar2 = *from;
      to = psVar3 + 1;
      from = from + 1;
      *psVar3 = sVar2;
switchD_001009b8_caseD_5:
      sVar2 = *from;
      psVar4 = to + 1;
      from = from + 1;
      *to = sVar2;
switchD_001009b8_caseD_4:
      sVar2 = *from;
      to = psVar4 + 1;
      from = from + 1;
      *psVar4 = sVar2;
switchD_001009b8_caseD_3:
      sVar2 = *from;
      psVar4 = to + 1;
      from = from + 1;
      *to = sVar2;
switchD_001009b8_caseD_2:
      sVar2 = *from;
      to = psVar4 + 1;
      from = from + 1;
      *psVar4 = sVar2;
switchD_001009b8_caseD_1:
      iVar5 = iVar5 + -1;
      *to = *from;
      if (iVar5 < 1) break;
      to = to + 1;
    ...
    break;
  case 1:
    goto switchD_001009b8_caseD_1;
  case 2:
    goto switchD_001009b8_caseD_2;
  case 3:
    goto switchD_001009b8_caseD_3;
  case 4:
    goto switchD_001009b8_caseD_4;
  case 5:
    goto switchD_001009b8_caseD_5;
  case 6:
    goto switchD_001009b8_caseD_6;
  case 7:
    goto switchD_001009b8_caseD_7;
  }
  return;
}
