  ...
  case 0:
    while( true ) {
      *to = *from;
      from = from + 1;
      to = to + 1;
switchD_001008b4_caseD_3:
      *to = *from;
      from = from + 1;
      to = to + 1;
switchD_001008b4_caseD_2:
      *to = *from;
      from = from + 1;
      to = to + 1;
LAB_001008d8:
  ...
  case 1:
    goto LAB_001008d8;
  case 2:
    goto switchD_001008b4_caseD_2;
  case 3:
    goto switchD_001008b4_caseD_3;
  }
  return;
}
  ...
  case 0:
    while( true ) {
      *to = *from;
      from = from + 1;
      to = to + 1;
switchD_00100954_caseD_7:
      *to = *from;
      from = from + 1;
      to = to + 1;
switchD_00100954_caseD_6:
      *to = *from;
      psVar2 = to + 1;
      psVar4 = from + 1;
LAB_00100978:
...
LAB_001009b8:
  ...
  case 1:
    goto LAB_001009b8;
  case 2:
    goto switchD_00100954_caseD_2;
  case 3:
    psVar2 = to;
    psVar4 = from;
    goto LAB_00100998;
  case 4:
    goto switchD_00100954_caseD_4;
  case 5:
    psVar2 = to;
    psVar4 = from;
    goto LAB_00100978;
  case 6:
    goto switchD_00100954_caseD_6;
  case 7:
    goto switchD_00100954_caseD_7;
  }
  return;
}
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x100c04);
