...
Eq_170 g_t0CB8 = // 0000000000000CB8
	{
		
		{
		},
	};
Eq_256 g_t0CBC = // 0000000000000CBC
	{
		
		{
		},
	};
Eq_526 g_t0CC4 = // 0000000000000CC4
	{
...
l0000000000000A00:
				*x2_24 = (word16) w4_26;
				struct Eq_280 * x1_38 = x1 + 1;
				x0->w0000 = (word16) (word32) x1_38->w0000;
				struct Eq_291 * x4_48 = x0 + 1;
...
void copy2_eight_times(ptr64 x0, int16 * x1, int32 w2)
{
	if (w2 > 0x00)
	{
		...
		do
		{
			...
			struct Eq_443 * x0_20 = x0 + 0x02;
			x0_20->wFFFFFFFC = (word16) (word32) *x1;
			struct Eq_454 * x1_21 = x1 + 1;
