...
void fun_8049127(int32_t a1, void** a2, int32_t a3) {
    return;
}
...
void fun_8049040(void* ecx, int32_t a2, int32_t a3) {
    goto printf;
}
...
void fun_80490f2() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    fun_8049127(edx5, v4, eax6);
    ebx7 = ebx8 + 0x2efc;
    fun_8049050(main, *reinterpret_cast<int16_t*>(&v1), esp3, ebx7 - 0x2df0, ebx7 - 0x2d90, edx5, v4, eax6);
    __asm__("hlt ");
}
...
void fun_8049212() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    if (esi7) {
        ...
        esi9 = esi7;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi8 * 4 - 0xf4)(*reinterpret_cast<int32_t*>(&v1), *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(&v1) + 4), ebp5, 0x804922f);
            ++edi8;
        } while (esi9 != edi8);
    }
    goto *reinterpret_cast<int32_t*>(&v1);
...
int32_t main() {
    ...
    fun_8049040(ecx1, "lea1 should=0x55667788 is=0x%08x\n", 0x55667788);
    fun_8049040(ecx1, "lea2 should=0x11227788 is=0x%08x\n", 0x11227788);
    fun_8049040("lea2 should=0x11227788 is=0x%08x\n", "lea3 should=0x00007788 is=0x%08x\n", 0x7788);
    fun_8049040("lea2 should=0x11227788 is=0x%08x\n", "lea4 should=0x11227788 is=0x%08x\n", 0x11227788);
    return 0;
}
