...
byte g_b8061020 = 0x00; // 08061020
ui32 g_a806103C[] = // 0806103C
	{
	};
word32 g_dw80610A4 = 0x00; // 080610A4
word32 g_dw80610A8 = 0x00; // 080610A8
word32 g_dw80610AC = 0x00; // 080610AC
word32 g_dw80610B0 = 0x00; // 080610B0
word32 g_dw80610B4 = 0x00; // 080610B4
word32 g_dw80610B8 = 0x00; // 080610B8
word32 g_dw80610BC = 0x00; // 080610BC
word32 g_dw80610C0 = 0x00; // 080610C0
word32 g_dw80610C4 = 0x00; // 080610C4
// subject_fini.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
<anonymous> * g_ptr8060FFC = null; // 08060FFC
// subject_init.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
word32 g_dw8060F10 = 0x00; // 08060F10
// subject_plt.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
word32 _fp_hw = 0x03; // 0805F1E8
word32 _IO_stdin_used = 0x00020001; // 0805F1EC
char g_str805F1F4[] = "exit block"; // 0805F1F4
char g_str805F20F[] = "block 2"; // 0805F20F
char g_str805F217[] = "block 3"; // 0805F217
char g_str805F21F[] = "block 4"; // 0805F21F
// subject_text_0000.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
void _start(void (* edx)(), int32 dwArg00, char * ptrArg04)
{
	...
	__libc_start_main(&g_t805E03D, dwArg00, &ptrArg04, &g_t805F170, &g_t805F1D0, edx, fp);
	__halt();
}
...
void initConditions(ui32 eax)
{
	...
	{
		ui32 eax_14;
		ui32 edx_15 = eax_14 + 1;
		g_a806103C[(edx_15 - eax) * 0x04] = eax_14;
		eax_14 = edx_15;
	} while (edx_15 != eax + 1000);
}
...
void test_3_blocks_variant_98_edges_6()
{
	...
	{
l0804AA26:
		char ** esp_19 = esp_18 - 4;
		*esp_19 = (char **) "block 4";
		puts(*esp_19);
		esp_18 = (char *) esp_19 + 4;
	}
	char ** esp_25 = esp_18 - 4;
	*esp_25 = (char **) "block 3";
	puts(*esp_25);
	esp_18 = (char *) esp_25 + 4;
	goto l0804AA26;
}
...
void test_3_blocks_variant_215_edges_7()
{
	...
	{
l0804D47A:
		char ** esp_11 = esp_10 - 4;
		*esp_11 = (char **) "block 4";
		puts(*esp_11);
		esp_10 = (char *) esp_11 + 4;
		if (g_dw80610AC == 0x00)
		{
l0804D437:
			puts("exit block");
	...
	char ** esp_18 = esp_10 - 4;
	*esp_18 = (char **) "block 3";
	puts(*esp_18);
	esp_10 = (char *) esp_18 + 4;
	if (g_dw80610A8 == 0x00)
		goto l0804D437;
	goto l0804D47A;
}
...
void test_3_blocks_variant_216_edges_7()
{
	...
	do
	{
		...
		*esp_5 = (char **) "block 2";
		puts(*esp_5);
		ptr32 esp_11 = (char *) esp_5 + 4;
		if (g_dw80610A4 == 0x00)
			break;
l0804D4D7:
		char ** esp_12 = esp_11 - 4;
		*esp_12 = (char **) "block 4";
		puts(*esp_12);
		esp_15 = (char *) esp_12 + 4;
	} while (g_dw80610AC == 0x00);
	puts("block 3");
	esp_11 = fp;
	if (g_dw80610A8 == 0x00)
...
void test_3_blocks_variant_256_edges_7()
{
	...
	if (g_dw80610A4 != 0x00)
	{
		...
		{
l0804E350:
			char ** esp_27 = esp_12 - 4;
			*esp_27 = (char **) "block 3";
			puts(*esp_27);
			esp_12 = (char *) esp_27 + 4;
			goto l0804E35F;
		}
l0804E35F:
		char ** esp_13 = esp_12 - 4;
		*esp_13 = (char **) "block 4";
		puts(*esp_13);
		esp_12 = (char *) esp_13 + 4;
		if (g_dw80610AC != 0x00)
			goto l0804E350;
	}
	puts("exit block");
...
void test_3_blocks_variant_258_edges_7()
{
	...
	do
	{
		...
		if (g_dw80610A8 == 0x00)
			break;
l0804E419:
		char ** esp_20 = esp_19 - 4;
		*esp_20 = (char **) "block 4";
		puts(*esp_20);
		esp_19 = (char *) esp_20 + 4;
	} while (g_dw80610AC == 0x00);
	char ** esp_27 = esp_19 - 4;
	*esp_27 = (char **) "block 3";
	puts(*esp_27);
	esp_19 = (char *) esp_27 + 4;
	goto l0804E419;
}
...
l0804E4D3:
	...
	char ** esp_26 = esp_18 - 4;
	*esp_26 = (char **) "block 3";
	puts(*esp_26);
	esp_18 = (char *) esp_26 + 4;
	goto l0804E4D3;
}
...
void test_3_blocks_variant_285_edges_7()
{
	...
	{
l0804EDF1:
		char ** esp_22 = esp_21 - 4;
		*esp_22 = (char **) "block 4";
		puts(*esp_22);
		esp_21 = (char *) esp_22 + 4;
	}
	char ** esp_28 = esp_21 - 4;
	*esp_28 = (char **) "block 3";
	puts(*esp_28);
	esp_21 = (char *) esp_28 + 4;
	goto l0804EDF1;
}
...
l080514A8:
	...
	char ** esp_21 = esp_11 - 4;
	*esp_21 = (char **) "block 3";
	puts(*esp_21);
	esp_11 = (char *) esp_21 + 4;
	if (g_dw80610A8 == 0x00)
		goto l080514A8;
	goto l080514EB;
}
...
l080515B7:
	...
	char ** esp_20 = esp_10 - 4;
	*esp_20 = (char **) "block 3";
	puts(*esp_20);
	esp_10 = (char *) esp_20 + 4;
	if (g_dw80610A8 == 0x00)
	{
l08051574:
		puts("exit block");
...
l080517B5:
	...
	char ** esp_27 = esp_15 - 4;
	*esp_27 = (char **) "block 3";
	puts(*esp_27);
	esp_15 = (char *) esp_27 + 4;
	if (g_dw80610A8 != 0x00)
		goto l080517B5;
	goto l08051785;
}
...
l08052C2A:
		...
		if (g_dw80610A8 == 0x00)
			break;
l08052C6D:
		char ** esp_14 = esp_13 - 4;
		*esp_14 = (char **) "block 4";
		puts(*esp_14);
		esp_13 = (char *) esp_14 + 4;
		if (g_dw80610AC == 0x00)
			goto l08052C2A;
	} while (g_dw80610B0 == 0x00);
	char ** esp_30 = esp_13 - 4;
	*esp_30 = (char **) "block 3";
	puts(*esp_30);
	esp_13 = (char *) esp_30 + 4;
	goto l08052C6D;
}
...
l08052D39:
	...
	char ** esp_29 = esp_12 - 4;
	*esp_29 = (char **) "block 3";
	puts(*esp_29);
	esp_12 = (char *) esp_29 + 4;
	goto l08052D39;
}
...
l08052D9F:
	...
	char ** esp_29 = esp_19 - 4;
	*esp_29 = (char **) "block 3";
	puts(*esp_29);
	esp_19 = (char *) esp_29 + 4;
	goto l08052D9F;
}
...
void test_3_blocks_variant_457_edges_8()
{
	...
	if (g_dw80610A4 != 0x00)
	{
		...
		{
l08053258:
			char ** esp_20 = esp_12 - 4;
			*esp_20 = (char **) "block 3";
			puts(*esp_20);
			esp_12 = (char *) esp_20 + 4;
			if (g_dw80610AC == 0x00)
				goto l08053224;
			goto l08053270;
		}
...
l080532D6:
	...
	char ** esp_21 = esp_13 - 4;
	*esp_21 = (char **) "block 3";
	puts(*esp_21);
	esp_13 = (char *) esp_21 + 4;
	if (g_dw80610AC == 0x00)
		goto l0805328A;
	goto l080532D6;
}
...
void test_3_blocks_variant_514_edges_8()
{
	...
	{
l08054926:
		char ** esp_16 = esp_15 - 4;
		*esp_16 = (char **) "block 4";
		puts(*esp_16);
		esp_15 = (char *) esp_16 + 4;
		if (g_dw80610B0 == 0x00)
		{
l080548DA:
			puts("exit block");
	...
	char ** esp_30 = esp_15 - 4;
	*esp_30 = (char **) "block 3";
	puts(*esp_30);
	esp_15 = (char *) esp_30 + 4;
	goto l08054926;
}
...
l080549F2:
	...
	char ** esp_29 = esp_21 - 4;
	*esp_29 = (char **) "block 3";
	puts(*esp_29);
	esp_21 = (char *) esp_29 + 4;
	goto l080549F2;
}
...
l080560C9:
	...
	char ** esp_23 = esp_11 - 4;
	*esp_23 = (char **) "block 3";
	puts(*esp_23);
	esp_11 = (char *) esp_23 + 4;
	if (g_dw80610A8 == 0x00)
	{
l08056086:
		puts("exit block");
...
l080561A7:
		...
		char ** esp_29 = esp_15 - 4;
		*esp_29 = (char **) "block 3";
		puts(*esp_29);
		esp_15 = (char *) esp_29 + 4;
		if (g_dw80610A8 != 0x00)
			goto l080561A7;
	}
}
...
l080576E6:
	...
	char ** esp_32 = esp_13 - 4;
	*esp_32 = (char **) "block 3";
	puts(*esp_32);
	esp_13 = (char *) esp_32 + 4;
	goto l080576E6;
}
...
l08057AD6:
	...
	char ** esp_23 = esp_13 - 4;
	*esp_23 = (char **) "block 3";
	puts(*esp_23);
	esp_13 = (char *) esp_23 + 4;
	if (g_dw80610AC == 0x00)
		goto l08057A8A;
	goto l08057AD6;
}
...
l08057BB4:
	...
	char ** esp_22 = esp_12 - 4;
	*esp_22 = (char **) "block 3";
	puts(*esp_22);
	esp_12 = (char *) esp_22 + 4;
	if (g_dw80610AC == 0x00)
		goto l08057B68;
	goto l08057BB4;
}
...
l08058A03:
	...
	char ** esp_29 = esp_17 - 4;
	*esp_29 = (char **) "block 3";
	puts(*esp_29);
	esp_17 = (char *) esp_29 + 4;
	if (g_dw80610AC != 0x00)
		goto l08058A03;
	goto l080589CA;
}
...
l080591D1:
	...
	char ** esp_32 = esp_15 - 4;
	*esp_32 = (char **) "block 3";
	puts(*esp_32);
	esp_15 = (char *) esp_32 + 4;
	goto l080591D1;
}
...
l0805931E:
	...
	char ** esp_31 = esp_21 - 4;
	*esp_31 = (char **) "block 3";
	puts(*esp_31);
	esp_21 = (char *) esp_31 + 4;
	goto l0805931E;
}
...
l08059806:
	...
	char ** esp_23 = esp_15 - 4;
	*esp_23 = (char **) "block 3";
	puts(*esp_23);
	esp_15 = (char *) esp_23 + 4;
	if (g_dw80610B0 == 0x00)
		goto l08059806;
	goto l0805985B;
}
...
l0805B058:
	...
	char ** esp_25 = esp_13 - 4;
	*esp_25 = (char **) "block 3";
	puts(*esp_25);
	esp_13 = (char *) esp_25 + 4;
	if (g_dw80610AC == 0x00)
		goto l0805B00C;
	goto l0805B058;
}
...
l0805B8C8:
		...
		char ** esp_31 = esp_17 - 4;
		*esp_31 = (char **) "block 3";
		puts(*esp_31);
		esp_17 = (char *) esp_31 + 4;
		if (g_dw80610AC != 0x00)
			goto l0805B8C8;
	}
}
...
l0805BF58:
	...
	char ** esp_34 = esp_15 - 4;
	*esp_34 = (char **) "block 3";
	puts(*esp_34);
	esp_15 = (char *) esp_34 + 4;
	goto l0805BF58;
}
...
l0805C399:
	...
	char ** esp_25 = esp_15 - 4;
	*esp_25 = (char **) "block 3";
	puts(*esp_25);
	esp_15 = (char *) esp_25 + 4;
	if (g_dw80610B0 == 0x00)
		goto l0805C344;
	goto l0805C399;
}
...
// 0805E03D: void main(Stack ui32 dwArg04)
...
{
	_init();
	int32 esi_29 = 0x08060F0C - g_a8060F08;
	if (esi_29 >> 0x02 != 0x00)
	{
		int32 edi_35 = 0x00;
		do
		{
			(*((char *) g_a8060F08 + edi_35 * 0x04))();
			++edi_35;
