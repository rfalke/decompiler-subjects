...
word32 g_dw8061004 = 0x00; // 08061004
// subject_init.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
{
	__align((char *) fp + 4);
	__libc_start_main(&g_t805E03D, dwArg00, (char *) fp + 4, &g_t805F170, &g_t805F1D0, edx, fp);
	__hlt();
}
...
{
	_init();
	int32 esi_28 = 0x080610F4 - 0x080610F8;
	if (esi_28 >> 0x02 != 0x00)
	{
		int32 edi_33 = 0x00;
		do
		{
			(*((char *) g_a80610F8 + edi_33 * 0x04))();
			++edi_33;
