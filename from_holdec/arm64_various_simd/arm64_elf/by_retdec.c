...
int64_t modify2(void);
int64_t modify3(void);
int64_t modify4(void);
...
char (*g4)[50] = "LoRem iPSUM is simply dummy text of the printing "; // 0x11fc8
int32_t g5 = 0x12058; // 0x11fd0
int32_t g6 = 2472; // 0x11fe0
void (*g7)() = (void (*)())3056; // 0x11fe8
char (*g8)[50] = "Lorem Ipsum is simply dummy text of the printing "; // 0x11ff0
int64_t g9 = 0; // 0x11ff8
int64_t g10; // 0x12000
int64_t g11 = 0; // 0x12018
int64_t g12 = 0; // 0x12020
char * g13; // 0xc70
int64_t g14 = 16; // 0xea0
int32_t g15;
...
void _start_c(int64_t * p) {
    int32_t v1 = g6; // 0x6f8
    __libc_start_main((int64_t)v1, v1, (char **)((int64_t)p + 8), g2, g7, NULL);
}
...
int64_t _24_x(void) {
    ...
    int64_t v2; // 0xab0
    *(int64_t *)v2 = __asm_fmov(0.0);
    *(int64_t *)v2 = 0x3fe8000000000000;
    return 0;
}
...
int64_t cmp_bytes(void) {
    ...
    __asm_cmeq(v1, v1);
    int64_t v2; // 0xbb8
    *(float128_t *)v2 = *(float128_t *)"Lorem Ipsum is simply dummy text of the printing ";
    *(int64_t *)v2 = __asm_fmov(0.0);
    float64_t v3; // 0xbb8
    *(int64_t *)v2 = (int64_t)v3;
    return 0;
