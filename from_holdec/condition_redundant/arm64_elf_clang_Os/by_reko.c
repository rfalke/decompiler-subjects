...
// 00000000004005E0: void main(Register word32 w0, Register word64 x1)
void main(word32 w0, word64 x1)
{
	ui32 w8_6 = (word32) (w0 == 0x02);
	ui32 w9_9 = (word32) (w0 == 0x2A);
	if (x1 != 0x00 && (w8_6 | w9_9) != 0x00)
	{
		x0_20 = (uint64) puts("Should be expressed as argv!=null && (argc==2 || argc==42)");
		x0_24 = (uint64) puts("Also if order is different");
	}
}
