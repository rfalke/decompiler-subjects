...
// WARNING: Removing unreachable block (ram,0x00100750)
...
// WARNING: Removing unreachable block (ram,0x0010078c)
...
{
  if (((argv != (char **)0x0) && (argc == 2)) || ((argv != (char **)0x0 && (argc == 0x2a)))) {
    puts("Should be expressed as argv!=null && (argc==2 || argc==42)");
  }
  if (((argv != (char **)0x0) && (argc == 2)) || ((argc == 0x2a && (argv != (char **)0x0)))) {
...

{
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    // WARNING: Could not recover jumptable at 0x001008bc. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x1008bc);
