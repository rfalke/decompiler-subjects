...

{
  ...
  do {
    ...
    puVar3 = (undefined4 *)cRead_8(tmp_ldXn);
    ...
    _uVar5 = SIMD_FLOAT_ADD(_uVar5,in_q1,4);
    in_z0 = ZEXT1632(_uVar5);
    iVar2 = param_4 + -4;
    cWrite_8(tmp_ldXn,param_1);
    puVar3 = (undefined4 *)cRead_8(tmp_ldXn);
    *puVar3 = SUB164(_uVar5,0);
    lVar4 = cRead_8(tmp_ldXn);
    cWrite_8(tmp_ldXn,lVar4 + 4);
    puVar3 = (undefined4 *)cRead_8(tmp_ldXn);
    *puVar3 = SUB324(in_z0 >> 0x20,0);
    lVar4 = cRead_8(tmp_ldXn);
    cWrite_8(tmp_ldXn,lVar4 + 4);
    puVar3 = (undefined4 *)cRead_8(tmp_ldXn);
    *puVar3 = SUB324(in_z0 >> 0x40,0);
    lVar4 = cRead_8(tmp_ldXn);
    cWrite_8(tmp_ldXn,lVar4 + 4);
    puVar3 = (undefined4 *)cRead_8(tmp_ldXn);
    *puVar3 = SUB324(in_z0 >> 0x60,0);
    lVar4 = cRead_8(tmp_ldXn);
    cWrite_8(tmp_ldXn,lVar4 + 4);
...

{
  ...
  local_38[0] = 1.20000005;
  local_38[1] = 0x40133333;
  local_38[2] = 0x4059999a;
  local_38[3] = 0x40b33333;
  local_28[0] = 0.10000000;
  local_28[1] = 0x3e4ccccd;
  local_28[2] = 0x3e99999a;
  local_28[3] = 0x3ecccccd;
