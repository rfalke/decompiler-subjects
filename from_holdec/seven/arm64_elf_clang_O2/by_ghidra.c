...

{
  ...
  do {
    uVar4 = uVar1;
    uVar1 = uVar4 / 7;
    uVar2 = (int)((ulong)uVar4 * 0x24924925 >> 0x20) - uVar1;
    if (uVar2 != 0) {
      printf("%u %u %u (diff=%d) %u (diff=%d)\n",(ulong)uVar4,(ulong)uVar1,(ulong)(uVar4 / 7),
             (ulong)(uVar4 / 7 - uVar1),(ulong)uVar4 * 0x24924925 >> 0x20,(ulong)uVar2);
    }
    bVar3 = uVar5 <= uVar4;
    uVar1 = uVar4 + 1000000;
    uVar5 = uVar4;
...
void FUN_004006ec(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x004006ec. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x4006ec);
