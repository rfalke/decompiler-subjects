...
{
	word32 x21_32_32_106 = SLICE(x21, word32, 32);
	uint32 w23_30 = 0x00;
	ui64 x21_107 = SEQ(x21_32_32_106, 0x4925);
	ui64 x8_177 = SEQ(x8_32_32, 0x00);
	do
	{
		uint64 x8_41 = x8_177 * x21_107;
		uint32 w8_34 = (word32) x8_177;
		uint32 w8_44 = (word32) (x8_41 >> 32);
		uint32 w5_46 = (word32) (x8_177 * x21_107 >> 32);
		uint32 w8_48 = w8_44 + (w8_34 - w8_44 >> 1);
		word32 x8_32_32_104 = SLICE(x8_41 >> 32, word32, 32);
		uint32 w9_49 = w5_46 + (w8_34 - w5_46 >> 1);
		if (w5_46 - (w8_48 >> 2) != 0x00 || w9_49 >> 2 != w8_48 >> 2)
			fn0000000000400480();
		w23_30 = w8_34;
		x8_177 = SEQ(x8_32_32_104, w8_34 + 0x4240);
		w23_180 = w23_30;
	} while (w8_34 >= w23_180);
}
