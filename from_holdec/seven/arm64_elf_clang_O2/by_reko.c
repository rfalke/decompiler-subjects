...
{
	word32 x21_32_32_122 = SLICE(x21, word32, 32);
	uint32 w23_30 = 0x00;
	ui64 x21_123 = SEQ(x21_32_32_122, 0x4925);
	ui64 x8_202 = SEQ(x8_32_32, 0x00);
	do
	{
		uint64 x8_41 = x8_202 * x21_123;
		uint64 x9_40 = x8_202 * x21_123;
		uint32 w8_34 = (word32) x8_202;
		uint32 w8_44 = (word32) (x8_41 >> 32);
		uint32 w5_46 = (word32) (x9_40 >> 32);
		uint32 w8_48 = w8_44 + (w8_34 - w8_44 >> 1);
		word32 x8_32_32_120 = SLICE(x8_41 >> 32, word32, 32);
		uint32 w9_49 = w5_46 + (w8_34 - w5_46 >> 1);
		Eq_121 w6_52 = w5_46 - (w8_48 >> 2);
		if (w6_52 != 0x00 || w9_49 >> 2 != w8_48 >> 2)
			x0_81 = (uint64) printf("%u %u %u (diff=%d) %u (diff=%d)\n", w8_34, w8_48 >> 2, w9_49 >> 2, (w9_49 >> 2) - (w8_48 >> 2), (uint32) (x9_40 >> 32), w6_52);
		w23_30 = w8_34;
		x8_202 = SEQ(x8_32_32_120, w8_34 + 0x4240);
		w23_205 = w23_30;
	} while (w8_34 >= w23_205);
}
