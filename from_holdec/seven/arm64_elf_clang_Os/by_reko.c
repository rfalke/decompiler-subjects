...
{
	word32 x21_32_32_118 = SLICE(x21, word32, 32);
	uint32 w23_28 = 0x00;
	ui64 x21_119 = SEQ(x21_32_32_118, 0x24924925);
	ui64 x8_197 = SEQ(x8_32_32, 0x00);
	do
	{
		uint64 x8_39 = x8_197 * x21_119;
		uint64 x9_38 = x8_197 * x21_119;
		uint32 w8_32 = (word32) x8_197;
		uint32 w8_42 = (word32) (x8_39 >> 32);
		uint32 w5_44 = (word32) (x9_38 >> 32);
		word32 x8_32_32_116 = SLICE(x8_39 >> 32, word32, 32);
		uint32 w8_46 = w8_42 + (w8_32 - w8_42 >> 1);
		uint32 w9_47 = w5_44 + (w8_32 - w5_44 >> 1);
		if (w5_44 != w8_46 >> 2 || w9_47 >> 2 != w8_46 >> 2)
			printf("%u %u %u (diff=%d) %u (diff=%d)\n", w8_32, w8_46 >> 2, w9_47 >> 2, (w9_47 >> 2) - (w8_46 >> 2), (uint32) (x9_38 >> 32), w5_44 - (w8_46 >> 2));
		w23_28 = w8_32;
		x8_197 = SEQ(x8_32_32_116, w8_32 + 1000000);
		w23_200 = w23_28;
	} while (w8_32 >= w23_200);
}
