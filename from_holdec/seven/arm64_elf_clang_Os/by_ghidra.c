...

{
  ...
  do {
    uVar4 = uVar1;
    uVar3 = (uint)((ulonglong)uVar4 * 0x24924925 >> 0x20);
    uVar1 = uVar4 / 7;
    if (uVar3 != uVar4 / 7) {
      printf("%u %u %u (diff=%d) %u (diff=%d)\n",(ulonglong)uVar4,(ulonglong)uVar1,
             (ulonglong)(uVar4 / 7),(ulonglong)(uVar4 / 7 - uVar1),
             (ulonglong)uVar4 * 0x24924925 >> 0x20,(ulonglong)(uVar3 - uVar1));
    }
    bVar2 = uVar5 <= uVar4;
    uVar1 = uVar4 + 1000000;
    uVar5 = uVar4;
