...

{
  ...
  return (uint)((ulong)in_w0 * 0x24924925 >> 0x20);
}
...

{
  ...
  local_1c = 0;
  while( true ) {
    uVar1 = test_1(in_stack_ffffffffffffffdc);
    in_stack_ffffffffffffffdc = test_2(x);
    uVar2 = test_3(in_stack_ffffffffffffffdc);
    if ((uVar1 != in_stack_ffffffffffffffdc) || (uVar1 != uVar2)) {
      printf("%u %u %u (diff=%d) %u (diff=%d)\n",(ulong)local_1c,(ulong)uVar1,
             (ulong)in_stack_ffffffffffffffdc,(ulong)(in_stack_ffffffffffffffdc - uVar1),
             (ulong)uVar2,(ulong)(uVar2 - uVar1));
    }
    if ((local_18 != 0) && (local_1c < local_18)) break;
    local_18 = local_1c;
