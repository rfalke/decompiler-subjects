...

{
  ...
  local_1c = 0;
  while( true ) {
    uVar1 = test_1(local_1c);
    uVar2 = test_2(local_1c);
    uVar3 = test_3(local_1c);
    if ((uVar1 != uVar2) || (uVar1 != uVar3)) {
      printf("%u %u %u (diff=%d) %u (diff=%d)\n",(ulonglong)local_1c,(ulonglong)uVar1,
             (ulonglong)uVar2,(ulonglong)(uVar2 - uVar1),(ulonglong)uVar3,(ulonglong)(uVar3 - uVar1)
            );
    }
