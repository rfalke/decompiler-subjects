...

{
  ...
  while( true ) {
    ...
    if ((iVar2 != iVar3) || (iVar2 != iVar4)) {
      printf("%u %u %u (diff=%d) %u (diff=%d)\n",uVar5,iVar2,iVar3,iVar3 - iVar2,iVar4,iVar4 - iVar2
            );
    }
    if ((uVar6 != 0) && (uVar5 < uVar6)) break;
    uVar1 = uVar5 + 1000000;
    uVar6 = uVar5;
  }
  return 0;
...
// WARNING: Removing unreachable block (ram,0x080483df)
...
// WARNING: Removing unreachable block (ram,0x08048421)
...
// WARNING: Removing unreachable block (ram,0x08048470)
...
undefined4 test_3(uint param_1)

{
  return (int)((ulonglong)param_1 * 0x24924925 >> 0x20);
}
