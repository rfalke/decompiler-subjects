...
void main(word32 x8_32_32, word64 x21)
{
	...
	ui64 x8_171 = SEQ(x8_32_32, 0x00);
	do
	{
		uint64 x8_41 = x8_171 * x21_107;
		uint32 w8_34 = (word32) x8_171;
		uint32 w8_44 = (word32) (x8_41 >> 32);
		uint32 w5_46 = (word32) (x8_171 * x21_107 >> 32);
		...
		if (w5_46 - (w8_48 >> 2) != 0x00 || w9_49 >> 2 != w8_48 >> 2)
			x0_65 = (uint64) printf("%u %u %u (diff=%d) %u (diff=%d)\n", 0x00);
		w23_30 = w8_34;
		x8_171 = SEQ(x8_32_32_104, w8_34 + 0x4240);
		w23_174 = w23_30;
	} while (w8_34 >= w23_174);
}
