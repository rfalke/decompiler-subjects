...
void main()
{
	uint32 dwArg04_121 = 0x00;
	uint32 dwArg00_122 = 0x00;
	while (true)
	{
		word64 x0_16 = test_1(dwArg00_122);
		word64 x0_22 = test_2(SEQ(SLICE(x0_16, word32, 32), dwArg00_122));
		uint32 w0_17 = (word32) x0_16;
		uint32 w0_24 = (word32) x0_22;
		uint32 w0_31 = test_3(SEQ(SLICE(x0_22, word32, 32), dwArg00_122));
		if (w0_17 != w0_24 || w0_17 != w0_31)
			x0_75 = (uint64) printf("%u %u %u (diff=%d) %u (diff=%d)\n", dwArg00_122, w0_17, w0_24, w0_24 - w0_17, w0_31, w0_31 - w0_17);
		if (dwArg04_121 != 0x00 && dwArg00_122 < dwArg04_121)
			break;
		dwArg04_121 = dwArg00_122;
		dwArg00_122 += 1000000;
	}
}

// 00000000000009E0: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24)
