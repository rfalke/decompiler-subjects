...
void main()
{
	uint32 dwArg04_103 = 0x00;
	uint32 dwArg00_104 = 0x00;
	while (true)
	{
		word64 x0_16 = test_1(dwArg00_104);
		word64 x0_22 = test_2(SEQ(SLICE(x0_16, word32, 32), dwArg00_104));
		word32 w0_17 = (word32) x0_16;
		word32 w0_31 = test_3(SEQ(SLICE(x0_22, word32, 32), dwArg00_104));
		if (w0_17 != (word32) x0_22 || w0_17 != w0_31)
			x0_57 = (uint64) printf("%u %u %u (diff=%d) %u (diff=%d)\n", 0x00);
		if (dwArg04_103 != 0x00 && dwArg00_104 < dwArg04_103)
			break;
		dwArg04_103 = dwArg00_104;
		dwArg00_104 += 1000000;
	}
}
