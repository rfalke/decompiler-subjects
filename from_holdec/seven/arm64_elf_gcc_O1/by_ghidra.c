...

{
  ...
  while( true ) {
    uVar1 = x / 7;
    uVar2 = test_2(x);
    uVar3 = (uint)((ulong)x * 0x24924925 >> 0x20);
    if (uVar2 != uVar1 || uVar3 != uVar1) {
      printf("%u %u %u (diff=%d) %u (diff=%d)\n",(ulong)x,(ulong)uVar1,(ulong)uVar2,
             (ulong)(uVar2 - uVar1),(ulong)x * 0x24924925 >> 0x20,(ulong)(uVar3 - uVar1));
    }
    if ((uVar4 != 0 && x <= uVar4) && (uVar4 == 0 || uVar4 != x)) break;
    uVar4 = x;
    x = x + 1000000;
  }
  return 0;
...
void FUN_0010095c(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x0010095c. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x10095c);
