...

{
  ...
  while( true ) {
    uVar1 = x / 7;
    uVar2 = test_2(x);
    uVar3 = (uint)((ulonglong)x * 0x24924925 >> 0x20);
    if (uVar2 != uVar1 || uVar3 != uVar1) {
      printf("%u %u %u (diff=%d) %u (diff=%d)\n",(ulonglong)x,(ulonglong)uVar1,(ulonglong)uVar2,
             (ulonglong)(uVar2 - uVar1),(ulonglong)x * 0x24924925 >> 0x20,(ulonglong)(uVar3 - uVar1)
            );
    }
