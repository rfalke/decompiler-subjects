...
{
	uint32 w21_123 = 0x00;
	ui64 x1_32_32_w19_239 = SEQ(x1_32_32, 0x00);
	while (true)
	{
		uint32 w19_40 = (word32) x1_32_32_w19_239;
		...
		bool v48_147 = false;
		word64 x1_52;
		if (test_2(x1_32_32_w19_239, out x1_52) == w20_46 >> 2)
			v48_147 = w5_64 == w20_46 >> 2;
		if (!v48_147)
			x0_81 = (uint64) printf("%u %u %u (diff=%d) %u (diff=%d)\n", 0x00);
		bool v50_149 = false;
		if (w21_123 != 0x00)
			v50_149 = w21_123 > w19_40;
		if (v50_149)
			break;
		w21_123 = w19_40;
		x1_32_32_w19_239 = SEQ(x1_32_32_136, w19_40 + 1000000);
	}
}
