...
longlong __regparm2
mystrcpy(undefined4 param_1_00,uint param_2_00,undefined4 *param_1,char *param_2)

{
  ...
  return (ulonglong)param_2_00 << 0x20;
}
...

{
  ...
  iVar1 = 0;
  do {
    (**(code **)(unaff_EBP + 0x2d02 + iVar1 * 4))(param_1,param_2,param_3);
    iVar1 = iVar1 + 1;
  } while (iVar1 != 1);
  return;
}
