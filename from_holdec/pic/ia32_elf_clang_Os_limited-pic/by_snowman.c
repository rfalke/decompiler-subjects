...
void fun_8049181() {
    ...
    ebx1 = reinterpret_cast<int32_t>(__return_address()) + 0x2e7f;
...
void fun_80491ac(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t ebx5;
    int32_t* esi6;
    int32_t v7;
    int32_t v8;

    ebx5 = reinterpret_cast<int32_t>(__return_address()) + 0x2e54;
...
void a_func(int32_t a1) {
    ...
    fun_8049040(ebx2 - 0x1ff4, v4, fun_8049181);
    goto a1;
}
...
void fun_80491e2() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    if (esi7) {
        ...
        esi9 = esi7;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi8 * 4 - 0xf8)(*reinterpret_cast<int32_t*>(&v1), *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(&v1) + 4), ebp5, 0x80491ff);
            ++edi8;
        } while (esi9 != edi8);
    }
    goto *reinterpret_cast<int32_t*>(&v1);
...
void main() {
    ...
    fun_80491ac(eax1, esi2, ebx3, __return_address());
}
