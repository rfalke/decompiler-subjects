...
{
	__align((char *) fp + 8);
	__libc_start_main(&g_t401144, qwArg00, (char *) fp + 8, &g_t401180, &g_t4011F0, rdx, fp);
	__hlt();
}
...
// 0000000000401126: void a_func()
// Called from:
//      main
void a_func()
{
	printf("in func: %d\n", (uint64) (word32) (uint64) g_dw404024);
}

// 0000000000401144: void main()
void main()
{
	printf("in main: %d\n", (uint64) (word32) (uint64) g_dw404024);
