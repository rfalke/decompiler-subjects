...
// 0000000000401070: void _start(Register (ptr64 Eq_24) rdx, Stack word32 dwArg00)
void _start(void (* rdx)(), word32 dwArg00)
{
	__align((char *) fp + 8);
	__libc_start_main(&g_t401040, (int32) qwArg00, (char *) fp + 8, &g_t401180, &g_t4011F0, rdx, fp);
	__hlt();
}
