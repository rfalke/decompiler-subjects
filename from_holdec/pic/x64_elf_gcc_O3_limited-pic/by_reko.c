...
// 0000000000401070: void _start(Register (ptr64 Eq_25) rdx, Stack word32 dwArg00, Stack (ptr64 char) ptrArg08)
void _start(void (* rdx)(), word32 dwArg00, char * ptrArg08)
{
	void * fp;
	word64 qwArg00;
	__align_stack<word64>(&ptrArg08);
	__libc_start_main(&g_t401040, (int32) qwArg00, &ptrArg08, &g_t401180, &g_t4011F0, rdx, fp);
	__halt();
}
