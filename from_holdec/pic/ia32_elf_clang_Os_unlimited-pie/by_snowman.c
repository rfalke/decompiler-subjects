...
void fun_8049181() {
    ...
    ebx1 = reinterpret_cast<struct s0*>(reinterpret_cast<int32_t>(__return_address()) + 0x2e7f);
    v2 = ebx1->f18;
    fun_8049040(reinterpret_cast<int32_t>(ebx1) - 0x1ff4, v2, v3);
    goto v4;
}
...
void fun_80491ab(int32_t a1) {
    struct s1* ebx2;
    int32_t v3;
    int32_t v4;
    int32_t v5;

    ebx2 = reinterpret_cast<struct s1*>(reinterpret_cast<int32_t>(__return_address()) + 0x2e55);
    v3 = ebx2->f18;
    fun_8049040(reinterpret_cast<int32_t>(ebx2) - 0x1fe7, v3, v4);
    ebx2->f18 = ebx2->f18 + 1;
    a_func(a1);
    goto v5;
}
...
void a_func(int32_t a1) {
    ...
    fun_8049181();
    ebx2 = reinterpret_cast<struct s2*>(v3 + 0x2e7f);
    v4 = ebx2->f18;
    fun_8049040(reinterpret_cast<int32_t>(ebx2) - 0x1ff4, v4, fun_8049181);
    goto a1;
}
...
void fun_8049062() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    ebx7 = ebx8 + 0x2f8c;
    fun_8049050(main, *reinterpret_cast<int16_t*>(&v1), esp3, ebx7 - 0x2e20, ebx7 - 0x2dc0, edx5, v4, eax6);
    __asm__("hlt ");
}
...
void fun_80491e2() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    if (esi7) {
        ...
        esi9 = esi7;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi8 * 4 - 0xf4)(*reinterpret_cast<int32_t*>(&v1), *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(&v1) + 4), ebp5, 0x80491ff);
            ++edi8;
        } while (esi9 != edi8);
    }
    goto *reinterpret_cast<int32_t*>(&v1);
