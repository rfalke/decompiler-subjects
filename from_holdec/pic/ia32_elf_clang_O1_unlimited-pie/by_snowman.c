...
void fun_8049189() {
    ...
    ebx1 = reinterpret_cast<struct s0*>(reinterpret_cast<int32_t>(__return_address()) + 0x2e77);
    v2 = ebx1->0x18;
...
void fun_80491b9(int32_t a1) {
    struct s1* ebx2;
    int32_t v3;
    int32_t v4;
    int32_t v5;

    ebx2 = reinterpret_cast<struct s1*>(reinterpret_cast<int32_t>(__return_address()) + 0x2e47);
    v3 = ebx2->0x18;
...
void a_func(int32_t a1) {
    ...
    fun_8049189();
    ebx2 = reinterpret_cast<struct s2*>(v3 + 0x2e77);
    v4 = ebx2->0x18;
    fun_8049040(reinterpret_cast<int32_t>(ebx2) - 0x1ff4, v4, fun_8049189);
    goto a1;
}
...
void fun_80491f2() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    if (esi7) {
        ...
        esi9 = esi7;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi8 * 4 - 0xf4)(*reinterpret_cast<int32_t*>(&v1), *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(&v1) + 4), ebp5, 0x804920f);
            ++edi8;
        } while (esi9 != edi8);
    }
    goto *reinterpret_cast<int32_t*>(&v1);
