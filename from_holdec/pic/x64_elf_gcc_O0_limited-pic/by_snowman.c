...
void fun_401043() {
    ...
    __libc_start_main(main, __return_address(), rsp1, 0x401190, 0x401200, rdx2, (reinterpret_cast<uint64_t>(rsp1) & 0xfffffffffffffff0) - 8 - 8, rax3);
    __asm__("hlt ");
}
...
void fun_401193(int32_t edi, int64_t rsi, int64_t rdx) {
    int64_t r15_4;
    int64_t r14_5;
    int32_t r13d6;
    int64_t rbx7;
...
int64_t main() {
    ...
    *reinterpret_cast<int32_t*>(&rax3) = a_global;
    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rax3) + 4) = 0;
    a_global = static_cast<int32_t>(rax3 + 1);
    a_func("in main: %d\n", rsi2);
    return 0;
}
