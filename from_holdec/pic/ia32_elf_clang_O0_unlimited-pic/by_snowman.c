...
void fun_804918c() {
    ...
    eax1 = reinterpret_cast<int32_t>(__return_address()) + 0x2e74;
    edx2 = **reinterpret_cast<int32_t**>(eax1 - 4);
    eax3 = fun_8049040(eax1 - 0x1ff4, edx2);
...
void fun_80491cc() {
    ...
    eax1 = reinterpret_cast<int32_t>(__return_address()) + 0x2e34;
    edx2 = *reinterpret_cast<int32_t**>(eax1 - 4);
    *reinterpret_cast<int32_t*>(ebp3 - 8) = 0;
    edx4 = *edx2;
    v5 = eax1 - 0x1fe7;
    *reinterpret_cast<int32_t*>(ebp6 - 12) = eax1;
    eax7 = fun_8049040(v5, edx4);
    **reinterpret_cast<int32_t**>(*reinterpret_cast<int32_t*>(ebp8 - 12) - 4) = **reinterpret_cast<int32_t**>(*reinterpret_cast<int32_t*>(ebp8 - 12) - 4) + 1;
    *reinterpret_cast<int32_t*>(ebp9 - 16) = eax7;
    a_func(v5, edx4);
    goto v10;
}
...
void a_func(int32_t a1, int32_t a2) {
    ...
    fun_804918c();
    eax3 = v4 + 0x2e74;
    edx5 = **reinterpret_cast<int32_t**>(eax3 - 4);
    fun_8049040(eax3 - 0x1ff4, edx5);
    goto a1;
}
...
void fun_8049222() {
    ...
    *reinterpret_cast<int16_t*>(&v1) = ds2;
    ...
    if (esi7) {
        ...
        esi9 = esi7;
        do {
            *reinterpret_cast<int32_t*>(ebx3 + edi8 * 4 - 0xf8)(*reinterpret_cast<int32_t*>(&v1), *reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(&v1) + 4), ebp5, 0x804923f);
            ++edi8;
        } while (esi9 != edi8);
    }
    goto *reinterpret_cast<int32_t*>(&v1);
