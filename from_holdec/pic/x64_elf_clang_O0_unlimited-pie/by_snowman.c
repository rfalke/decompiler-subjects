...
int32_t fun_401030(int64_t rdi, int64_t rsi) {
    goto printf;
}

int32_t a_global = 42;

int32_t a_func(int64_t rdi) {
    int64_t rsi2;
    int32_t eax3;

    *reinterpret_cast<int32_t*>(&rsi2) = a_global;
    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi2) + 4) = 0;
    eax3 = fun_401030("in func: %d\n", rsi2);
    return eax3;
}
...
void fun_401043() {
    ...
    __libc_start_main(main, __return_address(), rsp1, 0x4011b0, 0x401220, rdx2, (reinterpret_cast<uint64_t>(rsp1) & 0xfffffffffffffff0) - 8 - 8, rax3);
    __asm__("hlt ");
}
...
void fun_4011b3(int32_t edi, int64_t rsi, int64_t rdx) {
    int64_t r15_4;
    int64_t r14_5;
    int32_t r13d6;
    int64_t rbx7;
