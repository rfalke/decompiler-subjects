...
void _start(void (* edx)(), int32 dwArg00, char * ptrArg04)
{
	...
	__libc_start_main(&g_t80491C0, dwArg00, &ptrArg04, &g_t8049220, &g_t8049280, edx, fp);
	__halt();
}
...
{
	printf("in main: %d\n", *g_ptr804BFFC);
	int32 * edx_23 = g_ptr804BFFC;
	++*edx_23;
	a_func();
}

// 08049220: void __libc_csu_init(Stack word32 dwArg04, Stack word32 dwArg08, Stack word32 dwArg0C)
