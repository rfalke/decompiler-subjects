...
// 08048420: void main(Stack word32 dwArg00, Stack (ptr32 (ptr32 char)) dwArg08)
...
// 080490A2: void _start(Register (ptr32 Eq_841) edx, Stack int32 dwArg00)
...
// 080490D0: void __x86.get_pc_thunk.bx(Stack word32 dwArg00)
...
{
	_init();
	if (0x0804C0F4 - 0x0804C0F8 >> 0x02 != 0x00)
	{
		do
		{
			word32 esp_65;
