...
// WARNING: Removing unreachable block (ram,0x001008c0)
...
// WARNING: Removing unreachable block (ram,0x001008fc)
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x101634);
