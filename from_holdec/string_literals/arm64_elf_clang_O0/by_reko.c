...
void main(char ** x1)
{
	...
	FILE * x0_56 = fopen("with-null-byte", "w");
	fwrite(&g_v4038C9, 0x11, 0x01, x0_56);
	fwrite(&g_v4038C9, 0x01, 0x11, x0_56);
	fclose(x0_56);
...
// 0000000000401C80: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
