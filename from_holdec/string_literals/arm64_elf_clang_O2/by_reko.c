...
byte g_b41405F = 0x00; // 000000000041405F
// subject_fini.c
// Generated by decompiling subject.exe
// using Reko decompiler version VERSION
...
// 0000000000400630: void _start(Register (ptr64 Eq_5) x0, Stack word32 dwArg00, Stack (ptr64 char) ptrArg08)
void _start(void (* x0)(), word32 dwArg00, char * ptrArg08)
{
	void * fp;
	word64 qwArg00;
	__libc_start_main(g_ptr400660, (int32) qwArg00, &ptrArg08, g_ptr400668, g_ptr400670, x0, fp);
	abort();
}
...
// 0000000000400740: void frame_dummy()
void frame_dummy()
{
...
void main(char ** x1, word32 x2_32_32)
{
	...
	word32 x1_32_32_45 = SLICE("w", word32, 32);
	FILE * x0_37 = fopen("with-null-byte", "w");
	fwrite(&g_v403069, SEQ(x1_32_32_45, 0x11), SEQ(x2_32_32, 0x01), x0_37);
	fwrite(&g_v403069, SEQ(x1_32_32_45, 0x01), SEQ(x2_32_32, 0x11), x0_37);
	fclose(x0_37);
...
// 0000000000401420: void __libc_csu_init(Register word32 w0, Register word64 x1, Register word64 x2, Register word64 x24, Register word64 x30)
void __libc_csu_init(word32 w0, word64 x1, word64 x2, word64 x24, word64 x30)
{
	ptr64 fp;
	word32 x24_32_32_89 = SLICE(x24, word32, 32);
	_init();
	int64 x20_23 = 4275688 - g_a413DE0;
	ptr64 x29_49 = fp + -64;
	<anonymous> * x21_21[] = g_a413DE0;
	word64 x22_30 = x2;
	word64 x23_34 = x1;
