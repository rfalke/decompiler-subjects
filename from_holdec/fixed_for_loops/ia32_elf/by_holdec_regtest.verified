...
{
  (void) fputs("0019 signed start:0, iter:10, inc:+1, order:buj cmp:< 0 exp:+48        expected='0123456789' >", g_0x0806a020);
...
{
  (void) fputs("0020 signed start:0, iter:10, inc:+1, order:buj cmp:<=0 exp:+48        expected='0123456789' >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 10; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
{
  (void) fputs("0031 signed start:0, iter:10, inc:+1, order:jbu cmp:< 0 exp:+48        expected='0123456789' >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 10; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
{
  (void) fputs("0032 signed start:0, iter:10, inc:+1, order:jbu cmp:<=0 exp:+48        expected='0123456789' >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 10; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
{
  (void) fputs("0115 signed start:0, iter:10, inc:+1, order:buj cmp:< 0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
...
{
  (void) fputs("0116 signed start:0, iter:10, inc:+1, order:buj cmp:<=0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 10; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
...
{
  (void) fputs("0127 signed start:0, iter:10, inc:+1, order:jbu cmp:< 0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 10; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
...
{
  (void) fputs("0128 signed start:0, iter:10, inc:+1, order:jbu cmp:<=0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 10; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
...
d4 var0199_0(void)
{
  (void) fputs("0199 signed start:0, iter:1, inc:+1, order:jbu cmp:< 0 exp:+48         expected='0'   >", g_0x0806a020);
...
d4 var0200_0(void)
{
  (void) fputs("0200 signed start:0, iter:1, inc:+1, order:jbu cmp:<=0 exp:+48         expected='0'   >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 1; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
d4 var0295_0(void)
{
  (void) fputs("0295 signed start:0, iter:1, inc:+1, order:jbu cmp:< 0 second:=48 +1   expected='0'   >", g_0x0806a020);
  reg_var1 = 48;
...
d4 var0296_0(void)
{
  (void) fputs("0296 signed start:0, iter:1, inc:+1, order:jbu cmp:<=0 second:=48 +1   expected='0'   >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 1; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
...
{
  (void) fputs("0439 unsign start:0, iter:10, inc:+1, order:buj cmp:< 0 exp:+48        expected='0123456789' >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 10; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
{
  (void) fputs("0440 unsign start:0, iter:10, inc:+1, order:buj cmp:<=0 exp:+48        expected='0123456789' >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 10; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
{
  (void) fputs("0449 unsign start:0, iter:10, inc:+1, order:jbu cmp:< 0 exp:+48        expected='0123456789' >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 10; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
{
  (void) fputs("0450 unsign start:0, iter:10, inc:+1, order:jbu cmp:<=0 exp:+48        expected='0123456789' >", g_0x0806a020);
  for(reg_var1 = 0; reg_var1 < 10; reg_var1++) {
    (void) putchar(reg_var1 + 48);
  }
  (void) puts("<");
...
{
  (void) fputs("0531 unsign start:0, iter:10, inc:+1, order:buj cmp:< 0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 10; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
...
{
  (void) fputs("0532 unsign start:0, iter:10, inc:+1, order:buj cmp:<=0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 10; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
...
{
  (void) fputs("0541 unsign start:0, iter:10, inc:+1, order:jbu cmp:< 0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 10; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
...
{
  (void) fputs("0542 unsign start:0, iter:10, inc:+1, order:jbu cmp:<=0 second:=48 +1  expected='0123456789' >", g_0x0806a020);
  reg_var1 = 48;
  for(reg_var2 = 0; reg_var2 < 10; reg_var2++) {
    (void) putchar(reg_var1);
    reg_var1++;
