...
void log_size_7_var_001()
{
	...
	word32 r12d_412;
	uint64 rbx_433 = __shrd(SEQ(SLICE(rbx_247, word48, 16), SLICE(__rcr(bx_337, cl_302, SLICE(cond(di_344 + 0x8D8E), bool, 1)), byte, 8), (int8) __btc(SEQ(r12d_24_8_404, r12b_367 + 0x01), r10d_411, out r12d_412)), SEQ(rcx_56_8_431, cl_302), 0xA5);
	...
	if ((r12b_521 * 0x02 | r10b_536) >= 0x00)
...
void log_size_7_var_003()
{
	...
	uip32 r12d_213 = (word32) __rol(SEQ(~0x00, __xadd(0x2DCDA24E, (word32) rdx_142)), 0x01);
	uint32 ecx_195 = __rol(SEQ(~0x0165, SLICE(cx_147, byte, 8) * 0x02 + true, cl_154), 0x01);
	word32 r12d_214;
	__btr(r12d_213, 0xC2, out r12d_214);
...
void log_size_7_var_004()
{
	...
	uint16 r10w_101 = __shld((word16) r10d_96, ~0x44B9, cl_91 & 0x0F);
...
void log_size_7_var_006()
{
	...
	word16 r15w_430 = (bool) (ebp_411 < 670952469) + (r15w_364 + r12w_337);
...
void log_size_7_var_008()
{
	...
	uint128 rdx_rax_132 = rbp_127 *128 1257265537;
