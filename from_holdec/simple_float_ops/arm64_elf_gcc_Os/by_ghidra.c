...

{
  use((double)global_long_long +
      (double)global_long +
      (double)global_int + (double)(int)global_short + (double)(int)global_char + 0.00000000);
  return 0x78;
}
...
LAB_00101bd8:
          ...
          if (uVar6 == 0x800000) {
            ...
            uVar7 = uVar8;
            if (uVar6 == 0) {
              if ((uVar8 & 0xf) == 4) goto joined_r0x00101bd0;
              uVar6 = uVar8 + 4;
              goto joined_r0x00101cdc;
            }
          }
          uVar8 = uVar7;
          if (uVar10 != 0) goto LAB_00101bd8;
LAB_00101af4:
          uVar10 = (uint)uVar8;
        }
