...
undefined8 FUN_00100aac(double param_1,double param_2)

{
  printf((char *)(param_1 + param_2),&DAT_001022a0);
  printf((char *)(param_1 - param_2),&DAT_001022a0);
  printf((char *)(param_2 - param_1),&DAT_001022a0);
  printf((char *)(param_1 * param_2),&DAT_001022a0);
  printf((char *)(param_1 / param_2),&DAT_001022a0);
  printf((char *)(param_2 / param_1),&DAT_001022a0);
  printf((char *)-param_1,&DAT_001022a0);
  return 0x7b;
}
...
{
  printf((char *)(x + y),&DAT_001022a0);
  printf((char *)(x - y),&DAT_001022a0);
  printf((char *)(y - x),&DAT_001022a0);
  printf((char *)(x * y),&DAT_001022a0);
  printf((char *)(x / y),&DAT_001022a0);
  printf((char *)(y / x),&DAT_001022a0);
  printf((char *)-x,&DAT_001022a0);
  return 0x7b;
}
...
undefined8 FUN_00100bcc(double param_1)

{
  printf((char *)(param_1 + param_1),&DAT_001022a0);
  printf((char *)(param_1 * 3.0),&DAT_001022a0);
  printf((char *)(param_1 * 3.141592653589793),&DAT_001022a0);
  printf((char *)(param_1 * 10.0),&DAT_001022a0);
  printf((char *)(param_1 * 12.345),&DAT_001022a0);
  return 0x7d;
}
...
{
  printf((char *)(x + x),&DAT_001022a0);
  printf((char *)(x * 3.0),&DAT_001022a0);
  printf((char *)(x * 3.141592653589793),&DAT_001022a0);
  printf((char *)(x * 10.0),&DAT_001022a0);
  printf((char *)(x * 12.345),&DAT_001022a0);
  return 0x7d;
}
    ...
    if ((int)uVar11 < 1) {
      if (uVar11 != 0) {
        if (uVar16 == 0) {
          if ((uVar12 | uVar20) == 0) {
            uVar18 = uVar19;
            if (uVar17 != 0x7fff) goto LAB_00100e7c;
          }
          else {
            uVar11 = ~uVar11;
            if (uVar11 == 0) {
            ...
            if (uVar17 != 0x7fff) goto LAB_0010159c;
          }
        }
...
LAB_00101530:
      ...
      if (1 < (uVar1 & 0x7fff)) {
        ...
        if ((uVar2 & 0xc00000) == 0) goto LAB_001014e4;
        if ((uVar2 & 0xc00000) == 0x400000) {
          if (uVar19 == 0) goto LAB_001014e4;
...
LAB_00100fcc:
        ...
        if (uVar12 == 0x400000) {
          uVar14 = 0;
LAB_001010a4:
          if (uVar19 != 0) goto joined_r0x00100db4;
        }
        else {
          if (uVar12 != 0x800000) {
            if (uVar12 == 0) {
...
LAB_001010c4:
      ...
      if (uVar16 == 0) {
        ...
        if ((uVar13 | uVar21) == 0) goto LAB_00101690;
        uVar22 = uVar20 + uVar21;
        uVar13 = uVar12 + uVar13;
      ...
      if (uVar16 == 0x7fff) {
        if ((uVar12 | uVar20) == 0) {
          if (uVar17 == 0x7fff) goto LAB_00101654;
          goto LAB_00100fbc;
        }
        uVar11 = uVar5 >> 0x12 ^ 1;
        if (uVar17 == 0x7fff) goto LAB_00101658;
LAB_00101808:
        uVar22 = uVar13 | uVar21;
        uVar13 = uVar12;
        uVar16 = 0x7fff;
        uVar21 = uVar20;
        if (uVar22 == 0) goto LAB_00100fbc;
      }
      else {
        if (uVar17 != 0x7fff) {
LAB_00101640:
...
LAB_00101654:
        uVar11 = 0;
LAB_00101658:
        if ((uVar13 | uVar21) == 0) goto LAB_00101640;
...
LAB_00101004:
    ...
    if (uVar17 == 0) {
      if ((uVar13 | uVar21) != 0) {
        uVar11 = uVar11 - 1;
        if (uVar11 != 0) goto joined_r0x00100f74;
        uVar22 = uVar20 + uVar21;
        uVar13 = uVar12 + uVar13;
        uVar17 = uVar16;
        if (uVar22 <= uVar20 && uVar20 - uVar22 != 0) {
      ...
      uVar17 = uVar16;
      uVar21 = uVar20;
      if (uVar16 != 0x7fff) goto LAB_00100e7c;
      if ((uVar12 | uVar20) != 0) {
        uVar11 = uVar5 >> 0x12 ^ 1;
        goto LAB_00100fbc;
      }
...
joined_r0x00100f74:
      if (uVar16 == 0x7fff) goto LAB_00100ec4;
      if ((int)uVar11 < 0x75) {
        if ((int)uVar11 < 0x40) {
...
LAB_00101284:
      uVar18 = uVar19;
      uVar21 = uVar22;
      if ((uVar13 >> 0x33 & 1) == 0) goto LAB_00100e7c;
      if (uVar17 + 1 != 0x7fff) {
      ...
      if ((uVar2 & 0xc00000) != 0) {
        if ((uVar2 & 0xc00000) != 0x400000) goto LAB_001014bc;
        if (uVar19 != 0) {
          uVar13 = 0xffffffffffffffff;
          uVar16 = 0x7ffe;
          uVar11 = 0x14;
...
LAB_00100ec4:
    ...
    if (uVar14 == 0) {
      if (1 < (uVar16 + 1 & 0x7fff)) {
        ...
        if ((uVar15 >> 0x33 & 1) == 0) {
          if ((uVar22 | uVar15) == 0) goto LAB_00101248;
        }
        else {
      ...
      if (uVar16 != 0) {
        ...
        if (uVar16 == 0x7fff) {
          if ((uVar12 | uVar20) == 0) {
            if (uVar17 != 0x7fff) goto LAB_00101488;
          }
          else {
            uVar11 = uVar5 >> 0x12 ^ 1;
            if (uVar17 != 0x7fff) goto LAB_00101440;
          }
LAB_001016e0:
          if ((uVar13 | uVar21) == 0) {
            uVar13 = uVar12;
            uVar21 = uVar20;
            if ((uVar12 | uVar20) == 0) goto LAB_00101794;
          }
          else {
            if ((uVar22 & 0x4000000000000) == 0) {
              uVar11 = 1;
            ...
            uVar16 = uVar18;
            if ((uVar12 | uVar20) != 0) goto LAB_00101444;
          }
LAB_00101700:
          uVar19 = uVar16;
          uVar16 = 0x7fff;
          ...
          if (uVar17 == 0x7fff) goto LAB_001016e0;
          if ((uVar12 | uVar20) == 0) {
LAB_00101488:
            if ((uVar13 | uVar21) != 0) {
              uVar11 = 0;
...
LAB_00101248:
      ...
      if (uVar16 == 0) {
        if ((uVar12 | uVar20) == 0) {
          ...
          if (uVar17 != 0x7fff) goto LAB_001011f0;
        }
LAB_00101524:
        if ((uVar13 | uVar21) != 0) {
          uVar11 = uVar8 >> 0x12 ^ 1;
      ...
      if (uVar17 == 0x7fff) goto LAB_00101524;
      uVar14 = -uVar14;
      uVar12 = uVar12 | 0x8000000000000;
LAB_001011f0:
      if ((int)uVar14 < 0x75) {
...
LAB_00100d9c:
        uVar12 = uVar2 & 0xc00000;
        uVar11 = uVar11 | 0x10;
        if (uVar12 == 0x400000) goto LAB_001010a4;
        if (uVar12 == 0x800000) goto LAB_001010c4;
        if (uVar12 == 0) goto LAB_00100fe4;
joined_r0x00100db4:
        if (uVar14 == 0) goto LAB_00101004;
        uVar12 = uVar13 & 0x8000000000000;
        uVar11 = uVar11 | 8;
        goto LAB_00100dc4;
      }
...
LAB_00100dc4:
    if (uVar12 == 0) goto LAB_00100ed8;
    uVar16 = uVar16 + 1;
    if (uVar16 != 0x7fff) {
      uVar21 = uVar21 >> 3 | uVar13 << 0x3d;
      goto joined_r0x00100f1c;
    }
...
LAB_00101c80:
          ...
          if (uVar6 == 0x800000) {
            ...
            uVar1 = uVar7;
            if (uVar6 == 0) {
              if ((uVar7 & 0xf) == 4) goto joined_r0x00101c78;
              uVar6 = uVar7 + 4;
              goto joined_r0x00101d84;
            }
          }
          uVar7 = uVar1;
          if (uVar5 != 0) goto LAB_00101c80;
LAB_00101b9c:
          uVar5 = (uint)uVar7;
        }
        if ((uVar5 >> 0x1a & 1) == 0) goto LAB_00101c84;
        uVar9 = uVar9 + 1;
        if (uVar9 != 0xff) {
          uVar10 = (uint)(uVar7 >> 3) & 0x7fffff | ((uint)uVar9 & 0xff) << 0x17 |
                   iVar3 * -0x80000000;
          goto joined_r0x00101bd0;
        }
        uVar2 = uVar2 & 0xc00000;
        uVar5 = 0;
        if (uVar2 != 0) {
