    ...
    if ((int)uVar6 < 1) {
      if (uVar6 != 0) {
        if (uVar15 == 0) {
          if ((uVar12 | uVar19) == 0) {
            uVar17 = uVar18;
            if (uVar16 != 0x7fff) goto LAB_00100fa4;
          }
          else {
            uVar6 = ~uVar6;
            if (uVar6 == 0) {
            ...
            if (uVar16 != 0x7fff) goto LAB_001016c4;
          }
        }
...
LAB_00101658:
      ...
      if (1 < (uVar1 & 0x7fff)) {
        ...
        if ((uVar2 & 0xc00000) == 0) goto LAB_0010160c;
        if ((uVar2 & 0xc00000) == 0x400000) {
          if (uVar18 == 0) goto LAB_0010160c;
...
LAB_001010f4:
        ...
        if (uVar12 == 0x400000) {
          bVar9 = false;
LAB_001011cc:
          if (uVar18 != 0) goto joined_r0x00100edc;
        }
        else {
          if (uVar12 != 0x800000) {
            if (uVar12 == 0) {
...
LAB_001011ec:
      ...
      if (uVar15 == 0) {
        ...
        if ((uVar13 | uVar20) == 0) goto LAB_001017b8;
        uVar21 = uVar19 + uVar20;
        uVar13 = uVar12 + uVar13;
      ...
      if (uVar15 == 0x7fff) {
        if ((uVar12 | uVar19) == 0) {
          if (uVar16 == 0x7fff) goto LAB_0010177c;
          goto LAB_001010e4;
        }
        uVar11 = uVar5 >> 0x12 ^ 1;
        if (uVar16 == 0x7fff) goto LAB_00101780;
LAB_00101930:
        uVar21 = uVar13 | uVar20;
        uVar13 = uVar12;
        uVar15 = 0x7fff;
        uVar20 = uVar19;
        if (uVar21 == 0) goto LAB_001010e4;
      }
      else {
        if (uVar16 != 0x7fff) {
LAB_00101768:
...
LAB_0010177c:
        uVar11 = 0;
LAB_00101780:
        if ((uVar13 | uVar20) == 0) goto LAB_00101768;
...
LAB_0010112c:
    ...
    if (uVar16 == 0) {
      if ((uVar13 | uVar20) != 0) {
        uVar6 = uVar6 - 1;
        if (uVar6 != 0) goto joined_r0x0010109c;
        uVar21 = uVar19 + uVar20;
        uVar13 = uVar12 + uVar13;
        uVar16 = uVar15;
        if (uVar21 <= uVar19 && uVar19 - uVar21 != 0) {
      ...
      uVar16 = uVar15;
      uVar20 = uVar19;
      if (uVar15 != 0x7fff) goto LAB_00100fa4;
      if ((uVar12 | uVar19) != 0) {
        uVar11 = uVar5 >> 0x12 ^ 1;
        goto LAB_001010e4;
      }
...
joined_r0x0010109c:
      if (uVar15 == 0x7fff) goto LAB_00100fec;
      if ((int)uVar6 < 0x75) {
        if ((int)uVar6 < 0x40) {
...
LAB_001013ac:
      uVar17 = uVar18;
      uVar20 = uVar21;
      if ((uVar13 >> 0x33 & 1) == 0) goto LAB_00100fa4;
      if (uVar16 + 1 != 0x7fff) {
      ...
      if ((uVar2 & 0xc00000) != 0) {
        if ((uVar2 & 0xc00000) != 0x400000) goto LAB_001015e4;
        if (uVar18 != 0) {
          uVar13 = 0xffffffffffffffff;
          uVar15 = 0x7ffe;
          uVar11 = 0x14;
...
LAB_00100fec:
    ...
    if (uVar6 == 0) {
      if (1 < (uVar15 + 1 & 0x7fff)) {
        ...
        if ((uVar14 >> 0x33 & 1) == 0) {
          if ((uVar21 | uVar14) == 0) goto LAB_00101370;
        }
        else {
      ...
      if (uVar15 != 0) {
        ...
        if (uVar15 == 0x7fff) {
          if ((uVar12 | uVar19) == 0) {
            if (uVar16 != 0x7fff) goto LAB_001015b0;
          }
          else {
            uVar11 = uVar5 >> 0x12 ^ 1;
            if (uVar16 != 0x7fff) goto LAB_00101568;
          }
LAB_00101808:
          if ((uVar13 | uVar20) == 0) {
            uVar13 = uVar12;
            uVar20 = uVar19;
            if ((uVar12 | uVar19) == 0) goto LAB_001018bc;
          }
          else {
            if ((uVar21 & 0x4000000000000) == 0) {
              uVar11 = 1;
            ...
            uVar15 = uVar17;
            if ((uVar12 | uVar19) != 0) goto LAB_0010156c;
          }
LAB_00101828:
          uVar18 = uVar15;
          uVar15 = 0x7fff;
          ...
          if (uVar16 == 0x7fff) goto LAB_00101808;
          uVar11 = 0;
          if ((uVar12 | uVar19) == 0) {
LAB_001015b0:
            if ((uVar13 | uVar20) != 0) {
...
LAB_00101370:
      ...
      if (uVar15 == 0) {
        if ((uVar12 | uVar19) == 0) {
          ...
          if (uVar16 != 0x7fff) goto LAB_00101318;
        }
LAB_0010164c:
        if ((uVar13 | uVar20) != 0) {
          uVar11 = uVar11 >> 0x12 ^ 1;
      ...
      if (uVar16 == 0x7fff) goto LAB_0010164c;
      uVar6 = -uVar6;
      uVar12 = uVar12 | 0x8000000000000;
LAB_00101318:
      if ((int)uVar6 < 0x75) {
...
LAB_00100ec4:
        uVar12 = uVar2 & 0xc00000;
        uVar11 = uVar11 | 0x10;
        if (uVar12 == 0x400000) goto LAB_001011cc;
        if (uVar12 == 0x800000) goto LAB_001011ec;
        if (uVar12 == 0) goto LAB_0010110c;
joined_r0x00100edc:
        if (!bVar9) goto LAB_0010112c;
        uVar12 = uVar13 & 0x8000000000000;
        uVar11 = uVar11 | 8;
        goto LAB_00100eec;
      }
...
LAB_00100eec:
    if (uVar12 == 0) goto LAB_00101000;
    if (uVar15 != 0x7ffe) {
      uVar20 = uVar20 >> 3 | uVar13 << 0x3d;
      goto joined_r0x00101044;
    }
...
LAB_00101d40:
    ...
    if (lVar8 < 1) {
      ...
      lVar8 = 0;
      uVar3 = 0;
      if (((uint)uVar1 >> 0xb & 1) == 0) goto LAB_00101dac;
      goto LAB_00101da8;
    }
    uVar3 = 0;
