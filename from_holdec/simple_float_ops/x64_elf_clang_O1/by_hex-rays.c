...
__int64 __fastcall compare_floats(__m128d, __m128d x, double y);
...
__int64 __fastcall compare_floats(__m128d a1, __m128d x, double y)
{
  ...
  use_int(*(_OWORD *)&_mm_cmpeq_sd(a1, x) & 1);
  v3.m128d_f64[0] = x.m128d_f64[0];
  use_int(*(_OWORD *)&_mm_cmpneq_sd((__m128d)*(unsigned __int64 *)&a1.m128d_f64[0], v3) & 1);
...
// 40076C: variable 'v3' is possibly undefined
