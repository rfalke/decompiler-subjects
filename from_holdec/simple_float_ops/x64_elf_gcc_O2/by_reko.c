...
void read_ints()
{
	uint128 xmm0_39 = (uint128) (real64) g_qw601050;
	printf("%f", SEQ(SLICE(xmm0_39, word64, 64), (real64) xmm0_39 + (((real64) ((uint128) ((real64) g_dw601060)) + ((real64) ((uint128) ((real64) ((int32) g_w601064))) + (real64) ((uint128) ((real64) ((uint128) ((real64) ((int32) g_b601066))) + 0.0)))) + (real64) ((uint128) ((real64) g_qw601058)))));
}
