...

{
  ...
  use((double)(int)global_char + (double)(int)global_short + (double)SUB168(auVar1,0) +
...
LAB_00401988:
          ...
          if (uVar6 == 0x800000) {
            ...
            uVar7 = uVar8;
            if (uVar6 == 0) {
              if ((uVar8 & 0xf) == 4) goto joined_r0x00401980;
              uVar6 = uVar8 + 4;
              goto joined_r0x00401a8c;
            }
          }
          uVar8 = uVar7;
          if (uVar10 != 0) goto LAB_00401988;
LAB_004018a4:
          uVar10 = (uint)uVar8;
        }
