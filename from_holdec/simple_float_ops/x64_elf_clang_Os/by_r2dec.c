...
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400400 */
#include <stdint.h>
 
void entry0 (int64_t arg3) {
    rdx = arg3;
    /* [13] -r-x section size 1314 named .text */
    ebp = 0;
    r9 = rdx;
    rdx = rsp;
    r8 = __libc_csu_fini;
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400430 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400470 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4004b0 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4004d0 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400920 */
#include <stdint.h>
 
void libc_csu_fini (void) {
}
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400623 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4005ed */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4007dc */
#include <stdint.h>
...
int32_t dbg_constants (double x) {
    ...
    *(rsp) = xmm0;
    ...
    printf (0x400970);
    xmm0 = *(rsp);
    __asm ("mulsd xmm0, qword [0x00400968]");
    al = 1;
    printf (0x400970);
    eax = 0x7d;
    return eax;
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4003f0 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400571 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4005a1 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400668 */
#include <stdint.h>
...
int32_t dbg_basic_operations (double x, double y) {
    ...
    *((rsp + 8)) = xmm1;
    ...
    printf (0x400970);
    __asm ("movapd xmm0, xmmword [rsp + 0x10]");
    __asm ("xorpd xmm0, xmmword [0x00400940]");
    al = 1;
    printf (0x400970);
    eax = 0x7b;
    return eax;
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400924 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4004f8 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x40064e */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400724 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400504 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400630 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400612 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4008b0 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x40085d */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x40065b */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400641 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x4003c8 */
#include <stdint.h>
...
/* r2dec pseudo code output */
/* SUBJECTS/from_holdec/simple_float_ops/x64_elf_clang_Os/subject.exe @ 0x400514 */
#include <stdint.h>
