...

{
  printf((char *)(double)(global_long_double._0_10_ +
                         (float10)((double)global_float + 0.00000000 + global_double)),&DAT_00400970
        );
  return 0x7a;
}
...

{
  ...
  printf((char *)(x * 3.00000000),&DAT_00400970);
  printf((char *)(x * 3.14159265),&DAT_00400970);
  printf((char *)(x * 10.00000000),&DAT_00400970);
  printf((char *)(x * 12.34500000),&DAT_00400970);
  return 0x7d;
}
