...

{
  ...
  use((double)((float10)((double)global_float + 0.00000000 + global_double) +
              global_long_double._0_10_));
  return 0x7a;
}
...

{
  ...
  use(x / y);
  use(y / x);
  use((double)((ulong)x ^ 0x8000000000000000));
  return 0x7b;
}
