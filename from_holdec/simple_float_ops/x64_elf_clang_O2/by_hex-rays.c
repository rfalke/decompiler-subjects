...
__int64 __fastcall compare_floats(__m128d a1, __m128d x, double y)
{
  ...
  printf("%d", (unsigned __int8)*(_OWORD *)&_mm_cmpeq_sd(a1, x) & 1);
  v3.m128d_f64[0] = x.m128d_f64[0];
  printf("%d", (unsigned __int8)*(_OWORD *)&_mm_cmpneq_sd((__m128d)*(unsigned __int64 *)&a1.m128d_f64[0], v3) & 1);
...
// 4007A3: variable 'v3' is possibly undefined
