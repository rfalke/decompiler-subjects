...
long basic_operations() {
    ...
    →printf((char*)&gvar_4009D0);
    →printf((char*)&gvar_4009D0);
    →printf((char*)&gvar_4009D0, v0, v1, v2, v3, v4);
    return 123L;
}
...
long compare_floats(long param0, long param1) {
    ...
    →printf((char*)&gvar_4009D3, (unsigned long)((unsigned int)v1 & 0x1), param1, param0);
    long v4 = cmpneqsd(v0, v2);
    →printf((char*)&gvar_4009D3);
    →printf((char*)&gvar_4009D3);
    /*BAD_CALL!*/ →printf((char*)&gvar_4009D3);
    →printf((char*)&gvar_4009D3);
    →printf((char*)&gvar_4009D3, (v2 == v0 ? 0: v2 <= v0 ? 0L: 1L) & 0xffffffffL, param1);
    return 124L;
}

long constants(long param0, long param1) {
    →printf((char*)&gvar_4009D0, param1);
    →printf((char*)&gvar_4009D0);
    →printf((char*)&gvar_4009D0);
    →printf((char*)&gvar_4009D0);
    →printf((char*)&gvar_4009D0, param1);
...
long main() {
    ...
    →printf((char*)0x4009DE, 4L, 8L, 16L);
    return 0L;
}

long read_floats(long param0, long param1, long param2, long param3) {
    →printf((char*)&gvar_4009D0, param1, param2, param3);
    return 122L;
}
