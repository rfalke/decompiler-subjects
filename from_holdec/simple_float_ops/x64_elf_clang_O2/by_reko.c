...
Eq_133 g_t4009A0 = // 00000000004009A0
	{
...
// 00000000004005B0: void read_floats(Register Eq_133 xmm1)
void read_floats(Eq_133 xmm1)
{
	printf("%f", (uint128) ((real64) g_r601060 + (((real64) __xorpd(xmm1, xmm1) + (real64) ((real32) ((uint128) g_r601048))) + global_double)));
}
...
{
	g_r601048 = (real32) (real64) (uint128) global_double;
}
...
{
	global_double = (real64) (real32) (uint128) g_r601048;
}
...
// 00000000004006B0: void basic_operations(Register Eq_133 xmm0, Register word128 xmm1)
