...
{
	printf("%f", (uint128) (uint64) ((real64) g_r601060 + (((real64) __xorpd(xmm1, xmm1) + (real64) ((uint128) ((uint32) g_r601048))) + g_r601050)));
}
