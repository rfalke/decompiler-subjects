...
{
  printf("%f",(double)global_long_long +
              (double)global_long +
...
{
  printf("%f",param_1 + param_2);
  printf("%f",param_1 - param_2);
  printf("%f",param_2 - param_1);
  printf("%f",param_1 * param_2);
  printf("%f",param_1 / param_2);
  printf("%f",param_2 / param_1);
  printf("%f",-param_1);
...
{
  printf("%f",param_1 + param_1);
  printf("%f",param_1 * 3.0);
  printf("%f",param_1 * 3.141592653589793);
  printf("%f",param_1 * 10.0);
  printf("%f",param_1 * 12.345);
  return 0x7d;
}
      ...
      if (uVar6 != 0) {
        if (uVar15 == 0) {
          if ((uVar12 | uVar19) == 0) {
            ...
            if (uVar16 != 0x7fff) goto LAB_0010159c;
          }
        }
...
LAB_00100fcc:
        ...
        if (uVar12 == 0x400000) {
          bVar9 = false;
LAB_001010a4:
          if (uVar18 != 0) goto joined_r0x00100db4;
        }
        else {
          if (uVar12 != 0x800000) {
            if (uVar12 == 0) {
...
LAB_001010c4:
      ...
      if (uVar15 == 0) {
        ...
        if ((uVar13 | uVar20) == 0) goto LAB_00101690;
        uVar21 = uVar19 + uVar20;
        uVar13 = uVar12 + uVar13;
      ...
      if (uVar15 == 0x7fff) {
        if ((uVar12 | uVar19) == 0) {
          if (uVar16 == 0x7fff) goto LAB_00101654;
          goto LAB_00100fbc;
        }
        uVar11 = uVar5 >> 0x12 ^ 1;
        if (uVar16 == 0x7fff) goto LAB_00101658;
LAB_00101808:
        uVar21 = uVar13 | uVar20;
        uVar13 = uVar12;
        uVar15 = 0x7fff;
        uVar20 = uVar19;
        if (uVar21 == 0) goto LAB_00100fbc;
      }
      else {
        if (uVar16 != 0x7fff) {
LAB_00101640:
...
LAB_00101654:
        uVar11 = 0;
LAB_00101658:
        if ((uVar13 | uVar20) == 0) goto LAB_00101640;
...
LAB_00101004:
    ...
    if (uVar16 == 0) {
      if ((uVar13 | uVar20) != 0) {
        uVar6 = uVar6 - 1;
        if (uVar6 != 0) goto joined_r0x00100f74;
        uVar21 = uVar19 + uVar20;
        uVar13 = uVar12 + uVar13;
        uVar16 = uVar15;
        if (uVar21 <= uVar19 && uVar19 - uVar21 != 0) {
      ...
      uVar16 = uVar15;
      uVar20 = uVar19;
      if (uVar15 != 0x7fff) goto LAB_00100e7c;
      if ((uVar12 | uVar19) != 0) {
        uVar11 = uVar5 >> 0x12 ^ 1;
        goto LAB_00100fbc;
      }
...
joined_r0x00100f74:
      if (uVar15 == 0x7fff) goto LAB_00100ec4;
      if ((int)uVar6 < 0x75) {
        if ((int)uVar6 < 0x40) {
...
LAB_00100ec4:
    ...
    if (uVar6 == 0) {
      if (1 < (uVar15 + 1 & 0x7fff)) {
        ...
        if ((uVar14 >> 0x33 & 1) == 0) {
          if ((uVar21 | uVar14) == 0) goto LAB_00101248;
        }
        else {
      ...
      if (uVar15 != 0) {
        ...
        if (uVar15 == 0x7fff) {
          if ((uVar12 | uVar19) == 0) {
            if (uVar16 != 0x7fff) goto LAB_00101488;
          }
          else {
            uVar11 = uVar5 >> 0x12 ^ 1;
            if (uVar16 != 0x7fff) goto LAB_00101440;
          }
LAB_001016e0:
          if ((uVar13 | uVar20) == 0) {
            uVar13 = uVar12;
            uVar20 = uVar19;
            if ((uVar12 | uVar19) == 0) goto LAB_00101794;
          }
          else {
            if ((uVar21 & 0x4000000000000) == 0) {
              uVar11 = 1;
            ...
            uVar15 = uVar17;
            if ((uVar12 | uVar19) != 0) goto LAB_00101444;
          }
LAB_00101700:
          uVar18 = uVar15;
          uVar15 = 0x7fff;
          ...
          if (uVar16 == 0x7fff) goto LAB_001016e0;
          uVar11 = 0;
          if ((uVar12 | uVar19) == 0) {
LAB_00101488:
            if ((uVar13 | uVar20) != 0) {
...
LAB_00101248:
      ...
      if (uVar15 == 0) {
        if ((uVar12 | uVar19) == 0) {
          ...
          if (uVar16 != 0x7fff) goto LAB_001011f0;
        }
LAB_00101524:
        if ((uVar13 | uVar20) != 0) {
          uVar11 = uVar11 >> 0x12 ^ 1;
...
LAB_00101b9c:
        ...
        if ((uVar10 >> 0x1a & 1) == 0) goto LAB_00101c84;
        if (lVar8 + 1 != 0xff) {
...
LAB_00101c18:
    ...
    if (lVar8 < 1) {
      ...
      lVar8 = 0;
      uVar3 = 0;
      if (((uint)uVar1 >> 0xb & 1) == 0) goto LAB_00101c84;
      goto LAB_00101c80;
    }
    uVar3 = 0;
