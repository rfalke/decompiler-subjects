...

{
  printf((char *)((double)global_long_long +
                 (double)global_long +
                 (double)global_int +
                 (double)(int)global_short + (double)(int)global_char + 0.00000000),&DAT_001022a0,
         global_long,global_long_long,(longlong)global_short);
  return 0x78;
}
...

{
  ...
  uVar1 = __extenddftf2((double)global_float + 0.00000000 + global_double);
...
{
  printf("%d",(ulonglong)(x == y));
  printf("%d",(ulonglong)(x != y));
  printf("%d",(ulonglong)(y < x));
  printf("%d",(ulonglong)(y <= x));
  printf("%d",(ulonglong)(x < y));
  printf("%d",(ulonglong)(x <= y));
  return 0x7c;
...

{
  ...
  printf((char *)(param_1 * 3.00000000),&DAT_001022a0);
  printf((char *)(param_1 * 3.14159265),&DAT_001022a0);
  printf((char *)(param_1 * 10.00000000),&DAT_001022a0);
  printf("%f");
  return 0x7d;
}
...

{
  ...
  printf((char *)(x * 3.00000000),&DAT_001022a0);
  printf((char *)(x * 3.14159265),&DAT_001022a0);
  printf((char *)(x * 10.00000000),&DAT_001022a0);
  printf((char *)(x * 12.34500000),&DAT_001022a0);
  return 0x7d;
}
...
LAB_00101c80:
          ...
          if (uVar6 == 0x800000) {
            ...
            uVar7 = uVar8;
            if (uVar6 == 0) {
              if ((uVar8 & 0xf) == 4) goto joined_r0x00101c78;
              uVar6 = uVar8 + 4;
              goto joined_r0x00101d84;
            }
          }
          uVar8 = uVar7;
          if (uVar10 != 0) goto LAB_00101c80;
LAB_00101b9c:
          uVar10 = (uint)uVar8;
        }
