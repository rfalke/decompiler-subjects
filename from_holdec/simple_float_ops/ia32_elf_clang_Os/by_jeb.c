...
int constants(double param0, int param1) {
    ...
    *(double*)&v0 = param0 * 12.345;
    →printf((char*)&gvar_8048930, v0, v1);
    return 125;
}
...
int read_floats() {
    ...
    *(long long*)&v1 = v6 + *(double*)&v0;
    →printf((char*)&gvar_8048930, v1, v2, v3, v0, v4, v5);
    return 122;
}
...
int use(long long param0, int param1) {
    ...
    int v1;
    *(long long*)&v0 = param0;
    return →printf((char*)&gvar_8048930, v0, v1);
}
...
int use_int(int param0) {
    ...
    int v3;
    int v4;
    return →printf((char*)&gvar_8048933, param0, v0, v1, v2, v3, v4);
}
