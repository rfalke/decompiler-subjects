...
// 08048520: void read_floats(Register Eq_133 xmm1)
void read_floats(Eq_133 xmm1)
{
	printf("%f", (real64) g_r804A048 + (((real64) __xorpd(xmm1, xmm1) + (real64) ((real32) ((uint128) global_float))) + g_r804A040));
}
...
{
	global_float = (real32) (real64) (uint128) g_r804A040;
}
...
// 08048710: void compare_floats(Stack Eq_276 rArg04, Stack Eq_277 rArg0C)
void compare_floats(Eq_276 rArg04, Eq_277 rArg0C)
{
