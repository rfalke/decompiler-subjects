...
// 08048520: void read_floats(Register Eq_125 xmm1)
...
void basic_operations(real64 rArg04, real64 rArg0C)
{
	...
	printf("%f", rArg04 / rArg0C);
	printf("%f", rArg0C / rArg04);
	printf("%f", __movlpd(__xorpd(SEQ(0x00, rArg04), g_t8048960)));
}

// 08048710: void compare_floats(Stack Eq_239 rArg04, Stack Eq_239 rArg0C)
