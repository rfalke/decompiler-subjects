...
// 00000000004005B0: void read_floats(Register Eq_218 xmm1)
void read_floats(Eq_218 xmm1)
{
	printf("%f", DPB(xmm0, (real64) globals->r601060 + (((real64) __xorpd(xmm1, xmm1) + DPB(xmm0, (real64) DPB(xmm0, globals->r601048, 0), 0)) + globals->r601050), 0));
}
...
// 00000000004006B0: void basic_operations(Register Eq_218 xmm0, Register Eq_327 xmm1)
void basic_operations(Eq_218 xmm0, Eq_327 xmm1)
{
...
// 0000000000400830: void constants(Register Eq_391 xmm0)
void constants(Eq_391 xmm0)
{
