...

{
  ...
  use((double)CONCAT44(SUB84((double)global_long_long,0),in_stack_fffffff0));
  return 0x78;
}
...

{
  ...
  use((double)CONCAT44(SUB84((double)global_float + 0.0 + global_double,0),in_stack_fffffff0));
  return 0x7a;
}
...

{
  ...
  use((double)CONCAT44(in_stack_00000004,unaff_retaddr));
  use((double)CONCAT44(in_stack_00000004,unaff_retaddr));
  use((double)CONCAT44(in_stack_00000004,unaff_retaddr));
  use((double)CONCAT44(in_stack_00000004,unaff_retaddr));
  use((double)CONCAT44(in_stack_00000004,unaff_retaddr));
