...
{
	use((real64) g_r804A048 + (((real64) __xorpd(xmm1, xmm1) + (real64) ((real32) ((uint128) global_float))) + g_r804A040));
}
...
// 080486C0: void compare_floats(Stack Eq_250 rArg04, Stack Eq_251 rArg0C)
void compare_floats(Eq_250 rArg04, Eq_251 rArg0C)
{
