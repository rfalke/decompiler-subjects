...

{
  ...
  auVar1 = SIMD_INT_SEXT((ulonglong)(uint)global_int,4);
  printf((char *)((double)(int)global_char + (double)(int)global_short + (double)SUB168(auVar1,0) +
...

{
  ...
  uVar2 = global_long_double._0_8_;
  uVar1 = __extenddftf2(SUB84(global_double + (double)global_float + 0.00000000,0),global_double);
  __addtf3((int)uVar2,uVar1);
  __trunctfdf2();
  printf("%f");
  return 0x7a;
}
...

{
  ...
  bVar1 = x < y;
  bVar2 = x == y;
  printf("%d",(ulonglong)bVar2);
  printf("%d",(ulonglong)!bVar2);
  printf("%d",(ulonglong)(!bVar2 && !bVar1));
  printf("%d",(ulonglong)!bVar1);
  printf("%d",(ulonglong)bVar1);
...

{
  ...
  printf((char *)(x * 3.00000000),&DAT_00402038);
  printf((char *)(x * 3.14159265),&DAT_00402038);
  printf((char *)(x * 10.00000000),&DAT_00402038);
  printf((char *)(x * 12.34500000),&DAT_00402038);
  return 0x7d;
}
...
LAB_00401a08:
          ...
          if (uVar6 == 0x800000) {
            ...
            uVar7 = uVar8;
            if (uVar6 == 0) {
              if ((uVar8 & 0xf) == 4) goto joined_r0x00401a00;
              uVar6 = uVar8 + 4;
              goto joined_r0x00401b0c;
            }
          }
          uVar8 = uVar7;
          if (uVar10 != 0) goto LAB_00401a08;
LAB_00401924:
          uVar10 = (uint)uVar8;
        }
