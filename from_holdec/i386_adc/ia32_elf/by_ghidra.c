...
uint carry(byte param_1,char param_2)

{
  return (uint)((byte)(param_2 + param_1) < param_1);
}
...

{
  ...
  uVar1 = param_1 >> 7 & 1;
  return ((param_1 + param_2 & 0xffffff00 | param_1 + param_2 >> 7 & 1) ^
         (param_1 & 0xffffff00 | uVar1)) & (uint)(((byte)(param_2 >> 7) & 1) == (byte)uVar1);
}
