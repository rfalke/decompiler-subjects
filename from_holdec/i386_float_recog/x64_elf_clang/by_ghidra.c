...
undefined8 unknown_to_unknown(ulong param_1)

{
  printf("got a double with      0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x\n",
         param_1 >> 0x38,param_1 >> 0x30 & 0xff,param_1 >> 0x28 & 0xff,param_1 >> 0x20 & 0xff,
         (param_1 & 0xffffffff) >> 0x18,(param_1 & 0xffffffff) >> 0x10 & 0xff,param_1 >> 8 & 0xff,
         param_1 & 0xff);
  return 0;
}
...
undefined8 double_to_unknown(ulong param_1)
