...
void _start(void (* edx)(), int32 dwArg00, char * ptrArg04)
{
	...
	__libc_start_main(&g_t8049280, dwArg00, &ptrArg04, &g_t8049370, &g_t80493D0, edx, fp);
	__halt();
}
