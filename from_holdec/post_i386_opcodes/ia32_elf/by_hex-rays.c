...
// 805A014: using guessed type char _bss_start;
...
// nfuncs=312 queued=310 decompiled=310 lumina nreq=0 worse=0 better=0
#error "There were 1 decompilation failure(s) on 310 function(s)"
