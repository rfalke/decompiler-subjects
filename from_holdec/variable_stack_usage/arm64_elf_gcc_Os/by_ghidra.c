...
// WARNING: Removing unreachable block (ram,0x00100788)
...

{
  ...
  use((int *)(&stack0xffffffffffffffd0 + lVar1),(&stack0xffffffffffffffd0)[lVar1]);
...
void FUN_00100944(void)

{
  code *UNRECOVERED_JUMPTABLE;
  
                    // WARNING: Could not recover jumptable at 0x00100944. Too many branches
                    // WARNING: Treating indirect jump as call
  UNRECOVERED_JUMPTABLE = (code *)UndefinedInstructionException(0,0x100944);
