...

{
  ...
  dest = (undefined8 ***)((long)&local_30 - ((ulong)(uint)n * 4 + 0xf & 0x7fffffff0));
  local_24 = 8;
  local_30 = dest;
  fill((int *)dest,n,*(undefined *)dest);
  use(&local_18,*(undefined *)dest);
  use((int *)local_30,*(undefined *)dest);
  use(&local_24,*(undefined *)dest);
  return;
}



// WARNING: Variable defined which should be unmapped: dynamic
// WARNING: Variable defined which should be unmapped: fixed1
...

{
  ...
  fixed2 = n;
  local_18 = 7;
  dest = (int *)((long)aiStack48 - ((long)n * 4 + 0xfU & 0xfffffffffffffff0));
  local_20 = dest;
  aiStack48[3] = 8;
  fill(dest,n,*(undefined *)dest);
  use(&local_18,*(undefined *)dest);
  use(local_20,*(undefined *)dest);
  use(aiStack48 + 3,*(undefined *)dest);
  return;
}
