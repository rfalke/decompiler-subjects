...
word64 with_alloca(word64 x8_32_32_w0, word32 x1_32_32, ptr64 & x9Out, union Eq_158 & w19Out)
{
	...
	word64 x1_36 = fill(fp + ~0x27, SEQ(x1_32_32, w0));
	use(fp - 0x1C);
	use(fp + ~0x27);
	x9Out = use(fp - 0x20);
	w19Out.u0 = <invalid>;
...
void main(word64 x8_32_32_w0, word32 x1_32_32)
{
	...
	word64 x9_29;
	word32 w19_64;
	with_array(SEQ(SLICE(x9_29, word32, 32), (word32) x19_25), SLICE(with_alloca(x8_32_32_w0, x1_32_32, out x9_29, out w19_64), word32, 32));
}
