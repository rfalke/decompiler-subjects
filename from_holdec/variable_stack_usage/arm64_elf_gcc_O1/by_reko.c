...
// 0000000000000850: void fill(Register (ptr64 void) x0, Register word64 x1)
// Called from:
//      with_array
//      with_alloca
void fill(void * x0, word64 x1)
{
	word32 x1_32_32_13 = SLICE(x1, word32, 32);
	memset(x0, SEQ(x1_32_32_13, 0x78), __sbfiz(x1, 2));
}
...
word64 with_alloca(word64 x0, word32 x1_32_32, ptr64 & x1Out)
{
	...
	use(fp + -0x0A);
	x1Out = use(fp);
	return SEQ(SLICE(fp, word32, 32), w0_38);
}
