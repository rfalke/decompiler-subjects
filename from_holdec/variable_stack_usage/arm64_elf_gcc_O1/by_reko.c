...
void with_array(word64 x0, word32 x1_32_32)
{
	...
	__sbfiz(x0, 2);
	struct Eq_126 * x29_31 = fill(SEQ(x1_32_32, w0_21));
	use((char *) &x29_31->ptr0010 + 28);
	word32 * sp_26 = (word32 *) <invalid>;
	use(sp_26);
	use(&x29_31->ptr0010 + 3);
}

// 00000000000008CC: Register word64 with_alloca(Register word64 x0, Register word32 x1_32_32, Register out ptr64 x1Out, Register out ptr64 x19Out)
// Called from:
//      main
word64 with_alloca(word64 x0, word32 x1_32_32, ptr64 & x1Out, ptr64 & x19Out)
{
	word32 w0_21 = (word32) x0;
	__sbfiz(x0, 2);
	struct Eq_126 * x29_31 = fill(SEQ(x1_32_32, w0_21));
	...
	word32 * sp_26 = (word32 *) <invalid>;
	use(sp_26);
	ptr64 x1_44 = use(&x29_31->ptr0010 + 3);
	ptr64 x19_46 = x29_31->ptr0010;
	x1Out = x1_44;
	x19Out = x19_46;
	return SEQ(SLICE(&x29_31->ptr0010 + 3, word32, 32), w0_42);
}
...
void main(word64 x0, word32 x1_32_32)
{
	word64 x1_19;
	word64 x19_22;
	with_array(SEQ(SLICE(with_alloca(x0, x1_32_32, out x1_19, out x19_22), word32, 32), (word32) x19_22), SLICE(x1_19, word32, 32));
}
