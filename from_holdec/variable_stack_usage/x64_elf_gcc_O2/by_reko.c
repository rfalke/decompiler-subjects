...
// 0000000000400420: void _start(Register (ptr64 Eq_16) rdx, Stack Eq_17 qwArg00)
...
void with_alloca(word32 edi)
{
	...
	g_dw601028 = g_dw601028 + 0x0F + *memset((word64) ((fp - 8) - ((rdx_5 << 0x02) + 0x1E & ~0x0F)) + 0x0F & ~0x0F, 0x78, rdx_5 << 0x02);
}
