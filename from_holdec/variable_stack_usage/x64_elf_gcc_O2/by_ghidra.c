...
// WARNING: Removing unreachable block (ram,0x00400465)
// WARNING: Removing unreachable block (ram,0x0040046f)
...
// WARNING: Removing unreachable block (ram,0x004004b3)
// WARNING: Removing unreachable block (ram,0x004004bd)
...

{
  ...
  *(undefined8 *)((long)&uStack32 + lVar1) = 0x400586;
  memset((ulong)(auStack21 + lVar1) & 0xfffffffffffffffc,0x78,(long)n * 4,
