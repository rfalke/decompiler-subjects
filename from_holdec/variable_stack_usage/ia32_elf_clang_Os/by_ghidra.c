...

{
  ...
  *(int **)((int)&piStack48 + iVar1) = 0x8048470;
  fill(*(int **)((int)aiStack44 + iVar1),*(int *)((int)aiStack44 + iVar1 + 4));
  *(undefined4 **)((int)aiStack44 + iVar1) = &local_14;
  *(int **)((int)&piStack48 + iVar1) = 0x804847c;
  use(*(int **)((int)aiStack44 + iVar1));
  *(undefined **)((int)aiStack44 + iVar1) = auStack28 + iVar1;
  *(int **)((int)&piStack48 + iVar1) = 0x8048485;
  use(*(int **)((int)aiStack44 + iVar1));
  *(undefined4 **)((int)aiStack44 + iVar1) = &local_18;
  *(int **)((int)&piStack48 + iVar1) = 0x804848e;
  use(*(int **)((int)aiStack44 + iVar1));
  return;
}
...

{
  ...
  *(int **)((int)&piStack48 + iVar1) = 0x80484d3;
  fill(*(int **)((int)aiStack44 + iVar1),*(int *)((int)aiStack44 + iVar1 + 4));
  *(undefined4 **)((int)aiStack44 + iVar1) = &local_18;
  *(int **)((int)&piStack48 + iVar1) = 0x80484dc;
  use(*(int **)((int)aiStack44 + iVar1));
  *(undefined **)((int)aiStack44 + iVar1) = auStack28 + iVar1;
  *(int **)((int)&piStack48 + iVar1) = 0x80484e5;
  use(*(int **)((int)aiStack44 + iVar1));
  *(undefined4 **)((int)aiStack44 + iVar1) = &local_14;
