...
{
	__align(fp + 0x08);
	__libc_start_main(&globals->t400640, qwArg00, fp + 0x08, &globals->t400670, &globals->t4006E0, rdx, ptrLoc04);
	__hlt();
}
...
void use(word32 * rdi)
{
	globals->dw601028 = (word32) (uint64) ((word32) (uint64) *rdi + globals->dw601028);
}

// 0000000000400520: void fill(Register word32 esi, Register (ptr word32) rdi)
...
{
	word32 * rcx_19 = fp - 0x28 - ((word64) ((uint64) ((word32) ((uint64) edi)) * 0x04) + 0x0F & 0xFFFFFFF0);
	fill((word32) (uint64) edi, rcx_19);
	use(fp - 0x10);
	use(rcx_19);
	use(fp - 0x1C);
}
...
{
	word32 * rcx_14 = fp - 0x28 - ((word64) ((int64) edi * 0x04) + 0x0F & ~0x0F);
	fill((word32) (uint64) edi, rcx_14);
	use(fp - 0x10);
	use(rcx_14);
	use(fp - 0x1C);
}
...
// 0000000000400670: void __libc_csu_init(Register word32 edi)
