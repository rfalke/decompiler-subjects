...
void _start( * rdx, Eq_17 qwArg00)
{
	...
	__libc_start_main(&globals->t400640, qwArg00, (char *) fp + 0x08, &globals->t400670, &globals->t4006E0, rdx, fp);
	__hlt();
}
...
{
	word32 * rcx_19 = fp - 0x28 - ((uint64) ((word32) ((uint64) edi)) * 0x04 + 0x0F & 0xFFFFFFF0);
...
{
	word32 * rcx_14 = fp - 0x28 - ((int64) edi * 0x04 + 0x0F & ~0x0F);
