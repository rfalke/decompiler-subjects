...

{
  ...
  __s = (int *)(&stack0xffffffffffffffe0 + -((ulonglong)(uint)n * 4 + 0xf & 0x7fffffff0));
  memset(__s,0x78,n << 2,*(undefined *)__s);
  sum = sum + *__s + 0xf;
  return;
}
...

{
  ...
  __s = (int *)(&stack0xffffffffffffffe0 +
               -((-(ulonglong)((uint)n >> 0x1f) & 0xfffffffc00000000 | (ulonglong)(uint)n << 2) +
                 0xf & 0xfffffffffffffff0));
  memset(__s,0x78,(int)((ulonglong)(uint)n << 2),*(undefined *)__s);
  sum = sum + *__s + 0xf;
  return;
}
