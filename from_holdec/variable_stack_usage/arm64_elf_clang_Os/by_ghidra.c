...

{
  ...
  __s = (int *)(&stack0xffffffffffffffe0 + -((ulong)(uint)n * 4 + 0xf & 0x7fffffff0));
  memset(__s,0x78,-(ulong)((uint)n >> 0x1f) & 0xfffffffc00000000 | (ulong)(uint)n << 2,
         *(undefined *)__s);
  sum = sum + *__s + 0xf;
  return;
}
...

{
  ...
  __s = (int *)(&stack0xffffffffffffffe0 + -(__n + 0xf & 0xfffffffffffffff0));
  memset(__s,0x78,__n,*(undefined *)__s);
  sum = sum + *__s + 0xf;
  return;
}
