...

{
  ...
  *(int **)((int)apiStack48 + iVar1) = 0x80484a0;
  fill(*(int **)((int)ppiVar2 + iVar1),*(int *)((int)aiStack40 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed1;
  *(int **)((int)apiStack48 + iVar1) = 0x80484ab;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(undefined **)((int)ppiVar2 + iVar1) = auStack28 + iVar1;
  *(int **)((int)apiStack48 + iVar1) = 0x80484b3;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed2;
  *(int **)((int)apiStack48 + iVar1) = 0x80484be;
  use(*(int **)((int)ppiVar2 + iVar1));
  return;
}
...

{
  ...
  *(int **)((int)apiStack48 + iVar1) = 0x8048505;
  fill(*(int **)((int)ppiVar2 + iVar1),*(int *)((int)aiStack40 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed1;
  *(int **)((int)apiStack48 + iVar1) = 0x8048510;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = (int *)((int)&fixed2 + iVar1);
  *(int **)((int)apiStack48 + iVar1) = 0x8048518;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed2;
  *(int **)((int)apiStack48 + iVar1) = 0x8048523;
  use(*(int **)((int)ppiVar2 + iVar1));
  return;
}
