...

{
  ...
  dynamic = (int (*) [1])(aiStack72 + uVar1 * -4);
  fixed2 = 8;
  (&uStack80)[uVar1 * -2] = 0x4005d9;
  fill((int *)(int (*) [1])(aiStack72 + uVar1 * -4),n,*(undefined *)(&uStack80 + uVar1 * -2));
  (&uStack80)[uVar1 * -2] = 0x4005e5;
  use(&fixed1,*(undefined *)(&uStack80 + uVar1 * -2));
  x = dynamic;
  (&uStack80)[uVar1 * -2] = 0x4005f1;
  use((int *)x,*(undefined *)(&uStack80 + uVar1 * -2));
  (&uStack80)[uVar1 * -2] = 0x4005fd;
  use(&fixed2,*(undefined *)(&uStack80 + uVar1 * -2));
  return;
}
...

{
  ...
  fill(aiStack32 + uVar1 * -4,n,*(undefined *)(auStack48 + uVar1 * -2));
  auStack48[uVar1 * -2] = 0x40067d;
  use(&fixed1,*(undefined *)(auStack48 + uVar1 * -2));
  x = dynamic;
  auStack48[uVar1 * -2] = 0x400689;
  use(x,*(undefined *)(auStack48 + uVar1 * -2));
  auStack48[uVar1 * -2] = 0x400695;
  use(&fixed2,*(undefined *)(auStack48 + uVar1 * -2));
  return;
}
