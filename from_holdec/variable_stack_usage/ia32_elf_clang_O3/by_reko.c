...
void _start( * edx, int32 dwArg00)
{
	...
	__libc_start_main(&globals->t8048510, dwArg00, (char *) fp + 0x04, &globals->t8048530, &globals->t8048590, edx, fp);
	__hlt();
}
...
// 08048420: void fill(Stack (ptr32 word32) dwArg04, Stack ui32 dwArg08)
void fill(word32 * dwArg04, ui32 dwArg08)
{
	memset(dwArg04, 0x78, dwArg08 << 0x02);
}

// 08048440: void with_array(Register word32 ebp, Stack ui32 dwArg04)
void with_array(word32 ebp, ui32 dwArg04)
{
	ptr32 edi_20 = fp - 0x1C - (dwArg04 * 0x04 + 0x0F & ~0x0F);
	*(edi_20 - 0x0C) = dwArg04;
	*(edi_20 - 0x10) = edi_20;
...
// 080484B0: void with_alloca(Register word32 ebp, Stack ui32 dwArg04)
void with_alloca(word32 ebp, ui32 dwArg04)
{
	ptr32 esi_16 = fp - 0x1C - (dwArg04 * 0x04 + 0x0F & ~0x0F);
	*(esi_16 - 0x0C) = dwArg04;
	*(esi_16 - 0x10) = esi_16;
	fill(dwArg00, dwArg04);
	*(esi_16 - 0x10) = fp - 0x10;
...
// 08048510: void main(Register word32 ebp, Stack ui32 dwArg04)
