...
void with_alloca(int32_t a1) {
    ...
    esi3 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(esp2) - 4 - 20 - (reinterpret_cast<uint32_t>(a1 * 4 + 15) & 0xfffffff0));
    esp4 = reinterpret_cast<int32_t*>(reinterpret_cast<uint32_t>(esi3) - 8 - 4);
    *esp4 = a1;
    ...
    *esp11 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(esp2) - 8);
...
void with_array(int32_t a1) {
    ...
    esp2 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(__zero_stack_offset()) - 4);
    edi3 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(esp2) - 4 - 4 - 16 - (reinterpret_cast<uint32_t>(a1 * 4 + 15) & 0xfffffff0));
    ...
    *esp9 = edi3;
    ...
    use(esp10->f4);
    esp11 = reinterpret_cast<void**>(&esp10->f4 + 1 - 1);
    *esp11 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(esp2) - 12);
