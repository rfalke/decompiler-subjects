...

{
  ...
  *(int *)((int)aiStack44 + iVar1 + 4) = n;
  local_18 = auStack28 + iVar1;
  *(int **)((int)&piStack48 + iVar1) = 0x80484b7;
  fill(*(int **)((int)aiStack44 + iVar1),*(int *)((int)aiStack44 + iVar1 + 4));
  *(undefined4 **)((int)aiStack44 + iVar1) = &local_c;
  *(int **)((int)&piStack48 + iVar1) = 0x80484c8;
  use(*(int **)((int)aiStack44 + iVar1));
  *(undefined **)((int)aiStack44 + iVar1) = local_18;
  *(int **)((int)&piStack48 + iVar1) = 0x80484d3;
  use(*(int **)((int)aiStack44 + iVar1));
  *(undefined4 **)((int)aiStack44 + iVar1) = &local_14;
  *(int **)((int)&piStack48 + iVar1) = 0x80484e4;
  use(*(int **)((int)aiStack44 + iVar1));
  return;
}
...

{
  ...
  *(undefined **)((int)aiStack44 + iVar1) = auStack28 + iVar1;
  *(int *)((int)aiStack44 + iVar1 + 4) = n;
  *(int **)((int)&piStack48 + iVar1) = 0x8048535;
  fill(*(int **)((int)aiStack44 + iVar1),*(int *)((int)aiStack44 + iVar1 + 4));
  *(int ***)((int)aiStack44 + iVar1) = &dynamic;
  *(int **)((int)&piStack48 + iVar1) = 0x8048546;
  use(*(int **)((int)aiStack44 + iVar1));
  *(int *)((int)aiStack44 + iVar1) = fixed2;
  *(int **)((int)&piStack48 + iVar1) = 0x8048557;
  use(*(int **)((int)aiStack44 + iVar1));
  *(undefined4 **)((int)aiStack44 + iVar1) = &local_14;
  *(int **)((int)&piStack48 + iVar1) = 0x8048568;
  use(*(int **)((int)aiStack44 + iVar1));
  return;
}
