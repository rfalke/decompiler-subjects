...
void with_array(int32_t a1) {
    ...
    *esp5 = esp3;
    esp6 = reinterpret_cast<struct s0*>(esp5 - 1);
    esp6->f0 = 0x8048462;
    fill();
    esp7 = &esp6->f4;
    *esp7 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(esp2) - 12);
    esp8 = reinterpret_cast<struct s1*>(esp7 - 1);
    esp8->f0 = 0x804846d;
    use(esp8->f4);
    esp9 = &esp8->f4;
    *esp9 = esp3;
    esp10 = reinterpret_cast<struct s2*>(esp9 - 1);
    esp10->f0 = 0x8048475;
    use(esp10->f4);
    esp11 = &esp10->f4;
    *esp11 = reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(esp2) - 16);
    esp12 = reinterpret_cast<struct s3*>(esp11 - 1);
    esp12->f0 = 0x8048480;
    use(esp12->f4);
    return;
}
...
void with_alloca(int32_t a1) {
    ...
    ebx4 = reinterpret_cast<int32_t*>(reinterpret_cast<uint32_t>(esp3) + 15 & 0xfffffff0);
    ...
    *esp6 = ebx4;
    ...
    fill();
    esp8 = &esp7->f4;
    *esp8 = reinterpret_cast<void*>(reinterpret_cast<int32_t>(esp2) - 12);
    ...
    *esp10 = ebx4;
    ...
    use(esp11->f4);
    esp12 = &esp11->f4;
    *esp12 = reinterpret_cast<int32_t*>(reinterpret_cast<int32_t>(esp2) - 16);
