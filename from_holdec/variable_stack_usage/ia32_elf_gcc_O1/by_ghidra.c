...

{
  ...
  *(int **)((int)apiStack48 + iVar1) = 0x8048462;
  fill(*(int **)((int)ppiVar2 + iVar1),*(int *)((int)aiStack40 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed1;
  *(int **)((int)apiStack48 + iVar1) = 0x804846d;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(undefined **)((int)ppiVar2 + iVar1) = auStack28 + iVar1;
  *(int **)((int)apiStack48 + iVar1) = 0x8048475;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed2;
  *(int **)((int)apiStack48 + iVar1) = 0x8048480;
  use(*(int **)((int)ppiVar2 + iVar1));
  return;
}
...

{
  ...
  *(int **)((int)apiStack48 + iVar1) = 0x80484bd;
  fill(*(int **)((int)ppiVar2 + iVar1),*(int *)((int)aiStack40 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed1;
  *(int **)((int)apiStack48 + iVar1) = 0x80484c8;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = (int *)((int)&fixed1 + iVar1);
  *(int **)((int)apiStack48 + iVar1) = 0x80484d0;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed2;
  *(int **)((int)apiStack48 + iVar1) = 0x80484db;
  use(*(int **)((int)ppiVar2 + iVar1));
  return;
}
