...

{
  ...
  *(int *)((int)aiStack40 + iVar1) = n;
  ppiVar2 = apiStack48 + 1;
  *(int **)((int)ppiVar2 + iVar1) = (int *)((int)&fixed1 + iVar1);
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x80484bd;
  fill(*(int **)((int)ppiVar2 + iVar1),*(int *)((int)aiStack40 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed1;
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x80484c8;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = (int *)((int)&fixed1 + iVar1);
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x80484d0;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed2;
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x80484db;
  use(*(int **)((int)ppiVar2 + iVar1));
  return;
}
