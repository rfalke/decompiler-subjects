...

{
  ...
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x8048451;
  fill(*(int **)((int)ppiVar2 + iVar1),*(int *)((int)aiStack40 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed1;
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x804845c;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(undefined4 *)((int)ppiVar2 + iVar1) = extraout_EDX;
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x8048464;
  use(*(int **)((int)ppiVar2 + iVar1));
  *(int **)((int)ppiVar2 + iVar1) = &fixed2;
  *(undefined4 *)((int)apiStack48 + iVar1) = 0x804846f;
  use(*(int **)((int)ppiVar2 + iVar1));
  return;
}
