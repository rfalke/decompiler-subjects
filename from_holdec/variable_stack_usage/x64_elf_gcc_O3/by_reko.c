...
void with_array(word32 edi)
{
	...
	memset(rbx_21 * 0x04, 0x78, rdx_8 << 0x02);
	g_dw601028 = (word32) (uint64) (word32) ((uint64) g_dw601028 + 0x0F + (uint64) null[rbx_21]);
}
...
void with_alloca(word32 edi)
{
	...
	g_dw601028 = (word32) (uint64) (word32) ((uint64) g_dw601028 + 0x0F + (uint64) (*memset((word64) ((fp - 8) - ((rdx_5 << 0x02) + 0x1E & ~0x0F)) + 0x0F & ~0x0F, 0x78, rdx_5 << 0x02)));
}
