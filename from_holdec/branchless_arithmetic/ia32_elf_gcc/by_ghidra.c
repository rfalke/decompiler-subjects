...

{
  ...
  uVar1 = sat_adds32b_var3(0x7fffffff,2);
  uVar2 = sat_adds32b_var2(0x7fffffff,2);
  uVar3 = sat_adds32b_var1(0x7fffffff,2);
  printf("sat_adds32b(0x%08x,0x%08x) = 0x%08x 0x%08x 0x%08x\n",0x7fffffff,2,uVar3,uVar2,uVar1);
  ...
  printf("sat_divs32b(0x%08x,0x%08x) = 0x%08x\n",0x80000000,0xffffffff,uVar1);
  uVar1 = abs32(0xfffffff0);
  printf("abs32(0x%08x) = 0x%08x\n",0xfffffff0,uVar1);
  uVar1 = sgn32(3);
  printf("sgn32(0x%08x) = 0x%08x\n",3,uVar1);
  lVar4 = sat_addu64b(0,0,0,0);
  lVar5 = sat_subu64b(0,0,0,0);
  lVar6 = sat_divu64b(0,0,1,0);
  lVar7 = sat_adds64b(0,0,0,0);
  lVar8 = sat_subs64b(0,0,0,0);
  lVar9 = sat_divs64b(0,0,1,0);
  lVar10 = abs64(0,0);
  lVar11 = sgn64(0,0);
  if (lVar4 + lVar5 + lVar6 + lVar7 + lVar8 + lVar9 + lVar10 + lVar11 == 0x2a) {
    puts("not reached");
  }
  return;
}
...
// WARNING: Removing unreachable block (ram,0x0804930c)
// WARNING: Removing unreachable block (ram,0x08049315)
...
// WARNING: Removing unreachable block (ram,0x08049358)
// WARNING: Removing unreachable block (ram,0x08049361)
...
uint sat_addu32b(uint param_1,uint param_2)

{
  return param_2 + param_1 | -(uint)CARRY4(param_2,param_1);
}



uint sat_subu32b(uint param_1,uint param_2)

{
  return -(uint)(param_2 <= param_1) & param_1 - param_2;
}
...
uint sat_mulu32b(uint param_1,uint param_2)

{
  return (uint)((ulonglong)param_2 * (ulonglong)param_1) |
         -(uint)((int)((ulonglong)param_2 * (ulonglong)param_1 >> 0x20) != 0);
}
...

{
  ...
  uVar1 = -(uint)(CARRY4(param_4,param_2) || CARRY4(param_4 + param_2,(uint)CARRY4(param_3,param_1))
                 );
  return CONCAT44(param_4 + param_2 + (uint)CARRY4(param_3,param_1) | (int)uVar1 >> 0x1f,
                  uVar1 | param_3 + param_1);
}



undefined8 sat_subu64b(uint param_1,uint param_2,uint param_3,int param_4)

{
  uint uVar1;
  uint uVar2;
  
  uVar2 = (param_2 - param_4) - (uint)(param_1 < param_3);
  uVar1 = -(uint)(uVar2 <= param_2 && (uint)(param_1 < param_1 - param_3) <= param_2 - uVar2);
  return CONCAT44((int)uVar1 >> 0x1f & uVar2,uVar1 & param_1 - param_3);
}
...
uint sat_adds32b_var1(uint param_1,uint param_2)

{
  ...
  iVar2 = ((int)param_1 >> 0x1f) + ((int)param_2 >> 0x1f) + (uint)CARRY4(param_1,param_2);
  if ((SBORROW4(-iVar2,(uint)(0x7fffffff < uVar1)) != false) !=
      (int)(-iVar2 - (uint)(0x7fffffff < uVar1)) < 0) {
    uVar1 = 0x7fffffff;
    iVar2 = 0;
  }
  if ((SBORROW4(iVar2,-1) != SBORROW4(iVar2 + 1,(uint)(uVar1 < 0x80000000))) !=
      (int)((iVar2 + 1) - (uint)(uVar1 < 0x80000000)) < 0) {
    uVar1 = 0x80000000;
  }
  return uVar1;
}
...
{
  if ((-1 < (int)(param_2 ^ param_1)) && ((int)(param_1 ^ param_2 + param_1) < 0)) {
    return 0x7fffffff - ((int)param_1 >> 0x1f);
  }
...

{
  ...
  if (-1 < (int)(~(param_2 ^ param_1 + param_2) | param_2 ^ uVar1)) {
    uVar2 = uVar1;
  }
  return uVar2;
}
...

{
  ...
  uVar1 = 0x7fffffff - (param_1 >> 0x1f);
  uVar2 = param_1 - param_2;
  if ((int)((param_2 ^ uVar1) & (param_1 - param_2 ^ uVar1)) < 0) {
    uVar2 = uVar1;
  }
  return uVar2;
}
...
int sat_divs32b(int param_1,int param_2)

{
  return (int)(param_1 + (uint)((param_2 + 1U | param_1 + 0x80000000U) == 0)) / param_2;
}
...

{
  ...
  iVar1 = (int)((longlong)(int)param_1 * (longlong)(int)param_2);
  if (iVar1 >> 0x1f != (int)((ulonglong)((longlong)(int)param_1 * (longlong)(int)param_2) >> 0x20))
  {
...

{
  ...
  uVar3 = param_2 + param_4 + (uint)CARRY4(param_1,param_3);
  uVar1 = (uint)(0x80000000 < (uint)-(param_2 >> 0x1f));
  iVar2 = param_1 + param_3;
  if (-1 < (int)(~(param_4 ^ uVar3) | param_4 ^ uVar1)) {
    iVar2 = -(param_2 >> 0x1f) + 0x7fffffff;
    uVar3 = uVar1;
  }
...

{
  ...
  uVar1 = (uint)(0x80000000 < (uint)-(param_2 >> 0x1f));
  iVar2 = param_1 - param_3;
  if ((int)((param_4 ^ uVar1) & (uVar3 ^ uVar1)) < 0) {
    iVar2 = -(param_2 >> 0x1f) + 0x7fffffff;
    uVar3 = uVar1;
  }
  return CONCAT44(uVar3,iVar2);
...
undefined8 abs64(int param_1,int param_2)
...

{
  ...
  iVar1 = 0;
  do {
    (**(code **)(unaff_EBP + 0x2562 + iVar1 * 4))(param_1,param_2,param_3);
    iVar1 = iVar1 + 1;
  } while (iVar1 != 1);
  return;
}
