// subject.h
// Generated on TIMESTAMP by decompiling from_holdec/loops/ia32_elf/subject.exe
// using Decompiler version VERSION

/*
// Equivalence classes ////////////
Eq_1: (struct "Globals" (804965C (ptr code) ptr804965C))
...
T_2: (in 0x0804965C : ptr32)
  Class: Eq_2
  DataType: (ptr (ptr code))
  OrigDataType: (ptr (struct (0 T_3 t0000)))
T_3: (in Mem0[0x0804965C:word32] : word32)
  Class: Eq_3
  DataType: (ptr code)
